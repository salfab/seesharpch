...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},ju=e=>{Vu(e.inputs),e.compute(Hu(e.inputs))}}),Ku,xe,Xu,Yu,Zu,Qu,Ju,el,tl,nl,rl,il,al,sl,ol,ul,zn,ll,cr,dl,cl,pl,hl,fl,ml,gl,yl,wl,_l,bl,$l,xl,vl,Sl,Tl,Ei,Il,Mi,Ci,kl,El,Ml,Cl,Al,Rl,Ai=Y(()=>{de(),he(),Le(),fe(),Ku=(e,t,n,r,i,a,s)=>{let o=Math.ceil(t/4),u="";typeof i=="string"?u=`${i}(a)`:u=i("a");let l=W("inputData",n,[o],4),p=ie("outputData",r,[o],4),c=[{name:"vec_size",type:"u32"}];return s&&c.push(...s),`
...
`,Ci=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,kl=e=>{let t=Je(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"FastGelu",Ci,Mi(t),void 0,e.inputs[0].dataType))},El=(e,t)=>{let n=Je(e.inputs[0].dataType);return e.compute(xe(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Ml=e=>{e.compute(xe(e.inputs[0],"Log","log"))},Cl=(e,t)=>`
...
`},Oi=(e,t,n,r,i=!1,a)=>{let s=e[0].dims,o=e[1].dims,u=s[s.length-2],l=o[o.length-1],p=s[s.length-1],c=Pe(l),f=Pe(p),m=Pe(u),g=D.size(n)/c/m,y=e.length>2,b=r?r.slice(0,-2):n.slice(0,-2),$=[D.size(b),u,l],x=[{type:12,data:g},{type:12,data:u},{type:12,data:l},{type:12,data:p}];nn(t,x),x.push(...se(b,s,o)),y&&x.push(...se(e[2].dims)),x.push(...se($));let T=S=>{let k=$i("batch_dims",e[0].dataType,b.length),E=W("a",e[0].dataType,s.length,f),M=W("b",e[1].dataType,o.length,c),v=ie("output",e[0].dataType,$.length,c),R=Ve(v.type.tensor),O=tn(t,v.type.value,R),j=[E,M],P="";if(y){let B=i?c:1;j.push(W("bias",e[2].dataType,e[2].dims.length,B)),P=`${i?`value += bias[col / ${B}];`:`value += ${v.type.value}(bias[row + i]);`}`}let F=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];rn(t,F);let A=()=>{let B=`var a_data: ${E.type.value};`;for(let V=0;V<f;V++)B+=`
            ...
            values[${V}] = fma(${M.type.value}(a_data${f===1?"":`[${K}]`}), b_data${K}, values[${V}]);
`}return B};return`
  ...
  ${S.mainStart()}
    ...
    ${On("b_indices",M,M.rank-2,k.rank,"batch_indices")}
...
`},ad=(e,t,n,r,i=!1)=>{let[a,s,o,u]=r,l=Ve(r[0].type.tensor);return`
    ...
    `},pr=(e,t,n,r,i=!1,a)=>{let s=e[0].dims,o=e[1].dims,u=s.slice(0,-2),l=o.slice(0,-2),p=r?r.slice(0,-2):n.slice(0,-2),c=D.size(p),f=s[s.length-2],m=s[s.length-1],g=o[o.length-1],y=m%4===0&&g%4===0,b=f<=8?[4,1,1]:[4,4,1],$=[8,8,1],x=[Math.ceil(g/$[0]/b[0]),Math.ceil(f/$[1]/b[1]),Math.ceil(c/$[2]/b[2])],T=y?4:1,S=[...u,f,m/T],k=S.length,E=[...l,m,g/T],M=E.length,v=[c,f,g/T],R=[{type:6,data:f},{type:6,data:g},{type:6,data:m}];nn(t,R),R.push(...se(p,S,E));let O=["rank","rank"],j=e.length>2;j&&(R.push(...se(e[2].dims)),O.push("rank")),R.push(...se(v));let P=F=>{let A=p.length,B=$i("batchDims",e[0].dataType,A,1),V=Ve(e[0].dataType),K=W("a",e[0].dataType,k,T),re=W("b",e[1].dataType,M,T),N=ie("result",e[0].dataType,v.length,T),Z=[K,re];if(j){let ue=i?T:1;Z.push(W("bias",e[2].dataType,e[2].dims.length,ue))}let U=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];rn(t,U);let X=Ve(N.type.tensor),H=tn(t,N.type.value,X),q=ad(T,j,H,[B,K,re,N],i);return`
  ...
  ${y?Bi(b,$,V,B):Pi(b,$,V,B)}
    ...
    return ${je(o,l)}(0.0);`,k=je(u,l),E=je(e?s:o,l),M=je(e?o:s,l),v=tn(a,k,l);return`
  ...
  ${g.mainStart()}
    ...
    ${X}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${p}${y}${g}${c}${m}`,inputDependencies:x},getRunData:()=>({dispatchGroup:{x:$[0],y:$[1],z:$[2]},outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],programUniforms:v}),getShaderSource:R}}}),bd,$d,xd,Vi,vd,Sd,Hi,Td,Id,s0=Y(()=>{a0(),an(),Ut(),bd=(e,t,n,r,i,a)=>(e-1)*t+n+(r-1)*i+1-a,$d=(e,t,n,r,i)=>{let a=Math.floor(e/2);t==="SAME_UPPER"?(n[r]=a,n[i]=e-a):t==="SAME_LOWER"&&(n[r]=e-a,n[i]=a)},xd=(e,t,n,r,i,a,s,o,u,l)=>{let p=e.length-2,c=l.length===0;u.length<p&&u.push(...Array(p-u.length).fill(0));let f=e[0],m=t[o?3:1]*i;for(let g=0,y=e.length-p-(o?1:0);g<p;++g,++y){let b=e[y],$=c?b*s[g]:l[g],x=bd(b,s[g],a[g],t[y],n[g],$);$d(x,r,a,g,g+p),c&&l.push(s[g]*(b-1)+u[g]+(t[y]-1)*n[g]+1-a[g]-a[g+p])}l.splice(0,0,f),l.splice(o?3:1,0,m)},Vi=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,f)=>c*f,1)===0){n.length=0;for(let c=2;c<t[1].dims.length;++c)n.push(t[1].dims[c])}let r=e.format==="NHWC";n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let i=e.pads.slice(),a=e.outputShape.slice(),s=e.outputPadding.slice(),o=t[0].dims,u=e.dilations.slice();if(u.reduce((c,f)=>c+f,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let l=e.strides.slice();if(l.reduce((c,f)=>c+f,0)===0){let c=t[0].dims.length-2;l=new Array(c).fill(1)}xd(o,n,u,e.autoPad,e.group,i,l,r,s,a);let p=Object.assign({},e);return Object.assign(p,{kernelShape:n,pads:i,outputPadding:s,outputShape:a,dilations:u,strides:l}),p},vd=e=>{let t=Ri(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],i=e.dilations,a=e.group??1,s=e.kernelShape,o=e.pads,u=e.strides,l=e.wIsConst(),p=e.outputPadding,c=e.outputShape;return{autoPad:r,format:n,dilations:i,group:a,kernelShape:s,outputPadding:p,outputShape:c,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Sd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==i))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.reduce((s,o)=>s+o,0)>0&&t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.reduce((s,o)=>s+o,0)>0&&t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.reduce((s,o)=>s+o,0)>0&&t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.outputPadding.length!==a&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${a}D`);if(t.kernelShape.reduce((s,o)=>s+o,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Hi=(e,t,n,r)=>{let i=e.kernelCustomData.wT??e.compute(ut(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let a=[t[0],i];t.length===3&&a.push(t[2]),e.compute(_d(a,n,r),{inputs:a})},Td=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let o=t.pads;o.length===0&&(o=[0,0]),o=[0,o[0],0,o[1]],s=[1].concat(s),a=[1].concat(a),i=[1].concat(i);let u=t.outputPadding;u=[0].concat(u);let l=Vi({...t,pads:o,strides:s,dilations:a,kernelShape:i,outputPadding:u},r);Hi(e,r,l,p=>n?[p[0],p[2],p[3]]:[p[0],p[1],p[3]])},Id=(e,t)=>{if(Sd(e.inputs,t),e.inputs[0].dims.length===3)Td(e,t);else{let n=Vi(t,e.inputs);Hi(e,e.inputs,n)}}}),kd,Ed,Md,o0=Y(()=>{de(),he(),Le(),fe(),kd=(e,t,n,r)=>{let i=D.size(t),a=t.length,s=W("input",e,a),o=ie("output",e,a),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=D.normalizeAxis(u,a),p=c=>{let f=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,m=ae("uniforms.input_shape","uniforms.axis",a),g=r.reverse?f+(r.exclusive?" + 1":""):"0",y=r.reverse?m:f+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:l},...se(t,t)]}),getShaderSource:p}},Ed=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,i=e.inputs[1];e.compute(kd(r,n,i,t),{inputs:[0]})},Md=e=>{let t=e.exclusive===1,n=e.reverse===1;return ve({exclusive:t,reverse:n})}}),Cd,Ad,Rd,zd,Od,u0=Y(()=>{de(),he(),Le(),fe(),Cd=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Ad=(e,t,n,r)=>{let i=[];i.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${s.mainStart(yn)}
      ...
      ${f}
      let x_in = x + bias;
      ${l.setByOffset("global_idx",Ci("x_in"))}
  ...
  ${$.mainStart()}
    ...
    ${T}
    ${M!=null?`let cOffset = ${M.broadcastedIndicesToOffset("vec2(m, n)",R)}; value += ${E}(uniforms.beta) * ${M.getByOffset("cOffset")};`:""}
    output[global_idx] = value;
  }`},b=$=>{let x=W("a",e[0].dataType,e[0].dims),T=W("b",e[1].dataType,e[1].dims),S=null,k=[x,T];e.length===3&&(S=W("c",e[2].dataType,e[2].dims.length),k.push(S));let E=ie("output",e[0].dataType,o.length);k.push(E);let M=[{name:"num_tile_n",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"},{name:"alpha",type:"f32"},{name:"beta",type:"f32"}],v="",R="";t.transA&&t.transB?(R=`
...
`)}
  ...
  ${$.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${S(0)}, ${S(1)});
       ...
       Got scale size of ${c} and bias size of ${f}`);let m=[];for(let k=0;k<i.length;++k)k<u?m.push(i[k]):m.push(1);let g=Pe(p),y=["type","type"],b=[{type:12,data:l},{type:1,data:p},{type:12,data:Math.floor(p/g)},{type:1,data:t.epsilon}];s&&y.push("type");let $=n>1,x=n>2,T=k=>{let E=Ve(e[0].dataType),M=[W("x",e[0].dataType,e[0].dims,g),W("scale",a.dataType,a.dims,g)];s&&M.push(W("bias",s.dataType,s.dims,g)),M.push(ie("output",e[0].dataType,o,g)),$&&M.push(ie("mean_data_output",1,m)),x&&M.push(ie("inv_std_output",1,m));let v=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${k.mainStart()}
    ...
    `,o="",u=W("x",t.dataType,t.dims.length),l=["rank"],[p,c,f,m,g]=ta(a,i);return p.push(...se(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${f};${m};${g}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(D.size(a)/64)},programUniforms:p}),getShaderSource:y=>na(y,u,t.dims.length,a.length,i,s,o,t.dataType===10?-65504:-1e5,c,f,m,g)}},gp=(e,t)=>{Pn(e.inputs),e.compute(oa("MaxPool",e.inputs[0],!1,t))},yp=e=>{let t=e.storage_order,n=e.dilations,r=ia(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:n,...r,cacheKey:""};return{...i,cacheKey:cp(i)}},wp=e=>{let t=e.format;return{format:t,...sa,cacheKey:t}},_p=(e,t)=>{Pn(e.inputs),e.compute(oa("GlobalMaxPool",e.inputs[0],!0,t))}}),bp,$p,xp,vp,T0=Y(()=>{de(),he(),Le(),fe(),bp=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===t.axis||i===e[0].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},$p=(e,t)=>{let n=D.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,s=e[1].dataType,o=D.size(a),u=r===3||r===2,l=u?[Math.ceil(D.size(e[0].dims)/4)]:e[0].dims,p=e[1].dims,c=e.length>2?e[2]:void 0,f=c?u?[Math.ceil(D.size(c.dims)/4)]:c.dims:void 0,m=p.length===0||p.length===1&&p[0]===1,g=m===!1&&p.length===1,y=Pe(o),b=m&&(!u||y===4),$=b?y:1,x=b&&!u?y:1,T=W("input",u?12:r,l.length,x),S=W("scale",s,p.length),k=c?W("zero_point",u?12:r,f.length):void 0,E=ie("output",s,a.length,$),M=[T,S];k&&M.push(k);let v=[l,p];c&&v.push(f);let R=[{type:12,data:o/$},{type:12,data:n},{type:12,data:t.blockSize},...se(...v,a)],O=j=>{let P=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:o})}},Ip=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),Ce.webgpu.validateInputContent&&Sp(t,n,r),e.compute(Tp(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),kp,Ep,Mp,Cp,k0=Y(()=>{de(),he(),Le(),fe(),kp=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${kp(t.reduction,"output[data_offset + i]","value",g.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l}),getShaderSource:p}},Mp=e=>ve({reduction:e.reduction}),Cp=(e,t)=>{e.compute(Ep(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Ap,Rp,zp,ua,Op,Np,Bp,Dp,Pp,Up,Lp,Fp,la,Gp,Wp,qp,Vp,Hp,jp,Kp,E0=Y(()=>{de(),he(),Le(),fe(),Ap=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},S=[{dims:o,dataType:e[0].dataType}];return n>1&&S.push({dims:p,dataType:1}),n>2&&S.push({dims:p,dataType:1}),n>3&&S.push({dims:a,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${$};${m};${g};${y}`,inputDependencies:e.map((k,E)=>"type")},getShaderSource:T,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:x})}},Zp=(e,t)=>{Xp(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Yp(e.inputs,t,e.outputCount,!1),{outputs:n})}}),Qp,Un,Jp,da,eh,th,nh,rh,C0=Y(()=>{de(),he(),Le(),fe(),Qp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},Un=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},Jp=(e,t)=>{if(e.length>1){let n=Un(e,1),r=Un(e,2),i=Un(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),ve({starts:n,ends:r,axes:i})}else return t},da=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},eh=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
 ...
 * limitations under the License.
 * =============================================================================
 */const F0=114;function G0(e,t,n){const r=Math.min(n/e,n/t),i=Math.round(e*r),a=Math.round(t*r);return{scale:r,padX:Math.floor((n-i)/2),padY:Math.floor((n-a)/2),resizedWidth:i,resizedHeight:a}}function dn(e,t,n){const{width:r,height:i,channels:a,data:s}=e,o=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let p=0;p<n;p++){const c=(p+.5)*l-.5,f=Math.max(0,Math.min(i-1,Math.floor(c))),m=Math.min(i-1,f+1),g=Math.max(0,Math.min(1,c-f));for(let y=0;y<t;y++){const b=(y+.5)*u-.5,$=Math.max(0,Math.min(r-1,Math.floor(b))),x=Math.min(r-1,$+1),T=Math.max(0,Math.min(1,b-$)),S=(f*r+$)*a,k=(f*r+x)*a,E=(m*r+$)*a,M=(m*r+x)*a,v=(p*t+y)*3;for(let R=0;R<3;R++){const O=s[S+R]*(1-T)+s[k+R]*T,j=s[E+R]*(1-T)+s[M+R]*T;o[v+R]=Math.min(255,Math.max(0,Math.round(O*(1-g)+j*g)))}}}return o}function Fh(e,t){const n=G0(e.width,e.height,t),r=dn(e,n.resizedWidth,n.resizedHeight),i=t*t,a=new Float32Array(3*i).fill(F0/255);for(let s=0;s<n.resizedHeight;s++){const o=(s+n.padY)*t+n.padX,u=s*n.resizedWidth;for(let l=0;l<n.resizedWidth;l++){const p=(u+l)*3,c=o+l;a[c]=r[p]/255,a[i+c]=r[p+1]/255,a[2*i+c]=r[p+2]/255}}return{tensor:a,params:n}}function Gh(e,t,n,r){const i=[],a=Math.floor(e.length/6);for(let s=0;s<a;s++){const o=e[s*6],u=e[s*6+1],l=e[s*6+2],p=e[s*6+3],c=e[s*6+4],f=e[s*6+5];if(c<n)continue;const m=Math.round(f);if(m<0||m>=r)continue;const g=(o-t.padX)/t.scale,y=(u-t.padY)/t.scale,b=(l-t.padX)/t.scale,$=(p-t.padY)/t.scale;i.push({classIndex:m,confidence:c,box:[Math.trunc(g),Math.trunc(y),Math.trunc(b-g),Math.trunc($-y)],boxFloat:[g,y,b-g,$-y]})}return i}function Gn(e){const t=Math.floor(e);return e-t===.5?t%2===0?t:t+1:Math.round(e)}function Wh(e){if(e.length===0)return Number.NaN;const t=[...e].sort((r,i)=>r-i),n=Math.floor(t.length/2);return t.length%2===1?t[n]:(t[n-1]+t[n])/2}function qh(e,t){if(e.length===0)return Number.NaN;const n=[...e].sort((s,o)=>s-o),r=t/100*(n.length-1),i=Math.floor(r),a=Math.ceil(r);return i===a?n[i]:n[i]*(a-r)+n[a]*(r-i)}const W0=.6,q0=.74;function Vh(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++){if(e[a*6+4]<n)continue;const o=(e[a*6]-t.padX)/t.scale,u=(e[a*6+1]-t.padY)/t.scale,l=(e[a*6+2]-t.padX)/t.scale,p=(e[a*6+3]-t.padY)/t.scale,c=Gn((o+l)/2),f=Gn((u+p)/2),m=Gn((l-o+(p-u))/4);m>=1&&r.push({cx:c,cy:f,r:m})}return r}function V0(e){const t=[];for(const n of[...e].sort((r,i)=>r.r-i.r)){const r=(W0*n.r)**2;t.every(i=>(n.cx-i.cx)**2+(n.cy-i.cy)**2>r)&&t.push(n)}return t}function H0(e){const t=[];for(const n of[...e].sort((r,i)=>i.r-r.r))t.every(r=>Math.hypot(n.cx-r.cx,n.cy-r.cy)>=q0*(n.r+r.r))&&t.push(n);return t}function j0(e){if(e.length===0)return[];const t=Math.max(1,Math.trunc(Wh(e.map(n=>n.r))*1.5));return[...e].sort((n,r)=>{const i=Math.floor(n.cy/t),a=Math.floor(r.cy/t);return i!==a?i-a:n.cx-r.cx})}function Hh(e,t,n){const r=Vh(e,t,n);return r.length===0?[]:j0(H0(V0(r)))}function K0(e,t,n){return Vh(e,t,n)}function Ta(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++)e[a*6+4]<n||r.push([(e[a*6]-t.padX)/t.scale,(e[a*6+1]-t.padY)/t.scale,(e[a*6+2]-t.padX)/t.scale,(e[a*6+3]-t.padY)/t.scale]);return r}const jh=["brown","grey","blue","green","yellow","red","purple"],X0={brown:"raw",grey:"manufactured",blue:"civilian",green:"scientific",yellow:"commercial",red:"military",purple:"guild"},Y0=.7;function Z0(e){const t=e.map((i,a)=>a).sort((i,a)=>e[a].confidence-e[i].confidence),n=new Set,r=[];for(const i of t){const a=e[i],[s,o,u,l]=a.box;let p=!1;for(const c of r){const f=e[c];if(f.family!==a.family)continue;const[m,g,y,b]=f.box,$=Math.max(0,Math.min(s+u,m+y)-Math.max(s,m)),x=Math.max(0,Math.min(o+l,g+b)-Math.max(o,g)),T=Math.max(1,Math.min(u*l,y*b));if($*x>=Y0*T){p=!0;break}}p?n.add(i):r.push(i)}return e.filter((i,a)=>!n.has(a))}function Kh(e,t,n){const r=Gh(e,t,n,jh.length).map(i=>{const a=jh[i.classIndex];return{color:a,family:X0[a],box:i.box,confidence:i.confidence}});return Z0(r)}const Q0=8,J0=.8,Xh=1.25;function ey(e){if(e.length<Q0)return[];const t=[],n=[];for(const s of e){const[,,o,u]=s.box;o>u*Xh?t.push(s):u>o*Xh&&n.push(s)}const[r,i,a]=t.length>=n.length?[t,n,"vertical"]:[n,t,"horizontal"];return r.length<J0*e.length||i.length===0?[]:i.map(s=>({family:s.family,color:s.color,box:[...s.box],reason:`${s.color} banner sits ${a} while ${r.length}/${e.length} of the tableau faces the other way — probably a stray card poking into the frame`}))}const ty=2.25,Yh=8;function ny(e){if(e.length<Yh)return[];const t=e.map(c=>[c.box[0]+c.box[2]/2,c.box[1]+c.box[3]/2]),n=e.map(c=>Math.hypot(c.box[2],c.box[3])).sort((c,f)=>c-f),r=ty*n[Math.floor(n.length/2)],i=r*r,a=e.map((c,f)=>f),s=c=>{for(;a[c]!==c;)a[c]=a[a[c]],c=a[c];return c};for(let c=0;c<e.length;c++)for(let f=c+1;f<e.length;f++){const m=t[c][0]-t[f][0],g=t[c][1]-t[f][1];m*m+g*g<=i&&(a[s(c)]=s(f))}const o=new Map;for(let c=0;c<e.length;c++){const f=s(c);o.set(f,[...o.get(f)??[],c])}let u=[];for(const c of o.values())c.length>u.length&&(u=c);if(u.length<Yh||u.length===e.length)return[];const l=new Set(u),p=e.map((c,f)=>f).filter(c=>!l.has(c));return p.map(c=>({family:e[c].family,color:e[c].color,box:[...e[c].box],reason:`${e[c].color} banner sits in a detached group of ${p.length}, away from the ${u.length}-card tableau — probably the draw/discard pile, not this player's city`}))}const St={banner:{onnx:"banner_yolo.onnx",input:1280,conf:.5},coin:{onnx:"coin_yolo.onnx",input:1280,conf:.25},laurel:{onnx:"laurel_yolo.onnx",input:1280,conf:.25},token:{onnx:"token_yolo.onnx",input:1280,conf:.4},wonder:{onnx:"wonder_yolo.onnx",input:1280,conf:.3}};function _t(e,t,n){const r=Math.max(e,t,n),i=Math.min(e,t,n),a=r-i,s=r===0?0:Math.round(255*a/r);if(a===0)return{h:0,s,v:r};let o;return r===e?o=60*(t-n)/a:r===t?o=120+60*(n-e)/a:o=240+60*(e-t)/a,o<0&&(o+=360),{h:Math.round(o/2),s,v:r}}const ry=.42,iy=22,ay=43,sy=120,oy=1.5,uy=.72,ly=110,Zh=3;function Wn(e,t,n){const{width:r,height:i,channels:a,data:s}=e;if(r<4||i<4)return 0;const o=Math.floor(r/2),u=Math.floor(i/2),l=Math.trunc(Math.min(r,i)*ry);if(l<1)return 0;let p=0;for(let c=0;c<i;c++)for(let f=0;f<r;f++){if((f-o)**2+(c-u)**2>l*l)continue;const m=(c*r+f)*a,g=s[m],y=s[m+1],b=s[m+2];!t&&g>=250&&y>=250&&b>=250||(n(g,y,b),p+=1)}return p}function dy(e){let t=0,n=0,r=0,i=Wn(e,!1,(a,s,o)=>{const u=_t(a,s,o);t+=u.h,n+=u.s,r+=u.v});return i===0&&(i=Wn(e,!0,(a,s,o)=>{const u=_t(a,s,o);t+=u.h,n+=u.s,r+=u.v})),i===0?null:{h:t/i,s:n/i,v:r/i}}function cy(e){let t=0,n=0,r=Wn(e,!1,(a,s)=>{t+=a,n+=s});if(r===0&&(r=Wn(e,!0,(a,s)=>{t+=a,n+=s})),r===0)return null;const i=n/r;return i<=1e-6?null:t/r/i}function py(e){let t=0;const n=Wn(e,!0,(r,i,a)=>{t+=_t(r,i,a).s});return n===0?null:t/n}function hy(e){const t=dy(e);if(t===null||t.s<=iy)return 1;if(t.s>=sy){const n=cy(e);return n!==null&&n>=oy?6:3}return t.s>=ay?3:6}function fy(e,t){const n=[...t];if(e.length!==3||t.length!==3||new Set(t).size===3&&t.every(s=>[1,3,6].includes(s)))return n;const r=e.map(s=>s.r).sort((s,o)=>s-o);if(r[0]<=0||!(r[1]>=r[0]*1.12&&r[2]>=r[1]*1.12))return n;const i=[0,1,2].sort((s,o)=>e[s].r-e[o].r),a=new Map([[i[0],1],[i[1],3],[i[2],6]]);return[0,1,2].map(s=>a.get(s))}function my(e,t){const n=[...t];if(e.length<Zh||t.length!==e.length)return n;const r=e.map(s=>py(s)),i=r.filter(s=>s!==null);if(i.length<Zh)return n;const a=Wh(i);return a<=0||r.forEach((s,o)=>{s!==null&&n[o]!==1&&s<uy*a&&s<ly&&(n[o]=1)}),n}function Qh(e,t){const{cx:n,cy:r,r:i}=t,a=Math.max(0,n-i),s=Math.max(0,r-i),o=Math.min(e.width,n+i),u=Math.min(e.height,r+i),l=Math.max(0,o-a),p=Math.max(0,u-s),c=new Uint8Array(l*p*3);for(let f=0;f<p;f++)for(let m=0;m<l;m++){const g=(f*l+m)*3;if((m+a-n)**2+(f+s-r)**2<=i*i){const b=((f+s)*e.width+(m+a))*e.channels;c[g]=e.data[b],c[g+1]=e.data[b+1],c[g+2]=e.data[b+2]}else c[g]=255,c[g+1]=255,c[g+2]=255}return{width:l,height:p,channels:3,data:c}}function gy(e,t){const n=t.map(a=>Qh(e,a)),r=n.map(a=>hy(a)),i=fy(t,r);return my(n,i)}function yy(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n);for(let s=0,o=0;s<a.length;s++,o+=r)a[s]=i[o]*4899+i[o+1]*9617+i[o+2]*1868+8192>>14;return{width:t,height:n,data:a}}function Jh(e,t,n){const r=new Uint8Array(t*n),i=e.width/t,a=e.height/n;for(let s=0;s<n;s++){const o=s*a,u=Math.min((s+1)*a,e.height);for(let l=0;l<t;l++){const p=l*i,c=Math.min((l+1)*i,e.width);let f=0,m=0;for(let g=Math.floor(o);g<u;g++){const y=Math.min(g+1,u)-Math.max(g,o);if(!(y<=0))for(let b=Math.floor(p);b<c;b++){const $=Math.min(b+1,c)-Math.max(b,p);$<=0||(f+=e.data[g*e.width+b]*$*y,m+=$*y)}}r[s*t+l]=Math.min(255,Math.max(0,Gn(f/m)))}}return{width:t,height:n,data:r}}function wy(e){const t=new Array(256).fill(0);for(const u of e.data)t[u]+=1;const n=e.data.length;let r=0;for(;r<256&&t[r]===0;)r+=1;const i=new Uint8Array(n);if(r>=255||t[r]===n)return i.fill(r<256?r:0),{width:e.width,height:e.height,data:i};const a=255/(n-t[r]),s=new Uint8Array(256);let o=0;for(let u=r+1;u<256;u++)o+=t[u],s[u]=Math.min(255,Math.max(0,Gn(o*a)));for(let u=0;u<n;u++)i[u]=s[e.data[u]];return{width:e.width,height:e.height,data:i}}function _y(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let s=0;s<t;s++){let o=!0;for(let u=-1;u<=1&&o;u++)for(let l=-1;l<=1;l++){const p=s+l,c=a+u;if(!(p<0||p>=t||c<0||c>=n)&&r[c*t+p]===0){o=!1;break}}i[a*t+s]=o&&r[a*t+s]>0?255:0}return{width:t,height:n,data:i}}function by(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let s=0;s<t;s++){let o=!1;for(let u=-1;u<=1&&!o;u++)for(let l=-1;l<=1;l++){const p=s+l,c=a+u;if(p>=0&&p<t&&c>=0&&c<n&&r[c*t+p]>0){o=!0;break}}i[a*t+s]=o?255:0}return{width:t,height:n,data:i}}function Ia(e){const{width:t,height:n,data:r}=e,i=new Int32Array(t*n),a=[],s=new Int32Array(t*n);let o=1;for(let u=0;u<r.length;u++){if(r[u]===0||i[u]!==0)continue;let l=0,p=0;s[p++]=u,i[u]=o;let c=0,f=0,m=0;for(;l<p;){const g=s[l++],y=g%t,b=g/t|0;c+=1,f+=y,m+=b;for(let $=-1;$<=1;$++)for(let x=-1;x<=1;x++){if(x===0&&$===0)continue;const T=y+x,S=b+$;if(T<0||T>=t||S<0||S>=n)continue;const k=S*t+T;r[k]>0&&i[k]===0&&(i[k]=o,s[p++]=k)}}a[o]={area:c,centroidX:f/c,centroidY:m/c},o+=1}return{labels:i,stats:a}}function $y(e,t,n){return ef(Float32Array.from(e.data),e.width,t,n)}function ef(e,t,n,r){const i=new Float32Array(t*t),a=t/2,s=-n*Math.PI/180,o=Math.cos(s),u=Math.sin(s);for(let l=0;l<t;l++)for(let p=0;p<t;p++){const c=p-a,f=l-a,m=o*c-u*f+a,g=u*c+o*f+a,y=Math.floor(m),b=Math.floor(g),$=m-y,x=g-b,T=(E,M)=>E>=0&&E<t&&M>=0&&M<t?e[M*t+E]:r,S=T(y,b)*(1-$)+T(y+1,b)*$,k=T(y,b+1)*(1-$)+T(y+1,b+1)*$;i[l*t+p]=S*(1-x)+k*x}return i}const xy=.9,vy=.34,Sy=[.55,.6,.66,.72],Ty=22,Iy=88,ky=35,bn=28,ka=4,Ey=Array.from({length:15},(e,t)=>-21+t*3),tf=[-2,0,2],My=3,Cy=.3;function Ay(e){return e.templates.flatMap(({label:t,bits:n})=>{const r=Uint8Array.from(atob(n),i=>i.charCodeAt(0));return r.length!==e.size*e.size?[]:[{label:t,bits:Float32Array.from(r)}]})}function Ry(e){let t=e.width,n=-1,r=e.height,i=-1,a=0;for(let y=0;y<e.height;y++)for(let b=0;b<e.width;b++)e.data[y*e.width+b]>0&&(a+=1,t=Math.min(t,b),n=Math.max(n,b),r=Math.min(r,y),i=Math.max(i,y));if(a<8)return null;const s=n-t+1,o=i-r+1,u=Math.max(o,s),l=new Uint8Array(u*u),p=Math.floor((u-s)/2),c=Math.floor((u-o)/2);for(let y=0;y<o;y++)for(let b=0;b<s;b++)l[(y+c)*u+(b+p)]=e.data[(y+r)*e.width+(b+t)];const f=bn-2*ka,m=Jh({width:u,height:u,data:l},f,f),g=new Float32Array(bn*bn);for(let y=0;y<f;y++)for(let b=0;b<f;b++)g[(y+ka)*bn+(b+ka)]=m.data[y*f+b]>110?1:0;return g}function zy(e,t){const{width:n,height:r,channels:i,data:a}=e,s=Math.floor(r/2),o=Math.floor(n/2),u=Math.trunc(Math.min(n,r)*vy);if(u<4)return null;const l=s-u,p=o-u,c=2*u,f=2*u;if(c<6||f<6)return null;const m=new Int16Array(c*f),g=new Int16Array(c*f),y=new Int16Array(c*f),b=new Uint8Array(c*f),$=[],x=Math.min(c,f)/2;for(let N=0;N<c;N++)for(let Z=0;Z<f;Z++){const U=((N+l)*n+(Z+p))*i,{h:X,s:H,v:q}=_t(a[U],a[U+1],a[U+2]),ue=N*f+Z;m[ue]=X,g[ue]=H,y[ue]=q,Math.sqrt((Z-f/2)**2+(N-c/2)**2)/x<=t&&(b[ue]=1,$.push(q))}if($.length<16)return null;const T=qh($,55);let S=0,k=0,E=0;const M=N=>m[N]>=Ty&&m[N]<=Iy&&g[N]>=ky,v=N=>y[N]>=T&&g[N]<=95&&!M(N)&&b[N]===1;for(let N=0;N<c*f;N++)b[N]===1&&(E+=1,y[N]>=130&&!M(N)&&(S+=1),v(N)&&(k+=1));const R=S>.5*E&&k<.15*E,O=new Uint8Array(c*f);if(R){const N=qh($,45);for(let Z=0;Z<c*f;Z++)O[Z]=b[Z]===1&&y[Z]<=N?255:0}else for(let N=0;N<c*f;N++)O[N]=v(N)?255:0;const j={width:f,height:c,data:O},P=_y(j);let F=Ia(P),A=F;if(F.stats.length<=1&&(F=Ia(j),A=F,F.stats.length<=1))return null;const B=Math.min(c,f)/2;let V=0,K=-1;for(let N=1;N<A.stats.length;N++){const Z=A.stats[N];if(Z===void 0)continue;const U=Math.hypot(Z.centroidX-f/2,Z.centroidY-c/2)/B,X=Z.area*(1-.6*Math.min(U,1));X>K&&(K=X,V=N)}if(V===0)return null;const re=new Uint8Array(c*f);for(let N=0;N<c*f;N++)re[N]=A.labels[N]===V?255:0;return Ry(by({width:f,height:c,data:re}))}function Oy(e,t,n,r,i,a){const s=bn;let o=0,u=0;for(let l=0;l<s;l++){const p=l-a;if(!(p<0||p>=s))for(let c=0;c<s;c++){const f=c-i;if(f<0||f>=s)continue;const m=e[p*s+f];m!==0&&(u+=m,o+=m*n[l*s+c])}}return o/(u+r-o+1e-6)}function Ny(e,t){const n=t.reduce((i,a)=>i+a,0);let r=-1;for(const i of Ey){const a=i===0?e:ef(e,bn,i,0),s=a.reduce((o,u)=>o+u,0);for(const o of tf)for(const u of tf){const l=Oy(a,s,t,n,o,u);l>r&&(r=l)}}return r}function By(e,t){if(t.length===0||Math.min(e.width,e.height)<8)return[null,0];const n=[];for(const s of Sy){const o=zy(e,s);if(o!==null)for(const{label:u,bits:l}of t)n.push([Ny(o,l),u])}if(n.length===0)return[null,0];if(n.sort((s,o)=>o[0]-s[0]),n[0][0]<Cy)return[null,0];const r=new Map;for(const[s,o]of n.slice(0,My))r.set(o,(r.get(o)??0)+s);let i=0,a=-1;for(const[s,o]of r)o>a&&(a=o,i=s);return[i,n[0][0]]}const Dy=2560,Py=.3,Uy=.5,Ly=1.6,Fy=3,Gy=5;function Wy(e){const t=Math.min(1,Dy/Math.max(e.width,e.height)),n=Math.max(32,Math.round(e.width*t/32)*32),r=Math.max(32,Math.round(e.height*t/32)*32),i=n*r,a=new Float32Array(3*i),s=e.width/n,o=e.height/r;for(let u=0;u<r;u++){const l=(u+.5)*o-.5,p=Math.max(0,Math.min(e.height-1,Math.floor(l))),c=Math.min(e.height-1,p+1),f=Math.max(0,Math.min(1,l-p));for(let m=0;m<n;m++){const g=(m+.5)*s-.5,y=Math.max(0,Math.min(e.width-1,Math.floor(g))),b=Math.min(e.width-1,y+1),$=Math.max(0,Math.min(1,g-y));for(let x=0;x<3;x++){const T=2-x,S=(p*e.width+y)*e.channels+T,k=(p*e.width+b)*e.channels+T,E=(c*e.width+y)*e.channels+T,M=(c*e.width+b)*e.channels+T,v=e.data[S]*(1-$)+e.data[k]*$,R=e.data[E]*(1-$)+e.data[M]*$,O=v*(1-f)+R*f;a[x*i+u*n+m]=(O/255-.5)/.5}}}return{tensor:a,width:n,height:r}}function qy(e,t,n){const r=new Uint8Array(e.length);for(let i=0;i<n;i++){const a=i===n-1;for(let s=0;s<t;s++){const o=i*t+s;let u=e[o];if(s+1<t&&e[o+1]>u&&(u=e[o+1]),!a){const l=o+t;e[l]>u&&(u=e[l]),s+1<t&&e[l+1]>u&&(u=e[l+1])}r[o]=u}}return r}function Vy(e){if(e.length<3)return e;const t=[...e].sort((a,s)=>a[0]-s[0]||a[1]-s[1]),n=(a,s,o)=>(s[0]-a[0])*(o[1]-a[1])-(s[1]-a[1])*(o[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(let a=t.length-1;a>=0;a--){const s=t[a];for(;i.length>=2&&n(i[i.length-2],i[i.length-1],s)<=0;)i.pop();i.push(s)}return r.pop(),i.pop(),r.concat(i)}function Hy(e){if(e.length===1)return{cx:e[0][0],cy:e[0][1],w:0,h:0,angle:0};let t=null,n=1/0;for(let r=0;r<e.length;r++){const[i,a]=e[r],[s,o]=e[(r+1)%e.length],u=s-i,l=o-a,p=Math.hypot(u,l);if(p===0)continue;const c=u/p,f=l/p;let m=1/0,g=-1/0,y=1/0,b=-1/0;for(const[S,k]of e){const E=S*c+k*f,M=-S*f+k*c;E<m&&(m=E),E>g&&(g=E),M<y&&(y=M),M>b&&(b=M)}const $=g-m,x=b-y,T=$*x;if(T<n){n=T;const S=(m+g)/2,k=(y+b)/2;t={cx:S*c-k*f,cy:S*f+k*c,w:$,h:x,angle:Math.atan2(f,c)}}}return t}function jy(e,t,n,r){const i=Math.cos(r.angle),a=Math.sin(r.angle),s=r.w/2,o=r.h/2,u=Math.abs(s*i)+Math.abs(o*a),l=Math.abs(s*a)+Math.abs(o*i),p=Math.max(0,Math.floor(r.cx-u)),c=Math.min(t-1,Math.ceil(r.cx+u)),f=Math.max(0,Math.floor(r.cy-l)),m=Math.min(n-1,Math.ceil(r.cy+l));let g=0,y=0;for(let b=f;b<=m;b++)for(let $=p;$<=c;$++){const x=$-r.cx,T=b-r.cy,S=x*i+T*a,k=-x*a+T*i;Math.abs(S)<=s&&Math.abs(k)<=o&&(g+=e[b*t+$],y+=1)}return y===0?0:g/y}function Ky(e){const t=Math.cos(e.angle),n=Math.sin(e.angle),r=e.w/2,i=e.h/2,s=[...[[e.cx+-r*t- -i*n,e.cy+-r*n+-i*t],[e.cx+r*t- -i*n,e.cy+r*n+-i*t],[e.cx+r*t-i*n,e.cy+r*n+i*t],[e.cx+-r*t-i*n,e.cy+-r*n+i*t]]].sort((y,b)=>y[0]-b[0]),[o,u,l,p]=s,[c,f]=o[1]<=u[1]?[o,u]:[u,o],[m,g]=l[1]<=p[1]?[l,p]:[p,l];return[[c[0],c[1]],[m[0],m[1]],[g[0],g[1]],[f[0],f[1]]]}function Xy(e,t,n,r){const{width:i,height:a}=t;let s=new Uint8Array(i*a);for(let m=0;m<s.length;m++)s[m]=e[m]>Py?255:0;s=qy(s,i,a);const o={width:i,height:a,data:s},{labels:u}=Ia(o),l=new Map;for(let m=0;m<a;m++)for(let g=0;g<i;g++){const y=u[m*i+g];if(y===0)continue;let b=l.get(y);b===void 0&&(b=new Map,l.set(y,b));const $=b.get(m);$===void 0?b.set(m,[g,g]):(g<$[0]&&($[0]=g),g>$[1]&&($[1]=g))}const p=n/i,c=r/a,f=[];for(const[m,g]of l){const y=[];for(const[O,[j,P]]of g)y.push([j-.5,O-.5],[j-.5,O+.5],[P+.5,O-.5],[P+.5,O+.5]);const b=Hy(Vy(y));if(Math.min(b.w,b.h)<Fy)continue;const $=jy(e,i,a,b);if($<Uy)continue;const x=b.w*b.h*Ly/(2*(b.w+b.h)),T={...b,w:b.w+2*x,h:b.h+2*x};if(Math.min(T.w,T.h)<Gy+2)continue;const k=Ky(T).map(([O,j])=>[Math.min(n,Math.max(0,Math.round(O*p))),Math.min(r,Math.max(0,Math.round(j*c)))]),E=k.map(O=>O[0]),M=k.map(O=>O[1]),v=Math.min(...E),R=Math.min(...M);f.push({quad:k,x:v,y:R,width:Math.max(...E)-v,height:Math.max(...M)-R,score:$})}return f.sort((m,g)=>g.score-m.score)}function Yy(e,t){const[n,r,i,a]=t,s=Math.max(1,Math.round(Math.max(Math.hypot(r[0]-n[0],r[1]-n[1]),Math.hypot(i[0]-a[0],i[1]-a[1])))),o=Math.max(1,Math.round(Math.max(Math.hypot(a[0]-n[0],a[1]-n[1]),Math.hypot(i[0]-r[0],i[1]-r[1])))),u=Zy([[0,0],[s,0],[s,o],[0,o]],[n,r,i,a]),l=new Uint8Array(s*o*e.channels);for(let c=0;c<o;c++)for(let f=0;f<s;f++){const m=u[6]*f+u[7]*c+u[8],g=(u[0]*f+u[1]*c+u[2])/m,y=(u[3]*f+u[4]*c+u[5])/m,b=Math.floor(g),$=Math.floor(y),x=g-b,T=y-$,S=Math.max(0,Math.min(e.width-1,b)),k=Math.max(0,Math.min(e.width-1,b+1)),E=Math.max(0,Math.min(e.height-1,$)),M=Math.max(0,Math.min(e.height-1,$+1));for(let v=0;v<e.channels;v++){const R=e.data[(E*e.width+S)*e.channels+v],O=e.data[(E*e.width+k)*e.channels+v],j=e.data[(M*e.width+S)*e.channels+v],P=e.data[(M*e.width+k)*e.channels+v],F=R*(1-x)+O*x,A=j*(1-x)+P*x;l[(c*s+f)*e.channels+v]=Math.round(F*(1-T)+A*T)}}const p={width:s,height:o,channels:e.channels,data:l};return o/s>=1.5?Gt(p,3):p}function Zy(e,t){const n=[],r=[];for(let i=0;i<4;i++){const[a,s]=e[i],[o,u]=t[i];n.push([a,s,1,0,0,0,-o*a,-o*s]),r.push(o),n.push([0,0,0,a,s,1,-u*a,-u*s]),r.push(u)}for(let i=0;i<8;i++){let a=i;for(let o=i+1;o<8;o++)Math.abs(n[o][i])>Math.abs(n[a][i])&&(a=o);[n[i],n[a]]=[n[a],n[i]],[r[i],r[a]]=[r[a],r[i]];const s=n[i][i];for(let o=i;o<8;o++)n[i][o]/=s;r[i]/=s;for(let o=0;o<8;o++){if(o===i)continue;const u=n[o][i];if(u!==0){for(let l=i;l<8;l++)n[o][l]-=u*n[i][l];r[o]-=u*r[i]}}}return[r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],1]}function Gt(e,t){const n=(t%4+4)%4;if(n===0)return e;const{width:r,height:i,channels:a,data:s}=e,o=n%2===0?r:i,u=n%2===0?i:r,l=new Uint8Array(o*u*a);for(let p=0;p<i;p++)for(let c=0;c<r;c++){let f,m;n===1?(f=i-1-p,m=c):n===2?(f=r-1-c,m=i-1-p):(f=p,m=r-1-c);const g=(p*r+c)*a,y=(m*o+f)*a;for(let b=0;b<a;b++)l[y+b]=s[g+b]}return{width:o,height:u,channels:a,data:l}}const Qy=.6;(()=>{const e=new Uint8Array(256);for(let t=0;t<256;t++)e[t]=Math.min(255,Math.round(Math.pow(t/255,Qy)*255));return e})();const Ot=48,Jy=320;function ew(e){return["blank",...e.characters," "]}function tw(e,t,n){let r="";const i=[];for(let s=0;s<e.length;s++){const o=e[s];o!==0&&(s>0&&e[s-1]===o||(r+=n[o]??"",i.push(t[s])))}if(i.length===0)return["",0];const a=i.reduce((s,o)=>s+o,0)/i.length;return[r,a]}function nw(e,t){const n=Math.trunc(Ot*t),r=e.width/e.height,i=Math.ceil(Ot*r)>n?n:Math.ceil(Ot*r),a=new Float32Array(3*Ot*n),s=Ot*n,o=e.width/i,u=e.height/Ot;for(let l=0;l<Ot;l++){const p=(l+.5)*u-.5,c=Math.max(0,Math.min(e.height-1,Math.floor(p))),f=Math.min(e.height-1,c+1),m=Math.max(0,Math.min(1,p-c));for(let g=0;g<i;g++){const y=(g+.5)*o-.5,b=Math.max(0,Math.min(e.width-1,Math.floor(y))),$=Math.min(e.width-1,b+1),x=Math.max(0,Math.min(1,y-b));for(let T=0;T<3;T++){const S=2-T,k=(c*e.width+b)*e.channels+S,E=(c*e.width+$)*e.channels+S,M=(f*e.width+b)*e.channels+S,v=(f*e.width+$)*e.channels+S,R=e.data[k]*(1-x)+e.data[E]*x,O=e.data[M]*(1-x)+e.data[v]*x,j=R*(1-m)+O*m;a[T*s+l*n+g]=(j/255-.5)/.5}}}return{tensor:a,width:n}}const rw=62,iw=8,aw=5;function Ea(e){return e?e.normalize("NFKD").replace(new RegExp("\\p{M}","gu"),"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim():""}function sw(e,t){const n=e.length,r=t.length;if(n===0||r===0)return 0;let i=new Int32Array(r+1),a=new Int32Array(r+1);for(let s=1;s<=n;s++){for(let o=1;o<=r;o++)a[o]=e[s-1]===t[o-1]?i[o-1]+1:Math.max(i[o],a[o-1]);[i,a]=[a,i]}return i[r]}function $r(e,t){return e.length===0&&t.length===0?100:200*sw(e,t)/(e.length+t.length)}function nf(e,t){const n=r=>r.split(/\s+/).filter(Boolean).sort().join(" ");return $r(n(e),n(t))}function ow(e,t){const n=new Set(e.split(/\s+/).filter(Boolean)),r=new Set(t.split(/\s+/).filter(Boolean)),i=[...n].filter(p=>r.has(p)).sort(),a=[...n].filter(p=>!r.has(p)).sort(),s=[...r].filter(p=>!n.has(p)).sort(),o=i.join(" "),u=[o,a.join(" ")].filter(Boolean).join(" "),l=[o,s.join(" ")].filter(Boolean).join(" ");return o.length>0&&(a.length===0||s.length===0)?100:Math.max($r(o,u),$r(o,l),$r(u,l))}function uw(e){const t=new Set,n=[];for(const r of e){const i=r.nameFr??r.name;for(const a of[Ea(i),Ea(r.name)])if(a)for(const s of[a,a.replace(/ /g,"")])s&&!t.has(s)&&(t.add(s),n.push({key:s,id:r.id,display:i,...r.kind!==void 0?{kind:r.kind}:{}}))}return n}function lw(e,t){const n=Ea(e);if(!n||t.length===0)return null;const i=uw(t).map(p=>({...p,score:ow(n,p.key)})).sort((p,c)=>c.score-p.score).slice(0,iw).filter(p=>p.score>=rw);if(i.length===0)return null;const a=i[0].score,s=i.filter(p=>a-p.score<=aw),o=[...new Set(n.split(/\s+/).filter(Boolean))].join(" ");let u=s[0],l=[nf(o,u.key),u.score];for(const p of s.slice(1)){const c=[nf(o,p.key),p.score];(c[0]>l[0]||c[0]===l[0]&&c[1]>l[1])&&(u=p,l=c)}return{id:u.id,name:u.display,...u.kind!==void 0?{kind:u.kind}:{},confidence:Math.round(u.score/100*1e4)/1e4}}const rf=5e3,Ma=.75,af=15,dw=1.25,cw=2.4,pw=.003,hw=.85,fw=4,Ca=2600,Aa=2,Ra=.3,sf=.1,of=.012,mw=22,uf=.5,xr=.12;function Ze(e,t){const n=new e.Mat(t.height,t.width,e.CV_8UC3),r=n.data,i=t.channels;for(let a=0,s=t.width*t.height;a<s;a++)r[a*3]=t.data[a*i],r[a*3+1]=t.data[a*i+1],r[a*3+2]=t.data[a*i+2];return n}function gw(e,t,n,r){const i=r.map(ne=>ne[0]),a=r.map(ne=>ne[1]),s=i.reduce((ne,ye)=>ne+ye,0)/i.length,o=a.reduce((ne,ye)=>ne+ye,0)/a.length,u=Math.max(Math.max(...i)-Math.min(...i),Math.max(...a)-Math.min(...a));if(u<4)return null;const l=u*fw,p=Math.max(0,Math.trunc(s-l)),c=Math.min(n.width,Math.trunc(s+l)),f=Math.max(0,Math.trunc(o-l)),m=Math.min(n.height,Math.trunc(o+l));if(c-p<8||m-f<8)return null;const g=Math.max(n.width,n.height)<Ca?Aa:1,y=Ze(e,n),b=Ze(e,t),$=new e.Rect(p,f,c-p,m-f),x=y.roi($),T=new e.Mat;g!==1?e.resize(x,T,new e.Size(0,0),g,g,e.INTER_CUBIC):x.copyTo(T);const S=new e.Mat,k=new e.Mat;e.cvtColor(b,S,e.COLOR_RGB2GRAY),e.cvtColor(T,k,e.COLOR_RGB2GRAY);const E=new e.ORB(rf),M=new e.KeyPointVector,v=new e.KeyPointVector,R=new e.Mat,O=new e.Mat,j=new e.Mat,P=[y,b,x,T,S,k,M,v,R,O,j],F=ne=>{for(const ye of P)try{ye.delete()}catch{}try{E.delete()}catch{}return ne};if(E.detectAndCompute(S,j,M,R),E.detectAndCompute(k,j,v,O),R.rows<8||O.rows<8)return F(null);const A=new e.BFMatcher(e.NORM_HAMMING),B=new e.DMatchVectorVector;A.knnMatch(R,O,B,2);const V=[],K=[];for(let ne=0;ne<B.size();ne++){const ye=B.get(ne);if(ye.size()===2){const De=ye.get(0),Fe=ye.get(1);if(De.distance<Ma*Fe.distance){const Ge=M.get(De.queryIdx).pt,rt=v.get(De.trainIdx).pt;V.push(Ge.x,Ge.y),K.push(rt.x,rt.y)}}}if(B.delete(),A.delete(),V.length/2<8)return F(null);const re=e.matFromArray(V.length/2,1,e.CV_32FC2,V),N=e.matFromArray(K.length/2,1,e.CV_32FC2,K),Z=new e.Mat,U=e.findHomography(re,N,e.RANSAC,5,Z);let X=0;for(let ne=0;ne<Z.rows;ne++)X+=Z.data[ne];const H=U.rows===3?[...U.data64F]:null;if(re.delete(),N.delete(),Z.delete(),U.delete(),H===null||X<af)return F(null);const q=1/g,ue=[[q,0,p],[0,q,f],[0,0,1]],ce=[0,1,2].map(ne=>[0,1,2].map(ye=>ue[ne][0]*H[ye]+ue[ne][1]*H[3+ye]+ue[ne][2]*H[6+ye]));return F({H:ce,inliers:X})}function za(e,t,n){if(e.length!==4||e.some(u=>!Number.isFinite(u[0])||!Number.isFinite(u[1])))return!1;let r=0;for(let u=0;u<4;u++){const[l,p]=e[u],[c,f]=e[(u+1)%4];r+=l*f-c*p}const i=Math.abs(r/2)/(t*n);if(i<pw||i>hw)return!1;const a=e.map((u,l)=>{const p=e[(l+1)%4];return Math.hypot(p[0]-u[0],p[1]-u[1])}),s=Math.min(...a);if(s<1)return!1;const o=Math.max(...a)/s;return o>=dw&&o<=cw}function Oa(e,t,n){const r=e[2][0]*t+e[2][1]*n+e[2][2];return[(e[0][0]*t+e[0][1]*n+e[0][2])/r,(e[1][0]*t+e[1][1]*n+e[1][2])/r]}function Na(e,t,n,r){const i=n.width,a=n.height,s=Math.max(8,Math.trunc(Ra*i)),o=i+2*s,u=a+2*s;if(o*u>4e7)return null;const l=r.map(P=>[P[0],P[1],P[2]-s*(P[0]+P[1])+0]);for(let P=0;P<3;P++)l[P][2]=r[P][2]-s*r[P][0]-s*r[P][1];const p=Ze(e,t),c=new e.Mat,f=e.matFromArray(3,3,e.CV_64F,l.flat());e.warpPerspective(p,c,f,new e.Size(o,u),e.WARP_INVERSE_MAP);const m=new e.Mat;e.cvtColor(c,m,e.COLOR_RGB2Lab),p.delete(),f.delete();const g=m.data,y=Math.max(4,Math.trunc(s/3)),b=[[],[],[]],$=(P,F)=>{const A=(F*o+P)*3;b[0].push(g[A]),b[1].push(g[A+1]),b[2].push(g[A+2])};for(let P=0;P<u;P++)for(let F=0;F<o;F++)(P<y||P>=u-y||F<y||F>=o-y)&&$(F,P);const x=P=>{P.sort((A,B)=>A-B);const F=P.length>>1;return P.length%2?P[F]:(P[F-1]+P[F])/2},T=[x(b[0]),x(b[1]),x(b[2])],S=(P,F)=>{const A=(F*o+P)*3,B=g[A]-T[0],V=g[A+1]-T[1],K=g[A+2]-T[2];return Math.sqrt(B*B+V*V+K*K)>mw},k=Math.max(6,Math.trunc(sf*i)),E=Math.max(6,Math.trunc(sf*a)),M=Math.max(2,Math.trunc(of*i)),v=Math.max(2,Math.trunc(of*a)),R=P=>{let F=0,A=0;for(const B of P)A=B?A+1:0,A>F&&(F=A);return F/Math.max(1,P.length)},O=P=>{let F,A,B,V,K;if(P==="L"?(F=s,A=s+a,B=Math.max(0,s-M-k),V=Math.max(0,s-M),K=!1):P==="R"?(F=s,A=s+a,B=s+i+M,V=Math.min(o,s+i+M+k),K=!1):(F=Math.max(0,s-v-E),A=Math.max(0,s-v),B=s,V=s+i,K=!0),A<=F||V<=B)return 0;const re=[];if(K)for(let N=B;N<V;N++){let Z=0;for(let U=F;U<A;U++)S(N,U)&&Z++;re.push(Z/(A-F)>uf)}else for(let N=F;N<A;N++){let Z=0;for(let U=B;U<V;U++)S(U,N)&&Z++;re.push(Z/(V-B)>uf)}return R(re)},j={L:O("L"),R:O("R"),T:O("T")};return c.delete(),m.delete(),j}const yw=6e3,ww=8,lf=.5,_w=.6;function bw(e,t,n,r){if(n.size===0)return[];const i=Math.max(t.width,t.height)<Ca?Aa:1,a=Ze(e,t),s=new e.Mat;i!==1?e.resize(a,s,new e.Size(0,0),i,i,e.INTER_CUBIC):a.copyTo(s);const o=new e.Mat;e.cvtColor(s,o,e.COLOR_RGB2GRAY),a.delete(),s.delete();const u=new e.ORB(yw),l=new e.Mat,p=new e.KeyPointVector,c=new e.Mat;u.detectAndCompute(o,l,p,c);const f=[],m=new e.BFMatcher(e.NORM_HAMMING);try{if(c.rows<8)return f;for(const[g,y]of n){if(r!==void 0&&Date.now()>r)break;const b=Ze(e,y),$=new e.Mat;e.cvtColor(b,$,e.COLOR_RGB2GRAY);const x=new e.KeyPointVector,T=new e.Mat;u.detectAndCompute($,l,x,T);const S=[b,x,T],k=()=>{for(const ce of S)ce.delete();$.delete()};if(T.rows<8){k();continue}const E=new e.DMatchVectorVector;m.knnMatch(T,c,E,2);const M=[],v=[];for(let ce=0;ce<E.size();ce++){const ne=E.get(ce);if(ne.size()===2){const ye=ne.get(0);if(ye.distance<Ma*ne.get(1).distance){const De=x.get(ye.queryIdx).pt,Fe=p.get(ye.trainIdx).pt;M.push(De.x,De.y),v.push(Fe.x,Fe.y)}}}if(E.delete(),M.length/2<8){k();continue}const R=e.matFromArray(M.length/2,1,e.CV_32FC2,M),O=e.matFromArray(v.length/2,1,e.CV_32FC2,v),j=new e.Mat,P=e.findHomography(R,O,e.RANSAC,5,j);let F=0;for(let ce=0;ce<j.rows;ce++)F+=j.data[ce];const A=P.rows===3?[...P.data64F]:null;if(R.delete(),O.delete(),j.delete(),P.delete(),A===null||F<ww){k();continue}const B=1/i,V=[[B*A[0],B*A[1],B*A[2]],[B*A[3],B*A[4],B*A[5]],[A[6],A[7],A[8]]],K=[[0,0],[y.width,0],[y.width,y.height],[0,y.height]].map(([ce,ne])=>Oa(V,ce,ne));if(!za(K,t.width,t.height)){k();continue}const re=Ze(e,t),N=e.matFromArray(3,3,e.CV_64F,V.flat()),Z=new e.Mat;e.warpPerspective(re,Z,N,new e.Size(y.width,y.height),e.WARP_INVERSE_MAP);const U=new e.Mat;e.cvtColor(Z,U,e.COLOR_RGB2GRAY);const X=new e.Mat;e.matchTemplate(U,$,X,e.TM_CCOEFF_NORMED);const H=X.data32F[0];if(re.delete(),N.delete(),Z.delete(),U.delete(),X.delete(),H<lf){k();continue}const q=Na(e,t,y,V),ue=Ba(q);f.push({id:g,confidence:Math.max(0,H),footprint:K,built:q!==null&&Math.max(q.L,q.R,q.T)>=xr,tuckRegion:Da(K,ue)}),k()}}finally{o.delete(),l.delete(),p.delete(),c.delete();try{u.delete(),m.delete()}catch{}}return f}function Ba(e){return e!==null&&e.R>=xr?["R"]:[]}function Da(e,t){if(e.length<4||t.length===0)return null;const n=e.map(y=>[y[0],y[1]]),r=Math.hypot(n[1][0]-n[0][0],n[1][1]-n[0][1]),i=Math.hypot(n[2][0]-n[3][0],n[2][1]-n[3][1]),a=.5*(r+i),s=Ra*a;if(!(s>0))return null;const o=n.reduce((y,b)=>y+b[0],0)/n.length,u=n.reduce((y,b)=>y+b[1],0)/n.length,l={T:[0,1],R:[1,2],L:[0,3]},p=[...n];for(const y of["L","R","T"]){if(!t.includes(y))continue;const[b,$]=l[y],x=n[b],T=n[$];let S=-(T[1]-x[1]),k=T[0]-x[0];const E=(x[0]+T[0])/2,M=(x[1]+T[1])/2;S*(E-o)+k*(M-u)<0&&(S=-S,k=-k);const v=Math.hypot(S,k);v<=1e-6||(S=S/v*s,k=k/v*s,p.push([x[0]+S,x[1]+k],[T[0]+S,T[1]+k]))}const c=p.map(y=>y[0]),f=p.map(y=>y[1]),m=Math.round(Math.min(...c)),g=Math.round(Math.min(...f));return{x:m,y:g,width:Math.round(Math.max(...c))-m,height:Math.round(Math.max(...f))-g}}function $w(e,t,n,r){const i=gw(e,n,t,r);if(i===null)return null;const s=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([l,p])=>Oa(i.H,l,p));if(!za(s,t.width,t.height))return null;const o=Na(e,t,n,i.H);if(o===null)return null;const u=Ba(o);return{built:Math.max(o.L,o.R,o.T)>=xr,footprint:s,overflow:u,edgeScores:o,inliers:i.inliers}}const xw=.88;function df(e,t,n,r){if(r.length!==4)return null;const i=n.width,a=n.height,s=Math.max(8,Math.trunc(Ra*i)),o=i+2*s,u=a+2*s;if(o*u>4e7)return null;const l=s+Math.trunc(i*xw),p=o-l;if(p<1)return null;const c=Ze(e,t),f=e.matFromArray(4,1,e.CV_32FC2,[0,0,i,0,i,a,0,a]),m=e.matFromArray(4,1,e.CV_32FC2,[r[0][0],r[0][1],r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]),g=e.getPerspectiveTransform(f,m),y=[...g.data64F],b=[0,1,2].flatMap(M=>[y[M*3],y[M*3+1],y[M*3+2]-s*y[M*3]-s*y[M*3+1]]),$=e.matFromArray(3,3,e.CV_64F,b),x=new e.Mat;e.warpPerspective(c,x,$,new e.Size(o,u),e.WARP_INVERSE_MAP);const T=x.roi(new e.Rect(l,0,p,u)),S=new e.Mat;T.copyTo(S);const k=S.data,E=new Uint8ClampedArray(p*u*3);E.set(k.subarray(0,E.length));for(const M of[c,f,m,g,$,x,T,S])try{M.delete()}catch{}return{width:p,height:u,channels:3,data:E}}function vw(e,t,n,r){const[i,a,s,o]=r;if(s<8||o<8)return null;const u=Math.trunc(.06*s),l=Math.trunc(.06*o),p=Math.max(0,Math.trunc(i-u)),c=Math.min(n.width,Math.trunc(i+s+u)),f=Math.max(0,Math.trunc(a-l)),m=Math.min(n.height,Math.trunc(a+o+l));if(c-p<8||m-f<8)return null;const g=Math.max(n.width,n.height)<Ca?Aa:1,y=Ze(e,n),b=Ze(e,t),$=y.roi(new e.Rect(p,f,c-p,m-f)),x=new e.Mat;g!==1?e.resize($,x,new e.Size(0,0),g,g,e.INTER_CUBIC):$.copyTo(x);const T=new e.Mat,S=new e.Mat;e.cvtColor(b,T,e.COLOR_RGB2GRAY),e.cvtColor(x,S,e.COLOR_RGB2GRAY);const k=new e.ORB(rf),E=new e.KeyPointVector,M=new e.KeyPointVector,v=new e.Mat,R=new e.Mat,O=new e.Mat,j=[y,b,$,x,T,S,E,M,v,R,O],P=ce=>{for(const ne of j)try{ne.delete()}catch{}try{k.delete()}catch{}return ce};if(k.detectAndCompute(T,O,E,v),k.detectAndCompute(S,O,M,R),v.rows<8||R.rows<8)return P(null);const F=new e.BFMatcher(e.NORM_HAMMING),A=new e.DMatchVectorVector;F.knnMatch(v,R,A,2);const B=[],V=[];for(let ce=0;ce<A.size();ce++){const ne=A.get(ce);if(ne.size()===2){const ye=ne.get(0),De=ne.get(1);if(ye.distance<Ma*De.distance){const Fe=E.get(ye.queryIdx).pt,Ge=M.get(ye.trainIdx).pt;B.push(Fe.x,Fe.y),V.push(Ge.x,Ge.y)}}}if(A.delete(),F.delete(),B.length/2<8)return P(null);const K=e.matFromArray(B.length/2,1,e.CV_32FC2,B),re=e.matFromArray(V.length/2,1,e.CV_32FC2,V),N=new e.Mat,Z=e.findHomography(K,re,e.RANSAC,5,N);let U=0;for(let ce=0;ce<N.rows;ce++)U+=N.data[ce];const X=Z.rows===3?[...Z.data64F]:null;if(K.delete(),re.delete(),N.delete(),Z.delete(),X===null||U<af)return P(null);const H=1/g,q=[[H,0,p],[0,H,f],[0,0,1]],ue=[0,1,2].map(ce=>[0,1,2].map(ne=>q[ce][0]*X[ne]+q[ce][1]*X[3+ne]+q[ce][2]*X[6+ne]));return P({H:ue,inliers:U})}function cf(e,t,n,r){const i=vw(e,n,t,r);if(i===null)return null;const s=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([$,x])=>Oa(i.H,$,x));if(!za(s,t.width,t.height))return null;const o=Ze(e,t),u=e.matFromArray(3,3,e.CV_64F,i.H.flat()),l=new e.Mat;e.warpPerspective(o,l,u,new e.Size(n.width,n.height),e.WARP_INVERSE_MAP);const p=Ze(e,n),c=new e.Mat,f=new e.Mat;e.cvtColor(l,c,e.COLOR_RGB2GRAY),e.cvtColor(p,f,e.COLOR_RGB2GRAY);const m=new e.Mat;e.matchTemplate(c,f,m,e.TM_CCOEFF_NORMED);const g=m.data32F[0];for(const $ of[o,u,l,p,c,f,m])try{$.delete()}catch{}if(g<lf)return null;const y=Na(e,t,n,i.H);if(y===null)return null;const b=Ba(y);return{built:Math.max(y.L,y.R,y.T)>=xr,footprint:s,overflow:b,edgeScores:y,inliers:i.inliers}}function Sw(e,t,n,r=.03){let i=null,a=1/0;for(const s of e){const[o,u,l,p]=s;if(l<=0||p<=0)continue;const c=r*l,f=r*p;if(t>=o-c&&t<=o+l+c&&n>=u-f&&n<=u+p+f){const m=l*p;m<a&&(a=m,i=[o,u,l,p])}}return i}const Tw=.3,Iw=.3;function kw(e,t){const n=e.filter(a=>a.edgeScores!==null);if(n.length===0)return[];const r=n.length>=2&&n.every(a=>{const{L:s,R:o,T:u}=a.edgeScores;return Math.min(s,o,u)>=Tw}),i=[];return e.forEach((a,s)=>{if(!a.built||a.edgeScores===null)return;const{L:o,R:u,T:l}=a.edgeScores,p=Math.max(o,u,l)<Iw;if(!r&&!p)return;t.some(([f,m])=>f>=a.zone.x0&&f<=a.zone.x1&&m>=a.zone.y0&&m<=a.zone.y1)||i.push(s)}),i}const Tt=128,Pa=.5;function Ua(e){const t=dn(e,Tt,Tt),n=Tt*Tt,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function pf(e){const t=e[1]??0;return{built:t>=Pa,prob:t}}const qn=120,Vn=179,Ew=1.3,Mw=3.6,Cw=.45,Aw=6e-4,Rw=.02,zw=6e3,Ow=.78,Nw=1.25,Bw=2.4,Dw=.05,Pw=1.5,Uw=.5,Lw=.9,Fw=150,Gw=18,Ww=34,qw=90,Vw=130,Hw=.13,jw=.15,vr="magistrates-guild",La="merchants-guild";function Kw(e,t){const n=Ze(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2HSV),n.delete();const i=new e.Mat(r.rows,r.cols,r.type(),[qn,30,40,0]),a=new e.Mat(r.rows,r.cols,r.type(),[Vn,255,205,255]),s=new e.Mat;e.inRange(r,i,a,s),r.delete(),i.delete(),a.delete();const o=new Uint8Array(s.data),u=e.getStructuringElement(e.MORPH_RECT,new e.Size(31,31)),l=new e.Mat;e.morphologyEx(s,l,e.MORPH_CLOSE,u),s.delete(),u.delete();const p=new e.Mat,c=new e.Mat,f=new e.Mat,m=e.connectedComponentsWithStats(l,p,c,f,8);l.delete(),p.delete(),f.delete();const g=t.width*t.height,y=[];for(let b=1;b<m;b++){const $=c.intAt(b,0),x=c.intAt(b,1),T=c.intAt(b,2),S=c.intAt(b,3),k=c.intAt(b,4),E=k/g;E<Aw||E>Rw||k/Math.max(T*S,1)<Cw||y.push({x:$,y:x,w:T,h:S})}return c.delete(),{blobs:y,mask:o,maskWidth:t.width}}function Xw(e,t,n,r,i,a,s){const o=e,u=a,l=s,p=i;if(!p.gray){const H=Ze(e,r);p.gray=new o.Mat,o.cvtColor(H,p.gray,o.COLOR_RGB2GRAY),H.delete(),p.k=new o.KeyPointVector,p.d=new o.Mat;const q=new o.Mat;u.detectAndCompute(p.gray,q,p.k,p.d),q.delete()}const c=n,f=new o.Mat,m=new o.KeyPointVector,g=new o.Mat;u.detectAndCompute(c,f,m,g),f.delete();const y=H=>(m.delete(),g.delete(),H);if(p.d.rows<8||g.rows<8)return y(null);const b=new o.DMatchVectorVector;l.knnMatch(p.d,g,b,2);const $=[],x=[];for(let H=0;H<b.size();H++){const q=b.get(H);if(q.size()===2){const ue=q.get(0);if(ue.distance<Ow*q.get(1).distance){const ce=p.k.get(ue.queryIdx).pt,ne=m.get(ue.trainIdx).pt;$.push(ce.x,ce.y),x.push(ne.x,ne.y)}}}if(b.delete(),$.length/2<8)return y(null);const T=o.matFromArray($.length/2,1,o.CV_32FC2,$),S=o.matFromArray(x.length/2,1,o.CV_32FC2,x),k=new o.Mat,E=o.findHomography(T,S,o.RANSAC,5,k);if(T.delete(),S.delete(),k.delete(),E.rows!==3)return E.delete(),y(null);const M=[...E.data64F],v=(H,q)=>{const ue=M[6]*H+M[7]*q+M[8];return[(M[0]*H+M[1]*q+M[2])/ue,(M[3]*H+M[4]*q+M[5])/ue]},R=[[0,0],[r.width,0],[r.width,r.height],[0,r.height]].map(([H,q])=>v(H,q));if(R.some(H=>!Number.isFinite(H[0])||!Number.isFinite(H[1])))return E.delete(),y(null);const O=R.map((H,q)=>{const ue=R[(q+1)%4];return Math.hypot(ue[0]-H[0],ue[1]-H[1])}),j=Math.min(...O);if(j<1)return E.delete(),y(null);const P=Math.max(...O)/j;let F=0;for(let H=0;H<4;H++){const[q,ue]=R[H],[ce,ne]=R[(H+1)%4];F+=q*ne-ce*ue}const A=t,B=Math.abs(F/2)/(A.rows*A.cols);if(P<Nw||P>Bw||B<Dw||B>Pw)return E.delete(),y(null);const V=new o.Mat;o.warpPerspective(A,V,E,new o.Size(r.width,r.height),o.WARP_INVERSE_MAP),E.delete();const K=new o.Mat;o.cvtColor(V,K,o.COLOR_RGB2GRAY),V.delete();const re=Math.trunc(r.height/2),N=K.roi(new o.Rect(0,0,r.width,re)),Z=p.gray.roi(new o.Rect(0,0,r.width,re)),U=new o.Mat;o.matchTemplate(N,Z,U,o.TM_CCOEFF_NORMED);const X=U.data32F[0];return N.delete(),Z.delete(),U.delete(),K.delete(),y(X)}function Yw(e,t,n){let r,i;if(n===vr)r=La,i=Hw;else if(n===La)r=vr,i=jw;else return null;const{x:a,y:s,w:o,h:u}=t;if(o<8||u<8)return null;const l=Math.trunc(o/2);let p=0,c=null;for(const[f,m]of[[0,l],[l,o]]){let g=0,y=0;for(let $=s;$<s+u;$++)for(let x=a+f;x<a+m;x++){const T=($*e.width+x)*e.channels,{h:S,s:k,v:E}=_t(e.data[T],e.data[T+1],e.data[T+2]);if(S>=qn&&S<=Vn&&k>=30&&k<=170&&E<=170)continue;g++,(r===La?S>=Gw&&S<=Ww&&k>=qw&&E>=Vw:S>=95&&S<=130&&k>=80)&&y++}if(g<20)continue;const b=y/g;b>p&&(p=b,c={x:a+f,y:s,w:m-f,h:u})}return p>=i&&c!==null?{id:r,box:c}:null}const Zw=1.7,Qw=140,Jw=170,e_=.2,t_=.1,hf=240,ff=80,mf=60,n_=50,gf="scientists-guild",yf="tacticians-guild",Sr=["shipowners-guild","merchants-guild","builders-guild","moneylenders-guild"];function r_(e,t,n){const{x:r,y:i,w:a,h:s}=n,o=new Float32Array(s);for(let S=0;S<s;S++){let k=0;for(let E=0;E<a;E++)e[(i+S)*t+r+E]>0&&k++;o[S]=k/a}const u=[];for(let S=0;S<s;S++)o[S]>.3&&u.push(S);if(u.length<5)return[];const l=u[0],p=u[u.length-1],c=p-l;if(c<5)return[];const f=a/c;if(f<Ew||f>Mw)return[];if(f>=Zw)return[{x:r,y:i+l,w:a,h:c}];const m=new Float32Array(s),g=.3*(8*.5-1)+.8,y=[];let b=0;for(let S=-4;S<=4;S++){const k=Math.exp(-(S*S)/(2*g*g));y.push(k),b+=k}for(let S=0;S<s;S++){let k=0;for(let E=-4;E<=4;E++){const M=Math.min(s-1,Math.max(0,S+E));k+=o[M]*y[E+4]}m[S]=k/b}const $=l+Math.trunc(c*.3),x=l+Math.trunc(c*.78);let T=l+Math.trunc(c/2);if(x>$){let S=1/0;for(let k=$;k<x;k++)m[k]<S&&(S=m[k],T=k)}return[{x:r,y:i+l,w:a,h:T-l},{x:r,y:i+T,w:a,h:p-T}]}function i_(e,t){const n=Math.max(0,t.x),r=Math.max(0,t.y),i=Math.min(e.width,t.x+t.w),a=Math.min(e.height,t.y+t.h),s=Math.max(0,i-n),o=Math.max(0,a-r),u=new Uint8Array(s*o*3);for(let l=0;l<o;l++)for(let p=0;p<s;p++){const c=((r+l)*e.width+n+p)*e.channels,f=(l*s+p)*3;u[f]=e.data[c],u[f+1]=e.data[c+1],u[f+2]=e.data[c+2]}return{width:s,height:o,channels:3,data:u}}function a_(e){let t=0,n=0;for(let r=0,i=e.width*e.height;r<i;r++){const a=r*e.channels,{h:s,s:o,v:u}=_t(e.data[a],e.data[a+1],e.data[a+2]);o>=40&&u>=40&&u<=205&&(t++,s>=Qw&&s<=Jw&&n++)}return t===0?0:n/t}function s_(e){let t=0;const n=e.width*e.height;for(let r=0;r<n;r++){const i=r*e.channels,{h:a,s,v:o}=_t(e.data[i],e.data[i+1],e.data[i+2]);!(a>=qn&&a<=Vn)&&s>=70&&o>=50&&t++}return n===0?0:t/n}function wf(e,t){const n=Ze(e,t),r=new e.Mat;e.resize(n,r,new e.Size(hf,ff),0,0,e.INTER_AREA),n.delete();const i=new Uint8Array(r.data);return r.delete(),{width:hf,height:ff,channels:3,data:i}}function o_(e){const t=e.width*e.height,n=[0,0,0];for(let a=0;a<t;a++){const s=a*e.channels;n[0]+=e.data[s],n[1]+=e.data[s+1],n[2]+=e.data[s+2]}n[0]/=t,n[1]/=t,n[2]/=t;const r=(n[0]+n[1]+n[2])/3,i=new Uint8Array(t*3);for(let a=0;a<t;a++){const s=a*e.channels;for(let o=0;o<3;o++){const u=n[o]>1e-6?r/n[o]:1;i[a*3+o]=Math.max(0,Math.min(255,Math.round(e.data[s+o]*u)))}}return{width:e.width,height:e.height,channels:3,data:i}}function _f(e,t){const n=o_(t),r=n.width*n.height,i=new Uint8Array(r);let a=0;for(let g=0;g<r;g++){const y=g*3,{h:b,s:$,v:x}=_t(n.data[y],n.data[y+1],n.data[y+2]);!(b>=qn&&b<=Vn&&$>=30&&$<=170&&x<=170)&&x>=40&&(i[g]=1,a++)}const s=a<20,o=Ze(e,n),u=new e.Mat;e.cvtColor(o,u,e.COLOR_RGB2Lab),o.delete();const l=u.data;let p=0,c=0,f=0,m=0;for(let g=0;g<r;g++)!s&&i[g]===0||(p+=l[g*3]*100/255,c+=l[g*3+1]-128,f+=l[g*3+2]-128,m++);return u.delete(),m===0?[0,0,0]:[p/m,c/m,f/m]}function u_(e){let t=0,n=0,r=0,i=0,a=0;const s=e.width*e.height;for(let u=0;u<s;u++){const l=u*e.channels,{h:p,s:c,v:f}=_t(e.data[l],e.data[l+1],e.data[l+2]);p>=qn&&p<=Vn&&c>=30&&c<=170&&f<=170||(t++,c>=70&&f>=50&&(p>=95&&p<=130?n++:p>=35&&p<=92?r++:p<=10?i++:p>=15&&p<=34&&f>=80&&a++))}const o=Math.max(t,1);return{blue:n/o,green:r/o,red:i/o,gold:a/o}}function l_(e){const t=e.width*e.height,n={blue:0,green:0,red:0,gold:0,brown:0,grey:0};for(let r=0;r<t;r++){const i=r*e.channels,{h:a,s,v:o}=_t(e.data[i],e.data[i+1],e.data[i+2]);s>=mf&&o>=n_?(a>=95&&a<=128&&n.blue++,a>=35&&a<=85&&n.green++,(a<=8||a>=170)&&n.red++,a>=18&&a<=34&&n.gold++,a>=4&&a<=17&&o<150&&n.brown++):s<mf&&o>=70&&o<=235&&n.grey++}for(const r of Object.keys(n))n[r]/=t;return n}function d_(e,t){let n=0,r=0;for(let o=0;o<e.length;o++)n+=e[o],r+=t[o];n/=e.length,r/=t.length;let i=0,a=0,s=0;for(let o=0;o<e.length;o++){const u=e[o]-n,l=t[o]-r;i+=u*l,a+=u*u,s+=l*l}return i/(Math.sqrt(a*s)+1e-6)}function bf(e,t){const n=Ze(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2GRAY),n.delete();const i=Float32Array.from(r.data);return r.delete(),i}function c_(e,t){const n=new Map,r=new Map;for(const[i,a]of t){const s=wf(e,a);n.set(i,bf(e,s)),Sr.includes(i)&&r.set(i,_f(e,s))}return{gray:n,warmLab:r}}function p_(e,t,n){const r=wf(e,t),i=u_(r);if(i.blue>=.15&&i.blue>i.red&&i.blue>2*i.gold)return vr;if(i.green>=.08&&i.green>i.blue&&i.green>i.gold)return gf;if(i.red>=.15&&i.red>i.blue&&i.red>1.5*i.gold)return yf;const a=l_(r),s={blue:a.blue,green:a.green,red:a.red,gold:a.gold,browngrey:a.brown+a.grey};let o="blue";for(const l of Object.keys(s))s[l]>s[o]&&(o=l);if(s[o]<=0)return"";let u;if(o==="blue")u=vr;else if(o==="green")u=gf;else if(o==="red")u=yf;else{const l=bf(e,r);let p="",c=-2;for(const f of Sr){const m=n.gray.get(f);if(m===void 0)continue;const g=d_(l,m);g>c&&(c=g,p=f)}u=p||Sr[0]}if(Sr.includes(u)&&n.warmLab.size>0){const l=_f(e,r);let p=u,c=1/0;for(const[f,m]of n.warmLab){const g=Math.hypot(l[0]-m[0],l[1]-m[1],l[2]-m[2]);g<c&&(c=g,p=f)}return p}return u}function h_(e,t,n,r,i){var y;const a=[],{blobs:s,mask:o,maskWidth:u}=Kw(e,t);if(s.length===0||n.size===0)return a;const l=e,p=new l.ORB(zw),c=new l.BFMatcher(l.NORM_HAMMING),f=new Map;for(const b of n.keys())f.set(b,{});const m=Ze(e,t);let g=null;try{for(const b of s){if(r!==void 0&&Date.now()>r)break;const $=b.x+Math.trunc(b.w/2),x=b.y+Math.trunc(b.h/2),T=Math.max(Fw,Math.trunc(Lw*Math.max(b.w,b.h))),S=Math.max(0,$-T),k=Math.max(0,x-T),E=Math.min(t.width,$+T),M=Math.min(t.height,x+T);if(E-S<16||M-k<16)continue;const v=m.roi(new l.Rect(S,k,E-S,M-k)),R=new l.Mat;l.cvtColor(v,R,l.COLOR_RGB2GRAY);let O=null,j=-2;for(const[B,V]of n){if(r!==void 0&&Date.now()>r)break;const K=Xw(e,v,R,V,f.get(B),p,c);K!==null&&K>j&&(j=K,O=B)}v.delete(),R.delete();const P=new Set;if(O!==null&&j>=Uw){a.push({id:O,boundingBox:{x:b.x,y:b.y,width:b.w,height:b.h},confidence:1}),P.add(O);const B=Yw(t,b,O);B&&(a.push({id:B.id,boundingBox:{x:B.box.x,y:B.box.y,width:B.box.w,height:B.box.h},confidence:.9}),P.add(B.id))}if(i===void 0||i.size===0)continue;const F=r_(o,u,b);if(F.length!==2)continue;const A=F.map(B=>i_(t,B));if(!A.some(B=>B.width*B.height===0||s_(B)<t_))for(let B=0;B<F.length;B++){const V=A[B];if(a_(V)<e_)continue;g===null&&(g=c_(e,i));const K=p_(e,V,g);if(K&&!P.has(K)){P.add(K);const re=F[B];a.push({id:K,boundingBox:{x:re.x,y:re.y,width:re.w,height:re.h},confidence:1})}}}}finally{m.delete();for(const b of f.values()){const $=b;for(const x of["gray","k","d"])try{(y=$[x])==null||y.delete()}catch{}}try{p.delete(),c.delete()}catch{}}return a}const $f=128,f_=.56,m_=15,g_=.58,y_=70,w_=50,__=.12,b_=.2,$_=.1,x_=.17,xf=.15;function v_(e){const t=new Map;for(const[n,r]of Object.entries(e.templates)){const i=Uint8Array.from(atob(r),a=>a.charCodeAt(0));i.length===e.size*e.size&&t.set(n,i)}return t}function vf(e,t){const{width:n,height:r,channels:i,data:a}=e,s=Math.floor(n/2),o=Math.floor(r/2),u=Math.trunc(Math.min(n,r)*.5*t);if(u<1)return e;const l=Math.max(0,s-u),p=Math.max(0,o-u),c=Math.min(n,s+u),f=Math.min(r,o+u),m=c-l,g=f-p,y=new Uint8Array(m*g*i);for(let b=0;b<g;b++){const $=((b+p)*n+l)*i;y.set(a.subarray($,$+m*i),b*m*i)}return{width:m,height:g,channels:i,data:y}}function S_(e){const t=vf(e,f_),n=yy(t),r=Jh(n,$f,$f);return wy(r)}function T_(e,t){const n=e.length;let r=0,i=0;for(let u=0;u<n;u++)r+=e[u],i+=t[u];r/=n,i/=n;let a=0,s=0,o=0;for(let u=0;u<n;u++){const l=e[u]-r,p=t[u]-i;a+=l*p,s+=l*l,o+=p*p}return a/(Math.sqrt(s*o)+1e-6)}function I_(e){const t=new Map([["masonry",0],["strategy",0]]),n=vf(e,g_),{width:r,height:i,channels:a,data:s}=n,o=r*i||1;let u=0,l=0;for(let f=0;f<r*i;f++){const m=f*a,{h:g,s:y,v:b}=_t(s[m],s[m+1],s[m+2]);y>=y_&&b>=w_&&(g>=95&&g<=130&&(u+=1),(g<=8||g>=170)&&(l+=1))}const p=u/o,c=l/o;return p>=__&&t.set("masonry",xf*Math.min(1,p/b_)),c>=$_&&t.set("strategy",xf*Math.min(1,c/x_)),t}function k_(e,t){if(t.size===0||e.width===0||e.height===0)return["",0];const n=S_(e);let r=0;for(const l of n.data)r+=l;const i=r/n.data.length,a=[];for(let l=0;l<360;l+=m_)a.push($y(n,l,i));const s=new Map;for(const[l,p]of t){let c=-1/0;for(const f of a){const m=T_(f,p);m>c&&(c=m)}s.set(l,c)}for(const[l,p]of I_(e))p>0&&s.has(l)&&s.set(l,s.get(l)+p);let o="",u=-1/0;for(const[l,p]of s)p>u&&(o=l,u=p);return[o,u]}const Wt=224,E_=512,M_=[.485,.456,.406],C_=[.229,.224,.225];function A_(e){const t=atob(e.x),n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);const r=new Float32Array(n.buffer);if(r.length!==e.ids.length*e.dim)throw new Error(`token_embed_index: ${r.length} floats != ${e.ids.length}x${e.dim}`);return{dim:e.dim,ids:e.ids,x:r}}function R_(e){const t=dn(e,Wt,Wt),n=Wt*Wt,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=(t[i*3+a]/255-M_[a])/C_[a];return r}function z_(e){const t=3*Wt*Wt,n=new Float32Array(4*t);for(let r=0;r<4;r++)n.set(R_(Gt(e,r)),r*t);return n}function O_(e,t=E_){const n=e.length/t,r=new Float32Array(t);for(let a=0;a<n;a++)for(let s=0;s<t;s++)r[s]+=e[a*t+s];let i=0;for(let a=0;a<t;a++)r[a]/=n,i+=r[a]*r[a];i=Math.max(Math.sqrt(i),1e-9);for(let a=0;a<t;a++)r[a]/=i;return r}function N_(e,t){let n=0,r=-2;for(let i=0;i<e.ids.length;i++){let a=0;const s=i*e.dim;for(let o=0;o<e.dim;o++)a+=e.x[s+o]*t[o];a>r&&(r=a,n=i)}return{id:e.ids[n],cosine:r}}const $n=96,B_=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"],D_=.45;function P_(e){const t=dn(e,$n,$n),n=$n*$n,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function U_(e){let t=0;for(let r=1;r<e.length;r++)e[r]>e[t]&&(t=r);const n=e[t];return{id:n>=D_?B_[t]??"":"",prob:n}}const xn=128,L_=["circus-maximus","piraeus","the-appian-way","the-colossus","the-great-library","the-great-lighthouse","the-hanging-gardens","the-mausoleum","the-pyramids","the-sphinx","the-statue-of-zeus","the-temple-of-artemis"],F_=.5,G_=.9;function W_(e){const t=dn(e,xn,xn),n=xn*xn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function q_(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8ClampedArray(t*n*r);for(let s=0;s<t;s++)for(let o=0;o<n;o++){const u=s,p=((n-1-o)*t+u)*r,c=(s*n+o)*r;for(let f=0;f<r;f++)a[c+f]=i[p+f]}return{width:n,height:t,channels:r,data:a}}function V_(e,t){let n=e;const r=(t%4+4)%4;for(let i=0;i<r;i++)n=q_(n);return n}function H_(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{index:t,prob:e[t]}}async function j_(e,t){let n=0,r=-1;for(let i=0;i<4;i++){const a=i===0?e:V_(e,i),s=await t(W_(a)),o=H_(s);o.prob>r&&(r=o.prob,n=o.index)}return{id:r>=F_?L_[n]??"":"",prob:r}}const vn=96,K_=[1,2,3,4,5,6,7],X_=.8;function Y_(e){const t=dn(e,vn,vn),n=vn*vn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function Z_(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{value:K_[t],prob:e[t]}}const Sn=128,Sf=.35,Q_=["fp","laurel"],J_=.85;function eb(e){const t=dn(e,Sn,Sn),n=Sn*Sn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function tb(e){return e[Q_.indexOf("fp")]}const nb=[{id:"merchants-guild",name:"Merchants Guild",nameFr:"Guilde des commerçants",color:"guild",age:3,victoryPoints:0,variableScoring:"merchantsGuild",cost:{clay:1,wood:1,glass:1,papyrus:1}},{id:"shipowners-guild",name:"Shipowners Guild",nameFr:"Guilde des armateurs",color:"guild",age:3,victoryPoints:0,variableScoring:"shipownersGuild",cost:{clay:2,glass:1,papyrus:1}},{id:"builders-guild",name:"Builders Guild",nameFr:"Guilde des bâtisseurs",color:"guild",age:3,victoryPoints:0,variableScoring:"buildersGuild",cost:{stone:2,clay:1,wood:1,glass:1}},{id:"magistrates-guild",name:"Magistrates Guild",nameFr:"Guilde des magistrats",color:"guild",age:3,victoryPoints:0,variableScoring:"magistratesGuild",cost:{wood:2,clay:1,papyrus:1}},{id:"scientists-guild",name:"Scientists Guild",nameFr:"Guilde des scientifiques",color:"guild",age:3,victoryPoints:0,variableScoring:"scientistsGuild",cost:{wood:2,clay:2}},{id:"tacticians-guild",name:"Tacticians Guild",nameFr:"Guilde des tacticiens",color:"guild",age:3,victoryPoints:0,variableScoring:"tacticiansGuild",cost:{stone:2,clay:1,papyrus:1}},{id:"moneylenders-guild",name:"Moneylenders Guild",nameFr:"Guilde des usuriers",color:"guild",age:3,victoryPoints:0,variableScoring:"moneylendersGuild",cost:{stone:2,wood:2}}],rb=[{id:"lumber-yard",name:"Lumber Yard",nameFr:"Chantier",color:"raw",age:1,victoryPoints:0},{id:"logging-camp",name:"Logging Camp",nameFr:"Exploitation",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"clay-pool",name:"Clay Pool",nameFr:"Bassin argileux",color:"raw",age:1,victoryPoints:0},{id:"clay-pit",name:"Clay Pit",nameFr:"Cavité",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"quarry",name:"Quarry",nameFr:"Gisement",color:"raw",age:1,victoryPoints:0},{id:"stone-pit",name:"Stone Pit",nameFr:"Mine",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"glassworks",name:"Glassworks",nameFr:"Verrerie",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"press",name:"Press",nameFr:"Presse",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"theater",name:"Theater",nameFr:"Théâtre",color:"civilian",age:1,victoryPoints:3},{id:"altar",name:"Altar",nameFr:"Autel",color:"civilian",age:1,victoryPoints:3,providesChain:"moon"},{id:"baths",name:"Baths",nameFr:"Bains",color:"civilian",age:1,victoryPoints:3,providesChain:"drop",cost:{stone:1}},{id:"pharmacist",name:"Pharmacist",nameFr:"Officine",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"mortar",providesChain:"mortar-chain",cost:{glass:2}},{id:"apothecary",name:"Apothecary",nameFr:"Apothicaire",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain",cost:{glass:1}},{id:"workshop",name:"Workshop",nameFr:"Atelier",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain",cost:{papyrus:1}},{id:"scriptorium",name:"Scriptorium",nameFr:"Scriptorium",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"inkwell",providesChain:"inkwell-chain",coinCost:2},{id:"stone-reserve",name:"Stone Reserve",nameFr:"Dépôt de pierre",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"clay-reserve",name:"Clay Reserve",nameFr:"Dépôt d'argile",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"wood-reserve",name:"Wood Reserve",nameFr:"Dépôt de bois",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"tavern",name:"Tavern",nameFr:"Taverne",color:"commercial",age:1,victoryPoints:0,providesChain:"jug"},{id:"guard-tower",name:"Guard Tower",nameFr:"Tour de garde",color:"military",age:1,victoryPoints:0,shields:1},{id:"stable",name:"Stable",nameFr:"Écuries",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"horseshoe",cost:{wood:1}},{id:"garrison",name:"Garrison",nameFr:"Caserne",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"sword",cost:{clay:1}},{id:"palisade",name:"Palisade",nameFr:"Palissade",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"tower",coinCost:2}],ib=[{id:"sawmill",name:"Sawmill",nameFr:"Scierie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"brickyard",name:"Brickyard",nameFr:"Briqueterie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"shelf-quarry",name:"Shelf Quarry",nameFr:"Carrière",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"glass-blower",name:"Glass-Blower",nameFr:"Soufflerie",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"drying-room",name:"Drying Room",nameFr:"Séchoir",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"courthouse",name:"Courthouse",nameFr:"Tribunal",color:"civilian",age:2,victoryPoints:5,cost:{wood:2,glass:1}},{id:"statue",name:"Statue",nameFr:"Statue",color:"civilian",age:2,victoryPoints:4,providesChain:"column",chainFrom:"moon",cost:{clay:2}},{id:"temple",name:"Temple",nameFr:"Temple",color:"civilian",age:2,victoryPoints:4,providesChain:"sun",chainFrom:"drop",cost:{wood:1,papyrus:1}},{id:"aqueduct",name:"Aqueduct",nameFr:"Aqueduc",color:"civilian",age:2,victoryPoints:5,cost:{stone:3}},{id:"rostrum",name:"Rostrum",nameFr:"Rostres",color:"civilian",age:2,victoryPoints:4,providesChain:"horseshoe",cost:{stone:1,wood:1}},{id:"school",name:"School",nameFr:"École",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain-2",cost:{wood:1,papyrus:2}},{id:"laboratory",name:"Laboratory",nameFr:"Laboratoire",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain-2",cost:{wood:1,glass:2}},{id:"library",name:"Library",nameFr:"Bibliothèque",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"inkwell",chainFrom:"inkwell-chain",cost:{stone:1,wood:1,glass:1}},{id:"dispensary",name:"Dispensary",nameFr:"Dispensaire",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"mortar",chainFrom:"mortar-chain",cost:{clay:2,stone:1}},{id:"forum",name:"Forum",nameFr:"Forum",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel",coinCost:3,cost:{clay:1}},{id:"caravansery",name:"Caravansery",nameFr:"Caravansérail",color:"commercial",age:2,victoryPoints:0,coinCost:2,cost:{glass:1,papyrus:1}},{id:"customs-house",name:"Customs House",nameFr:"Douanes",color:"commercial",age:2,victoryPoints:0,coinCost:4},{id:"brewery",name:"Brewery",nameFr:"Brasserie",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel-2"},{id:"horse-breeders",name:"Horse Breeders",nameFr:"Haras",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"horseshoe",cost:{clay:1,wood:1}},{id:"barracks",name:"Barracks",nameFr:"Baraquements",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"sword",coinCost:3},{id:"archery-range",name:"Archery Range",nameFr:"Champ de tir",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"target",cost:{stone:1,wood:1,papyrus:1}},{id:"parade-ground",name:"Parade Ground",nameFr:"Place d'armes",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"mask",cost:{clay:2,glass:1}},{id:"walls",name:"Walls",nameFr:"Muraille",color:"military",age:2,victoryPoints:0,shields:2,cost:{stone:2}}],ab=[{id:"pantheon",name:"Pantheon",nameFr:"Panthéon",color:"civilian",age:3,victoryPoints:6,chainFrom:"sun",cost:{clay:1,wood:1,papyrus:2}},{id:"gardens",name:"Gardens",nameFr:"Jardins",color:"civilian",age:3,victoryPoints:6,chainFrom:"column",cost:{clay:2,wood:2}},{id:"town-hall",name:"Town Hall",nameFr:"Hôtel de ville",color:"civilian",age:3,victoryPoints:7,cost:{stone:3,wood:2}},{id:"palace",name:"Palace",nameFr:"Palace",color:"civilian",age:3,victoryPoints:7,cost:{clay:1,stone:1,wood:1,glass:2}},{id:"senate",name:"Senate",nameFr:"Sénat",color:"civilian",age:3,victoryPoints:5,chainFrom:"horseshoe",cost:{clay:2,stone:1,papyrus:1}},{id:"obelisk",name:"Obelisk",nameFr:"Obélisque",color:"civilian",age:3,victoryPoints:5,cost:{stone:2,glass:1}},{id:"academy",name:"Academy",nameFr:"Académie",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{stone:1,wood:1,glass:2}},{id:"study",name:"Study",nameFr:"Étude",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{wood:2,glass:1,papyrus:1}},{id:"university",name:"University",nameFr:"Université",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"wheel-chain-2",cost:{clay:1,glass:1,papyrus:1}},{id:"observatory",name:"Observatory",nameFr:"Observatoire",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"pendulum-chain-2",cost:{stone:1,papyrus:2}},{id:"chamber-of-commerce",name:"Chamber of Commerce",nameFr:"Chambre de commerce",color:"commercial",age:3,victoryPoints:3,variableScoring:"chamberOfCommerce",cost:{papyrus:2}},{id:"port",name:"Port",nameFr:"Port",color:"commercial",age:3,victoryPoints:3,variableScoring:"port",cost:{wood:1,glass:1,papyrus:1}},{id:"armory",name:"Armory",nameFr:"Armurerie",color:"commercial",age:3,victoryPoints:3,variableScoring:"armory",cost:{stone:2,glass:1}},{id:"lighthouse",name:"Lighthouse",nameFr:"Phare",color:"commercial",age:3,victoryPoints:3,variableScoring:"lighthouse",chainFrom:"jug",cost:{clay:2,glass:1}},{id:"arena",name:"Arena",nameFr:"Arène",color:"commercial",age:3,victoryPoints:3,variableScoring:"arena",chainFrom:"barrel-2",cost:{clay:1,stone:1,wood:1}},{id:"pretorium",name:"Pretorium",nameFr:"Prétoire",color:"military",age:3,victoryPoints:0,shields:3,coinCost:8},{id:"arsenal",name:"Arsenal",nameFr:"Arsenal",color:"military",age:3,victoryPoints:0,shields:3,cost:{clay:3,wood:2}},{id:"fortifications",name:"Fortifications",nameFr:"Fortifications",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"tower",cost:{stone:2,clay:1,papyrus:1}},{id:"siege-workshop",name:"Siege Workshop",nameFr:"Atelier de siège",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"target",cost:{wood:3,glass:1}},{id:"circus",name:"Circus",nameFr:"Cirque",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"mask",cost:{clay:2,stone:2}}],sb=[...rb,...ib,...ab,...nb];Object.fromEntries(sb.map(e=>[e.id,e]));const ob=Object.fromEntries([{id:"the-appian-way",name:"The Appian Way",nameFr:"La Via Appia",victoryPoints:3,description:"The opponent loses 3 coins. Take another turn. Once built, repeated discards are not affected. Worth 3 victory points."},{id:"circus-maximus",name:"Circus Maximus",nameFr:"Le Circus Maximus",victoryPoints:3,shields:1,description:"Destroy one grey (manufactured) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-colossus",name:"The Colossus",nameFr:"Le Colosse",victoryPoints:3,shields:2,description:"Provides 2 shields. Worth 3 victory points."},{id:"the-great-library",name:"The Great Library",nameFr:"La Grande Bibliothèque",victoryPoints:4,description:"Randomly draw 3 of the Progress tokens discarded at game setup and keep one. Worth 4 victory points."},{id:"the-great-lighthouse",name:"The Great Lighthouse",nameFr:"Le Grand Phare",victoryPoints:4,description:"Once built, the owner may take any raw or manufactured good of choice each turn (production effect). Worth 4 victory points."},{id:"the-hanging-gardens",name:"The Hanging Gardens",nameFr:"Les Jardins Suspendus",victoryPoints:3,description:"Gain 6 coins. Take another turn. Worth 3 victory points."},{id:"the-mausoleum",name:"The Mausoleum",nameFr:"Le Mausolée",victoryPoints:2,description:"Build, for free, any one card from the discard pile. Worth 2 victory points."},{id:"piraeus",name:"Piraeus",nameFr:"Le Pirée",victoryPoints:2,description:"Once built, the owner may take any one manufactured good (glass or papyrus) of choice each turn. Take another turn. Worth 2 victory points."},{id:"the-pyramids",name:"The Pyramids",nameFr:"Les Pyramides",victoryPoints:9,description:"Worth 9 victory points."},{id:"the-sphinx",name:"The Sphinx",nameFr:"Le Sphinx",victoryPoints:6,description:"Take another turn. Worth 6 victory points."},{id:"the-statue-of-zeus",name:"The Statue of Zeus",nameFr:"La Statue de Zeus",victoryPoints:3,shields:1,description:"Destroy one brown (raw) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-temple-of-artemis",name:"The Temple of Artemis",nameFr:"Le Temple d'Artémis",victoryPoints:0,description:"Gain 12 coins. Take another turn. Worth 0 victory points."}].map(e=>[e.id,e]));Object.fromEntries([{id:"agriculture",name:"Agriculture",nameFr:"Agriculture",victoryPoints:4,description:"Gain 6 coins immediately. Worth 4 victory points at game end."},{id:"architecture",name:"Architecture",nameFr:"Architecture",description:"Any future Wonder constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"economy",name:"Economy",nameFr:"Économie",description:"When the opponent uses the trading-cost coins (pays the bank to buy goods), the owner receives those coins instead."},{id:"law",name:"Law",nameFr:"Loi",variableScoring:"law",description:"Grants one science symbol, counting toward the six-symbol scientific victory and toward pairs of identical symbols."},{id:"masonry",name:"Masonry",nameFr:"Maçonnerie",description:"Any future blue (civilian) building constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"mathematics",name:"Mathematics",nameFr:"Mathématiques",variableScoring:"mathematics",description:"Worth 3 victory points at game end for EACH Progress token the owner possesses (including this one)."},{id:"philosophy",name:"Philosophy",nameFr:"Philosophie",victoryPoints:7,description:"Worth 7 victory points at game end."},{id:"strategy",name:"Strategy",nameFr:"Stratégie",description:"Whenever the owner builds a red (military) building, it provides 1 additional shield."},{id:"theology",name:"Theology",nameFr:"Théologie",description:"Every future Wonder built by the owner grants an extra turn."},{id:"urbanism",name:"Urbanism",nameFr:"Urbanisme",description:"Gain 6 coins immediately. When the owner builds a card for free via a chain link, they also gain 4 coins."}].map(e=>[e.id,e]));const Ne="/7wd-scorer/models/";let Tf=!1;const Tr=new Map;function If(){var e;Tf||(Ce.wasm.wasmPaths="/7wd-scorer/ort/",Ce.wasm.numThreads=globalThis.crossOriginIsolated?Math.max(1,(((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??4)-2):1,Tf=!0)}const Fa=new Set;function ub(e){If();let t=Tr.get(e);return t===void 0&&(t=it.create(`${Ne}${St[e].onnx}`,{executionProviders:Fa.has(e)?["wasm"]:["webgpu","wasm"]}),Tr.set(e,t),t.catch(()=>Tr.delete(e))),t}let Ga=null,Wa=null;const lb=.75,db=4,cb=.65,pb=3e4;let qa=null;function Va(){return qa===null&&(qa=(async()=>{try{let e;return self.importScripts("/7wd-scorer/opencv/opencv.js"),e=self.cv,typeof(e==null?void 0:e.then)=="function"&&(e=await e),typeof(e==null?void 0:e.getBuildInformation)!="function"&&(e=await new Promise(t=>{e.onRuntimeInitialized=()=>t(e)})),e}catch(e){return console.warn("[wonders-reg] opencv.js load failed:",e),null}})()),qa}const kf=new Map;function Ha(e){let t=kf.get(e);return t===void 0&&(t=(async()=>{try{const n=await fetch(`${Ne}${e}`);if(!n.ok)return null;const r=await createImageBitmap(await n.blob()),a=new OffscreenCanvas(r.width,r.height).getContext("2d");a.drawImage(r,0,0);const s=a.getImageData(0,0,r.width,r.height);return{width:r.width,height:r.height,channels:4,data:new Uint8Array(s.data.buffer)}}catch{return null}})(),kf.set(e,t)),t}function ja(e){return Ha(`wonder-refs/${e}.jpg`)}const Ef=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"];async function hb(){const e=new Map;for(const t of Ef){const n=await Ha(`guild-refs/${t}.jpg`);n!==null&&e.set(t,n)}return e}async function fb(){const e=new Map;for(const t of Ef){const n=await Ha(`guild-band-refs/${t}.png`);n!==null&&e.set(t,n)}return e}const mb=.6,gb=12,yb=45e3;let Ka=null;function Mf(){return Ka===null&&(If(),Ka=(async()=>{try{const[e,t,n,r]=await Promise.all([it.create(`${Ne}ocr/ch_PP-OCRv4_det_infer.onnx`,{executionProviders:["webgpu","wasm"]}),it.create(`${Ne}ocr/ch_PP-OCRv4_rec_infer.onnx`,{executionProviders:["webgpu","wasm"]}),fetch(`${Ne}ocr_charset.json`).then(i=>i.ok?i.json():null),fetch(`${Ne}wonder_names.json`).then(i=>i.ok?i.json():null)]);return n===null||r===null?(console.warn("[wonders-ocr] charset/names asset missing"),null):{det:e,rec:t,charset:ew(n),catalog:r.entries}}catch(e){return console.warn("[wonders-ocr] bundle load failed:",e),null}})()),Ka}async function wb(e,t){const n=Math.max(Jy/Ot,t.width/t.height),{tensor:r,width:i}=nw(t,n),a={[e.rec.inputNames[0]]:new Ue("float32",r,[1,3,Ot,i])},s=(await e.rec.run(a))[e.rec.outputNames[0]],[o,u,l]=s.dims,p=s.data,c=new Array(u),f=new Array(u);for(let m=0;m<u;m++){let g=0,y=-1/0;const b=m*l;for(let $=0;$<l;$++){const x=p[b+$];x>y&&(y=x,g=$)}c[m]=g,f[m]=y}return tw(c,f,e.charset)}async function _b(e,t){const n=await Mf();if(n===null)return{wonders:[],aborted:!1};const r=new Map,i=Date.now()+yb;let a=!1;e:for(const s of[0,1,2,3]){if(Date.now()>i){a=!0;break}t(`wonder names: rotation ${s*90}°…`,s/4);const o=Gt(e,s),u=Wy(o),l={[n.det.inputNames[0]]:new Ue("float32",u.tensor,[1,3,u.height,u.width])},p=(await n.det.run(l))[n.det.outputNames[0]],c=Xy(p.data,u,o.width,o.height).slice(0,gb);console.debug(`[wonders-ocr] rot ${s*90}: ${c.length} det boxes`,c.slice(0,5).map(f=>`${f.width}x${f.height}@${f.score.toFixed(2)}`));for(const f of c){if(Date.now()>i){a=!0;break e}const m=Yy(o,f.quad);if(m.width<m.height*1.5)continue;const[g,y]=await wb(n,m);if(console.debug(`[wonders-ocr] rec "${g}" @${y.toFixed(2)}`),y<mb||g.trim().length<db)continue;const b=lw(g,n.catalog);if(console.debug("[wonders-ocr] fuzzy",b),b===null||b.confidence<lb||b.kind!=="wonder")continue;const $=r.get(b.id);($===void 0||b.confidence>$.confidence)&&r.set(b.id,{id:b.id,name:b.name,confidence:b.confidence,nameBox:Cf(f,s,e.width,e.height)})}}return{wonders:[...r.values()],aborted:a}}function Cf(e,t,n,r){const i=(t%4+4)%4;if(i===0)return{x:e.x,y:e.y,width:e.width,height:e.height};const a=(c,f)=>i===1?[f,r-1-c]:i===2?[n-1-c,r-1-f]:[n-1-f,c],s=[a(e.x,e.y),a(e.x+e.width,e.y+e.height)],o=s.map(c=>c[0]),u=s.map(c=>c[1]),l=Math.min(...o),p=Math.min(...u);return{x:l,y:p,width:Math.max(...o)-l,height:Math.max(...u)-p}}function bb(){return Wa===null&&(Wa=fetch(`${Ne}laurel_gallery.json`).then(async e=>e.ok?Ay(await e.json()):[]).catch(()=>[])),Wa}function $b(e,t,n,r){return Ir(e,t-r,n-r,2*r,2*r)}function Ir(e,t,n,r,i){const a=Math.max(0,Math.round(t)),s=Math.max(0,Math.round(n)),o=Math.min(e.width,Math.round(t+r)),u=Math.min(e.height,Math.round(n+i)),l=Math.max(0,o-a),p=Math.max(0,u-s),c=new Uint8Array(l*p*3);for(let f=0;f<p;f++)for(let m=0;m<l;m++){const g=((f+s)*e.width+(m+a))*e.channels,y=(f*l+m)*3;c[y]=e.data[g],c[y+1]=e.data[g+1],c[y+2]=e.data[g+2]}return{width:l,height:p,channels:3,data:c}}function xb(){return Ga===null&&(Ga=fetch(`${Ne}token_templates.json`).then(async e=>e.ok?v_(await e.json()):new Map).catch(()=>new Map)),Ga}let Xa=null;function vb(){return Xa===null&&(Xa=(async()=>{try{const e=await fetch(`${Ne}token_embed_index.json`);if(!e.ok)return null;const t=A_(await e.json());return{session:await it.create(`${Ne}token_embed.onnx`,{executionProviders:["wasm"]}),index:t}}catch{return null}})()),Xa}const Sb=.92;let Ya=null;function Tb(){return Ya===null&&(Ya=(async()=>{try{return(await fetch(`${Ne}guild_classifier.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}guild_classifier.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),Ya}let Za=null;function Ib(){return Za===null&&(Za=(async()=>{try{return(await fetch(`${Ne}laurel_digit.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}laurel_digit.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),Za}let Qa=null;function kb(){return Qa===null&&(Qa=(async()=>{try{return(await fetch(`${Ne}laurel_filter.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}laurel_filter.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),Qa}async function Eb(e,t,n){const[r,i,a,s]=t,o=a-r,u=s-i;if(o<=0||u<=0)return null;const l=Math.trunc(Sf*o),p=Math.trunc(Sf*u),c=Math.max(0,r-l),f=Math.max(0,i-p),m=Math.min(e.width,a+l),g=Math.min(e.height,s+p),y=Ir(e,c,f,m-c,g-f);if(y.width<=0||y.height<=0)return null;try{const b=eb(y),$=await n.run({[n.inputNames[0]]:new Ue("float32",b,[1,3,Sn,Sn])});return tb($[n.outputNames[0]].data)}catch{return null}}let Ja=null;function Af(){return Ja===null&&(Ja=(async()=>{try{return(await fetch(`${Ne}tuck_classifier.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}tuck_classifier.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),Ja}const Rf=.2,Mb=.3,zf=.25,Cb=.1;let es=null;function Ab(){return es===null&&(es=(async()=>{try{return(await fetch(`${Ne}track_band.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}track_band.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),es}let ts=null;function Rb(e,t,n){if(t.height<=0)return!1;const r=t.width/t.height;if(Math.abs(Math.log(r))<=zf)return!1;const i=e.x+e.width,a=e.y+e.height;for(const s of n){const o=s.box;if(!o||o.length<4||o[3]<=0)continue;const u=o[0]+o[2]/2,l=o[1]+o[3]/2;if(!(u>=e.x&&u<=i&&l>=e.y&&l<=a))continue;const p=o[2]/o[3];if(!(Math.abs(Math.log(p))<=zf)&&r>1==p>1)return!0}return!1}const zb=.4;function Ob(e,t){const n=Math.min(e.x+e.width,t.x+t.width)-Math.max(e.x,t.x),r=Math.min(e.y+e.height,t.y+t.height)-Math.max(e.y,t.y);if(n<=0||r<=0)return 0;const i=e.width*e.height;return i>0?n*r/i:0}function Nb(e,t){const n=[],r=[];for(const i of t){if(!i.builtWithCardUnderneath)continue;i.boundingBox&&n.push(i.boundingBox);const a=i.tuckRegion;a&&r.push(a)}return n.length===0&&r.length===0?e:e.filter(i=>{const a=i.boundingBox;if(!a)return!0;const s=a.x+a.width/2,o=a.y+a.height/2;for(const u of n)if(s>=u.x&&s<=u.x+u.width&&o>=u.y&&o<=u.y+u.height||Ob(a,u)>=zb)return!1;for(const u of r)if(s>=u.x&&s<=u.x+u.width&&o>=u.y&&o<=u.y+u.height)return!1;return!0})}function Bb(){return ts===null&&(ts=(async()=>{try{return(await fetch(`${Ne}tuck_box.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}tuck_box.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),ts}async function Db(e,t,n){const[r,i,a,s]=t;if(a<=0||s<=0)return null;const o=Math.round(a*Rf),u=Math.round(s*Rf),l=Math.max(0,Math.round(r-o)),p=Math.max(0,Math.round(i-u)),c=Math.min(e.width,Math.round(r+a+o)),f=Math.min(e.height,Math.round(i+s+u)),m=c-l,g=f-p;if(m<=0||g<=0)return null;const y=e.channels,b=new Uint8ClampedArray(m*g*y);for(let T=0;T<g;T++){const S=((p+T)*e.width+l)*y;b.set(e.data.subarray(S,S+m*y),T*m*y)}const $={width:m,height:g,channels:y,data:b};let x=null;for(let T=0;T<4;T++){const S=T===0?$:Gt($,T),k=S.width,E=k-Math.floor(Mb*k),M=k-E;if(M<=0)continue;const v=new Uint8ClampedArray(M*S.height*S.channels);for(let F=0;F<S.height;F++){const A=(F*k+E)*S.channels;v.set(S.data.subarray(A,A+M*S.channels),F*M*S.channels)}const R={width:M,height:S.height,channels:S.channels,data:v},O=Ua(R),P=(await n.run({[n.inputNames[0]]:new Ue("float32",O,[1,3,Tt,Tt])}))[n.outputNames[0]].data[1]??0;x=x===null?P:Math.max(x,P)}return x}let ns=null;function Pb(){return ns===null&&(ns=(async()=>{try{return(await fetch(`${Ne}wonder_classifier.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}wonder_classifier.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),ns}async function Ub(e,t,n,r,i,a){var f;const s=(m,g,y,b)=>{const $=Math.max(0,Math.round(m)),x=Math.max(0,Math.round(g)),T=Math.min(t.width,Math.round(m+y)),S=Math.min(t.height,Math.round(g+b)),k=T-$,E=S-x;if(k<=0||E<=0)return null;const M=t.channels,v=new Uint8ClampedArray(k*E*M);for(let R=0;R<E;R++){const O=((x+R)*t.width+$)*M;v.set(t.data.subarray(O,O+k*M),R*k*M)}return{width:k,height:E,channels:M,data:v}},o=async m=>(await r.run({[r.inputNames[0]]:new Ue("float32",m,[1,3,xn,xn])}))[r.outputNames[0]].data,u=new Map;for(const m of n){const[g,y,b,$]=m;if(b<=0||$<=0)continue;const x=s(g,y,b,$);if(x===null)continue;const{id:T,prob:S}=await j_(x,o);if(T===""||S<G_)continue;const k=u.get(T);(k===void 0||S>k.prob)&&u.set(T,{prob:S,box:m})}const l=[],p=await Af(),c=await Bb();for(const[m,{prob:g,box:y}]of u){const[b,$,x,T]=y;let S={x:Math.round(b),y:Math.round($),width:Math.round(x),height:Math.round(T)},k=null,E=[],M=null;if(Date.now()<i)try{const B=await ja(m);if(B!==null){const V=cf(e,t,B,y);if(V!==null){k=V.footprint,E=V.overflow;const K=k.map(U=>U[0]),re=k.map(U=>U[1]),N=Math.max(0,Math.round(Math.min(...K))),Z=Math.max(0,Math.round(Math.min(...re)));if(S={x:N,y:Z,width:Math.min(t.width,Math.round(Math.max(...K)))-N,height:Math.min(t.height,Math.round(Math.max(...re)))-Z},p!==null)try{const U=df(e,t,B,k);if(U!==null){const X=Ua(U),H=await p.run({[p.inputNames[0]]:new Ue("float32",X,[1,3,Tt,Tt])});M=pf(H[p.outputNames[0]].data).prob}}catch{}}}}catch(B){console.warn(`[wonders-cls] ${m} registration failed:`,B)}const v=k!==null?Da(k,E):null,R=[];if(M!==null&&R.push(M>=Pa?1:0),c!==null)try{const B=await Db(t,y,c);B!==null&&R.push(B>=Pa?1:0)}catch{}const O=v??S,j=a.some(B=>{const V=B.box[0]+B.box[2]/2,K=B.box[1]+B.box[3]/2;return V>=O.x&&V<=O.x+O.width&&K>=O.y&&K<=O.y+O.height});R.push(j?1:0);let P=R.length>0&&R.reduce((B,V)=>B+V,0)*2>R.length;P&&Rb(O,S,a)&&(P=!1);const F={id:m,name:((f=ob[m])==null?void 0:f.name)??m,builtWithCardUnderneath:P,boundingBox:S,confidence:Math.round(g*1e4)/1e4,...v?{tuckRegion:v}:{}},A=v??S;l.push({obj:F,edgeScores:null,zone:{x0:A.x,y0:A.y,x1:A.x+A.width,y1:A.y+A.height}})}return l}async function Lb(e,t){const n=await vb();if(n!==null)try{const r=z_(e),i=new Ue("float32",r,[4,3,Wt,Wt]),s=(await n.session.run({image:i}))[n.session.outputNames[0]].data,{id:o,cosine:u}=N_(n.index,O_(s));return u<Sb?["",-1]:[o,u]}catch{}return k_(e,t)}async function rs(e){const t=await createImageBitmap(e);try{const r=new OffscreenCanvas(t.width,t.height).getContext("2d",{willReadFrequently:!0});if(r===null)throw new Error("OffscreenCanvas 2D context unavailable.");r.drawImage(t,0,0);const{data:i}=r.getImageData(0,0,t.width,t.height);return{width:t.width,height:t.height,channels:4,data:i}}finally{t.close()}}async function qt(e,t){const n=St[e],{tensor:r,params:i}=Fh(t,n.input),a=async()=>{const s=await ub(e),o={[s.inputNames[0]]:new Ue("float32",r,[1,3,n.input,n.input])};return{rows:(await s.run(o))[s.outputNames[0]].data,params:i}};try{return await a()}catch(s){if(Fa.has(e))throw s;return Fa.add(e),Tr.delete(e),await a()}}const Fb=6,Gb=2,Wb=5,qb=2;async function Vb(e){const t={kind:"unknown",confidence:0,banners:null,laurels:null,coins:null,pawnFound:!1},n=await rs(e),r=await qt("banner",n),i=Kh(r.rows,r.params,St.banner.conf);if(t.banners=i.length,i.length>=Fb)return{...t,kind:"player",confidence:Math.min(1,i.length/12)};const a=await qt("laurel",n),s=Ta(a.rows,a.params,St.laurel.conf);if(t.laurels=s.length,s.length>=Gb)return{...t,kind:"player",confidence:Math.min(1,s.length/8)};const o=await qt("coin",n),u=Hh(o.rows,o.params,St.coin.conf);return t.coins=u.length,u.length>=Wb?{...t,kind:"player",confidence:.5}:t.banners!==null&&t.banners<=qb?{...t,kind:"board",confidence:.4}:t}function Hb(){return{wonders:[],guilds:[],progressTokens:[],laurels:[],cardVictoryPoints:{value:0,laurelsKept:0,laurelsUnread:0,complete:!0},cardCounts:{byFamily:{},source:"none",tuckedExcluded:0},coins:{total:0,confidence:0,source:"none",coins:[]}}}async function jb(e,t,n,r,i=()=>{}){const a={},s=[],o=[],u=[],l=[],p=[],c=[];let f=0,m=0,g=0,y=0,b=0;for(const S of e){b+=1;const k=`${t} photo ${b}/${e.length}`;r(`${k}: reading pixels…`,.01);const E=await rs(S);r(`${k}: card banners…`,.04);const M=await qt("banner",E),v=Kh(M.rows,M.params,St.banner.conf);r(`${k}: progress tokens…`,.08);let R=[];const O=await Ab();if(O!==null)try{const G=Fh(E,1280),Q=await O.run({[O.inputNames[0]]:new Ue("float32",G.tensor,[1,3,1280,1280])});R=Ta(Q[O.outputNames[0]].data,G.params,Cb)}catch{}const j=await qt("token",E),P=await xb(),F=[];for(const G of K0(j.rows,j.params,St.token.conf)){if(F.push({cx:G.cx,cy:G.cy,r:G.r}),R.some(([oe,le,Ee,Ie])=>G.cx>=oe&&G.cx<=Ee&&G.cy>=le&&G.cy<=Ie))continue;const[Q,ee]=await Lb(Qh(E,G),P);Q===""&&ee<0?F.pop():Q===""?m+=1:u.some(oe=>oe.id===Q)||u.push({id:Q,center:[G.cx,G.cy],radius:G.r,confidence:Math.round(ee*1e4)/1e4})}r(`${k}: coins…`,.14);const A=await qt("coin",E),B=Hh(A.rows,A.params,St.coin.conf).filter(G=>!F.some(Q=>(G.cx-Q.cx)**2+(G.cy-Q.cy)**2<=G.r*G.r)),V=gy(E,B),K=[];if(B.forEach((G,Q)=>{const ee=V[Q];f+=ee,K.push({denomination:ee,center:[G.cx,G.cy],radius:G.r,denomSource:"colour"})}),K.length>=2){const G=K.map(ee=>ee.radius).sort((ee,oe)=>ee-oe),Q=G.length%2===1?G[(G.length-1)/2]:(G[G.length/2-1]+G[G.length/2])/2;if(Q>0)for(const ee of K)ee.radius/Q>2&&(ee.suspect=!0,ee.suspectReason=`radius ${ee.radius}px is ${(ee.radius/Q).toFixed(1)}x the photo's median coin radius — probably not a coin`)}o.push(...K);const re=[],N=Date.now()+pb;let Z=null,U=null;const X=()=>(U===null&&(U=(async()=>{try{const{rows:G,params:Q}=await qt("wonder",E);return Gh(G,Q,St.wonder.conf,1).map(ee=>ee.box)}catch{return[]}})()),U),H=[];let q=!1;const ue=await Pb();if(ue!==null){const G=await X();if(G.length>0&&(Z=await Va(),Z!==null)){r(`${k}: identifying wonders…`,.35);const Q=await Ub(Z,E,G,ue,N,v);for(const ee of Q)l.some(oe=>oe.id===ee.obj.id)||(l.push(ee.obj),H.push({obj:ee.obj,edgeScores:ee.edgeScores,zone:ee.zone}),re.push(ee.zone));q=Q.length>0}}q||r(`${k}: wonder names…`,.2);const ce=q?{wonders:[],aborted:!1}:await _b(E,(G,Q)=>r(`${k}: ${G}`,.2+.35*(Q??0)));Z===null&&(Z=ce.wonders.length>0?await Va():null);for(const G of ce.wonders){let Q=null;if(Z!==null&&Date.now()<N){r(`${k}: registering ${G.name}…`,.6);try{const ee=await ja(G.id);if(ee!==null){let oe=$w(Z,E,ee,[[G.nameBox.x,G.nameBox.y],[G.nameBox.x+G.nameBox.width,G.nameBox.y],[G.nameBox.x+G.nameBox.width,G.nameBox.y+G.nameBox.height],[G.nameBox.x,G.nameBox.y+G.nameBox.height]]);if(oe===null){const le=await X(),Ee=Sw(le,G.nameBox.x+G.nameBox.width/2,G.nameBox.y+G.nameBox.height/2);Ee!==null&&(oe=cf(Z,E,ee,Ee))}if(oe!==null){let le=oe.built,Ee=!1;const Ie=await Af();if(Ie!==null)try{const ke=df(Z,E,ee,oe.footprint);if(ke!==null){const et=Ua(ke),qe=await Ie.run({[Ie.inputNames[0]]:new Ue("float32",et,[1,3,Tt,Tt])});le=pf(qe[Ie.outputNames[0]].data).built,Ee=!0}}catch{}const Re=oe.footprint.map(ke=>ke[0]),Ke=oe.footprint.map(ke=>ke[1]),ze=Math.max(0,Math.round(Math.min(...Re))),Xe=Math.max(0,Math.round(Math.min(...Ke)));Q={built:le,boundingBox:{x:ze,y:Xe,width:Math.min(E.width,Math.round(Math.max(...Re)))-ze,height:Math.min(E.height,Math.round(Math.max(...Ke)))-Xe},tuckRegion:Da(oe.footprint,oe.overflow),edgeScores:oe.edgeScores,builtByTuck:Ee}}}}catch(ee){console.warn(`[wonders-reg] ${G.id} failed:`,ee)}}if(Q!==null){const ee=Q.tuckRegion??Q.boundingBox;re.push({x0:ee.x,y0:ee.y,x1:ee.x+ee.width,y1:ee.y+ee.height})}else{const ee=Math.max(8,G.nameBox.height),oe=Math.round(G.nameBox.width*.15);re.push({x0:G.nameBox.x-oe,y0:G.nameBox.y-ee*2.5,x1:G.nameBox.x+G.nameBox.width+oe,y1:G.nameBox.y+G.nameBox.height+ee*2.5})}if(!l.some(ee=>ee.id===G.id)){const ee=(Q==null?void 0:Q.builtByTuck)===!0,oe=ee?Q.built:!1,le=!ee&&(Q==null?void 0:Q.built)===!0,Ee={id:G.id,name:G.name,builtWithCardUnderneath:oe,boundingBox:(Q==null?void 0:Q.boundingBox)??{x:0,y:0,width:0,height:0},...Q!=null&&Q.tuckRegion?{tuckRegion:Q.tuckRegion}:{},confidence:G.confidence,...le?{suspect:!0,suspectReason:"built-unconfirmed"}:{}};l.push(Ee),H.push({obj:Ee,edgeScores:Q&&!Q.builtByTuck?Q.edgeScores:null,zone:re[re.length-1]})}}if(!q){const G=kw(H.map(Q=>({built:Q.obj.builtWithCardUnderneath,edgeScores:Q.edgeScores,zone:Q.zone})),v.map(Q=>[Q.box[0]+Q.box[2]/2,Q.box[1]+Q.box[3]/2]));for(const Q of G){const ee=H[Q];ee.obj.builtWithCardUnderneath=!1,n.push({code:"INCONSISTENT_STATE",message:`${t}: wonder '${ee.obj.id}' was NOT marked built — the card-under-wonder signal saturated on this surface and no tucked card banner supports it. Tick it in the review if it really was built.`})}if(v.length>0){const Q=new Set(G);for(let ee=0;ee<H.length;ee++){const oe=H[ee];if(Q.has(ee)||!oe.obj.builtWithCardUnderneath)continue;const le=oe.obj.tuckRegion;if(le===void 0)continue;if(!v.some(Ie=>{const Re=Ie.box[0]+Ie.box[2]/2,Ke=Ie.box[1]+Ie.box[3]/2;return Re>=le.x&&Re<=le.x+le.width&&Ke>=le.y&&Ke<=le.y+le.height})){const Ie=oe.obj;Ie.builtWithCardUnderneath=!1,Ie.suspect=!0,Ie.suspectReason="built-unconfirmed"}}}}if(ce.aborted&&n.push({code:"LOW_CONFIDENCE",message:`${k}: the wonder-name read ran out of its time budget on this device — ${ce.wonders.length} wonder(s) read before the cutoff; check the built-wonders list.`}),Z!==null&&ce.wonders.length>0&&Date.now()<N)try{const G=await Mf(),Q=(G==null?void 0:G.catalog.filter(oe=>oe.kind==="wonder").map(oe=>oe.id))??[],ee=new Map;for(const oe of Q)if(!l.some(le=>le.id===oe)){const le=await ja(oe);le!==null&&ee.set(oe,le)}if(ee.size>0){r(`${k}: searching occluded wonders…`,.7);const oe=bw(Z,E,ee,N);for(const le of oe){const Ee=le.footprint.map(qe=>qe[0]),Ie=le.footprint.map(qe=>qe[1]),Re=Math.max(0,Math.round(Math.min(...Ee))),Ke=Math.max(0,Math.round(Math.min(...Ie))),ze={x:Re,y:Ke,width:Math.min(E.width,Math.round(Math.max(...Ee)))-Re,height:Math.min(E.height,Math.round(Math.max(...Ie)))-Ke};if(l.some(qe=>{const Qe=qe.boundingBox,Be=Math.max(0,Math.min(Qe.x+Qe.width,ze.x+ze.width)-Math.max(Qe.x,ze.x)),Ye=Math.max(0,Math.min(Qe.y+Qe.height,ze.y+ze.height)-Math.max(Qe.y,ze.y)),tt=Be*Ye,dt=Qe.width*Qe.height+ze.width*ze.height-tt;return dt>0&&tt/dt>_w}))continue;const ke=G==null?void 0:G.catalog.find(qe=>qe.id===le.id);l.push({id:le.id,name:(ke==null?void 0:ke.nameFr)??(ke==null?void 0:ke.name)??le.id,builtWithCardUnderneath:le.built,boundingBox:ze,...le.tuckRegion?{tuckRegion:le.tuckRegion}:{},confidence:Math.round(le.confidence*1e4)/1e4});const et=le.tuckRegion??ze;re.push({x0:et.x,y0:et.y,x1:et.x+et.width,y1:et.y+et.height})}}}catch(G){console.warn("[wonders-reg] discovery failed:",G)}const ne=[];for(const G of v){const Q=G.box[0]+G.box[2]/2,ee=G.box[1]+G.box[3]/2;if(re.some(le=>Q>=le.x0&&Q<=le.x1&&ee>=le.y0&&ee<=le.y1)){y+=1;continue}ne.push(G),a[G.family]=(a[G.family]??0)+1,g+=1}const ye=ey(ne),De=new Set(ye.map(G=>G.box.join(",")));for(const G of ny(ne))De.has(G.box.join(","))||ye.push(G);for(const G of ye)c.push(G);if(ne.some(G=>G.family==="guild")){const G=await Tb();if(G!==null){r(`${k}: identifying guilds…`,.75);for(const Q of ne)if(Q.family==="guild")try{const[ee,oe,le,Ee]=Q.box,Ie=Ir(E,ee,oe,le,Ee),Re=P_(Ie),Ke={[G.inputNames[0]]:new Ue("float32",Re,[1,3,$n,$n])},Xe=(await G.run(Ke))[G.outputNames[0]].data,{id:ke,prob:et}=U_(Xe);ke!==""&&!p.some(qe=>qe.id===ke)&&p.push({id:ke,boundingBox:{x:ee,y:oe,width:le,height:Ee},confidence:Math.round(et*1e4)/1e4})}catch(ee){console.warn("[guild-cls] failed:",ee)}}else if(Date.now()<N)try{const Q=Z??await Va();if(Q!==null){const ee=await hb();if(ee.size>0){r(`${k}: identifying guilds…`,.75);const oe=await fb();for(const le of h_(Q,E,ee,N,oe))p.some(Ee=>Ee.id===le.id)||p.push(le)}}}catch(Q){console.warn("[guilds-reg] failed:",Q)}}r(`${k}: laurels…`,.8);const Ge=await bb(),rt=[];for(const G of[0,1,2,3]){const Q=G===0?E:Gt(E,G),ee=await qt("laurel",Q);for(const[oe,le,Ee,Ie]of Ta(ee.rows,ee.params,St.laurel.conf)){const Re=Cf({x:oe,y:le,width:Ee-oe,height:Ie-le},G,E.width,E.height),Ke=Re.x+Re.width/2,ze=Re.y+Re.height/2,Xe=.6*Math.max(Re.width,Re.height);rt.some(([et,qe,Qe,Be])=>{const Ye=(et+Qe)/2,tt=(qe+Be)/2;return(Ke-Ye)**2+(ze-tt)**2<Xe*Xe})||rt.push([Re.x,Re.y,Re.x+Re.width,Re.y+Re.height])}}const Te=await Ib(),pe=await kb();for(const[G,Q,ee,oe]of rt){const le=Math.trunc((G+ee)/2),Ee=Math.trunc((Q+oe)/2);if([...F,...B].some(Be=>(le-Be.cx)**2+(Ee-Be.cy)**2<=Be.r*Be.r))continue;if(pe!==null){const Be=await Eb(E,[Math.trunc(G),Math.trunc(Q),Math.trunc(ee),Math.trunc(oe)],pe);if(Be!==null&&Be>=J_)continue}const Re=Math.max(6,Math.trunc(Math.max(ee-G,oe-Q)*xy)),Ke=$b(E,le,Ee,Re);let ze=null,Xe=0;const ke=new Map;for(const Be of[0,1,2,3]){const Ye=Be===0?Ke:Gt(Ke,Be),[tt,dt]=By(Ye,Ge);tt!==null&&(ke.set(tt,Math.max(ke.get(tt)??0,dt)),dt>Xe&&(ze=tt,Xe=dt))}ze!==null&&Xe<cb&&(ze=null);const et=Xe;if(Te!==null){const Be=Ir(E,Math.trunc(G),Math.trunc(Q),Math.trunc(ee-G),Math.trunc(oe-Q));let Ye=null,tt=0;for(const dt of[0,1,2,3]){const kr=dt===0?Be:Gt(Be,dt),Hn=Y_(kr),jn=await Te.run({[Te.inputNames[0]]:new Ue("float32",Hn,[1,3,vn,vn])}),{value:ss,prob:Er}=Z_(jn[Te.outputNames[0]].data);Er>tt&&(Ye=ss,tt=Er)}Ye!==null&&tt>=X_&&(ze=Ye,Xe=tt)}const qe=ze!==null&&[...ke.entries()].some(([Be,Ye])=>Be!==ze&&Ye>=et-.1),Qe=re.some(Be=>le>=Be.x0&&le<=Be.x1&&Ee>=Be.y0&&Ee<=Be.y1);s.push({value:ze,valueRead:ze!==null,center:[Math.round((G+ee)/2),Math.round((Q+oe)/2)],boundingBox:{x:Math.trunc(G),y:Math.trunc(Q),width:Math.trunc(ee-G),height:Math.trunc(oe-Q)},confidence:Math.round(Xe*1e4)/1e4,excluded:Qe,photoIndex:b-1,...qe?{suspect:!0,suspectReason:"orientation-ambiguous"}:{}})}i()}y>0?n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: ${y} banner(s) near a wonder were excluded as tucked/consumed (estimated footprint — the server uses the real card box); verify the per-colour counts.`}):g>0&&l.length===0&&n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: no wonder was located on this photo, so a card tucked under a wonder may still be counted — verify the per-colour counts.`});const $=a.guild??0;$!==p.length?n.push({code:"INCONSISTENT_STATE",message:`${t}: ${$} purple banner(s) counted but ${p.length} guild(s) identified — reconcile in the review (stacked guilds or a missed identification).`}):p.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: guild(s) identified by their card art: `+p.map(S=>S.id).join(", ")+" — confirm in the review."});const x=l.filter(S=>S.boundingBox.width===0);x.length>0?n.push({code:"LOW_CONFIDENCE",message:`${t}: wonder(s) identified by name but NOT registered against their reference (${x.map(S=>S.name).join(", ")}) — their BUILT flag is a suggestion: unselect any that was not built.`}):l.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: ${l.length} wonder(s) registered — the BUILT flags were measured (card protruding underneath); confirm in the review.`}),m>0&&n.push({code:"UNRECOGNIZED_OBJECT",message:`${t}: ${m} token disc(s) found but not identified — pick them in the review below.`}),u.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: progress token(s) identified on-device: `+u.map(S=>S.id).join(", ")+" — confirm in the review."}),o.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: coins read as ${f} from ${o.length} tile(s) by their metal COLOUR (the embossed-digit reader is server-only) — confirm the total.`});const T=s.filter(S=>S.valueRead);return{...Hb(),wonders:l,guilds:Nb(p,l),progressTokens:u,laurels:s,cardVictoryPoints:{value:T.reduce((S,k)=>S+(k.value??0),0),laurelsKept:s.length,laurelsUnread:s.length-T.length,complete:s.length===T.length},cardCounts:{byFamily:a,source:g>0?"yolo":"none",tuckedExcluded:y,...c.length>0?{suspects:c}:{}},coins:{total:f,confidence:o.length>0?.5:0,source:o.length>0?"local-colour":"none",coins:o}}}const bt=1280,Kb=.3,is=9;let as=null;function Xb(){return as===null&&(as=(async()=>{try{return(await fetch(`${Ne}pawn_ends.onnx`,{method:"HEAD"})).ok?await it.create(`${Ne}pawn_ends.onnx`,{executionProviders:["wasm"]}):null}catch{return null}})()),as}function Yb(e){const t=bt/Math.max(e.width,e.height),n=Math.round(e.width*t),r=Math.round(e.height*t),i=new OffscreenCanvas(e.width,e.height);i.getContext("2d",{willReadFrequently:!0}).putImageData(new ImageData(new Uint8ClampedArray(e.data),e.width,e.height),0,0);const o=new OffscreenCanvas(bt,bt).getContext("2d",{willReadFrequently:!0});o.fillStyle="rgb(114,114,114)",o.fillRect(0,0,bt,bt),o.drawImage(i,0,0,e.width,e.height,0,0,n,r);const{data:u}=o.getImageData(0,0,bt,bt),l=bt*bt,p=new Float32Array(3*l);for(let c=0;c<l;c+=1)p[c]=u[c*4]/255,p[l+c]=u[c*4+1]/255,p[2*l+c]=u[c*4+2]/255;return{tensor:p,r:t}}async function Zb(e,t){const{tensor:n,r}=Yb(t),a=(await e.run({[e.inputNames[0]]:new Ue("float32",n,[1,3,bt,bt])}))[e.outputNames[0]].data,s=new Map;for(let o=0;o+5<a.length;o+=6){const u=a[o+4];if(u<Kb)continue;const l=Math.round(a[o+5]),p=s.get(l);if(p===void 0||u>p.conf){const c=(a[o]+a[o+2])/2/r,f=(a[o+1]+a[o+3])/2/r;s.set(l,{conf:u,cx:c,cy:f})}}return s}async function Qb(e,t){let n=null;for(let g=0;g<4;g+=1){const y=g===0?t:Gt(t,g),b=await Zb(e,y);if(b.has(0)&&b.has(1)&&b.has(2)){const $=b.get(0).conf+b.get(1).conf+b.get(2).conf;(n===null||$>n.score)&&(n={score:$,det:b})}}if(n===null)return null;const r=n.det.get(0),i=n.det.get(1),a=n.det.get(2),s=a.cx-i.cx,o=a.cy-i.cy,u=(i.cx+a.cx)/2,l=(i.cy+a.cy)/2,p=s*s+o*o;if(p<=0)return null;const c=((r.cx-u)*s+(r.cy-l)*o)/p*(2*is),f=Math.min(is,Math.max(-is,Math.round(c))),m=Math.min(r.conf,i.conf,a.conf);return{position:f,confidence:Math.round(m*1e4)/1e4}}async function Jb(e,t){const n=[{code:"LOW_CONFIDENCE",message:"On-device mode: card counts and laurel/token/coin COUNTS are detected locally; laurel values, wonders, guilds, token ids and coin totals are entered in the review (those recognition stages are not ported to the browser yet)."}],r={left:null,right:null},i=e.left.length+e.right.length;let a=0;const s=(l,p=0)=>{t(l,i>0?Math.min(.99,(a+p)/i):void 0)},o=()=>{a+=1};for(const l of["left","right"]){const p=e[l];p.length>0&&(r[l]=await jb(p,l,n,s,o))}let u={conflictPawnPosition:0,found:!1,confidence:0};if(e.board!==void 0){try{const l=await rs(e.board),p=await Xb();if(p!==null){const c=await Qb(p,l);c!==null&&(u={conflictPawnPosition:c.position,found:!0,confidence:c.confidence})}}catch(l){console.warn("[pawn] on-device read failed:",l)}u.found||n.push({code:"MILITARY_PAWN_NOT_FOUND",message:"On-device mode could not read the conflict pawn — set its position below."})}return{imageId:e.imageId,players:r,militaryTrack:u,outcome:{type:"civilian"},confidence:.5,warnings:n}}self.onmessage=e=>{const{id:t,kind:n}=e.data,r=(i,a)=>{self.postMessage({id:t,progress:i,...a!==void 0?{fraction:a}:{}})};(async()=>{try{n==="recognize"&&r("starting the on-device engine…",0);const i=n==="classify"?await Vb(e.data.file):await Jb(e.data.payload,r);self.postMessage({id:t,ok:!0,result:i})}catch(i){self.postMessage({id:t,ok:!1,error:String(i)})}})()}})();
