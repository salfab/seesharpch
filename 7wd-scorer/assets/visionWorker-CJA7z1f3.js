...
`)},type:p,offsetToIndices:v,indicesToOffset:k,broadcastedIndicesToOffset:G,indices:S,indicesGet:R,indicesSet:B,set:(...C)=>{if(C.length!==o+1)throw new Error(`indices length must be ${o}`);let z=C[o];if(typeof z!="string")throw new Error("value must be string");let U=C.slice(0,o).map(f).join(",");return o===0?q("0u",z):o===1?q(U[0],z):(m.set=!0,m.setByIndices=!0,m.indicesToOffset=!0,`set_${e}(${U}, ${z})`)},setByOffset:q,setByIndices:(C,z)=>o<2?q(C,z):(m.setByIndices=!0,m.indicesToOffset=!0,`set_${e}ByIndices(${C}, ${z});`),get:Z,getByOffset:N,getByIndices:le,usage:r,name:e,strides:b,shape:w,rank:o}},K=(e,t,n,r=1)=>er(e,t,n,"input",r),de=(e,t,n,r=1)=>er(e,t,n,"output",r),Hu=(e,t,n)=>er(e,t,n,"atomicOutput",1),ao=(e,t,n,r=1)=>er(e,t,n,"internal",r),ju=class{constructor(e,t){this.normalizedDispatchGroup=e,this.limits=t,this.internalVariables=[],this.variables=[],this.uniforms=[],this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(e){return`if (global_idx >= ${typeof e=="number"?`${e}u`:e}) { return; }`}mainStart(e=Pn){let t=typeof e=="number"?e:e[0],n=typeof e=="number"?1:e[1],r=typeof e=="number"?1:e[2];if(t>this.limits.maxComputeWorkgroupSizeX||n>this.limits.maxComputeWorkgroupSizeY||r>this.limits.maxComputeWorkgroupSizeZ)throw new Error(`workgroup size [${t}, ${n}, ${r}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(t*n*r>this.limits.maxComputeInvocationsPerWorkgroup)throw new Error(`workgroup size [${t}, ${n}, ${r}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let i=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,a=i?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Ku=(e,t)=>new ju(e,t)}),Yu,so,Xu,Qu,Zu,Ju,pt,el,tl,on=re(()=>{be(),$e(),Ve(),ve(),Yu=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},so=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Xu=(e,t)=>V.sortBasedOnPerm(e,so(e.length,t)),Qu=(e,t,n,r)=>{let i=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let a=0;a<t;++a)i+=`a[${e[a]}]=i[${a}];`;return i+="return a;}"},Zu=(e,t)=>{let n=[],r=[];for(let i=0;i<e.length;++i)e[i]!==1&&n.push(e[i]),e[t[i]]!==1&&r.push(t[i]);return{newShape:n,newPerm:r}},Ju=(e,t)=>{let n=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<n)return!1;n=e[r]}return!0},pt=(e,t)=>{let n=e.dataType,r=e.dims.length,i=so(r,t),a=Xu(e.dims,i),o=e.dims,s=a,u=r<2||Ju(i,e.dims),l;if(u)return l=m=>{let y=K("input",n,o,4),w=de("output",n,s,4);return`
  ${m.registerUniform("output_size","u32").declareVariables(y,w)}
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let m=V.size(a);return{outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(m/4)}]}},getShaderSource:l};let{newShape:c,newPerm:d}=Zu(e.dims,i),p=V.areEqual(d,[2,3,1]),f=V.areEqual(d,[3,1,2]);if(c.length===2||p||f){o=p?[c[0],c[1]*c[2]]:f?[c[0]*c[1],c[2]]:c,s=[o[1],o[0]];let m=16;return l=y=>{let w=K("a",n,o.length),b=de("output",n,s.length);return`
  ...
  ${m.mainStart()}
    ...
    ${w.setByOffset("global_idx",y.getByIndices("aIndices"))}
       ...
       `,m=y=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Mt=(e,t,n,r)=>{let i=e.inputs.length===1?n:uo(e.inputs,n),a=i.axes;a.length===0&&!i.noopWithEmptyAxes&&(a=e.inputs[0].dims.map((f,m)=>m));let o=V.normalizeAxes(a,e.inputs[0].dims.length),s=o,u=e.inputs[0],l=cl(s,e.inputs[0].dims.length);l.length>0&&(u=e.compute(pt(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],s=al(s.length,u.dims.length));let[c,d]=sl(u.dims,s),p=c;i.keepDims&&(p=ul(c,o)),e.compute(dl(t,i.cacheKey,[u],r,e.inputs[0].dataType,p,d),{inputs:[u]})},hl=(e,t)=>{Mt(e,"ReduceMeanShared",t,"mean")},pl=(e,t)=>{Mt(e,"ReduceL1Shared",t,"l1")},fl=(e,t)=>{Mt(e,"ReduceL2Shared",t,"l2")},ml=(e,t)=>{Mt(e,"ReduceLogSumExpShared",t,"logSumExp")},gl=(e,t)=>{Mt(e,"ReduceMaxShared",t,"max")},yl=(e,t)=>{Mt(e,"ReduceMinShared",t,"min")},wl=(e,t)=>{Mt(e,"ReduceProdShared",t,"prod")},bl=(e,t)=>{Mt(e,"ReduceSumShared",t,"sum")},_l=(e,t)=>{Mt(e,"ReduceSumSquareShared",t,"sumSquare")},xl=(e,t)=>{Mt(e,"ReduceLogSumShared",t,"logSum")}}),St,$l,Nr,uo,It,vl,Ml,Sl,Il,Tl,El,kl,Cl,Al,Rl,Tt,Ol,Nl,zl,Bl,Pl,Dl,Ul,Ll,Fl,Gl,lo=re(()=>{be(),$e(),Ve(),ve(),Hy(),St=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},$l=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Nr=(e,t,n,r,i,a,o=!1,s=!1)=>{let u=[],l=n[0].dims,c=l.length,d=V.normalizeAxes(i,c),p=!s&&d.length===0;l.forEach((y,w)=>{p||d.indexOf(w)>=0?o&&u.push(1):u.push(y)});let f=u.length,m=V.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let w=[],b=K("_A",n[0].dataType,c),x=de("output",a,f),M=r(b,x,d),v=M[2];for(let I=0,E=0;I<c;I++)p||d.indexOf(I)>=0?(o&&E++,v=`for(var j${I}: u32 = 0; j${I} < ${l[I]}; j${I}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${o}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:x,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...fe(a)]:[{type:12,data:u}]})}},Jl=e=>Oe(e),ec=(e,t)=>{let{inputs:n,outputCount:r}=e,i=Jl({...t,outputCount:r});if(ze.webgpu.validateInputContent&&Ql(n,i),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Zl(n,i))}}),tc,nc,rc,Yy=re(()=>{$e(),ve(),tc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},nc=e=>{let t=e[0].dims,n=e[0].dims[2],r=V.size(t)/4,i=e[0].dataType,a=K("input",i,t,4),o=K("bias",i,[n],4),s=K("residual",i,t,4),u=de("output",i,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
  ...
  }`}},rc=e=>{tc(e.inputs),e.compute(nc(e.inputs))}}),ic,Re,oc,ac,sc,uc,lc,cc,dc,hc,pc,fc,mc,gc,yc,wc,nr,bc,Br,_c,xc,$c,vc,Mc,Sc,Ic,Tc,Ec,kc,Cc,Ac,Rc,Oc,Nc,zc,fo,Bc,mo,go,Pc,Dc,Uc,Lc,Fc,Gc,yo=re(()=>{be(),$e(),Ve(),ve(),ic=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),u="";typeof i=="string"?u=`${i}(a)`:u=i("a");let l=K("inputData",n,[s],4),c=de("outputData",r,[s],4),d=[{name:"vec_size",type:"u32"}];return o&&d.push(...o),`
...
`,go=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Pc=e=>{let t=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"FastGelu",go,mo(t),void 0,e.inputs[0].dataType))},Dc=(e,t)=>{let n=rt(e.inputs[0].dataType);return e.compute(Re(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Uc=e=>{e.compute(Re(e.inputs[0],"Log","log"))},Lc=(e,t)=>`
...
`,Fc=e=>`quick_gelu_impl(${e})`,Gc=(e,t)=>{let n=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"QuickGelu",Fc,Lc(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Wc,qc,Vc,Xy=re(()=>{$e(),ve(),yo(),Wc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},qc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=K("input",e[0].dataType,e[0].dims,4),r=K("bias",e[0].dataType,[e[0].dims[2]],4),i=de("output",e[0].dataType,t,4),a=V.size(t)/4,o=Qe(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:s=>`
  ...
  ${s.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Jc=e=>{Et(e,"Sub",(t,n)=>`${t}-${n}`)},ed=e=>{Et(e,"Greater",{scalar:(t,n)=>`u32(${t}>${n})`,vector:(t,n)=>`vec4<u32>(${t}>${n})`},void 0,void 0,9)},td=e=>{Et(e,"Less",{scalar:(t,n)=>`u32(${t}<${n})`,vector:(t,n)=>`vec4<u32>(${t}<${n})`},void 0,void 0,9)},nd=e=>{Et(e,"GreaterOrEqual",{scalar:(t,n)=>`u32(${t}>=${n})`,vector:(t,n)=>`vec4<u32>(${t}>=${n})`},void 0,void 0,9)},rd=e=>{Et(e,"LessOrEqual",{scalar:(t,n)=>`u32(${t}<=${n})`,vector:(t,n)=>`vec4<u32>(${t}<=${n})`},void 0,void 0,9)}}),id,od,ad,sd,ud,ld,Zy=re(()=>{be(),$e(),Ve(),ve(),id=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let n=0,r=e[n],i=r.dataType,a=r.dims.length;e.forEach((o,s)=>{if(s!==n){if(o.dataType!==i)throw new Error("input tensors should be one type");if(o.dims.length!==a)throw new Error("input tensors should have the same shape");o.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},od=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,ad=(e,t)=>{let n=e.length,r=[];for(let i=0;i<n;++i){let a=t.setByOffset("global_idx",e[i].getByIndices("indices"));n===1?r.push(a):i===0?r.push(`if (inputIndex == ${i}u) { ${a} }`):i===n-1?r.push(`else { ${a} }`):r.push(`else if (inputIndex == ${i}) { ${a} }`)}return r.join(`
`)},sd=(e,t,n,r)=>{let i=V.size(n),a=new Array(e.length),o=new Array(e.length),s=0,u=[],l=[],c=[{type:12,data:i}];for(let y=0;y<e.length;++y)s+=e[y].dims[t],a[y]=s,l.push(e[y].dims.length),o[y]=K(`input${y}`,r,l[y]),u.push("rank"),c.push({type:12,data:a[y]});for(let y=0;y<e.length;++y)c.push(...fe(e[y].dims));c.push(...fe(n));let d=de("output",r,n.length),p=d.indicesGet("indices",t),f=Array.from(Array(a.length).keys()).map(y=>`uniforms.sizeInConcatAxis${y}`).join(","),m=y=>`
  ...
  ${y.mainStart()}
    ...
    ${ad(o,d)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}),getShaderSource:m}},ud=(e,t)=>{let n=e.inputs,r=n[0].dims,i=V.normalizeAxis(t.axis,r.length);id(n,i);let a=r.slice();a[i]=n.reduce((s,u)=>s+(u.dims.length>i?u.dims[i]:0),0);let o=n.filter(s=>V.size(s.dims)>0);e.compute(sd(o,i,a,n[0].dataType),{inputs:o})},ld=e=>Oe({axis:e.axis})}),xn,$n,vn,wo,Mn=re(()=>{be(),$e(),xn=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},$n=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},vn=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},wo=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[n,r]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=(e==null?void 0:e.activation_params)||[Ru,Ou];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:n}}return{activation:t}}}),Je,cd,bo=re(()=>{Je=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},cd=e=>`
...
`}),rr,_o,xo=re(()=>{be(),$e(),ve(),Mn(),rr=(e,t,n,r,i)=>{let a=r-n;return`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${d};${p};${f};${i}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:x}),getShaderSource:M}}}),hd,pd,$o,vo,fd,Mo,md,Pr,So=re(()=>{be(),$e(),ve(),Mn(),xo(),bo(),hd=(e,t)=>e?`
        ...
        }`,$o=(e,t,n="f32",r,i=!1,a=32,o=!1,s=32)=>{let u=t[1]*e[1],l=t[0]*e[0],c=i?u:a,d=i?a:u,p=c/t[0],f=a/t[1];if(!((i&&p===4&&e[1]===4||!i&&(p===3||p===4))&&c%t[0]===0&&a%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
`},md=(e,t,n,r,i=!1)=>{let[a,o,s,u]=r,l=Qe(r[0].type.tensor);return`
  ...
  ${y?$o(w,b,X,F):Mo(w,b,X,F)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${L}>`:L}) {
        ...
        ${O}
        ${gd(l,R,B,Y,o,t,G[0],G[1],G[2],L)}
        ${y?$o(M,x,L,void 0,!l,S):Mo(M,x,L,void 0,!l,S,!1,void 0,s)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${y};${R};${B};${Y};${E};${k};${S}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(n):n,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:q}),getShaderSource:F}}}),wd,Io,ir,bd,To,_d,xd,$d,tw=re(()=>{be(),Ht(),$e(),ve(),Mn(),bo(),wd=e=>{let t=1;for(let n=0;n<e.length;n++)t*=e[n];return t},Io=e=>typeof e=="number"?[e,e,e]:e,ir=(e,t)=>t<=1?e:e+(e-1)*(t-1),bd=(e,t,n,r=1)=>{let i=ir(t,r);return Math.floor((e[0]*(n-1)-n+i)/2)},To=(e,t,n,r,i)=>{i==null&&(i=bd(e,t[0],r[0]));let a=[0,0,0,n];for(let o=0;o<3;o++)e[o]+2*i>=t[o]&&(a[o]=Math.trunc((e[o]-t[o]+2*i)/r[o]+1));return a},_d=(e,t,n,r,i,a,o,s,u,l)=>{let c,d,p,f;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=To([t,n,r,1],[s,u,l],1,[i,a,o],e);d=m[0],p=m[1],f=m[2]}else if(Array.isArray(e)){if(!e.every((y,w,b)=>y===b[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=To([t,n,r,1],[s,u,l],1,[i,a,o],e[0]);d=m[0],p=m[1],f=m[2]}else if(e==="SAME_UPPER"){d=Math.ceil(t/i),p=Math.ceil(n/a),f=Math.ceil(r/o);let m=(d-1)*i+s-t,y=(p-1)*a+u-n,w=(f-1)*o+l-r,b=Math.floor(m/2),x=m-b,M=Math.floor(y/2),v=y-M,I=Math.floor(w/2),E=w-I;c={top:M,bottom:v,left:I,right:E,front:b,back:x}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:d,outHeight:p,outWidth:f}},xd=(e,t,n,r,i,a=!1,o="channelsLast")=>{let s,u,l,c,d;if(o==="channelsLast")[s,u,l,c,d]=e;else if(o==="channelsFirst")[s,d,u,l,c]=e;else throw new Error(`Unknown dataFormat ${o}`);let[p,,f,m,y]=t,[w,b,x]=Io(n),[M,v,I]=Io(r),E=ir(f,M),k=ir(m,v),S=ir(y,I),{padInfo:R,outDepth:B,outHeight:Y,outWidth:G}=_d(i,u,l,c,w,b,x,E,k,S),q=a?p*d:p,N=[0,0,0,0,0];return o==="channelsFirst"?N=[s,q,B,Y,G]:o==="channelsLast"&&(N=[s,B,Y,G,q]),{batchSize:s,dataFormat:o,inDepth:u,inHeight:l,inWidth:c,inChannels:d,outDepth:B,outHeight:Y,outWidth:G,outChannels:q,padInfo:R,strideDepth:w,strideHeight:b,strideWidth:x,filterDepth:f,filterHeight:m,filterWidth:y,effectiveFilterDepth:E,effectiveFilterHeight:k,effectiveFilterWidth:S,dilationDepth:M,dilationHeight:v,dilationWidth:I,inShape:e,outShape:N,filterShape:t}},$d=(e,t,n,r,i,a)=>{let o=a==="channelsLast";o?e[0].dims[3]:e[0].dims[1];let s=[64,1,1],u={x:n.map((w,b)=>b)},l=[Math.ceil(wd(u.x.map(w=>n[w]))/s[0]),1,1];Ce("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let c=1,d=V.size(n),p=[{type:12,data:d},{type:12,data:r},{type:12,data:i},{type:12,data:t.strides},{type:12,data:t.dilations}];$n(t,p),p.push(...fe(e[0].dims,e[1].dims));let f=["rank","rank"],m=e.length===3;m&&(p.push(...fe(e[2].dims)),f.push("rank")),p.push(...fe(n));let y=w=>{let b=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:i.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];vn(t,b);let x=1,M=Qe(e[0].dataType),v=K("x",e[0].dataType,e[0].dims.length,c),I=K("W",e[1].dataType,e[1].dims.length,x),E=[v,I],k=de("result",e[0].dataType,n.length,x),S="";if(m){let Y=K("bias",e[2].dataType,e[2].dims.length,x);E.push(Y),S+=`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${a};${o};${p};${l[0]};${l[1]}`,inputDependencies:i?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:f}}}),Sd,Dr,Id,Ur,Eo,ko,Td,Ed,Co,rw=re(()=>{$e(),ew(),tw(),So(),nw(),Mn(),xo(),on(),Sd=(e,t,n,r,i,a)=>{let o=e[0],s=e.slice(a?1:2,a?3:4),u=s.length,l=t[0],c=t.slice(2).map((p,f)=>p+(p-1)*(n[f]-1)),d=s.map((p,f)=>p+r[f]+r[f+u]).map((p,f)=>Math.floor((p-c[f]+i[f])/i[f]));return d.splice(0,0,o),d.splice(a?3:1,0,l),d},Dr=[2,3,1,0],Id=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ur=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let a=2;a<t[1].dims.length;++a)n[a-2]===0&&(n[a-2]=t[1].dims[a]);let r=e.pads.slice();Cr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:n,pads:r}),i},Eo=e=>{let t=wo(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,a=e.group,o=e.kernel_shape,s=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,pads:s,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},ko=(e,t,n,r)=>{let i=n.format==="NHWC",a=Sd(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,i);if(n.group!==1){let E=[t[0]];if(i){let k=e.kernelCustomData.wT??e.compute(pt(t[1],Dr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=k),E.push(k)}else E.push(t[1]);t.length===3&&E.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&i&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(Md(E,n,a,r),{inputs:E}):e.compute(vd(E,n,a,r),{inputs:E});return}let o=t.length===3,s=t[0].dims[i?1:2],u=t[0].dims[i?2:3],l=t[0].dims[i?3:1],c=t[1].dims[2],d=t[1].dims[3],p=a[i?1:2],f=a[i?2:3],m=a[i?3:1],y=i&&c===s&&d===u&&n.pads[0]===0&&n.pads[1]===0;if(y||c===1&&d===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let E=a[0],k,S,R,B=[];if(i){let q=e.kernelCustomData.wT??e.compute(pt(t[1],Dr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=q),y){let N=s*u*l;k=t[0].reshape([1,E,N]),S=q.reshape([1,N,m]),R=[1,E,m]}else k=t[0].reshape([E,s*u,l]),S=q.reshape([1,l,m]),R=[E,p*f,m];B.push(k),B.push(S)}else k=t[0].reshape([E,l,s*u]),S=t[1].reshape([1,m,l]),R=[E,m,p*f],B.push(S),B.push(k);o&&B.push(t[2]);let Y=R[2],G=B[0].dims[B[0].dims.length-1];Y<8&&G<8?e.compute(_o(B,n,a,R,i,r),{inputs:B}):e.compute(Pr(B,n,a,R,i,r),{inputs:B});return}let w=!0,b=e.kernelCustomData.wT??e.compute(pt(t[1],Dr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let x=[t[0],b];o&&x.push(t[2]);let M=i?p*f:m,v=i?m:p*f,I=c*d*l;e.compute(yd(x,n,a,M,v,I,o,w,r),{inputs:x})},Td=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),o=[1].concat(t.dilations),s=[1].concat(t.kernelShape),u=Ur({...t,pads:i,strides:a,dilations:o,kernelShape:s},r);ko(e,r,u,l=>n?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},Ed=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",i=Ur(n,t),a=n.autoPad==="NOTSET"?n.pads:n.autoPad,o=xd(t[0].dims,t[1].dims,n.strides,n.dilations,a,!1,r);e.compute($d(t,i,o.outShape,[o.filterDepth,o.filterHeight,o.filterWidth],[o.padInfo.front,o.padInfo.top,o.padInfo.left],r))},Co=(e,t)=>{if(Id(e.inputs,t),e.inputs[0].dims.length===3)Td(e,t);else if(e.inputs[0].dims.length===5)Ed(e,e.inputs,t);else{let n=Ur(t,e.inputs);ko(e,e.inputs,n)}}}),kd,iw=re(()=>{be(),Ht(),$e(),ve(),kd=(e,t,n)=>{let r=e.length>2,i=t.outputShape,a=t.format==="NHWC",o=t.group,s=e[1].dims,u=s[2]/o,l=s[3],c=a?Ge(u):1,d=a&&l===1&&u>=4,p=d?Math.floor(u/4)*4:Math.floor(u/c)*c,f=u-p,m=a?Ge(l):1,y=a?l===1?c:m:1,w=V.size(i)/m,b=[Math.ceil(w/64),1,1];Ce("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${b}`);let x=["rank","rank"],M=[t.strides[0],t.strides[1]],v=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],I=[t.dilations[0],t.dilations[1]],E=[v[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),v[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],k=[E[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),E[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],S=[{type:12,data:w},{type:12,data:M},{type:12,data:v},{type:12,data:I},{type:12,data:E},{type:6,data:k},{type:12,data:p},{type:12,data:u},{type:12,data:l},...fe(e[0].dims,e[1].dims)];r&&(S.push(...fe(e[2].dims)),x.push("rank")),S.push(...fe(i));let R=B=>{let Y=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:M.length},{name:"filter_dims",type:"u32",length:v.length},{name:"dilations",type:"u32",length:v.length},{name:"effective_filter_dims",type:"u32",length:E.length},{name:"pads",type:"i32",length:k.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],G=Qe(e[0].dataType),q=a?1:2,N=a?2:3,F=a?3:1,X=K("W",e[1].dataType,e[1].dims.length,y),Z=K("Dy",e[0].dataType,e[0].dims.length,c),le=[Z,X];r&&le.push(K("bias",e[2].dataType,[i[F]].length,m));let L=de("result",e[0].dataType,i.length,m),O=()=>{let U="";if(d)c===4?U+=`
...
`)},Gd=(e,t)=>{let n,r,i,a,o,s,u=t.format==="NHWC",l=t.blocksize,c=t.mode==="DCR";u?([n,r,i,a]=e.dims,o=c?[n,r,i,l,l,a/l**2]:[n,r,i,a/l**2,l,l],s=c?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,r,i,a]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],o=c?[n,l,l,a/l**2,r,i]:[n,a/l**2,l,l,r,i],s=c?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let d=e.reshape(o),p=d.dims.length,f=e.dataType,m=K("a",f,p),y=de("output",f,p),w=b=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:b=>{let x=u?[n,r*l,i*l,a/l**2]:[n,a/l**2,r*l,i*l],M=V.size(x),v=d.dims,I=V.sortBasedOnPerm(v,s);return{outputs:[{dims:x,dataType:b[0].dataType}],dispatchGroup:{x:Math.ceil(M/64)},programUniforms:[{type:12,data:M},...fe(v,I)]}},getShaderSource:w}},Wd=(e,t)=>{Ld(e.inputs),e.compute(Gd(e.inputs[0],t))},qd=e=>Oe({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Lr,or,Oo,Vd,Hd,jd,Kd,No,Yd,Xd,Qd,uw=re(()=>{be(),$e(),Ve(),ve(),Lr="[a-zA-Z]|\\.\\.\\.",or="("+Lr+")+",Oo="^"+or+"$",Vd="("+or+",)*"+or,Hd="^"+Vd+"$",jd=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let n=this.symbolToIndices.get(e);n===void 0?n=[t]:n.push(t),this.symbolToIndices.set(e,n)}},Kd=class{constructor(e,t){var i;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,r]=t.includes("->")?t.split("->",2):[t,""];if(!n.match(RegExp(Hd)))throw new Error("Invalid LHS term");if(n.split(",").forEach((a,o)=>{let s=e[o].dims.slice();if(!a.match(RegExp(Oo)))throw new Error("Invalid LHS term");let u=this.processTerm(a,!0,s,o);this.lhs.push(u)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([a,o])=>o.count===1||a==="...").map(([a])=>a).join("");else if(!r.match(RegExp(or)))throw new Error("Invalid RHS");(i=r.match(RegExp(Lr,"g")))==null||i.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let o=this.symbolToInfo.get(a);if(o===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(o.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,n){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(n)}else r={count:1,dimValue:t,inputIndices:[n]};this.symbolToInfo.set(e,r)}processTerm(e,t,n,r=-1){let i=n.length,a=!1,o=[],s=0;if(!e.match(RegExp(Oo))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Lr,"g")),l=new jd(r);return u==null||u.forEach((c,d)=>{if(c==="..."){if(a)throw new Error("Only one ellipsis is allowed per input term");a=!0;let p=i-u.length+1;if(p<0)throw new Error("Ellipsis out of bounds");if(o=n.slice(s,s+p),this.hasEllipsis){if(this.ellipsisDims.length!==o.length||this.ellipsisDims.toString()!==o.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=o;else throw new Error("Ellipsis must be specified in the LHS");for(let f=0;f<o.length;f++){let m=String.fromCharCode(48+f);l.addSymbol(m,d+f),this.addSymbol(m,n[s++],r)}}else l.addSymbol(c,d+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,n[s++],r)}),l}},No=e=>e+"_max",Yd=(e,t,n,r)=>{let i=e.map(l=>l.length).map((l,c)=>K(`input${c}`,t,l)),a=V.size(r),o=de("output",t,r.length),s=[...n.symbolToInfo.keys()].filter(l=>!n.rhs.symbolToIndices.has(l)),u=l=>{let c=[],d="var prod = 1.0;",p="var sum = 0.0;",f="sum += prod;",m=[],y=[],w=[],b=[],x=n.symbolToInfo.size===n.rhs.symbolToIndices.size;n.symbolToInfo.forEach((v,I)=>{var E;if(n.rhs.symbolToIndices.has(I)){let k=(E=n.rhs.symbolToIndices.get(I))==null?void 0:E[0];k!==void 0&&n.lhs.forEach((S,R)=>{if(v.inputIndices.includes(R)){let B=S.symbolToIndices.get(I);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(Y=>{c.push(`${i[R].indicesSet(`input${R}Indices`,Y,o.indicesGet("outputIndices",k))}`)})}})}else n.lhs.forEach((k,S)=>{if(v.inputIndices.includes(S)){let R=k.symbolToIndices.get(I);if(R===void 0)throw new Error("Invalid symbol error");R.forEach(B=>{m.push(`${i[S].indicesSet(`input${S}Indices`,B,`${I}`)}`)}),b.push(`prod *= ${i[S].getByIndices(`input${S}Indices`)};`)}}),y.push(`for(var ${I}: u32 = 0; ${I} < uniforms.${No(I)}; ${I}++) {`),w.push("}")});let M=x?[...c,`let sum = ${i.map((v,I)=>v.getByIndices(`input${I}Indices`)).join(" * ")};`]:[...c,p,...y,...m,d,...b,f,...w];return`
            ${l.registerUniforms(s.map(v=>({name:`${No(v)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...i,o)}
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:n.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=s.filter(d=>n.symbolToInfo.has(d)).map(d=>{var p;return{type:12,data:((p=n.symbolToInfo.get(d))==null?void 0:p.dimValue)||0}});l.push({type:12,data:a});let c=e.map((d,p)=>[...fe(d)]).reduce((d,p)=>d.concat(p),l);return c.push(...fe(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}},getShaderSource:u}},Xd=(e,t)=>{let n=new Kd(e.inputs,t.equation),r=n.outputDims,i=e.inputs.map((a,o)=>a.dims);e.compute(Yd(i,e.inputs[0].dataType,n,r))},Qd=e=>{let t=e.equation.replace(/\s+/g,"");return Oe({equation:t})}}),Zd,zo,Jd,eh,th,lw=re(()=>{be(),$e(),ve(),Zd=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,i=t.length<n.length?0:t.length-n.length;for(;r<n.length&&i<t.length;++r,++i)if(n[r]!==t[i]&&n[r]!==1&&t[i]!==1)throw new Error("Expand requires shape to be broadcastable to input")},zo=(e,t)=>{let n=e.length-t.length,r=[];for(let i=0;i<n;++i)r.push(e[i]);for(let i=0;i<t.length;++i)r.push(t[i]===1?e[i+n]:t[i]);return r},Jd=(e,t)=>e.length>t.length?zo(e,t):zo(t,e),eh=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=Jd(t,n),i=e[0].dataType,a=i===9||V.size(t)===1,o=i===9||t.length>0&&t[t.length-1]%4===0?4:1,s=a||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil(V.size(r)/s),l=d=>{let p=K("input",i,t.length,o),f=de("output",i,r.length,s),m;if(i===9){let y=(w,b,x="")=>`
    ...
    ${m}`},c=[{type:12,data:u},...fe(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},th=e=>{Zd(e.inputs),e.compute(eh(e.inputs),{inputs:[0]})}}),nh,rh,cw=re(()=>{be(),$e(),ve(),yo(),nh=e=>{let t=e[0].dataType,n=V.size(e[0].dims),r=V.size(e[1].dims),i=r%4===0,a=o=>{let s=K("x",t,[1],4),u=K("bias",t,[1],4),l=de("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
  ...
  ${p.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((f,m)=>m!==1).map(f=>f.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(f,m)=>"rank")},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:p}},ph=(e,t)=>{let n=e.inputs;dh(n,t),e.compute(hh(e.inputs,t))},fh=e=>Oe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),mh,gh,yh,wh,fw=re(()=>{be(),$e(),Ve(),ve(),mh=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},gh=(e,t)=>{let n=e[0].dims,r=e[0].dataType,i=n.length,a=e[1].dims,o=e[1].dataType,s=V.normalizeAxis(t.axis,i),u=n[s],l=a.slice(0),c=V.size(l),d=K("input",r,i),p=K("indicesInput",o,a.length),f=de("output",r,l.length),m=[{type:12,data:c},{type:6,data:u},{type:12,data:s}];return m.push(...fe(n,a,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:m}),getShaderSource:y=>`
...
`,kh=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${zt}], indices[${jt}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${zt}], indices[${jt}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${zt}], indices[${jt}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${zt}], indices[${jt}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${zt}], indices[${jt}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${zt}], indices[${jt}], border);
            }
          }
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,Ch=(e,t)=>{let n=K("x",e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=K("grid",e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[zt,jt,Sn,In]=[0,3,1,2]);let o=de("output",e[0].dataType,a.length),s=n.type.value,u=V.size(a),l=[{type:12,data:u},...fe(e[0].dims,r,a)],c=d=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:c},{inputs:[t,n],outputs:[-1]})[0]},ar=(e,t,n,r,i,a,o,s)=>{let u=a;if(o&&V.size(o.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=zh(e,a,o,t,r,n*i,s),u=u.reshape([t,r,n,i]),n===1||r===1?u:e.compute(pt(u,Bo.perm),{inputs:[u],outputs:[-1]})[0]}else return a.dims.length===3&&(u=a.reshape([t,r,n,i])),n===1||r===1?u:e.compute(pt(u,Bo.perm),{inputs:[u],outputs:[-1]})[0]},Bh=(e,t)=>{let n=Oh(e.inputs,t),r=e.inputs[0],i=ot(e.inputs,1),a=ot(e.inputs,2),o=ot(e.inputs,3),s=ot(e.inputs,4),u=ot(e.inputs,5),l=ot(e.inputs,6),c=ot(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if((i==null?void 0:i.dims.length)===5)throw new Error("Packed KV is not implemented");let d=i&&a&&i.dims.length===4&&a.dims.length===4,p=ar(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,o,0);if(d)return tr(e,p,i,a,s,void 0,l,c,u,n);if(!i||!a)throw new Error("key and value must be provided");let f=ar(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,i,o,n.hiddenSize),m=ar(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,o,2*n.hiddenSize);tr(e,p,f,m,s,void 0,l,c,u,n)}}),Dh,Uh,Lh,Fh,Po,Gh,Wh,qh=re(()=>{be(),$e(),Ve(),ve(),Dh=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Uh=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>n.push(Number(i))),r=n.length),Oe({numOutputs:r,axis:t.axis,splitSizes:n})},Lh=e=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:a},getRunData:()=>({outputs:[{dims:o,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},Qh=(e,t)=>{var v;let n=Kh(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((v=e.inputs[1])==null?void 0:v.dims.length)===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=Oe({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,c*n.headSize,c*n.headSize]}),[p,f,m]=!i&&!a?e.compute(Po([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],y,w;if(t.doRotary){let I=e.compute(Xh(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],E=e.inputs[7],k=e.inputs[8],S=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),R=[p,I,E,k],B=[-1];y=e.compute(Fr(R,S),{inputs:R,outputs:B})[0],R.splice(0,1,f);let Y=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});w=e.compute(Fr(R,Y),{inputs:R,outputs:B})[0]}let b=ar(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?y:p,void 0,0),x=Do(e,t.doRotary?w:f,n),M=Do(e,m,n);tr(e,b,x,M,void 0,void 0,o,s,void 0,n,u,l)}}),Uo,Zh,Jh,ep,ww=re(()=>{be(),$e(),on(),ve(),Uo=(e,t,n,r,i,a,o,s)=>{let u=Ge(a),l=u===1?"f32":`vec${u}f`,c=u===1?"vec2f":`mat2x${u}f`,d=i*o,p=64;d===1&&(p=256);let f=[i,o,a/u],m=[i,o,2],y=["rank","type","type"],w=[];w.push(...fe(f,m));let b=x=>{let M=K("x",t.dataType,3,u),v=K("scale",n.dataType,n.dims),I=K("bias",r.dataType,r.dims),E=de("output",1,3,2),k=[M,v,I,E];return`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${s};${p}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:w}),getShaderSource:b},{inputs:[t,n,r],outputs:[-1]})[0]},Zh=(e,t,n)=>{let r=t[0].dims,i=r,a=2,o=r[0],s=r[1],u=V.sizeFromDimension(r,a),l=Ge(u),c=V.size(i)/l,d=Uo(e,t[0],t[1],t[2],o,u,s,n.epsilon),p=[o,s,u/l],f=[o,s],m=["type","none"],y=w=>{let b=K("x",t[0].dataType,p.length,l),x=K("scale_shift",1,f.length,2),M=de("output",t[0].dataType,p.length,l),v=[b,x,M];return`
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...fe(p,f,p)]}),getShaderSource:y},{inputs:[t[0],d]})},Jh=(e,t,n)=>{let r=t[0].dims,i=r,a=r[0],o=r[r.length-1],s=V.sizeFromDimension(r,1)/o,u=Ge(o),l=V.size(i)/u,c=[{type:12,data:s},{type:12,data:Math.floor(o/u)}],d=["type","type"],p=!1,f=[0,r.length-1];for(let b=0;b<r.length-2;b++)p=p||r[b+1]!==1,f.push(b+1);p=p&&r[r.length-1]!==1;let m=p?e.compute(pt(e.inputs[0],f),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:r.length},(b,x)=>r[f[x]])),y=Uo(e,m,t[1],t[2],a,s,o,n.epsilon),w=b=>{let x=Qe(t[0].dataType),M=u===1?"vec2f":`mat${u}x2f`,v=k=>{let S=k===0?"x":"y",R=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${x}(${R}(scale.${S}))`;case 2:return`vec2<${x}>(${R}(scale[0].${S}, scale[1].${S}))`;case 4:return`vec4<${x}>(${R}(scale[0].${S}, scale[1].${S}, scale[2].${S}, scale[3].${S}))`;default:throw new Error(`Not supported compoents ${u}`)}},I=K("input",t[0].dataType,t[0].dims,u),E=de("output",t[0].dataType,i,u);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:w},{inputs:[t[0],y]})},ep=(e,t)=>{t.format==="NHWC"?Jh(e,e.inputs,t):Zh(e,e.inputs,t)}}),tp,np,rp,bw=re(()=>{be(),$e(),ve(),tp=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},np=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,u=V.normalizeAxis(t.axis,i.length),l=V.sizeToDimension(i,u),c=V.sizeFromDimension(i,u),d=V.size(a.dims),p=o?V.size(o.dims):0;if(d!==c||o&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${d} and bias size of ${p}`);let f=[];for(let I=0;I<i.length;++I)I<u?f.push(i[I]):f.push(1);let m=Ge(c),y=["type","type"],w=[{type:12,data:l},{type:1,data:c},{type:12,data:Math.floor(c/m)},{type:1,data:t.epsilon}];o&&y.push("type");let b=n>1,x=n>2,M=I=>{let E=Qe(e[0].dataType),k=[K("x",e[0].dataType,e[0].dims,m),K("scale",a.dataType,a.dims,m)];o&&k.push(K("bias",o.dataType,o.dims,m)),k.push(de("output",e[0].dataType,s,m)),b&&k.push(de("mean_data_output",1,f)),x&&k.push(de("inv_std_output",1,f));let S=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${I.mainStart()}
    ...
    ${x?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},v=[{dims:s,dataType:e[0].dataType}];return b&&v.push({dims:f,dataType:1}),x&&v.push({dims:f,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${n};${r}`,inputDependencies:y},getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:w}),getShaderSource:M}},rp=(e,t)=>{tp(e.inputs),e.compute(np(e.inputs,t,e.outputCount))}}),ip,op,_w=re(()=>{$e(),xo(),So(),ip=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},op=e=>{ip(e.inputs);let t=Bn.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(_o(e.inputs,{activation:""},t));else{let i=t[t.length-2],a=V.size(e.inputs[0].dims.slice(0,-2)),o=V.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let s=e.inputs[0].reshape([1,a,r]),u=e.inputs[1].reshape([1,r,n]),l=[1,a,n],c=[s,u];e.compute(Pr(c,{activation:""},t,l),{inputs:c})}else e.compute(Pr(e.inputs,{activation:""},t))}}}),ap,sp,up,lp,cp,xw=re(()=>{be(),$e(),Ve(),ve(),ap=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!V.areEqual(o.dims,[t.n,i,a]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let s=e[2].dims;if(V.size(s)!==t.n*i)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(V.size(u)!==l)throw new Error("zeroPoints input size error.")}},sp=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),u=V.size(s),l=e[1].dims[2]/4,c=e[0].dataType,d=Ge(t.k),p=Ge(l),f=Ge(o),m=s.concat([i,o]),y=i>1&&o/f%2===0?2:1,w=V.size(m)/f/y,b=64,x=[],M=[u,i,a/d],v=V.convertShape(e[1].dims).slice();v.splice(-1,1,l/p),x.push(...fe(M)),x.push(...fe(v)),x.push(...fe(e[2].dims)),e.length===4&&x.push(...fe(V.convertShape(e[3].dims)));let I=[u,i,o/f];x.push(...fe(I));let E=k=>{let S=M.length,R=K("a",e[0].dataType,S,d),B=K("b",12,v.length,p),Y=K("scales",e[2].dataType,e[2].dims.length),G=[R,B,Y],q=e.length===4?K("zero_points",12,e[3].dims.length):void 0;q&&G.push(q);let N=I.length,F=de("output",e[0].dataType,N,f),X=Qe(e[0].dataType),Z=(()=>{switch(d){case 1:return`array<${X}, 8>`;case 2:return`mat4x2<${X}>`;case 4:return`mat2x4<${X}>`;default:throw new Error(`${d}-component is not supported.`)}})(),le=Math.floor(32/t.bits),L=Math.floor(le/8),O=()=>{let U="";for(let P=0;P<L;P++){let j=P*t.bits*4,ie=j+t.bits;U+=`
          // reuse a data (pass ${P})
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${d};${p};${w};${y}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:c}],dispatchGroup:{x:I},programUniforms:E}),getShaderSource:B}},lp=(e,t)=>{ap(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(up(e.inputs,t)):e.compute(sp(e.inputs,t))},cp=e=>Oe(e)}),dp,hp,pp,fp,mp,gp,yp,wp,bp,$w=re(()=>{be(),$e(),ve(),dp=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},hp=(e,t,n)=>{let r="";for(let i=t-1;i>=0;--i)r+=`
      ...
      `},pp=(e,t,n)=>{let r="";for(let i=t-1;i>=0;--i)r+=`
          ...
          `},gp=(e,t,n)=>{switch(n.mode){case 0:return hp(e,t,n.pads.length);case 1:return pp(e,t,n.pads.length);case 2:return fp(e,t,n.pads.length);case 3:return mp(e,t,n.pads.length);default:throw new Error("Invalid mode")}},yp=(e,t)=>{let n=V.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,i=V.size(n),a=[{type:12,data:i},{type:6,data:t.pads}],o=e.length>=3&&e[2].data;t.mode===0&&a.push({type:o?e[2].dataType:1,data:t.value}),a.push(...fe(e[0].dims,n));let s=["rank"],u=l=>{let c=de("output",e[0].dataType,n.length),d=K("x",e[0].dataType,r.length),p=d.type.value,f=gp(c,r.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:o?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Wo=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,_p=e=>`${Wo(e)};${e.countIncludePad}`,xp=e=>`${Wo(e)};${e.storageOrder};${e.dilations}`,qo=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),Vo=(e,t,n,r)=>{let[i,a]=Lo(t,r,n),o=K("x",t.dataType,t.dims.length),s=o.type.value,u="value += x_val;",l="";i.countIncludePad?l+=`value /= ${s}(uniforms.kernelSize);`:l+=`value /= ${s}(i32(uniforms.kernelSize) - pad);`;let[c,d,p,f,m]=Fo(a,i);c.push(...fe(t.dims,a));let y=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(a)/64)},programUniforms:c}),getShaderSource:w=>Go(w,o,t.dims.length,a.length,i,u,l,0,d,p,f,m)}},$p=e=>{let t=e.count_include_pad!==0,n=qo(e);if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...n,cacheKey:""};return{...r,cacheKey:_p(r)}},vp=(e,t)=>{sr(e.inputs),e.compute(Vo("AveragePool",e.inputs[0],!1,t))},Ho={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Mp=e=>{let t=e.format;return{format:t,...Ho,cacheKey:t}},Sp=(e,t)=>{sr(e.inputs),e.compute(Vo("GlobalAveragePool",e.inputs[0],!0,t))},jo=(e,t,n,r)=>{let[i,a]=Lo(t,r,n),o=`
      value = max(x_val, value);
    `,s="",u=K("x",t.dataType,t.dims.length),l=["rank"],[c,d,p,f,m]=Fo(a,i);return c.push(...fe(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(a)/64)},programUniforms:c}),getShaderSource:y=>Go(y,u,t.dims.length,a.length,i,o,s,t.dataType===10?-65504:-1e5,d,p,f,m)}},Ip=(e,t)=>{sr(e.inputs),e.compute(jo("MaxPool",e.inputs[0],!1,t))},Tp=e=>{let t=e.storage_order,n=e.dilations,r=qo(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:n,...r,cacheKey:""};return{...i,cacheKey:xp(i)}},Ep=e=>{let t=e.format;return{format:t,...Ho,cacheKey:t}},kp=(e,t)=>{sr(e.inputs),e.compute(jo("GlobalMaxPool",e.inputs[0],!0,t))}}),Cp,Ap,Rp,Op,Mw=re(()=>{be(),$e(),Ve(),ve(),Cp=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===t.axis||i===e[0].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Ap=(e,t)=>{let n=V.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=V.size(a),u=r===3||r===2,l=u?[Math.ceil(V.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,d=e.length>2?e[2]:void 0,p=d?u?[Math.ceil(V.size(d.dims)/4)]:d.dims:void 0,f=c.length===0||c.length===1&&c[0]===1,m=f===!1&&c.length===1,y=Ge(s),w=f&&(!u||y===4),b=w?y:1,x=w&&!u?y:1,M=K("input",u?12:r,l.length,x),v=K("scale",o,c.length),I=d?K("zero_point",u?12:r,p.length):void 0,E=de("output",o,a.length,b),k=[M,v];I&&k.push(I);let S=[l,c];d&&S.push(p);let R=[{type:12,data:s/b},{type:12,data:n},{type:12,data:t.blockSize},...fe(...S,a)],B=Y=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/b/64),y:1,z:1},programUniforms:R})}},Rp=(e,t)=>{Cp(e.inputs,t),e.compute(Ap(e.inputs,t))},Op=e=>Oe({axis:e.axis,blockSize:e.blockSize})}),Np,zp,Bp,Sw=re(()=>{mt(),be(),ve(),Np=(e,t,n)=>{let r=e===t,i=e<t&&n<0,a=e>t&&n>0;if(r||i||a)throw new Error("Range these inputs' contents are invalid.")},zp=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...fe(a)],u=l=>{let c=de("output",r,a.length),d=c.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:d},{name:"delta",type:d}];return`
        ${l.registerUniforms(p).declareVariables(c)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${d}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},Bp=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),ze.webgpu.validateInputContent&&Np(t,n,r),e.compute(zp(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),Pp,Dp,Up,Lp,Iw=re(()=>{be(),$e(),Ve(),ve(),Pp=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
              ...
              ${i}bitcast<${r}>(oldValue) + (${n})${a}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${n}));`:`
                ${i}max(bitcast<f32>(oldValue), (${n}))${a}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${n}));`:`${i}min(bitcast<${r}>(oldValue), (${n}))${a}`;case"mul":return`${i}(bitcast<${r}>(oldValue) * (${n}))${a}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Dp=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n,a=1,o=Math.ceil(V.sizeToDimension(r,r.length-1)/a),s=r[r.length-1],u=V.sizeFromDimension(n,s),l=[{type:12,data:o},{type:12,data:s},{type:12,data:u},...fe(e[1].dims,e[2].dims,i)],c=d=>{let p=K("indices",e[1].dataType,e[1].dims.length),f=K("updates",e[2].dataType,e[2].dims.length,a),m=t.reduction!=="none"&&t.reduction!==""?Hu("output",e[0].dataType,i.length):de("output",e[0].dataType,i.length,a);return`
...
`,qp=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Vp=(e,t,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",Hp=(e,t,n)=>{let r=new Array(n).fill(0).concat(new Array(n).fill(1)),i=e.length===0?r:e.slice();return t.length>0?(t.forEach((a,o)=>{r[a]=i[o],r[o+n]=i[t.length+o]}),r):i},jp=(e,t,n,r)=>{let i=[];if(n.length>0)if(r.length>0){if(e.forEach(a=>i.push(a)),Math.max(...r)>e.length)throw new Error("axes is out of bound");r.forEach((a,o)=>i[a]=n[o])}else n.forEach(a=>i.push(a));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");i=e.map((a,o)=>Math.round(a*t[o]))}return i},Kp=(e,t,n)=>{let r=(()=>{switch(n.keepAspectRatioPolicy){case"not_larger":return n.axes.length>0?Math.min(...n.axes.map(a=>t[a]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return n.axes.length>0?Math.max(...n.axes.map(a=>t[a]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return n.axes.length>0?(n.axes.forEach(a=>t[a]=r),n.axes.forEach(a=>i[a]=Math.round(e[a]*t[a]))):(t.fill(r,0,t.length),i.forEach((a,o)=>i[o]=Math.round(a*t[o]))),i},Yp=(e,t,n,r,i)=>`
...
`:"",Zp=(e,t,n,r,i)=>{let[a,o,s,u]=n.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Jp=(e,t,n,r,i,a,o,s,u,l)=>{let c=n.length===2,[d,p]=c?[0,1]:[2,3],f=e.type.value,m=y=>{let w=y===d?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    `},ef=(e,t,n,r,i)=>{let[a,o,s,u,l]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],c=e.type.value;return`
    ...
    }`},tf=(e,t,n,r,i,a)=>{let o=e.dims,s=Hp(a,t.axes,o.length),u=jp(o,r,i,t.axes),l=r.slice();r.length===0&&(l=o.map((x,M)=>x===0?1:u[M]/x),t.keepAspectRatioPolicy!=="stretch"&&(u=Kp(o,l,t)));let c=de("output",e.dataType,u.length),d=K("input",e.dataType,o.length),p=V.size(u),f=o.length===u.length&&o.every((x,M)=>x===u[M]),m=t.coordinateTransformMode==="tf_crop_and_resize",y=t.extrapolationValue,w=d.type.value,b=x=>`
      ${f?"":`
      ${qp(t.coordinateTransformMode,w)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Qp(d,o)};
              ${Vp(t.nearestMode,n,w)};
              ${Xp(d,c,o,u,l.length,s.length,m)};
              `;case"linear":return`
              ${Yp(c,o,u,l.length,s.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${Zp(d,c,o,m,y)}`;if(o.length===3||o.length===5)return`${ef(d,c,o,m,y)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(o.length===2||o.length===4)return`${Jp(d,c,o,u,l,s,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${n}|${l.length>0?t.mode==="cubic"?l:l.length:""}|${i.length>0?i:""}|${s.length>0?s:""}|${f}|${t.mode==="nearest"?o.length:o}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},{type:1,data:l},{type:1,data:s},...fe(o,u)]})}},nf=e=>{let t=e.customDataBuffer;return new Uint32Array(t.buffer,t.byteOffset,1)[0]},rf=(e,t)=>{let n=[],r=[],i=[],a=nf(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");Wp(e.inputs,t,a,n,r,i),e.compute(tf(e.inputs[0],t,a,n,r,i),{inputs:[0]})},of=e=>{let t=e.antialias,n=e.axes,r=e.coordinateTransformMode,i=e.cubicCoeffA,a=e.excludeOutside!==0,o=e.extrapolationValue,s=e.keepAspectRatioPolicy,u=e.mode,l=e.nearestMode===""?"simple":e.nearestMode;return Oe({antialias:t,axes:n,coordinateTransformMode:r,cubicCoeffA:i,excludeOutside:a,extrapolationValue:o,keepAspectRatioPolicy:s,mode:u,nearestMode:l})}}),af,sf,uf,Ew=re(()=>{be(),$e(),ve(),af=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],n=e[1],r=e[2];if(t.dataType!==n.dataType||t.dataType!==r.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(n.dims.length!==3&&n.dims.length!==2)throw new Error("Skip must be 2D or 3D");let i=t.dims[t.dims.length-1],a=t.dims[t.dims.length-2];if(n.dims[n.dims.length-1]!==i)throw new Error("Skip must have the same hidden size as input");if(n.dims[n.dims.length-2]!==a)throw new Error("Skip must have the same sequence length as input");if(r.dims.length!==1)throw new Error("Gamma must be 1D");if(r.dims[r.dims.length-1]!==i)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let o=e[3];if(o.dims.length!==1)throw new Error("Beta must be 1D");if(o.dims[o.dims.length-1]!==i)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let o=e[4];if(o.dims.length!==1)throw new Error("Bias must be 1D");if(o.dims[o.dims.length-1]!==i)throw new Error("Bias must have the same hidden size as input")}},sf=(e,t,n,r)=>{let i=t.simplified,a=e[0].dims,o=V.size(a),s=a,u=o,l=a.slice(-1)[0],c=r?a.slice(0,-1).concat(1):[],d=!i&&e.length>3,p=e.length>4,f=r&&n>1,m=r&&n>2,y=n>3,w=64,b=Ge(l),x=[{type:12,data:u},{type:12,data:b},{type:12,data:l},{type:1,data:t.epsilon}],M=I=>{let E=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],k=[K("x",e[0].dataType,e[0].dims,b),K("skip",e[1].dataType,e[1].dims,b),K("gamma",e[2].dataType,e[2].dims,b)];d&&k.push(K("beta",e[3].dataType,e[3].dims,b)),p&&k.push(K("bias",e[4].dataType,e[4].dims,b)),k.push(de("output",e[0].dataType,s,b)),f&&k.push(de("mean_output",1,c)),m&&k.push(de("inv_std_output",1,c)),y&&k.push(de("input_skip_bias_sum",e[0].dataType,s,b));let S=Qe(e[0].dataType),R=Qe(1,b);return`
      ...
      }`},v=[{dims:s,dataType:e[0].dataType}];return n>1&&v.push({dims:c,dataType:1}),n>2&&v.push({dims:c,dataType:1}),n>3&&v.push({dims:a,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${b};${f};${m};${y}`,inputDependencies:e.map((I,E)=>"type")},getShaderSource:M,getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:x})}},uf=(e,t)=>{af(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(sf(e.inputs,t,e.outputCount,!1),{outputs:n})}}),lf,ur,cf,Xo,df,hf,pf,ff,kw=re(()=>{be(),$e(),Ve(),ve(),lf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},ur=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},cf=(e,t)=>{if(e.length>1){let n=ur(e,1),r=ur(e,2),i=ur(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),Oe({starts:n,ends:r,axes:i})}else return t},Xo=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},df=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${o.length}_${a.length}`,inputDependencies:["rank"]},getShaderSource:w,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:y})}},pf=(e,t)=>{lf(e.inputs,t);let n=cf(e.inputs,t);e.compute(hf(e.inputs,n),{inputs:[0]})},ff=e=>{let t=e.starts,n=e.ends,r=e.axes;return Oe({starts:t,ends:n,axes:r})}}),mf,gf,yf,wf,Cw=re(()=>{be(),$e(),Ve(),on(),ve(),mf=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},gf=(e,t)=>{let n=e.inputs[0],r=n.dims,i=V.size(r),a=r.length,o=V.normalizeAxis(t.axis,a),s=o<r.length-1,u,l=[];s?(l=Array.from({length:a},(k,S)=>S),l[o]=a-1,l[a-1]=o,u=e.compute(pt(n,l),{inputs:[n],outputs:[-1]})[0]):u=n;let c=u.dims,d=c[a-1],p=i/d,f=Ge(d),m=d/f,y=64;p===1&&(y=256);let w=(k,S)=>S===4?`max(max(${k}.x, ${k}.y), max(${k}.z, ${k}.w))`:S===2?`max(${k}.x, ${k}.y)`:S===3?`max(max(${k}.x, ${k}.y), ${k}.z)`:k,b=K("x",u.dataType,u.dims,f),x=de("result",u.dataType,u.dims,f),M=b.type.value,v=Qe(u.dataType)==="f32"?`var threadMax = ${M}(-3.4028234663852886e+38f);`:`var threadMax = ${M}(-65504.0h);`,I=k=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...fe(e[0].dims,i)]}),getShaderSource:l}},$f=e=>{bf(e.inputs),e.compute(xf(e.inputs),{inputs:[0]})}}),vf,Mf,Sf,Rw=re(()=>{be(),$e(),ve(),vf=(e,t,n,r,i)=>{let a=de("output_data",i,n.length,4),o=K("a_data",t[1].dataType,t[1].dims.length,4),s=K("b_data",t[2].dataType,t[2].dims.length,4),u=K("c_data",t[0].dataType,t[0].dims.length,4),l,c=(d,p,f)=>`select(${p}, ${d}, ${f})`;if(!r)l=a.setByOffset("global_idx",c(o.getByOffset("global_idx"),s.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let d=(p,f,m="")=>{let y=`a_data[index_a${f}][component_a${f}]`,w=`b_data[index_b${f}][component_b${f}]`,b=`bool(c_data[index_c${f}] & (0xffu << (component_c${f} * 8)))`;return`
 ...
 * limitations under the License.
 * =============================================================================
 */const Hr=new Map;function Zf(e,t){const n=Hr.get(e)??{ms:0,appels:0};n.ms+=t,n.appels+=1,Hr.set(e,n)}function at(e,t){const n=performance.now();try{return t()}finally{Zf(e,performance.now()-n)}}async function et(e,t){const n=performance.now();try{return await t()}finally{Zf(e,performance.now()-n)}}function Lw(){return[...Hr.entries()].map(([e,t])=>({nom:e,ms:Math.round(t.ms),appels:t.appels})).sort((e,t)=>t.ms-e.ms)}function Fw(){Hr.clear()}function Gw(e,t,n,r){const i=t*n,a=new Uint8ClampedArray(new ArrayBuffer(i*4));if(r===4)return a.set(e),a;for(let o=0;o<i;o+=1)a[o*4]=e[o*r],a[o*4+1]=e[o*r+1],a[o*4+2]=e[o*r+2],a[o*4+3]=255;return a}function st(e){const t=Math.floor(e);return e-t===.5?t%2===0?t:t+1:Math.round(e)}function Ln(e){if(e.length===0)return Number.NaN;const t=[...e].sort((r,i)=>r-i),n=Math.floor(t.length/2);return t.length%2===1?t[n]:(t[n-1]+t[n])/2}function Jf(e,t){if(e.length===0)return Number.NaN;const n=[...e].sort((o,s)=>o-s),r=t/100*(n.length-1),i=Math.floor(r),a=Math.ceil(r);return i===a?n[i]:n[i]*(a-r)+n[a]*(r-i)}const Ww=114;function qw(e,t,n,r=1){const i=Math.min(n*r/e,n*r/t),a=Math.round(e*i),o=Math.round(t*i);return{scale:i,padX:Math.floor((n-a)/2),padY:Math.floor((n-o)/2),resizedWidth:a,resizedHeight:o}}function da(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let c=0;c<n;c++){const d=(c+.5)*l-.5,p=Math.max(0,Math.min(i-1,Math.floor(d))),f=Math.min(i-1,p+1),m=Math.max(0,Math.min(1,d-p));for(let y=0;y<t;y++){const w=(y+.5)*u-.5,b=Math.max(0,Math.min(r-1,Math.floor(w))),x=Math.min(r-1,b+1),M=Math.max(0,Math.min(1,w-b)),v=(p*r+b)*a,I=(p*r+x)*a,E=(f*r+b)*a,k=(f*r+x)*a,S=(c*t+y)*3;for(let R=0;R<3;R++){const B=o[v+R]*(1-M)+o[I+R]*M,Y=o[E+R]*(1-M)+o[k+R]*M;s[S+R]=Math.min(255,Math.max(0,Math.round(B*(1-m)+Y*m)))}}}return s}function Fn(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let c=0;c<n;c++){const d=c*l,p=Math.min((c+1)*l,i);for(let f=0;f<t;f++){const m=f*u,y=Math.min((f+1)*u,r);let w=0,b=0,x=0,M=0;for(let I=Math.floor(d);I<p;I++){const E=Math.min(I+1,p)-Math.max(I,d);if(!(E<=0))for(let k=Math.floor(m);k<y;k++){const S=Math.min(k+1,y)-Math.max(k,m);if(S<=0)continue;const R=S*E,B=(I*r+k)*a;w+=o[B]*R,b+=o[B+1]*R,x+=o[B+2]*R,M+=R}}const v=(c*t+f)*3;s[v]=Math.min(255,Math.max(0,st(w/M))),s[v+1]=Math.min(255,Math.max(0,st(b/M))),s[v+2]=Math.min(255,Math.max(0,st(x/M)))}}return s}function em(e){const n=((-.75*(e+1)- -3.75)*(e+1)+-6)*(e+1)- -3,r=((-.75+2)*e-(-.75+3))*e*e+1,i=((-.75+2)*(1-e)-(-.75+3))*(1-e)*(1-e)+1;return[n,r,i,1-n-r-i]}function dr(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n,c=p=>Math.max(0,Math.min(r-1,p)),d=p=>Math.max(0,Math.min(i-1,p));for(let p=0;p<n;p++){const f=(p+.5)*l-.5,m=Math.floor(f),y=em(f-m);for(let w=0;w<t;w++){const b=(w+.5)*u-.5,x=Math.floor(b),M=em(b-x),v=(p*t+w)*3;for(let I=0;I<3;I++){let E=0;for(let k=0;k<4;k++){const S=d(m-1+k)*r;let R=0;for(let B=0;B<4;B++)R+=M[B]*o[(S+c(x-1+B))*a+I];E+=y[k]*R}s[v+I]=Math.min(255,Math.max(0,Math.round(E)))}}}return s}function jr(e,t,n=1){const r=qw(e.width,e.height,t,n),i=da(e,r.resizedWidth,r.resizedHeight),a=t*t,o=new Float32Array(3*a).fill(Ww/255);for(let s=0;s<r.resizedHeight;s++){const u=(s+r.padY)*t+r.padX,l=s*r.resizedWidth;for(let c=0;c<r.resizedWidth;c++){const d=(l+c)*3,p=u+c;o[p]=i[d]/255,o[a+p]=i[d+1]/255,o[2*a+p]=i[d+2]/255}}return{tensor:o,params:r}}function ha(e,t,n,r){const i=[],a=Math.floor(e.length/6);for(let o=0;o<a;o++){const s=e[o*6],u=e[o*6+1],l=e[o*6+2],c=e[o*6+3],d=e[o*6+4],p=e[o*6+5];if(d<n)continue;const f=Math.round(p);if(f<0||f>=r)continue;const m=(s-t.padX)/t.scale,y=(u-t.padY)/t.scale,w=(l-t.padX)/t.scale,b=(c-t.padY)/t.scale;i.push({classIndex:f,confidence:d,box:[Math.trunc(m),Math.trunc(y),Math.trunc(w-m),Math.trunc(b-y)],boxFloat:[m,y,w-m,b-y]})}return i}const hr=.8,tm=.65,Vw=110,Hw=1280;function jw(e,t,n){if(n==null)return hr;if(n.length===0)return tm;const r=Math.max(e,t);if(!(r>0))return hr;const i=Hw/r,a=n.filter(u=>Array.isArray(u.box)||u.box!==void 0).map(u=>Math.sqrt(Number(u.box[2])**2+Number(u.box[3])**2)*i).filter(u=>Number.isFinite(u)).sort((u,l)=>u-l);if(a.length===0)return hr;const o=a.length;return(o%2===1?a[(o-1)/2]:(a[o/2-1]+a[o/2])/2)>=Vw?tm:hr}const nm=.25,rm=.6;function Kw(e,t,n){const r=Math.trunc(Number(n[0])),i=Math.trunc(Number(n[1])),a=Math.trunc(Number(n[2])),o=Math.trunc(Number(n[3]));if(![r,i,a,o].every(b=>Number.isFinite(b)))return null;const s=a-r,u=o-i;if(s<=0||u<=0)return null;const l=Math.trunc(s*(s>=u?nm:rm)),c=Math.trunc(u*(s>=u?rm:nm)),d=Math.max(0,r-l),p=Math.max(0,i-c),f=Math.min(Math.trunc(e),a+l),m=Math.min(Math.trunc(t),o+c),y=f-d,w=m-p;return y<=0||w<=0?null:{x:d,y:p,width:y,height:w}}const Yw=3,Xw=.15,Qw=.6;function pa(e,t){return Math.hypot(Number(e[0])-Number(t[0]),Number(e[1])-Number(t[1]))}function Zw(e){const t=e.filter(i=>i&&Number.isFinite(Number(i[0]))&&Number.isFinite(Number(i[1])));if(t.length===0)return null;let n=0,r=0;for(const i of t)n+=Number(i[0]),r+=Number(i[1]);return[n/t.length,r/t.length]}function Jw(e,t,n){try{if(n==null)return null;const r=Math.trunc(Number(n));if(!Number.isFinite(r)||r===0||!e||e.length<2)return null;const i=[Number(e[0][0]),Number(e[0][1])],a=[Number(e[1][0]),Number(e[1][1])];if(![...i,...a].every(v=>Number.isFinite(v)))return null;const o=pa(i,a);if(!(o>0))return null;const s=[];for(const v of t??[]){const I=Math.trunc(Number(v.n));if(!Number.isFinite(I)||I<Yw)continue;const E=Zw(v.poly);E!==null&&s.push({owner:v.owner,c:E,n:I,d0:0,d1:0,ecart:0})}if(s.length<2)return null;s.sort((v,I)=>I.n-v.n);const u=s.slice(0,2);let l=!1;s.length>2&&u[1].n>0&&(l=s[2].n/u[1].n>Qw);for(const v of u)v.d0=pa(v.c,i),v.d1=pa(v.c,a),v.ecart=Math.abs(v.d0-v.d1);const c=[...u].sort((v,I)=>I.ecart-v.ecart),d=c[0],p=c[1],f=d.d0<d.d1?0:1,m=r>0?1:0,y=f===m?d:p,w=f===m?p:d,b=f===1?d.owner:p.owner,x=f===1?p.owner:d.owner,M=d.ecart/o<Xw;return{favoredOwner:w.owner,threatenedOwner:y.owner,ownerAtEnd0:x,ownerAtEnd1:b,distance:Math.abs(r),ambiguous:!!(M||l)}}catch{return null}}function eb(e){if(!e)return null;const t=e.ownerAtEnd1,n=e.ownerAtEnd0;return!t||!n||t===n?null:{left:n,right:t}}const tb=.6;function im(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++){if(e[a*6+4]<n)continue;const s=(e[a*6]-t.padX)/t.scale,u=(e[a*6+1]-t.padY)/t.scale,l=(e[a*6+2]-t.padX)/t.scale,c=(e[a*6+3]-t.padY)/t.scale,d=st((s+l)/2),p=st((u+c)/2),f=st((l-s+(c-u))/4);f>=1&&r.push({cx:d,cy:p,r:f})}return r}function nb(e){const t=[];for(const n of[...e].sort((r,i)=>r.r-i.r)){const r=(tb*n.r)**2;t.every(i=>(n.cx-i.cx)**2+(n.cy-i.cy)**2>r)&&t.push(n)}return t}function rb(e){if(e.length===0)return[];const t=Math.max(1,Math.trunc(Ln(e.map(n=>n.r))*1.5));return[...e].sort((n,r)=>{const i=Math.floor(n.cy/t),a=Math.floor(r.cy/t);return i!==a?i-a:n.cx-r.cx})}function om(e,t,n){const r=im(e,t,n);return r.length===0?[]:rb(nb(r))}function ib(e,t,n){return im(e,t,n)}function pr(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++)e[a*6+4]<n||r.push([(e[a*6]-t.padX)/t.scale,(e[a*6+1]-t.padY)/t.scale,(e[a*6+2]-t.padX)/t.scale,(e[a*6+3]-t.padY)/t.scale]);return r}const ob=.5,ab=.7,sb=.55;function fa(e){const t=e.map(([n,r,i,a])=>Math.min(i-n,a-r)).sort((n,r)=>n-r);return t[Math.floor(t.length/2)]||1}function am(e){if(e.length===0)return[];const t=(ob*fa(e))**2,n=[];for(const i of e){const a=(i[0]+i[2])/2,o=(i[1]+i[3])/2,s=n.find(u=>(u.cx-a)**2+(u.cy-o)**2<=t);if(s===void 0)n.push({cx:a,cy:o,boxes:[i]});else{s.boxes.push(i);const u=s.boxes.length;s.cx=(s.cx*(u-1)+a)/u,s.cy=(s.cy*(u-1)+o)/u}}let r=n.map(({boxes:i})=>[Math.trunc(Ln(i.map(a=>a[0]))),Math.trunc(Ln(i.map(a=>a[1]))),Math.trunc(Ln(i.map(a=>a[2]))),Math.trunc(Ln(i.map(a=>a[3])))]);if(r.length>=2){const i=fa(r),a=r.map(()=>!0);for(let o=0;o<r.length;o++)if(a[o])for(let s=o+1;s<r.length;s++){if(!a[s])continue;const u=r[o],l=r[s],c=Math.max(0,Math.min(u[2],l[2])-Math.max(u[0],l[0])),d=Math.max(0,Math.min(u[3],l[3])-Math.max(u[1],l[1])),p=c*d,f=(u[2]-u[0])*(u[3]-u[1]),m=(l[2]-l[0])*(l[3]-l[1]);if(p>=ab*Math.min(f,m)){const y=Math.abs(Math.min(u[2]-u[0],u[3]-u[1])-i),w=Math.abs(Math.min(l[2]-l[0],l[3]-l[1])-i);if(a[y<=w?s:o]=!1,!a[o])break}}r=r.filter((o,s)=>a[s])}if(r.length>=3){const i=fa(r);r=r.filter(([a,o,s,u])=>Math.min(s-a,u-o)>=sb*i)}return r}const sm=["brown","grey","blue","green","yellow","red","purple"],ub={brown:"raw",grey:"manufactured",blue:"civilian",green:"scientific",yellow:"commercial",red:"military",purple:"guild"},lb=.7;function um(e){const t=e.map((i,a)=>a).sort((i,a)=>e[a].confidence-e[i].confidence),n=new Set,r=[];for(const i of t){const a=e[i],[o,s,u,l]=a.box;let c=!1;for(const d of r){const p=e[d];if(p.family!==a.family)continue;const[f,m,y,w]=p.box,b=Math.max(0,Math.min(o+u,f+y)-Math.max(o,f)),x=Math.max(0,Math.min(s+l,m+w)-Math.max(s,m)),M=Math.max(1,Math.min(u*l,y*w));if(b*x>=lb*M){c=!0;break}}c?n.add(i):r.push(i)}return e.filter((i,a)=>!n.has(a))}function Kr(e,t,n){const r=ha(e,t,n,sm.length).map(i=>{const a=sm[i.classIndex];return{color:a,family:ub[a],box:i.box,confidence:i.confidence}});return um(r)}const cb=8,db=.8,lm=1.25;function hb(e){if(e.length<cb)return[];const t=[],n=[];for(const o of e){const[,,s,u]=o.box;s>u*lm?t.push(o):u>s*lm&&n.push(o)}const[r,i,a]=t.length>=n.length?[t,n,"vertical"]:[n,t,"horizontal"];return r.length<db*e.length||i.length===0?[]:i.map(o=>({family:o.family,color:o.color,box:[...o.box],reason:`${o.color} banner sits ${a} while ${r.length}/${e.length} of the tableau faces the other way — probably a stray card poking into the frame`}))}const pb=2.25,cm=8;function fb(e){if(e.length<cm)return[];const t=e.map(d=>[d.box[0]+d.box[2]/2,d.box[1]+d.box[3]/2]),n=e.map(d=>Math.hypot(d.box[2],d.box[3])).sort((d,p)=>d-p),r=pb*n[Math.floor(n.length/2)],i=r*r,a=e.map((d,p)=>p),o=d=>{for(;a[d]!==d;)a[d]=a[a[d]],d=a[d];return d};for(let d=0;d<e.length;d++)for(let p=d+1;p<e.length;p++){const f=t[d][0]-t[p][0],m=t[d][1]-t[p][1];f*f+m*m<=i&&(a[o(d)]=o(p))}const s=new Map;for(let d=0;d<e.length;d++){const p=o(d);s.set(p,[...s.get(p)??[],d])}let u=[];for(const d of s.values())d.length>u.length&&(u=d);if(u.length<cm||u.length===e.length)return[];const l=new Set(u),c=e.map((d,p)=>p).filter(d=>!l.has(d));return c.map(d=>({family:e[d].family,color:e[d].color,box:[...e[d].box],reason:`${e[d].color} banner sits in a detached group of ${c.length}, away from the ${u.length}-card tableau — probably the draw/discard pile, not this player's city`}))}const nt={banner:{onnx:"banner_yolo.onnx",input:1280,conf:.5},coin:{onnx:"coin_yolo.onnx",input:1280,conf:.25},laurel:{onnx:"laurel_yolo.onnx",input:1280,conf:.25},token:{onnx:"token_yolo.onnx",input:1280,conf:.4},wonder:{onnx:"wonder_yolo.onnx",input:1280,conf:.3}};function kt(e,t,n){const r=Math.max(e,t,n),i=Math.min(e,t,n),a=r-i,o=r===0?0:Math.round(255*a/r);if(a===0)return{h:0,s:o,v:r};let s;return r===e?s=60*(t-n)/a:r===t?s=120+60*(n-e)/a:s=240+60*(e-t)/a,s<0&&(s+=360),{h:Math.round(s/2),s:o,v:r}}const mb=.42,gb=22,yb=43,wb=120,bb=1.5,_b=.72,xb=110,dm=3;function fr(e,t,n){const{width:r,height:i,channels:a,data:o}=e;if(r<4||i<4)return 0;const s=Math.floor(r/2),u=Math.floor(i/2),l=Math.trunc(Math.min(r,i)*mb);if(l<1)return 0;let c=0;for(let d=0;d<i;d++)for(let p=0;p<r;p++){if((p-s)**2+(d-u)**2>l*l)continue;const f=(d*r+p)*a,m=o[f],y=o[f+1],w=o[f+2];!t&&m>=250&&y>=250&&w>=250||(n(m,y,w),c+=1)}return c}function $b(e){let t=0,n=0,r=0,i=fr(e,!1,(a,o,s)=>{const u=kt(a,o,s);t+=u.h,n+=u.s,r+=u.v});return i===0&&(i=fr(e,!0,(a,o,s)=>{const u=kt(a,o,s);t+=u.h,n+=u.s,r+=u.v})),i===0?null:{h:t/i,s:n/i,v:r/i}}function vb(e){let t=0,n=0,r=fr(e,!1,(a,o)=>{t+=a,n+=o});if(r===0&&(r=fr(e,!0,(a,o)=>{t+=a,n+=o})),r===0)return null;const i=n/r;return i<=1e-6?null:t/r/i}function Mb(e){let t=0;const n=fr(e,!0,(r,i,a)=>{t+=kt(r,i,a).s});return n===0?null:t/n}function Sb(e){const t=$b(e);if(t===null||t.s<=gb)return 1;if(t.s>=wb){const n=vb(e);return n!==null&&n>=bb?6:3}return t.s>=yb?3:6}function Ib(e,t){const n=[...t];if(e.length!==3||t.length!==3||new Set(t).size===3&&t.every(o=>[1,3,6].includes(o)))return n;const r=e.map(o=>o.r).sort((o,s)=>o-s);if(r[0]<=0||!(r[1]>=r[0]*1.12&&r[2]>=r[1]*1.12))return n;const i=[0,1,2].sort((o,s)=>e[o].r-e[s].r),a=new Map([[i[0],1],[i[1],3],[i[2],6]]);return[0,1,2].map(o=>a.get(o))}function Tb(e,t){const n=[...t];if(e.length<dm||t.length!==e.length)return n;const r=e.map(o=>Mb(o)),i=r.filter(o=>o!==null);if(i.length<dm)return n;const a=Ln(i);return a<=0||r.forEach((o,s)=>{o!==null&&n[s]!==1&&o<_b*a&&o<xb&&(n[s]=1)}),n}function hm(e,t){const{cx:n,cy:r,r:i}=t,a=Math.max(0,n-i),o=Math.max(0,r-i),s=Math.min(e.width,n+i),u=Math.min(e.height,r+i),l=Math.max(0,s-a),c=Math.max(0,u-o),d=new Uint8Array(l*c*3);for(let p=0;p<c;p++)for(let f=0;f<l;f++){const m=(p*l+f)*3;if((f+a-n)**2+(p+o-r)**2<=i*i){const w=((p+o)*e.width+(f+a))*e.channels;d[m]=e.data[w],d[m+1]=e.data[w+1],d[m+2]=e.data[w+2]}else d[m]=255,d[m+1]=255,d[m+2]=255}return{width:l,height:c,channels:3,data:d}}function Eb(e,t){const n=t.map(a=>hm(e,a)),r=n.map(a=>Sb(a)),i=Ib(t,r);return Tb(n,i)}function kb(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n);for(let o=0,s=0;o<a.length;o++,s+=r)a[o]=i[s]*4899+i[s+1]*9617+i[s+2]*1868+8192>>14;return{width:t,height:n,data:a}}function pm(e,t,n){const r=new Uint8Array(t*n),i=e.width/t,a=e.height/n;for(let o=0;o<n;o++){const s=o*a,u=Math.min((o+1)*a,e.height);for(let l=0;l<t;l++){const c=l*i,d=Math.min((l+1)*i,e.width);let p=0,f=0;for(let m=Math.floor(s);m<u;m++){const y=Math.min(m+1,u)-Math.max(m,s);if(!(y<=0))for(let w=Math.floor(c);w<d;w++){const b=Math.min(w+1,d)-Math.max(w,c);b<=0||(p+=e.data[m*e.width+w]*b*y,f+=b*y)}}r[o*t+l]=Math.min(255,Math.max(0,st(p/f)))}}return{width:t,height:n,data:r}}function Cb(e){const t=new Array(256).fill(0);for(const u of e.data)t[u]+=1;const n=e.data.length;let r=0;for(;r<256&&t[r]===0;)r+=1;const i=new Uint8Array(n);if(r>=255||t[r]===n)return i.fill(r<256?r:0),{width:e.width,height:e.height,data:i};const a=255/(n-t[r]),o=new Uint8Array(256);let s=0;for(let u=r+1;u<256;u++)s+=t[u],o[u]=Math.min(255,Math.max(0,st(s*a)));for(let u=0;u<n;u++)i[u]=o[e.data[u]];return{width:e.width,height:e.height,data:i}}function Ab(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!0;for(let u=-1;u<=1&&s;u++)for(let l=-1;l<=1;l++){const c=o+l,d=a+u;if(!(c<0||c>=t||d<0||d>=n)&&r[d*t+c]===0){s=!1;break}}i[a*t+o]=s&&r[a*t+o]>0?255:0}return{width:t,height:n,data:i}}function Rb(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!1;for(let u=-1;u<=1&&!s;u++)for(let l=-1;l<=1;l++){const c=o+l,d=a+u;if(c>=0&&c<t&&d>=0&&d<n&&r[d*t+c]>0){s=!0;break}}i[a*t+o]=s?255:0}return{width:t,height:n,data:i}}function ma(e){const{width:t,height:n,data:r}=e,i=new Int32Array(t*n),a=[],o=new Int32Array(t*n);let s=1;for(let u=0;u<r.length;u++){if(r[u]===0||i[u]!==0)continue;let l=0,c=0;o[c++]=u,i[u]=s;let d=0,p=0,f=0;for(;l<c;){const m=o[l++],y=m%t,w=m/t|0;d+=1,p+=y,f+=w;for(let b=-1;b<=1;b++)for(let x=-1;x<=1;x++){if(x===0&&b===0)continue;const M=y+x,v=w+b;if(M<0||M>=t||v<0||v>=n)continue;const I=v*t+M;r[I]>0&&i[I]===0&&(i[I]=s,o[c++]=I)}}a[s]={area:d,centroidX:p/d,centroidY:f/d},s+=1}return{labels:i,stats:a}}function Ob(e,t,n){return fm(Float32Array.from(e.data),e.width,t,n)}function fm(e,t,n,r){const i=new Float32Array(t*t),a=t/2,o=-n*Math.PI/180,s=Math.cos(o),u=Math.sin(o);for(let l=0;l<t;l++)for(let c=0;c<t;c++){const d=c-a,p=l-a,f=s*d-u*p+a,m=u*d+s*p+a,y=Math.floor(f),w=Math.floor(m),b=f-y,x=m-w,M=(E,k)=>E>=0&&E<t&&k>=0&&k<t?e[k*t+E]:r,v=M(y,w)*(1-b)+M(y+1,w)*b,I=M(y,w+1)*(1-b)+M(y+1,w+1)*b;i[l*t+c]=v*(1-x)+I*x}return i}const Nb=.9,zb=.34,Bb=[.55,.6,.66,.72],Pb=22,Db=88,Ub=35,Gn=28,ga=4,Lb=Array.from({length:15},(e,t)=>-21+t*3),mm=[-2,0,2],Fb=3,Gb=.3;function Wb(e){return e.templates.flatMap(({label:t,bits:n})=>{const r=Uint8Array.from(atob(n),i=>i.charCodeAt(0));return r.length!==e.size*e.size?[]:[{label:t,bits:Float32Array.from(r)}]})}function qb(e){let t=e.width,n=-1,r=e.height,i=-1,a=0;for(let y=0;y<e.height;y++)for(let w=0;w<e.width;w++)e.data[y*e.width+w]>0&&(a+=1,t=Math.min(t,w),n=Math.max(n,w),r=Math.min(r,y),i=Math.max(i,y));if(a<8)return null;const o=n-t+1,s=i-r+1,u=Math.max(s,o),l=new Uint8Array(u*u),c=Math.floor((u-o)/2),d=Math.floor((u-s)/2);for(let y=0;y<s;y++)for(let w=0;w<o;w++)l[(y+d)*u+(w+c)]=e.data[(y+r)*e.width+(w+t)];const p=Gn-2*ga,f=pm({width:u,height:u,data:l},p,p),m=new Float32Array(Gn*Gn);for(let y=0;y<p;y++)for(let w=0;w<p;w++)m[(y+ga)*Gn+(w+ga)]=f.data[y*p+w]>110?1:0;return m}function Vb(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(r/2),s=Math.floor(n/2),u=Math.trunc(Math.min(n,r)*zb);if(u<4)return null;const l=o-u,c=s-u,d=2*u,p=2*u;if(d<6||p<6)return null;const f=new Int16Array(d*p),m=new Int16Array(d*p),y=new Int16Array(d*p),w=new Uint8Array(d*p),b=[],x=Math.min(d,p)/2;for(let L=0;L<d;L++)for(let O=0;O<p;O++){const C=((L+l)*n+(O+c))*i,{h:z,s:U,v:P}=kt(a[C],a[C+1],a[C+2]),j=L*p+O;f[j]=z,m[j]=U,y[j]=P,Math.sqrt((O-p/2)**2+(L-d/2)**2)/x<=t&&(w[j]=1,b.push(P))}if(b.length<16)return null;const M=Jf(b,55);let v=0,I=0,E=0;const k=L=>f[L]>=Pb&&f[L]<=Db&&m[L]>=Ub,S=L=>y[L]>=M&&m[L]<=95&&!k(L)&&w[L]===1;for(let L=0;L<d*p;L++)w[L]===1&&(E+=1,y[L]>=130&&!k(L)&&(v+=1),S(L)&&(I+=1));const R=v>.5*E&&I<.15*E,B=new Uint8Array(d*p);if(R){const L=Jf(b,45);for(let O=0;O<d*p;O++)B[O]=w[O]===1&&y[O]<=L?255:0}else for(let L=0;L<d*p;L++)B[L]=S(L)?255:0;const Y={width:p,height:d,data:B},G=Ab(Y);let q=ma(G),N=q;if(q.stats.length<=1&&(q=ma(Y),N=q,q.stats.length<=1))return null;const F=Math.min(d,p)/2;let X=0,Z=-1;for(let L=1;L<N.stats.length;L++){const O=N.stats[L];if(O===void 0)continue;const C=Math.hypot(O.centroidX-p/2,O.centroidY-d/2)/F,z=O.area*(1-.6*Math.min(C,1));z>Z&&(Z=z,X=L)}if(X===0)return null;const le=new Uint8Array(d*p);for(let L=0;L<d*p;L++)le[L]=N.labels[L]===X?255:0;return qb(Rb({width:p,height:d,data:le}))}function Hb(e,t,n,r,i,a){const o=Gn;let s=0,u=0;for(let l=0;l<o;l++){const c=l-a;if(!(c<0||c>=o))for(let d=0;d<o;d++){const p=d-i;if(p<0||p>=o)continue;const f=e[c*o+p];f!==0&&(u+=f,s+=f*n[l*o+d])}}return s/(u+r-s+1e-6)}function jb(e,t){const n=t.reduce((i,a)=>i+a,0);let r=-1;for(const i of Lb){const a=i===0?e:fm(e,Gn,i,0),o=a.reduce((s,u)=>s+u,0);for(const s of mm)for(const u of mm){const l=Hb(a,o,t,n,s,u);l>r&&(r=l)}}return r}function Kb(e,t){if(t.length===0||Math.min(e.width,e.height)<8)return[null,0];const n=[];for(const o of Bb){const s=Vb(e,o);if(s!==null)for(const{label:u,bits:l}of t)n.push([jb(s,l),u])}if(n.length===0)return[null,0];if(n.sort((o,s)=>s[0]-o[0]),n[0][0]<Gb)return[null,0];const r=new Map;for(const[o,s]of n.slice(0,Fb))r.set(s,(r.get(s)??0)+o);let i=0,a=-1;for(const[o,s]of r)s>a&&(a=s,i=o);return[i,n[0][0]]}const Yb=2560,Xb=.3,Qb=.5,Zb=1.6,Jb=3,e_=5;function t_(e){const t=Math.min(1,Yb/Math.max(e.width,e.height)),n=Math.max(32,Math.round(e.width*t/32)*32),r=Math.max(32,Math.round(e.height*t/32)*32),i=n*r,a=new Float32Array(3*i),o=e.width/n,s=e.height/r;for(let u=0;u<r;u++){const l=(u+.5)*s-.5,c=Math.max(0,Math.min(e.height-1,Math.floor(l))),d=Math.min(e.height-1,c+1),p=Math.max(0,Math.min(1,l-c));for(let f=0;f<n;f++){const m=(f+.5)*o-.5,y=Math.max(0,Math.min(e.width-1,Math.floor(m))),w=Math.min(e.width-1,y+1),b=Math.max(0,Math.min(1,m-y));for(let x=0;x<3;x++){const M=2-x,v=(c*e.width+y)*e.channels+M,I=(c*e.width+w)*e.channels+M,E=(d*e.width+y)*e.channels+M,k=(d*e.width+w)*e.channels+M,S=e.data[v]*(1-b)+e.data[I]*b,R=e.data[E]*(1-b)+e.data[k]*b,B=S*(1-p)+R*p;a[x*i+u*n+f]=(B/255-.5)/.5}}}return{tensor:a,width:n,height:r}}function n_(e,t,n){const r=new Uint8Array(e.length);for(let i=0;i<n;i++){const a=i===n-1;for(let o=0;o<t;o++){const s=i*t+o;let u=e[s];if(o+1<t&&e[s+1]>u&&(u=e[s+1]),!a){const l=s+t;e[l]>u&&(u=e[l]),o+1<t&&e[l+1]>u&&(u=e[l+1])}r[s]=u}}return r}function r_(e){if(e.length<3)return e;const t=[...e].sort((a,o)=>a[0]-o[0]||a[1]-o[1]),n=(a,o,s)=>(o[0]-a[0])*(s[1]-a[1])-(o[1]-a[1])*(s[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(let a=t.length-1;a>=0;a--){const o=t[a];for(;i.length>=2&&n(i[i.length-2],i[i.length-1],o)<=0;)i.pop();i.push(o)}return r.pop(),i.pop(),r.concat(i)}function i_(e){if(e.length===1)return{cx:e[0][0],cy:e[0][1],w:0,h:0,angle:0};let t=null,n=1/0;for(let r=0;r<e.length;r++){const[i,a]=e[r],[o,s]=e[(r+1)%e.length],u=o-i,l=s-a,c=Math.hypot(u,l);if(c===0)continue;const d=u/c,p=l/c;let f=1/0,m=-1/0,y=1/0,w=-1/0;for(const[v,I]of e){const E=v*d+I*p,k=-v*p+I*d;E<f&&(f=E),E>m&&(m=E),k<y&&(y=k),k>w&&(w=k)}const b=m-f,x=w-y,M=b*x;if(M<n){n=M;const v=(f+m)/2,I=(y+w)/2;t={cx:v*d-I*p,cy:v*p+I*d,w:b,h:x,angle:Math.atan2(p,d)}}}return t}function o_(e,t,n,r){const i=Math.cos(r.angle),a=Math.sin(r.angle),o=r.w/2,s=r.h/2,u=Math.abs(o*i)+Math.abs(s*a),l=Math.abs(o*a)+Math.abs(s*i),c=Math.max(0,Math.floor(r.cx-u)),d=Math.min(t-1,Math.ceil(r.cx+u)),p=Math.max(0,Math.floor(r.cy-l)),f=Math.min(n-1,Math.ceil(r.cy+l));let m=0,y=0;for(let w=p;w<=f;w++)for(let b=c;b<=d;b++){const x=b-r.cx,M=w-r.cy,v=x*i+M*a,I=-x*a+M*i;Math.abs(v)<=o&&Math.abs(I)<=s&&(m+=e[w*t+b],y+=1)}return y===0?0:m/y}function a_(e){const t=Math.cos(e.angle),n=Math.sin(e.angle),r=e.w/2,i=e.h/2,o=[...[[e.cx+-r*t- -i*n,e.cy+-r*n+-i*t],[e.cx+r*t- -i*n,e.cy+r*n+-i*t],[e.cx+r*t-i*n,e.cy+r*n+i*t],[e.cx+-r*t-i*n,e.cy+-r*n+i*t]]].sort((y,w)=>y[0]-w[0]),[s,u,l,c]=o,[d,p]=s[1]<=u[1]?[s,u]:[u,s],[f,m]=l[1]<=c[1]?[l,c]:[c,l];return[[d[0],d[1]],[f[0],f[1]],[m[0],m[1]],[p[0],p[1]]]}function s_(e,t,n,r){const{width:i,height:a}=t;let o=new Uint8Array(i*a);for(let f=0;f<o.length;f++)o[f]=e[f]>Xb?255:0;o=n_(o,i,a);const s={width:i,height:a,data:o},{labels:u}=ma(s),l=new Map;for(let f=0;f<a;f++)for(let m=0;m<i;m++){const y=u[f*i+m];if(y===0)continue;let w=l.get(y);w===void 0&&(w=new Map,l.set(y,w));const b=w.get(f);b===void 0?w.set(f,[m,m]):(m<b[0]&&(b[0]=m),m>b[1]&&(b[1]=m))}const c=n/i,d=r/a,p=[];for(const[f,m]of l){const y=[];for(const[B,[Y,G]]of m)y.push([Y-.5,B-.5],[Y-.5,B+.5],[G+.5,B-.5],[G+.5,B+.5]);const w=i_(r_(y));if(Math.min(w.w,w.h)<Jb)continue;const b=o_(e,i,a,w);if(b<Qb)continue;const x=w.w*w.h*Zb/(2*(w.w+w.h)),M={...w,w:w.w+2*x,h:w.h+2*x};if(Math.min(M.w,M.h)<e_+2)continue;const I=a_(M).map(([B,Y])=>[Math.min(n,Math.max(0,Math.round(B*c))),Math.min(r,Math.max(0,Math.round(Y*d)))]),E=I.map(B=>B[0]),k=I.map(B=>B[1]),S=Math.min(...E),R=Math.min(...k);p.push({quad:I,x:S,y:R,width:Math.max(...E)-S,height:Math.max(...k)-R,score:b})}return p.sort((f,m)=>m.score-f.score)}function u_(e,t){const[n,r,i,a]=t,o=Math.max(1,Math.round(Math.max(Math.hypot(r[0]-n[0],r[1]-n[1]),Math.hypot(i[0]-a[0],i[1]-a[1])))),s=Math.max(1,Math.round(Math.max(Math.hypot(a[0]-n[0],a[1]-n[1]),Math.hypot(i[0]-r[0],i[1]-r[1])))),u=l_([[0,0],[o,0],[o,s],[0,s]],[n,r,i,a]),l=new Uint8Array(o*s*e.channels);for(let d=0;d<s;d++)for(let p=0;p<o;p++){const f=u[6]*p+u[7]*d+u[8],m=(u[0]*p+u[1]*d+u[2])/f,y=(u[3]*p+u[4]*d+u[5])/f,w=Math.floor(m),b=Math.floor(y),x=m-w,M=y-b,v=Math.max(0,Math.min(e.width-1,w)),I=Math.max(0,Math.min(e.width-1,w+1)),E=Math.max(0,Math.min(e.height-1,b)),k=Math.max(0,Math.min(e.height-1,b+1));for(let S=0;S<e.channels;S++){const R=e.data[(E*e.width+v)*e.channels+S],B=e.data[(E*e.width+I)*e.channels+S],Y=e.data[(k*e.width+v)*e.channels+S],G=e.data[(k*e.width+I)*e.channels+S],q=R*(1-x)+B*x,N=Y*(1-x)+G*x;l[(d*o+p)*e.channels+S]=Math.round(q*(1-M)+N*M)}}const c={width:o,height:s,channels:e.channels,data:l};return s/o>=1.5?Kt(c,3):c}function l_(e,t){const n=[],r=[];for(let i=0;i<4;i++){const[a,o]=e[i],[s,u]=t[i];n.push([a,o,1,0,0,0,-s*a,-s*o]),r.push(s),n.push([0,0,0,a,o,1,-u*a,-u*o]),r.push(u)}for(let i=0;i<8;i++){let a=i;for(let s=i+1;s<8;s++)Math.abs(n[s][i])>Math.abs(n[a][i])&&(a=s);[n[i],n[a]]=[n[a],n[i]],[r[i],r[a]]=[r[a],r[i]];const o=n[i][i];for(let s=i;s<8;s++)n[i][s]/=o;r[i]/=o;for(let s=0;s<8;s++){if(s===i)continue;const u=n[s][i];if(u!==0){for(let l=i;l<8;l++)n[s][l]-=u*n[i][l];r[s]-=u*r[i]}}}return[r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],1]}function Kt(e,t){const n=(t%4+4)%4;if(n===0)return e;const{width:r,height:i,channels:a,data:o}=e,s=n%2===0?r:i,u=n%2===0?i:r,l=new Uint8Array(s*u*a);for(let c=0;c<i;c++)for(let d=0;d<r;d++){let p,f;n===1?(p=i-1-c,f=d):n===2?(p=r-1-d,f=i-1-c):(p=c,f=r-1-d);const m=(c*r+d)*a,y=(f*s+p)*a;for(let w=0;w<a;w++)l[y+w]=o[m+w]}return{width:s,height:u,channels:a,data:l}}const c_=.6;(()=>{const e=new Uint8Array(256);for(let t=0;t<256;t++)e[t]=Math.min(255,Math.round(Math.pow(t/255,c_)*255));return e})();const Yt=48,d_=320;function h_(e){return["blank",...e.characters," "]}function p_(e,t,n){let r="";const i=[];for(let o=0;o<e.length;o++){const s=e[o];s!==0&&(o>0&&e[o-1]===s||(r+=n[s]??"",i.push(t[o])))}if(i.length===0)return["",0];const a=i.reduce((o,s)=>o+s,0)/i.length;return[r,a]}function f_(e,t){const n=Math.trunc(Yt*t),r=e.width/e.height,i=Math.ceil(Yt*r)>n?n:Math.ceil(Yt*r),a=new Float32Array(3*Yt*n),o=Yt*n,s=e.width/i,u=e.height/Yt;for(let l=0;l<Yt;l++){const c=(l+.5)*u-.5,d=Math.max(0,Math.min(e.height-1,Math.floor(c))),p=Math.min(e.height-1,d+1),f=Math.max(0,Math.min(1,c-d));for(let m=0;m<i;m++){const y=(m+.5)*s-.5,w=Math.max(0,Math.min(e.width-1,Math.floor(y))),b=Math.min(e.width-1,w+1),x=Math.max(0,Math.min(1,y-w));for(let M=0;M<3;M++){const v=2-M,I=(d*e.width+w)*e.channels+v,E=(d*e.width+b)*e.channels+v,k=(p*e.width+w)*e.channels+v,S=(p*e.width+b)*e.channels+v,R=e.data[I]*(1-x)+e.data[E]*x,B=e.data[k]*(1-x)+e.data[S]*x,Y=R*(1-f)+B*f;a[M*o+l*n+m]=(Y/255-.5)/.5}}}return{tensor:a,width:n}}const m_=62,g_=8,y_=5;function ya(e){return e?e.normalize("NFKD").replace(new RegExp("\\p{M}","gu"),"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim():""}function w_(e,t){const n=e.length,r=t.length;if(n===0||r===0)return 0;let i=new Int32Array(r+1),a=new Int32Array(r+1);for(let o=1;o<=n;o++){for(let s=1;s<=r;s++)a[s]=e[o-1]===t[s-1]?i[s-1]+1:Math.max(i[s],a[s-1]);[i,a]=[a,i]}return i[r]}function Yr(e,t){return e.length===0&&t.length===0?100:200*w_(e,t)/(e.length+t.length)}function gm(e,t){const n=r=>r.split(/\s+/).filter(Boolean).sort().join(" ");return Yr(n(e),n(t))}function b_(e,t){const n=new Set(e.split(/\s+/).filter(Boolean)),r=new Set(t.split(/\s+/).filter(Boolean)),i=[...n].filter(c=>r.has(c)).sort(),a=[...n].filter(c=>!r.has(c)).sort(),o=[...r].filter(c=>!n.has(c)).sort(),s=i.join(" "),u=[s,a.join(" ")].filter(Boolean).join(" "),l=[s,o.join(" ")].filter(Boolean).join(" ");return s.length>0&&(a.length===0||o.length===0)?100:Math.max(Yr(s,u),Yr(s,l),Yr(u,l))}function __(e){const t=new Set,n=[];for(const r of e){const i=r.nameFr??r.name;for(const a of[ya(i),ya(r.name)])if(a)for(const o of[a,a.replace(/ /g,"")])o&&!t.has(o)&&(t.add(o),n.push({key:o,id:r.id,display:i,...r.kind!==void 0?{kind:r.kind}:{}}))}return n}function x_(e,t){const n=ya(e);if(!n||t.length===0)return null;const i=__(t).map(c=>({...c,score:b_(n,c.key)})).sort((c,d)=>d.score-c.score).slice(0,g_).filter(c=>c.score>=m_);if(i.length===0)return null;const a=i[0].score,o=i.filter(c=>a-c.score<=y_),s=[...new Set(n.split(/\s+/).filter(Boolean))].join(" ");let u=o[0],l=[gm(s,u.key),u.score];for(const c of o.slice(1)){const d=[gm(s,c.key),c.score];(d[0]>l[0]||d[0]===l[0]&&d[1]>l[1])&&(u=c,l=d)}return{id:u.id,name:u.display,...u.kind!==void 0?{kind:u.kind}:{},confidence:Math.round(u.score/100*1e4)/1e4}}const ym=5e3,wa=.75,wm=15,$_=1.25,v_=2.4,M_=.003,S_=.85,I_=4,ba=2600,_a=2,xa=.3,bm=.1,_m=.012,T_=22,xm=.5,Xr=.12;function tt(e,t){const n=new e.Mat(t.height,t.width,e.CV_8UC3),r=n.data,i=t.channels;for(let a=0,o=t.width*t.height;a<o;a++)r[a*3]=t.data[a*i],r[a*3+1]=t.data[a*i+1],r[a*3+2]=t.data[a*i+2];return n}function E_(e,t,n,r){const i=r.map(J=>J[0]),a=r.map(J=>J[1]),o=i.reduce((J,me)=>J+me,0)/i.length,s=a.reduce((J,me)=>J+me,0)/a.length,u=Math.max(Math.max(...i)-Math.min(...i),Math.max(...a)-Math.min(...a));if(u<4)return null;const l=u*I_,c=Math.max(0,Math.trunc(o-l)),d=Math.min(n.width,Math.trunc(o+l)),p=Math.max(0,Math.trunc(s-l)),f=Math.min(n.height,Math.trunc(s+l));if(d-c<8||f-p<8)return null;const m=Math.max(n.width,n.height)<ba?_a:1,y=tt(e,n),w=tt(e,t),b=new e.Rect(c,p,d-c,f-p),x=y.roi(b),M=new e.Mat;m!==1?e.resize(x,M,new e.Size(0,0),m,m,e.INTER_CUBIC):x.copyTo(M);const v=new e.Mat,I=new e.Mat;e.cvtColor(w,v,e.COLOR_RGB2GRAY),e.cvtColor(M,I,e.COLOR_RGB2GRAY);const E=new e.ORB(ym),k=new e.KeyPointVector,S=new e.KeyPointVector,R=new e.Mat,B=new e.Mat,Y=new e.Mat,G=[y,w,x,M,v,I,k,S,R,B,Y],q=J=>{for(const me of G)try{me.delete()}catch{}try{E.delete()}catch{}return J};if(E.detectAndCompute(v,Y,k,R),E.detectAndCompute(I,Y,S,B),R.rows<8||B.rows<8)return q(null);const N=new e.BFMatcher(e.NORM_HAMMING),F=new e.DMatchVectorVector;N.knnMatch(R,B,F,2);const X=[],Z=[];for(let J=0;J<F.size();J++){const me=F.get(J);if(me.size()===2){const Te=me.get(0),W=me.get(1);if(Te.distance<wa*W.distance){const ee=k.get(Te.queryIdx).pt,ne=S.get(Te.trainIdx).pt;X.push(ee.x,ee.y),Z.push(ne.x,ne.y)}}}if(F.delete(),N.delete(),X.length/2<8)return q(null);const le=e.matFromArray(X.length/2,1,e.CV_32FC2,X),L=e.matFromArray(Z.length/2,1,e.CV_32FC2,Z),O=new e.Mat,C=e.findHomography(le,L,e.RANSAC,5,O);let z=0;for(let J=0;J<O.rows;J++)z+=O.data[J];const U=C.rows===3?[...C.data64F]:null;if(le.delete(),L.delete(),O.delete(),C.delete(),U===null||z<wm)return q(null);const P=1/m,j=[[P,0,c],[0,P,p],[0,0,1]],ie=[0,1,2].map(J=>[0,1,2].map(me=>j[J][0]*U[me]+j[J][1]*U[3+me]+j[J][2]*U[6+me]));return q({H:ie,inliers:z})}function $a(e,t,n){if(e.length!==4||e.some(u=>!Number.isFinite(u[0])||!Number.isFinite(u[1])))return!1;let r=0;for(let u=0;u<4;u++){const[l,c]=e[u],[d,p]=e[(u+1)%4];r+=l*p-d*c}const i=Math.abs(r/2)/(t*n);if(i<M_||i>S_)return!1;const a=e.map((u,l)=>{const c=e[(l+1)%4];return Math.hypot(c[0]-u[0],c[1]-u[1])}),o=Math.min(...a);if(o<1)return!1;const s=Math.max(...a)/o;return s>=$_&&s<=v_}function va(e,t,n){const r=e[2][0]*t+e[2][1]*n+e[2][2];return[(e[0][0]*t+e[0][1]*n+e[0][2])/r,(e[1][0]*t+e[1][1]*n+e[1][2])/r]}function Ma(e,t,n,r){const i=n.width,a=n.height,o=Math.max(8,Math.trunc(xa*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=r.map(G=>[G[0],G[1],G[2]-o*(G[0]+G[1])+0]);for(let G=0;G<3;G++)l[G][2]=r[G][2]-o*r[G][0]-o*r[G][1];const c=tt(e,t),d=new e.Mat,p=e.matFromArray(3,3,e.CV_64F,l.flat());e.warpPerspective(c,d,p,new e.Size(s,u),e.WARP_INVERSE_MAP);const f=new e.Mat;e.cvtColor(d,f,e.COLOR_RGB2Lab),c.delete(),p.delete();const m=f.data,y=Math.max(4,Math.trunc(o/3)),w=[[],[],[]],b=(G,q)=>{const N=(q*s+G)*3;w[0].push(m[N]),w[1].push(m[N+1]),w[2].push(m[N+2])};for(let G=0;G<u;G++)for(let q=0;q<s;q++)(G<y||G>=u-y||q<y||q>=s-y)&&b(q,G);const x=G=>{G.sort((N,F)=>N-F);const q=G.length>>1;return G.length%2?G[q]:(G[q-1]+G[q])/2},M=[x(w[0]),x(w[1]),x(w[2])],v=(G,q)=>{const N=(q*s+G)*3,F=m[N]-M[0],X=m[N+1]-M[1],Z=m[N+2]-M[2];return Math.sqrt(F*F+X*X+Z*Z)>T_},I=Math.max(6,Math.trunc(bm*i)),E=Math.max(6,Math.trunc(bm*a)),k=Math.max(2,Math.trunc(_m*i)),S=Math.max(2,Math.trunc(_m*a)),R=G=>{let q=0,N=0;for(const F of G)N=F?N+1:0,N>q&&(q=N);return q/Math.max(1,G.length)},B=G=>{let q,N,F,X,Z;if(G==="L"?(q=o,N=o+a,F=Math.max(0,o-k-I),X=Math.max(0,o-k),Z=!1):G==="R"?(q=o,N=o+a,F=o+i+k,X=Math.min(s,o+i+k+I),Z=!1):(q=Math.max(0,o-S-E),N=Math.max(0,o-S),F=o,X=o+i,Z=!0),N<=q||X<=F)return 0;const le=[];if(Z)for(let L=F;L<X;L++){let O=0;for(let C=q;C<N;C++)v(L,C)&&O++;le.push(O/(N-q)>xm)}else for(let L=q;L<N;L++){let O=0;for(let C=F;C<X;C++)v(C,L)&&O++;le.push(O/(X-F)>xm)}return R(le)},Y={L:B("L"),R:B("R"),T:B("T")};return d.delete(),f.delete(),Y}const k_=6e3,C_=8,$m=.5,A_=.6;function R_(e,t,n,r){if(n.size===0)return[];const i=Math.max(t.width,t.height)<ba?_a:1,a=tt(e,t),o=new e.Mat;i!==1?e.resize(a,o,new e.Size(0,0),i,i,e.INTER_CUBIC):a.copyTo(o);const s=new e.Mat;e.cvtColor(o,s,e.COLOR_RGB2GRAY),a.delete(),o.delete();const u=new e.ORB(k_),l=new e.Mat,c=new e.KeyPointVector,d=new e.Mat;u.detectAndCompute(s,l,c,d);const p=[],f=new e.BFMatcher(e.NORM_HAMMING);try{if(d.rows<8)return p;for(const[m,y]of n){if(r!==void 0&&Date.now()>r)break;const w=tt(e,y),b=new e.Mat;e.cvtColor(w,b,e.COLOR_RGB2GRAY);const x=new e.KeyPointVector,M=new e.Mat;u.detectAndCompute(b,l,x,M);const v=[w,x,M],I=()=>{for(const ie of v)ie.delete();b.delete()};if(M.rows<8){I();continue}const E=new e.DMatchVectorVector;f.knnMatch(M,d,E,2);const k=[],S=[];for(let ie=0;ie<E.size();ie++){const J=E.get(ie);if(J.size()===2){const me=J.get(0);if(me.distance<wa*J.get(1).distance){const Te=x.get(me.queryIdx).pt,W=c.get(me.trainIdx).pt;k.push(Te.x,Te.y),S.push(W.x,W.y)}}}if(E.delete(),k.length/2<8){I();continue}const R=e.matFromArray(k.length/2,1,e.CV_32FC2,k),B=e.matFromArray(S.length/2,1,e.CV_32FC2,S),Y=new e.Mat,G=e.findHomography(R,B,e.RANSAC,5,Y);let q=0;for(let ie=0;ie<Y.rows;ie++)q+=Y.data[ie];const N=G.rows===3?[...G.data64F]:null;if(R.delete(),B.delete(),Y.delete(),G.delete(),N===null||q<C_){I();continue}const F=1/i,X=[[F*N[0],F*N[1],F*N[2]],[F*N[3],F*N[4],F*N[5]],[N[6],N[7],N[8]]],Z=[[0,0],[y.width,0],[y.width,y.height],[0,y.height]].map(([ie,J])=>va(X,ie,J));if(!$a(Z,t.width,t.height)){I();continue}const le=tt(e,t),L=e.matFromArray(3,3,e.CV_64F,X.flat()),O=new e.Mat;e.warpPerspective(le,O,L,new e.Size(y.width,y.height),e.WARP_INVERSE_MAP);const C=new e.Mat;e.cvtColor(O,C,e.COLOR_RGB2GRAY);const z=new e.Mat;e.matchTemplate(C,b,z,e.TM_CCOEFF_NORMED);const U=z.data32F[0];if(le.delete(),L.delete(),O.delete(),C.delete(),z.delete(),U<$m){I();continue}const P=Ma(e,t,y,X),j=Sa(P);p.push({id:m,confidence:Math.max(0,U),footprint:Z,built:P!==null&&Math.max(P.L,P.R,P.T)>=Xr,tuckRegion:Qr(Z,j)}),I()}}finally{s.delete(),l.delete(),c.delete(),d.delete();try{u.delete(),f.delete()}catch{}}return p}function Sa(e){return e!==null&&e.R>=Xr?["R"]:[]}function Qr(e,t){if(e.length<4||t.length===0)return null;const n=e.map(y=>[y[0],y[1]]),r=Math.hypot(n[1][0]-n[0][0],n[1][1]-n[0][1]),i=Math.hypot(n[2][0]-n[3][0],n[2][1]-n[3][1]),a=.5*(r+i),o=xa*a;if(!(o>0))return null;const s=n.reduce((y,w)=>y+w[0],0)/n.length,u=n.reduce((y,w)=>y+w[1],0)/n.length,l={T:[0,1],R:[1,2],L:[0,3]},c=[...n];for(const y of["L","R","T"]){if(!t.includes(y))continue;const[w,b]=l[y],x=n[w],M=n[b];let v=-(M[1]-x[1]),I=M[0]-x[0];const E=(x[0]+M[0])/2,k=(x[1]+M[1])/2;v*(E-s)+I*(k-u)<0&&(v=-v,I=-I);const S=Math.hypot(v,I);S<=1e-6||(v=v/S*o,I=I/S*o,c.push([x[0]+v,x[1]+I],[M[0]+v,M[1]+I]))}const d=c.map(y=>y[0]),p=c.map(y=>y[1]),f=Math.round(Math.min(...d)),m=Math.round(Math.min(...p));return{x:f,y:m,width:Math.round(Math.max(...d))-f,height:Math.round(Math.max(...p))-m}}function O_(e,t,n,r){const i=E_(e,n,t,r);if(i===null)return null;const o=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([l,c])=>va(i.H,l,c));if(!$a(o,t.width,t.height))return null;const s=Ma(e,t,n,i.H);if(s===null)return null;const u=Sa(s);return{built:Math.max(s.L,s.R,s.T)>=Xr,footprint:o,overflow:u,edgeScores:s,inliers:i.inliers}}const N_=.88;function Ia(e,t,n,r){if(r.length!==4)return null;const i=n.width,a=n.height,o=Math.max(8,Math.trunc(xa*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=o+Math.trunc(i*N_),c=s-l;if(c<1)return null;const d=tt(e,t),p=e.matFromArray(4,1,e.CV_32FC2,[0,0,i,0,i,a,0,a]),f=e.matFromArray(4,1,e.CV_32FC2,[r[0][0],r[0][1],r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]),m=e.getPerspectiveTransform(p,f),y=[...m.data64F],w=[0,1,2].flatMap(k=>[y[k*3],y[k*3+1],y[k*3+2]-o*y[k*3]-o*y[k*3+1]]),b=e.matFromArray(3,3,e.CV_64F,w),x=new e.Mat;e.warpPerspective(d,x,b,new e.Size(s,u),e.WARP_INVERSE_MAP);const M=x.roi(new e.Rect(l,0,c,u)),v=new e.Mat;M.copyTo(v);const I=v.data,E=new Uint8ClampedArray(c*u*3);E.set(I.subarray(0,E.length));for(const k of[d,p,f,m,b,x,M,v])try{k.delete()}catch{}return{width:c,height:u,channels:3,data:E}}function z_(e,t,n,r){const[i,a,o,s]=r;if(o<8||s<8)return null;const u=Math.trunc(.06*o),l=Math.trunc(.06*s),c=Math.max(0,Math.trunc(i-u)),d=Math.min(n.width,Math.trunc(i+o+u)),p=Math.max(0,Math.trunc(a-l)),f=Math.min(n.height,Math.trunc(a+s+l));if(d-c<8||f-p<8)return null;const m=Math.max(n.width,n.height)<ba?_a:1,y=tt(e,n),w=tt(e,t),b=y.roi(new e.Rect(c,p,d-c,f-p)),x=new e.Mat;m!==1?e.resize(b,x,new e.Size(0,0),m,m,e.INTER_CUBIC):b.copyTo(x);const M=new e.Mat,v=new e.Mat;e.cvtColor(w,M,e.COLOR_RGB2GRAY),e.cvtColor(x,v,e.COLOR_RGB2GRAY);const I=new e.ORB(ym),E=new e.KeyPointVector,k=new e.KeyPointVector,S=new e.Mat,R=new e.Mat,B=new e.Mat,Y=[y,w,b,x,M,v,E,k,S,R,B],G=ie=>{for(const J of Y)try{J.delete()}catch{}try{I.delete()}catch{}return ie};if(I.detectAndCompute(M,B,E,S),I.detectAndCompute(v,B,k,R),S.rows<8||R.rows<8)return G(null);const q=new e.BFMatcher(e.NORM_HAMMING),N=new e.DMatchVectorVector;q.knnMatch(S,R,N,2);const F=[],X=[];for(let ie=0;ie<N.size();ie++){const J=N.get(ie);if(J.size()===2){const me=J.get(0),Te=J.get(1);if(me.distance<wa*Te.distance){const W=E.get(me.queryIdx).pt,ee=k.get(me.trainIdx).pt;F.push(W.x,W.y),X.push(ee.x,ee.y)}}}if(N.delete(),q.delete(),F.length/2<8)return G(null);const Z=e.matFromArray(F.length/2,1,e.CV_32FC2,F),le=e.matFromArray(X.length/2,1,e.CV_32FC2,X),L=new e.Mat,O=e.findHomography(Z,le,e.RANSAC,5,L);let C=0;for(let ie=0;ie<L.rows;ie++)C+=L.data[ie];const z=O.rows===3?[...O.data64F]:null;if(Z.delete(),le.delete(),L.delete(),O.delete(),z===null||C<wm)return G(null);const U=1/m,P=[[U,0,c],[0,U,p],[0,0,1]],j=[0,1,2].map(ie=>[0,1,2].map(J=>P[ie][0]*z[J]+P[ie][1]*z[3+J]+P[ie][2]*z[6+J]));return G({H:j,inliers:C})}const B_=620;function P_(e,t){return{width:t.cols,height:t.rows,channels:3,data:new Uint8Array(t.data.slice(0,t.rows*t.cols*3))}}function vm(e,t,n,r){const i=Mm(e,t,n,r);if(i!==null)return i;try{const[a,o,s,u]=r.map(I=>Math.trunc(I));if(Math.min(s,u)>=B_||s<=0||u<=0)return null;const l=Math.trunc(s*.25),c=Math.trunc(u*.25),d=Math.max(0,a-l),p=Math.max(0,o-c),f=Math.min(t.width,a+s+l),m=Math.min(t.height,o+u+c);if(f<=d||m<=p)return null;const y=tt(e,t),w=y.roi(new e.Rect(d,p,f-d,m-p)),b=new e.Mat;e.resize(w,b,new e.Size((f-d)*2,(m-p)*2),0,0,e.INTER_CUBIC);const x=P_(e,b);for(const I of[y,w,b])try{I.delete()}catch{}const M=[(a-d)*2,(o-p)*2,s*2,u*2],v=Mm(e,x,n,M);return v===null?null:{...v,footprint:v.footprint.map(([I,E])=>[I*.5+d,E*.5+p])}}catch{return null}}function Mm(e,t,n,r){const i=z_(e,n,t,r);if(i===null)return null;const o=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([b,x])=>va(i.H,b,x));if(!$a(o,t.width,t.height))return null;const s=tt(e,t),u=e.matFromArray(3,3,e.CV_64F,i.H.flat()),l=new e.Mat;e.warpPerspective(s,l,u,new e.Size(n.width,n.height),e.WARP_INVERSE_MAP);const c=tt(e,n),d=new e.Mat,p=new e.Mat;e.cvtColor(l,d,e.COLOR_RGB2GRAY),e.cvtColor(c,p,e.COLOR_RGB2GRAY);const f=new e.Mat;e.matchTemplate(d,p,f,e.TM_CCOEFF_NORMED);const m=f.data32F[0];for(const b of[s,u,l,c,d,p,f])try{b.delete()}catch{}if(m<$m)return null;const y=Ma(e,t,n,i.H);if(y===null)return null;const w=Sa(y);return{built:Math.max(y.L,y.R,y.T)>=Xr,footprint:o,overflow:w,edgeScores:y,inliers:i.inliers}}function D_(e,t,n,r=.03){let i=null,a=1/0;for(const o of e){const[s,u,l,c]=o;if(l<=0||c<=0)continue;const d=r*l,p=r*c;if(t>=s-d&&t<=s+l+d&&n>=u-p&&n<=u+c+p){const f=l*c;f<a&&(a=f,i=[s,u,l,c])}}return i}const U_=.3,L_=.3;function F_(e,t){const n=e.filter(a=>a.edgeScores!==null);if(n.length===0)return[];const r=n.length>=2&&n.every(a=>{const{L:o,R:s,T:u}=a.edgeScores;return Math.min(o,s,u)>=U_}),i=[];return e.forEach((a,o)=>{if(!a.built||a.edgeScores===null)return;const{L:s,R:u,T:l}=a.edgeScores,c=Math.max(s,u,l)<L_;if(!r&&!c)return;t.some(([p,f])=>p>=a.zone.x0&&p<=a.zone.x1&&f>=a.zone.y0&&f<=a.zone.y1)||i.push(o)}),i}const gt=128,Wn=.5;function Zr(e){const t=Fn(e,gt,gt),n=gt*gt,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function Ta(e){const t=e[1]??0;return{built:t>=Wn,prob:t}}const mr=120,gr=179,G_=1.3,W_=3.6,q_=.45,V_=6e-4,H_=.02,j_=6e3,K_=.78,Y_=1.25,X_=2.4,Q_=.05,Z_=1.5,J_=.5,e1=.9,t1=150,n1=18,r1=34,i1=90,o1=130,a1=.13,s1=.15,Jr="magistrates-guild",Ea="merchants-guild";function u1(e,t){const n=tt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2HSV),n.delete();const i=new e.Mat(r.rows,r.cols,r.type(),[mr,30,40,0]),a=new e.Mat(r.rows,r.cols,r.type(),[gr,255,205,255]),o=new e.Mat;e.inRange(r,i,a,o),r.delete(),i.delete(),a.delete();const s=new Uint8Array(o.data),u=e.getStructuringElement(e.MORPH_RECT,new e.Size(31,31)),l=new e.Mat;e.morphologyEx(o,l,e.MORPH_CLOSE,u),o.delete(),u.delete();const c=new e.Mat,d=new e.Mat,p=new e.Mat,f=e.connectedComponentsWithStats(l,c,d,p,8);l.delete(),c.delete(),p.delete();const m=t.width*t.height,y=[];for(let w=1;w<f;w++){const b=d.intAt(w,0),x=d.intAt(w,1),M=d.intAt(w,2),v=d.intAt(w,3),I=d.intAt(w,4),E=I/m;E<V_||E>H_||I/Math.max(M*v,1)<q_||y.push({x:b,y:x,w:M,h:v})}return d.delete(),{blobs:y,mask:s,maskWidth:t.width}}function l1(e,t,n,r,i,a,o){const s=e,u=a,l=o,c=i;if(!c.gray){const U=tt(e,r);c.gray=new s.Mat,s.cvtColor(U,c.gray,s.COLOR_RGB2GRAY),U.delete(),c.k=new s.KeyPointVector,c.d=new s.Mat;const P=new s.Mat;u.detectAndCompute(c.gray,P,c.k,c.d),P.delete()}const d=n,p=new s.Mat,f=new s.KeyPointVector,m=new s.Mat;u.detectAndCompute(d,p,f,m),p.delete();const y=U=>(f.delete(),m.delete(),U);if(c.d.rows<8||m.rows<8)return y(null);const w=new s.DMatchVectorVector;l.knnMatch(c.d,m,w,2);const b=[],x=[];for(let U=0;U<w.size();U++){const P=w.get(U);if(P.size()===2){const j=P.get(0);if(j.distance<K_*P.get(1).distance){const ie=c.k.get(j.queryIdx).pt,J=f.get(j.trainIdx).pt;b.push(ie.x,ie.y),x.push(J.x,J.y)}}}if(w.delete(),b.length/2<8)return y(null);const M=s.matFromArray(b.length/2,1,s.CV_32FC2,b),v=s.matFromArray(x.length/2,1,s.CV_32FC2,x),I=new s.Mat,E=s.findHomography(M,v,s.RANSAC,5,I);if(M.delete(),v.delete(),I.delete(),E.rows!==3)return E.delete(),y(null);const k=[...E.data64F],S=(U,P)=>{const j=k[6]*U+k[7]*P+k[8];return[(k[0]*U+k[1]*P+k[2])/j,(k[3]*U+k[4]*P+k[5])/j]},R=[[0,0],[r.width,0],[r.width,r.height],[0,r.height]].map(([U,P])=>S(U,P));if(R.some(U=>!Number.isFinite(U[0])||!Number.isFinite(U[1])))return E.delete(),y(null);const B=R.map((U,P)=>{const j=R[(P+1)%4];return Math.hypot(j[0]-U[0],j[1]-U[1])}),Y=Math.min(...B);if(Y<1)return E.delete(),y(null);const G=Math.max(...B)/Y;let q=0;for(let U=0;U<4;U++){const[P,j]=R[U],[ie,J]=R[(U+1)%4];q+=P*J-ie*j}const N=t,F=Math.abs(q/2)/(N.rows*N.cols);if(G<Y_||G>X_||F<Q_||F>Z_)return E.delete(),y(null);const X=new s.Mat;s.warpPerspective(N,X,E,new s.Size(r.width,r.height),s.WARP_INVERSE_MAP),E.delete();const Z=new s.Mat;s.cvtColor(X,Z,s.COLOR_RGB2GRAY),X.delete();const le=Math.trunc(r.height/2),L=Z.roi(new s.Rect(0,0,r.width,le)),O=c.gray.roi(new s.Rect(0,0,r.width,le)),C=new s.Mat;s.matchTemplate(L,O,C,s.TM_CCOEFF_NORMED);const z=C.data32F[0];return L.delete(),O.delete(),C.delete(),Z.delete(),y(z)}function c1(e,t,n){let r,i;if(n===Jr)r=Ea,i=a1;else if(n===Ea)r=Jr,i=s1;else return null;const{x:a,y:o,w:s,h:u}=t;if(s<8||u<8)return null;const l=Math.trunc(s/2);let c=0,d=null;for(const[p,f]of[[0,l],[l,s]]){let m=0,y=0;for(let b=o;b<o+u;b++)for(let x=a+p;x<a+f;x++){const M=(b*e.width+x)*e.channels,{h:v,s:I,v:E}=kt(e.data[M],e.data[M+1],e.data[M+2]);if(v>=mr&&v<=gr&&I>=30&&I<=170&&E<=170)continue;m++,(r===Ea?v>=n1&&v<=r1&&I>=i1&&E>=o1:v>=95&&v<=130&&I>=80)&&y++}if(m<20)continue;const w=y/m;w>c&&(c=w,d={x:a+p,y:o,w:f-p,h:u})}return c>=i&&d!==null?{id:r,box:d}:null}const d1=1.7,h1=140,p1=170,f1=.2,m1=.1,Sm=240,Im=80,Tm=60,g1=50,Em="scientists-guild",km="tacticians-guild",ei=["shipowners-guild","merchants-guild","builders-guild","moneylenders-guild"];function y1(e,t,n){const{x:r,y:i,w:a,h:o}=n,s=new Float32Array(o);for(let v=0;v<o;v++){let I=0;for(let E=0;E<a;E++)e[(i+v)*t+r+E]>0&&I++;s[v]=I/a}const u=[];for(let v=0;v<o;v++)s[v]>.3&&u.push(v);if(u.length<5)return[];const l=u[0],c=u[u.length-1],d=c-l;if(d<5)return[];const p=a/d;if(p<G_||p>W_)return[];if(p>=d1)return[{x:r,y:i+l,w:a,h:d}];const f=new Float32Array(o),m=.3*(8*.5-1)+.8,y=[];let w=0;for(let v=-4;v<=4;v++){const I=Math.exp(-(v*v)/(2*m*m));y.push(I),w+=I}for(let v=0;v<o;v++){let I=0;for(let E=-4;E<=4;E++){const k=Math.min(o-1,Math.max(0,v+E));I+=s[k]*y[E+4]}f[v]=I/w}const b=l+Math.trunc(d*.3),x=l+Math.trunc(d*.78);let M=l+Math.trunc(d/2);if(x>b){let v=1/0;for(let I=b;I<x;I++)f[I]<v&&(v=f[I],M=I)}return[{x:r,y:i+l,w:a,h:M-l},{x:r,y:i+M,w:a,h:c-M}]}function w1(e,t){const n=Math.max(0,t.x),r=Math.max(0,t.y),i=Math.min(e.width,t.x+t.w),a=Math.min(e.height,t.y+t.h),o=Math.max(0,i-n),s=Math.max(0,a-r),u=new Uint8Array(o*s*3);for(let l=0;l<s;l++)for(let c=0;c<o;c++){const d=((r+l)*e.width+n+c)*e.channels,p=(l*o+c)*3;u[p]=e.data[d],u[p+1]=e.data[d+1],u[p+2]=e.data[d+2]}return{width:o,height:s,channels:3,data:u}}function b1(e){let t=0,n=0;for(let r=0,i=e.width*e.height;r<i;r++){const a=r*e.channels,{h:o,s,v:u}=kt(e.data[a],e.data[a+1],e.data[a+2]);s>=40&&u>=40&&u<=205&&(t++,o>=h1&&o<=p1&&n++)}return t===0?0:n/t}function _1(e){let t=0;const n=e.width*e.height;for(let r=0;r<n;r++){const i=r*e.channels,{h:a,s:o,v:s}=kt(e.data[i],e.data[i+1],e.data[i+2]);!(a>=mr&&a<=gr)&&o>=70&&s>=50&&t++}return n===0?0:t/n}function Cm(e,t){const n=tt(e,t),r=new e.Mat;e.resize(n,r,new e.Size(Sm,Im),0,0,e.INTER_AREA),n.delete();const i=new Uint8Array(r.data);return r.delete(),{width:Sm,height:Im,channels:3,data:i}}function x1(e){const t=e.width*e.height,n=[0,0,0];for(let a=0;a<t;a++){const o=a*e.channels;n[0]+=e.data[o],n[1]+=e.data[o+1],n[2]+=e.data[o+2]}n[0]/=t,n[1]/=t,n[2]/=t;const r=(n[0]+n[1]+n[2])/3,i=new Uint8Array(t*3);for(let a=0;a<t;a++){const o=a*e.channels;for(let s=0;s<3;s++){const u=n[s]>1e-6?r/n[s]:1;i[a*3+s]=Math.max(0,Math.min(255,Math.round(e.data[o+s]*u)))}}return{width:e.width,height:e.height,channels:3,data:i}}function Am(e,t){const n=x1(t),r=n.width*n.height,i=new Uint8Array(r);let a=0;for(let m=0;m<r;m++){const y=m*3,{h:w,s:b,v:x}=kt(n.data[y],n.data[y+1],n.data[y+2]);!(w>=mr&&w<=gr&&b>=30&&b<=170&&x<=170)&&x>=40&&(i[m]=1,a++)}const o=a<20,s=tt(e,n),u=new e.Mat;e.cvtColor(s,u,e.COLOR_RGB2Lab),s.delete();const l=u.data;let c=0,d=0,p=0,f=0;for(let m=0;m<r;m++)!o&&i[m]===0||(c+=l[m*3]*100/255,d+=l[m*3+1]-128,p+=l[m*3+2]-128,f++);return u.delete(),f===0?[0,0,0]:[c/f,d/f,p/f]}function $1(e){let t=0,n=0,r=0,i=0,a=0;const o=e.width*e.height;for(let u=0;u<o;u++){const l=u*e.channels,{h:c,s:d,v:p}=kt(e.data[l],e.data[l+1],e.data[l+2]);c>=mr&&c<=gr&&d>=30&&d<=170&&p<=170||(t++,d>=70&&p>=50&&(c>=95&&c<=130?n++:c>=35&&c<=92?r++:c<=10?i++:c>=15&&c<=34&&p>=80&&a++))}const s=Math.max(t,1);return{blue:n/s,green:r/s,red:i/s,gold:a/s}}function v1(e){const t=e.width*e.height,n={blue:0,green:0,red:0,gold:0,brown:0,grey:0};for(let r=0;r<t;r++){const i=r*e.channels,{h:a,s:o,v:s}=kt(e.data[i],e.data[i+1],e.data[i+2]);o>=Tm&&s>=g1?(a>=95&&a<=128&&n.blue++,a>=35&&a<=85&&n.green++,(a<=8||a>=170)&&n.red++,a>=18&&a<=34&&n.gold++,a>=4&&a<=17&&s<150&&n.brown++):o<Tm&&s>=70&&s<=235&&n.grey++}for(const r of Object.keys(n))n[r]/=t;return n}function M1(e,t){let n=0,r=0;for(let s=0;s<e.length;s++)n+=e[s],r+=t[s];n/=e.length,r/=t.length;let i=0,a=0,o=0;for(let s=0;s<e.length;s++){const u=e[s]-n,l=t[s]-r;i+=u*l,a+=u*u,o+=l*l}return i/(Math.sqrt(a*o)+1e-6)}function Rm(e,t){const n=tt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2GRAY),n.delete();const i=Float32Array.from(r.data);return r.delete(),i}function S1(e,t){const n=new Map,r=new Map;for(const[i,a]of t){const o=Cm(e,a);n.set(i,Rm(e,o)),ei.includes(i)&&r.set(i,Am(e,o))}return{gray:n,warmLab:r}}function I1(e,t,n){const r=Cm(e,t),i=$1(r);if(i.blue>=.15&&i.blue>i.red&&i.blue>2*i.gold)return Jr;if(i.green>=.08&&i.green>i.blue&&i.green>i.gold)return Em;if(i.red>=.15&&i.red>i.blue&&i.red>1.5*i.gold)return km;const a=v1(r),o={blue:a.blue,green:a.green,red:a.red,gold:a.gold,browngrey:a.brown+a.grey};let s="blue";for(const l of Object.keys(o))o[l]>o[s]&&(s=l);if(o[s]<=0)return"";let u;if(s==="blue")u=Jr;else if(s==="green")u=Em;else if(s==="red")u=km;else{const l=Rm(e,r);let c="",d=-2;for(const p of ei){const f=n.gray.get(p);if(f===void 0)continue;const m=M1(l,f);m>d&&(d=m,c=p)}u=c||ei[0]}if(ei.includes(u)&&n.warmLab.size>0){const l=Am(e,r);let c=u,d=1/0;for(const[p,f]of n.warmLab){const m=Math.hypot(l[0]-f[0],l[1]-f[1],l[2]-f[2]);m<d&&(d=m,c=p)}return c}return u}function T1(e,t,n,r,i){var y;const a=[],{blobs:o,mask:s,maskWidth:u}=u1(e,t);if(o.length===0||n.size===0)return a;const l=e,c=new l.ORB(j_),d=new l.BFMatcher(l.NORM_HAMMING),p=new Map;for(const w of n.keys())p.set(w,{});const f=tt(e,t);let m=null;try{for(const w of o){if(r!==void 0&&Date.now()>r)break;const b=w.x+Math.trunc(w.w/2),x=w.y+Math.trunc(w.h/2),M=Math.max(t1,Math.trunc(e1*Math.max(w.w,w.h))),v=Math.max(0,b-M),I=Math.max(0,x-M),E=Math.min(t.width,b+M),k=Math.min(t.height,x+M);if(E-v<16||k-I<16)continue;const S=f.roi(new l.Rect(v,I,E-v,k-I)),R=new l.Mat;l.cvtColor(S,R,l.COLOR_RGB2GRAY);let B=null,Y=-2;for(const[F,X]of n){if(r!==void 0&&Date.now()>r)break;const Z=l1(e,S,R,X,p.get(F),c,d);Z!==null&&Z>Y&&(Y=Z,B=F)}S.delete(),R.delete();const G=new Set;if(B!==null&&Y>=J_){a.push({id:B,boundingBox:{x:w.x,y:w.y,width:w.w,height:w.h},confidence:1}),G.add(B);const F=c1(t,w,B);F&&(a.push({id:F.id,boundingBox:{x:F.box.x,y:F.box.y,width:F.box.w,height:F.box.h},confidence:.9}),G.add(F.id))}if(i===void 0||i.size===0)continue;const q=y1(s,u,w);if(q.length!==2)continue;const N=q.map(F=>w1(t,F));if(!N.some(F=>F.width*F.height===0||_1(F)<m1))for(let F=0;F<q.length;F++){const X=N[F];if(b1(X)<f1)continue;m===null&&(m=S1(e,i));const Z=I1(e,X,m);if(Z&&!G.has(Z)){G.add(Z);const le=q[F];a.push({id:Z,boundingBox:{x:le.x,y:le.y,width:le.w,height:le.h},confidence:1})}}}}finally{f.delete();for(const w of p.values()){const b=w;for(const x of["gray","k","d"])try{(y=b[x])==null||y.delete()}catch{}}try{c.delete(),d.delete()}catch{}}return a}const Om=128,E1=.56,k1=15,C1=.58,A1=70,R1=50,O1=.12,N1=.2,z1=.1,B1=.17,Nm=.15;function P1(e){const t=new Map;for(const[n,r]of Object.entries(e.templates)){const i=Uint8Array.from(atob(r),a=>a.charCodeAt(0));i.length===e.size*e.size&&t.set(n,i)}return t}function zm(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(n/2),s=Math.floor(r/2),u=Math.trunc(Math.min(n,r)*.5*t);if(u<1)return e;const l=Math.max(0,o-u),c=Math.max(0,s-u),d=Math.min(n,o+u),p=Math.min(r,s+u),f=d-l,m=p-c,y=new Uint8Array(f*m*i);for(let w=0;w<m;w++){const b=((w+c)*n+l)*i;y.set(a.subarray(b,b+f*i),w*f*i)}return{width:f,height:m,channels:i,data:y}}function D1(e){const t=zm(e,E1),n=kb(t),r=pm(n,Om,Om);return Cb(r)}function U1(e,t){const n=e.length;let r=0,i=0;for(let u=0;u<n;u++)r+=e[u],i+=t[u];r/=n,i/=n;let a=0,o=0,s=0;for(let u=0;u<n;u++){const l=e[u]-r,c=t[u]-i;a+=l*c,o+=l*l,s+=c*c}return a/(Math.sqrt(o*s)+1e-6)}function L1(e){const t=new Map([["masonry",0],["strategy",0]]),n=zm(e,C1),{width:r,height:i,channels:a,data:o}=n,s=r*i||1;let u=0,l=0;for(let p=0;p<r*i;p++){const f=p*a,{h:m,s:y,v:w}=kt(o[f],o[f+1],o[f+2]);y>=A1&&w>=R1&&(m>=95&&m<=130&&(u+=1),(m<=8||m>=170)&&(l+=1))}const c=u/s,d=l/s;return c>=O1&&t.set("masonry",Nm*Math.min(1,c/N1)),d>=z1&&t.set("strategy",Nm*Math.min(1,d/B1)),t}function F1(e,t){if(t.size===0||e.width===0||e.height===0)return["",0];const n=D1(e);let r=0;for(const l of n.data)r+=l;const i=r/n.data.length,a=[];for(let l=0;l<360;l+=k1)a.push(Ob(n,l,i));const o=new Map;for(const[l,c]of t){let d=-1/0;for(const p of a){const f=U1(p,c);f>d&&(d=f)}o.set(l,d)}for(const[l,c]of L1(e))c>0&&o.has(l)&&o.set(l,o.get(l)+c);let s="",u=-1/0;for(const[l,c]of o)c>u&&(s=l,u=c);return[s,u]}const un=224,G1=512,W1=[.485,.456,.406],q1=[.229,.224,.225];function V1(e){const t=atob(e.x),n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);const r=new Float32Array(n.buffer);if(r.length!==e.ids.length*e.dim)throw new Error(`token_embed_index: ${r.length} floats != ${e.ids.length}x${e.dim}`);return{dim:e.dim,ids:e.ids,x:r}}function H1(e){const t=da(e,un,un),n=un*un,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=(t[i*3+a]/255-W1[a])/q1[a];return r}function j1(e){const t=3*un*un,n=new Float32Array(4*t);for(let r=0;r<4;r++)n.set(H1(Kt(e,r)),r*t);return n}function K1(e,t=G1){const n=e.length/t,r=new Float32Array(t);for(let a=0;a<n;a++)for(let o=0;o<t;o++)r[o]+=e[a*t+o];let i=0;for(let a=0;a<t;a++)r[a]/=n,i+=r[a]*r[a];i=Math.max(Math.sqrt(i),1e-9);for(let a=0;a<t;a++)r[a]/=i;return r}function Y1(e,t){let n=0,r=-2;for(let i=0;i<e.ids.length;i++){let a=0;const o=i*e.dim;for(let s=0;s<e.dim;s++)a+=e.x[o+s]*t[s];a>r&&(r=a,n=i)}return{id:e.ids[n],cosine:r}}const qn=96,X1=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"],Q1=.45;function Z1(e){const t=da(e,qn,qn),n=qn*qn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function J1(e){let t=0;for(let r=1;r<e.length;r++)e[r]>e[t]&&(t=r);const n=e[t];return{id:n>=Q1?X1[t]??"":"",prob:n}}const Xt=128,e2=["circus-maximus","piraeus","the-appian-way","the-colossus","the-great-library","the-great-lighthouse","the-hanging-gardens","the-mausoleum","the-pyramids","the-sphinx","the-statue-of-zeus","the-temple-of-artemis","other"],t2=.5;let Bm=null;function n2(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError(`seuil merveilles hors bornes : ${e}`);Bm=e}function Pm(){return Bm??t2}let Dm=null;function r2(e){if(!Array.isArray(e)||e.length===0||!e.includes("other"))throw new RangeError("classes merveilles invalides (liste vide ou sans `other`)");Dm=[...e]}function i2(){return Dm??e2}const Um="__inverse";function o2(e){return e.endsWith(Um)?[e.slice(0,-Um.length),!0]:[e,!1]}function a2(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n*3);for(let o=0;o<t*n;o++)for(let s=0;s<3;s++)a[o*3+s]=i[o*r+s];return a}function s2(e){const t=Math.min(Xt/e.width,Xt/e.height),n=Math.max(1,Math.round(e.width*t)),r=Math.max(1,Math.round(e.height*t)),i=n===e.width&&r===e.height?a2(e):t<1?Fn(e,n,r):dr(e,n,r),a=Xt*Xt,o=new Float32Array(3*a);o.fill(114/255);const s=Math.floor((Xt-r)/2),u=Math.floor((Xt-n)/2);for(let l=0;l<r;l++)for(let c=0;c<n;c++){const d=(l*n+c)*3,p=(l+s)*Xt+(c+u);for(let f=0;f<3;f++)o[f*a+p]=i[d+f]/255}return o}async function u2(e,t){const{index:n,prob:r}=l2(await t(s2(e))),[i,a]=o2(i2()[n]??"");return r<Pm()||i==="other"||i===""?{id:"",prob:r,inverse:!1}:{id:i,prob:r,inverse:a}}function l2(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{index:t,prob:e[t]}}const Bt=96,c2=[1,2,3,4,5,6,7],d2=.8,h2=.99;function p2(e){const t=dr(e,e.width*2,e.height*2),n=e.width*2<Bt&&e.height*2<Bt,r={width:e.width*2,height:e.height*2,channels:3,data:t},i=n?dr(r,Bt,Bt):Fn(r,Bt,Bt),a=Bt*Bt,o=new Float32Array(3*a);for(let s=0;s<a;s++)for(let u=0;u<3;u++)o[u*a+s]=i[s*3+u]/255;return o}function f2(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{value:c2[t],prob:e[t]}}const ln=128,Lm=.35,m2=["fp","laurel"],g2=.85,Vn=40;function y2(e){const r=(e.width<ln&&e.height<ln?dr:Fn)(e,ln,ln),i=ln*ln,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function w2(e){return e[m2.indexOf("fp")]}const cn=128,b2=.15,Fm=["blue","brown","green","grey","purple","red","yellow","tuile_militaire","dos_de_carte","livret_de_regles","objet_hors_jeu"],_2=7,x2=.9;function $2(e,t,n){const[r,i,a,o]=e.map(Number);if(!(a>1)||!(o>1))return null;const s=r+a/2,u=i+o/2,l=Math.max(a,o)*(1+2*b2),c=Math.max(0,st(s-l/2)),d=Math.max(0,st(u-l/2)),p=Math.min(t,st(s+l/2)),f=Math.min(n,st(u+l/2));return p-c<8||f-d<8?null:{x:c,y:d,w:p-c,h:f-d}}function v2(e){const r=(e.width<cn&&e.height<cn?dr:Fn)(e,cn,cn),i=cn*cn,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function M2(e){let t=0;for(let i=1;i<Fm.length;i++)e[i]>e[t]&&(t=i);const n=e[t],r=t>=_2;return{className:Fm[t],probability:n,rejected:r&&n>=x2}}const ti=3,S2=2.2,I2=.3,T2=.65,E2=3,k2=1.3,C2=.77;function Gm(e,t,n){const[r,i,a,o]=e,s=[];return r<=ti&&s.push("gauche"),i<=ti&&s.push("haut"),r+a>=t-ti&&s.push("droit"),i+o>=n-ti&&s.push("bas"),s}function Wm(e){const t=e[3]/Math.max(e[2],1);return t>=k2?"portrait":t<=C2?"paysage":null}function ka(e){const t=[...e].sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function A2(e,t,n){for(const[r,i,a,o]of e??[])if(Math.max(Math.abs(a-r)/Math.max(t,1),Math.abs(o-i)/Math.max(n,1))>T2)return!0;return!1}function R2(e,t,n,r,i){try{const a=[...e],o=a.filter(w=>Gm(w.box,r,i).length>0);if(o.length===0)return{kept:a,dropped:[],suspects:[]};const s=a.filter(w=>!o.includes(w)),u=w=>({kept:s,dropped:o.map(b=>({banner:b,edgeReason:w})),suspects:[]});if(A2(n,r,i))return u("photo-piste");if(s.length<E2)return t>0?u("photo-merveilles"):{kept:a,dropped:[],suspects:o.map(w=>({family:w.family,color:w.color,box:w.box,reason:"bord-sans-scene"}))};if(o.length>(s.length+o.length)/3)return u("debordement-structurel");const l=ka(s.map(w=>w.box[2]*w.box[3])),c=ka(s.map(w=>w.box[2])),d=ka(s.map(w=>w.box[3])),p=new Set(s.map(w=>Wm(w.box)).filter(w=>w!==null)),f=[...s],m=[],y=[];for(const w of o){const b=Gm(w.box,r,i),[,,x,M]=w.box,v=l>0?x*M/l:0,I=[];(b.includes("gauche")||b.includes("droit"))&&I.push(c>0?x/c:1),(b.includes("haut")||b.includes("bas"))&&I.push(d>0?M/d:1);const E=I.length>0?Math.min(...I):1,k=Wm(w.box);v>S2?m.push({banner:w,edgeReason:"bord-grosse"}):E<I2?m.push({banner:w,edgeReason:"bord-tronquee"}):k!==null&&p.size>0&&!p.has(k)?m.push({banner:w,edgeReason:"bord-orientation-adverse"}):(f.push(w),y.push({family:w.family,color:w.color,box:w.box,reason:"tronquee-par-le-bord"}))}return{kept:f,dropped:m,suspects:y}}catch{return{kept:[...e],dropped:[],suspects:[]}}}const O2=1,N2=1.5;function z2(e){return e.length<4?[]:[[e[0],e[1]],[e[1],e[2]],[e[2],e[3]],[e[3],e[0]]]}function B2(e,t,n,r){const i=r[0]-n[0],a=r[1]-n[1],o=Math.hypot(i,a);if(o<=0)return null;const s=((e-n[0])*i+(t-n[1])*a)/(o*o);return[Math.abs((e-n[0])*a-(t-n[1])*i)/o,Math.abs(s-.5)*o]}function P2(e){if(e.length===0)return null;const t=e.map(r=>r[0]),n=e.map(r=>r[1]);return Math.max(...t)-Math.min(...t)>Math.max(...n)-Math.min(...n)}function D2(e,t,n){try{const r=Number(n);if(!(r>0)||e.length<4||t.length<4)return null;const[i,a,o,s]=t,u=i+o/2,l=a+s/2;let c=null;for(const[p,f]of z2(e)){const m=B2(u,l,p,f);m!==null&&(c===null||m[0]<c[0])&&(c=m)}if(c===null)return null;const d=P2(e);return d===null?null:{distBord:c[0]/r,decalLat:c[1]/r,perpendiculaire:d!==o>s}}catch{return null}}function U2(e,t,n,r=O2,i=N2){const a=[];for(const[o,s]of t??[]){const u=D2(e,s,n);u!==null&&u.perpendiculaire&&(u.decalLat>r||u.distBord>i||a.push([u.decalLat,o]))}return a.length===0?null:(a.sort((o,s)=>o[0]-s[0]||o[1]-s[1]),a[0][1])}const yt=64,qm=.5,L2=[.67,1.24];function Vm(e,t,n,r){const i=Math.max(0,t-r),a=Math.max(0,n-r),o=Math.min(e.width,t+r),s=Math.min(e.height,n+r),u=o-i,l=s-a;if(u<=0||l<=0)return null;const c=e.channels,d=new Uint8ClampedArray(u*l*3),p=r*r;for(let w=0;w<l;w++){const b=a+w,x=b-n;for(let M=0;M<u;M++){const v=i+M,I=v-t,E=(w*u+M)*3;if(I*I+x*x<=p){const k=(b*e.width+v)*c;d[E]=e.data[k],d[E+1]=e.data[k+1],d[E+2]=e.data[k+2]}else d[E]=255,d[E+1]=255,d[E+2]=255}}const f=Fn({width:u,height:l,channels:3,data:d},yt,yt),m=yt*yt,y=new Float32Array(3*m);for(let w=0;w<m;w++)for(let b=0;b<3;b++)y[b*m+w]=f[w*3+b]/255;return y}function F2(e){return e[1]}const ni=[1,3,6],G2=.5;function W2(e){if(e.length!==ni.length)return null;let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{denomination:ni[t],prob:e[t]}}function q2(e,t){return e.map((n,r)=>{const i=t[r]??null;return i!==null&&ni.includes(i.denomination)&&i.prob>=G2?{value:i.denomination,source:"cnn",conf:i.prob}:{value:n,source:null,conf:null}})}const V2=2.25,ri=3,H2=1.15,j2=.5,K2=2.5,Y2=.75,X2=2.25,Q2=1.3,Z2=.77;function ii(e,t){const n=Math.max(0,Math.max(e[0],t[0])-Math.min(e[0]+e[2],t[0]+t[2])),r=Math.max(0,Math.max(e[1],t[1])-Math.min(e[1]+e[3],t[1]+t[3]));return Math.hypot(n,r)}function J2(e){const t=Array.from(new Map(e.map(a=>[`${a[0]},${a[1]}`,a])).values());if(t.sort((a,o)=>a[0]-o[0]||a[1]-o[1]),t.length<=2)return t;const n=(a,o,s)=>(o[0]-a[0])*(s[1]-a[1])-(o[1]-a[1])*(s[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(const a of[...t].reverse()){for(;i.length>=2&&n(i[i.length-2],i[i.length-1],a)<=0;)i.pop();i.push(a)}return[...r.slice(0,-1),...i.slice(0,-1)]}function Hm(e,t,n){let r=!1;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[(a+1)%i];if(s>t!=l>t){const c=(u-o)*(t-s)/(l-s)+o;e<c&&(r=!r)}}return r}function ex(e,t,n){if(n.length>=3&&Hm(e,t,n))return 0;let r=Number.POSITIVE_INFINITY;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[i>1?(a+1)%i:a],c=u-o,d=l-s,p=c*c+d*d,f=p===0?0:Math.max(0,Math.min(1,((e-o)*c+(t-s)*d)/p));r=Math.min(r,Math.hypot(e-(o+f*c),t-(s+f*d)))}return r}function tx(e,t,n){const r=Math.max(Math.abs(e-(n[0]+n[2]/2))-n[2]/2,0),i=Math.max(Math.abs(t-(n[1]+n[3]/2))-n[3]/2,0);return Math.hypot(r,i)}function nx(e,t,n){const[r,i]=e,a=t[0]-r,o=t[1]-i;if(a===0&&o===0)return!1;const[s,u,l,c]=n;let d=0,p=1;const f=[[-a,r-s],[a,l-r],[-o,i-u],[o,c-i]];for(const[m,y]of f){if(m===0){if(y<0)return!1;continue}const w=y/m;if(m<0?d=Math.max(d,w):p=Math.min(p,w),d>p)return!1}return d>=p?!1:d>=.1&&p<=.95||p-d>=.15}const Ca=e=>e.box[3]/Math.max(1,e.box[2]),Qt=e=>Ca(e)>H2,Hn=e=>Ca(e)>=Q2||Ca(e)<=Z2;function Aa(e){const[t,n,r,i]=e.box;if(r>=i){const o=7*i;return[t,n-o,r,i+2*o]}const a=7*r;return[t-a,n,r+2*a,i]}function Ra(e,t,n,r,i){const a=new Set(t),o=[...e.map((O,C)=>({box:[O[0],O[1],O[2],O[3]],kind:a.has(C)?"card":"tucked",src:["banner",C]})),...n.map((O,C)=>({box:[O[0],O[1],O[2],O[3]],kind:"wonder",src:["wonder",C]}))],s=e.map(()=>"player"),u=n.map(()=>"player");if(o.length===0)return{bannerOwner:s,wonderOwner:u,opponentFound:!1,hulls:[],hullBoxCounts:[],pointOwner:()=>"player",pointInside:()=>"none"};const l=o.map(O=>[O.box[0]+O.box[2]/2,O.box[1]+O.box[3]/2]);let c=o.filter(O=>O.kind!=="wonder").map(O=>Math.hypot(O.box[2],O.box[3])).sort((O,C)=>O-C);c.length===0&&(c=o.map(O=>Math.hypot(O.box[2],O.box[3])).sort((O,C)=>O-C));const d=c[Math.floor(c.length/2)],p=(V2*d)**2,f=o.map((O,C)=>C),m=O=>{let C=O;for(;f[C]!==C;)f[C]=f[f[C]],C=f[C];return C},y=o.map((O,C)=>O.kind==="card"?C:-1).filter(O=>O>=0),w=o.map((O,C)=>O.kind!=="card"?C:-1).filter(O=>O>=0);for(let O=0;O<y.length;O+=1)for(let C=O+1;C<y.length;C+=1){const z=y[O],U=y[C],P=o[z],j=o[U];if(Hn(P)&&Hn(j)&&Qt(P)!==Qt(j))continue;const ie=l[z][0]-l[U][0],J=l[z][1]-l[U][1],me=ie*ie+J*J;let Te=me<=p;!Te&&Hn(P)&&Hn(j)&&Qt(P)===Qt(j)&&me<=(4*d)**2&&(Te=ii(Aa(P),Aa(j))<=.5*d),Te&&(f[m(z)]=m(U))}for(let O=0;O<w.length;O+=1)for(let C=O+1;C<w.length;C+=1){const z=w[O],U=w[C];ii(o[z].box,o[U].box)<=Y2*d&&(f[m(z)]=m(U))}const b=new Map;for(const O of w){const C=m(O);b.set(C,[...b.get(C)??[],O])}const x=new Map;for(const O of y){const C=m(O);x.set(C,[...x.get(C)??[],O])}for(const O of b.values()){const C=O.filter(j=>o[j].kind==="wonder"&&Hn(o[j])).map(j=>Qt(o[j])),z=C.length>0?C.filter(Boolean).length*2>C.length:null,U=[];for(const[j,ie]of x){let J=Number.POSITIVE_INFINITY;for(const W of O)for(const ee of ie)J=Math.min(J,ii(o[W].box,o[ee].box));if(J>X2*d)continue;const Te=ie.filter(W=>Qt(o[W])).length/ie.length>=.5;z!==null&&Te!==z||U.push([j,J,Te])}if(U.length===0)continue;const P=new Set(U.map(j=>j[2]));if(U.length>=2&&P.size===1&&z!==null){const j=U[0][0];for(const[ie]of U.slice(1))f[m(ie)]=m(j);f[m(O[0])]=m(j)}else{const j=U.reduce((ie,J)=>J[1]<ie[1]?J:ie);f[m(O[0])]=m(j[0])}}let M=new Map;for(let O=0;O<o.length;O+=1){const C=m(O);M.set(C,[...M.get(C)??[],O])}const v=o.map((O,C)=>O.kind==="wonder"?C:-1).filter(O=>O>=0);if(v.length>0){const O=(z,U)=>{const[P,j,ie,J]=Aa(o[z]),[me,Te,W,ee]=o[U].box,ne=Math.max(0,Math.min(P+ie,me+W)-Math.max(P,me)),oe=Math.max(0,Math.min(j+J,Te+ee)-Math.max(j,Te));return ne*oe>=.9*o[z].box[2]*o[z].box[3]},C=new Map;for(let z=0;z<o.length;z+=1)if(!(o[z].kind!=="card"||!Hn(o[z])))for(const U of v){const P=ii(o[z].box,o[U].box);if(P<=.8*d&&Qt(o[z])!==Qt(o[U])&&O(z,U)){const j=C.get(U);(!j||P<j[1])&&C.set(U,[z,P])}}for(const[z,[U]]of C){const P=m(z);for(const[j,ie]of M){const J=ie.indexOf(U);if(J>=0&&j!==P){ie.splice(J,1),M.set(P,[...M.get(P)??[],U]),o[U].kind="tucked";break}}}M=new Map([...M].filter(([,z])=>z.length>0))}const I=O=>O.filter(C=>o[C].kind==="card").length,E=O=>{const C=O.filter(z=>o[z].kind==="card"||o[z].kind==="wonder");return C.length===0?null:C.filter(z=>Qt(o[z])).length/C.length},k=O=>[O.reduce((C,z)=>C+l[z][0],0)/O.length,O.reduce((C,z)=>C+l[z][1],0)/O.length],S=[i[0]/2,i[1]/2],R=[...M.values()].sort((O,C)=>{const z=I(O),U=I(C);if(z!==U)return U-z;const P=Math.hypot(k(O)[0]-S[0],k(O)[1]-S[1]),j=Math.hypot(k(C)[0]-S[0],k(C)[1]-S[1]);return P-j}),B=k(R[0]),Y=E(R[0]),G=R.map((O,C)=>{if(C===0||I(O)<ri)return"player";const z=E(O),U=z!==null&&Y!==null&&Math.abs(z-Y)>=j2,P=k(O),j=r.some(ie=>nx(B,P,ie));return U||j?"opponent":"player"});if(!G.includes("opponent")){const O=z=>z.reduce((U,P)=>U+(o[P].kind==="wonder"?1:0),0);let C=G.map((z,U)=>U).filter(z=>z>0&&(I(R[z])>=ri||O(R[z])>=2));if(C.reduce((z,U)=>z+O(R[U]),0)<1&&(C=[]),C.length>0&&(I(R[0])<2*ri||C.reduce((z,U)=>z+I(R[U]),0)<2*ri)&&(C=[]),C.length>0){const z=new Map(C.map(j=>[j,k(R[j])])),U=(j,ie)=>(j[0]-ie[0])**2+(j[1]-ie[1])**2;if(C.every((j,ie)=>C.slice(ie+1).every(J=>U(z.get(j),z.get(J))<Math.min(U(z.get(j),B),U(z.get(J),B)))))for(const j of C)G[j]="opponent"}}const q=[],N=[];let F=!1;R.forEach((O,C)=>{const z=G[C];z==="opponent"&&(F=!0);const U=[],P=[];for(const j of O){const[ie,J,me,Te]=o[j].box;U.push([ie,J],[ie+me,J],[ie,J+Te],[ie+me,J+Te]),P.push(o[j].box);const[W,ee]=o[j].src;W==="banner"?s[ee]=z:u[ee]=z}q.push([z,J2(U)]),N.push([z,P])});const X=(O,C,z)=>Math.min(...N[z][1].map(U=>tx(O,C,U))),Z=(O,C)=>q.map(([,z],U)=>z.length>=3&&Hm(O,C,z)?U:-1).filter(z=>z>=0),le=(O,C)=>{if(q.length===0)return"player";const z=d>0?K2*d:Number.POSITIVE_INFINITY,U=Z(O,C);if(U.length>0){const ie=U.reduce((J,me)=>X(O,C,me)<X(O,C,J)?me:J);return q[ie][0]}let P=-1,j=Number.POSITIVE_INFINITY;return q.forEach(([,ie],J)=>{const me=ex(O,C,ie);me<j&&(P=J,j=me)}),P>=0&&j<=z?q[P][0]:"none"},L=(O,C)=>{if(q.length===0)return"none";const z=Z(O,C);if(z.length===0)return"none";const U=z.reduce((P,j)=>X(O,C,j)<X(O,C,P)?j:P);return q[U][0]};return{bannerOwner:s,wonderOwner:u,opponentFound:F,hulls:q,hullBoxCounts:N.map(([,O])=>O.length),pointOwner:le,pointInside:L}}const rx=3;function ix(e,t=rx){const n=e.length,r=Array.from({length:n},(o,s)=>s),i=o=>{for(;r[o]!==o;)r[o]=r[r[o]],o=r[o];return o};for(let o=0;o<n;o+=1)for(let s=o+1;s<n;s+=1){const u=e[o],l=e[s],c=Number(u.center[0]),d=Number(u.center[1]),p=Number(l.center[0]),f=Number(l.center[1]),m=Number(u.radius??0),y=Number(l.radius??0);![c,d,p,f,m,y].every(Number.isFinite)||m<=0||y<=0||Math.hypot(c-p,d-f)<=t*(m+y)&&(r[i(o)]=i(s))}const a=new Map;for(let o=0;o<n;o+=1){const s=i(o);a.has(s)||a.set(s,[]),a.get(s).push(o)}return[...a.values()]}function ox(e,t,n){const r=Number(n[0]),i=Number(n[1]),a=Number(n[2]),o=Number(n[3]),s=Math.max(Math.min(r,a)-e,0,e-Math.max(r,a)),u=Math.max(Math.min(i,o)-t,0,t-Math.max(i,o));return Math.hypot(s,u)}function Oa(e,t,n,r){const i=new Set(e.filter(o=>t.pointOwner(Number(o.center[0]),Number(o.center[1]))===n));if(i.size===0)return[];const a=[];for(const o of ix(e)){const s=o.map(y=>e[y]),u=s.filter(y=>i.has(y));if(u.length===0)continue;let l=0,c=0,d=0;for(const y of s){const w=Number(y.center[0]),b=Number(y.center[1]);c+=w,d+=b,t.pointInside(w,b)===n&&(l+=1)}const p=c/s.length,f=d/s.length,m=r&&r.length>0?Math.min(...r.map(y=>ox(p,f,y))):0;a.push({cle:[...o].sort((y,w)=>y-w).join(","),membres:s,miens:u,inside:l,dPiste:m,centre:[p,f],valeur:u.reduce((y,w)=>y+(Number(w.denomination??0)||0),0)})}return a}function ax(e){return e.reduce((t,n)=>{const r=[t.inside>0?1:0,t.inside,t.dPiste,t.valeur],i=[n.inside>0?1:0,n.inside,n.dPiste,n.valeur];for(let a=0;a<4;a+=1){if(i[a]>r[a])return n;if(i[a]<r[a])return t}return t})}function sx(e,t,n,r){const[i,a]=e.centre,o={};for(const c of["player","opponent"]){const d=Oa(t,n,c,r).filter(p=>p.cle!==e.cle);o[c]=d.length===0?1/0:Math.min(...d.map(p=>Math.hypot(i-p.centre[0],a-p.centre[1])))}if(o.player!==o.opponent)return o.player>o.opponent?"player":"opponent";const s=c=>{const d=Oa(t,n,c,r).find(p=>p.cle===e.cle);return d?[d.inside,d.dPiste,d.valeur]:[-1,-1,-1]},u=s("player"),l=s("opponent");for(let c=0;c<3;c+=1){if(u[c]>l[c])return"player";if(u[c]<l[c])return"opponent"}return"player"}function ux(e,t,n){const r={player:[],opponent:[]},i={};for(const o of["player","opponent"]){const s=Oa(e,t,o,n);s.length>0&&(i[o]=ax(s))}const a=Object.keys(i);if(a.length===0)return r;if(a.length===2&&i.player.cle===i.opponent.cle){const o=sx(i.player,e,t,n);return r[o]=i[o].membres,r}for(const o of a)r[o]=i[o].membres;return r}function lx(e,t,n,r){const i=()=>e.filter(a=>t.pointOwner(Number(a.center[0]),Number(a.center[1]))===n);try{return ux(e,t,r)[n]??[]}catch{try{return i()}catch{return[...e]}}}const cx=1280,dx=80,hx=3,px=3,fx=.3,mx=2.4,gx=1,yx=5.2,wx=5;function Na(e){const t=e.filter(r=>r&&r.length>=4).map(r=>Math.min(r[2],r[3])).sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function bx(e,t,n){const r=Math.min(e,t),i=Math.max(e,t);return!(n>0)||!(r>0)?!1:r/n>=fx&&r/n<=mx&&i/n>=gx&&i/n<=yx&&i/r<=wx}function _x(e,t,n){const r=Math.max(e,t);return!(r>0)||!(n>0)?!1:n*cx/r<dx}function xx(e,t){if(t.length===0)return e.slice();const n=e.map(r=>{const i=r.poly.map(s=>s[0]),a=r.poly.map(s=>s[1]),o=Math.max(1,i.length);return{hull:r,cx:i.reduce((s,u)=>s+u,0)/o,cy:a.reduce((s,u)=>s+u,0)/o,extra:[]}});if(n.length===0)return e.slice();for(const r of t){const i=Number(r[0]),a=Number(r[1]),o=Number(r[2]),s=Number(r[3]);if(![i,a,o,s].every(Number.isFinite))continue;const u=i+o/2,l=a+s/2;let c=n[0],d=1/0;for(const p of n){const f=(u-p.cx)**2+(l-p.cy)**2;f<d&&(d=f,c=p)}c.extra.push([i,a],[i+o,a+s])}return n.map(r=>r.extra.length===0?r.hull:{...r.hull,poly:[...r.hull.poly.map(i=>[i[0],i[1]]),...r.extra]})}function jm(e,t,n,r,i=[]){const a=Na(n);if(!_x(e,t,a))return[];const o=r.filter(l=>l.n>=px&&l.poly.length>0).slice().sort((l,c)=>c.n-l.n).slice(0,2),s=Math.round(a*hx),u=[];for(const l of xx(o,i)){const c=l.poly.map(w=>w[0]),d=l.poly.map(w=>w[1]);if(c.length===0)continue;const p=Math.max(0,Math.trunc(Math.min(...c))-s),f=Math.max(0,Math.trunc(Math.min(...d))-s),m=Math.min(e,Math.trunc(Math.max(...c))+s),y=Math.min(t,Math.trunc(Math.max(...d))+s);m>p&&y>f&&u.push([p,f,m,y])}return u}function $x(e,t,n){if(!e||e.length<4)return null;const[r,i,a,o]=[e[0],e[1],e[2],e[3]];return bx(a,o,n)?[Math.round(r+t[0]),Math.round(i+t[1]),Math.round(a),Math.round(o)]:null}function vx(e,t,n,r,i){return jm(e,t,n,r,i)}function Mx(e,t){var s,u,l,c;const[n,r,i,a]=t,o=[];for(const d of e){const p=Number((s=d.box)==null?void 0:s[0]),f=Number((u=d.box)==null?void 0:u[1]),m=Number((l=d.box)==null?void 0:l[2]),y=Number((c=d.box)==null?void 0:c[3]);[p,f,m,y].every(Number.isFinite)&&(p+m<n||p>i||f+y<r||f>a||o.push({...d,box:[Math.round(p-n),Math.round(f-r),Math.round(m),Math.round(y)]}))}return o}function Sx(e){const t=[];for(const n of e){const r=n==null?void 0:n.boundingBox;if(!r||!Number.isFinite(r.width)||!Number.isFinite(r.height))continue;const i=r.x+r.width/2,a=r.y+r.height/2;let o=!1;for(const s of t){if(n.id&&s.id===n.id){o=!0;break}const u=s.boundingBox,l=u.x+u.width/2,c=u.y+u.height/2,d=.5*Math.min(u.width,u.height);if((i-l)**2+(a-c)**2<d*d){o=!0;break}}o||t.push(n)}return t}function Km(e,t){return{x:Math.round(e.x+t[0]),y:Math.round(e.y+t[1]),width:Math.round(e.width),height:Math.round(e.height)}}const Ix=1.1,Tx=3.2,Ex=20,kx=.5,Cx=1280,Ax=.18,Rx=28,Ox=.3;function Nx(e){const t=Math.min(...e),n=Math.max(...e);let r=(t+n)/2;for(let o=0;o<30;o++){const s=e.filter(c=>c<=r),u=e.filter(c=>c>r);if(s.length===0||u.length===0)return[e.map((c,d)=>d)];const l=(s.reduce((c,d)=>c+d,0)/s.length+u.reduce((c,d)=>c+d,0)/u.length)/2;if(Math.abs(l-r)<1)break;r=l}const i=[],a=[];return e.forEach((o,s)=>(o<=r?i:a).push(s)),[i,a]}function zx(e,t,n=Ix){const[r,i]=t;if(e.length<3||r<=0||i<=0)return[];const a=e.map(l=>l[0]+l[2]/2),o=e.map(l=>l[1]+l[3]/2),s=Math.max(...a)-Math.min(...a)>Math.max(...o)-Math.min(...o)?a:o,u=[];for(const l of Nx(s)){if(l.length===0)continue;const c=l.map(R=>e[R]),d=c.map(R=>Math.min(R[2],R[3])).sort((R,B)=>R-B),p=d[Math.trunc(d.length/2)],f=Tx*p,m=Math.max(0,Math.min(...c.map(R=>R[0]))-f),y=Math.max(0,Math.min(...c.map(R=>R[1]))-f),w=Math.min(r,Math.max(...c.map(R=>R[0]+R[2]))+f),b=Math.min(i,Math.max(...c.map(R=>R[1]+R[3]))+f),x=Math.max(w-m,b-y);if(x<=0)continue;const M=kx*p*Cx/x,v=M>0?Math.max(1,Math.ceil(Ex/M)):1;if(v===1){u.push([Math.trunc(m),Math.trunc(y),Math.trunc(w),Math.trunc(b)]);continue}const I=w-m>=b-y,k=(I?w-m:b-y)/v,S=k*(1+Ax);for(let R=0;R<v;R++){let B=(I?m:y)+R*k-(S-k)/2;B=Math.max(I?m:y,B);const Y=Math.min(I?w:b,B+S);u.push(I?[Math.trunc(B),Math.trunc(y),Math.trunc(Y),Math.trunc(b)]:[Math.trunc(m),Math.trunc(B),Math.trunc(w),Math.trunc(Y)])}}return u.filter(([l,c,d,p])=>Math.max(r,i)/Math.max(1,Math.max(d-l,p-c))>=n)}function Bx(e,t,n,r=Rx){const[i,a]=n,o=e;for(const[s,u,l,c]of t){const d=(s+l)/2+i,p=(u+c)/2+a;o.some(([m,y,w,b])=>{const x=d-(m+w)/2,M=p-(y+b)/2;return Math.hypot(x,M)<=r})||o.push([s+i,u+a,l+i,c+a])}return o}function Px(e,t,n,r=Ox){for(const i of n){const a=r*Math.min(i[2],i[3]);if(i[0]-a<=e&&e<=i[0]+i[2]+a&&i[1]-a<=t&&t<=i[1]+i[3]+a)return!0}return!1}function Dx(e,t,n){return n.some(([r,i,a,o])=>r<=e&&e<=a&&i<=t&&t<=o)}function Ux(e,t,n,r){return n.length===0?!1:Dx(e,t,n)&&!Px(e,t,r)}const Ym=4,Xm=8,oi=5,kn="base-game rule";function Pt(e,t){return{code:e,message:t,severity:"warning"}}function za(e){const t=new Set,n=new Set;for(const r of e)t.has(r)&&n.add(r),t.add(r);return[...n].sort()}function Lx(e,t=""){const n=e.filter(o=>!!o),r=t||"a player",i=[];n.length>Ym&&i.push(Pt("TOO_MANY_WONDERS",`${r}: ${n.length} wonders recognised, but a player builds at most ${Ym} (${kn}) — at least one reading is wrong. Check the wonder list in the review; a card seen at an angle can be named as a wonder.`));const a=za(n);return a.length>0&&i.push(Pt("DUPLICATE_WONDER",`${r}: wonder(s) counted twice — ${a.join(", ")}. Only one copy of each wonder exists (${kn}), so one of the two readings is wrong.`)),i}function Fx(e){const t=[],n=Object.entries(e).map(([i,a])=>[i,new Set(a.filter(o=>!!o))]),r=Object.values(e).reduce((i,a)=>i+a.filter(Boolean).length,0);r>Xm&&t.push(Pt("TOO_MANY_WONDERS_IN_PLAY",`${r} wonders recognised across both cities, but only ${Xm} are in play (${kn}) — at least one reading is wrong.`));for(let i=0;i<n.length;i++){const[a,o]=n[i];for(let s=i+1;s<n.length;s++){const[u,l]=n[s],c=[...o].filter(d=>l.has(d)).sort();c.length>0&&t.push(Pt("WONDER_IN_BOTH_CITIES",`wonder(s) assigned to both cities at once (${a} and ${u}): ${c.join(", ")} — the city split misread one of them.`))}}return t}function Gx(e,t=null){const n=[],r=Object.values(e).flatMap(a=>a.filter(o=>!!o));r.length>oi&&n.push(Pt("TOO_MANY_TOKENS",`${r.length} Progress tokens claimed by the cities, but only ${oi} are in play (${kn}) — reserve tokens sitting on the board were probably counted as owned.`));const i=za(r);if(i.length>0&&n.push(Pt("DUPLICATE_TOKEN",`Progress token(s) counted twice: ${i.join(", ")} — only one copy of each token exists (${kn}).`)),t!==null){const a=t.filter(Boolean),o=r.length+a.length;o!==oi&&n.push(Pt("TOKEN_COUNT_MISMATCH",`${r.length} token(s) in the cities + ${t.length} in the reserve = ${o}, but exactly ${oi} are in play (${kn}) — one is missing or one was counted twice.`));const s=new Set(a),u=[...new Set(r.filter(l=>s.has(l)))].sort();u.length>0&&n.push(Pt("TOKEN_IN_CITY_AND_RESERVE",`token(s) seen both in a city and in the reserve: ${u.join(", ")} — the board-token exclusion did not fire.`))}return n}function Wx(e,t=""){const n=t||"a player",r=[],i=e.filter(o=>!o).length;i>0&&r.push(Pt("UNNAMED_GUILD",`${n}: ${i} guild(s) detected but not identified — their points cannot be computed. Name them in the review.`));const a=za(e.filter(o=>!!o));return a.length>0&&r.push(Pt("DUPLICATE_GUILD",`${n}: guild(s) counted twice — ${a.join(", ")}. Only one copy of each guild exists (${kn}).`)),r}const qx=.25,Vx=.45;function Hx(e,t,n,r,i){const a=Math.cos(i),o=Math.sin(i),s=[n/2*a,n/2*o],u=[-r/2*o,r/2*a],c=[...[[e+s[0]+u[0],t+s[1]+u[1]],[e+s[0]-u[0],t+s[1]-u[1]],[e-s[0]-u[0],t-s[1]-u[1]],[e-s[0]+u[0],t-s[1]+u[1]]]].reverse();return[c[1],c[2],c[3],c[0]]}function Ba(e,t){return e.matFromArray(t.length,1,e.CV_32FC2,t.flatMap(n=>[n[0],n[1]]))}function Qm(e,t){const n=Ba(e,t);try{return Math.abs(e.contourArea(n))}finally{n.delete()}}function jx(e,t,n){const r=Ba(e,t),i=Ba(e,n),a=new e.Mat;try{return Math.abs(e.intersectConvexConvex(r,i,a,!0))}finally{r.delete(),i.delete(),a.delete()}}function Kx(e,t,n=Vx){const r=[...t].sort((a,o)=>o.confidence-a.confidence),i=[];for(const a of r){let o=!1;for(const s of i){const u=jx(e,a.quad,s.quad);if(u<=0)continue;const l=Qm(e,a.quad)+Qm(e,s.quad)-u;if(u/Math.max(1e-6,l)>=n){o=!0;break}}o||i.push(a)}return i}function Yx(e,t,n,r,i=qx){const a=[];for(let o=0;o<n;o++){const s=t[4*n+o];if(s<i)continue;const l=Hx(t[o],t[n+o],t[2*n+o],t[3*n+o],t[5*n+o]).map(c=>[(c[0]-r.padX)/r.scale,(c[1]-r.padY)/r.scale]);a.push({quad:l,confidence:s})}return Kx(e,a)}const Xx=128,Qx=88;function Zx(e,t,n,r=Xx,i=Qx){const a=new e.Mat(t.height,t.width,e.CV_8UC3),o=a.data,s=t.channels;for(let p=0,f=t.width*t.height;p<f;p++)o[p*3]=t.data[p*s],o[p*3+1]=t.data[p*s+1],o[p*3+2]=t.data[p*s+2];const u=e.matFromArray(4,1,e.CV_32FC2,n.flatMap(p=>[p[0],p[1]])),l=e.matFromArray(4,1,e.CV_32FC2,[0,0,r,0,r,i,0,i]),c=e.getPerspectiveTransform(u,l),d=new e.Mat;try{return e.warpPerspective(a,d,c,new e.Size(r,i)),{data:new Uint8Array(d.data),width:r,height:i,channels:3}}finally{a.delete(),u.delete(),l.delete(),c.delete(),d.delete()}}function Jx(e){return[e[2],e[3],e[0],e[1]]}const e$=[{id:"merchants-guild",name:"Merchants Guild",nameFr:"Guilde des commerçants",color:"guild",age:3,victoryPoints:0,variableScoring:"merchantsGuild",cost:{clay:1,wood:1,glass:1,papyrus:1}},{id:"shipowners-guild",name:"Shipowners Guild",nameFr:"Guilde des armateurs",color:"guild",age:3,victoryPoints:0,variableScoring:"shipownersGuild",cost:{clay:2,glass:1,papyrus:1}},{id:"builders-guild",name:"Builders Guild",nameFr:"Guilde des bâtisseurs",color:"guild",age:3,victoryPoints:0,variableScoring:"buildersGuild",cost:{stone:2,clay:1,wood:1,glass:1}},{id:"magistrates-guild",name:"Magistrates Guild",nameFr:"Guilde des magistrats",color:"guild",age:3,victoryPoints:0,variableScoring:"magistratesGuild",cost:{wood:2,clay:1,papyrus:1}},{id:"scientists-guild",name:"Scientists Guild",nameFr:"Guilde des scientifiques",color:"guild",age:3,victoryPoints:0,variableScoring:"scientistsGuild",cost:{wood:2,clay:2}},{id:"tacticians-guild",name:"Tacticians Guild",nameFr:"Guilde des tacticiens",color:"guild",age:3,victoryPoints:0,variableScoring:"tacticiansGuild",cost:{stone:2,clay:1,papyrus:1}},{id:"moneylenders-guild",name:"Moneylenders Guild",nameFr:"Guilde des usuriers",color:"guild",age:3,victoryPoints:0,variableScoring:"moneylendersGuild",cost:{stone:2,wood:2}}],t$=[{id:"lumber-yard",name:"Lumber Yard",nameFr:"Chantier",color:"raw",age:1,victoryPoints:0},{id:"logging-camp",name:"Logging Camp",nameFr:"Exploitation",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"clay-pool",name:"Clay Pool",nameFr:"Bassin argileux",color:"raw",age:1,victoryPoints:0},{id:"clay-pit",name:"Clay Pit",nameFr:"Cavité",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"quarry",name:"Quarry",nameFr:"Gisement",color:"raw",age:1,victoryPoints:0},{id:"stone-pit",name:"Stone Pit",nameFr:"Mine",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"glassworks",name:"Glassworks",nameFr:"Verrerie",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"press",name:"Press",nameFr:"Presse",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"theater",name:"Theater",nameFr:"Théâtre",color:"civilian",age:1,victoryPoints:3},{id:"altar",name:"Altar",nameFr:"Autel",color:"civilian",age:1,victoryPoints:3,providesChain:"moon"},{id:"baths",name:"Baths",nameFr:"Bains",color:"civilian",age:1,victoryPoints:3,providesChain:"drop",cost:{stone:1}},{id:"pharmacist",name:"Pharmacist",nameFr:"Officine",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"mortar",providesChain:"mortar-chain",cost:{glass:2}},{id:"apothecary",name:"Apothecary",nameFr:"Apothicaire",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain",cost:{glass:1}},{id:"workshop",name:"Workshop",nameFr:"Atelier",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain",cost:{papyrus:1}},{id:"scriptorium",name:"Scriptorium",nameFr:"Scriptorium",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"inkwell",providesChain:"inkwell-chain",coinCost:2},{id:"stone-reserve",name:"Stone Reserve",nameFr:"Dépôt de pierre",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"clay-reserve",name:"Clay Reserve",nameFr:"Dépôt d'argile",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"wood-reserve",name:"Wood Reserve",nameFr:"Dépôt de bois",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"tavern",name:"Tavern",nameFr:"Taverne",color:"commercial",age:1,victoryPoints:0,providesChain:"jug"},{id:"guard-tower",name:"Guard Tower",nameFr:"Tour de garde",color:"military",age:1,victoryPoints:0,shields:1},{id:"stable",name:"Stable",nameFr:"Écuries",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"horseshoe",cost:{wood:1}},{id:"garrison",name:"Garrison",nameFr:"Caserne",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"sword",cost:{clay:1}},{id:"palisade",name:"Palisade",nameFr:"Palissade",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"tower",coinCost:2}],n$=[{id:"sawmill",name:"Sawmill",nameFr:"Scierie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"brickyard",name:"Brickyard",nameFr:"Briqueterie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"shelf-quarry",name:"Shelf Quarry",nameFr:"Carrière",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"glass-blower",name:"Glass-Blower",nameFr:"Soufflerie",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"drying-room",name:"Drying Room",nameFr:"Séchoir",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"courthouse",name:"Courthouse",nameFr:"Tribunal",color:"civilian",age:2,victoryPoints:5,cost:{wood:2,glass:1}},{id:"statue",name:"Statue",nameFr:"Statue",color:"civilian",age:2,victoryPoints:4,providesChain:"column",chainFrom:"moon",cost:{clay:2}},{id:"temple",name:"Temple",nameFr:"Temple",color:"civilian",age:2,victoryPoints:4,providesChain:"sun",chainFrom:"drop",cost:{wood:1,papyrus:1}},{id:"aqueduct",name:"Aqueduct",nameFr:"Aqueduc",color:"civilian",age:2,victoryPoints:5,cost:{stone:3}},{id:"rostrum",name:"Rostrum",nameFr:"Rostres",color:"civilian",age:2,victoryPoints:4,providesChain:"horseshoe",cost:{stone:1,wood:1}},{id:"school",name:"School",nameFr:"École",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain-2",cost:{wood:1,papyrus:2}},{id:"laboratory",name:"Laboratory",nameFr:"Laboratoire",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain-2",cost:{wood:1,glass:2}},{id:"library",name:"Library",nameFr:"Bibliothèque",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"inkwell",chainFrom:"inkwell-chain",cost:{stone:1,wood:1,glass:1}},{id:"dispensary",name:"Dispensary",nameFr:"Dispensaire",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"mortar",chainFrom:"mortar-chain",cost:{clay:2,stone:1}},{id:"forum",name:"Forum",nameFr:"Forum",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel",coinCost:3,cost:{clay:1}},{id:"caravansery",name:"Caravansery",nameFr:"Caravansérail",color:"commercial",age:2,victoryPoints:0,coinCost:2,cost:{glass:1,papyrus:1}},{id:"customs-house",name:"Customs House",nameFr:"Douanes",color:"commercial",age:2,victoryPoints:0,coinCost:4},{id:"brewery",name:"Brewery",nameFr:"Brasserie",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel-2"},{id:"horse-breeders",name:"Horse Breeders",nameFr:"Haras",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"horseshoe",cost:{clay:1,wood:1}},{id:"barracks",name:"Barracks",nameFr:"Baraquements",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"sword",coinCost:3},{id:"archery-range",name:"Archery Range",nameFr:"Champ de tir",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"target",cost:{stone:1,wood:1,papyrus:1}},{id:"parade-ground",name:"Parade Ground",nameFr:"Place d'armes",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"mask",cost:{clay:2,glass:1}},{id:"walls",name:"Walls",nameFr:"Muraille",color:"military",age:2,victoryPoints:0,shields:2,cost:{stone:2}}],r$=[{id:"pantheon",name:"Pantheon",nameFr:"Panthéon",color:"civilian",age:3,victoryPoints:6,chainFrom:"sun",cost:{clay:1,wood:1,papyrus:2}},{id:"gardens",name:"Gardens",nameFr:"Jardins",color:"civilian",age:3,victoryPoints:6,chainFrom:"column",cost:{clay:2,wood:2}},{id:"town-hall",name:"Town Hall",nameFr:"Hôtel de ville",color:"civilian",age:3,victoryPoints:7,cost:{stone:3,wood:2}},{id:"palace",name:"Palace",nameFr:"Palace",color:"civilian",age:3,victoryPoints:7,cost:{clay:1,stone:1,wood:1,glass:2}},{id:"senate",name:"Senate",nameFr:"Sénat",color:"civilian",age:3,victoryPoints:5,chainFrom:"horseshoe",cost:{clay:2,stone:1,papyrus:1}},{id:"obelisk",name:"Obelisk",nameFr:"Obélisque",color:"civilian",age:3,victoryPoints:5,cost:{stone:2,glass:1}},{id:"academy",name:"Academy",nameFr:"Académie",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{stone:1,wood:1,glass:2}},{id:"study",name:"Study",nameFr:"Étude",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{wood:2,glass:1,papyrus:1}},{id:"university",name:"University",nameFr:"Université",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"wheel-chain-2",cost:{clay:1,glass:1,papyrus:1}},{id:"observatory",name:"Observatory",nameFr:"Observatoire",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"pendulum-chain-2",cost:{stone:1,papyrus:2}},{id:"chamber-of-commerce",name:"Chamber of Commerce",nameFr:"Chambre de commerce",color:"commercial",age:3,victoryPoints:3,variableScoring:"chamberOfCommerce",cost:{papyrus:2}},{id:"port",name:"Port",nameFr:"Port",color:"commercial",age:3,victoryPoints:3,variableScoring:"port",cost:{wood:1,glass:1,papyrus:1}},{id:"armory",name:"Armory",nameFr:"Armurerie",color:"commercial",age:3,victoryPoints:3,variableScoring:"armory",cost:{stone:2,glass:1}},{id:"lighthouse",name:"Lighthouse",nameFr:"Phare",color:"commercial",age:3,victoryPoints:3,variableScoring:"lighthouse",chainFrom:"jug",cost:{clay:2,glass:1}},{id:"arena",name:"Arena",nameFr:"Arène",color:"commercial",age:3,victoryPoints:3,variableScoring:"arena",chainFrom:"barrel-2",cost:{clay:1,stone:1,wood:1}},{id:"pretorium",name:"Pretorium",nameFr:"Prétoire",color:"military",age:3,victoryPoints:0,shields:3,coinCost:8},{id:"arsenal",name:"Arsenal",nameFr:"Arsenal",color:"military",age:3,victoryPoints:0,shields:3,cost:{clay:3,wood:2}},{id:"fortifications",name:"Fortifications",nameFr:"Fortifications",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"tower",cost:{stone:2,clay:1,papyrus:1}},{id:"siege-workshop",name:"Siege Workshop",nameFr:"Atelier de siège",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"target",cost:{wood:3,glass:1}},{id:"circus",name:"Circus",nameFr:"Cirque",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"mask",cost:{clay:2,stone:2}}],i$=[...t$,...n$,...r$,...e$];Object.fromEntries(i$.map(e=>[e.id,e]));const o$=Object.fromEntries([{id:"the-appian-way",name:"The Appian Way",nameFr:"La Via Appia",victoryPoints:3,description:"The opponent loses 3 coins. Take another turn. Once built, repeated discards are not affected. Worth 3 victory points."},{id:"circus-maximus",name:"Circus Maximus",nameFr:"Le Circus Maximus",victoryPoints:3,shields:1,description:"Destroy one grey (manufactured) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-colossus",name:"The Colossus",nameFr:"Le Colosse",victoryPoints:3,shields:2,description:"Provides 2 shields. Worth 3 victory points."},{id:"the-great-library",name:"The Great Library",nameFr:"La Grande Bibliothèque",victoryPoints:4,description:"Randomly draw 3 of the Progress tokens discarded at game setup and keep one. Worth 4 victory points."},{id:"the-great-lighthouse",name:"The Great Lighthouse",nameFr:"Le Grand Phare",victoryPoints:4,description:"Once built, the owner may take any raw or manufactured good of choice each turn (production effect). Worth 4 victory points."},{id:"the-hanging-gardens",name:"The Hanging Gardens",nameFr:"Les Jardins Suspendus",victoryPoints:3,description:"Gain 6 coins. Take another turn. Worth 3 victory points."},{id:"the-mausoleum",name:"The Mausoleum",nameFr:"Le Mausolée",victoryPoints:2,description:"Build, for free, any one card from the discard pile. Worth 2 victory points."},{id:"piraeus",name:"Piraeus",nameFr:"Le Pirée",victoryPoints:2,description:"Once built, the owner may take any one manufactured good (glass or papyrus) of choice each turn. Take another turn. Worth 2 victory points."},{id:"the-pyramids",name:"The Pyramids",nameFr:"Les Pyramides",victoryPoints:9,description:"Worth 9 victory points."},{id:"the-sphinx",name:"The Sphinx",nameFr:"Le Sphinx",victoryPoints:6,description:"Take another turn. Worth 6 victory points."},{id:"the-statue-of-zeus",name:"The Statue of Zeus",nameFr:"La Statue de Zeus",victoryPoints:3,shields:1,description:"Destroy one brown (raw) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-temple-of-artemis",name:"The Temple of Artemis",nameFr:"Le Temple d'Artémis",victoryPoints:0,description:"Gain 12 coins. Take another turn. Worth 0 victory points."}].map(e=>[e.id,e]));Object.fromEntries([{id:"agriculture",name:"Agriculture",nameFr:"Agriculture",victoryPoints:4,description:"Gain 6 coins immediately. Worth 4 victory points at game end."},{id:"architecture",name:"Architecture",nameFr:"Architecture",description:"Any future Wonder constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"economy",name:"Economy",nameFr:"Économie",description:"When the opponent uses the trading-cost coins (pays the bank to buy goods), the owner receives those coins instead."},{id:"law",name:"Law",nameFr:"Loi",variableScoring:"law",description:"Grants one science symbol, counting toward the six-symbol scientific victory and toward pairs of identical symbols."},{id:"masonry",name:"Masonry",nameFr:"Maçonnerie",description:"Any future blue (civilian) building constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"mathematics",name:"Mathematics",nameFr:"Mathématiques",variableScoring:"mathematics",description:"Worth 3 victory points at game end for EACH Progress token the owner possesses (including this one)."},{id:"philosophy",name:"Philosophy",nameFr:"Philosophie",victoryPoints:7,description:"Worth 7 victory points at game end."},{id:"strategy",name:"Strategy",nameFr:"Stratégie",description:"Whenever the owner builds a red (military) building, it provides 1 additional shield."},{id:"theology",name:"Theology",nameFr:"Théologie",description:"Every future Wonder built by the owner grants an extra turn."},{id:"urbanism",name:"Urbanism",nameFr:"Urbanisme",description:"Gain 6 coins immediately. When the owner builds a card for free via a chain link, they also gain 4 coins."}].map(e=>[e.id,e]));const Zm=.2,a$=.3,Jm=.25,Pa={total:0,idDiff:0,verdictDiff:0},wt={pass1Calls:0,pass1Boxes:0,pass1Kept:0,pass2Calls:0,pass2Boxes:0,pass2Promoted:0},Dt={total:0,divergent:0,positifs4:0,positifs2:0,detail:[]},ai={total:0,memeK:0,memeKInverse:0,detail:[]};function s$(e,t,n){for(const r of e){let i=!1;for(let a=0,o=r.length-1;a<r.length;o=a++){const s=r[a],u=r[o];s[1]>n!=u[1]>n&&t<(u[0]-s[0])*(n-s[1])/(u[1]-s[1])+s[0]&&(i=!i)}if(i)return r.map(a=>[a[0],a[1]])}return null}function u$(e,t,n){if(t.height<=0)return!1;const r=t.width/t.height;if(Math.abs(Math.log(r))<=Jm)return!1;const i=e.x+e.width,a=e.y+e.height;for(const o of n){const s=o.box;if(!s||s.length<4||s[3]<=0)continue;const u=s[0]+s[2]/2,l=s[1]+s[3]/2;if(!(u>=e.x&&u<=i&&l>=e.y&&l<=a))continue;const c=s[2]/s[3];if(!(Math.abs(Math.log(c))<=Jm)&&r>1==c>1)return!0}return!1}async function l$(e,t,n,r,i=[0,1,2,3]){const[a,o,s,u]=t;if(s<=0||u<=0)return null;const l=Math.round(s*Zm),c=Math.round(u*Zm),d=Math.max(0,Math.round(a-l)),p=Math.max(0,Math.round(o-c)),f=Math.min(e.width,Math.round(a+s+l)),m=Math.min(e.height,Math.round(o+u+c)),y=f-d,w=m-p;if(y<=0||w<=0)return null;const b=e.channels,x=new Uint8ClampedArray(y*w*b);for(let I=0;I<w;I++){const E=((p+I)*e.width+d)*b;x.set(e.data.subarray(E,E+y*b),I*y*b)}const M={width:y,height:w,channels:b,data:x};let v=null;for(const I of i){const E=I===0?M:Kt(M,I),k=E.width,S=k-Math.floor(a$*k),R=k-S;if(R<=0)continue;const B=new Uint8ClampedArray(R*E.height*E.channels);for(let F=0;F<E.height;F++){const X=(F*k+S)*E.channels;B.set(E.data.subarray(X,X+R*E.channels),F*R*E.channels)}const Y={width:R,height:E.height,channels:E.channels,data:B},G=Zr(Y),N=(await n.run({[n.inputNames[0]]:new Be("float32",G,[1,3,gt,gt])}))[n.outputNames[0]].data[1]??0;r&&(r[I]=N),v=v===null?N:Math.max(v,N)}return v}async function eg(e,t,n,r,i,a,o){var f;const s=async m=>(await i.run({[i.inputNames[0]]:new Be("float32",m,[1,3,Xt,Xt])}))[i.outputNames[0]].data,u=e.obbQuads===void 0?null:await et("OBB merveilles (détection orientée)",async()=>{try{return await e.obbQuads(n)}catch(m){return console.warn("[wonders-obb] détection échouée, repli ORB :",m),null}}),l=new Map;for(const m of r){const[y,w,b,x]=m;if(b<=0||x<=0)continue;const M=u===null?null:s$(u,y+b/2,w+x/2);if(M===null||e.redresserQuad===void 0)continue;let v=M;const I=at("identify: redressement du quad",()=>e.redresserQuad(n,v)),E=Pm(),{id:k,prob:S,inverse:R}=await et("classifieur merveille (1 lecture)",()=>u2(I,s));if(k===""||S<E)continue;R&&(v=Jx(v).map(Y=>[Y[0],Y[1]]));const B=l.get(k);(B===void 0||S>B.prob)&&l.set(k,{prob:S,box:m,quad:v})}const c=[],d=await e.tuckClassifier(),p=await e.tuckBoxClassifier();for(const[m,{prob:y,box:w,quad:b}]of l){const[x,M,v,I]=w;let E={x:Math.round(x),y:Math.round(M),width:Math.round(v),height:Math.round(I)},k=null,S=[],R=null;if(b!==null){k=b;const L=k.map(U=>U[0]),O=k.map(U=>U[1]),C=Math.max(0,Math.round(Math.min(...L))),z=Math.max(0,Math.round(Math.min(...O)));if(E={x:C,y:z,width:Math.min(n.width,Math.round(Math.max(...L)))-C,height:Math.min(n.height,Math.round(Math.max(...O)))-z},d!==null)try{const U=await e.wonderRef(m),P=k,j=U===null||P===null?null:at("identify: bande droite #63",()=>Ia(t,n,U,P));if(j!==null){const ie=at("identify: preprocess tuck",()=>Zr(j)),J=await d.run({[d.inputNames[0]]:new Be("float32",ie,[1,3,gt,gt])});R=Ta(J[d.outputNames[0]].data).prob,S=R>=Wn?["R"]:[]}}catch{}}else if(Date.now()<a)try{const L=await et("chargement refs merveilles",()=>e.wonderRef(m));if(L!==null){const O=at("ORB registration (merveille)",()=>vm(t,n,L,w));if(O!==null){k=O.footprint,S=O.overflow;const C=k.map(j=>j[0]),z=k.map(j=>j[1]),U=Math.max(0,Math.round(Math.min(...C))),P=Math.max(0,Math.round(Math.min(...z)));if(E={x:U,y:P,width:Math.min(n.width,Math.round(Math.max(...C)))-U,height:Math.min(n.height,Math.round(Math.max(...z)))-P},d!==null)try{const j=k,ie=j===null?null:at("identify: bande droite #63",()=>Ia(t,n,L,j));if(ie!==null){const J=at("identify: preprocess tuck",()=>Zr(ie)),me=await d.run({[d.inputNames[0]]:new Be("float32",J,[1,3,gt,gt])});R=Ta(me[d.outputNames[0]].data).prob}}catch{}}}}catch(L){console.warn(`[wonders-cls] ${m} registration failed:`,L)}const B=k!==null?Qr(k,S):null,Y=b!==null&&k!==null?Qr(k,["R"]):null,G=[];if(R!==null&&G.push(R>=Wn?1:0),p!==null)try{let L=[0,1,2,3];if(b!==null){const z=b[1][1]-b[0][1],U=b[1][0]-b[0][0],P=(Math.round(Math.atan2(z,U)*180/Math.PI/90)%4+4)%4;L=[(0+P)%4,(2+P)%4]}const O=[0,0,0,0],C=await et("identify: sonde marges (#68)",()=>l$(n,w,p,O,L));if(C!==null&&(G.push(C>=Wn?1:0),b!==null)){const z=b[1][1]-b[0][1],U=b[1][0]-b[0][0],P=(Math.round(Math.atan2(z,U)*180/Math.PI/90)%4+4)%4,j=Math.max(O[(0+P)%4],O[(2+P)%4]);Dt.total+=1;const ie=C>=Wn?1:0,J=j>=Wn?1:0;ie===1&&(Dt.positifs4+=1),J===1&&(Dt.positifs2+=1),ie!==J&&(Dt.divergent+=1,Dt.detail.push(`${m.slice(0,12)}:v4=${ie}/v2=${J} p=[${O.map(me=>me.toFixed(2)).join(",")}]kQ${P}`))}}catch{}const q=Y??B??E,N=o.some(L=>{const O=L.box[0]+L.box[2]/2,C=L.box[1]+L.box[3]/2;return O>=q.x&&O<=q.x+q.width&&C>=q.y&&C<=q.y+q.height});G.push(N?1:0);let F=G.length>0&&G.reduce((L,O)=>L+O,0)*2>G.length;F&&u$(q,E,o)&&(F=!1);const X=B??(F&&Y!==null?Y:null),Z={id:m,name:((f=o$[m])==null?void 0:f.name)??m,builtWithCardUnderneath:F,boundingBox:E,confidence:Math.round(y*1e4)/1e4,...X?{tuckRegion:X}:{}},le=X??E;c.push({obj:Z,edgeScores:null,zone:{x0:le.x,y0:le.y,x1:le.x+le.width,y1:le.y+le.height},quad:k,region:X})}return c}async function tg(e,t,n,r,i,a,o=[]){let s=await e.localiseWonders(n);return s.length===0?[]:o.length>0&&(s=s.filter(([u,l,c,d])=>{const p=u+c/2,f=l+d/2;return!o.some(m=>{const y=m.x+m.width/2,w=m.y+m.height/2,b=.5*Math.min(m.width,m.height);return(p-y)**2+(f-w)**2<b*b})}),s.length===0)?[]:eg(e,t,n,s,r,i,a)}function c$(e,t){const n=Km(e.obj.boundingBox,t),r=e.region===null?null:Km(e.region,t),i=r??n;return{obj:{...e.obj,boundingBox:n,...e.region===null?{}:{tuckRegion:r}},edgeScores:e.edgeScores,zone:{x0:i.x,y0:i.y,x1:i.x+i.width,y1:i.y+i.height},quad:e.quad===null?null:e.quad.map(([a,o])=>[a+t[0],o+t[1]]),region:r}}async function ng(e){try{const t=vx(e.image.width,e.image.height,e.banners.map(o=>o.box),e.hulls,e.wonderBoxes);if(t.length===0)return[];const n=[];for(const o of t){const s=e.cropFrame(o);if(s.width<=0||s.height<=0)continue;const u=e.skipKnownNear?e.known.map(l=>({x:l.boundingBox.x-o[0],y:l.boundingBox.y-o[1],width:l.boundingBox.width,height:l.boundingBox.height})):void 0;for(const l of await e.detect(s,Mx(e.banners,o),u))n.push(c$(l,o))}if(e.builtSeenOut)for(const o of n)o.obj.id&&o.obj.builtWithCardUnderneath===!0&&e.builtSeenOut.add(o.obj.id);if(n.length===0)return[];const r=[...e.known.map(o=>({boundingBox:o.boundingBox,id:o.id,neuf:-1})),...n.map((o,s)=>({boundingBox:o.obj.boundingBox,id:o.obj.id,neuf:s}))],i=Sx(r),a=[];for(const o of i){const s=o.neuf;s>=0&&a.push(n[s])}return a}catch(t){return console.warn("[#149 wonder-rescan] skipped:",t),[]}}const je="/7wd-scorer/models/",Da=[];let Ct=null;function d$(){Da.length=0,Ct=null}function h$(e){const t=performance.now();Ct!==null&&Da.push({nom:Ct.nom,ms:Math.round(t-Ct.debut)}),Ct={nom:e,debut:t}}function rg(){const e=[...Da];Ct!==null&&e.push({nom:`${Ct.nom} (en cours)`,ms:Math.round(performance.now()-Ct.debut)});const t=new Map;for(const n of e){const r=t.get(n.nom)??{appels:0,ms:0};r.appels+=1,r.ms+=n.ms,t.set(n.nom,r)}return[...t.entries()].map(([n,r])=>({nom:n,appels:r.appels,ms:r.ms})).sort((n,r)=>r.ms-n.ms)}function ig(){const e={};for(const t of Object.keys(nt))e[nt[t].onnx]=li.has(t)?"wasm (repli apres echec webgpu)":"webgpu>wasm";for(const[t,n]of ut)e[t]=n;return e}function p$(){var e,t;return ui(),{crossOriginIsolated:globalThis.crossOriginIsolated??null,numThreads:ze.wasm.numThreads??null,sharedArrayBuffer:typeof SharedArrayBuffer<"u",coeurs:((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??null,webgpuPresent:typeof((t=globalThis.navigator)==null?void 0:t.gpu)<"u"}}let og=!1;const si=new Map;function ui(){var e;og||(ze.wasm.wasmPaths="/7wd-scorer/ort/",ze.wasm.numThreads=globalThis.crossOriginIsolated?Math.max(1,(((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??4)-2):1,og=!0)}const li=new Set;function f$(e){ui();let t=si.get(e);return t===void 0&&(t=et(`session: 1er chargement ${nt[e].onnx}`,()=>zn.create(`${je}${nt[e].onnx}`,{executionProviders:li.has(e)?["wasm"]:["webgpu","wasm"]})),si.set(e,t),t.catch(()=>si.delete(e))),t}const ut=new Map;let yr=0,wr=0;const ci=new Map;function Ua(e){const t=(Ct==null?void 0:Ct.nom)??"(hors etage)";ci.set(t,(ci.get(t)??0)+e)}function m$(){return[...ci.entries()].map(([e,t])=>({nom:e,ms:Math.round(t)})).sort((e,t)=>t.ms-e.ms)}let La=0;function g$(){return{ms:Math.round(yr),appels:wr,preparationMs:Math.round(La)}}function y$(){yr=0,wr=0,La=0,Fw(),ci.clear(),iv()}const ag=new Set(["coin_yolo.onnx","token_yolo.onnx","wonder_yolo.onnx","track_band.onnx"]),Fa=new Set;let Ga=null;async function Wa(e){if(Ga)return await Ga.catch(()=>{}),e();const t=e();return Ga=t.catch(()=>{}),t}async function qa(e,t){return Wa(()=>zn.create(`${je}${e}`,{executionProviders:t?["webgpu"]:["wasm"]}))}async function ft(e){return et(`session: 1er chargement ${e}`,()=>w$(e))}async function w$(e){ui();const t=!ag.has(e)&&!Fa.has(e);let n=null;if(t)try{n=await qa(e,!0),ut.set(e,"webgpu")}catch(o){Fa.add(e),ut.set(e,`wasm (webgpu refuse a la creation: ${String(o).slice(0,60)})`)}else ut.set(e,ag.has(e)?"wasm (webgpu incompatible, mesure)":"wasm");if(n===null)try{n=await qa(e,!1)}catch(o){return ut.set(e,`ECHEC wasm: ${String(o).slice(0,160)}`),null}let r=n,i=ut.get(e)==="webgpu";const a=async(o,...s)=>{const u=performance.now();try{const l=await r.run(o,...s),c=performance.now()-u;return yr+=c,Ua(c),wr+=1,l}catch(l){if(!i)throw l;Fa.add(e),ut.set(e,`wasm (repli au run: ${String(l).slice(0,60)})`),i=!1,r=await qa(e,!1);const c=await r.run(o,...s),d=performance.now()-u;return yr+=d,Ua(d),wr+=1,c}};return new Proxy(r,{get(o,s,u){if(s==="run")return a;const l=Reflect.get(r,s,u);return typeof l=="function"?l.bind(r):l}})}let Va=null,Ha=null;const b$=.75,_$=4,x$=.65,$$=3e4;let ja=null;function jn(){return ja===null&&(ja=(async()=>{try{let e;return self.importScripts("/7wd-scorer/opencv/opencv.js"),e=self.cv,typeof(e==null?void 0:e.then)=="function"&&(e=await e),typeof(e==null?void 0:e.getBuildInformation)!="function"&&(e=await new Promise(t=>{e.onRuntimeInitialized=()=>t(e)})),e}catch(e){return console.warn("[wonders-reg] opencv.js load failed:",e),null}})()),ja}const sg=new Map;function Ka(e){let t=sg.get(e);return t===void 0&&(t=(async()=>{try{const n=await fetch(`${je}${e}`);if(!n.ok)return null;const r=await createImageBitmap(await n.blob()),a=new OffscreenCanvas(r.width,r.height).getContext("2d");a.drawImage(r,0,0);const o=a.getImageData(0,0,r.width,r.height);return{width:r.width,height:r.height,channels:4,data:new Uint8Array(o.data.buffer)}}catch{return null}})(),sg.set(e,t)),t}function Ya(e){return Ka(`wonder-refs/${e}.jpg`)}const ug=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"];async function v$(){const e=new Map;for(const t of ug){const n=await Ka(`guild-refs/${t}.jpg`);n!==null&&e.set(t,n)}return e}async function M$(){const e=new Map;for(const t of ug){const n=await Ka(`guild-band-refs/${t}.png`);n!==null&&e.set(t,n)}return e}const S$=.6,I$=12,T$=45e3;let Xa=null;function lg(){return Xa===null&&(ui(),Xa=(async()=>{try{const[e,t,n,r]=await Promise.all([Wa(()=>zn.create(`${je}ocr/ch_PP-OCRv4_det_infer.onnx`,{executionProviders:["webgpu","wasm"]})),Wa(()=>zn.create(`${je}ocr/ch_PP-OCRv4_rec_infer.onnx`,{executionProviders:["webgpu","wasm"]})),fetch(`${je}ocr_charset.json`).then(i=>i.ok?i.json():null),fetch(`${je}wonder_names.json`).then(i=>i.ok?i.json():null)]);return n===null||r===null?(console.warn("[wonders-ocr] charset/names asset missing"),null):{det:e,rec:t,charset:h_(n),catalog:r.entries}}catch(e){return console.warn("[wonders-ocr] bundle load failed:",e),null}})()),Xa}async function E$(e,t){const n=Math.max(d_/Yt,t.width/t.height),{tensor:r,width:i}=f_(t,n),a={[e.rec.inputNames[0]]:new Be("float32",r,[1,3,Yt,i])},o=(await e.rec.run(a))[e.rec.outputNames[0]],[s,u,l]=o.dims,c=o.data,d=new Array(u),p=new Array(u);for(let f=0;f<u;f++){let m=0,y=-1/0;const w=f*l;for(let b=0;b<l;b++){const x=c[w+b];x>y&&(y=x,m=b)}d[f]=m,p[f]=y}return p_(d,p,e.charset)}function k$(...e){return et("merveilles (OCR+ORB+opencv)",()=>C$(...e))}async function C$(e,t){const n=await lg();if(n===null)return{wonders:[],aborted:!1};const r=new Map,i=Date.now()+T$;let a=!1;e:for(const o of[0,1,2,3]){if(Date.now()>i){a=!0;break}t(`wonder names: rotation ${o*90}°…`,o/4);const s=Kt(e,o),u=t_(s),l={[n.det.inputNames[0]]:new Be("float32",u.tensor,[1,3,u.height,u.width])},c=(await n.det.run(l))[n.det.outputNames[0]],d=s_(c.data,u,s.width,s.height).slice(0,I$);console.debug(`[wonders-ocr] rot ${o*90}: ${d.length} det boxes`,d.slice(0,5).map(p=>`${p.width}x${p.height}@${p.score.toFixed(2)}`));for(const p of d){if(Date.now()>i){a=!0;break e}const f=u_(s,p.quad);if(f.width<f.height*1.5)continue;const[m,y]=await E$(n,f);if(console.debug(`[wonders-ocr] rec "${m}" @${y.toFixed(2)}`),y<S$||m.trim().length<_$)continue;const w=x_(m,n.catalog);if(console.debug("[wonders-ocr] fuzzy",w),w===null||w.confidence<b$||w.kind!=="wonder")continue;const b=r.get(w.id);(b===void 0||w.confidence>b.confidence)&&r.set(w.id,{id:w.id,name:w.name,confidence:w.confidence,nameBox:Qa(p,o,e.width,e.height)})}}return{wonders:[...r.values()],aborted:a}}function Qa(e,t,n,r){const i=(t%4+4)%4;if(i===0)return{x:e.x,y:e.y,width:e.width,height:e.height};const a=(d,p)=>i===1?[p,r-1-d]:i===2?[n-1-d,r-1-p]:[n-1-p,d],o=[a(e.x,e.y),a(e.x+e.width,e.y+e.height)],s=o.map(d=>d[0]),u=o.map(d=>d[1]),l=Math.min(...s),c=Math.min(...u);return{x:l,y:c,width:Math.max(...s)-l,height:Math.max(...u)-c}}function A$(){return Ha===null&&(Ha=fetch(`${je}laurel_gallery.json`).then(async e=>e.ok?Wb(await e.json()):[]).catch(()=>[])),Ha}function R$(e,t,n,r){return at("crop",()=>O$(e,t,n,r))}function O$(e,t,n,r){return Ut(e,t-r,n-r,2*r,2*r)}function Ut(e,t,n,r,i){return at("crop",()=>N$(e,t,n,r,i))}function N$(e,t,n,r,i){const a=Math.max(0,Math.round(t)),o=Math.max(0,Math.round(n)),s=Math.min(e.width,Math.round(t+r)),u=Math.min(e.height,Math.round(n+i)),l=Math.max(0,s-a),c=Math.max(0,u-o),d=new Uint8Array(l*c*3);for(let p=0;p<c;p++)for(let f=0;f<l;f++){const m=((p+o)*e.width+(f+a))*e.channels,y=(p*l+f)*3;d[y]=e.data[m],d[y+1]=e.data[m+1],d[y+2]=e.data[m+2]}return{width:l,height:c,channels:3,data:d}}function z$(){return Va===null&&(Va=fetch(`${je}token_templates.json`).then(async e=>e.ok?P1(await e.json()):new Map).catch(()=>new Map)),Va}let Za=null;function cg(){return Za===null&&(Za=(async()=>{try{const e=await fetch(`${je}token_embed_index.json`);if(!e.ok)return null;const t=V1(await e.json()),n=await ft("token_embed.onnx");return n===null?null:{session:n,index:t}}catch{return null}})()),Za}const B$=.92;let Ja=null;function dg(){return Ja===null&&(Ja=(async()=>{try{return(await fetch(`${je}guild_classifier.onnx`,{method:"HEAD"})).ok?await ft("guild_classifier.onnx"):null}catch{return null}})()),Ja}let es=null;function hg(){return es===null&&(es=(async()=>{try{return(await fetch(`${je}laurel_digit.onnx`,{method:"HEAD"})).ok?await ft("laurel_digit.onnx"):null}catch{return null}})()),es}let ts=null,ns=null;function pg(){return ns===null&&(ns=(async()=>{try{return(await fetch(`${je}banner_class.onnx`,{method:"HEAD"})).ok?await ft("banner_class.onnx"):null}catch{return null}})()),ns}async function P$(e,t){if(t.length===0)return t;const n=await pg();if(n===null)return t;const r=[];for(const i of t)try{const a=$2(i.box,e.width,e.height);if(a===null){r.push(i);continue}const o=Ut(e,a.x,a.y,a.w,a.h),s=v2(o),u=await n.run({[n.inputNames[0]]:new Be("float32",s,[1,3,cn,cn])});M2(u[n.outputNames[0]].data).rejected||r.push(i)}catch{r.push(i)}return r}function fg(){return ts===null&&(ts=(async()=>{try{return(await fetch(`${je}laurel_filter.onnx`,{method:"HEAD"})).ok?await ft("laurel_filter.onnx"):null}catch{return null}})()),ts}async function D$(e,t,n){let[r,i,a,o]=t,s=a-r,u=o-i;if(s<=0||u<=0)return null;if(s<Vn){const w=Math.floor((r+a)/2);r=w-Math.floor(Vn/2),a=w+Math.floor(Vn/2),s=a-r}if(u<Vn){const w=Math.floor((i+o)/2);i=w-Math.floor(Vn/2),o=w+Math.floor(Vn/2),u=o-i}const l=Math.trunc(Lm*s),c=Math.trunc(Lm*u),d=Math.max(0,r-l),p=Math.max(0,i-c),f=Math.min(e.width,a+l),m=Math.min(e.height,o+c),y=Ut(e,d,p,f-d,m-p);if(y.width<=0||y.height<=0)return null;try{const w=y2(y),b=await n.run({[n.inputNames[0]]:new Be("float32",w,[1,3,ln,ln])});return w2(b[n.outputNames[0]].data)}catch{return null}}let rs=null;function mg(){return rs===null&&(rs=(async()=>{try{return(await fetch(`${je}coin_filter_cnn.onnx`,{method:"HEAD"})).ok?await ft("coin_filter_cnn.onnx"):null}catch{return null}})()),rs}let is=null;function gg(){return is===null&&(is=(async()=>{try{return(await fetch(`${je}coin_denom.onnx`,{method:"HEAD"})).ok?await ft("coin_denom.onnx"):null}catch{return null}})()),is}async function U$(e,t,n){if(t.length===0)return[];try{const r=[];for(const u of t){const l=Vm(e,Math.round(u.cx),Math.round(u.cy),Math.round(u.r));if(l===null)return null;r.push(l)}const i=new Float32Array(t.length*3*yt*yt);r.forEach((u,l)=>i.set(u,l*u.length));const o=(await n.run({[n.inputNames[0]]:new Be("float32",i,[t.length,3,yt,yt])}))[n.outputNames[0]].data,s=ni.length;return t.map((u,l)=>W2(o.subarray(l*s,l*s+s)))}catch{return null}}async function L$(e,t,n){if(t.length===0)return[];try{const r=async u=>{const l=[];for(let f=0;f<t.length;f++){const m=Vm(e,Math.round(t[f].cx),Math.round(t[f].cy),Math.round(u[f]));if(m===null)return null;l.push(m)}const c=new Float32Array(t.length*3*yt*yt);l.forEach((f,m)=>c.set(f,m*f.length));const p=(await n.run({[n.inputNames[0]]:new Be("float32",c,[t.length,3,yt,yt])}))[n.outputNames[0]].data;return t.map((f,m)=>F2(p.subarray(m*2,m*2+2)))},i=await r(t.map(u=>u.r));if(i===null)return null;const a=t.map(u=>u.r).sort((u,l)=>u-l),o=a.length%2===1?a[(a.length-1)/2]:(a[a.length/2-1]+a[a.length/2])/2,s=Math.trunc(o);if(s>=8){const u=await r(t.map(()=>s));if(u!==null)return i.map((l,c)=>Math.max(l,u[c]))}return i}catch{return null}}let os=null;function as(){return os===null&&(os=(async()=>{try{return(await fetch(`${je}tuck_classifier.onnx`,{method:"HEAD"})).ok?await ft("tuck_classifier.onnx"):null}catch{return null}})()),os}const yg=.1;let ss=null;function us(){return ss===null&&(ss=(async()=>{try{return(await fetch(`${je}track_band.onnx`,{method:"HEAD"})).ok?await ft("track_band.onnx"):null}catch{return null}})()),ss}async function wg(e,t,n){try{const r=jr(t,1280,jw(t.width,t.height,n)),i=await e.run({[e.inputNames[0]]:new Be("float32",r.tensor,[1,3,1280,1280])});return pr(i[e.outputNames[0]].data,r.params,yg)}catch{return[]}}let ls=null;const F$=.4;function G$(e,t){const n=Math.min(e.x+e.width,t.x+t.width)-Math.max(e.x,t.x),r=Math.min(e.y+e.height,t.y+t.height)-Math.max(e.y,t.y);if(n<=0||r<=0)return 0;const i=e.width*e.height;return i>0?n*r/i:0}function W$(e,t){const n=[],r=[];for(const i of t){if(!i.builtWithCardUnderneath)continue;i.boundingBox&&n.push(i.boundingBox);const a=i.tuckRegion;a&&r.push(a)}return n.length===0&&r.length===0?e:e.filter(i=>{const a=i.boundingBox;if(!a)return!0;const o=a.x+a.width/2,s=a.y+a.height/2;for(const u of n)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height||G$(a,u)>=F$)return!1;for(const u of r)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height)return!1;return!0})}function bg(){return ls===null&&(ls=(async()=>{try{return(await fetch(`${je}tuck_box.onnx`,{method:"HEAD"})).ok?await ft("tuck_box.onnx"):null}catch{return null}})()),ls}let cs=null;function _g(){return cs===null&&(cs=(async()=>{try{return(await fetch(`${je}wonder_classifier.onnx`,{method:"HEAD"})).ok?(await q$(),await ft("wonder_classifier.onnx")):null}catch{return null}})()),cs}let xg=!1;async function q$(){if(xg)return;const e=await(await fetch(`${je}wonder_classifier_seuil.json`)).json();n2(Number(e.seuil)),r2(e.classes),xg=!0}let $g=null,vg=null;async function V$(e){var d;$g??($g=ft("wonder_obb.onnx"));const t=await $g;if(t===null)return null;const n=await jn();if(n===null)return null;vg=n;const{tensor:r,params:i}=jr(e,1024),o=(await t.run({[t.inputNames[0]]:new Be("float32",r,[1,3,1024,1024])}))[t.outputNames[0]],s=o.dims[o.dims.length-1],u=o.data;let l=0;for(let p=0;p<s;p++){const f=u[4*s+p];f>l&&(l=f)}const c=Yx(n,u,s,i);return ut.set("wonder_obb.onnx",`${ut.get("wonder_obb.onnx")??"?"} | dims=${o.dims} scoreMax=${l.toFixed(4)} dets=${c.length} q0=${(d=c[0])!=null&&d.quad[0]?JSON.stringify(c[0].quad[0].map(Math.round)):"-"} img=${e.width}x${e.height} scale=${i.scale.toFixed(4)} pad=${i.padX},${i.padY}`),c.map(p=>p.quad.map(f=>[f[0],f[1]]))}const ds={wonderRef:Ya,tuckClassifier:as,tuckBoxClassifier:bg,obbQuads:V$,redresserQuad:(e,t)=>Zx(vg,e,t),localiseWonders:async e=>{try{const{rows:t,params:n}=await bt("wonder",e);return ha(t,n,nt.wonder.conf,Number.POSITIVE_INFINITY).map(r=>r.box)}catch{return[]}}};async function H$(e,t){const n=await cg();if(n!==null)try{const r=j1(e),i=new Be("float32",r,[4,3,un,un]),o=(await n.session.run({image:i}))[n.session.outputNames[0]].data,{id:s,cosine:u}=Y1(n.index,K1(o));return u<B$?["",-1]:[s,u]}catch{}return F1(e,t)}const Mg=new WeakMap;async function di(e){const t=Mg.get(e);if(t!==void 0)return await t;const n=et("decodage image",()=>j$(e));return Mg.set(e,n),await n}async function j$(e){let t;try{t=await createImageBitmap(e)}catch(n){const r=e.name||"(sans nom)",i=e.type||"(type inconnu)",a=e.size===0?"le fichier est VIDE (0 octet) — la capture a probablement été interrompue":/heic|heif/i.test(i)||/\.hei[cf]$/i.test(r)?"format HEIC/HEIF : ce navigateur ne sait pas le décoder — régler l'appareil photo sur JPEG (« Plus compatible » sur iPhone), ou repasser par la galerie qui convertit":"le fichier n'est plus lisible : s'il vient de l'appareil photo, l'OS a pu l'invalider pendant que l'app était en arrière-plan — reprendre la photo devrait suffire";throw new Error(`Image illisible (${r}, ${i}, ${e.size} octets) : ${a}. [${n instanceof Error?n.name:String(n)}]`)}try{const r=new OffscreenCanvas(t.width,t.height).getContext("2d",{willReadFrequently:!0});if(r===null)throw new Error("OffscreenCanvas 2D context unavailable.");r.drawImage(t,0,0);const{data:i}=r.getImageData(0,0,t.width,t.height);return{width:t.width,height:t.height,channels:4,data:i}}finally{t.close()}}const Sg=new WeakMap;async function bt(e,t){let n=Sg.get(t);n===void 0&&(n=new Map,Sg.set(t,n));const r=n.get(e);if(r!==void 0)return await r;const i=K$(e,t);return n.set(e,i),await i}async function K$(e,t){const n=nt[e],r=performance.now(),{tensor:i,params:a}=jr(t,n.input);La+=performance.now()-r;const o=async()=>{const s=await f$(e),u={[s.inputNames[0]]:new Be("float32",i,[1,3,n.input,n.input])},l=performance.now(),c=await s.run(u),d=performance.now()-l;yr+=d,Ua(d),wr+=1;const p=c[s.outputNames[0]];return{rows:new Float32Array(p.data),params:a}};try{return await o()}catch(s){if(li.has(e))throw s;return li.add(e),si.delete(e),await o()}}const Y$=6,X$=4,Q$=5,Z$=2;async function J$(e){const t={kind:"unknown",confidence:0,banners:null,laurels:null,coins:null,pawnFound:!1},n=await di(e),r=await bt("banner",n),i=Kr(r.rows,r.params,nt.banner.conf);if(t.banners=i.length,i.length>=Y$)return{...t,kind:"player",confidence:Math.min(1,i.length/12)};const a=await bt("laurel",n),o=pr(a.rows,a.params,nt.laurel.conf);if(t.laurels=o.length,o.length>=X$)return{...t,kind:"player",confidence:Math.min(1,o.length/8)};const s=await bt("coin",n),u=om(s.rows,s.params,nt.coin.conf);return t.coins=u.length,u.length>=Q$?{...t,kind:"player",confidence:.5}:t.banners!==null&&t.banners<=Z$?{...t,kind:"board",confidence:.4}:t}function ev(){return{wonders:[],guilds:[],progressTokens:[],laurels:[],cardVictoryPoints:{value:0,laurelsKept:0,laurelsUnread:0,complete:!0},cardCounts:{byFamily:{},source:"none",tuckedExcluded:0},coins:{total:0,confidence:0,source:"none",coins:[]}}}async function Ig(e,t,n,r,i,a,o,s){let u=0;r(`${i}: card banners…`,.04);const l=await bt("banner",e);let c=Kr(l.rows,l.params,nt.banner.conf);c=await P$(e,c),r(`${i}: progress tokens…`,.08);let d=[];const p=await us();p!==null&&(d=await wg(p,e,c)),d.length>0&&c.length>0&&(c=c.filter(W=>{const ee=W.box[0]+W.box[2]/2,ne=W.box[1]+W.box[3]/2;return!d.some(([oe,ae,xe,_e])=>Math.min(oe,xe)<=ee&&ee<=Math.max(oe,xe)&&Math.min(ae,_e)<=ne&&ne<=Math.max(ae,_e))}));const f=await bt("token",e),m=await z$(),y=[],w=[];for(const W of ib(f.rows,f.params,nt.token.conf)){if(w.push({cx:W.cx,cy:W.cy,r:W.r}),d.some(([oe,ae,xe,_e])=>W.cx>=oe&&W.cx<=xe&&W.cy>=ae&&W.cy<=_e))continue;const[ee,ne]=await H$(hm(e,W),m);ee===""&&ne<0?w.pop():ee===""?u+=1:!y.some(oe=>oe.id===ee)&&!s.some(oe=>oe.id===ee)&&y.push({id:ee,center:[W.cx,W.cy],radius:W.r,confidence:Math.round(ne*1e4)/1e4})}r(`${i}: coins…`,.14);const b=await bt("coin",e),x=om(b.rows,b.params,nt.coin.conf).filter(W=>!w.some(ee=>(W.cx-ee.cx)**2+(W.cy-ee.cy)**2<=W.r*W.r)),M=await mg(),v=M!==null?await L$(e,x,M):null,I=(v!==null?x.filter((W,ee)=>v[ee]>=qm).map(W=>W.r):[]).sort((W,ee)=>W-ee),E=I.length>0?I.length%2===1?I[(I.length-1)/2]:(I[I.length/2-1]+I[I.length/2])/2:null,[k,S]=L2,R=x.map((W,ee)=>{const ne=v!==null?v[ee]:null;return ne===null||ne>=qm?"keep":E!==null&&E>0&&W.r/E>=k&&W.r/E<=S?"suspect":"drop"}),B=x.filter((W,ee)=>R[ee]==="keep"),Y=Eb(e,B),G=await gg(),q=G!==null?await U$(e,B,G):null,N=q2(Y,q??Y.map(()=>null));N.map(W=>W.value);const F=[];let X=0;if(x.forEach((W,ee)=>{if(R[ee]==="drop")return;if(R[ee]==="suspect"){const oe=v[ee];F.push({denomination:null,center:[W.cx,W.cy],radius:W.r,suspect:!0,suspectReason:`content rejected as non-coin (P=${oe.toFixed(2)}) but the size matches this photo's confirmed coins — glare-blinded real coin OR a look-alike object; confirm or remove (a busy table warrants a cleaner photo)`});return}const ne=N[X++];F.push({denomination:ne.value,center:[W.cx,W.cy],radius:W.r,denomSource:ne.source??"colour"})}),x.length>0&&F.length===0&&t.push({code:"LOW_CONFIDENCE",message:`${n}: ${x.length} disque(s) rond(s) détecté(s) mais tous rejetés comme non-pièces (0 pièce comptée) — vérifie, ou reprends une photo plus nette.`}),F.length>=2){const W=F.map(ne=>ne.radius).sort((ne,oe)=>ne-oe),ee=W.length%2===1?W[(W.length-1)/2]:(W[W.length/2-1]+W[W.length/2])/2;if(ee>0)for(const ne of F)ne.radius/ee>2&&(ne.suspect=!0,ne.suspectReason=`radius ${ne.radius}px is ${(ne.radius/ee).toFixed(1)}x the photo's median coin radius — probably not a coin`)}if(F.length>=2)for(let W=0;W<F.length;W+=1)for(let ee=W+1;ee<F.length;ee+=1){const ne=F[W],oe=F[ee],ae=Math.hypot(ne.center[0]-oe.center[0],ne.center[1]-oe.center[1]);if(ae<1.1*Math.min(ne.radius,oe.radius))for(const xe of[ne,oe])xe.suspect||(xe.suspect=!0,xe.suspectReason=`almost concentric with another coin (${ae.toFixed(0)}px apart) — either a pile of two coins or a duplicate read of one; confirm which`)}const Z=[],le=[],L=[],O=Date.now()+$$;let C=null,z=null;const U=()=>(z===null&&(z=(async()=>{try{const{rows:W,params:ee}=await bt("wonder",e);return ha(W,ee,nt.wonder.conf,Number.POSITIVE_INFINITY).map(ne=>ne.box)}catch{return[]}})()),z),P=[];let j=!1;const ie=await _g();if(ie!==null){const W=await U();if(W.length>0&&(C=await et("opencv.js (chargement)",()=>jn()),C!==null)){r(`${i}: identifying wonders…`,.35);const ee=await et("identifyWondersByClassifier",()=>eg(ds,C,e,W,ie,O,c));for(const ne of ee)Z.some(oe=>oe.id===ne.obj.id)||o.some(oe=>oe.id===ne.obj.id)||(Z.push(ne.obj),P.push({obj:ne.obj,edgeScores:ne.edgeScores,zone:ne.zone}),le.push(ne.zone),L.push({quad:ne.quad,region:ne.region}));j=ee.length>0}}j||r(`${i}: wonder names…`,.2);const J=j?{wonders:[],aborted:!1}:await k$(e,(W,ee)=>r(`${i}: ${W}`,.2+.35*(ee??0)));C===null&&(C=J.wonders.length>0?await jn():null);for(const W of J.wonders){let ee=null;if(C!==null&&Date.now()<O){r(`${i}: registering ${W.name}…`,.6);try{const ne=await Ya(W.id);if(ne!==null){let oe=O_(C,e,ne,[[W.nameBox.x,W.nameBox.y],[W.nameBox.x+W.nameBox.width,W.nameBox.y],[W.nameBox.x+W.nameBox.width,W.nameBox.y+W.nameBox.height],[W.nameBox.x,W.nameBox.y+W.nameBox.height]]);if(oe===null){const ae=await U(),xe=D_(ae,W.nameBox.x+W.nameBox.width/2,W.nameBox.y+W.nameBox.height/2);xe!==null&&(oe=vm(C,e,ne,xe))}if(oe!==null){let ae=oe.built,xe=!1;const _e=await as();if(_e!==null)try{const ge=Ia(C,e,ne,oe.footprint);if(ge!==null){const we=Zr(ge),Se=await _e.run({[_e.inputNames[0]]:new Be("float32",we,[1,3,gt,gt])});ae=Ta(Se[_e.outputNames[0]].data).built,xe=!0}}catch{}const Q=oe.footprint.map(ge=>ge[0]),te=oe.footprint.map(ge=>ge[1]),se=Math.max(0,Math.round(Math.min(...Q))),pe=Math.max(0,Math.round(Math.min(...te)));ee={built:ae,boundingBox:{x:se,y:pe,width:Math.min(e.width,Math.round(Math.max(...Q)))-se,height:Math.min(e.height,Math.round(Math.max(...te)))-pe},tuckRegion:Qr(oe.footprint,oe.overflow),footprint:oe.footprint,edgeScores:oe.edgeScores,builtByTuck:xe}}}}catch(ne){console.warn(`[wonders-reg] ${W.id} failed:`,ne)}}if(ee!==null){const ne=ee.tuckRegion??ee.boundingBox;le.push({x0:ne.x,y0:ne.y,x1:ne.x+ne.width,y1:ne.y+ne.height}),L.push({quad:ee.footprint,region:ee.tuckRegion})}else{const ne=Math.max(8,W.nameBox.height),oe=Math.round(W.nameBox.width*.15);le.push({x0:W.nameBox.x-oe,y0:W.nameBox.y-ne*2.5,x1:W.nameBox.x+W.nameBox.width+oe,y1:W.nameBox.y+W.nameBox.height+ne*2.5}),L.push({quad:null,region:null})}if(!Z.some(ne=>ne.id===W.id)&&!o.some(ne=>ne.id===W.id)){const ne=(ee==null?void 0:ee.builtByTuck)===!0,oe=ne?ee.built:!1,ae=!ne&&(ee==null?void 0:ee.built)===!0,xe={id:W.id,name:W.name,builtWithCardUnderneath:oe,boundingBox:(ee==null?void 0:ee.boundingBox)??{x:0,y:0,width:0,height:0},...ee!=null&&ee.tuckRegion?{tuckRegion:ee.tuckRegion}:{},confidence:W.confidence,...ae?{suspect:!0,suspectReason:"built-unconfirmed"}:{}};Z.push(xe),P.push({obj:xe,edgeScores:ee&&!ee.builtByTuck?ee.edgeScores:null,zone:le[le.length-1]})}}if(!j){const W=F_(P.map(ee=>({built:ee.obj.builtWithCardUnderneath,edgeScores:ee.edgeScores,zone:ee.zone})),c.map(ee=>[ee.box[0]+ee.box[2]/2,ee.box[1]+ee.box[3]/2]));for(const ee of W){const ne=P[ee];ne.obj.builtWithCardUnderneath=!1,t.push({code:"INCONSISTENT_STATE",message:`${n}: wonder '${ne.obj.id}' was NOT marked built — the card-under-wonder signal saturated on this surface and no tucked card banner supports it. Tick it in the review if it really was built.`})}if(c.length>0){const ee=new Set(W);for(let ne=0;ne<P.length;ne++){const oe=P[ne];if(ee.has(ne)||!oe.obj.builtWithCardUnderneath)continue;const ae=oe.obj.tuckRegion;if(ae===void 0)continue;if(!c.some(_e=>{const Q=_e.box[0]+_e.box[2]/2,te=_e.box[1]+_e.box[3]/2;return Q>=ae.x&&Q<=ae.x+ae.width&&te>=ae.y&&te<=ae.y+ae.height})){const _e=oe.obj;_e.builtWithCardUnderneath=!1,_e.suspect=!0,_e.suspectReason="built-unconfirmed"}}}}if(J.aborted&&t.push({code:"LOW_CONFIDENCE",message:`${i}: the wonder-name read ran out of its time budget on this device — ${J.wonders.length} wonder(s) read before the cutoff; check the built-wonders list.`}),C!==null&&J.wonders.length>0&&Date.now()<O)try{const W=await lg(),ee=(W==null?void 0:W.catalog.filter(oe=>oe.kind==="wonder").map(oe=>oe.id))??[],ne=new Map;for(const oe of ee)if(!Z.some(ae=>ae.id===oe)&&!o.some(ae=>ae.id===oe)){const ae=await Ya(oe);ae!==null&&ne.set(oe,ae)}if(ne.size>0){r(`${i}: searching occluded wonders…`,.7);const oe=R_(C,e,ne,O);for(const ae of oe){const xe=ae.footprint.map(ye=>ye[0]),_e=ae.footprint.map(ye=>ye[1]),Q=Math.max(0,Math.round(Math.min(...xe))),te=Math.max(0,Math.round(Math.min(..._e))),se={x:Q,y:te,width:Math.min(e.width,Math.round(Math.max(...xe)))-Q,height:Math.min(e.height,Math.round(Math.max(..._e)))-te},pe=ye=>{const Ue=ye.boundingBox,Fe=Math.max(0,Math.min(Ue.x+Ue.width,se.x+se.width)-Math.max(Ue.x,se.x)),We=Math.max(0,Math.min(Ue.y+Ue.height,se.y+se.height)-Math.max(Ue.y,se.y)),qe=Fe*We,it=Ue.width*Ue.height+se.width*se.height-qe;return it>0&&qe/it>A_};if(Z.some(pe)||o.some(pe))continue;const we=W==null?void 0:W.catalog.find(ye=>ye.id===ae.id);Z.push({id:ae.id,name:(we==null?void 0:we.nameFr)??(we==null?void 0:we.name)??ae.id,builtWithCardUnderneath:ae.built,boundingBox:se,...ae.tuckRegion?{tuckRegion:ae.tuckRegion}:{},confidence:Math.round(ae.confidence*1e4)/1e4});const Se=ae.tuckRegion??se;le.push({x0:Se.x,y0:Se.y,x1:Se.x+Se.width,y1:Se.y+Se.height}),L.push({quad:ae.footprint.map(([ye,Ue])=>[ye,Ue]),region:ae.tuckRegion??null})}}}catch(W){console.warn("[wonders-reg] discovery failed:",W)}const me=async()=>{let W=Z.slice();const ee=[];c.forEach((_e,Q)=>{const te=_e.box[0]+_e.box[2]/2,se=_e.box[1]+_e.box[3]/2;le.some(pe=>te>=pe.x0&&te<=pe.x1&&se>=pe.y0&&se<=pe.y1)||ee.push(Q)});const ne=[],oe=[];W.forEach((_e,Q)=>{const te=_e.boundingBox;te&&te.width>0&&(ne.push(Q),oe.push([te.x,te.y,te.width,te.height]))});const ae=_e=>{const Q=[];return _e.forEach((te,se)=>{const pe=te.box[0]+te.box[2]/2,ge=te.box[1]+te.box[3]/2;le.some(we=>pe>=we.x0&&pe<=we.x1&&ge>=we.y0&&ge<=we.y1)||Q.push(se)}),Q};let xe=Ra(c.map(_e=>_e.box),ee,oe,d,[e.width,e.height]);if(ie!==null){r(`${i}: seconde passe merveilles (crop de cité)…`,.42),wt.pass1Calls+=1;const Q=(await ng({skipKnownNear:!0,image:e,banners:c,hulls:xe.hulls.map(([te,se],pe)=>({owner:te,poly:se,n:xe.hullBoxCounts[pe]??0})),wonderBoxes:oe,known:W,cropFrame:([te,se,pe,ge])=>Ut(e,te,se,pe-te,ge-se),detect:async(te,se,pe)=>{if(C===null&&(C=await jn()),C===null)return[];const ge=await tg(ds,C,te,ie,O,se,pe);return wt.pass1Boxes+=ge.length,ge}})).filter(te=>!Z.some(se=>se.id===te.obj.id)&&!o.some(se=>se.id===te.obj.id));if(wt.pass1Kept+=Q.length,Q.length>0){for(const te of Q)Z.push(te.obj),le.push(te.zone),L.push({quad:te.quad,region:te.region});W=Z.slice(),ne.length=0,oe.length=0,W.forEach((te,se)=>{const pe=te.boundingBox;pe&&pe.width>0&&(ne.push(se),oe.push([pe.x,pe.y,pe.width,pe.height]))}),xe=Ra(c.map(te=>te.box),ae(c),oe,d,[e.width,e.height])}}try{const _e=jm(e.width,e.height,c.map(Q=>Q.box),xe.hulls.map(([Q,te],se)=>({owner:Q,poly:te,n:xe.hullBoxCounts[se]??0})),oe);if(_e.length>0){const Q=Na(c.map(se=>se.box)),te=[];for(const se of _e){const[pe,ge,we,Se]=se,ye=Ut(e,pe,ge,we-pe,Se-ge);if(ye.width<=0||ye.height<=0)continue;const Ue=await bt("banner",ye);for(const Fe of Kr(Ue.rows,Ue.params,nt.banner.conf)){const We=$x(Fe.box,se,Q);We&&te.push({...Fe,box:We})}}if(te.length>0){const se=um([...c,...te]);se.length>c.length&&(c=se,xe=Ra(c.map(pe=>pe.box),ae(c),oe,d,[e.width,e.height]))}}}catch(_e){console.warn("[#129 city-rescan] skipped:",_e)}if(ie!==null&&W.some(_e=>_e.builtWithCardUnderneath!==!0)){r(`${i}: revote built (crop de cité)…`,.47);const _e=new Set;wt.pass2Calls+=1,await ng({builtSeenOut:_e,image:e,banners:c,hulls:xe.hulls.map(([Q,te],se)=>({owner:Q,poly:te,n:xe.hullBoxCounts[se]??0})),wonderBoxes:oe,known:W,cropFrame:([Q,te,se,pe])=>Ut(e,Q,te,se-Q,pe-te),detect:async(Q,te)=>{if(C===null&&(C=await jn()),C===null)return[];const se=await tg(ds,C,Q,ie,O,te);return wt.pass2Boxes+=se.length,se}}),wt.pass2Promoted+=[..._e].filter(Q=>W.some(te=>te.id===Q&&te.builtWithCardUnderneath!==!0)).length;for(const Q of W)Q.id&&_e.has(Q.id)&&Q.builtWithCardUnderneath!==!0&&(Q.builtWithCardUnderneath=!0,Q.builtByCityCrop=!0)}return a!==void 0&&(a.hulls=xe.hulls.map(([_e,Q],te)=>({owner:_e,poly:Q,n:xe.hullBoxCounts[te]??0})),a.bandBoxes=d,a.image=e),{split:xe,photoWonders:W,splitWonderIdx:ne}};let Te=null;try{Te=await me()}catch(W){console.warn("[city-split] failed (side unfiltered):",W)}return{bannerDetections:c,photoCoins:F,photoTokenDiscs:w,discs:x,bandBoxes:d,bandSession:p,wonderFootprints:le,wonderTuckGates:L,photoTokensList:y,geo:Te,cv:C,regDeadline:O,unidentifiedTokens:u}}async function Tg(e,t,n,r,i,a,o,s,u,l){let c=e.bannerDetections,d=e.cv;const{photoCoins:p,photoTokenDiscs:f,discs:m,bandBoxes:y,bandSession:w,wonderFootprints:b,wonderTuckGates:x,photoTokensList:M,geo:v,regDeadline:I}=e,E={},k=[],S=[];let R=0;const B=[];let Y=0,G=0;const q=[],N=[],F=[],X=t==="opponent";let Z=(Q,te)=>!X,le=(Q,te)=>!X,L=null;if(v!==null)try{const{split:Q,photoWonders:te,splitWonderIdx:se}=v;Z=(Se,ye)=>Q.pointOwner(Se,ye)==="opponent"===X;const pe=X?"opponent":"player";if(le=(Se,ye)=>Q.pointOwner(Se,ye)===pe,n){const Se=Q;L=ye=>new Set(lx(ye,Se,pe,y))}c=c.filter((Se,ye)=>Q.bannerOwner[ye]==="opponent"===X);const ge=te.map(()=>"player");se.forEach((Se,ye)=>{ge[Se]=Q.wonderOwner[ye]});const we=[];te.forEach((Se,ye)=>{ge[ye]==="opponent"===X&&we.push(Se)});for(const Se of we)N.push(Se);b.length=0;for(const Se of we){const ye=Se.tuckRegion??Se.boundingBox;ye&&b.push({x0:ye.x,y0:ye.y,x1:ye.x+ye.width,y1:ye.y+ye.height})}for(const Se of M)Z(Se.center[0],Se.center[1])&&F.push(Se)}catch(Q){console.warn("[city-split] failed (side unfiltered):",Q)}const O=L!==null?L(p):null;for(const Q of p)(O!==null?!O.has(Q):!le(Q.center[0],Q.center[1]))||(R+=Q.denomination??0,S.push(Q));const C=new Set,z=[],U=Na(c.map(Q=>Q.box));x.forEach((Q,te)=>{if(Q.quad===null||Q.region===null){const we=b[te];we&&z.push(we);return}const se=Q.region,pe=[];c.forEach((we,Se)=>{const ye=we.box[0]+we.box[2]/2,Ue=we.box[1]+we.box[3]/2;ye>=se.x&&ye<=se.x+se.width&&Ue>=se.y&&Ue<=se.y+se.height&&pe.push([Se,we.box])});const ge=U2(Q.quad,pe,U);ge!==null&&C.add(ge)});let P=[],j=0;c.forEach((Q,te)=>{if(C.has(te)){G+=1,j+=1;return}const se=Q.box[0]+Q.box[2]/2,pe=Q.box[1]+Q.box[3]/2;if(z.some(ge=>se>=ge.x0&&se<=ge.x1&&pe>=ge.y0&&pe<=ge.y1)){G+=1,j+=1;return}P.push(Q)});const ie=R2(P,j,y,a.width,a.height);P=ie.kept;for(const Q of P)E[Q.family]=(E[Q.family]??0)+1,Y+=1;const J=hb(P),me=new Set(J.map(Q=>Q.box.join(",")));for(const Q of fb(P))me.has(Q.box.join(","))||(J.push(Q),me.add(Q.box.join(",")));for(const Q of ie.suspects)me.has(Q.box.join(","))||(J.push(Q),me.add(Q.box.join(",")));for(const Q of J)q.push(Q);if(P.some(Q=>Q.family==="guild")){const Q=await dg();if(Q!==null){s(`${u}: identifying guilds…`,.75);for(const te of P)if(te.family==="guild")try{const[se,pe,ge,we]=te.box,Se=Ut(a,se,pe,ge,we),ye=Z1(Se),Ue={[Q.inputNames[0]]:new Be("float32",ye,[1,3,qn,qn])},We=(await Q.run(Ue))[Q.outputNames[0]].data,{id:qe,prob:it}=J1(We);qe!==""&&!B.some(Zt=>Zt.id===qe)&&!l.some(Zt=>Zt.id===qe)&&B.push({id:qe,boundingBox:{x:se,y:pe,width:ge,height:we},confidence:Math.round(it*1e4)/1e4})}catch(se){console.warn("[guild-cls] failed:",se)}}else if(Date.now()<I)try{const te=d??await jn();if(te!==null){const se=await v$();if(se.size>0){s(`${u}: identifying guilds…`,.75);const pe=await M$();for(const ge of T1(te,a,se,I,pe))!B.some(we=>we.id===ge.id)&&!l.some(we=>we.id===ge.id)&&B.push(ge)}}}catch(te){console.warn("[guilds-reg] failed:",te)}}s(`${u}: laurels…`,.8);const W=await et("laurier: chargement galerie gabarits",()=>A$()),ee=[];for(const Q of[0]){const te=Q===0?a:Kt(a,Q),se=await et("laurier: passe PLEINE photo",()=>bt("laurel",te));for(const[pe,ge,we,Se]of at("laurier: decodage YOLO (JS)",()=>pr(se.rows,se.params,nt.laurel.conf))){const ye=Qa({x:pe,y:ge,width:we-pe,height:Se-ge},Q,a.width,a.height);ee.push([ye.x,ye.y,ye.x+ye.width,ye.y+ye.height])}}let ne=at("laurier: dedup",()=>am(ee));const oe=[];try{const Q=zx(c.map(te=>te.box),[a.width,a.height]);ut.set("_tta.onnx",`total=${Pa.total} idDiff=${Pa.idDiff} verdictDiff=${Pa.verdictDiff}`),ut.set("_rescan.onnx",`p1: ${wt.pass1Calls} appels, ${wt.pass1Boxes} boites, ${wt.pass1Kept} neuves | p2: ${wt.pass2Calls} appels, ${wt.pass2Boxes} boites, ${wt.pass2Promoted} promues`),ut.set("_marge2.onnx",`total=${Dt.total} pos4=${Dt.positifs4} pos2=${Dt.positifs2} divergent=${Dt.divergent} `+Dt.detail.slice(0,10).join(" | ")),ut.set("_ttaObb.onnx",`total=${ai.total} memeK=${ai.memeK} inv=${ai.memeKInverse} `+ai.detail.slice(0,12).join(" ")),ut.set("_tuilage.onnx",`groupes=? tuiles=${Q.length} bannieres=${c.length} image=${a.width}x${a.height}`);for(const[te,se,pe,ge]of Q){const we=Ut(a,te,se,pe-te,ge-se);if(we.width<=0||we.height<=0)continue;const Se=[];for(const ye of[0]){const Ue=ye===0?we:Kt(we,ye),Fe=await et("laurier: passe par TUILE (#113)",()=>bt("laurel",Ue));for(const[We,qe,it,Zt]of at("laurier: decodage YOLO (JS)",()=>pr(Fe.rows,Fe.params,nt.laurel.conf))){const lt=Qa({x:We,y:qe,width:it-We,height:Zt-qe},ye,we.width,we.height);Se.push([lt.x,lt.y,lt.x+lt.width,lt.y+lt.height])}}if(ne=Bx(ne,am(Se),[te,se]),w!==null)try{const ye=await et("laurier: bande de piste sur tuile (#114)",async()=>{const Fe=jr(we,1280,hr);return{sortie:await w.run({[w.inputNames[0]]:new Be("float32",Fe.tensor,[1,3,1280,1280])}),params:Fe.params}}),Ue={params:ye.params};for(const[Fe,We,qe,it]of pr(ye.sortie[w.outputNames[0]].data,Ue.params,yg))oe.push([Fe+te,We+se,qe+te,it+se])}catch{}}}catch(Q){console.warn("[laurel-containers] failed:",Q)}const ae=[...y,...oe];ne=ne.filter(([Q,te,se,pe])=>!Ux((Q+se)/2,(te+pe)/2,ae,c.map(ge=>ge.box)));const[xe,_e]=await et("laurier: 1er contact des 2 ResNet (89,6 Mo)",()=>Promise.all([hg(),fg()]));for(const[Q,te,se,pe]of ne){const ge=Math.trunc((Q+se)/2),we=Math.trunc((te+pe)/2);if([...f,...m].some(He=>(ge-He.cx)**2+(we-He.cy)**2<=He.r*He.r)||!Z(ge,we))continue;if(_e!==null){const He=await et("laurier: filtre FP (#49)",()=>D$(a,[Math.trunc(Q),Math.trunc(te),Math.trunc(se),Math.trunc(pe)],_e));if(He!==null&&He>=g2)continue}const ye=Math.min(Math.trunc(se-Q),Math.trunc(pe-te)),Ue=Math.max(6,Math.trunc(Math.max(se-Q,pe-te)*Nb)),Fe=R$(a,ge,we,Ue);let We=null,qe=0,it=!1;if(xe!==null&&ye>=6){const He=Ut(a,Math.trunc(Q),Math.trunc(te),Math.trunc(se-Q),Math.trunc(pe-te));let Xe=null,_t=0;for(const Rt of[0,1,2,3]){const Jt=Rt===0?He:Kt(He,Rt),ms=p2(Jt),gs=await et("laurier: lecture chiffre (CNN)",()=>xe.run({[xe.inputNames[0]]:new Be("float32",ms,[1,3,Bt,Bt])})),{value:ys,prob:pi}=f2(gs[xe.outputNames[0]].data);if(pi>_t&&(Xe=ys,_t=pi),Xe!==null&&_t>=h2)break}Xe!==null&&_t>=d2&&(We=Xe,qe=_t)}if(We===null&&ye>=6){const He=new Map;for(const Xe of[0,1,2,3]){const _t=Xe===0?Fe:Kt(Fe,Xe),[Rt,Jt]=at("laurier: lecteur GABARITS (repli, JS pur)",()=>Kb(_t,W));Rt!==null&&(He.set(Rt,Math.max(He.get(Rt)??0,Jt)),Jt>qe&&(We=Rt,qe=Jt))}We!==null&&qe<x$&&(We=null),it=We!==null&&[...He.entries()].some(([Xe,_t])=>Xe!==We&&_t>=qe-.1)}const Zt=b.some(He=>ge>=He.x0&&ge<=He.x1&&we>=He.y0&&we<=He.y1),lt=[...B,...l].some(He=>{const Xe=He.boundingBox;return Xe!==void 0&&ge>=Xe.x&&ge<=Xe.x+Xe.width&&we>=Xe.y&&we<=Xe.y+Xe.height});k.push({value:We,valueRead:We!==null,center:[Math.round((Q+se)/2),Math.round((te+pe)/2)],boundingBox:{x:Math.trunc(Q),y:Math.trunc(te),width:Math.trunc(se-Q),height:Math.trunc(pe-te)},confidence:Math.round(qe*1e4)/1e4,excluded:Zt||lt,photoIndex:i-1,...it?{suspect:!0,suspectReason:"orientation-ambiguous"}:{}})}return{byFamily:E,laurels:k,coins:S,coinTotal:R,guilds:B,bannerCount:Y,tuckedExcluded:G,bannerSuspects:q,cityWondersKept:N,cityTokensKept:F}}function Eg(){return{byFamily:{},laurels:[],coins:[],progressTokens:[],wonders:[],guilds:[],bannerSuspects:[],coinTotal:0,unidentifiedTokens:0,bannerCount:0,tuckedExcluded:0}}function kg(e,t){for(const n of t.cityWondersKept)e.wonders.push(n);for(const n of t.cityTokensKept)e.progressTokens.push(n);for(const n of t.coins)e.coins.push(n);e.coinTotal+=t.coinTotal;for(const n of t.laurels)e.laurels.push(n);for(const n of t.guilds)e.guilds.push(n);for(const n of t.bannerSuspects)e.bannerSuspects.push(n);e.bannerCount+=t.bannerCount,e.tuckedExcluded+=t.tuckedExcluded;for(const[n,r]of Object.entries(t.byFamily))e.byFamily[n]=(e.byFamily[n]??0)+r}function Cg(e,t,n){const{byFamily:r,laurels:i,coins:a,progressTokens:o,wonders:s,guilds:u,bannerSuspects:l,coinTotal:c,unidentifiedTokens:d,bannerCount:p,tuckedExcluded:f}=e;f>0?n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: ${f} banner(s) near a wonder were excluded as tucked/consumed (estimated footprint — the server uses the real card box); verify the per-colour counts.`}):p>0&&s.length===0&&n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: no wonder was located on this photo, so a card tucked under a wonder may still be counted — verify the per-colour counts.`});const m=r.guild??0;m!==u.length?n.push({code:"INCONSISTENT_STATE",message:`${t}: ${m} purple banner(s) counted but ${u.length} guild(s) identified — reconcile in the review (stacked guilds or a missed identification).`}):u.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: guild(s) identified by their card art: `+u.map(M=>M.id).join(", ")+" — confirm in the review."});const y=s.filter(M=>M.boundingBox.width===0);if(y.length>0?n.push({code:"LOW_CONFIDENCE",message:`${t}: wonder(s) identified by name but NOT registered against their reference (${y.map(M=>M.name).join(", ")}) — their BUILT flag is a suggestion: unselect any that was not built.`}):s.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: ${s.length} wonder(s) registered — the BUILT flags were measured (card protruding underneath); confirm in the review.`}),d>0&&n.push({code:"UNRECOGNIZED_OBJECT",message:`${t}: ${d} token disc(s) found but not identified — pick them in the review below.`}),o.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: progress token(s) identified on-device: `+o.map(M=>M.id).join(", ")+" — confirm in the review."}),a.length>0){const M=a.filter(I=>I.denomSource==="cnn").length,v=a.length-M;n.push({code:"LOW_CONFIDENCE",message:v===0?`${t}: coins read as ${c} from ${a.length} tile(s) by the learned denomination model — confirm the total.`:`${t}: coins read as ${c} from ${a.length} tile(s) — ${M} by the learned model, ${v} by metal COLOUR alone (the model abstained); confirm the total.`})}const w=W$(u,s);for(const M of[...Lx(s.map(v=>v.id),t),...Wx(w.map(v=>v.id),t)])n.push({code:"INCONSISTENT_STATE",message:M.message});const b=i.filter(M=>!M.excluded),x=b.filter(M=>M.valueRead);return{...ev(),wonders:s,guilds:w,progressTokens:o,laurels:i,cardVictoryPoints:{value:x.reduce((M,v)=>M+(v.value??0),0),laurelsKept:b.length,laurelsUnread:b.length-x.length,complete:b.length===x.length},cardCounts:{byFamily:r,source:p>0?"yolo":"none",tuckedExcluded:f,...l.length>0?{suspects:l}:{}},coins:{total:c,confidence:a.length>0?.5:0,source:a.length===0?"none":a.some(M=>M.denomSource==="cnn")?"local-cnn":"local-colour",coins:a}}}async function tv(e,t,n,r,i=()=>{},a="player",o,s=!1){const u=Eg();let l=0;for(const c of e){l+=1;const d=`${t} photo ${l}/${e.length}`;r(`${d}: reading pixels…`,.01);const p=await di(c),f=await Ig(p,n,t,r,d,o,u.wonders,u.progressTokens);u.unidentifiedTokens+=f.unidentifiedTokens;const m=await Tg(f,a,s,t,l,p,n,r,d,u.guilds);kg(u,m),i()}return Cg(u,t,n)}const At=1280,nv=.3,hi=9;let hs=null;function ps(){return hs===null&&(hs=(async()=>{try{return(await fetch(`${je}pawn_ends_brut.onnx`,{method:"HEAD"})).ok?await ft("pawn_ends_brut.onnx"):null}catch{return null}})()),hs}function rv(e){const t=At/Math.max(e.width,e.height),n=Math.round(e.width*t),r=Math.round(e.height*t),i=new OffscreenCanvas(e.width,e.height),a=i.getContext("2d",{willReadFrequently:!0}),o=Gw(e.data,e.width,e.height,e.channels);a.putImageData(new ImageData(o,e.width,e.height),0,0);const u=new OffscreenCanvas(At,At).getContext("2d",{willReadFrequently:!0});u.fillStyle="rgb(114,114,114)",u.fillRect(0,0,At,At),u.drawImage(i,0,0,e.width,e.height,0,0,n,r);const{data:l}=u.getImageData(0,0,At,At),c=At*At,d=new Float32Array(3*c);for(let p=0;p<c;p+=1)d[p]=l[p*4]/255,d[c+p]=l[p*4+1]/255,d[2*c+p]=l[p*4+2]/255;return{tensor:d,r:t}}const Ye={appels:0,inferences:0,bandes:0,detail:[],premiereGagne:null};function iv(){Ye.appels=0,Ye.inferences=0,Ye.bandes=0,Ye.detail=[],Ye.premiereGagne=null}function Ag(){ut.set("_pion.onnx",`appels=${Ye.appels} inferences=${Ye.inferences} bandes=${Ye.bandes} premiereGagne=${Ye.premiereGagne??"n/a"} | ${Ye.detail.join(" ")}`)}async function ov(e,t){Ye.inferences+=1;const{tensor:n,r}=at("pion: mise en tenseur 1280x1280",()=>rv(t)),a=(await e.run({[e.inputNames[0]]:new Be("float32",n,[1,3,At,At])}))[e.outputNames[0]],o=a.data,s=a.dims[2]??0,u=(a.dims[1]??4)-4;return at("pion: depouillement des ancres brutes",()=>{const c=new Map;for(let d=0;d<u;d+=1){const p=(4+d)*s;let f=-1,m=nv;for(let y=0;y<s;y+=1){const w=o[p+y];w>=m&&(m=w,f=y)}if(f>=0){const y=(o[f]+o[2*s+f])/2/r,w=(o[s+f]+o[3*s+f])/2/r;c.set(d,{conf:m,cx:y,cy:w})}}return c})}async function fs(e,t,n){const r=Ye.inferences,i=`a${Ye.appels}`;Ye.appels+=1;const a=await et("pion: UNE passe (les 4 rotations)",()=>av(e,t,n));return Ye.detail.push(`${i}:${Ye.inferences-r}inf conf=${a===null?"rien":a.confidence.toFixed(2)}`),Ag(),a}async function av(e,t,n){let r=null;const i=1.8;for(const x of n??[0,1,2,3]){const M=x===0?t:at("pion: rotation de l'image",()=>Kt(t,x)),v=await ov(e,M);if(v.has(0)&&v.has(1)&&v.has(2)){const I=v.get(0).conf+v.get(1).conf+v.get(2).conf;if((r===null||I>r.score)&&(r={score:I,det:v,k:x}),I>=i)break}}if(r===null)return null;const a=r.det.get(0),o=r.det.get(1),s=r.det.get(2),u=s.cx-o.cx,l=s.cy-o.cy,c=(o.cx+s.cx)/2,d=(o.cy+s.cy)/2,p=u*u+l*l;if(p<=0)return null;const f=((a.cx-c)*u+(a.cy-d)*l)/p*(2*hi),m=Math.min(hi,Math.max(-hi,st(f))),y=Math.min(a.conf,o.conf,s.conf),w=(x,M)=>{const v=r.k%4;return v===0?[x,M]:v===1?[M,t.height-1-x]:v===2?[t.width-1-x,t.height-1-M]:[t.width-1-M,x]},b=[o,s].map(x=>{const[M,v]=w(x.cx,x.cy);return[st(M),st(v)]});return{position:m,confidence:Math.round(y*1e4)/1e4,ends:b,k:r.k}}async function Rg(e,t,n){let r=null,i=null;for(const a of n){const o=Kw(t.width,t.height,a);if(o===null)continue;const s=Ut(t,o.x,o.y,o.width,o.height);if(s.width===0||s.height===0)continue;Ye.bandes+=1;const u=await fs(e,s,i===null?void 0:[i]);u!==null&&i===null&&(i=u.k),u!==null&&(Ye.premiereGagne===null?Ye.premiereGagne=!0:r!==null&&u.confidence>r.confidence&&(Ye.premiereGagne=!1),Ag()),u!==null&&(r===null||u.confidence>r.confidence)&&(r={...u,ends:u.ends.map(([l,c])=>[l+o.x,c+o.y])})}return r}function sv(){const e=[cg,dg,hg,pg,fg,mg,gg,as,us,bg,_g,ps];for(const t of e)try{Promise.resolve(t()).catch(()=>{})}catch{}}async function uv(e,t){sv();const n=[{code:"LOW_CONFIDENCE",message:"On-device mode: everything is recognised locally — card counts, coin denominations, laurel values, wonders, guilds and token identities, with the same models as the server. What still deserves a look is COMPLETENESS: an object the detector never saw cannot be corrected by any of them, so check the totals against the table."}],r={left:null,right:null},i=e.left.length+e.right.length+(e.both!==void 0?2:0);let a=0;const o=(f,m=0)=>{t(f,i>0?Math.min(.99,(a+m)/i):void 0)},s=()=>{a+=1};for(const f of["left","right"]){const m=e[f];m.length>0&&(r[f]=await tv(m,f,n,o,s))}let u=null,l=null;if(e.both!==void 0){const f={},m=await di(e.both),y=await Ig(m,n,"both",o,"both photo 1/1",f,[],[]),w=async(M,v)=>{const I=Eg();return I.unidentifiedTokens+=y.unidentifiedTokens,kg(I,await Tg(y,M,!0,v,1,m,n,o,`${v} photo 1/1`,I.guilds)),s(),Cg(I,v,n)},b={player:await w("player","left"),opponent:await w("opponent","right")};if(o("military pawn…",.95),f.image!==void 0)try{const M=await ps();M!==null&&(f.bandBoxes!==void 0&&f.bandBoxes.length>0&&(u=await Rg(M,f.image,f.bandBoxes)),u===null&&(u=await fs(M,f.image)))}catch(M){console.warn("[#125] both-photo pawn read failed:",M)}u!==null&&(l=Jw(u.ends,f.hulls??[],u.position));const x=l!==null&&!l.ambiguous?eb(l):null;x!==null?(r.left=b[x.left],r.right=b[x.right],n.push({code:"AMBIGUOUS_OWNER",message:`Both-players photo: LEFT and RIGHT were derived from the MILITARY BOARD geometry (each track end paired with the city it is the capital of), which overrides the cluster-dominance guess — favored ${l.favoredOwner}, pawn at ${u.position}. Swap them in the review only if this is wrong.`})):(r.left=b.player,r.right=b.opponent,n.push({code:"AMBIGUOUS_OWNER",message:"Both-players photo: the DOMINANT city was assigned to the left player and the opposing city to the right — swap them in the review if the seating is the other way around."}))}{const f={},m={};for(const y of["left","right"]){const w=r[y];w!=null&&(f[y]=w.wonders.map(b=>b.id),m[y]=w.progressTokens.map(b=>b.id))}for(const y of[...Fx(f),...Gx(m)])n.push({code:"INCONSISTENT_STATE",message:y.message})}let c={conflictPawnPosition:0,found:!1,confidence:0};if(e.board!==void 0)try{const f=await di(e.board),m=await ps();if(m!==null){let y=await fs(m,f);if(y===null){const w=await us();if(w!==null){const b=await bt("banner",f),x=Kr(b.rows,b.params,nt.banner.conf),M=await wg(w,f,x);y=await Rg(m,f,M)}}y!==null&&(c={conflictPawnPosition:y.position,found:!0,confidence:y.confidence},n.push({code:"AMBIGUOUS_OWNER",message:`Conflict pawn read at position ${y.position} — confirm which player it favours (the sign is a convention, not read from the photo).`}))}}catch(f){console.warn("[pawn] on-device read failed:",f)}else u!==null&&l!==null&&(c={conflictPawnPosition:u.position,found:!0,confidence:u.confidence});if(!c.found){const f=b=>{var x,M;return Number(((M=(x=b==null?void 0:b.cardCounts)==null?void 0:x.byFamily)==null?void 0:M.military)??0)},m=f(r.left),y=f(r.right),w=Math.abs(m-y);n.push({code:"MILITARY_PAWN_NOT_FOUND",message:w>=3?`The conflict pawn was NOT read, so the military score is 0 — but one city has ${m} military cards and the other ${y}. A gap that wide almost never leaves the pawn in the middle: set its position below, it is very likely worth points.`:"The conflict pawn was not read — the military score is 0 by default, not by measurement. Set its position below if the pawn is off-centre."})}const d=c.conflictPawnPosition,p=Math.abs(d)>=hi?{type:"military",winner:d>0?"left":"right"}:{type:"civilian"};return{imageId:e.imageId,players:r,militaryTrack:c,outcome:p,confidence:.5,warnings:n}}self.onmessage=e=>{const{id:t,kind:n}=e.data;let r=null;const i=(a,o)=>{h$(a),self.postMessage({id:t,progress:a,...o!==void 0?{fraction:o}:{},...a!==r?{perfPartiel:{providers:ig(),etapes:rg(),etapeCourante:a}}:{}}),r=a};(async()=>{try{n==="recognize"&&i("starting the on-device engine…",0),d$(),y$();const a=performance.now(),o=n==="classify"?await J$(e.data.file):await uv(e.data.payload,i);self.postMessage({id:t,ok:!0,result:o,perf:{etapes:rg(),providers:ig(),runtime:p$(),inference:g$(),famillesJs:Lw(),inferenceParEtape:m$(),totalMs:Math.round(performance.now()-a)}})}catch(a){self.postMessage({id:t,ok:!1,error:String(a)})}})()}})();
