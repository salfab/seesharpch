...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Vu=(e,t)=>new qu(e,t)}),Hu,co,ju,Ku,Yu,Xu,dt,Qu,Zu,nn=ie(()=>{be(),ve(),We(),Me(),Hu=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},co=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),ju=(e,t)=>V.sortBasedOnPerm(e,co(e.length,t)),Ku=(e,t,n,r)=>{let i=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let o=0;o<t;++o)i+=`a[${e[o]}]=i[${o}];`;return i+="return a;}"},Yu=(e,t)=>{let n=[],r=[];for(let i=0;i<e.length;++i)e[i]!==1&&n.push(e[i]),e[t[i]]!==1&&r.push(t[i]);return{newShape:n,newPerm:r}},Xu=(e,t)=>{let n=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<n)return!1;n=e[r]}return!0},dt=(e,t)=>{let n=e.dataType,r=e.dims.length,i=co(r,t),o=ju(e.dims,i),a=e.dims,s=o,u=r<2||Xu(i,e.dims),l;if(u)return l=m=>{let y=Y("input",n,a,4),w=he("output",n,s,4);return`
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},ec=e=>{Zl(e.inputs),e.compute(Jl(e.inputs))}}),tc,Re,nc,rc,ic,oc,ac,sc,uc,lc,cc,dc,hc,pc,fc,mc,rr,gc,Br,yc,wc,bc,_c,xc,$c,vc,Mc,Sc,Ic,Tc,Ec,kc,Cc,Ac,Rc,yo,Oc,wo,bo,Nc,zc,Bc,Pc,Dc,Uc,_o=ie(()=>{be(),ve(),We(),Me(),tc=(e,t,n,r,i,o,a)=>{let s=Math.ceil(t/4),u="";typeof i=="string"?u=`${i}(a)`:u=i("a");let l=Y("inputData",n,[s],4),c=he("outputData",r,[s],4),d=[{name:"vec_size",type:"u32"}];return a&&d.push(...a),`
...
`,bo=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Nc=e=>{let t=et(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"FastGelu",bo,wo(t),void 0,e.inputs[0].dataType))},zc=(e,t)=>{let n=et(e.inputs[0].dataType);return e.compute(Re(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Bc=e=>{e.compute(Re(e.inputs[0],"Log","log"))},Pc=(e,t)=>`
...
`)},id=(e,t,n,r)=>{let i=V.size(n),o=new Array(e.length),a=new Array(e.length),s=0,u=[],l=[],c=[{type:12,data:i}];for(let y=0;y<e.length;++y)s+=e[y].dims[t],o[y]=s,l.push(e[y].dims.length),a[y]=Y(`input${y}`,r,l[y]),u.push("rank"),c.push({type:12,data:o[y]});for(let y=0;y<e.length;++y)c.push(...me(e[y].dims));c.push(...me(n));let d=he("output",r,n.length),p=d.indicesGet("indices",t),f=Array.from(Array(o.length).keys()).map(y=>`uniforms.sizeInConcatAxis${y}`).join(","),m=y=>`
  ...
  ${y.mainStart()}
    ...
    ${rd(a,d)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}),getShaderSource:m}},od=(e,t)=>{let n=e.inputs,r=n[0].dims,i=V.normalizeAxis(t.axis,r.length);td(n,i);let o=r.slice();o[i]=n.reduce((s,u)=>s+(u.dims.length>i?u.dims[i]:0),0);let a=n.filter(s=>V.size(s.dims)>0);e.compute(id(a,i,o,n[0].dataType),{inputs:a})},ad=e=>Oe({axis:e.axis})}),_n,xn,$n,xo,vn=ie(()=>{be(),ve(),_n=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},xn=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},$n=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},xo=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[n,r]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=(e==null?void 0:e.activation_params)||[ku,Cu];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:n}}return{activation:t}}}),Ze,sd,$o=ie(()=>{Ze=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},sd=e=>`
...
`}),ir,vo,Mo=ie(()=>{be(),ve(),Me(),vn(),ir=(e,t,n,r,i)=>{let o=r-n;return`
...
`},vo=(e,t,n,r,i=!1,o)=>{let a=e[0].dims,s=e[1].dims,u=a[a.length-2],l=s[s.length-1],c=a[a.length-1],d=Fe(l),p=Fe(c),f=Fe(u),m=V.size(n)/d/f,y=e.length>2,w=r?r.slice(0,-2):n.slice(0,-2),b=[V.size(w),u,l],x=[{type:12,data:m},{type:12,data:u},{type:12,data:l},{type:12,data:c}];xn(t,x),x.push(...me(w,a,s)),y&&x.push(...me(e[2].dims)),x.push(...me(b));let v=M=>{let I=lo("batch_dims",e[0].dataType,w.length),E=Y("a",e[0].dataType,a.length,p),k=Y("b",e[1].dataType,s.length,d),S=he("output",e[0].dataType,b.length,d),R=Xe(S.type.tensor),B=_n(t,S.type.value,R),q=[E,k],G="";if(y){let F=i?d:1;q.push(Y("bias",e[2].dataType,e[2].dims.length,F)),G=`${i?`value += bias[col / ${F}];`:`value += ${S.type.value}(bias[row + i]);`}`}let H=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];$n(t,H);let O=()=>{let F=`var a_data: ${E.type.value};`;for(let X=0;X<p;X++)F+=`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${d};${p};${f};${i}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:o?o(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:x}),getShaderSource:v}}}),ld,cd,So,Io,dd,To,hd,Pr,Eo=ie(()=>{be(),ve(),Me(),vn(),Mo(),$o(),ld=(e,t)=>e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${L}>`:L}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${v} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${a};${c};${m}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:p}),getShaderSource:y}}}),_d,xd,Fy=ie(()=>{be(),ve(),Me(),vn(),_d=(e,t,n,r)=>{let i=e.length>2,o=i?"value += b[output_channel];":"",a=e[0].dims,s=e[1].dims,u=t.format==="NHWC",l=u?n[3]:n[1],c=l/t.group,d=u&&c>=4?Fe(l):1,p=V.size(n)/d,f=[{type:12,data:p},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:c}];xn(t,f),f.push(...me(a,[s[0],s[1],s[2],s[3]/d]));let m=i?["rank","rank","rank"]:["rank","rank"];f.push(...me([n[0],n[1],n[2],n[3]/d]));let y=w=>{let b=he("output",e[0].dataType,n.length,d),x=Xe(b.type.tensor),v=_n(t,b.type.value,x),M=Y("x",e[0].dataType,a.length),I=Y("w",e[1].dataType,s.length,d),E=[M,I];i&&E.push(Y("b",e[2].dataType,e[2].dims,d));let k=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];$n(t,k);let S=u?`
...
`)},Ud=(e,t)=>{let n,r,i,o,a,s,u=t.format==="NHWC",l=t.blocksize,c=t.mode==="DCR";u?([n,r,i,o]=e.dims,a=c?[n,r,i,l,l,o/l**2]:[n,r,i,o/l**2,l,l],s=c?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,r,i,o]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],a=c?[n,l,l,o/l**2,r,i]:[n,o/l**2,l,l,r,i],s=c?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let d=e.reshape(a),p=d.dims.length,f=e.dataType,m=Y("a",f,p),y=he("output",f,p),w=b=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:b=>{let x=u?[n,r*l,i*l,o/l**2]:[n,o/l**2,r*l,i*l],v=V.size(x),M=d.dims,I=V.sortBasedOnPerm(M,s);return{outputs:[{dims:x,dataType:b[0].dataType}],dispatchGroup:{x:Math.ceil(v/64)},programUniforms:[{type:12,data:v},...me(M,I)]}},getShaderSource:w}},Ld=(e,t)=>{Pd(e.inputs),e.compute(Ud(e.inputs[0],t))},Fd=e=>Oe({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Lr,ar,Bo,Gd,Wd,qd,Vd,Po,Hd,jd,Kd,jy=ie(()=>{be(),ve(),We(),Me(),Lr="[a-zA-Z]|\\.\\.\\.",ar="("+Lr+")+",Bo="^"+ar+"$",Gd="("+ar+",)*"+ar,Wd="^"+Gd+"$",qd=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let n=this.symbolToIndices.get(e);n===void 0?n=[t]:n.push(t),this.symbolToIndices.set(e,n)}},Vd=class{constructor(e,t){var i;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,r]=t.includes("->")?t.split("->",2):[t,""];if(!n.match(RegExp(Wd)))throw new Error("Invalid LHS term");if(n.split(",").forEach((o,a)=>{let s=e[a].dims.slice();if(!o.match(RegExp(Bo)))throw new Error("Invalid LHS term");let u=this.processTerm(o,!0,s,a);this.lhs.push(u)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([o,a])=>a.count===1||o==="...").map(([o])=>o).join("");else if(!r.match(RegExp(ar)))throw new Error("Invalid RHS");(i=r.match(RegExp(Lr,"g")))==null||i.forEach(o=>{if(o==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let a=this.symbolToInfo.get(o);if(a===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(a.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,n){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(n)}else r={count:1,dimValue:t,inputIndices:[n]};this.symbolToInfo.set(e,r)}processTerm(e,t,n,r=-1){let i=n.length,o=!1,a=[],s=0;if(!e.match(RegExp(Bo))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Lr,"g")),l=new qd(r);return u==null||u.forEach((c,d)=>{if(c==="..."){if(o)throw new Error("Only one ellipsis is allowed per input term");o=!0;let p=i-u.length+1;if(p<0)throw new Error("Ellipsis out of bounds");if(a=n.slice(s,s+p),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let f=0;f<a.length;f++){let m=String.fromCharCode(48+f);l.addSymbol(m,d+f),this.addSymbol(m,n[s++],r)}}else l.addSymbol(c,d+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,n[s++],r)}),l}},Po=e=>e+"_max",Hd=(e,t,n,r)=>{let i=e.map(l=>l.length).map((l,c)=>Y(`input${c}`,t,l)),o=V.size(r),a=he("output",t,r.length),s=[...n.symbolToInfo.keys()].filter(l=>!n.rhs.symbolToIndices.has(l)),u=l=>{let c=[],d="var prod = 1.0;",p="var sum = 0.0;",f="sum += prod;",m=[],y=[],w=[],b=[],x=n.symbolToInfo.size===n.rhs.symbolToIndices.size;n.symbolToInfo.forEach((M,I)=>{var E;if(n.rhs.symbolToIndices.has(I)){let k=(E=n.rhs.symbolToIndices.get(I))==null?void 0:E[0];k!==void 0&&n.lhs.forEach((S,R)=>{if(M.inputIndices.includes(R)){let B=S.symbolToIndices.get(I);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(q=>{c.push(`${i[R].indicesSet(`input${R}Indices`,q,a.indicesGet("outputIndices",k))}`)})}})}else n.lhs.forEach((k,S)=>{if(M.inputIndices.includes(S)){let R=k.symbolToIndices.get(I);if(R===void 0)throw new Error("Invalid symbol error");R.forEach(B=>{m.push(`${i[S].indicesSet(`input${S}Indices`,B,`${I}`)}`)}),b.push(`prod *= ${i[S].getByIndices(`input${S}Indices`)};`)}}),y.push(`for(var ${I}: u32 = 0; ${I} < uniforms.${Po(I)}; ${I}++) {`),w.push("}")});let v=x?[...c,`let sum = ${i.map((M,I)=>M.getByIndices(`input${I}Indices`)).join(" * ")};`]:[...c,p,...y,...m,d,...b,f,...w];return`
            ${l.registerUniforms(s.map(M=>({name:`${Po(M)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...i,a)}
...
`)};
    ...
    ${m}`},c=[{type:12,data:u},...me(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},Zd=e=>{Yd(e.inputs),e.compute(Qd(e.inputs),{inputs:[0]})}}),Jd,eh,Yy=ie(()=>{be(),ve(),Me(),_o(),Jd=e=>{let t=e[0].dataType,n=V.size(e[0].dims),r=V.size(e[1].dims),i=r%4===0,o=a=>{let s=Y("x",t,[1],4),u=Y("bias",t,[1],4),l=he("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:o},getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},Kh=(e,t)=>{var M;let n=Vh(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((M=e.inputs[1])==null?void 0:M.dims.length)===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,o=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,a=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=Oe({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,c*n.headSize,c*n.headSize]}),[p,f,m]=!i&&!o?e.compute(Lo([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,o],y,w;if(t.doRotary){let I=e.compute(jh(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],E=e.inputs[7],k=e.inputs[8],S=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),R=[p,I,E,k],B=[-1];y=e.compute(Fr(R,S),{inputs:R,outputs:B})[0],R.splice(0,1,f);let q=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});w=e.compute(Fr(R,q),{inputs:R,outputs:B})[0]}let b=sr(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?y:p,void 0,0),x=Fo(e,t.doRotary?w:f,n),v=Fo(e,m,n);nr(e,b,x,v,void 0,void 0,a,s,void 0,n,u,l)}}),Go,Yh,Xh,Qh,rw=ie(()=>{be(),ve(),nn(),Me(),Go=(e,t,n,r,i,o,a,s)=>{let u=Fe(o),l=u===1?"f32":`vec${u}f`,c=u===1?"vec2f":`mat2x${u}f`,d=i*a,p=64;d===1&&(p=256);let f=[i,a,o/u],m=[i,a,2],y=["rank","type","type"],w=[];w.push(...me(f,m));let b=x=>{let v=Y("x",t.dataType,3,u),M=Y("scale",n.dataType,n.dims),I=Y("bias",r.dataType,r.dims),E=he("output",1,3,2),k=[v,M,I,E];return`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${s};${p}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:w}),getShaderSource:b},{inputs:[t,n,r],outputs:[-1]})[0]},Yh=(e,t,n)=>{let r=t[0].dims,i=r,o=2,a=r[0],s=r[1],u=V.sizeFromDimension(r,o),l=Fe(u),c=V.size(i)/l,d=Go(e,t[0],t[1],t[2],a,u,s,n.epsilon),p=[a,s,u/l],f=[a,s],m=["type","none"],y=w=>{let b=Y("x",t[0].dataType,p.length,l),x=Y("scale_shift",1,f.length,2),v=he("output",t[0].dataType,p.length,l),M=[b,x,v];return`
  ...
  }`},M=[{dims:s,dataType:e[0].dataType}];return b&&M.push({dims:f,dataType:1}),x&&M.push({dims:f,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${n};${r}`,inputDependencies:y},getRunData:()=>({outputs:M,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:w}),getShaderSource:v}},ep=(e,t)=>{Zh(e.inputs),e.compute(Jh(e.inputs,t,e.outputCount))}}),tp,np,ow=ie(()=>{ve(),Mo(),Eo(),tp=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},np=e=>{tp(e.inputs);let t=zn.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(vo(e.inputs,{activation:""},t));else{let i=t[t.length-2],o=V.size(e.inputs[0].dims.slice(0,-2)),a=V.size(e.inputs[1].dims.slice(0,-2));if(o!==1&&i===1&&a===1){let s=e.inputs[0].reshape([1,o,r]),u=e.inputs[1].reshape([1,r,n]),l=[1,o,n],c=[s,u];e.compute(Pr(c,{activation:""},t,l),{inputs:c})}else e.compute(Pr(e.inputs,{activation:""},t))}}}),rp,ip,op,ap,sp,aw=ie(()=>{be(),ve(),We(),Me(),rp=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),o=t.blockSize/8*t.bits,a=e[1];if(!V.areEqual(a.dims,[t.n,i,o]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let s=e[2].dims;if(V.size(s)!==t.n*i)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(V.size(u)!==l)throw new Error("zeroPoints input size error.")}},ip=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],o=t.k,a=t.n,s=n.slice(0,r-2),u=V.size(s),l=e[1].dims[2]/4,c=e[0].dataType,d=Fe(t.k),p=Fe(l),f=Fe(a),m=s.concat([i,a]),y=i>1&&a/f%2===0?2:1,w=V.size(m)/f/y,b=64,x=[],v=[u,i,o/d],M=V.convertShape(e[1].dims).slice();M.splice(-1,1,l/p),x.push(...me(v)),x.push(...me(M)),x.push(...me(e[2].dims)),e.length===4&&x.push(...me(V.convertShape(e[3].dims)));let I=[u,i,a/f];x.push(...me(I));let E=k=>{let S=v.length,R=Y("a",e[0].dataType,S,d),B=Y("b",12,M.length,p),q=Y("scales",e[2].dataType,e[2].dims.length),G=[R,B,q],H=e.length===4?Y("zero_points",12,e[3].dims.length):void 0;H&&G.push(H);let O=I.length,F=he("output",e[0].dataType,O,f),X=Xe(e[0].dataType),Q=(()=>{switch(d){case 1:return`array<${X}, 8>`;case 2:return`mat4x2<${X}>`;case 4:return`mat2x4<${X}>`;default:throw new Error(`${d}-component is not supported.`)}})(),le=Math.floor(32/t.bits),L=Math.floor(le/8),N=()=>{let U="";for(let P=0;P<L;P++){let j=P*t.bits*4,ne=j+t.bits;U+=`
          // reuse a data (pass ${P})
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Np(t.reduction,"output[data_offset + i]","value",m.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:c}},Bp=e=>Oe({reduction:e.reduction}),Pp=(e,t)=>{e.compute(zp(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Dp,Up,Lp,Qo,Fp,Gp,Wp,qp,Vp,Hp,jp,Kp,Zo,Yp,Xp,Qp,Zp,Jp,ef,tf,hw=ie(()=>{be(),ve(),We(),Me(),Dp=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      ${I.mainStart([w,1,1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
      ...
      }`},M=[{dims:s,dataType:e[0].dataType}];return n>1&&M.push({dims:c,dataType:1}),n>2&&M.push({dims:c,dataType:1}),n>3&&M.push({dims:o,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${b};${f};${m};${y}`,inputDependencies:e.map((I,E)=>"type")},getShaderSource:v,getRunData:()=>({outputs:M,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:x})}},of=(e,t)=>{nf(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(rf(e.inputs,t,e.outputCount,!1),{outputs:n})}}),af,lr,sf,Jo,uf,lf,cf,df,fw=ie(()=>{be(),ve(),We(),Me(),af=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},lr=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},sf=(e,t)=>{if(e.length>1){let n=lr(e,1),r=lr(e,2),i=lr(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),Oe({starts:n,ends:r,axes:i})}else return t},Jo=(e,t,n,r,i)=>{let o=e;return e<0&&(o+=n[r[t]]),i[t]<0?Math.max(0,Math.min(o,n[r[t]]-1)):Math.max(0,Math.min(o,n[r[t]]))},uf=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
          ...
          return input_indices;
      }`,lf=(e,t)=>{let n=e[0].dims,r=V.size(n),i=t.axes.length>0?V.normalizeAxes(t.axes,n.length):[...Array(n.length).keys()],o=lr(e,4);o.forEach(b=>b!==0||(()=>{throw new Error("step cannot be 0")})),o.length===0&&(o=Array(i.length).fill(1));let a=t.starts.map((b,x)=>Jo(b,x,n,i,o)),s=t.ends.map((b,x)=>Jo(b,x,n,i,o));if(i.length!==a.length||i.length!==s.length)throw new Error("start, ends and axes should have the same number of elements");if(i.length!==n.length)for(let b=0;b<n.length;++b)i.includes(b)||(a.splice(b,0,0),s.splice(b,0,n[b]),o.splice(b,0,1));let u=o.map(b=>Math.sign(b));o.forEach((b,x,v)=>{if(b<0){let M=(s[x]-a[x])/b,I=a[x],E=I+M*o[x];a[x]=E,s[x]=I,v[x]=-b}});let l=n.slice(0);i.forEach((b,x)=>{l[b]=Math.ceil((s[b]-a[b])/o[b])});let c={dims:l,dataType:e[0].dataType},d=he("output",e[0].dataType,l.length),p=Y("input",e[0].dataType,e[0].dims.length),f=V.size(l),m=[{name:"outputSize",type:"u32"},{name:"starts",type:"u32",length:a.length},{name:"signs",type:"i32",length:u.length},{name:"steps",type:"u32",length:o.length}],y=[{type:12,data:f},{type:12,data:a},{type:6,data:u},{type:12,data:o},...me(e[0].dims,l)],w=b=>`
      ...
      ${k.mainStart(y)}
        ...
        if (lindex == 0) {
          rowSumShared = ${v}(${tn("threadShared[0]",f)});
        }
        workgroupBarrier();
