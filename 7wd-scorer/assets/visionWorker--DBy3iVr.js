...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
    ...
    `,Ol=(e,t,n,r,i,a,o,s)=>{let u=Le(o?1:a),l=64,d=a/u;d<l&&(l=32);let p=Math.ceil(a/u/l),h=[{type:12,data:t},{type:12,data:n},{type:12,data:r},{type:12,data:i},{type:12,data:d},{type:12,data:p}],m=Ke(e.dataType,u),g=et(1,u),y=["type"];o&&y.push("type"),s&&y.push("type");let w=b=>{let x=se("x",e.dataType,e.dims,u),S=[x],v=o?H("seq_lens",o.dataType,o.dims):void 0;v&&S.push(v);let T=s?H("total_sequence_length_input",s.dataType,s.dims):void 0;T&&S.push(T);let M=et(e.dataType),k=[{name:"batch_size",type:"u32"},{name:"num_heads",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"sequence_length",type:"u32"},{name:"total_sequence_length",type:"u32"},{name:"elements_per_thread",type:"u32"}];return`
...
`,Mc=e=>`quick_gelu_impl(${e})`,kc=(e,t)=>{let n=et(e.inputs[0].dataType);e.compute(Ce(e.inputs[0],"QuickGelu",Mc,Ic(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Cc,Ac,Rc,ky=Z(()=>{ge(),we(),la(),Cc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ac=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=H("input",e[0].dataType,e[0].dims,4),r=H("bias",e[0].dataType,[e[0].dims[2]],4),i=se("output",e[0].dataType,t,4),a=G.size(t)/4,o=Ke(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:s=>`
  ...
  ${s.mainStart()}
    ...
    ${i.setByOffset("global_idx","valueLeft * geluRight")}
            ...
            ${g.setByOffset("global_idx",m(o||v?y.getByOffset("offsetA / 4u"):`${y.type.value}(${y.getByOffset("offsetA / 4u")}[offsetA % 4u])`,o||T?w.getByOffset("offsetB / 4u"):`${w.type.value}(${w.getByOffset("offsetB / 4u")}[offsetB % 4u])`))}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Lc=e=>{Tt(e,"Sub",(t,n)=>`${t}-${n}`)},Fc=e=>{Tt(e,"Greater",{scalar:(t,n)=>`u32(${t}>${n})`,vector:(t,n)=>`vec4<u32>(${t}>${n})`},void 0,void 0,9)},Gc=e=>{Tt(e,"Less",{scalar:(t,n)=>`u32(${t}<${n})`,vector:(t,n)=>`vec4<u32>(${t}<${n})`},void 0,void 0,9)},Wc=e=>{Tt(e,"GreaterOrEqual",{scalar:(t,n)=>`u32(${t}>=${n})`,vector:(t,n)=>`vec4<u32>(${t}>=${n})`},void 0,void 0,9)},qc=e=>{Tt(e,"LessOrEqual",{scalar:(t,n)=>`u32(${t}<=${n})`,vector:(t,n)=>`vec4<u32>(${t}<=${n})`},void 0,void 0,9)}}),Vc,Hc,jc,Kc,Yc,Xc,Ay=Z(()=>{he(),ge(),Fe(),we(),Vc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let n=0,r=e[n],i=r.dataType,a=r.dims.length;e.forEach((o,s)=>{if(s!==n){if(o.dataType!==i)throw new Error("input tensors should be one type");if(o.dims.length!==a)throw new Error("input tensors should have the same shape");o.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},Hc=(e,t)=>`
...
`},nd=(e,t,n,r,i=!1)=>{let[a,o,s,u]=r,l=Ke(r[0].type.tensor);return`
  ...
  ${y?fa(w,b,K,F):ga(w,b,K,F)}
    ...
    return ${Qe(s,l)}(0.0);`,T=Qe(u,l),M=Qe(e?o:s,l),k=Qe(e?s:o,l),E=_n(a,T,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${L}>`:L}) {
      ...
      }`,A=H("x",e[0].dataType,e[0].dims.length,T===3?1:T),N=H("w",e[1].dataType,e[1].dims.length,ue),D=[A,N],U=se("result",e[0].dataType,n.length,ue);if(o){let j=H("bias",e[2].dataType,e[2].dims.length,ue);D.push(j),B+=`
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${S} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${o};${d};${g}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:h}),getShaderSource:y}}}),cd,dd,zy=Z(()=>{he(),ge(),we(),xn(),cd=(e,t,n,r)=>{let i=e.length>2,a=i?"value += b[output_channel];":"",o=e[0].dims,s=e[1].dims,u=t.format==="NHWC",l=u?n[3]:n[1],d=l/t.group,p=u&&d>=4?Le(l):1,h=G.size(n)/p,m=[{type:12,data:h},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];bn(t,m),m.push(...ce(o,[s[0],s[1],s[2],s[3]/p]));let g=i?["rank","rank","rank"]:["rank","rank"];m.push(...ce([n[0],n[1],n[2],n[3]/p]));let y=w=>{let b=se("output",e[0].dataType,n.length,p),x=Ke(b.type.tensor),S=_n(t,b.type.value,x),v=H("x",e[0].dataType,o.length),T=H("w",e[1].dataType,s.length,p),M=[v,T];i&&M.push(H("b",e[2].dataType,e[2].dims,p));let k=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];$n(t,k);let E=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:m}),getShaderSource:y}},dd=(e,t,n,r)=>{let i=e.length>2,a=Le(n[3]),o=Le(n[2]),s=G.size(n)/a/o,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/a],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/a],d=[n[0],n[1],n[2],n[3]/a],p=[{type:12,data:s},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];bn(t,p),p.push(...ce(u,l,d));let h=(o-1)*t.strides[1]+l[1],m=g=>{let y=se("output",e[0].dataType,d.length,a),w=Ke(y.type.tensor),b=_n(t,y.type.value,w),x=H("x",e[0].dataType,u.length,a),S=H("w",e[1].dataType,l.length,a),v=[x,S];i&&v.push(H("b",e[2].dataType,e[2].dims,a));let T=i?"value += b[output_channel];":"",M=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return $n(t,M),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${a};${o};${h};${l[0]};${l[1]}`,inputDependencies:i?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:p}),getShaderSource:m}}}),pd,Nr,hd,zr,ba,$a,fd,md,xa,By=Z(()=>{ge(),Oy(),Ny(),ya(),zy(),xn(),ha(),en(),pd=(e,t,n,r,i,a)=>{let o=e[0],s=e.slice(a?1:2,a?3:4),u=s.length,l=t[0],d=t.slice(2).map((h,m)=>h+(h-1)*(n[m]-1)),p=s.map((h,m)=>h+r[m]+r[m+u]).map((h,m)=>Math.floor((h-d[m]+i[m])/i[m]));return p.splice(0,0,o),p.splice(a?3:1,0,l),p},Nr=[2,3,1,0],hd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},zr=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let a=2;a<t[1].dims.length;++a)n[a-2]===0&&(n[a-2]=t[1].dims[a]);let r=e.pads.slice();Er.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:n,pads:r}),i},ba=e=>{let t=ca(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,a=e.group,o=e.kernel_shape,s=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,pads:s,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},$a=(e,t,n,r)=>{let i=n.format==="NHWC",a=pd(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,i);if(n.group!==1){let M=[t[0]];if(i){let k=e.kernelCustomData.wT??e.compute(dt(t[1],Nr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=k),M.push(k)}else M.push(t[1]);t.length===3&&M.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&i&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(dd(M,n,a,r),{inputs:M}):e.compute(cd(M,n,a,r),{inputs:M});return}let o=t.length===3,s=t[0].dims[i?1:2],u=t[0].dims[i?2:3],l=t[0].dims[i?3:1],d=t[1].dims[2],p=t[1].dims[3],h=a[i?1:2],m=a[i?2:3],g=a[i?3:1],y=i&&d===s&&p===u&&n.pads[0]===0&&n.pads[1]===0;if(y||d===1&&p===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let M=a[0],k,E,R,P=[];if(i){let V=e.kernelCustomData.wT??e.compute(dt(t[1],Nr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=V),y){let O=s*u*l;k=t[0].reshape([1,M,O]),E=V.reshape([1,O,g]),R=[1,M,g]}else k=t[0].reshape([M,s*u,l]),E=V.reshape([1,l,g]),R=[M,h*m,g];P.push(k),P.push(E)}else k=t[0].reshape([M,l,s*u]),E=t[1].reshape([1,g,l]),R=[M,g,h*m],P.push(E),P.push(k);o&&P.push(t[2]);let X=R[2],W=P[0].dims[P[0].dims.length-1];X<8&&W<8?e.compute(pa(P,n,a,R,i,r),{inputs:P}):e.compute(Or(P,n,a,R,i,r),{inputs:P});return}let w=!0,b=e.kernelCustomData.wT??e.compute(dt(t[1],Nr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let x=[t[0],b];o&&x.push(t[2]);let S=i?h*m:g,v=i?g:h*m,T=d*p*l;e.compute(id(x,n,a,S,v,T,o,w,r),{inputs:x})},fd=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),o=[1].concat(t.dilations),s=[1].concat(t.kernelShape),u=zr({...t,pads:i,strides:a,dilations:o,kernelShape:s},r);$a(e,r,u,l=>n?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},md=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",i=zr(n,t),a=n.autoPad==="NOTSET"?n.pads:n.autoPad,o=ud(t[0].dims,t[1].dims,n.strides,n.dilations,a,!1,r);e.compute(ld(t,i,o.outShape,[o.filterDepth,o.filterHeight,o.filterWidth],[o.padInfo.front,o.padInfo.top,o.padInfo.left],r))},xa=(e,t)=>{if(hd(e.inputs,t),e.inputs[0].dims.length===3)fd(e,t);else if(e.inputs[0].dims.length===5)md(e,e.inputs,t);else{let n=zr(t,e.inputs);$a(e,e.inputs,n)}}}),gd,Py=Z(()=>{he(),Vt(),ge(),we(),gd=(e,t,n)=>{let r=e.length>2,i=t.outputShape,a=t.format==="NHWC",o=t.group,s=e[1].dims,u=s[2]/o,l=s[3],d=a?Le(u):1,p=a&&l===1&&u>=4,h=p?Math.floor(u/4)*4:Math.floor(u/d)*d,m=u-h,g=a?Le(l):1,y=a?l===1?d:g:1,w=G.size(i)/g,b=[Math.ceil(w/64),1,1];Ee("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${b}`);let x=["rank","rank"],S=[t.strides[0],t.strides[1]],v=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],T=[t.dilations[0],t.dilations[1]],M=[v[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),v[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],k=[M[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),M[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],E=[{type:12,data:w},{type:12,data:S},{type:12,data:v},{type:12,data:T},{type:12,data:M},{type:6,data:k},{type:12,data:h},{type:12,data:u},{type:12,data:l},...ce(e[0].dims,e[1].dims)];r&&(E.push(...ce(e[2].dims)),x.push("rank")),E.push(...ce(i));let R=P=>{let X=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:S.length},{name:"filter_dims",type:"u32",length:v.length},{name:"dilations",type:"u32",length:v.length},{name:"effective_filter_dims",type:"u32",length:M.length},{name:"pads",type:"i32",length:k.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],W=Ke(e[0].dataType),V=a?1:2,O=a?2:3,F=a?3:1,K=H("W",e[1].dataType,e[1].dims.length,y),Q=H("Dy",e[0].dataType,e[0].dims.length,d),ue=[Q,K];r&&ue.push(H("bias",e[2].dataType,[i[F]].length,g));let L=se("result",e[0].dataType,i.length,g),B=()=>{let D="";if(p)d===4?D+=`
...
`)};
    ...
    ${g}`},d=[{type:12,data:u},...ce(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},Gd=e=>{Ud(e.inputs),e.compute(Fd(e.inputs),{inputs:[0]})}}),Wd,qd,Wy=Z(()=>{he(),ge(),we(),la(),Wd=e=>{let t=e[0].dataType,n=G.size(e[0].dims),r=G.size(e[1].dims),i=r%4===0,a=o=>{let s=H("x",t,[1],4),u=H("bias",t,[1],4),l=se("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=m=>`
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${i}`,inputDependencies:["type","type"]},getShaderSource:a,getRunData:o=>({outputs:[{dims:o[0].dims,dataType:o[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(n/Nn/4)}})}},qd=e=>{e.inputs.length<2||G.size(e.inputs[1].dims)===0?Sc(e):e.compute(Wd(e.inputs))}}),Vd,Hd,jd,Kd,qy=Z(()=>{he(),ge(),Fe(),we(),Vd=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Hd=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n.length,a=G.normalizeAxis(t.axis,i),o=n.slice(0);o.splice(a,1,...r);let s=n[a],u=e[0].dataType===9?4:1,l=Math.ceil(G.size(o)/u),d=[{type:12,data:l},{type:6,data:s},{type:12,data:a},...ce(e[0].dims,e[1].dims,o)],p=h=>{let m=H("data",e[0].dataType,e[0].dims.length,u),g=H("inputIndices",e[1].dataType,e[1].dims.length),y=se("output",e[0].dataType,o.length,u),w=x=>{let S=r.length,v=`var indicesIndices${x}  = ${g.type.indices}(0);`;for(let T=0;T<S;T++)v+=`${S>1?`indicesIndices${x}[${T}]`:`indicesIndices${x}`} = ${o.length>1?`outputIndices${x}[uniforms.axis + ${T}]`:`outputIndices${x}`};`;v+=`
          var idx${x} = ${g.getByIndices(`indicesIndices${x}`)};
          if (idx${x} < 0) {
            idx${x} = idx${x} + uniforms.axisDimLimit;
          }
          var dataIndices${x} : ${m.type.indices};
        `;for(let T=0,M=0;T<i;T++)T===a?(v+=`${i>1?`dataIndices${x}[${T}]`:`dataIndices${x}`} = u32(idx${x});`,M+=S):(v+=`${i>1?`dataIndices${x}[${T}]`:`dataIndices${x}`} = ${o.length>1?`outputIndices${x}[${M}]`:`outputIndices${x}`};`,M++);return v},b;if(e[0].dataType===9){let x=(S,v,T="")=>`
  ...
  }`},w=b=>{let x=H("a",e[0].dataType,e[0].dims),S=H("b",e[1].dataType,e[1].dims),v=null,T=[x,S];e.length===3&&(v=H("c",e[2].dataType,e[2].dims.length),T.push(v));let M=se("output",e[0].dataType,s.length);T.push(M);let k=[{name:"num_tile_n",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"},{name:"alpha",type:"f32"},{name:"beta",type:"f32"}],E="",R="";t.transA&&t.transB?(R=`
...
`,gp=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,yp=(e,t)=>{let n=H("x",e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=H("grid",e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[Ot,Ht,vn,Sn]=[0,3,1,2]);let o=se("output",e[0].dataType,a.length),s=n.type.value,u=G.size(a),l=[{type:12,data:u},...ce(e[0].dims,r,a)],d=p=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:a},getRunData:()=>({outputs:[{dims:o,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},Dp=(e,t)=>{var v;let n=zp(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((v=e.inputs[1])==null?void 0:v.dims.length)===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,d=n.kvNumHeads?n.kvNumHeads:n.numHeads,p=Re({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,d*n.headSize,d*n.headSize]}),[h,m,g]=!i&&!a?e.compute(ka([r],p),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],y,w;if(t.doRotary){let T=e.compute(Pp(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],M=e.inputs[7],k=e.inputs[8],E=Re({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),R=[h,T,M,k],P=[-1];y=e.compute(Pr(R,E),{inputs:R,outputs:P})[0],R.splice(0,1,m);let X=Re({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});w=e.compute(Pr(R,X),{inputs:R,outputs:P})[0]}let b=nr(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?y:h,void 0,0),x=Ca(e,t.doRotary?w:m,n),S=Ca(e,g,n);Qn(e,b,x,S,void 0,void 0,o,s,void 0,n,u,l)}}),Aa,Up,Lp,Fp,Qy=Z(()=>{he(),ge(),en(),we(),Aa=(e,t,n,r,i,a,o,s)=>{let u=Le(a),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,p=i*o,h=64;p===1&&(h=256);let m=[i,o,a/u],g=[i,o,2],y=["rank","type","type"],w=[];w.push(...ce(m,g));let b=x=>{let S=H("x",t.dataType,3,u),v=H("scale",n.dataType,n.dims),T=H("bias",r.dataType,r.dims),M=se("output",1,3,2),k=[S,v,T,M];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:w},{inputs:[t[0],y]})},Fp=(e,t)=>{t.format==="NHWC"?Lp(e,e.inputs,t):Up(e,e.inputs,t)}}),Gp,Wp,qp,Zy=Z(()=>{he(),ge(),we(),Gp=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Wp=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,u=G.normalizeAxis(t.axis,i.length),l=G.sizeToDimension(i,u),d=G.sizeFromDimension(i,u),p=G.size(a.dims),h=o?G.size(o.dims):0;if(p!==d||o&&h!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${p} and bias size of ${h}`);let m=[];for(let T=0;T<i.length;++T)T<u?m.push(i[T]):m.push(1);let g=Le(d),y=["type","type"],w=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/g)},{type:1,data:t.epsilon}];o&&y.push("type");let b=n>1,x=n>2,S=T=>{let M=Ke(e[0].dataType),k=[H("x",e[0].dataType,e[0].dims,g),H("scale",a.dataType,a.dims,g)];o&&k.push(H("bias",o.dataType,o.dims,g)),k.push(se("output",e[0].dataType,s,g)),b&&k.push(se("mean_data_output",1,m)),x&&k.push(se("inv_std_output",1,m));let E=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${T.mainStart()}
    ...
    ${x?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},v=[{dims:s,dataType:e[0].dataType}];return b&&v.push({dims:m,dataType:1}),x&&v.push({dims:m,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${g};${n};${r}`,inputDependencies:y},getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:w}),getShaderSource:S}},qp=(e,t)=>{Gp(e.inputs),e.compute(Wp(e.inputs,t,e.outputCount))}}),Vp,Hp,Jy=Z(()=>{ge(),ha(),ya(),Vp=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Hp=e=>{Vp(e.inputs);let t=On.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(pa(e.inputs,{activation:""},t));else{let i=t[t.length-2],a=G.size(e.inputs[0].dims.slice(0,-2)),o=G.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let s=e.inputs[0].reshape([1,a,r]),u=e.inputs[1].reshape([1,r,n]),l=[1,a,n],d=[s,u];e.compute(Or(d,{activation:""},t,l),{inputs:d})}else e.compute(Or(e.inputs,{activation:""},t))}}}),jp,Kp,Yp,Xp,Qp,ew=Z(()=>{he(),ge(),Fe(),we(),jp=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!G.areEqual(o.dims,[t.n,i,a]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let s=e[2].dims;if(G.size(s)!==t.n*i)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(G.size(u)!==l)throw new Error("zeroPoints input size error.")}},Kp=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),u=G.size(s),l=e[1].dims[2]/4,d=e[0].dataType,p=Le(t.k),h=Le(l),m=Le(o),g=s.concat([i,o]),y=i>1&&o/m%2===0?2:1,w=G.size(g)/m/y,b=64,x=[],S=[u,i,a/p],v=G.convertShape(e[1].dims).slice();v.splice(-1,1,l/h),x.push(...ce(S)),x.push(...ce(v)),x.push(...ce(e[2].dims)),e.length===4&&x.push(...ce(G.convertShape(e[3].dims)));let T=[u,i,o/m];x.push(...ce(T));let M=k=>{let E=S.length,R=H("a",e[0].dataType,E,p),P=H("b",12,v.length,h),X=H("scales",e[2].dataType,e[2].dims.length),W=[R,P,X],V=e.length===4?H("zero_points",12,e[3].dims.length):void 0;V&&W.push(V);let O=T.length,F=se("output",e[0].dataType,O,m),K=Ke(e[0].dataType),Q=(()=>{switch(p){case 1:return`array<${K}, 8>`;case 2:return`mat4x2<${K}>`;case 4:return`mat2x4<${K}>`;default:throw new Error(`${p}-component is not supported.`)}})(),ue=Math.floor(32/t.bits),L=Math.floor(ue/8),B=()=>{let D="";for(let U=0;U<L;U++){let j=U*t.bits*4,re=j+t.bits;D+=`
          // reuse a data (pass ${U})
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${h};${m};${y};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:g,dataType:d}],dispatchGroup:{x:w},programUniforms:x}),getShaderSource:M}},Yp=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),u=G.size(s),l=e[1].dims[2]/4,d=e[0].dataType,p=Le(t.k),h=Le(l),m=s.concat([i,o]),g=128,y=o%8===0?8:o%4===0?4:1,w=g/y,b=Math.floor(32/t.bits),x=w*h*b,S=x/p,v=x/t.blockSize,T=G.size(m)/y,M=[],k=[u,i,a/p],E=G.convertShape(e[1].dims).slice();E.splice(-1,1,l/h),M.push(...ce(k)),M.push(...ce(E)),M.push(...ce(e[2].dims)),e.length===4&&M.push(...ce(G.convertShape(e[3].dims)));let R=[u,i,o];M.push(...ce(R));let P=X=>{let W=k.length,V=H("a",e[0].dataType,W,p),O=H("b",12,E.length,h),F=H("scales",e[2].dataType,e[2].dims.length),K=[V,O,F],Q=e.length===4?H("zero_points",12,e[3].dims.length):void 0;Q&&K.push(Q);let ue=R.length,L=se("output",e[0].dataType,ue),B=Ke(e[0].dataType),A=()=>{switch(p){case 1:return`
    ...
    `,s="",u=H("x",t.dataType,t.dims.length),l=["rank"],[d,p,h,m,g]=Oa(a,i);return d.push(...ce(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${h};${m};${g}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(G.size(a)/64)},programUniforms:d}),getShaderSource:y=>Na(y,u,t.dims.length,a.length,i,o,s,t.dataType===10?-65504:-1e5,p,h,m,g)}},hh=(e,t)=>{rr(e.inputs),e.compute(Ua("MaxPool",e.inputs[0],!1,t))},fh=e=>{let t=e.storage_order,n=e.dilations,r=Ba(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:n,...r,cacheKey:""};return{...i,cacheKey:uh(i)}},mh=e=>{let t=e.format;return{format:t,...Da,cacheKey:t}},gh=(e,t)=>{rr(e.inputs),e.compute(Ua("GlobalMaxPool",e.inputs[0],!0,t))}}),yh,wh,_h,bh,rw=Z(()=>{he(),ge(),Fe(),we(),yh=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===t.axis||i===e[0].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},wh=(e,t)=>{let n=G.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=G.size(a),u=r===3||r===2,l=u?[Math.ceil(G.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,p=e.length>2?e[2]:void 0,h=p?u?[Math.ceil(G.size(p.dims)/4)]:p.dims:void 0,m=d.length===0||d.length===1&&d[0]===1,g=m===!1&&d.length===1,y=Le(s),w=m&&(!u||y===4),b=w?y:1,x=w&&!u?y:1,S=H("input",u?12:r,l.length,x),v=H("scale",o,d.length),T=p?H("zero_point",u?12:r,h.length):void 0,M=se("output",o,a.length,b),k=[S,v];T&&k.push(T);let E=[l,d];p&&E.push(h);let R=[{type:12,data:s/b},{type:12,data:n},{type:12,data:t.blockSize},...ce(...E,a)],P=X=>{let W=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:T?["rank","rank","rank"]:["rank","rank"]},getShaderSource:P,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/b/64),y:1,z:1},programUniforms:R})}},_h=(e,t)=>{yh(e.inputs,t),e.compute(wh(e.inputs,t))},bh=e=>Re({axis:e.axis,blockSize:e.blockSize})}),$h,xh,vh,iw=Z(()=>{mt(),he(),we(),$h=(e,t,n)=>{let r=e===t,i=e<t&&n<0,a=e>t&&n>0;if(r||i||a)throw new Error("Range these inputs' contents are invalid.")},xh=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...ce(a)],u=l=>{let d=se("output",r,a.length),p=d.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
        ${l.registerUniforms(h).declareVariables(d)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},vh=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),ze.webgpu.validateInputContent&&$h(t,n,r),e.compute(xh(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),Sh,Th,Eh,Ih,aw=Z(()=>{he(),ge(),Fe(),we(),Sh=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Sh(t.reduction,"output[data_offset + i]","value",g.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:l}),getShaderSource:d}},Eh=e=>Re({reduction:e.reduction}),Ih=(e,t)=>{e.compute(Th(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Mh,kh,Ch,La,Ah,Rh,Oh,Nh,zh,Bh,Ph,Dh,Fa,Uh,Lh,Fh,Gh,Wh,qh,Vh,ow=Z(()=>{he(),ge(),Fe(),we(),Mh=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...ce(e[0].dims,i)]}),getShaderSource:l}},lf=e=>{of(e.inputs),e.compute(uf(e.inputs),{inputs:[0]})}}),cf,df,pf,dw=Z(()=>{he(),ge(),we(),cf=(e,t,n,r,i)=>{let a=se("output_data",i,n.length,4),o=H("a_data",t[1].dataType,t[1].dims.length,4),s=H("b_data",t[2].dataType,t[2].dims.length,4),u=H("c_data",t[0].dataType,t[0].dims.length,4),l,d=(p,h,m)=>`select(${h}, ${p}, ${m})`;if(!r)l=a.setByOffset("global_idx",d(o.getByOffset("global_idx"),s.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let p=(h,m,g="")=>{let y=`a_data[index_a${m}][component_a${m}]`,w=`b_data[index_b${m}][component_b${m}]`,b=`bool(c_data[index_c${m}] & (0xffu << (component_c${m} * 8)))`;return`
 ...
 * limitations under the License.
 * =============================================================================
 */const Gr=new Map;function Uf(e,t){const n=Gr.get(e)??{ms:0,appels:0};n.ms+=t,n.appels+=1,Gr.set(e,n)}function rt(e,t){const n=performance.now();try{return t()}finally{Uf(e,performance.now()-n)}}async function Je(e,t){const n=performance.now();try{return await t()}finally{Uf(e,performance.now()-n)}}function _w(){return[...Gr.entries()].map(([e,t])=>({nom:e,ms:Math.round(t.ms),appels:t.appels})).sort((e,t)=>t.ms-e.ms)}function bw(){Gr.clear()}const $w=new Map([["starting the on-device engine…","Démarrage du moteur…"],["reading pixels…","Lecture de la photo…"],["card banners…","Détection des cartes…"],["progress tokens…","Jetons de progrès…"],["coins…","Comptage des pièces…"],["identifying wonders…","Identification des merveilles…"],["identifying guilds…","Identification des guildes…"],["laurels…","Lecture des points de victoire…"],["wonder names…","Lecture des noms de merveilles…"],["searching occluded wonders…","Recherche des merveilles masquées…"],["seconde passe merveilles (crop de cité)…","Seconde passe sur les merveilles…"],["revote built (crop de cité)…","Vérification des merveilles construites…"],["military pawn…","Position du pion militaire…"]]),xw=new Map([["left","Cité de gauche"],["right","Cité de droite"],["board","Piste militaire"]]),vw=/^(left|right|board|both) photo (\d+)\/(\d+): (.+)$/;function Lf(e){const t=$w.get(e);if(t!==void 0)return t;const n=/^registering (.+)…$/.exec(e);if(n!==null)return`Recalage de ${n[1]}…`;const r=/^wonder names: rotation (\d+)°…$/.exec(e);return r!==null?`Lecture des noms de merveilles — rotation ${r[1]}°…`:e}function Sw(e){const t=vw.exec(e);if(t===null)return Lf(e);const[,n,r,i,a]=t,o=Lf(a);if(n==="both")return o;const s=xw.get(n)??n,u=i==="1"?"":` (${r}/${i})`;return`${s}${u} — ${o}`}function Tw(e,t,n,r){const i=t*n,a=new Uint8ClampedArray(new ArrayBuffer(i*4));if(r===4)return a.set(e),a;for(let o=0;o<i;o+=1)a[o*4]=e[o*r],a[o*4+1]=e[o*r+1],a[o*4+2]=e[o*r+2],a[o*4+3]=255;return a}function it(e){const t=Math.floor(e);return e-t===.5?t%2===0?t:t+1:Math.round(e)}function Pn(e){if(e.length===0)return Number.NaN;const t=[...e].sort((r,i)=>r-i),n=Math.floor(t.length/2);return t.length%2===1?t[n]:(t[n-1]+t[n])/2}function Ff(e,t){if(e.length===0)return Number.NaN;const n=[...e].sort((o,s)=>o-s),r=t/100*(n.length-1),i=Math.floor(r),a=Math.ceil(r);return i===a?n[i]:n[i]*(a-r)+n[a]*(r-i)}const Ew=114;function Iw(e,t,n,r=1){const i=Math.min(n*r/e,n*r/t),a=Math.round(e*i),o=Math.round(t*i);return{scale:i,padX:Math.floor((n-a)/2),padY:Math.floor((n-o)/2),resizedWidth:a,resizedHeight:o}}function ro(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let d=0;d<n;d++){const p=(d+.5)*l-.5,h=Math.max(0,Math.min(i-1,Math.floor(p))),m=Math.min(i-1,h+1),g=Math.max(0,Math.min(1,p-h));for(let y=0;y<t;y++){const w=(y+.5)*u-.5,b=Math.max(0,Math.min(r-1,Math.floor(w))),x=Math.min(r-1,b+1),S=Math.max(0,Math.min(1,w-b)),v=(h*r+b)*a,T=(h*r+x)*a,M=(m*r+b)*a,k=(m*r+x)*a,E=(d*t+y)*3;for(let R=0;R<3;R++){const P=o[v+R]*(1-S)+o[T+R]*S,X=o[M+R]*(1-S)+o[k+R]*S;s[E+R]=Math.min(255,Math.max(0,Math.round(P*(1-g)+X*g)))}}}return s}function Dn(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let d=0;d<n;d++){const p=d*l,h=Math.min((d+1)*l,i);for(let m=0;m<t;m++){const g=m*u,y=Math.min((m+1)*u,r);let w=0,b=0,x=0,S=0;for(let T=Math.floor(p);T<h;T++){const M=Math.min(T+1,h)-Math.max(T,p);if(!(M<=0))for(let k=Math.floor(g);k<y;k++){const E=Math.min(k+1,y)-Math.max(k,g);if(E<=0)continue;const R=E*M,P=(T*r+k)*a;w+=o[P]*R,b+=o[P+1]*R,x+=o[P+2]*R,S+=R}}const v=(d*t+m)*3;s[v]=Math.min(255,Math.max(0,it(w/S))),s[v+1]=Math.min(255,Math.max(0,it(b/S))),s[v+2]=Math.min(255,Math.max(0,it(x/S)))}}return s}function Gf(e){const n=((-.75*(e+1)- -3.75)*(e+1)+-6)*(e+1)- -3,r=((-.75+2)*e-(-.75+3))*e*e+1,i=((-.75+2)*(1-e)-(-.75+3))*(1-e)*(1-e)+1;return[n,r,i,1-n-r-i]}function sr(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n,d=h=>Math.max(0,Math.min(r-1,h)),p=h=>Math.max(0,Math.min(i-1,h));for(let h=0;h<n;h++){const m=(h+.5)*l-.5,g=Math.floor(m),y=Gf(m-g);for(let w=0;w<t;w++){const b=(w+.5)*u-.5,x=Math.floor(b),S=Gf(b-x),v=(h*t+w)*3;for(let T=0;T<3;T++){let M=0;for(let k=0;k<4;k++){const E=p(g-1+k)*r;let R=0;for(let P=0;P<4;P++)R+=S[P]*o[(E+d(x-1+P))*a+T];M+=y[k]*R}s[v+T]=Math.min(255,Math.max(0,Math.round(M)))}}}return s}function Wr(e,t,n=1){const r=Iw(e.width,e.height,t,n),i=ro(e,r.resizedWidth,r.resizedHeight),a=t*t,o=new Float32Array(3*a).fill(Ew/255);for(let s=0;s<r.resizedHeight;s++){const u=(s+r.padY)*t+r.padX,l=s*r.resizedWidth;for(let d=0;d<r.resizedWidth;d++){const p=(l+d)*3,h=u+d;o[h]=i[p]/255,o[a+h]=i[p+1]/255,o[2*a+h]=i[p+2]/255}}return{tensor:o,params:r}}function Mw(e,t,n,r){const i=[],a=Math.floor(e.length/6);for(let o=0;o<a;o++){const s=e[o*6],u=e[o*6+1],l=e[o*6+2],d=e[o*6+3],p=e[o*6+4],h=e[o*6+5];if(p<n)continue;const m=Math.round(h);if(m<0||m>=r)continue;const g=(s-t.padX)/t.scale,y=(u-t.padY)/t.scale,w=(l-t.padX)/t.scale,b=(d-t.padY)/t.scale;i.push({classIndex:m,confidence:p,box:[Math.trunc(g),Math.trunc(y),Math.trunc(w-g),Math.trunc(b-y)],boxFloat:[g,y,w-g,b-y]})}return i}const ur=.8,Wf=.65,kw=110,Cw=1280;function Aw(e,t,n){if(n==null)return ur;if(n.length===0)return Wf;const r=Math.max(e,t);if(!(r>0))return ur;const i=Cw/r,a=n.filter(u=>Array.isArray(u.box)||u.box!==void 0).map(u=>Math.sqrt(Number(u.box[2])**2+Number(u.box[3])**2)*i).filter(u=>Number.isFinite(u)).sort((u,l)=>u-l);if(a.length===0)return ur;const o=a.length;return(o%2===1?a[(o-1)/2]:(a[o/2-1]+a[o/2])/2)>=kw?Wf:ur}const qf=.25,Vf=.6;function Rw(e,t,n){const r=Math.trunc(Number(n[0])),i=Math.trunc(Number(n[1])),a=Math.trunc(Number(n[2])),o=Math.trunc(Number(n[3]));if(![r,i,a,o].every(b=>Number.isFinite(b)))return null;const s=a-r,u=o-i;if(s<=0||u<=0)return null;const l=Math.trunc(s*(s>=u?qf:Vf)),d=Math.trunc(u*(s>=u?Vf:qf)),p=Math.max(0,r-l),h=Math.max(0,i-d),m=Math.min(Math.trunc(e),a+l),g=Math.min(Math.trunc(t),o+d),y=m-p,w=g-h;return y<=0||w<=0?null:{x:p,y:h,width:y,height:w}}const Ow=3,Nw=.15,zw=.6;function io(e,t){return Math.hypot(Number(e[0])-Number(t[0]),Number(e[1])-Number(t[1]))}function Bw(e){const t=e.filter(i=>i&&Number.isFinite(Number(i[0]))&&Number.isFinite(Number(i[1])));if(t.length===0)return null;let n=0,r=0;for(const i of t)n+=Number(i[0]),r+=Number(i[1]);return[n/t.length,r/t.length]}function Pw(e,t,n){try{const r=Math.trunc(Number(n)),i=n!=null&&Number.isFinite(r)&&r!==0;if(!e||e.length<2)return null;const a=[Number(e[0][0]),Number(e[0][1])],o=[Number(e[1][0]),Number(e[1][1])];if(![...a,...o].every(T=>Number.isFinite(T)))return null;const s=io(a,o);if(!(s>0))return null;const u=[];for(const T of t??[]){const M=Math.trunc(Number(T.n));if(!Number.isFinite(M)||M<Ow)continue;const k=Bw(T.poly);k!==null&&u.push({owner:T.owner,c:k,n:M,d0:0,d1:0,ecart:0})}if(u.length<2)return null;u.sort((T,M)=>M.n-T.n);const l=u.slice(0,2);let d=!1;u.length>2&&l[1].n>0&&(d=u[2].n/l[1].n>zw);for(const T of l)T.d0=io(T.c,a),T.d1=io(T.c,o),T.ecart=Math.abs(T.d0-T.d1);const p=[...l].sort((T,M)=>M.ecart-T.ecart),h=p[0],m=p[1],g=h.d0<h.d1?0:1,y=r>0?1:0,w=i?g===y?h:m:null,b=i?g===y?m:h:null,x=g===1?h.owner:m.owner,S=g===1?m.owner:h.owner,v=h.ecart/s<Nw;return{favoredOwner:(b==null?void 0:b.owner)??null,threatenedOwner:(w==null?void 0:w.owner)??null,ownerAtEnd0:S,ownerAtEnd1:x,distance:i?Math.abs(r):null,ambiguous:!!(v||d)}}catch{return null}}function Dw(e){if(!e)return null;const t=e.ownerAtEnd1,n=e.ownerAtEnd0;return!t||!n||t===n?null:{left:n,right:t}}const Uw=.6;function Hf(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++){if(e[a*6+4]<n)continue;const s=(e[a*6]-t.padX)/t.scale,u=(e[a*6+1]-t.padY)/t.scale,l=(e[a*6+2]-t.padX)/t.scale,d=(e[a*6+3]-t.padY)/t.scale,p=it((s+l)/2),h=it((u+d)/2),m=it((l-s+(d-u))/4);m>=1&&r.push({cx:p,cy:h,r:m})}return r}function Lw(e){const t=[];for(const n of[...e].sort((r,i)=>r.r-i.r)){const r=(Uw*n.r)**2;t.every(i=>(n.cx-i.cx)**2+(n.cy-i.cy)**2>r)&&t.push(n)}return t}function Fw(e){if(e.length===0)return[];const t=Math.max(1,Math.trunc(Pn(e.map(n=>n.r))*1.5));return[...e].sort((n,r)=>{const i=Math.floor(n.cy/t),a=Math.floor(r.cy/t);return i!==a?i-a:n.cx-r.cx})}function jf(e,t,n){const r=Hf(e,t,n);return r.length===0?[]:Fw(Lw(r))}function Gw(e,t,n){return Hf(e,t,n)}function ao(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++)e[a*6+4]<n||r.push([(e[a*6]-t.padX)/t.scale,(e[a*6+1]-t.padY)/t.scale,(e[a*6+2]-t.padX)/t.scale,(e[a*6+3]-t.padY)/t.scale]);return r}const Ww=.5,qw=.7,Vw=.55;function oo(e){const t=e.map(([n,r,i,a])=>Math.min(i-n,a-r)).sort((n,r)=>n-r);return t[Math.floor(t.length/2)]||1}function Kf(e){if(e.length===0)return[];const t=(Ww*oo(e))**2,n=[];for(const i of e){const a=(i[0]+i[2])/2,o=(i[1]+i[3])/2,s=n.find(u=>(u.cx-a)**2+(u.cy-o)**2<=t);if(s===void 0)n.push({cx:a,cy:o,boxes:[i]});else{s.boxes.push(i);const u=s.boxes.length;s.cx=(s.cx*(u-1)+a)/u,s.cy=(s.cy*(u-1)+o)/u}}let r=n.map(({boxes:i})=>[Math.trunc(Pn(i.map(a=>a[0]))),Math.trunc(Pn(i.map(a=>a[1]))),Math.trunc(Pn(i.map(a=>a[2]))),Math.trunc(Pn(i.map(a=>a[3])))]);if(r.length>=2){const i=oo(r),a=r.map(()=>!0);for(let o=0;o<r.length;o++)if(a[o])for(let s=o+1;s<r.length;s++){if(!a[s])continue;const u=r[o],l=r[s],d=Math.max(0,Math.min(u[2],l[2])-Math.max(u[0],l[0])),p=Math.max(0,Math.min(u[3],l[3])-Math.max(u[1],l[1])),h=d*p,m=(u[2]-u[0])*(u[3]-u[1]),g=(l[2]-l[0])*(l[3]-l[1]);if(h>=qw*Math.min(m,g)){const y=Math.abs(Math.min(u[2]-u[0],u[3]-u[1])-i),w=Math.abs(Math.min(l[2]-l[0],l[3]-l[1])-i);if(a[y<=w?s:o]=!1,!a[o])break}}r=r.filter((o,s)=>a[s])}if(r.length>=3){const i=oo(r);r=r.filter(([a,o,s,u])=>Math.min(s-a,u-o)>=Vw*i)}return r}const Hw=.7;function jw(e,t){const n=Math.max(e[0],t[0]),r=Math.max(e[1],t[1]),i=Math.min(e[2],t[2]),a=Math.min(e[3],t[3]);if(i<=n||a<=r)return 0;const o=(i-n)*(a-r),s=(e[2]-e[0])*(e[3]-e[1]),u=(t[2]-t[0])*(t[3]-t[1]),l=s+u-o;return l>0?o/l:0}function Yf(e,t,n,r,i,a=Hw){const o=t-4;if(o<=0||n<=0)return[];const s=[];for(let l=0;l<n;l+=1){let d=0,p=0;for(let h=0;h<o;h+=1){const m=e[(4+h)*n+l];m>d&&(d=m,p=h)}d<i||s.push({box:[(e[l]-r.padX)/r.scale,(e[n+l]-r.padY)/r.scale,(e[2*n+l]-r.padX)/r.scale,(e[3*n+l]-r.padY)/r.scale],score:d,cls:p})}s.sort((l,d)=>d.score-l.score);const u=[];for(const l of s){let d=!1;for(const p of u)if(p.cls===l.cls&&jw(p.box,l.box)>a){d=!0;break}d||u.push(l)}return u.map(l=>l.box)}const Xf=["brown","grey","blue","green","yellow","red","purple"],Kw={brown:"raw",grey:"manufactured",blue:"civilian",green:"scientific",yellow:"commercial",red:"military",purple:"guild"},Yw=.7;function Qf(e){const t=e.map((i,a)=>a).sort((i,a)=>e[a].confidence-e[i].confidence),n=new Set,r=[];for(const i of t){const a=e[i],[o,s,u,l]=a.box;let d=!1;for(const p of r){const h=e[p];if(h.family!==a.family)continue;const[m,g,y,w]=h.box,b=Math.max(0,Math.min(o+u,m+y)-Math.max(o,m)),x=Math.max(0,Math.min(s+l,g+w)-Math.max(s,g)),S=Math.max(1,Math.min(u*l,y*w));if(b*x>=Yw*S){d=!0;break}}d?n.add(i):r.push(i)}return e.filter((i,a)=>!n.has(a))}function qr(e,t,n){const r=Mw(e,t,n,Xf.length).map(i=>{const a=Xf[i.classIndex];return{color:a,family:Kw[a],box:i.box,confidence:i.confidence}});return Qf(r)}const Xw=8,Qw=.8,Zf=1.25;function Zw(e){if(e.length<Xw)return[];const t=[],n=[];for(const o of e){const[,,s,u]=o.box;s>u*Zf?t.push(o):u>s*Zf&&n.push(o)}const[r,i,a]=t.length>=n.length?[t,n,"vertical"]:[n,t,"horizontal"];return r.length<Qw*e.length||i.length===0?[]:i.map(o=>({family:o.family,color:o.color,box:[...o.box],reason:`${o.color} banner sits ${a} while ${r.length}/${e.length} of the tableau faces the other way — probably a stray card poking into the frame`}))}const Jw=2.25,Jf=8;function e_(e){if(e.length<Jf)return[];const t=e.map(p=>[p.box[0]+p.box[2]/2,p.box[1]+p.box[3]/2]),n=e.map(p=>Math.hypot(p.box[2],p.box[3])).sort((p,h)=>p-h),r=Jw*n[Math.floor(n.length/2)],i=r*r,a=e.map((p,h)=>h),o=p=>{for(;a[p]!==p;)a[p]=a[a[p]],p=a[p];return p};for(let p=0;p<e.length;p++)for(let h=p+1;h<e.length;h++){const m=t[p][0]-t[h][0],g=t[p][1]-t[h][1];m*m+g*g<=i&&(a[o(p)]=o(h))}const s=new Map;for(let p=0;p<e.length;p++){const h=o(p);s.set(h,[...s.get(h)??[],p])}let u=[];for(const p of s.values())p.length>u.length&&(u=p);if(u.length<Jf||u.length===e.length)return[];const l=new Set(u),d=e.map((p,h)=>h).filter(p=>!l.has(p));return d.map(p=>({family:e[p].family,color:e[p].color,box:[...e[p].box],reason:`${e[p].color} banner sits in a detached group of ${d.length}, away from the ${u.length}-card tableau — probably the draw/discard pile, not this player's city`}))}const at={banner:{onnx:"banner_yolo.onnx",input:1280,conf:.5},coin:{onnx:"coin_yolo.onnx",input:1280,conf:.25},laurel:{onnx:"laurel_yolo.onnx",input:1280,conf:.25},token:{onnx:"token_yolo.onnx",input:1280,conf:.4}};function Et(e,t,n){const r=Math.max(e,t,n),i=Math.min(e,t,n),a=r-i,o=r===0?0:Math.round(255*a/r);if(a===0)return{h:0,s:o,v:r};let s;return r===e?s=60*(t-n)/a:r===t?s=120+60*(n-e)/a:s=240+60*(e-t)/a,s<0&&(s+=360),{h:Math.round(s/2),s:o,v:r}}const t_=.42,n_=22,r_=43,i_=120,a_=1.5,o_=.72,s_=110,em=3;function lr(e,t,n){const{width:r,height:i,channels:a,data:o}=e;if(r<4||i<4)return 0;const s=Math.floor(r/2),u=Math.floor(i/2),l=Math.trunc(Math.min(r,i)*t_);if(l<1)return 0;let d=0;for(let p=0;p<i;p++)for(let h=0;h<r;h++){if((h-s)**2+(p-u)**2>l*l)continue;const m=(p*r+h)*a,g=o[m],y=o[m+1],w=o[m+2];!t&&g>=250&&y>=250&&w>=250||(n(g,y,w),d+=1)}return d}function u_(e){let t=0,n=0,r=0,i=lr(e,!1,(a,o,s)=>{const u=Et(a,o,s);t+=u.h,n+=u.s,r+=u.v});return i===0&&(i=lr(e,!0,(a,o,s)=>{const u=Et(a,o,s);t+=u.h,n+=u.s,r+=u.v})),i===0?null:{h:t/i,s:n/i,v:r/i}}function l_(e){let t=0,n=0,r=lr(e,!1,(a,o)=>{t+=a,n+=o});if(r===0&&(r=lr(e,!0,(a,o)=>{t+=a,n+=o})),r===0)return null;const i=n/r;return i<=1e-6?null:t/r/i}function c_(e){let t=0;const n=lr(e,!0,(r,i,a)=>{t+=Et(r,i,a).s});return n===0?null:t/n}function d_(e){const t=u_(e);if(t===null||t.s<=n_)return 1;if(t.s>=i_){const n=l_(e);return n!==null&&n>=a_?6:3}return t.s>=r_?3:6}function p_(e,t){const n=[...t];if(e.length!==3||t.length!==3||new Set(t).size===3&&t.every(o=>[1,3,6].includes(o)))return n;const r=e.map(o=>o.r).sort((o,s)=>o-s);if(r[0]<=0||!(r[1]>=r[0]*1.12&&r[2]>=r[1]*1.12))return n;const i=[0,1,2].sort((o,s)=>e[o].r-e[s].r),a=new Map([[i[0],1],[i[1],3],[i[2],6]]);return[0,1,2].map(o=>a.get(o))}function h_(e,t){const n=[...t];if(e.length<em||t.length!==e.length)return n;const r=e.map(o=>c_(o)),i=r.filter(o=>o!==null);if(i.length<em)return n;const a=Pn(i);return a<=0||r.forEach((o,s)=>{o!==null&&n[s]!==1&&o<o_*a&&o<s_&&(n[s]=1)}),n}function tm(e,t){const{cx:n,cy:r,r:i}=t,a=Math.max(0,n-i),o=Math.max(0,r-i),s=Math.min(e.width,n+i),u=Math.min(e.height,r+i),l=Math.max(0,s-a),d=Math.max(0,u-o),p=new Uint8Array(l*d*3);for(let h=0;h<d;h++)for(let m=0;m<l;m++){const g=(h*l+m)*3;if((m+a-n)**2+(h+o-r)**2<=i*i){const w=((h+o)*e.width+(m+a))*e.channels;p[g]=e.data[w],p[g+1]=e.data[w+1],p[g+2]=e.data[w+2]}else p[g]=255,p[g+1]=255,p[g+2]=255}return{width:l,height:d,channels:3,data:p}}function f_(e,t){const n=t.map(a=>tm(e,a)),r=n.map(a=>d_(a)),i=p_(t,r);return h_(n,i)}function m_(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n);for(let o=0,s=0;o<a.length;o++,s+=r)a[o]=i[s]*4899+i[s+1]*9617+i[s+2]*1868+8192>>14;return{width:t,height:n,data:a}}function nm(e,t,n){const r=new Uint8Array(t*n),i=e.width/t,a=e.height/n;for(let o=0;o<n;o++){const s=o*a,u=Math.min((o+1)*a,e.height);for(let l=0;l<t;l++){const d=l*i,p=Math.min((l+1)*i,e.width);let h=0,m=0;for(let g=Math.floor(s);g<u;g++){const y=Math.min(g+1,u)-Math.max(g,s);if(!(y<=0))for(let w=Math.floor(d);w<p;w++){const b=Math.min(w+1,p)-Math.max(w,d);b<=0||(h+=e.data[g*e.width+w]*b*y,m+=b*y)}}r[o*t+l]=Math.min(255,Math.max(0,it(h/m)))}}return{width:t,height:n,data:r}}function g_(e){const t=new Array(256).fill(0);for(const u of e.data)t[u]+=1;const n=e.data.length;let r=0;for(;r<256&&t[r]===0;)r+=1;const i=new Uint8Array(n);if(r>=255||t[r]===n)return i.fill(r<256?r:0),{width:e.width,height:e.height,data:i};const a=255/(n-t[r]),o=new Uint8Array(256);let s=0;for(let u=r+1;u<256;u++)s+=t[u],o[u]=Math.min(255,Math.max(0,it(s*a)));for(let u=0;u<n;u++)i[u]=o[e.data[u]];return{width:e.width,height:e.height,data:i}}function y_(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!0;for(let u=-1;u<=1&&s;u++)for(let l=-1;l<=1;l++){const d=o+l,p=a+u;if(!(d<0||d>=t||p<0||p>=n)&&r[p*t+d]===0){s=!1;break}}i[a*t+o]=s&&r[a*t+o]>0?255:0}return{width:t,height:n,data:i}}function w_(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!1;for(let u=-1;u<=1&&!s;u++)for(let l=-1;l<=1;l++){const d=o+l,p=a+u;if(d>=0&&d<t&&p>=0&&p<n&&r[p*t+d]>0){s=!0;break}}i[a*t+o]=s?255:0}return{width:t,height:n,data:i}}function rm(e){const{width:t,height:n,data:r}=e,i=new Int32Array(t*n),a=[],o=new Int32Array(t*n);let s=1;for(let u=0;u<r.length;u++){if(r[u]===0||i[u]!==0)continue;let l=0,d=0;o[d++]=u,i[u]=s;let p=0,h=0,m=0;for(;l<d;){const g=o[l++],y=g%t,w=g/t|0;p+=1,h+=y,m+=w;for(let b=-1;b<=1;b++)for(let x=-1;x<=1;x++){if(x===0&&b===0)continue;const S=y+x,v=w+b;if(S<0||S>=t||v<0||v>=n)continue;const T=v*t+S;r[T]>0&&i[T]===0&&(i[T]=s,o[d++]=T)}}a[s]={area:p,centroidX:h/p,centroidY:m/p},s+=1}return{labels:i,stats:a}}function __(e,t,n){return im(Float32Array.from(e.data),e.width,t,n)}function im(e,t,n,r){const i=new Float32Array(t*t),a=t/2,o=-n*Math.PI/180,s=Math.cos(o),u=Math.sin(o);for(let l=0;l<t;l++)for(let d=0;d<t;d++){const p=d-a,h=l-a,m=s*p-u*h+a,g=u*p+s*h+a,y=Math.floor(m),w=Math.floor(g),b=m-y,x=g-w,S=(M,k)=>M>=0&&M<t&&k>=0&&k<t?e[k*t+M]:r,v=S(y,w)*(1-b)+S(y+1,w)*b,T=S(y,w+1)*(1-b)+S(y+1,w+1)*b;i[l*t+d]=v*(1-x)+T*x}return i}const b_=.9,$_=.34,x_=[.55,.6,.66,.72],v_=22,S_=88,T_=35,Un=28,so=4,E_=Array.from({length:15},(e,t)=>-21+t*3),am=[-2,0,2],I_=3,M_=.3;function k_(e){return e.templates.flatMap(({label:t,bits:n})=>{const r=Uint8Array.from(atob(n),i=>i.charCodeAt(0));return r.length!==e.size*e.size?[]:[{label:t,bits:Float32Array.from(r)}]})}function C_(e){let t=e.width,n=-1,r=e.height,i=-1,a=0;for(let y=0;y<e.height;y++)for(let w=0;w<e.width;w++)e.data[y*e.width+w]>0&&(a+=1,t=Math.min(t,w),n=Math.max(n,w),r=Math.min(r,y),i=Math.max(i,y));if(a<8)return null;const o=n-t+1,s=i-r+1,u=Math.max(s,o),l=new Uint8Array(u*u),d=Math.floor((u-o)/2),p=Math.floor((u-s)/2);for(let y=0;y<s;y++)for(let w=0;w<o;w++)l[(y+p)*u+(w+d)]=e.data[(y+r)*e.width+(w+t)];const h=Un-2*so,m=nm({width:u,height:u,data:l},h,h),g=new Float32Array(Un*Un);for(let y=0;y<h;y++)for(let w=0;w<h;w++)g[(y+so)*Un+(w+so)]=m.data[y*h+w]>110?1:0;return g}function A_(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(r/2),s=Math.floor(n/2),u=Math.trunc(Math.min(n,r)*$_);if(u<4)return null;const l=o-u,d=s-u,p=2*u,h=2*u;if(p<6||h<6)return null;const m=new Int16Array(p*h),g=new Int16Array(p*h),y=new Int16Array(p*h),w=new Uint8Array(p*h),b=[],x=Math.min(p,h)/2;for(let L=0;L<p;L++)for(let B=0;B<h;B++){const A=((L+l)*n+(B+d))*i,{h:N,s:D,v:U}=Et(a[A],a[A+1],a[A+2]),j=L*h+B;m[j]=N,g[j]=D,y[j]=U,Math.sqrt((B-h/2)**2+(L-p/2)**2)/x<=t&&(w[j]=1,b.push(U))}if(b.length<16)return null;const S=Ff(b,55);let v=0,T=0,M=0;const k=L=>m[L]>=v_&&m[L]<=S_&&g[L]>=T_,E=L=>y[L]>=S&&g[L]<=95&&!k(L)&&w[L]===1;for(let L=0;L<p*h;L++)w[L]===1&&(M+=1,y[L]>=130&&!k(L)&&(v+=1),E(L)&&(T+=1));const R=v>.5*M&&T<.15*M,P=new Uint8Array(p*h);if(R){const L=Ff(b,45);for(let B=0;B<p*h;B++)P[B]=w[B]===1&&y[B]<=L?255:0}else for(let L=0;L<p*h;L++)P[L]=E(L)?255:0;const X={width:h,height:p,data:P},W=y_(X);let V=rm(W),O=V;if(V.stats.length<=1&&(V=rm(X),O=V,V.stats.length<=1))return null;const F=Math.min(p,h)/2;let K=0,Q=-1;for(let L=1;L<O.stats.length;L++){const B=O.stats[L];if(B===void 0)continue;const A=Math.hypot(B.centroidX-h/2,B.centroidY-p/2)/F,N=B.area*(1-.6*Math.min(A,1));N>Q&&(Q=N,K=L)}if(K===0)return null;const ue=new Uint8Array(p*h);for(let L=0;L<p*h;L++)ue[L]=O.labels[L]===K?255:0;return C_(w_({width:h,height:p,data:ue}))}function R_(e,t,n,r,i,a){const o=Un;let s=0,u=0;for(let l=0;l<o;l++){const d=l-a;if(!(d<0||d>=o))for(let p=0;p<o;p++){const h=p-i;if(h<0||h>=o)continue;const m=e[d*o+h];m!==0&&(u+=m,s+=m*n[l*o+p])}}return s/(u+r-s+1e-6)}function O_(e,t){const n=t.reduce((i,a)=>i+a,0);let r=-1;for(const i of E_){const a=i===0?e:im(e,Un,i,0),o=a.reduce((s,u)=>s+u,0);for(const s of am)for(const u of am){const l=R_(a,o,t,n,s,u);l>r&&(r=l)}}return r}function N_(e,t){if(t.length===0||Math.min(e.width,e.height)<8)return[null,0];const n=[];for(const o of x_){const s=A_(e,o);if(s!==null)for(const{label:u,bits:l}of t)n.push([O_(s,l),u])}if(n.length===0)return[null,0];if(n.sort((o,s)=>s[0]-o[0]),n[0][0]<M_)return[null,0];const r=new Map;for(const[o,s]of n.slice(0,I_))r.set(s,(r.get(s)??0)+o);let i=0,a=-1;for(const[o,s]of r)s>a&&(a=s,i=o);return[i,n[0][0]]}function rn(e,t){const n=(t%4+4)%4;if(n===0)return e;const{width:r,height:i,channels:a,data:o}=e,s=n%2===0?r:i,u=n%2===0?i:r,l=new Uint8Array(s*u*a);for(let d=0;d<i;d++)for(let p=0;p<r;p++){let h,m;n===1?(h=i-1-d,m=p):n===2?(h=r-1-p,m=i-1-d):(h=d,m=r-1-p);const g=(d*r+p)*a,y=(m*s+h)*a;for(let w=0;w<a;w++)l[y+w]=o[g+w]}return{width:s,height:u,channels:a,data:l}}const z_=.6;(()=>{const e=new Uint8Array(256);for(let t=0;t<256;t++)e[t]=Math.min(255,Math.round(Math.pow(t/255,z_)*255));return e})();const B_=5e3,P_=.75,D_=15,U_=1.25,L_=2.4,F_=.003,G_=.85,W_=2600,q_=2,uo=.3,om=.1,sm=.012,V_=22,um=.5,lm=.12;function pt(e,t){const n=new e.Mat(t.height,t.width,e.CV_8UC3),r=n.data,i=t.channels;for(let a=0,o=t.width*t.height;a<o;a++)r[a*3]=t.data[a*i],r[a*3+1]=t.data[a*i+1],r[a*3+2]=t.data[a*i+2];return n}function H_(e,t,n){if(e.length!==4||e.some(u=>!Number.isFinite(u[0])||!Number.isFinite(u[1])))return!1;let r=0;for(let u=0;u<4;u++){const[l,d]=e[u],[p,h]=e[(u+1)%4];r+=l*h-p*d}const i=Math.abs(r/2)/(t*n);if(i<F_||i>G_)return!1;const a=e.map((u,l)=>{const d=e[(l+1)%4];return Math.hypot(d[0]-u[0],d[1]-u[1])}),o=Math.min(...a);if(o<1)return!1;const s=Math.max(...a)/o;return s>=U_&&s<=L_}function j_(e,t,n){const r=e[2][0]*t+e[2][1]*n+e[2][2];return[(e[0][0]*t+e[0][1]*n+e[0][2])/r,(e[1][0]*t+e[1][1]*n+e[1][2])/r]}function K_(e,t,n,r){const i=n.width,a=n.height,o=Math.max(8,Math.trunc(uo*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=r.map(W=>[W[0],W[1],W[2]-o*(W[0]+W[1])+0]);for(let W=0;W<3;W++)l[W][2]=r[W][2]-o*r[W][0]-o*r[W][1];const d=pt(e,t),p=new e.Mat,h=e.matFromArray(3,3,e.CV_64F,l.flat());e.warpPerspective(d,p,h,new e.Size(s,u),e.WARP_INVERSE_MAP);const m=new e.Mat;e.cvtColor(p,m,e.COLOR_RGB2Lab),d.delete(),h.delete();const g=m.data,y=Math.max(4,Math.trunc(o/3)),w=[[],[],[]],b=(W,V)=>{const O=(V*s+W)*3;w[0].push(g[O]),w[1].push(g[O+1]),w[2].push(g[O+2])};for(let W=0;W<u;W++)for(let V=0;V<s;V++)(W<y||W>=u-y||V<y||V>=s-y)&&b(V,W);const x=W=>{W.sort((O,F)=>O-F);const V=W.length>>1;return W.length%2?W[V]:(W[V-1]+W[V])/2},S=[x(w[0]),x(w[1]),x(w[2])],v=(W,V)=>{const O=(V*s+W)*3,F=g[O]-S[0],K=g[O+1]-S[1],Q=g[O+2]-S[2];return Math.sqrt(F*F+K*K+Q*Q)>V_},T=Math.max(6,Math.trunc(om*i)),M=Math.max(6,Math.trunc(om*a)),k=Math.max(2,Math.trunc(sm*i)),E=Math.max(2,Math.trunc(sm*a)),R=W=>{let V=0,O=0;for(const F of W)O=F?O+1:0,O>V&&(V=O);return V/Math.max(1,W.length)},P=W=>{let V,O,F,K,Q;if(W==="L"?(V=o,O=o+a,F=Math.max(0,o-k-T),K=Math.max(0,o-k),Q=!1):W==="R"?(V=o,O=o+a,F=o+i+k,K=Math.min(s,o+i+k+T),Q=!1):(V=Math.max(0,o-E-M),O=Math.max(0,o-E),F=o,K=o+i,Q=!0),O<=V||K<=F)return 0;const ue=[];if(Q)for(let L=F;L<K;L++){let B=0;for(let A=V;A<O;A++)v(L,A)&&B++;ue.push(B/(O-V)>um)}else for(let L=V;L<O;L++){let B=0;for(let A=F;A<K;A++)v(A,L)&&B++;ue.push(B/(K-F)>um)}return R(ue)},X={L:P("L"),R:P("R"),T:P("T")};return p.delete(),m.delete(),X}const Y_=.5;function X_(e){return e!==null&&e.R>=lm?["R"]:[]}function cm(e,t){if(e.length<4||t.length===0)return null;const n=e.map(y=>[y[0],y[1]]),r=Math.hypot(n[1][0]-n[0][0],n[1][1]-n[0][1]),i=Math.hypot(n[2][0]-n[3][0],n[2][1]-n[3][1]),a=.5*(r+i),o=uo*a;if(!(o>0))return null;const s=n.reduce((y,w)=>y+w[0],0)/n.length,u=n.reduce((y,w)=>y+w[1],0)/n.length,l={T:[0,1],R:[1,2],L:[0,3]},d=[...n];for(const y of["L","R","T"]){if(!t.includes(y))continue;const[w,b]=l[y],x=n[w],S=n[b];let v=-(S[1]-x[1]),T=S[0]-x[0];const M=(x[0]+S[0])/2,k=(x[1]+S[1])/2;v*(M-s)+T*(k-u)<0&&(v=-v,T=-T);const E=Math.hypot(v,T);E<=1e-6||(v=v/E*o,T=T/E*o,d.push([x[0]+v,x[1]+T],[S[0]+v,S[1]+T]))}const p=d.map(y=>y[0]),h=d.map(y=>y[1]),m=Math.round(Math.min(...p)),g=Math.round(Math.min(...h));return{x:m,y:g,width:Math.round(Math.max(...p))-m,height:Math.round(Math.max(...h))-g}}const Q_=.88;function dm(e,t,n,r){if(r.length!==4)return null;const i=n.width,a=n.height,o=Math.max(8,Math.trunc(uo*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=o+Math.trunc(i*Q_),d=s-l;if(d<1)return null;const p=pt(e,t),h=e.matFromArray(4,1,e.CV_32FC2,[0,0,i,0,i,a,0,a]),m=e.matFromArray(4,1,e.CV_32FC2,[r[0][0],r[0][1],r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]),g=e.getPerspectiveTransform(h,m),y=[...g.data64F],w=[0,1,2].flatMap(k=>[y[k*3],y[k*3+1],y[k*3+2]-o*y[k*3]-o*y[k*3+1]]),b=e.matFromArray(3,3,e.CV_64F,w),x=new e.Mat;e.warpPerspective(p,x,b,new e.Size(s,u),e.WARP_INVERSE_MAP);const S=x.roi(new e.Rect(l,0,d,u)),v=new e.Mat;S.copyTo(v);const T=v.data,M=new Uint8ClampedArray(d*u*3);M.set(T.subarray(0,M.length));for(const k of[p,h,m,g,b,x,S,v])try{k.delete()}catch{}return{width:d,height:u,channels:3,data:M}}function Z_(e,t,n,r){const[i,a,o,s]=r;if(o<8||s<8)return null;const u=Math.trunc(.06*o),l=Math.trunc(.06*s),d=Math.max(0,Math.trunc(i-u)),p=Math.min(n.width,Math.trunc(i+o+u)),h=Math.max(0,Math.trunc(a-l)),m=Math.min(n.height,Math.trunc(a+s+l));if(p-d<8||m-h<8)return null;const g=Math.max(n.width,n.height)<W_?q_:1,y=pt(e,n),w=pt(e,t),b=y.roi(new e.Rect(d,h,p-d,m-h)),x=new e.Mat;g!==1?e.resize(b,x,new e.Size(0,0),g,g,e.INTER_CUBIC):b.copyTo(x);const S=new e.Mat,v=new e.Mat;e.cvtColor(w,S,e.COLOR_RGB2GRAY),e.cvtColor(x,v,e.COLOR_RGB2GRAY);const T=new e.ORB(B_),M=new e.KeyPointVector,k=new e.KeyPointVector,E=new e.Mat,R=new e.Mat,P=new e.Mat,X=[y,w,b,x,S,v,M,k,E,R,P],W=re=>{for(const te of X)try{te.delete()}catch{}try{T.delete()}catch{}return re};if(T.detectAndCompute(S,P,M,E),T.detectAndCompute(v,P,k,R),E.rows<8||R.rows<8)return W(null);const V=new e.BFMatcher(e.NORM_HAMMING),O=new e.DMatchVectorVector;V.knnMatch(E,R,O,2);const F=[],K=[];for(let re=0;re<O.size();re++){const te=O.get(re);if(te.size()===2){const Y=te.get(0),J=te.get(1);if(Y.distance<P_*J.distance){const ae=M.get(Y.queryIdx).pt,pe=k.get(Y.trainIdx).pt;F.push(ae.x,ae.y),K.push(pe.x,pe.y)}}}if(O.delete(),V.delete(),F.length/2<8)return W(null);const Q=e.matFromArray(F.length/2,1,e.CV_32FC2,F),ue=e.matFromArray(K.length/2,1,e.CV_32FC2,K),L=new e.Mat,B=e.findHomography(Q,ue,e.RANSAC,5,L);let A=0;for(let re=0;re<L.rows;re++)A+=L.data[re];const N=B.rows===3?[...B.data64F]:null;if(Q.delete(),ue.delete(),L.delete(),B.delete(),N===null||A<D_)return W(null);const D=1/g,U=[[D,0,d],[0,D,h],[0,0,1]],j=[0,1,2].map(re=>[0,1,2].map(te=>U[re][0]*N[te]+U[re][1]*N[3+te]+U[re][2]*N[6+te]));return W({H:j,inliers:A})}const J_=620;function eb(e,t){return{width:t.cols,height:t.rows,channels:3,data:new Uint8Array(t.data.slice(0,t.rows*t.cols*3))}}function tb(e,t,n,r){const i=pm(e,t,n,r);if(i!==null)return i;try{const[a,o,s,u]=r.map(T=>Math.trunc(T));if(Math.min(s,u)>=J_||s<=0||u<=0)return null;const l=Math.trunc(s*.25),d=Math.trunc(u*.25),p=Math.max(0,a-l),h=Math.max(0,o-d),m=Math.min(t.width,a+s+l),g=Math.min(t.height,o+u+d);if(m<=p||g<=h)return null;const y=pt(e,t),w=y.roi(new e.Rect(p,h,m-p,g-h)),b=new e.Mat;e.resize(w,b,new e.Size((m-p)*2,(g-h)*2),0,0,e.INTER_CUBIC);const x=eb(e,b);for(const T of[y,w,b])try{T.delete()}catch{}const S=[(a-p)*2,(o-h)*2,s*2,u*2],v=pm(e,x,n,S);return v===null?null:{...v,footprint:v.footprint.map(([T,M])=>[T*.5+p,M*.5+h])}}catch{return null}}function pm(e,t,n,r){const i=Z_(e,n,t,r);if(i===null)return null;const o=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([b,x])=>j_(i.H,b,x));if(!H_(o,t.width,t.height))return null;const s=pt(e,t),u=e.matFromArray(3,3,e.CV_64F,i.H.flat()),l=new e.Mat;e.warpPerspective(s,l,u,new e.Size(n.width,n.height),e.WARP_INVERSE_MAP);const d=pt(e,n),p=new e.Mat,h=new e.Mat;e.cvtColor(l,p,e.COLOR_RGB2GRAY),e.cvtColor(d,h,e.COLOR_RGB2GRAY);const m=new e.Mat;e.matchTemplate(p,h,m,e.TM_CCOEFF_NORMED);const g=m.data32F[0];for(const b of[s,u,l,d,p,h,m])try{b.delete()}catch{}if(g<Y_)return null;const y=K_(e,t,n,i.H);if(y===null)return null;const w=X_(y);return{built:Math.max(y.L,y.R,y.T)>=lm,footprint:o,overflow:w,edgeScores:y,inliers:i.inliers}}const nb=.3,rb=.3;function ib(e,t){const n=e.filter(a=>a.edgeScores!==null);if(n.length===0)return[];const r=n.length>=2&&n.every(a=>{const{L:o,R:s,T:u}=a.edgeScores;return Math.min(o,s,u)>=nb}),i=[];return e.forEach((a,o)=>{if(!a.built||a.edgeScores===null)return;const{L:s,R:u,T:l}=a.edgeScores,d=Math.max(s,u,l)<rb;if(!r&&!d)return;t.some(([h,m])=>h>=a.zone.x0&&h<=a.zone.x1&&m>=a.zone.y0&&m<=a.zone.y1)||i.push(o)}),i}const Nt=128,Ln=.5;function lo(e){const t=Dn(e,Nt,Nt),n=Nt*Nt,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function hm(e){const t=e[1]??0;return{built:t>=Ln,prob:t}}const cr=120,dr=179,ab=1.3,ob=3.6,sb=.45,ub=6e-4,lb=.02,cb=6e3,db=.78,pb=1.25,hb=2.4,fb=.05,mb=1.5,gb=.5,yb=.9,wb=150,_b=18,bb=34,$b=90,xb=130,vb=.13,Sb=.15,Vr="magistrates-guild",co="merchants-guild";function Tb(e,t){const n=pt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2HSV),n.delete();const i=new e.Mat(r.rows,r.cols,r.type(),[cr,30,40,0]),a=new e.Mat(r.rows,r.cols,r.type(),[dr,255,205,255]),o=new e.Mat;e.inRange(r,i,a,o),r.delete(),i.delete(),a.delete();const s=new Uint8Array(o.data),u=e.getStructuringElement(e.MORPH_RECT,new e.Size(31,31)),l=new e.Mat;e.morphologyEx(o,l,e.MORPH_CLOSE,u),o.delete(),u.delete();const d=new e.Mat,p=new e.Mat,h=new e.Mat,m=e.connectedComponentsWithStats(l,d,p,h,8);l.delete(),d.delete(),h.delete();const g=t.width*t.height,y=[];for(let w=1;w<m;w++){const b=p.intAt(w,0),x=p.intAt(w,1),S=p.intAt(w,2),v=p.intAt(w,3),T=p.intAt(w,4),M=T/g;M<ub||M>lb||T/Math.max(S*v,1)<sb||y.push({x:b,y:x,w:S,h:v})}return p.delete(),{blobs:y,mask:s,maskWidth:t.width}}function Eb(e,t,n,r,i,a,o){const s=e,u=a,l=o,d=i;if(!d.gray){const D=pt(e,r);d.gray=new s.Mat,s.cvtColor(D,d.gray,s.COLOR_RGB2GRAY),D.delete(),d.k=new s.KeyPointVector,d.d=new s.Mat;const U=new s.Mat;u.detectAndCompute(d.gray,U,d.k,d.d),U.delete()}const p=n,h=new s.Mat,m=new s.KeyPointVector,g=new s.Mat;u.detectAndCompute(p,h,m,g),h.delete();const y=D=>(m.delete(),g.delete(),D);if(d.d.rows<8||g.rows<8)return y(null);const w=new s.DMatchVectorVector;l.knnMatch(d.d,g,w,2);const b=[],x=[];for(let D=0;D<w.size();D++){const U=w.get(D);if(U.size()===2){const j=U.get(0);if(j.distance<db*U.get(1).distance){const re=d.k.get(j.queryIdx).pt,te=m.get(j.trainIdx).pt;b.push(re.x,re.y),x.push(te.x,te.y)}}}if(w.delete(),b.length/2<8)return y(null);const S=s.matFromArray(b.length/2,1,s.CV_32FC2,b),v=s.matFromArray(x.length/2,1,s.CV_32FC2,x),T=new s.Mat,M=s.findHomography(S,v,s.RANSAC,5,T);if(S.delete(),v.delete(),T.delete(),M.rows!==3)return M.delete(),y(null);const k=[...M.data64F],E=(D,U)=>{const j=k[6]*D+k[7]*U+k[8];return[(k[0]*D+k[1]*U+k[2])/j,(k[3]*D+k[4]*U+k[5])/j]},R=[[0,0],[r.width,0],[r.width,r.height],[0,r.height]].map(([D,U])=>E(D,U));if(R.some(D=>!Number.isFinite(D[0])||!Number.isFinite(D[1])))return M.delete(),y(null);const P=R.map((D,U)=>{const j=R[(U+1)%4];return Math.hypot(j[0]-D[0],j[1]-D[1])}),X=Math.min(...P);if(X<1)return M.delete(),y(null);const W=Math.max(...P)/X;let V=0;for(let D=0;D<4;D++){const[U,j]=R[D],[re,te]=R[(D+1)%4];V+=U*te-re*j}const O=t,F=Math.abs(V/2)/(O.rows*O.cols);if(W<pb||W>hb||F<fb||F>mb)return M.delete(),y(null);const K=new s.Mat;s.warpPerspective(O,K,M,new s.Size(r.width,r.height),s.WARP_INVERSE_MAP),M.delete();const Q=new s.Mat;s.cvtColor(K,Q,s.COLOR_RGB2GRAY),K.delete();const ue=Math.trunc(r.height/2),L=Q.roi(new s.Rect(0,0,r.width,ue)),B=d.gray.roi(new s.Rect(0,0,r.width,ue)),A=new s.Mat;s.matchTemplate(L,B,A,s.TM_CCOEFF_NORMED);const N=A.data32F[0];return L.delete(),B.delete(),A.delete(),Q.delete(),y(N)}function Ib(e,t,n){let r,i;if(n===Vr)r=co,i=vb;else if(n===co)r=Vr,i=Sb;else return null;const{x:a,y:o,w:s,h:u}=t;if(s<8||u<8)return null;const l=Math.trunc(s/2);let d=0,p=null;for(const[h,m]of[[0,l],[l,s]]){let g=0,y=0;for(let b=o;b<o+u;b++)for(let x=a+h;x<a+m;x++){const S=(b*e.width+x)*e.channels,{h:v,s:T,v:M}=Et(e.data[S],e.data[S+1],e.data[S+2]);if(v>=cr&&v<=dr&&T>=30&&T<=170&&M<=170)continue;g++,(r===co?v>=_b&&v<=bb&&T>=$b&&M>=xb:v>=95&&v<=130&&T>=80)&&y++}if(g<20)continue;const w=y/g;w>d&&(d=w,p={x:a+h,y:o,w:m-h,h:u})}return d>=i&&p!==null?{id:r,box:p}:null}const Mb=1.7,kb=140,Cb=170,Ab=.2,Rb=.1,fm=240,mm=80,gm=60,Ob=50,ym="scientists-guild",wm="tacticians-guild",Hr=["shipowners-guild","merchants-guild","builders-guild","moneylenders-guild"];function Nb(e,t,n){const{x:r,y:i,w:a,h:o}=n,s=new Float32Array(o);for(let v=0;v<o;v++){let T=0;for(let M=0;M<a;M++)e[(i+v)*t+r+M]>0&&T++;s[v]=T/a}const u=[];for(let v=0;v<o;v++)s[v]>.3&&u.push(v);if(u.length<5)return[];const l=u[0],d=u[u.length-1],p=d-l;if(p<5)return[];const h=a/p;if(h<ab||h>ob)return[];if(h>=Mb)return[{x:r,y:i+l,w:a,h:p}];const m=new Float32Array(o),g=.3*(8*.5-1)+.8,y=[];let w=0;for(let v=-4;v<=4;v++){const T=Math.exp(-(v*v)/(2*g*g));y.push(T),w+=T}for(let v=0;v<o;v++){let T=0;for(let M=-4;M<=4;M++){const k=Math.min(o-1,Math.max(0,v+M));T+=s[k]*y[M+4]}m[v]=T/w}const b=l+Math.trunc(p*.3),x=l+Math.trunc(p*.78);let S=l+Math.trunc(p/2);if(x>b){let v=1/0;for(let T=b;T<x;T++)m[T]<v&&(v=m[T],S=T)}return[{x:r,y:i+l,w:a,h:S-l},{x:r,y:i+S,w:a,h:d-S}]}function zb(e,t){const n=Math.max(0,t.x),r=Math.max(0,t.y),i=Math.min(e.width,t.x+t.w),a=Math.min(e.height,t.y+t.h),o=Math.max(0,i-n),s=Math.max(0,a-r),u=new Uint8Array(o*s*3);for(let l=0;l<s;l++)for(let d=0;d<o;d++){const p=((r+l)*e.width+n+d)*e.channels,h=(l*o+d)*3;u[h]=e.data[p],u[h+1]=e.data[p+1],u[h+2]=e.data[p+2]}return{width:o,height:s,channels:3,data:u}}function Bb(e){let t=0,n=0;for(let r=0,i=e.width*e.height;r<i;r++){const a=r*e.channels,{h:o,s,v:u}=Et(e.data[a],e.data[a+1],e.data[a+2]);s>=40&&u>=40&&u<=205&&(t++,o>=kb&&o<=Cb&&n++)}return t===0?0:n/t}function Pb(e){let t=0;const n=e.width*e.height;for(let r=0;r<n;r++){const i=r*e.channels,{h:a,s:o,v:s}=Et(e.data[i],e.data[i+1],e.data[i+2]);!(a>=cr&&a<=dr)&&o>=70&&s>=50&&t++}return n===0?0:t/n}function _m(e,t){const n=pt(e,t),r=new e.Mat;e.resize(n,r,new e.Size(fm,mm),0,0,e.INTER_AREA),n.delete();const i=new Uint8Array(r.data);return r.delete(),{width:fm,height:mm,channels:3,data:i}}function Db(e){const t=e.width*e.height,n=[0,0,0];for(let a=0;a<t;a++){const o=a*e.channels;n[0]+=e.data[o],n[1]+=e.data[o+1],n[2]+=e.data[o+2]}n[0]/=t,n[1]/=t,n[2]/=t;const r=(n[0]+n[1]+n[2])/3,i=new Uint8Array(t*3);for(let a=0;a<t;a++){const o=a*e.channels;for(let s=0;s<3;s++){const u=n[s]>1e-6?r/n[s]:1;i[a*3+s]=Math.max(0,Math.min(255,Math.round(e.data[o+s]*u)))}}return{width:e.width,height:e.height,channels:3,data:i}}function bm(e,t){const n=Db(t),r=n.width*n.height,i=new Uint8Array(r);let a=0;for(let g=0;g<r;g++){const y=g*3,{h:w,s:b,v:x}=Et(n.data[y],n.data[y+1],n.data[y+2]);!(w>=cr&&w<=dr&&b>=30&&b<=170&&x<=170)&&x>=40&&(i[g]=1,a++)}const o=a<20,s=pt(e,n),u=new e.Mat;e.cvtColor(s,u,e.COLOR_RGB2Lab),s.delete();const l=u.data;let d=0,p=0,h=0,m=0;for(let g=0;g<r;g++)!o&&i[g]===0||(d+=l[g*3]*100/255,p+=l[g*3+1]-128,h+=l[g*3+2]-128,m++);return u.delete(),m===0?[0,0,0]:[d/m,p/m,h/m]}function Ub(e){let t=0,n=0,r=0,i=0,a=0;const o=e.width*e.height;for(let u=0;u<o;u++){const l=u*e.channels,{h:d,s:p,v:h}=Et(e.data[l],e.data[l+1],e.data[l+2]);d>=cr&&d<=dr&&p>=30&&p<=170&&h<=170||(t++,p>=70&&h>=50&&(d>=95&&d<=130?n++:d>=35&&d<=92?r++:d<=10?i++:d>=15&&d<=34&&h>=80&&a++))}const s=Math.max(t,1);return{blue:n/s,green:r/s,red:i/s,gold:a/s}}function Lb(e){const t=e.width*e.height,n={blue:0,green:0,red:0,gold:0,brown:0,grey:0};for(let r=0;r<t;r++){const i=r*e.channels,{h:a,s:o,v:s}=Et(e.data[i],e.data[i+1],e.data[i+2]);o>=gm&&s>=Ob?(a>=95&&a<=128&&n.blue++,a>=35&&a<=85&&n.green++,(a<=8||a>=170)&&n.red++,a>=18&&a<=34&&n.gold++,a>=4&&a<=17&&s<150&&n.brown++):o<gm&&s>=70&&s<=235&&n.grey++}for(const r of Object.keys(n))n[r]/=t;return n}function Fb(e,t){let n=0,r=0;for(let s=0;s<e.length;s++)n+=e[s],r+=t[s];n/=e.length,r/=t.length;let i=0,a=0,o=0;for(let s=0;s<e.length;s++){const u=e[s]-n,l=t[s]-r;i+=u*l,a+=u*u,o+=l*l}return i/(Math.sqrt(a*o)+1e-6)}function $m(e,t){const n=pt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2GRAY),n.delete();const i=Float32Array.from(r.data);return r.delete(),i}function Gb(e,t){const n=new Map,r=new Map;for(const[i,a]of t){const o=_m(e,a);n.set(i,$m(e,o)),Hr.includes(i)&&r.set(i,bm(e,o))}return{gray:n,warmLab:r}}function Wb(e,t,n){const r=_m(e,t),i=Ub(r);if(i.blue>=.15&&i.blue>i.red&&i.blue>2*i.gold)return Vr;if(i.green>=.08&&i.green>i.blue&&i.green>i.gold)return ym;if(i.red>=.15&&i.red>i.blue&&i.red>1.5*i.gold)return wm;const a=Lb(r),o={blue:a.blue,green:a.green,red:a.red,gold:a.gold,browngrey:a.brown+a.grey};let s="blue";for(const l of Object.keys(o))o[l]>o[s]&&(s=l);if(o[s]<=0)return"";let u;if(s==="blue")u=Vr;else if(s==="green")u=ym;else if(s==="red")u=wm;else{const l=$m(e,r);let d="",p=-2;for(const h of Hr){const m=n.gray.get(h);if(m===void 0)continue;const g=Fb(l,m);g>p&&(p=g,d=h)}u=d||Hr[0]}if(Hr.includes(u)&&n.warmLab.size>0){const l=bm(e,r);let d=u,p=1/0;for(const[h,m]of n.warmLab){const g=Math.hypot(l[0]-m[0],l[1]-m[1],l[2]-m[2]);g<p&&(p=g,d=h)}return d}return u}function qb(e,t,n,r,i){var y;const a=[],{blobs:o,mask:s,maskWidth:u}=Tb(e,t);if(o.length===0||n.size===0)return a;const l=e,d=new l.ORB(cb),p=new l.BFMatcher(l.NORM_HAMMING),h=new Map;for(const w of n.keys())h.set(w,{});const m=pt(e,t);let g=null;try{for(const w of o){if(r!==void 0&&Date.now()>r)break;const b=w.x+Math.trunc(w.w/2),x=w.y+Math.trunc(w.h/2),S=Math.max(wb,Math.trunc(yb*Math.max(w.w,w.h))),v=Math.max(0,b-S),T=Math.max(0,x-S),M=Math.min(t.width,b+S),k=Math.min(t.height,x+S);if(M-v<16||k-T<16)continue;const E=m.roi(new l.Rect(v,T,M-v,k-T)),R=new l.Mat;l.cvtColor(E,R,l.COLOR_RGB2GRAY);let P=null,X=-2;for(const[F,K]of n){if(r!==void 0&&Date.now()>r)break;const Q=Eb(e,E,R,K,h.get(F),d,p);Q!==null&&Q>X&&(X=Q,P=F)}E.delete(),R.delete();const W=new Set;if(P!==null&&X>=gb){a.push({id:P,boundingBox:{x:w.x,y:w.y,width:w.w,height:w.h},confidence:1}),W.add(P);const F=Ib(t,w,P);F&&(a.push({id:F.id,boundingBox:{x:F.box.x,y:F.box.y,width:F.box.w,height:F.box.h},confidence:.9}),W.add(F.id))}if(i===void 0||i.size===0)continue;const V=Nb(s,u,w);if(V.length!==2)continue;const O=V.map(F=>zb(t,F));if(!O.some(F=>F.width*F.height===0||Pb(F)<Rb))for(let F=0;F<V.length;F++){const K=O[F];if(Bb(K)<Ab)continue;g===null&&(g=Gb(e,i));const Q=Wb(e,K,g);if(Q&&!W.has(Q)){W.add(Q);const ue=V[F];a.push({id:Q,boundingBox:{x:ue.x,y:ue.y,width:ue.w,height:ue.h},confidence:1})}}}}finally{m.delete();for(const w of h.values()){const b=w;for(const x of["gray","k","d"])try{(y=b[x])==null||y.delete()}catch{}}try{d.delete(),p.delete()}catch{}}return a}const xm=128,Vb=.56,Hb=15,jb=.58,Kb=70,Yb=50,Xb=.12,Qb=.2,Zb=.1,Jb=.17,vm=.15;function e1(e){const t=new Map;for(const[n,r]of Object.entries(e.templates)){const i=Uint8Array.from(atob(r),a=>a.charCodeAt(0));i.length===e.size*e.size&&t.set(n,i)}return t}function Sm(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(n/2),s=Math.floor(r/2),u=Math.trunc(Math.min(n,r)*.5*t);if(u<1)return e;const l=Math.max(0,o-u),d=Math.max(0,s-u),p=Math.min(n,o+u),h=Math.min(r,s+u),m=p-l,g=h-d,y=new Uint8Array(m*g*i);for(let w=0;w<g;w++){const b=((w+d)*n+l)*i;y.set(a.subarray(b,b+m*i),w*m*i)}return{width:m,height:g,channels:i,data:y}}function t1(e){const t=Sm(e,Vb),n=m_(t),r=nm(n,xm,xm);return g_(r)}function n1(e,t){const n=e.length;let r=0,i=0;for(let u=0;u<n;u++)r+=e[u],i+=t[u];r/=n,i/=n;let a=0,o=0,s=0;for(let u=0;u<n;u++){const l=e[u]-r,d=t[u]-i;a+=l*d,o+=l*l,s+=d*d}return a/(Math.sqrt(o*s)+1e-6)}function r1(e){const t=new Map([["masonry",0],["strategy",0]]),n=Sm(e,jb),{width:r,height:i,channels:a,data:o}=n,s=r*i||1;let u=0,l=0;for(let h=0;h<r*i;h++){const m=h*a,{h:g,s:y,v:w}=Et(o[m],o[m+1],o[m+2]);y>=Kb&&w>=Yb&&(g>=95&&g<=130&&(u+=1),(g<=8||g>=170)&&(l+=1))}const d=u/s,p=l/s;return d>=Xb&&t.set("masonry",vm*Math.min(1,d/Qb)),p>=Zb&&t.set("strategy",vm*Math.min(1,p/Jb)),t}function i1(e,t){if(t.size===0||e.width===0||e.height===0)return["",0];const n=t1(e);let r=0;for(const l of n.data)r+=l;const i=r/n.data.length,a=[];for(let l=0;l<360;l+=Hb)a.push(__(n,l,i));const o=new Map;for(const[l,d]of t){let p=-1/0;for(const h of a){const m=n1(h,d);m>p&&(p=m)}o.set(l,p)}for(const[l,d]of r1(e))d>0&&o.has(l)&&o.set(l,o.get(l)+d);let s="",u=-1/0;for(const[l,d]of o)d>u&&(s=l,u=d);return[s,u]}const an=224,a1=512,o1=[.485,.456,.406],s1=[.229,.224,.225];function u1(e){const t=atob(e.x),n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);const r=new Float32Array(n.buffer);if(r.length!==e.ids.length*e.dim)throw new Error(`token_embed_index: ${r.length} floats != ${e.ids.length}x${e.dim}`);return{dim:e.dim,ids:e.ids,x:r}}function l1(e){const t=ro(e,an,an),n=an*an,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=(t[i*3+a]/255-o1[a])/s1[a];return r}function c1(e){const t=3*an*an,n=new Float32Array(4*t);for(let r=0;r<4;r++)n.set(l1(rn(e,r)),r*t);return n}function d1(e,t=a1){const n=e.length/t,r=new Float32Array(t);for(let a=0;a<n;a++)for(let o=0;o<t;o++)r[o]+=e[a*t+o];let i=0;for(let a=0;a<t;a++)r[a]/=n,i+=r[a]*r[a];i=Math.max(Math.sqrt(i),1e-9);for(let a=0;a<t;a++)r[a]/=i;return r}function p1(e,t){let n=0,r=-2;for(let i=0;i<e.ids.length;i++){let a=0;const o=i*e.dim;for(let s=0;s<e.dim;s++)a+=e.x[o+s]*t[s];a>r&&(r=a,n=i)}return{id:e.ids[n],cosine:r}}const Fn=96,h1=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"],f1=.45;function m1(e){const t=ro(e,Fn,Fn),n=Fn*Fn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function g1(e){let t=0;for(let r=1;r<e.length;r++)e[r]>e[t]&&(t=r);const n=e[t];return{id:n>=f1?h1[t]??"":"",prob:n}}const jt=128,y1=["circus-maximus","piraeus","the-appian-way","the-colossus","the-great-library","the-great-lighthouse","the-hanging-gardens","the-mausoleum","the-pyramids","the-sphinx","the-statue-of-zeus","the-temple-of-artemis","other"],w1=.5;let Tm=null;function _1(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError(`seuil merveilles hors bornes : ${e}`);Tm=e}function Em(){return Tm??w1}let Im=null;function b1(e){if(!Array.isArray(e)||e.length===0||!e.includes("other"))throw new RangeError("classes merveilles invalides (liste vide ou sans `other`)");Im=[...e]}function $1(){return Im??y1}const Mm="__inverse";function x1(e){return e.endsWith(Mm)?[e.slice(0,-Mm.length),!0]:[e,!1]}function v1(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n*3);for(let o=0;o<t*n;o++)for(let s=0;s<3;s++)a[o*3+s]=i[o*r+s];return a}function S1(e){const t=Math.min(jt/e.width,jt/e.height),n=Math.max(1,Math.round(e.width*t)),r=Math.max(1,Math.round(e.height*t)),i=n===e.width&&r===e.height?v1(e):t<1?Dn(e,n,r):sr(e,n,r),a=jt*jt,o=new Float32Array(3*a);o.fill(114/255);const s=Math.floor((jt-r)/2),u=Math.floor((jt-n)/2);for(let l=0;l<r;l++)for(let d=0;d<n;d++){const p=(l*n+d)*3,h=(l+s)*jt+(d+u);for(let m=0;m<3;m++)o[m*a+h]=i[p+m]/255}return o}async function T1(e,t){const{index:n,prob:r}=E1(await t(S1(e))),[i,a]=x1($1()[n]??"");return r<Em()||i==="other"||i===""?{id:"",prob:r,inverse:!1}:{id:i,prob:r,inverse:a}}function E1(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{index:t,prob:e[t]}}const zt=96,I1=[1,2,3,4,5,6,7],M1=.8,k1=.99;function C1(e){const t=sr(e,e.width*2,e.height*2),n=e.width*2<zt&&e.height*2<zt,r={width:e.width*2,height:e.height*2,channels:3,data:t},i=n?sr(r,zt,zt):Dn(r,zt,zt),a=zt*zt,o=new Float32Array(3*a);for(let s=0;s<a;s++)for(let u=0;u<3;u++)o[u*a+s]=i[s*3+u]/255;return o}function A1(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{value:I1[t],prob:e[t]}}const on=128,km=.35,R1=["fp","laurel"],O1=.85,Gn=40;function N1(e){const r=(e.width<on&&e.height<on?sr:Dn)(e,on,on),i=on*on,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function z1(e){return e[R1.indexOf("fp")]}const sn=128,B1=.15,Cm=["blue","brown","green","grey","purple","red","yellow","tuile_militaire","dos_de_carte","livret_de_regles","objet_hors_jeu"],P1=7,D1=.9;function U1(e,t,n){const[r,i,a,o]=e.map(Number);if(!(a>1)||!(o>1))return null;const s=r+a/2,u=i+o/2,l=Math.max(a,o)*(1+2*B1),d=Math.max(0,it(s-l/2)),p=Math.max(0,it(u-l/2)),h=Math.min(t,it(s+l/2)),m=Math.min(n,it(u+l/2));return h-d<8||m-p<8?null:{x:d,y:p,w:h-d,h:m-p}}function L1(e){const r=(e.width<sn&&e.height<sn?sr:Dn)(e,sn,sn),i=sn*sn,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function F1(e){let t=0;for(let i=1;i<Cm.length;i++)e[i]>e[t]&&(t=i);const n=e[t],r=t>=P1;return{className:Cm[t],probability:n,rejected:r&&n>=D1}}const jr=3,G1=2.2,W1=.3,q1=.65,V1=3,H1=1.3,j1=.77;function Am(e,t,n){const[r,i,a,o]=e,s=[];return r<=jr&&s.push("gauche"),i<=jr&&s.push("haut"),r+a>=t-jr&&s.push("droit"),i+o>=n-jr&&s.push("bas"),s}function Rm(e){const t=e[3]/Math.max(e[2],1);return t>=H1?"portrait":t<=j1?"paysage":null}function po(e){const t=[...e].sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function K1(e,t,n){for(const[r,i,a,o]of e??[])if(Math.max(Math.abs(a-r)/Math.max(t,1),Math.abs(o-i)/Math.max(n,1))>q1)return!0;return!1}function Y1(e,t,n,r,i){try{const a=[...e],o=a.filter(w=>Am(w.box,r,i).length>0);if(o.length===0)return{kept:a,dropped:[],suspects:[]};const s=a.filter(w=>!o.includes(w)),u=w=>({kept:s,dropped:o.map(b=>({banner:b,edgeReason:w})),suspects:[]});if(K1(n,r,i))return u("photo-piste");if(s.length<V1)return t>0?u("photo-merveilles"):{kept:a,dropped:[],suspects:o.map(w=>({family:w.family,color:w.color,box:w.box,reason:"bord-sans-scene"}))};if(o.length>(s.length+o.length)/3)return u("debordement-structurel");const l=po(s.map(w=>w.box[2]*w.box[3])),d=po(s.map(w=>w.box[2])),p=po(s.map(w=>w.box[3])),h=new Set(s.map(w=>Rm(w.box)).filter(w=>w!==null)),m=[...s],g=[],y=[];for(const w of o){const b=Am(w.box,r,i),[,,x,S]=w.box,v=l>0?x*S/l:0,T=[];(b.includes("gauche")||b.includes("droit"))&&T.push(d>0?x/d:1),(b.includes("haut")||b.includes("bas"))&&T.push(p>0?S/p:1);const M=T.length>0?Math.min(...T):1,k=Rm(w.box);v>G1?g.push({banner:w,edgeReason:"bord-grosse"}):M<W1?g.push({banner:w,edgeReason:"bord-tronquee"}):k!==null&&h.size>0&&!h.has(k)?g.push({banner:w,edgeReason:"bord-orientation-adverse"}):(m.push(w),y.push({family:w.family,color:w.color,box:w.box,reason:"tronquee-par-le-bord"}))}return{kept:m,dropped:g,suspects:y}}catch{return{kept:[...e],dropped:[],suspects:[]}}}const X1=1,Q1=1.5;function Z1(e){return e.length<4?[]:[[e[0],e[1]],[e[1],e[2]],[e[2],e[3]],[e[3],e[0]]]}function J1(e,t,n,r){const i=r[0]-n[0],a=r[1]-n[1],o=Math.hypot(i,a);if(o<=0)return null;const s=((e-n[0])*i+(t-n[1])*a)/(o*o);return[Math.abs((e-n[0])*a-(t-n[1])*i)/o,Math.abs(s-.5)*o]}function e2(e){if(e.length===0)return null;const t=e.map(r=>r[0]),n=e.map(r=>r[1]);return Math.max(...t)-Math.min(...t)>Math.max(...n)-Math.min(...n)}function t2(e,t,n){try{const r=Number(n);if(!(r>0)||e.length<4||t.length<4)return null;const[i,a,o,s]=t,u=i+o/2,l=a+s/2;let d=null;for(const[h,m]of Z1(e)){const g=J1(u,l,h,m);g!==null&&(d===null||g[0]<d[0])&&(d=g)}if(d===null)return null;const p=e2(e);return p===null?null:{distBord:d[0]/r,decalLat:d[1]/r,perpendiculaire:p!==o>s}}catch{return null}}function n2(e,t,n,r=X1,i=Q1){const a=[];for(const[o,s]of t??[]){const u=t2(e,s,n);u!==null&&u.perpendiculaire&&(u.decalLat>r||u.distBord>i||a.push([u.decalLat,o]))}return a.length===0?null:(a.sort((o,s)=>o[0]-s[0]||o[1]-s[1]),a[0][1])}const gt=64,Om=.5,r2=[.67,1.24];function Nm(e,t,n,r){const i=Math.max(0,t-r),a=Math.max(0,n-r),o=Math.min(e.width,t+r),s=Math.min(e.height,n+r),u=o-i,l=s-a;if(u<=0||l<=0)return null;const d=e.channels,p=new Uint8ClampedArray(u*l*3),h=r*r;for(let w=0;w<l;w++){const b=a+w,x=b-n;for(let S=0;S<u;S++){const v=i+S,T=v-t,M=(w*u+S)*3;if(T*T+x*x<=h){const k=(b*e.width+v)*d;p[M]=e.data[k],p[M+1]=e.data[k+1],p[M+2]=e.data[k+2]}else p[M]=255,p[M+1]=255,p[M+2]=255}}const m=Dn({width:u,height:l,channels:3,data:p},gt,gt),g=gt*gt,y=new Float32Array(3*g);for(let w=0;w<g;w++)for(let b=0;b<3;b++)y[b*g+w]=m[w*3+b]/255;return y}function i2(e){return e[1]}const Kr=[1,3,6],a2=.5;function o2(e){if(e.length!==Kr.length)return null;let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{denomination:Kr[t],prob:e[t]}}function s2(e,t){return e.map((n,r)=>{const i=t[r]??null;return i!==null&&Kr.includes(i.denomination)&&i.prob>=a2?{value:i.denomination,source:"cnn",conf:i.prob}:{value:n,source:null,conf:null}})}const u2=2.25,Yr=3,l2=1.15,c2=.5,d2=2.5,p2=.75,h2=2.25,f2=1.3,m2=.77;function Xr(e,t){const n=Math.max(0,Math.max(e[0],t[0])-Math.min(e[0]+e[2],t[0]+t[2])),r=Math.max(0,Math.max(e[1],t[1])-Math.min(e[1]+e[3],t[1]+t[3]));return Math.hypot(n,r)}function g2(e){const t=Array.from(new Map(e.map(a=>[`${a[0]},${a[1]}`,a])).values());if(t.sort((a,o)=>a[0]-o[0]||a[1]-o[1]),t.length<=2)return t;const n=(a,o,s)=>(o[0]-a[0])*(s[1]-a[1])-(o[1]-a[1])*(s[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(const a of[...t].reverse()){for(;i.length>=2&&n(i[i.length-2],i[i.length-1],a)<=0;)i.pop();i.push(a)}return[...r.slice(0,-1),...i.slice(0,-1)]}function zm(e,t,n){let r=!1;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[(a+1)%i];if(s>t!=l>t){const d=(u-o)*(t-s)/(l-s)+o;e<d&&(r=!r)}}return r}function y2(e,t,n){if(n.length>=3&&zm(e,t,n))return 0;let r=Number.POSITIVE_INFINITY;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[i>1?(a+1)%i:a],d=u-o,p=l-s,h=d*d+p*p,m=h===0?0:Math.max(0,Math.min(1,((e-o)*d+(t-s)*p)/h));r=Math.min(r,Math.hypot(e-(o+m*d),t-(s+m*p)))}return r}function w2(e,t,n){const r=Math.max(Math.abs(e-(n[0]+n[2]/2))-n[2]/2,0),i=Math.max(Math.abs(t-(n[1]+n[3]/2))-n[3]/2,0);return Math.hypot(r,i)}function _2(e,t,n){const[r,i]=e,a=t[0]-r,o=t[1]-i;if(a===0&&o===0)return!1;const[s,u,l,d]=n;let p=0,h=1;const m=[[-a,r-s],[a,l-r],[-o,i-u],[o,d-i]];for(const[g,y]of m){if(g===0){if(y<0)return!1;continue}const w=y/g;if(g<0?p=Math.max(p,w):h=Math.min(h,w),p>h)return!1}return p>=h?!1:p>=.1&&h<=.95||h-p>=.15}const ho=e=>e.box[3]/Math.max(1,e.box[2]),Kt=e=>ho(e)>l2,Wn=e=>ho(e)>=f2||ho(e)<=m2;function fo(e){const[t,n,r,i]=e.box;if(r>=i){const o=7*i;return[t,n-o,r,i+2*o]}const a=7*r;return[t-a,n,r+2*a,i]}function Bm(e,t,n,r,i){const a=new Set(t),o=[...e.map((B,A)=>({box:[B[0],B[1],B[2],B[3]],kind:a.has(A)?"card":"tucked",src:["banner",A]})),...n.map((B,A)=>({box:[B[0],B[1],B[2],B[3]],kind:"wonder",src:["wonder",A]}))],s=e.map(()=>"player"),u=n.map(()=>"player");if(o.length===0)return{bannerOwner:s,wonderOwner:u,opponentFound:!1,hulls:[],hullBoxCounts:[],pointOwner:()=>"player",pointInside:()=>"none"};const l=o.map(B=>[B.box[0]+B.box[2]/2,B.box[1]+B.box[3]/2]);let d=o.filter(B=>B.kind!=="wonder").map(B=>Math.hypot(B.box[2],B.box[3])).sort((B,A)=>B-A);d.length===0&&(d=o.map(B=>Math.hypot(B.box[2],B.box[3])).sort((B,A)=>B-A));const p=d[Math.floor(d.length/2)],h=(u2*p)**2,m=o.map((B,A)=>A),g=B=>{let A=B;for(;m[A]!==A;)m[A]=m[m[A]],A=m[A];return A},y=o.map((B,A)=>B.kind==="card"?A:-1).filter(B=>B>=0),w=o.map((B,A)=>B.kind!=="card"?A:-1).filter(B=>B>=0);for(let B=0;B<y.length;B+=1)for(let A=B+1;A<y.length;A+=1){const N=y[B],D=y[A],U=o[N],j=o[D];if(Wn(U)&&Wn(j)&&Kt(U)!==Kt(j))continue;const re=l[N][0]-l[D][0],te=l[N][1]-l[D][1],Y=re*re+te*te;let J=Y<=h;!J&&Wn(U)&&Wn(j)&&Kt(U)===Kt(j)&&Y<=(4*p)**2&&(J=Xr(fo(U),fo(j))<=.5*p),J&&(m[g(N)]=g(D))}for(let B=0;B<w.length;B+=1)for(let A=B+1;A<w.length;A+=1){const N=w[B],D=w[A];Xr(o[N].box,o[D].box)<=p2*p&&(m[g(N)]=g(D))}const b=new Map;for(const B of w){const A=g(B);b.set(A,[...b.get(A)??[],B])}const x=new Map;for(const B of y){const A=g(B);x.set(A,[...x.get(A)??[],B])}for(const B of b.values()){const A=B.filter(j=>o[j].kind==="wonder"&&Wn(o[j])).map(j=>Kt(o[j])),N=A.length>0?A.filter(Boolean).length*2>A.length:null,D=[];for(const[j,re]of x){let te=Number.POSITIVE_INFINITY;for(const ae of B)for(const pe of re)te=Math.min(te,Xr(o[ae].box,o[pe].box));if(te>h2*p)continue;const J=re.filter(ae=>Kt(o[ae])).length/re.length>=.5;N!==null&&J!==N||D.push([j,te,J])}if(D.length===0)continue;const U=new Set(D.map(j=>j[2]));if(D.length>=2&&U.size===1&&N!==null){const j=D[0][0];for(const[re]of D.slice(1))m[g(re)]=g(j);m[g(B[0])]=g(j)}else{const j=D.reduce((re,te)=>te[1]<re[1]?te:re);m[g(B[0])]=g(j[0])}}let S=new Map;for(let B=0;B<o.length;B+=1){const A=g(B);S.set(A,[...S.get(A)??[],B])}const v=o.map((B,A)=>B.kind==="wonder"?A:-1).filter(B=>B>=0);if(v.length>0){const B=(N,D)=>{const[U,j,re,te]=fo(o[N]),[Y,J,ae,pe]=o[D].box,Ae=Math.max(0,Math.min(U+re,Y+ae)-Math.max(U,Y)),me=Math.max(0,Math.min(j+te,J+pe)-Math.max(j,J));return Ae*me>=.9*o[N].box[2]*o[N].box[3]},A=new Map;for(let N=0;N<o.length;N+=1)if(!(o[N].kind!=="card"||!Wn(o[N])))for(const D of v){const U=Xr(o[N].box,o[D].box);if(U<=.8*p&&Kt(o[N])!==Kt(o[D])&&B(N,D)){const j=A.get(D);(!j||U<j[1])&&A.set(D,[N,U])}}for(const[N,[D]]of A){const U=g(N);for(const[j,re]of S){const te=re.indexOf(D);if(te>=0&&j!==U){re.splice(te,1),S.set(U,[...S.get(U)??[],D]),o[D].kind="tucked";break}}}S=new Map([...S].filter(([,N])=>N.length>0))}const T=B=>B.filter(A=>o[A].kind==="card").length,M=B=>{const A=B.filter(N=>o[N].kind==="card"||o[N].kind==="wonder");return A.length===0?null:A.filter(N=>Kt(o[N])).length/A.length},k=B=>[B.reduce((A,N)=>A+l[N][0],0)/B.length,B.reduce((A,N)=>A+l[N][1],0)/B.length],E=[i[0]/2,i[1]/2],R=[...S.values()].sort((B,A)=>{const N=T(B),D=T(A);if(N!==D)return D-N;const U=Math.hypot(k(B)[0]-E[0],k(B)[1]-E[1]),j=Math.hypot(k(A)[0]-E[0],k(A)[1]-E[1]);return U-j}),P=k(R[0]),X=M(R[0]),W=R.map((B,A)=>{if(A===0||T(B)<Yr)return"player";const N=M(B),D=N!==null&&X!==null&&Math.abs(N-X)>=c2,U=k(B),j=r.some(re=>_2(P,U,re));return D||j?"opponent":"player"});if(!W.includes("opponent")){const B=N=>N.reduce((D,U)=>D+(o[U].kind==="wonder"?1:0),0);let A=W.map((N,D)=>D).filter(N=>N>0&&(T(R[N])>=Yr||B(R[N])>=2));if(A.reduce((N,D)=>N+B(R[D]),0)<1&&(A=[]),A.length>0&&(T(R[0])<2*Yr||A.reduce((N,D)=>N+T(R[D]),0)<2*Yr)&&(A=[]),A.length>0){const N=new Map(A.map(j=>[j,k(R[j])])),D=(j,re)=>(j[0]-re[0])**2+(j[1]-re[1])**2;if(A.every((j,re)=>A.slice(re+1).every(te=>D(N.get(j),N.get(te))<Math.min(D(N.get(j),P),D(N.get(te),P)))))for(const j of A)W[j]="opponent"}}const V=[],O=[];let F=!1;R.forEach((B,A)=>{const N=W[A];N==="opponent"&&(F=!0);const D=[],U=[];for(const j of B){const[re,te,Y,J]=o[j].box;D.push([re,te],[re+Y,te],[re,te+J],[re+Y,te+J]),U.push(o[j].box);const[ae,pe]=o[j].src;ae==="banner"?s[pe]=N:u[pe]=N}V.push([N,g2(D)]),O.push([N,U])});const K=(B,A,N)=>Math.min(...O[N][1].map(D=>w2(B,A,D))),Q=(B,A)=>V.map(([,N],D)=>N.length>=3&&zm(B,A,N)?D:-1).filter(N=>N>=0),ue=(B,A)=>{if(V.length===0)return"player";const N=p>0?d2*p:Number.POSITIVE_INFINITY,D=Q(B,A);if(D.length>0){const re=D.reduce((te,Y)=>K(B,A,Y)<K(B,A,te)?Y:te);return V[re][0]}let U=-1,j=Number.POSITIVE_INFINITY;return V.forEach(([,re],te)=>{const Y=y2(B,A,re);Y<j&&(U=te,j=Y)}),U>=0&&j<=N?V[U][0]:"none"},L=(B,A)=>{if(V.length===0)return"none";const N=Q(B,A);if(N.length===0)return"none";const D=N.reduce((U,j)=>K(B,A,j)<K(B,A,U)?j:U);return V[D][0]};return{bannerOwner:s,wonderOwner:u,opponentFound:F,hulls:V,hullBoxCounts:O.map(([,B])=>B.length),pointOwner:ue,pointInside:L}}const b2=3;function $2(e,t=b2){const n=e.length,r=Array.from({length:n},(o,s)=>s),i=o=>{for(;r[o]!==o;)r[o]=r[r[o]],o=r[o];return o};for(let o=0;o<n;o+=1)for(let s=o+1;s<n;s+=1){const u=e[o],l=e[s],d=Number(u.center[0]),p=Number(u.center[1]),h=Number(l.center[0]),m=Number(l.center[1]),g=Number(u.radius??0),y=Number(l.radius??0);![d,p,h,m,g,y].every(Number.isFinite)||g<=0||y<=0||Math.hypot(d-h,p-m)<=t*(g+y)&&(r[i(o)]=i(s))}const a=new Map;for(let o=0;o<n;o+=1){const s=i(o);a.has(s)||a.set(s,[]),a.get(s).push(o)}return[...a.values()]}function x2(e,t,n){const r=Number(n[0]),i=Number(n[1]),a=Number(n[2]),o=Number(n[3]),s=Math.max(Math.min(r,a)-e,0,e-Math.max(r,a)),u=Math.max(Math.min(i,o)-t,0,t-Math.max(i,o));return Math.hypot(s,u)}function mo(e,t,n,r){const i=new Set(e.filter(o=>t.pointOwner(Number(o.center[0]),Number(o.center[1]))===n));if(i.size===0)return[];const a=[];for(const o of $2(e)){const s=o.map(y=>e[y]),u=s.filter(y=>i.has(y));if(u.length===0)continue;let l=0,d=0,p=0;for(const y of s){const w=Number(y.center[0]),b=Number(y.center[1]);d+=w,p+=b,t.pointInside(w,b)===n&&(l+=1)}const h=d/s.length,m=p/s.length,g=r&&r.length>0?Math.min(...r.map(y=>x2(h,m,y))):0;a.push({cle:[...o].sort((y,w)=>y-w).join(","),membres:s,miens:u,inside:l,dPiste:g,centre:[h,m],valeur:u.reduce((y,w)=>y+(Number(w.denomination??0)||0),0)})}return a}function v2(e){return e.reduce((t,n)=>{const r=[t.inside>0?1:0,t.inside,t.dPiste,t.valeur],i=[n.inside>0?1:0,n.inside,n.dPiste,n.valeur];for(let a=0;a<4;a+=1){if(i[a]>r[a])return n;if(i[a]<r[a])return t}return t})}function S2(e,t,n,r){const[i,a]=e.centre,o={};for(const d of["player","opponent"]){const p=mo(t,n,d,r).filter(h=>h.cle!==e.cle);o[d]=p.length===0?1/0:Math.min(...p.map(h=>Math.hypot(i-h.centre[0],a-h.centre[1])))}if(o.player!==o.opponent)return o.player>o.opponent?"player":"opponent";const s=d=>{const p=mo(t,n,d,r).find(h=>h.cle===e.cle);return p?[p.inside,p.dPiste,p.valeur]:[-1,-1,-1]},u=s("player"),l=s("opponent");for(let d=0;d<3;d+=1){if(u[d]>l[d])return"player";if(u[d]<l[d])return"opponent"}return"player"}function T2(e,t,n){const r={player:[],opponent:[]},i={};for(const o of["player","opponent"]){const s=mo(e,t,o,n);s.length>0&&(i[o]=v2(s))}const a=Object.keys(i);if(a.length===0)return r;if(a.length===2&&i.player.cle===i.opponent.cle){const o=S2(i.player,e,t,n);return r[o]=i[o].membres,r}for(const o of a)r[o]=i[o].membres;return r}function E2(e,t,n,r){const i=()=>e.filter(a=>t.pointOwner(Number(a.center[0]),Number(a.center[1]))===n);try{return T2(e,t,r)[n]??[]}catch{try{return i()}catch{return[...e]}}}const I2=1280,M2=80,k2=3,C2=3,A2=.3,R2=2.4,O2=1,N2=5.2,z2=5;function go(e){const t=e.filter(r=>r&&r.length>=4).map(r=>Math.min(r[2],r[3])).sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function B2(e,t,n){const r=Math.min(e,t),i=Math.max(e,t);return!(n>0)||!(r>0)?!1:r/n>=A2&&r/n<=R2&&i/n>=O2&&i/n<=N2&&i/r<=z2}function P2(e,t,n){const r=Math.max(e,t);return!(r>0)||!(n>0)?!1:n*I2/r<M2}function D2(e,t){if(t.length===0)return e.slice();const n=e.map(r=>{const i=r.poly.map(s=>s[0]),a=r.poly.map(s=>s[1]),o=Math.max(1,i.length);return{hull:r,cx:i.reduce((s,u)=>s+u,0)/o,cy:a.reduce((s,u)=>s+u,0)/o,extra:[]}});if(n.length===0)return e.slice();for(const r of t){const i=Number(r[0]),a=Number(r[1]),o=Number(r[2]),s=Number(r[3]);if(![i,a,o,s].every(Number.isFinite))continue;const u=i+o/2,l=a+s/2;let d=n[0],p=1/0;for(const h of n){const m=(u-h.cx)**2+(l-h.cy)**2;m<p&&(p=m,d=h)}d.extra.push([i,a],[i+o,a+s])}return n.map(r=>r.extra.length===0?r.hull:{...r.hull,poly:[...r.hull.poly.map(i=>[i[0],i[1]]),...r.extra]})}function U2(e,t,n,r,i=[]){const a=go(n);if(!P2(e,t,a))return[];const o=r.filter(l=>l.n>=C2&&l.poly.length>0).slice().sort((l,d)=>d.n-l.n).slice(0,2),s=Math.round(a*k2),u=[];for(const l of D2(o,i)){const d=l.poly.map(w=>w[0]),p=l.poly.map(w=>w[1]);if(d.length===0)continue;const h=Math.max(0,Math.trunc(Math.min(...d))-s),m=Math.max(0,Math.trunc(Math.min(...p))-s),g=Math.min(e,Math.trunc(Math.max(...d))+s),y=Math.min(t,Math.trunc(Math.max(...p))+s);g>h&&y>m&&u.push([h,m,g,y])}return u}function L2(e,t,n){if(!e||e.length<4)return null;const[r,i,a,o]=[e[0],e[1],e[2],e[3]];return B2(a,o,n)?[Math.round(r+t[0]),Math.round(i+t[1]),Math.round(a),Math.round(o)]:null}const F2=1.1,G2=3.2,W2=20,q2=.5,V2=1280,H2=.18,j2=28,K2=.3;function Y2(e){const t=Math.min(...e),n=Math.max(...e);let r=(t+n)/2;for(let o=0;o<30;o++){const s=e.filter(d=>d<=r),u=e.filter(d=>d>r);if(s.length===0||u.length===0)return[e.map((d,p)=>p)];const l=(s.reduce((d,p)=>d+p,0)/s.length+u.reduce((d,p)=>d+p,0)/u.length)/2;if(Math.abs(l-r)<1)break;r=l}const i=[],a=[];return e.forEach((o,s)=>(o<=r?i:a).push(s)),[i,a]}function X2(e,t,n=F2){const[r,i]=t;if(e.length<3||r<=0||i<=0)return[];const a=e.map(l=>l[0]+l[2]/2),o=e.map(l=>l[1]+l[3]/2),s=Math.max(...a)-Math.min(...a)>Math.max(...o)-Math.min(...o)?a:o,u=[];for(const l of Y2(s)){if(l.length===0)continue;const d=l.map(R=>e[R]),p=d.map(R=>Math.min(R[2],R[3])).sort((R,P)=>R-P),h=p[Math.trunc(p.length/2)],m=G2*h,g=Math.max(0,Math.min(...d.map(R=>R[0]))-m),y=Math.max(0,Math.min(...d.map(R=>R[1]))-m),w=Math.min(r,Math.max(...d.map(R=>R[0]+R[2]))+m),b=Math.min(i,Math.max(...d.map(R=>R[1]+R[3]))+m),x=Math.max(w-g,b-y);if(x<=0)continue;const S=q2*h*V2/x,v=S>0?Math.max(1,Math.ceil(W2/S)):1;if(v===1){u.push([Math.trunc(g),Math.trunc(y),Math.trunc(w),Math.trunc(b)]);continue}const T=w-g>=b-y,k=(T?w-g:b-y)/v,E=k*(1+H2);for(let R=0;R<v;R++){let P=(T?g:y)+R*k-(E-k)/2;P=Math.max(T?g:y,P);const X=Math.min(T?w:b,P+E);u.push(T?[Math.trunc(P),Math.trunc(y),Math.trunc(X),Math.trunc(b)]:[Math.trunc(g),Math.trunc(P),Math.trunc(w),Math.trunc(X)])}}return u.filter(([l,d,p,h])=>Math.max(r,i)/Math.max(1,Math.max(p-l,h-d))>=n)}function Q2(e,t,n,r=j2){const[i,a]=n,o=e;for(const[s,u,l,d]of t){const p=(s+l)/2+i,h=(u+d)/2+a;o.some(([g,y,w,b])=>{const x=p-(g+w)/2,S=h-(y+b)/2;return Math.hypot(x,S)<=r})||o.push([s+i,u+a,l+i,d+a])}return o}function Z2(e,t,n,r=K2){for(const i of n){const a=r*Math.min(i[2],i[3]);if(i[0]-a<=e&&e<=i[0]+i[2]+a&&i[1]-a<=t&&t<=i[1]+i[3]+a)return!0}return!1}function J2(e,t,n){return n.some(([r,i,a,o])=>r<=e&&e<=a&&i<=t&&t<=o)}function e$(e,t,n,r){return n.length===0?!1:J2(e,t,n)&&!Z2(e,t,r)}const Pm=4,Dm=8,Qr=5,In="base-game rule";function Bt(e,t){return{code:e,message:t,severity:"warning"}}function yo(e){const t=new Set,n=new Set;for(const r of e)t.has(r)&&n.add(r),t.add(r);return[...n].sort()}function t$(e,t=""){const n=e.filter(o=>!!o),r=t||"a player",i=[];n.length>Pm&&i.push(Bt("TOO_MANY_WONDERS",`${r}: ${n.length} wonders recognised, but a player builds at most ${Pm} (${In}) — at least one reading is wrong. Check the wonder list in the review; a card seen at an angle can be named as a wonder.`));const a=yo(n);return a.length>0&&i.push(Bt("DUPLICATE_WONDER",`${r}: wonder(s) counted twice — ${a.join(", ")}. Only one copy of each wonder exists (${In}), so one of the two readings is wrong.`)),i}function n$(e){const t=[],n=Object.entries(e).map(([i,a])=>[i,new Set(a.filter(o=>!!o))]),r=Object.values(e).reduce((i,a)=>i+a.filter(Boolean).length,0);r>Dm&&t.push(Bt("TOO_MANY_WONDERS_IN_PLAY",`${r} wonders recognised across both cities, but only ${Dm} are in play (${In}) — at least one reading is wrong.`));for(let i=0;i<n.length;i++){const[a,o]=n[i];for(let s=i+1;s<n.length;s++){const[u,l]=n[s],d=[...o].filter(p=>l.has(p)).sort();d.length>0&&t.push(Bt("WONDER_IN_BOTH_CITIES",`wonder(s) assigned to both cities at once (${a} and ${u}): ${d.join(", ")} — the city split misread one of them.`))}}return t}function r$(e,t=null){const n=[],r=Object.values(e).flatMap(a=>a.filter(o=>!!o));r.length>Qr&&n.push(Bt("TOO_MANY_TOKENS",`${r.length} Progress tokens claimed by the cities, but only ${Qr} are in play (${In}) — reserve tokens sitting on the board were probably counted as owned.`));const i=yo(r);if(i.length>0&&n.push(Bt("DUPLICATE_TOKEN",`Progress token(s) counted twice: ${i.join(", ")} — only one copy of each token exists (${In}).`)),t!==null){const a=t.filter(Boolean),o=r.length+a.length;o!==Qr&&n.push(Bt("TOKEN_COUNT_MISMATCH",`${r.length} token(s) in the cities + ${t.length} in the reserve = ${o}, but exactly ${Qr} are in play (${In}) — one is missing or one was counted twice.`));const s=new Set(a),u=[...new Set(r.filter(l=>s.has(l)))].sort();u.length>0&&n.push(Bt("TOKEN_IN_CITY_AND_RESERVE",`token(s) seen both in a city and in the reserve: ${u.join(", ")} — the board-token exclusion did not fire.`))}return n}function i$(e,t=""){const n=t||"a player",r=[],i=e.filter(o=>!o).length;i>0&&r.push(Bt("UNNAMED_GUILD",`${n}: ${i} guild(s) detected but not identified — their points cannot be computed. Name them in the review.`));const a=yo(e.filter(o=>!!o));return a.length>0&&r.push(Bt("DUPLICATE_GUILD",`${n}: guild(s) counted twice — ${a.join(", ")}. Only one copy of each guild exists (${In}).`)),r}const a$=.25,o$=.45;function s$(e,t,n,r,i){const a=Math.cos(i),o=Math.sin(i),s=[n/2*a,n/2*o],u=[-r/2*o,r/2*a],d=[...[[e+s[0]+u[0],t+s[1]+u[1]],[e+s[0]-u[0],t+s[1]-u[1]],[e-s[0]-u[0],t-s[1]-u[1]],[e-s[0]+u[0],t-s[1]+u[1]]]].reverse();return[d[1],d[2],d[3],d[0]]}function wo(e,t){return e.matFromArray(t.length,1,e.CV_32FC2,t.flatMap(n=>[n[0],n[1]]))}function Um(e,t){const n=wo(e,t);try{return Math.abs(e.contourArea(n))}finally{n.delete()}}function u$(e,t,n){const r=wo(e,t),i=wo(e,n),a=new e.Mat;try{return Math.abs(e.intersectConvexConvex(r,i,a,!0))}finally{r.delete(),i.delete(),a.delete()}}function l$(e,t,n=o$){const r=[...t].sort((a,o)=>o.confidence-a.confidence),i=[];for(const a of r){let o=!1;for(const s of i){const u=u$(e,a.quad,s.quad);if(u<=0)continue;const l=Um(e,a.quad)+Um(e,s.quad)-u;if(u/Math.max(1e-6,l)>=n){o=!0;break}}o||i.push(a)}return i}function c$(e,t,n,r,i=a$){const a=[];for(let o=0;o<n;o++){const s=t[4*n+o];if(s<i)continue;const l=s$(t[o],t[n+o],t[2*n+o],t[3*n+o],t[5*n+o]).map(d=>[(d[0]-r.padX)/r.scale,(d[1]-r.padY)/r.scale]);a.push({quad:l,confidence:s})}return l$(e,a)}const d$=128,p$=88;function h$(e,t,n,r=d$,i=p$){const a=new e.Mat(t.height,t.width,e.CV_8UC3),o=a.data,s=t.channels;for(let h=0,m=t.width*t.height;h<m;h++)o[h*3]=t.data[h*s],o[h*3+1]=t.data[h*s+1],o[h*3+2]=t.data[h*s+2];const u=e.matFromArray(4,1,e.CV_32FC2,n.flatMap(h=>[h[0],h[1]])),l=e.matFromArray(4,1,e.CV_32FC2,[0,0,r,0,r,i,0,i]),d=e.getPerspectiveTransform(u,l),p=new e.Mat;try{return e.warpPerspective(a,p,d,new e.Size(r,i)),{data:new Uint8Array(p.data),width:r,height:i,channels:3}}finally{a.delete(),u.delete(),l.delete(),d.delete(),p.delete()}}function f$(e){return[e[2],e[3],e[0],e[1]]}const m$=[{id:"merchants-guild",name:"Merchants Guild",nameFr:"Guilde des commerçants",color:"guild",age:3,victoryPoints:0,variableScoring:"merchantsGuild",cost:{clay:1,wood:1,glass:1,papyrus:1}},{id:"shipowners-guild",name:"Shipowners Guild",nameFr:"Guilde des armateurs",color:"guild",age:3,victoryPoints:0,variableScoring:"shipownersGuild",cost:{clay:2,glass:1,papyrus:1}},{id:"builders-guild",name:"Builders Guild",nameFr:"Guilde des bâtisseurs",color:"guild",age:3,victoryPoints:0,variableScoring:"buildersGuild",cost:{stone:2,clay:1,wood:1,glass:1}},{id:"magistrates-guild",name:"Magistrates Guild",nameFr:"Guilde des magistrats",color:"guild",age:3,victoryPoints:0,variableScoring:"magistratesGuild",cost:{wood:2,clay:1,papyrus:1}},{id:"scientists-guild",name:"Scientists Guild",nameFr:"Guilde des scientifiques",color:"guild",age:3,victoryPoints:0,variableScoring:"scientistsGuild",cost:{wood:2,clay:2}},{id:"tacticians-guild",name:"Tacticians Guild",nameFr:"Guilde des tacticiens",color:"guild",age:3,victoryPoints:0,variableScoring:"tacticiansGuild",cost:{stone:2,clay:1,papyrus:1}},{id:"moneylenders-guild",name:"Moneylenders Guild",nameFr:"Guilde des usuriers",color:"guild",age:3,victoryPoints:0,variableScoring:"moneylendersGuild",cost:{stone:2,wood:2}}],g$=[{id:"lumber-yard",name:"Lumber Yard",nameFr:"Chantier",color:"raw",age:1,victoryPoints:0},{id:"logging-camp",name:"Logging Camp",nameFr:"Exploitation",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"clay-pool",name:"Clay Pool",nameFr:"Bassin argileux",color:"raw",age:1,victoryPoints:0},{id:"clay-pit",name:"Clay Pit",nameFr:"Cavité",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"quarry",name:"Quarry",nameFr:"Gisement",color:"raw",age:1,victoryPoints:0},{id:"stone-pit",name:"Stone Pit",nameFr:"Mine",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"glassworks",name:"Glassworks",nameFr:"Verrerie",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"press",name:"Press",nameFr:"Presse",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"theater",name:"Theater",nameFr:"Théâtre",color:"civilian",age:1,victoryPoints:3},{id:"altar",name:"Altar",nameFr:"Autel",color:"civilian",age:1,victoryPoints:3,providesChain:"moon"},{id:"baths",name:"Baths",nameFr:"Bains",color:"civilian",age:1,victoryPoints:3,providesChain:"drop",cost:{stone:1}},{id:"pharmacist",name:"Pharmacist",nameFr:"Officine",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"mortar",providesChain:"mortar-chain",cost:{glass:2}},{id:"apothecary",name:"Apothecary",nameFr:"Apothicaire",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain",cost:{glass:1}},{id:"workshop",name:"Workshop",nameFr:"Atelier",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain",cost:{papyrus:1}},{id:"scriptorium",name:"Scriptorium",nameFr:"Scriptorium",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"inkwell",providesChain:"inkwell-chain",coinCost:2},{id:"stone-reserve",name:"Stone Reserve",nameFr:"Dépôt de pierre",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"clay-reserve",name:"Clay Reserve",nameFr:"Dépôt d'argile",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"wood-reserve",name:"Wood Reserve",nameFr:"Dépôt de bois",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"tavern",name:"Tavern",nameFr:"Taverne",color:"commercial",age:1,victoryPoints:0,providesChain:"jug"},{id:"guard-tower",name:"Guard Tower",nameFr:"Tour de garde",color:"military",age:1,victoryPoints:0,shields:1},{id:"stable",name:"Stable",nameFr:"Écuries",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"horseshoe",cost:{wood:1}},{id:"garrison",name:"Garrison",nameFr:"Caserne",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"sword",cost:{clay:1}},{id:"palisade",name:"Palisade",nameFr:"Palissade",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"tower",coinCost:2}],y$=[{id:"sawmill",name:"Sawmill",nameFr:"Scierie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"brickyard",name:"Brickyard",nameFr:"Briqueterie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"shelf-quarry",name:"Shelf Quarry",nameFr:"Carrière",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"glass-blower",name:"Glass-Blower",nameFr:"Soufflerie",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"drying-room",name:"Drying Room",nameFr:"Séchoir",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"courthouse",name:"Courthouse",nameFr:"Tribunal",color:"civilian",age:2,victoryPoints:5,cost:{wood:2,glass:1}},{id:"statue",name:"Statue",nameFr:"Statue",color:"civilian",age:2,victoryPoints:4,providesChain:"column",chainFrom:"moon",cost:{clay:2}},{id:"temple",name:"Temple",nameFr:"Temple",color:"civilian",age:2,victoryPoints:4,providesChain:"sun",chainFrom:"drop",cost:{wood:1,papyrus:1}},{id:"aqueduct",name:"Aqueduct",nameFr:"Aqueduc",color:"civilian",age:2,victoryPoints:5,cost:{stone:3}},{id:"rostrum",name:"Rostrum",nameFr:"Rostres",color:"civilian",age:2,victoryPoints:4,providesChain:"horseshoe",cost:{stone:1,wood:1}},{id:"school",name:"School",nameFr:"École",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain-2",cost:{wood:1,papyrus:2}},{id:"laboratory",name:"Laboratory",nameFr:"Laboratoire",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain-2",cost:{wood:1,glass:2}},{id:"library",name:"Library",nameFr:"Bibliothèque",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"inkwell",chainFrom:"inkwell-chain",cost:{stone:1,wood:1,glass:1}},{id:"dispensary",name:"Dispensary",nameFr:"Dispensaire",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"mortar",chainFrom:"mortar-chain",cost:{clay:2,stone:1}},{id:"forum",name:"Forum",nameFr:"Forum",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel",coinCost:3,cost:{clay:1}},{id:"caravansery",name:"Caravansery",nameFr:"Caravansérail",color:"commercial",age:2,victoryPoints:0,coinCost:2,cost:{glass:1,papyrus:1}},{id:"customs-house",name:"Customs House",nameFr:"Douanes",color:"commercial",age:2,victoryPoints:0,coinCost:4},{id:"brewery",name:"Brewery",nameFr:"Brasserie",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel-2"},{id:"horse-breeders",name:"Horse Breeders",nameFr:"Haras",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"horseshoe",cost:{clay:1,wood:1}},{id:"barracks",name:"Barracks",nameFr:"Baraquements",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"sword",coinCost:3},{id:"archery-range",name:"Archery Range",nameFr:"Champ de tir",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"target",cost:{stone:1,wood:1,papyrus:1}},{id:"parade-ground",name:"Parade Ground",nameFr:"Place d'armes",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"mask",cost:{clay:2,glass:1}},{id:"walls",name:"Walls",nameFr:"Muraille",color:"military",age:2,victoryPoints:0,shields:2,cost:{stone:2}}],w$=[{id:"pantheon",name:"Pantheon",nameFr:"Panthéon",color:"civilian",age:3,victoryPoints:6,chainFrom:"sun",cost:{clay:1,wood:1,papyrus:2}},{id:"gardens",name:"Gardens",nameFr:"Jardins",color:"civilian",age:3,victoryPoints:6,chainFrom:"column",cost:{clay:2,wood:2}},{id:"town-hall",name:"Town Hall",nameFr:"Hôtel de ville",color:"civilian",age:3,victoryPoints:7,cost:{stone:3,wood:2}},{id:"palace",name:"Palace",nameFr:"Palace",color:"civilian",age:3,victoryPoints:7,cost:{clay:1,stone:1,wood:1,glass:2}},{id:"senate",name:"Senate",nameFr:"Sénat",color:"civilian",age:3,victoryPoints:5,chainFrom:"horseshoe",cost:{clay:2,stone:1,papyrus:1}},{id:"obelisk",name:"Obelisk",nameFr:"Obélisque",color:"civilian",age:3,victoryPoints:5,cost:{stone:2,glass:1}},{id:"academy",name:"Academy",nameFr:"Académie",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{stone:1,wood:1,glass:2}},{id:"study",name:"Study",nameFr:"Étude",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{wood:2,glass:1,papyrus:1}},{id:"university",name:"University",nameFr:"Université",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"wheel-chain-2",cost:{clay:1,glass:1,papyrus:1}},{id:"observatory",name:"Observatory",nameFr:"Observatoire",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"pendulum-chain-2",cost:{stone:1,papyrus:2}},{id:"chamber-of-commerce",name:"Chamber of Commerce",nameFr:"Chambre de commerce",color:"commercial",age:3,victoryPoints:3,variableScoring:"chamberOfCommerce",cost:{papyrus:2}},{id:"port",name:"Port",nameFr:"Port",color:"commercial",age:3,victoryPoints:3,variableScoring:"port",cost:{wood:1,glass:1,papyrus:1}},{id:"armory",name:"Armory",nameFr:"Armurerie",color:"commercial",age:3,victoryPoints:3,variableScoring:"armory",cost:{stone:2,glass:1}},{id:"lighthouse",name:"Lighthouse",nameFr:"Phare",color:"commercial",age:3,victoryPoints:3,variableScoring:"lighthouse",chainFrom:"jug",cost:{clay:2,glass:1}},{id:"arena",name:"Arena",nameFr:"Arène",color:"commercial",age:3,victoryPoints:3,variableScoring:"arena",chainFrom:"barrel-2",cost:{clay:1,stone:1,wood:1}},{id:"pretorium",name:"Pretorium",nameFr:"Prétoire",color:"military",age:3,victoryPoints:0,shields:3,coinCost:8},{id:"arsenal",name:"Arsenal",nameFr:"Arsenal",color:"military",age:3,victoryPoints:0,shields:3,cost:{clay:3,wood:2}},{id:"fortifications",name:"Fortifications",nameFr:"Fortifications",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"tower",cost:{stone:2,clay:1,papyrus:1}},{id:"siege-workshop",name:"Siege Workshop",nameFr:"Atelier de siège",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"target",cost:{wood:3,glass:1}},{id:"circus",name:"Circus",nameFr:"Cirque",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"mask",cost:{clay:2,stone:2}}],_$=[...g$,...y$,...w$,...m$];Object.fromEntries(_$.map(e=>[e.id,e]));const b$=Object.fromEntries([{id:"the-appian-way",name:"The Appian Way",nameFr:"La Via Appia",victoryPoints:3,description:"The opponent loses 3 coins. Take another turn. Once built, repeated discards are not affected. Worth 3 victory points."},{id:"circus-maximus",name:"Circus Maximus",nameFr:"Le Circus Maximus",victoryPoints:3,shields:1,description:"Destroy one grey (manufactured) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-colossus",name:"The Colossus",nameFr:"Le Colosse",victoryPoints:3,shields:2,description:"Provides 2 shields. Worth 3 victory points."},{id:"the-great-library",name:"The Great Library",nameFr:"La Grande Bibliothèque",victoryPoints:4,description:"Randomly draw 3 of the Progress tokens discarded at game setup and keep one. Worth 4 victory points."},{id:"the-great-lighthouse",name:"The Great Lighthouse",nameFr:"Le Grand Phare",victoryPoints:4,description:"Once built, the owner may take any raw or manufactured good of choice each turn (production effect). Worth 4 victory points."},{id:"the-hanging-gardens",name:"The Hanging Gardens",nameFr:"Les Jardins Suspendus",victoryPoints:3,description:"Gain 6 coins. Take another turn. Worth 3 victory points."},{id:"the-mausoleum",name:"The Mausoleum",nameFr:"Le Mausolée",victoryPoints:2,description:"Build, for free, any one card from the discard pile. Worth 2 victory points."},{id:"piraeus",name:"Piraeus",nameFr:"Le Pirée",victoryPoints:2,description:"Once built, the owner may take any one manufactured good (glass or papyrus) of choice each turn. Take another turn. Worth 2 victory points."},{id:"the-pyramids",name:"The Pyramids",nameFr:"Les Pyramides",victoryPoints:9,description:"Worth 9 victory points."},{id:"the-sphinx",name:"The Sphinx",nameFr:"Le Sphinx",victoryPoints:6,description:"Take another turn. Worth 6 victory points."},{id:"the-statue-of-zeus",name:"The Statue of Zeus",nameFr:"La Statue de Zeus",victoryPoints:3,shields:1,description:"Destroy one brown (raw) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-temple-of-artemis",name:"The Temple of Artemis",nameFr:"Le Temple d'Artémis",victoryPoints:0,description:"Gain 12 coins. Take another turn. Worth 0 victory points."}].map(e=>[e.id,e]));Object.fromEntries([{id:"agriculture",name:"Agriculture",nameFr:"Agriculture",victoryPoints:4,description:"Gain 6 coins immediately. Worth 4 victory points at game end."},{id:"architecture",name:"Architecture",nameFr:"Architecture",description:"Any future Wonder constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"economy",name:"Economy",nameFr:"Économie",description:"When the opponent uses the trading-cost coins (pays the bank to buy goods), the owner receives those coins instead."},{id:"law",name:"Law",nameFr:"Loi",variableScoring:"law",description:"Grants one science symbol, counting toward the six-symbol scientific victory and toward pairs of identical symbols."},{id:"masonry",name:"Masonry",nameFr:"Maçonnerie",description:"Any future blue (civilian) building constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"mathematics",name:"Mathematics",nameFr:"Mathématiques",variableScoring:"mathematics",description:"Worth 3 victory points at game end for EACH Progress token the owner possesses (including this one)."},{id:"philosophy",name:"Philosophy",nameFr:"Philosophie",victoryPoints:7,description:"Worth 7 victory points at game end."},{id:"strategy",name:"Strategy",nameFr:"Stratégie",description:"Whenever the owner builds a red (military) building, it provides 1 additional shield."},{id:"theology",name:"Theology",nameFr:"Théologie",description:"Every future Wonder built by the owner grants an extra turn."},{id:"urbanism",name:"Urbanism",nameFr:"Urbanisme",description:"Gain 6 coins immediately. When the owner builds a card for free via a chain link, they also gain 4 coins."}].map(e=>[e.id,e]));const Lm=.2,$$=.3,Fm=.25,_o={total:0,idDiff:0,verdictDiff:0},Pt={total:0,divergent:0,positifs4:0,positifs2:0,detail:[]},Zr={total:0,memeK:0,memeKInverse:0,detail:[]};function x$(e,t,n){for(const r of e){let i=!1;for(let a=0,o=r.length-1;a<r.length;o=a++){const s=r[a],u=r[o];s[1]>n!=u[1]>n&&t<(u[0]-s[0])*(n-s[1])/(u[1]-s[1])+s[0]&&(i=!i)}if(i)return r.map(a=>[a[0],a[1]])}return null}function v$(e,t,n){if(t.height<=0)return!1;const r=t.width/t.height;if(Math.abs(Math.log(r))<=Fm)return!1;const i=e.x+e.width,a=e.y+e.height;for(const o of n){const s=o.box;if(!s||s.length<4||s[3]<=0)continue;const u=s[0]+s[2]/2,l=s[1]+s[3]/2;if(!(u>=e.x&&u<=i&&l>=e.y&&l<=a))continue;const d=s[2]/s[3];if(!(Math.abs(Math.log(d))<=Fm)&&r>1==d>1)return!0}return!1}async function S$(e,t,n,r,i=[0,1,2,3]){const[a,o,s,u]=t;if(s<=0||u<=0)return null;const l=Math.round(s*Lm),d=Math.round(u*Lm),p=Math.max(0,Math.round(a-l)),h=Math.max(0,Math.round(o-d)),m=Math.min(e.width,Math.round(a+s+l)),g=Math.min(e.height,Math.round(o+u+d)),y=m-p,w=g-h;if(y<=0||w<=0)return null;const b=e.channels,x=new Uint8ClampedArray(y*w*b);for(let T=0;T<w;T++){const M=((h+T)*e.width+p)*b;x.set(e.data.subarray(M,M+y*b),T*y*b)}const S={width:y,height:w,channels:b,data:x};let v=null;for(const T of i){const M=T===0?S:rn(S,T),k=M.width,E=k-Math.floor($$*k),R=k-E;if(R<=0)continue;const P=new Uint8ClampedArray(R*M.height*M.channels);for(let F=0;F<M.height;F++){const K=(F*k+E)*M.channels;P.set(M.data.subarray(K,K+R*M.channels),F*R*M.channels)}const X={width:R,height:M.height,channels:M.channels,data:P},W=lo(X),O=(await n.run({[n.inputNames[0]]:new Ue("float32",W,[1,3,Nt,Nt])}))[n.outputNames[0]].data[1]??0;r&&(r[T]=O),v=v===null?O:Math.max(v,O)}return v}async function T$(e,t,n,r,i,a,o=[],s){var w;const u=async b=>(await r.run({[r.inputNames[0]]:new Ue("float32",b,[1,3,jt,jt])}))[r.outputNames[0]].data,l=e.obbQuads===void 0?null:await Je("OBB merveilles (détection orientée)",async()=>{try{return await e.obbQuads(n)}catch(b){return console.warn("[wonders-obb] détection échouée, repli ORB :",b),null}});s!==void 0&&(s.n=l===null?0:l.length);const d=l===null?[]:l.map(b=>{const x=b.map(([M])=>M),S=b.map(([,M])=>M),v=Math.min(...x),T=Math.min(...S);return[Math.round(v),Math.round(T),Math.round(Math.max(...x)-v),Math.round(Math.max(...S)-T)]}),p=o.length===0?d:d.filter(([b,x,S,v])=>{const T=b+S/2,M=x+v/2;return!o.some(k=>{const E=k.x+k.width/2,R=k.y+k.height/2,P=.5*Math.min(k.width,k.height);return(T-E)**2+(M-R)**2<P*P})}),h=new Map;for(const b of p){const[x,S,v,T]=b;if(v<=0||T<=0)continue;const M=l===null?null:x$(l,x+v/2,S+T/2);if(M===null||e.redresserQuad===void 0)continue;let k=M;const E=rt("identify: redressement du quad",()=>e.redresserQuad(n,k)),R=Em(),{id:P,prob:X,inverse:W}=await Je("classifieur merveille (1 lecture)",()=>T1(E,u));if(P===""||X<R)continue;W&&(k=f$(k).map(O=>[O[0],O[1]]));const V=h.get(P);(V===void 0||X>V.prob)&&h.set(P,{prob:X,box:b,quad:k})}const m=[],g=await e.tuckClassifier(),y=await e.tuckBoxClassifier();for(const[b,{prob:x,box:S,quad:v}]of h){const[T,M,k,E]=S;let R={x:Math.round(T),y:Math.round(M),width:Math.round(k),height:Math.round(E)},P=null,X=[],W=null;if(v!==null){P=v;const N=P.map(re=>re[0]),D=P.map(re=>re[1]),U=Math.max(0,Math.round(Math.min(...N))),j=Math.max(0,Math.round(Math.min(...D)));if(R={x:U,y:j,width:Math.min(n.width,Math.round(Math.max(...N)))-U,height:Math.min(n.height,Math.round(Math.max(...D)))-j},g!==null)try{const re=await e.wonderRef(b),te=P,Y=re===null||te===null?null:rt("identify: bande droite #63",()=>dm(t,n,re,te));if(Y!==null){const J=rt("identify: preprocess tuck",()=>lo(Y)),ae=await g.run({[g.inputNames[0]]:new Ue("float32",J,[1,3,Nt,Nt])});W=hm(ae[g.outputNames[0]].data).prob,X=W>=Ln?["R"]:[]}}catch{}}else if(Date.now()<i)try{const N=await Je("chargement refs merveilles",()=>e.wonderRef(b));if(N!==null){const D=rt("ORB registration (merveille)",()=>tb(t,n,N,S));if(D!==null){P=D.footprint,X=D.overflow;const U=P.map(Y=>Y[0]),j=P.map(Y=>Y[1]),re=Math.max(0,Math.round(Math.min(...U))),te=Math.max(0,Math.round(Math.min(...j)));if(R={x:re,y:te,width:Math.min(n.width,Math.round(Math.max(...U)))-re,height:Math.min(n.height,Math.round(Math.max(...j)))-te},g!==null)try{const Y=P,J=Y===null?null:rt("identify: bande droite #63",()=>dm(t,n,N,Y));if(J!==null){const ae=rt("identify: preprocess tuck",()=>lo(J)),pe=await g.run({[g.inputNames[0]]:new Ue("float32",ae,[1,3,Nt,Nt])});W=hm(pe[g.outputNames[0]].data).prob}}catch{}}}}catch(N){console.warn(`[wonders-cls] ${b} registration failed:`,N)}const V=P!==null?cm(P,X):null,O=v!==null&&P!==null?cm(P,["R"]):null,F=[];if(W!==null&&F.push(W>=Ln?1:0),y!==null)try{let N=[0,1,2,3];if(v!==null){const j=v[1][1]-v[0][1],re=v[1][0]-v[0][0],te=(Math.round(Math.atan2(j,re)*180/Math.PI/90)%4+4)%4;N=[(0+te)%4,(2+te)%4]}const D=[0,0,0,0],U=await Je("identify: sonde marges (#68)",()=>S$(n,S,y,D,N));if(U!==null&&(F.push(U>=Ln?1:0),v!==null)){const j=v[1][1]-v[0][1],re=v[1][0]-v[0][0],te=(Math.round(Math.atan2(j,re)*180/Math.PI/90)%4+4)%4,Y=Math.max(D[(0+te)%4],D[(2+te)%4]);Pt.total+=1;const J=U>=Ln?1:0,ae=Y>=Ln?1:0;J===1&&(Pt.positifs4+=1),ae===1&&(Pt.positifs2+=1),J!==ae&&(Pt.divergent+=1,Pt.detail.push(`${b.slice(0,12)}:v4=${J}/v2=${ae} p=[${D.map(pe=>pe.toFixed(2)).join(",")}]kQ${te}`))}}catch{}const K=O??V??R,Q=a.some(N=>{const D=N.box[0]+N.box[2]/2,U=N.box[1]+N.box[3]/2;return D>=K.x&&D<=K.x+K.width&&U>=K.y&&U<=K.y+K.height});F.push(Q?1:0);let ue=F.length>0&&F.reduce((N,D)=>N+D,0)*2>F.length;ue&&v$(K,R,a)&&(ue=!1);const L=V??(ue&&O!==null?O:null),B={id:b,name:((w=b$[b])==null?void 0:w.name)??b,builtWithCardUnderneath:ue,boundingBox:R,confidence:Math.round(x*1e4)/1e4,...L?{tuckRegion:L}:{}},A=L??R;m.push({obj:B,edgeScores:null,zone:{x0:A.x,y0:A.y,x1:A.x+A.width,y1:A.y+A.height},quad:P,region:L})}return m}const Ze="/7wd-scorer/models/",bo=[];let It=null;function E$(){bo.length=0,It=null}function I$(e){const t=performance.now();It!==null&&bo.push({nom:It.nom,ms:Math.round(t-It.debut)}),It={nom:e,debut:t}}function Gm(){const e=[...bo];It!==null&&e.push({nom:`${It.nom} (en cours)`,ms:Math.round(performance.now()-It.debut)});const t=new Map;for(const n of e){const r=t.get(n.nom)??{appels:0,ms:0};r.appels+=1,r.ms+=n.ms,t.set(n.nom,r)}return[...t.entries()].map(([n,r])=>({nom:n,appels:r.appels,ms:r.ms})).sort((n,r)=>r.ms-n.ms)}function Wm(){const e={};for(const t of Object.keys(at))e[at[t].onnx]=ei.has(t)?"wasm (repli apres echec webgpu)":"webgpu>wasm";for(const[t,n]of ut)e[t]=n;return e}function M$(){var e,t;return $o(),{crossOriginIsolated:globalThis.crossOriginIsolated??null,numThreads:ze.wasm.numThreads??null,sharedArrayBuffer:typeof SharedArrayBuffer<"u",coeurs:((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??null,webgpuPresent:typeof((t=globalThis.navigator)==null?void 0:t.gpu)<"u"}}let qm=!1;const Jr=new Map;function $o(){var e;qm||(ze.wasm.wasmPaths="/7wd-scorer/ort/",ze.wasm.numThreads=globalThis.crossOriginIsolated?Math.max(1,(((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??4)-2):1,qm=!0)}const ei=new Set;let xo=0;function Vm(e){return xo+=1,e.finally(()=>{xo-=1})}function k$(){return xo>0}function C$(e){$o();let t=Jr.get(e);return t===void 0&&(t=Vm(Je(`session: 1er chargement ${at[e].onnx}`,()=>br.create(`${Ze}${at[e].onnx}`,{executionProviders:ei.has(e)?["wasm"]:["webgpu","wasm"]}))),Jr.set(e,t),t.catch(()=>Jr.delete(e))),t}const ut=new Map;let pr=0,hr=0;const ti=new Map;function vo(e){const t=(It==null?void 0:It.nom)??"(hors etage)";ti.set(t,(ti.get(t)??0)+e)}function A$(){return[...ti.entries()].map(([e,t])=>({nom:e,ms:Math.round(t)})).sort((e,t)=>t.ms-e.ms)}let So=0;function R$(){return{ms:Math.round(pr),appels:hr,preparationMs:Math.round(So)}}function O$(){pr=0,hr=0,So=0,bw(),ti.clear(),mx()}const Hm=new Set(["coin_yolo.onnx","token_yolo.onnx"]),To=new Set;let Eo=null;async function N$(e){if(Eo)return await Eo.catch(()=>{}),e();const t=e();return Eo=t.catch(()=>{}),t}async function Io(e,t){return N$(()=>br.create(`${Ze}${e}`,{executionProviders:t?["webgpu"]:["wasm"]}))}async function ht(e){return Vm(Je(`session: 1er chargement ${e}`,()=>z$(e)))}async function z$(e){$o();const t=!Hm.has(e)&&!To.has(e);let n=null;if(t)try{n=await Io(e,!0),ut.set(e,"webgpu")}catch(o){To.add(e),ut.set(e,`wasm (webgpu refuse a la creation: ${String(o).slice(0,60)})`)}else ut.set(e,Hm.has(e)?"wasm (webgpu incompatible, mesure)":"wasm");if(n===null)try{n=await Io(e,!1)}catch(o){return ut.set(e,`ECHEC wasm: ${String(o).slice(0,160)}`),null}let r=n,i=ut.get(e)==="webgpu";const a=async(o,...s)=>{const u=performance.now();try{const l=await r.run(o,...s),d=performance.now()-u;return pr+=d,vo(d),hr+=1,l}catch(l){if(!i)throw l;To.add(e),ut.set(e,`wasm (repli au run: ${String(l).slice(0,60)})`),i=!1,r=await Io(e,!1);const d=await r.run(o,...s),p=performance.now()-u;return pr+=p,vo(p),hr+=1,d}};return new Proxy(r,{get(o,s,u){if(s==="run")return a;const l=Reflect.get(r,s,u);return typeof l=="function"?l.bind(r):l}})}let Mo=null,ko=null;const B$=.65,P$=3e4;let Co=null;function Ao(){return Co===null&&(Co=(async()=>{try{let e;return self.importScripts("/7wd-scorer/opencv/opencv.js"),e=self.cv,typeof(e==null?void 0:e.then)=="function"&&(e=await e),typeof(e==null?void 0:e.getBuildInformation)!="function"&&(e=await new Promise(t=>{e.onRuntimeInitialized=()=>t(e)})),e}catch(e){return console.warn("[wonders-reg] opencv.js load failed:",e),null}})()),Co}const jm=new Map;function Ro(e){let t=jm.get(e);return t===void 0&&(t=(async()=>{try{const n=await fetch(`${Ze}${e}`);if(!n.ok)return null;const r=await createImageBitmap(await n.blob()),a=new OffscreenCanvas(r.width,r.height).getContext("2d");a.drawImage(r,0,0);const o=a.getImageData(0,0,r.width,r.height);return{width:r.width,height:r.height,channels:4,data:new Uint8Array(o.data.buffer)}}catch{return null}})(),jm.set(e,t)),t}function D$(e){return Ro(`wonder-refs/${e}.jpg`)}const Km=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"];async function U$(){const e=new Map;for(const t of Km){const n=await Ro(`guild-refs/${t}.jpg`);n!==null&&e.set(t,n)}return e}async function L$(){const e=new Map;for(const t of Km){const n=await Ro(`guild-band-refs/${t}.png`);n!==null&&e.set(t,n)}return e}function Ym(e,t,n,r){const i=(t%4+4)%4;if(i===0)return{x:e.x,y:e.y,width:e.width,height:e.height};const a=(p,h)=>i===1?[h,r-1-p]:i===2?[n-1-p,r-1-h]:[n-1-h,p],o=[a(e.x,e.y),a(e.x+e.width,e.y+e.height)],s=o.map(p=>p[0]),u=o.map(p=>p[1]),l=Math.min(...s),d=Math.min(...u);return{x:l,y:d,width:Math.max(...s)-l,height:Math.max(...u)-d}}function F$(){return ko===null&&(ko=fetch(`${Ze}laurel_gallery.json`).then(async e=>e.ok?k_(await e.json()):[]).catch(()=>[])),ko}function G$(e,t,n,r){return rt("crop",()=>W$(e,t,n,r))}function W$(e,t,n,r){return un(e,t-r,n-r,2*r,2*r)}function un(e,t,n,r,i){return rt("crop",()=>q$(e,t,n,r,i))}function q$(e,t,n,r,i){const a=Math.max(0,Math.round(t)),o=Math.max(0,Math.round(n)),s=Math.min(e.width,Math.round(t+r)),u=Math.min(e.height,Math.round(n+i)),l=Math.max(0,s-a),d=Math.max(0,u-o),p=new Uint8Array(l*d*3);for(let h=0;h<d;h++)for(let m=0;m<l;m++){const g=((h+o)*e.width+(m+a))*e.channels,y=(h*l+m)*3;p[y]=e.data[g],p[y+1]=e.data[g+1],p[y+2]=e.data[g+2]}return{width:l,height:d,channels:3,data:p}}function V$(){return Mo===null&&(Mo=fetch(`${Ze}token_templates.json`).then(async e=>e.ok?e1(await e.json()):new Map).catch(()=>new Map)),Mo}let Oo=null;function No(){return Oo===null&&(Oo=(async()=>{try{const e=await fetch(`${Ze}token_embed_index.json`);if(!e.ok)return null;const t=u1(await e.json()),n=await ht("token_embed.onnx");return n===null?null:{session:n,index:t}}catch{return null}})()),Oo}const H$=.92;let zo=null;function Bo(){return zo===null&&(zo=(async()=>{try{return(await fetch(`${Ze}guild_classifier.onnx`,{method:"HEAD"})).ok?await ht("guild_classifier.onnx"):null}catch{return null}})()),zo}let Po=null;function Do(){return Po===null&&(Po=(async()=>{try{return(await fetch(`${Ze}laurel_digit.onnx`,{method:"HEAD"})).ok?await ht("laurel_digit.onnx"):null}catch{return null}})()),Po}let Uo=null,Lo=null;function Fo(){return Lo===null&&(Lo=(async()=>{try{return(await fetch(`${Ze}banner_class.onnx`,{method:"HEAD"})).ok?await ht("banner_class.onnx"):null}catch{return null}})()),Lo}async function j$(e,t){if(t.length===0)return t;const n=await Fo();if(n===null)return t;const r=[];for(const i of t)try{const a=U1(i.box,e.width,e.height);if(a===null){r.push(i);continue}const o=un(e,a.x,a.y,a.w,a.h),s=L1(o),u=await n.run({[n.inputNames[0]]:new Ue("float32",s,[1,3,sn,sn])});F1(u[n.outputNames[0]].data).rejected||r.push(i)}catch{r.push(i)}return r}function Go(){return Uo===null&&(Uo=(async()=>{try{return(await fetch(`${Ze}laurel_filter.onnx`,{method:"HEAD"})).ok?await ht("laurel_filter.onnx"):null}catch{return null}})()),Uo}async function K$(e,t,n){let[r,i,a,o]=t,s=a-r,u=o-i;if(s<=0||u<=0)return null;if(s<Gn){const w=Math.floor((r+a)/2);r=w-Math.floor(Gn/2),a=w+Math.floor(Gn/2),s=a-r}if(u<Gn){const w=Math.floor((i+o)/2);i=w-Math.floor(Gn/2),o=w+Math.floor(Gn/2),u=o-i}const l=Math.trunc(km*s),d=Math.trunc(km*u),p=Math.max(0,r-l),h=Math.max(0,i-d),m=Math.min(e.width,a+l),g=Math.min(e.height,o+d),y=un(e,p,h,m-p,g-h);if(y.width<=0||y.height<=0)return null;try{const w=N1(y),b=await n.run({[n.inputNames[0]]:new Ue("float32",w,[1,3,on,on])});return z1(b[n.outputNames[0]].data)}catch{return null}}let Wo=null;function qo(){return Wo===null&&(Wo=(async()=>{try{return(await fetch(`${Ze}coin_filter_cnn.onnx`,{method:"HEAD"})).ok?await ht("coin_filter_cnn.onnx"):null}catch{return null}})()),Wo}let Vo=null;function Ho(){return Vo===null&&(Vo=(async()=>{try{return(await fetch(`${Ze}coin_denom.onnx`,{method:"HEAD"})).ok?await ht("coin_denom.onnx"):null}catch{return null}})()),Vo}async function Y$(e,t,n){if(t.length===0)return[];try{const r=[];for(const u of t){const l=Nm(e,Math.round(u.cx),Math.round(u.cy),Math.round(u.r));if(l===null)return null;r.push(l)}const i=new Float32Array(t.length*3*gt*gt);r.forEach((u,l)=>i.set(u,l*u.length));const o=(await n.run({[n.inputNames[0]]:new Ue("float32",i,[t.length,3,gt,gt])}))[n.outputNames[0]].data,s=Kr.length;return t.map((u,l)=>o2(o.subarray(l*s,l*s+s)))}catch{return null}}async function X$(e,t,n){if(t.length===0)return[];try{const r=async u=>{const l=[];for(let m=0;m<t.length;m++){const g=Nm(e,Math.round(t[m].cx),Math.round(t[m].cy),Math.round(u[m]));if(g===null)return null;l.push(g)}const d=new Float32Array(t.length*3*gt*gt);l.forEach((m,g)=>d.set(m,g*m.length));const h=(await n.run({[n.inputNames[0]]:new Ue("float32",d,[t.length,3,gt,gt])}))[n.outputNames[0]].data;return t.map((m,g)=>i2(h.subarray(g*2,g*2+2)))},i=await r(t.map(u=>u.r));if(i===null)return null;const a=t.map(u=>u.r).sort((u,l)=>u-l),o=a.length%2===1?a[(a.length-1)/2]:(a[a.length/2-1]+a[a.length/2])/2,s=Math.trunc(o);if(s>=8){const u=await r(t.map(()=>s));if(u!==null)return i.map((l,d)=>Math.max(l,u[d]))}return i}catch{return null}}let jo=null;function Ko(){return jo===null&&(jo=(async()=>{try{return(await fetch(`${Ze}tuck_classifier.onnx`,{method:"HEAD"})).ok?await ht("tuck_classifier.onnx"):null}catch{return null}})()),jo}const Xm=.1;let Yo=null;function ni(){return Yo===null&&(Yo=(async()=>{try{return(await fetch(`${Ze}track_band_brut.onnx`,{method:"HEAD"})).ok?await ht("track_band_brut.onnx"):null}catch{return null}})()),Yo}async function Qm(e,t,n){try{const r=Wr(t,1280,Aw(t.width,t.height,n)),a=(await e.run({[e.inputNames[0]]:new Ue("float32",r.tensor,[1,3,1280,1280])}))[e.outputNames[0]];return Yf(a.data,a.dims[1]??0,a.dims[2]??0,r.params,Xm)}catch{return[]}}let Xo=null;const Q$=.4;function Z$(e,t){const n=Math.min(e.x+e.width,t.x+t.width)-Math.max(e.x,t.x),r=Math.min(e.y+e.height,t.y+t.height)-Math.max(e.y,t.y);if(n<=0||r<=0)return 0;const i=e.width*e.height;return i>0?n*r/i:0}function J$(e,t){const n=[],r=[];for(const i of t){if(!i.builtWithCardUnderneath)continue;i.boundingBox&&n.push(i.boundingBox);const a=i.tuckRegion;a&&r.push(a)}return n.length===0&&r.length===0?e:e.filter(i=>{const a=i.boundingBox;if(!a)return!0;const o=a.x+a.width/2,s=a.y+a.height/2;for(const u of n)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height||Z$(a,u)>=Q$)return!1;for(const u of r)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height)return!1;return!0})}function Qo(){return Xo===null&&(Xo=(async()=>{try{return(await fetch(`${Ze}tuck_box.onnx`,{method:"HEAD"})).ok?await ht("tuck_box.onnx"):null}catch{return null}})()),Xo}let Zo=null;function Jo(){return Zo===null&&(Zo=(async()=>{try{return(await fetch(`${Ze}wonder_classifier.onnx`,{method:"HEAD"})).ok?(await ex(),await ht("wonder_classifier.onnx")):null}catch{return null}})()),Zo}let Zm=!1;async function ex(){if(Zm)return;const e=await(await fetch(`${Ze}wonder_classifier_seuil.json`)).json();_1(Number(e.seuil)),b1(e.classes),Zm=!0}let Jm=null,eg=null;async function tx(e){var p;Jm??(Jm=ht("wonder_obb.onnx"));const t=await Jm;if(t===null)return null;const n=await Ao();if(n===null)return null;eg=n;const{tensor:r,params:i}=Wr(e,1024),o=(await t.run({[t.inputNames[0]]:new Ue("float32",r,[1,3,1024,1024])}))[t.outputNames[0]],s=o.dims[o.dims.length-1],u=o.data;let l=0;for(let h=0;h<s;h++){const m=u[4*s+h];m>l&&(l=m)}const d=c$(n,u,s,i);return ut.set("wonder_obb.onnx",`${ut.get("wonder_obb.onnx")??"?"} | dims=${o.dims} scoreMax=${l.toFixed(4)} dets=${d.length} q0=${(p=d[0])!=null&&p.quad[0]?JSON.stringify(d[0].quad[0].map(Math.round)):"-"} img=${e.width}x${e.height} scale=${i.scale.toFixed(4)} pad=${i.padX},${i.padY}`),d.map(h=>h.quad.map(m=>[m[0],m[1]]))}const nx={wonderRef:D$,tuckClassifier:Ko,tuckBoxClassifier:Qo,obbQuads:tx,redresserQuad:(e,t)=>h$(eg,e,t)};async function rx(e,t){const n=await No();if(n!==null)try{const r=c1(e),i=new Ue("float32",r,[4,3,an,an]),o=(await n.session.run({image:i}))[n.session.outputNames[0]].data,{id:s,cosine:u}=p1(n.index,d1(o));return u<H$?["",-1]:[s,u]}catch{}return i1(e,t)}const tg=new WeakMap;async function ri(e){const t=tg.get(e);if(t!==void 0)return await t;const n=Je("decodage image",()=>ix(e));return tg.set(e,n),await n}async function ix(e){let t;try{t=await createImageBitmap(e)}catch(n){const r=e.name||"(sans nom)",i=e.type||"(type inconnu)",a=e.size===0?"le fichier est VIDE (0 octet) — la capture a probablement été interrompue":/heic|heif/i.test(i)||/\.hei[cf]$/i.test(r)?"format HEIC/HEIF : ce navigateur ne sait pas le décoder — régler l'appareil photo sur JPEG (« Plus compatible » sur iPhone), ou repasser par la galerie qui convertit":"le fichier n'est plus lisible : s'il vient de l'appareil photo, l'OS a pu l'invalider pendant que l'app était en arrière-plan — reprendre la photo devrait suffire";throw new Error(`Image illisible (${r}, ${i}, ${e.size} octets) : ${a}. [${n instanceof Error?n.name:String(n)}]`)}try{const r=new OffscreenCanvas(t.width,t.height).getContext("2d",{willReadFrequently:!0});if(r===null)throw new Error("OffscreenCanvas 2D context unavailable.");r.drawImage(t,0,0);const{data:i}=r.getImageData(0,0,t.width,t.height);return{width:t.width,height:t.height,channels:4,data:i}}finally{t.close()}}const ng=new WeakMap;async function Dt(e,t){let n=ng.get(t);n===void 0&&(n=new Map,ng.set(t,n));const r=n.get(e);if(r!==void 0)return await r;const i=ax(e,t);return n.set(e,i),await i}async function ax(e,t){const n=at[e],r=performance.now(),{tensor:i,params:a}=Wr(t,n.input);So+=performance.now()-r;const o=async()=>{const s=await C$(e),u={[s.inputNames[0]]:new Ue("float32",i,[1,3,n.input,n.input])},l=performance.now(),d=await s.run(u),p=performance.now()-l;pr+=p,vo(p),hr+=1;const h=d[s.outputNames[0]];return{rows:new Float32Array(h.data),params:a}};try{return await o()}catch(s){if(ei.has(e))throw s;return ei.add(e),Jr.delete(e),await o()}}const ox=6,sx=4,ux=5,lx=2;async function cx(e){const t={kind:"unknown",confidence:0,banners:null,laurels:null,coins:null,pawnFound:!1},n=await ri(e),r=await Dt("banner",n),i=qr(r.rows,r.params,at.banner.conf);if(t.banners=i.length,i.length>=ox)return{...t,kind:"player",confidence:Math.min(1,i.length/12)};const a=await Dt("laurel",n),o=ao(a.rows,a.params,at.laurel.conf);if(t.laurels=o.length,o.length>=sx)return{...t,kind:"player",confidence:Math.min(1,o.length/8)};const s=await Dt("coin",n),u=jf(s.rows,s.params,at.coin.conf);return t.coins=u.length,u.length>=ux?{...t,kind:"player",confidence:.5}:t.banners!==null&&t.banners<=lx?{...t,kind:"board",confidence:.4}:t}function dx(){return{wonders:[],guilds:[],progressTokens:[],laurels:[],cardVictoryPoints:{value:0,laurelsKept:0,laurelsUnread:0,complete:!0},cardCounts:{byFamily:{},source:"none",tuckedExcluded:0},coins:{total:0,confidence:0,source:"none",coins:[]}}}async function rg(e,t,n,r,i,a,o,s){let u=0;r(`${i}: card banners…`,.04);const l=await Dt("banner",e);let d=qr(l.rows,l.params,at.banner.conf);d=await j$(e,d),r(`${i}: progress tokens…`,.08);let p=[];const h=await ni();h!==null&&(p=await Qm(h,e,d)),p.length>0&&d.length>0&&(d=d.filter(Y=>{const J=Y.box[0]+Y.box[2]/2,ae=Y.box[1]+Y.box[3]/2;return!p.some(([pe,Ae,me,ie])=>Math.min(pe,me)<=J&&J<=Math.max(pe,me)&&Math.min(Ae,ie)<=ae&&ae<=Math.max(Ae,ie))}));const m=await Dt("token",e),g=await V$(),y=[],w=[];for(const Y of Gw(m.rows,m.params,at.token.conf)){if(w.push({cx:Y.cx,cy:Y.cy,r:Y.r}),p.some(([pe,Ae,me,ie])=>Y.cx>=pe&&Y.cx<=me&&Y.cy>=Ae&&Y.cy<=ie))continue;const[J,ae]=await rx(tm(e,Y),g);J===""&&ae<0?w.pop():J===""?u+=1:!y.some(pe=>pe.id===J)&&!s.some(pe=>pe.id===J)&&y.push({id:J,center:[Y.cx,Y.cy],radius:Y.r,confidence:Math.round(ae*1e4)/1e4})}r(`${i}: coins…`,.14);const b=await Dt("coin",e),x=jf(b.rows,b.params,at.coin.conf).filter(Y=>!w.some(J=>(Y.cx-J.cx)**2+(Y.cy-J.cy)**2<=Y.r*Y.r)),S=await qo(),v=S!==null?await X$(e,x,S):null,T=(v!==null?x.filter((Y,J)=>v[J]>=Om).map(Y=>Y.r):[]).sort((Y,J)=>Y-J),M=T.length>0?T.length%2===1?T[(T.length-1)/2]:(T[T.length/2-1]+T[T.length/2])/2:null,[k,E]=r2,R=x.map((Y,J)=>{const ae=v!==null?v[J]:null;return ae===null||ae>=Om?"keep":M!==null&&M>0&&Y.r/M>=k&&Y.r/M<=E?"suspect":"drop"}),P=x.filter((Y,J)=>R[J]==="keep"),X=f_(e,P),W=await Ho(),V=W!==null?await Y$(e,P,W):null,O=s2(X,V??X.map(()=>null));O.map(Y=>Y.value);const F=[];let K=0;if(x.forEach((Y,J)=>{if(R[J]==="drop")return;if(R[J]==="suspect"){const pe=v[J];F.push({denomination:null,center:[Y.cx,Y.cy],radius:Y.r,suspect:!0,suspectReason:`content rejected as non-coin (P=${pe.toFixed(2)}) but the size matches this photo's confirmed coins — glare-blinded real coin OR a look-alike object; confirm or remove (a busy table warrants a cleaner photo)`});return}const ae=O[K++];F.push({denomination:ae.value,center:[Y.cx,Y.cy],radius:Y.r,denomSource:ae.source??"colour"})}),x.length>0&&F.length===0&&t.push({code:"LOW_CONFIDENCE",message:`${n}: ${x.length} disque(s) rond(s) détecté(s) mais tous rejetés comme non-pièces (0 pièce comptée) — vérifie, ou reprends une photo plus nette.`}),F.length>=2){const Y=F.map(ae=>ae.radius).sort((ae,pe)=>ae-pe),J=Y.length%2===1?Y[(Y.length-1)/2]:(Y[Y.length/2-1]+Y[Y.length/2])/2;if(J>0)for(const ae of F)ae.radius/J>2&&(ae.suspect=!0,ae.suspectReason=`radius ${ae.radius}px is ${(ae.radius/J).toFixed(1)}x the photo's median coin radius — probably not a coin`)}if(F.length>=2)for(let Y=0;Y<F.length;Y+=1)for(let J=Y+1;J<F.length;J+=1){const ae=F[Y],pe=F[J],Ae=Math.hypot(ae.center[0]-pe.center[0],ae.center[1]-pe.center[1]);if(Ae<1.1*Math.min(ae.radius,pe.radius))for(const me of[ae,pe])me.suspect||(me.suspect=!0,me.suspectReason=`almost concentric with another coin (${Ae.toFixed(0)}px apart) — either a pile of two coins or a duplicate read of one; confirm which`)}const Q=[],ue=[],L=[],B=Date.now()+P$;let A=null;const N=[];let D=!1;const U={n:0},j=await Jo();if(j!==null&&(A=await Je("opencv.js (chargement)",()=>Ao()),A!==null)){r(`${i}: identifying wonders…`,.35);const Y=await Je("identifyWondersByClassifier",()=>T$(nx,A,e,j,B,d,[],U));for(const J of Y)Q.some(ae=>ae.id===J.obj.id)||o.some(ae=>ae.id===J.obj.id)||(Q.push(J.obj),N.push({obj:J.obj,edgeScores:J.edgeScores,zone:J.zone}),ue.push(J.zone),L.push({quad:J.quad,region:J.region}));D=Y.length>0}if(!D){const Y=ib(N.map(J=>({built:J.obj.builtWithCardUnderneath,edgeScores:J.edgeScores,zone:J.zone})),d.map(J=>[J.box[0]+J.box[2]/2,J.box[1]+J.box[3]/2]));for(const J of Y){const ae=N[J];ae.obj.builtWithCardUnderneath=!1,t.push({code:"INCONSISTENT_STATE",message:`${n}: wonder '${ae.obj.id}' was NOT marked built — the card-under-wonder signal saturated on this surface and no tucked card banner supports it. Tick it in the review if it really was built.`})}if(d.length>0){const J=new Set(Y);for(let ae=0;ae<N.length;ae++){const pe=N[ae];if(J.has(ae)||!pe.obj.builtWithCardUnderneath)continue;const Ae=pe.obj.tuckRegion;if(Ae===void 0)continue;if(!d.some(ie=>{const Ie=ie.box[0]+ie.box[2]/2,Oe=ie.box[1]+ie.box[3]/2;return Ie>=Ae.x&&Ie<=Ae.x+Ae.width&&Oe>=Ae.y&&Oe<=Ae.y+Ae.height})){const ie=pe.obj;ie.builtWithCardUnderneath=!1,ie.suspect=!0,ie.suspectReason="built-unconfirmed"}}}}const re=async()=>{let Y=Q.slice();const J=[];d.forEach((ie,Ie)=>{const Oe=ie.box[0]+ie.box[2]/2,ee=ie.box[1]+ie.box[3]/2;ue.some(de=>Oe>=de.x0&&Oe<=de.x1&&ee>=de.y0&&ee<=de.y1)||J.push(Ie)});const ae=[],pe=[];Y.forEach((ie,Ie)=>{const Oe=ie.boundingBox;Oe&&Oe.width>0&&(ae.push(Ie),pe.push([Oe.x,Oe.y,Oe.width,Oe.height]))});const Ae=ie=>{const Ie=[];return ie.forEach((Oe,ee)=>{const de=Oe.box[0]+Oe.box[2]/2,fe=Oe.box[1]+Oe.box[3]/2;ue.some(Te=>de>=Te.x0&&de<=Te.x1&&fe>=Te.y0&&fe<=Te.y1)||Ie.push(ee)}),Ie};let me=Bm(d.map(ie=>ie.box),J,pe,p,[e.width,e.height]);try{const ie=U2(e.width,e.height,d.map(Ie=>Ie.box),me.hulls.map(([Ie,Oe],ee)=>({owner:Ie,poly:Oe,n:me.hullBoxCounts[ee]??0})),pe);if(ie.length>0){const Ie=go(d.map(ee=>ee.box)),Oe=[];for(const ee of ie){const[de,fe,Te,$e]=ee,_e=un(e,de,fe,Te-de,$e-fe);if(_e.width<=0||_e.height<=0)continue;const Me=await Dt("banner",_e);for(const ye of qr(Me.rows,Me.params,at.banner.conf)){const tt=L2(ye.box,ee,Ie);tt&&Oe.push({...ye,box:tt})}}if(Oe.length>0){const ee=Qf([...d,...Oe]);ee.length>d.length&&(d=ee,me=Bm(d.map(de=>de.box),Ae(d),pe,p,[e.width,e.height]))}}}catch(ie){console.warn("[#129 city-rescan] skipped:",ie)}return a!==void 0&&(a.hulls=me.hulls.map(([ie,Ie],Oe)=>({owner:ie,poly:Ie,n:me.hullBoxCounts[Oe]??0})),a.bandBoxes=p,a.image=e),{split:me,photoWonders:Y,splitWonderIdx:ae}};let te=null;try{te=await re()}catch(Y){console.warn("[city-split] failed (side unfiltered):",Y)}return{bannerDetections:d,photoCoins:F,photoTokenDiscs:w,discs:x,bandBoxes:p,bandSession:h,wonderFootprints:ue,wonderTuckGates:L,photoTokensList:y,geo:te,cv:A,regDeadline:B,unidentifiedTokens:u}}async function ig(e,t,n,r,i,a,o,s,u,l){let d=e.bannerDetections,p=e.cv;const{photoCoins:h,photoTokenDiscs:m,discs:g,bandBoxes:y,bandSession:w,wonderFootprints:b,wonderTuckGates:x,photoTokensList:S,geo:v,regDeadline:T}=e,M={},k=[],E=[];let R=0;const P=[];let X=0,W=0;const V=[],O=[],F=[],K=t==="opponent";let Q=(ee,de)=>!K,ue=(ee,de)=>!K,L=null;if(v!==null)try{const{split:ee,photoWonders:de,splitWonderIdx:fe}=v;Q=(Me,ye)=>ee.pointOwner(Me,ye)==="opponent"===K;const Te=K?"opponent":"player";if(ue=(Me,ye)=>ee.pointOwner(Me,ye)===Te,n){const Me=ee;L=ye=>new Set(E2(ye,Me,Te,y))}d=d.filter((Me,ye)=>ee.bannerOwner[ye]==="opponent"===K);const $e=de.map(()=>"player");fe.forEach((Me,ye)=>{$e[Me]=ee.wonderOwner[ye]});const _e=[];de.forEach((Me,ye)=>{$e[ye]==="opponent"===K&&_e.push(Me)});for(const Me of _e)O.push(Me);b.length=0;for(const Me of _e){const ye=Me.tuckRegion??Me.boundingBox;ye&&b.push({x0:ye.x,y0:ye.y,x1:ye.x+ye.width,y1:ye.y+ye.height})}for(const Me of S)Q(Me.center[0],Me.center[1])&&F.push(Me)}catch(ee){console.warn("[city-split] failed (side unfiltered):",ee)}const B=L!==null?L(h):null;for(const ee of h)(B!==null?!B.has(ee):!ue(ee.center[0],ee.center[1]))||(R+=ee.denomination??0,E.push(ee));const A=new Set,N=[],D=go(d.map(ee=>ee.box));x.forEach((ee,de)=>{if(ee.quad===null||ee.region===null){const _e=b[de];_e&&N.push(_e);return}const fe=ee.region,Te=[];d.forEach((_e,Me)=>{const ye=_e.box[0]+_e.box[2]/2,tt=_e.box[1]+_e.box[3]/2;ye>=fe.x&&ye<=fe.x+fe.width&&tt>=fe.y&&tt<=fe.y+fe.height&&Te.push([Me,_e.box])});const $e=n2(ee.quad,Te,D);$e!==null&&A.add($e)});let U=[],j=0;d.forEach((ee,de)=>{if(A.has(de)){W+=1,j+=1;return}const fe=ee.box[0]+ee.box[2]/2,Te=ee.box[1]+ee.box[3]/2;if(N.some($e=>fe>=$e.x0&&fe<=$e.x1&&Te>=$e.y0&&Te<=$e.y1)){W+=1,j+=1;return}U.push(ee)});const re=Y1(U,j,y,a.width,a.height);U=re.kept;for(const ee of U)M[ee.family]=(M[ee.family]??0)+1,X+=1;const te=Zw(U),Y=new Set(te.map(ee=>ee.box.join(",")));for(const ee of e_(U))Y.has(ee.box.join(","))||(te.push(ee),Y.add(ee.box.join(",")));for(const ee of re.suspects)Y.has(ee.box.join(","))||(te.push(ee),Y.add(ee.box.join(",")));for(const ee of te)V.push(ee);if(U.some(ee=>ee.family==="guild")){const ee=await Bo();if(ee!==null){s(`${u}: identifying guilds…`,.75);for(const de of U)if(de.family==="guild")try{const[fe,Te,$e,_e]=de.box,Me=un(a,fe,Te,$e,_e),ye=m1(Me),tt={[ee.inputNames[0]]:new Ue("float32",ye,[1,3,Fn,Fn])},qe=(await ee.run(tt))[ee.outputNames[0]].data,{id:We,prob:ft}=g1(qe);We!==""&&!P.some(kt=>kt.id===We)&&!l.some(kt=>kt.id===We)&&P.push({id:We,boundingBox:{x:fe,y:Te,width:$e,height:_e},confidence:Math.round(ft*1e4)/1e4})}catch(fe){console.warn("[guild-cls] failed:",fe)}}else if(Date.now()<T)try{const de=p??await Ao();if(de!==null){const fe=await U$();if(fe.size>0){s(`${u}: identifying guilds…`,.75);const Te=await L$();for(const $e of qb(de,a,fe,T,Te))!P.some(_e=>_e.id===$e.id)&&!l.some(_e=>_e.id===$e.id)&&P.push($e)}}}catch(de){console.warn("[guilds-reg] failed:",de)}}s(`${u}: laurels…`,.8);const ae=await Je("laurier: chargement galerie gabarits",()=>F$()),pe=[];for(const ee of[0]){const de=ee===0?a:rn(a,ee),fe=await Je("laurier: passe PLEINE photo",()=>Dt("laurel",de));for(const[Te,$e,_e,Me]of rt("laurier: decodage YOLO (JS)",()=>ao(fe.rows,fe.params,at.laurel.conf))){const ye=Ym({x:Te,y:$e,width:_e-Te,height:Me-$e},ee,a.width,a.height);pe.push([ye.x,ye.y,ye.x+ye.width,ye.y+ye.height])}}let Ae=rt("laurier: dedup",()=>Kf(pe));const me=[];try{const ee=X2(d.map(de=>de.box),[a.width,a.height]);ut.set("_tta.onnx",`total=${_o.total} idDiff=${_o.idDiff} verdictDiff=${_o.verdictDiff}`),ut.set("_marge2.onnx",`total=${Pt.total} pos4=${Pt.positifs4} pos2=${Pt.positifs2} divergent=${Pt.divergent} `+Pt.detail.slice(0,10).join(" | ")),ut.set("_ttaObb.onnx",`total=${Zr.total} memeK=${Zr.memeK} inv=${Zr.memeKInverse} `+Zr.detail.slice(0,12).join(" ")),ut.set("_tuilage.onnx",`groupes=? tuiles=${ee.length} bannieres=${d.length} image=${a.width}x${a.height}`);for(const[de,fe,Te,$e]of ee){const _e=un(a,de,fe,Te-de,$e-fe);if(_e.width<=0||_e.height<=0)continue;const Me=[];for(const ye of[0]){const tt=ye===0?_e:rn(_e,ye),Ye=await Je("laurier: passe par TUILE (#113)",()=>Dt("laurel",tt));for(const[qe,We,ft,kt]of rt("laurier: decodage YOLO (JS)",()=>ao(Ye.rows,Ye.params,at.laurel.conf))){const ot=Ym({x:qe,y:We,width:ft-qe,height:kt-We},ye,_e.width,_e.height);Me.push([ot.x,ot.y,ot.x+ot.width,ot.y+ot.height])}}if(Ae=Q2(Ae,Kf(Me),[de,fe]),w!==null)try{const ye=await Je("laurier: bande de piste sur tuile (#114)",async()=>{const qe=Wr(_e,1280,ur);return{sortie:await w.run({[w.inputNames[0]]:new Ue("float32",qe.tensor,[1,3,1280,1280])}),params:qe.params}}),tt={params:ye.params},Ye=ye.sortie[w.outputNames[0]];for(const[qe,We,ft,kt]of Yf(Ye.data,Ye.dims[1]??0,Ye.dims[2]??0,tt.params,Xm))me.push([qe+de,We+fe,ft+de,kt+fe])}catch{}}}catch(ee){console.warn("[laurel-containers] failed:",ee)}const ie=[...y,...me];Ae=Ae.filter(([ee,de,fe,Te])=>!e$((ee+fe)/2,(de+Te)/2,ie,d.map($e=>$e.box)));const[Ie,Oe]=await Je("laurier: 1er contact des 2 ResNet (89,6 Mo)",()=>Promise.all([Do(),Go()]));for(const[ee,de,fe,Te]of Ae){const $e=Math.trunc((ee+fe)/2),_e=Math.trunc((de+Te)/2);if([...m,...g].some(Ge=>($e-Ge.cx)**2+(_e-Ge.cy)**2<=Ge.r*Ge.r)||!Q($e,_e))continue;if(Oe!==null){const Ge=await Je("laurier: filtre FP (#49)",()=>K$(a,[Math.trunc(ee),Math.trunc(de),Math.trunc(fe),Math.trunc(Te)],Oe));if(Ge!==null&&Ge>=O1)continue}const ye=Math.min(Math.trunc(fe-ee),Math.trunc(Te-de)),tt=Math.max(6,Math.trunc(Math.max(fe-ee,Te-de)*b_)),Ye=G$(a,$e,_e,tt);let qe=null,We=0,ft=!1;if(Ie!==null&&ye>=6){const Ge=un(a,Math.trunc(ee),Math.trunc(de),Math.trunc(fe-ee),Math.trunc(Te-de));let je=null,yt=0;for(const Ct of[0,1,2,3]){const Yt=Ct===0?Ge:rn(Ge,Ct),ns=C1(Yt),rs=await Je("laurier: lecture chiffre (CNN)",()=>Ie.run({[Ie.inputNames[0]]:new Ue("float32",ns,[1,3,zt,zt])})),{value:is,prob:oi}=A1(rs[Ie.outputNames[0]].data);if(oi>yt&&(je=is,yt=oi),je!==null&&yt>=k1)break}je!==null&&yt>=M1&&(qe=je,We=yt)}if(qe===null&&ye>=6){const Ge=new Map;for(const je of[0,1,2,3]){const yt=je===0?Ye:rn(Ye,je),[Ct,Yt]=rt("laurier: lecteur GABARITS (repli, JS pur)",()=>N_(yt,ae));Ct!==null&&(Ge.set(Ct,Math.max(Ge.get(Ct)??0,Yt)),Yt>We&&(qe=Ct,We=Yt))}qe!==null&&We<B$&&(qe=null),ft=qe!==null&&[...Ge.entries()].some(([je,yt])=>je!==qe&&yt>=We-.1)}const kt=b.some(Ge=>$e>=Ge.x0&&$e<=Ge.x1&&_e>=Ge.y0&&_e<=Ge.y1),ot=[...P,...l].some(Ge=>{const je=Ge.boundingBox;return je!==void 0&&$e>=je.x&&$e<=je.x+je.width&&_e>=je.y&&_e<=je.y+je.height});k.push({value:qe,valueRead:qe!==null,center:[Math.round((ee+fe)/2),Math.round((de+Te)/2)],boundingBox:{x:Math.trunc(ee),y:Math.trunc(de),width:Math.trunc(fe-ee),height:Math.trunc(Te-de)},confidence:Math.round(We*1e4)/1e4,excluded:kt||ot,photoIndex:i-1,...ft?{suspect:!0,suspectReason:"orientation-ambiguous"}:{}})}return{byFamily:M,laurels:k,coins:E,coinTotal:R,guilds:P,bannerCount:X,tuckedExcluded:W,bannerSuspects:V,cityWondersKept:O,cityTokensKept:F}}function ag(){return{byFamily:{},laurels:[],coins:[],progressTokens:[],wonders:[],guilds:[],bannerSuspects:[],coinTotal:0,unidentifiedTokens:0,bannerCount:0,tuckedExcluded:0}}function og(e,t){for(const n of t.cityWondersKept)e.wonders.push(n);for(const n of t.cityTokensKept)e.progressTokens.push(n);for(const n of t.coins)e.coins.push(n);e.coinTotal+=t.coinTotal;for(const n of t.laurels)e.laurels.push(n);for(const n of t.guilds)e.guilds.push(n);for(const n of t.bannerSuspects)e.bannerSuspects.push(n);e.bannerCount+=t.bannerCount,e.tuckedExcluded+=t.tuckedExcluded;for(const[n,r]of Object.entries(t.byFamily))e.byFamily[n]=(e.byFamily[n]??0)+r}function sg(e,t,n){const{byFamily:r,laurels:i,coins:a,progressTokens:o,wonders:s,guilds:u,bannerSuspects:l,coinTotal:d,unidentifiedTokens:p,bannerCount:h,tuckedExcluded:m}=e;m>0?n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: ${m} banner(s) near a wonder were excluded as tucked/consumed (estimated footprint — the server uses the real card box); verify the per-colour counts.`}):h>0&&s.length===0&&n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: no wonder was located on this photo, so a card tucked under a wonder may still be counted — verify the per-colour counts.`});const g=r.guild??0;g!==u.length?n.push({code:"INCONSISTENT_STATE",message:`${t}: ${g} purple banner(s) counted but ${u.length} guild(s) identified — reconcile in the review (stacked guilds or a missed identification).`}):u.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: guild(s) identified by their card art: `+u.map(S=>S.id).join(", ")+" — confirm in the review."});const y=s.filter(S=>S.boundingBox.width===0);if(y.length>0?n.push({code:"LOW_CONFIDENCE",message:`${t}: wonder(s) identified by name but NOT registered against their reference (${y.map(S=>S.name).join(", ")}) — their BUILT flag is a suggestion: unselect any that was not built.`}):s.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: ${s.length} wonder(s) registered — the BUILT flags were measured (card protruding underneath); confirm in the review.`}),p>0&&n.push({code:"UNRECOGNIZED_OBJECT",message:`${t}: ${p} token disc(s) found but not identified — pick them in the review below.`}),o.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: progress token(s) identified on-device: `+o.map(S=>S.id).join(", ")+" — confirm in the review."}),a.length>0){const S=a.filter(T=>T.denomSource==="cnn").length,v=a.length-S;n.push({code:"LOW_CONFIDENCE",message:v===0?`${t}: coins read as ${d} from ${a.length} tile(s) by the learned denomination model — confirm the total.`:`${t}: coins read as ${d} from ${a.length} tile(s) — ${S} by the learned model, ${v} by metal COLOUR alone (the model abstained); confirm the total.`})}const w=J$(u,s);for(const S of[...t$(s.map(v=>v.id),t),...i$(w.map(v=>v.id),t)])n.push({code:"INCONSISTENT_STATE",message:S.message});const b=i.filter(S=>!S.excluded),x=b.filter(S=>S.valueRead);return{...dx(),wonders:s,guilds:w,progressTokens:o,laurels:i,cardVictoryPoints:{value:x.reduce((S,v)=>S+(v.value??0),0),laurelsKept:b.length,laurelsUnread:b.length-x.length,complete:b.length===x.length},cardCounts:{byFamily:r,source:h>0?"yolo":"none",tuckedExcluded:m,...l.length>0?{suspects:l}:{}},coins:{total:d,confidence:a.length>0?.5:0,source:a.length===0?"none":a.some(S=>S.denomSource==="cnn")?"local-cnn":"local-colour",coins:a}}}async function px(e,t,n,r,i=()=>{},a="player",o,s=!1){const u=ag();let l=0;for(const d of e){l+=1;const p=`${t} photo ${l}/${e.length}`;r(`${p}: reading pixels…`,.01);const h=await ri(d),m=await rg(h,n,t,r,p,o,u.wonders,u.progressTokens);u.unidentifiedTokens+=m.unidentifiedTokens;const g=await ig(m,a,s,t,l,h,n,r,p,u.guilds);og(u,g),i()}return sg(u,t,n)}const Mt=1280,hx=.3,ii=9;let es=null;function ai(){return es===null&&(es=(async()=>{try{return(await fetch(`${Ze}pawn_ends_brut.onnx`,{method:"HEAD"})).ok?await ht("pawn_ends_brut.onnx"):null}catch{return null}})()),es}function fx(e){const t=Mt/Math.max(e.width,e.height),n=Math.round(e.width*t),r=Math.round(e.height*t),i=new OffscreenCanvas(e.width,e.height),a=i.getContext("2d",{willReadFrequently:!0}),o=Tw(e.data,e.width,e.height,e.channels);a.putImageData(new ImageData(o,e.width,e.height),0,0);const u=new OffscreenCanvas(Mt,Mt).getContext("2d",{willReadFrequently:!0});u.fillStyle="rgb(114,114,114)",u.fillRect(0,0,Mt,Mt),u.drawImage(i,0,0,e.width,e.height,0,0,n,r);const{data:l}=u.getImageData(0,0,Mt,Mt),d=Mt*Mt,p=new Float32Array(3*d);for(let h=0;h<d;h+=1)p[h]=l[h*4]/255,p[d+h]=l[h*4+1]/255,p[2*d+h]=l[h*4+2]/255;return{tensor:p,r:t}}const He={appels:0,inferences:0,bandes:0,detail:[],premiereGagne:null};function mx(){He.appels=0,He.inferences=0,He.bandes=0,He.detail=[],He.premiereGagne=null}function ug(){ut.set("_pion.onnx",`appels=${He.appels} inferences=${He.inferences} bandes=${He.bandes} premiereGagne=${He.premiereGagne??"n/a"} | ${He.detail.join(" ")}`)}async function lg(e,t){He.inferences+=1;const{tensor:n,r}=rt("pion: mise en tenseur 1280x1280",()=>fx(t)),a=(await e.run({[e.inputNames[0]]:new Ue("float32",n,[1,3,Mt,Mt])}))[e.outputNames[0]],o=a.data,s=a.dims[2]??0,u=(a.dims[1]??4)-4;return rt("pion: depouillement des ancres brutes",()=>{const d=new Map;for(let p=0;p<u;p+=1){const h=(4+p)*s;let m=-1,g=hx;for(let y=0;y<s;y+=1){const w=o[h+y];w>=g&&(g=w,m=y)}if(m>=0){const y=(o[m]+o[2*s+m])/2/r,w=(o[s+m]+o[3*s+m])/2/r;d.set(p,{conf:g,cx:y,cy:w})}}return d})}async function ts(e,t,n){const r=He.inferences,i=`a${He.appels}`;He.appels+=1;const a=await Je("pion: UNE passe (les 4 rotations)",()=>gx(e,t,n));return He.detail.push(`${i}:${He.inferences-r}inf conf=${a===null?"rien":a.confidence.toFixed(2)}`),ug(),a}async function gx(e,t,n){let r=null;const i=1.8;for(const S of n??[0,1,2,3]){const v=S===0?t:rt("pion: rotation de l'image",()=>rn(t,S)),T=await lg(e,v);if(T.has(0)&&T.has(1)&&T.has(2)){const M=T.get(0).conf+T.get(1).conf+T.get(2).conf;if((r===null||M>r.score)&&(r={score:M,det:T,k:S}),M>=i)break}}if(r===null)for(const S of n??[0,1,2,3]){const v=S===0?t:rn(t,S),T=await lg(e,v);if(T.has(1)&&T.has(2)){const M=T.get(1).conf+T.get(2).conf;(r===null||M>r.score)&&(r={score:M,det:T,k:S})}}if(r===null)return null;const a=!r.det.has(0),o=r.det.get(0)??{conf:0,cx:0,cy:0},s=r.det.get(1),u=r.det.get(2),l=u.cx-s.cx,d=u.cy-s.cy,p=(s.cx+u.cx)/2,h=(s.cy+u.cy)/2,m=l*l+d*d;if(m<=0)return null;const g=((o.cx-p)*l+(o.cy-h)*d)/m*(2*ii),y=a?0:Math.min(ii,Math.max(-ii,it(g))),w=a?0:Math.min(o.conf,s.conf,u.conf),b=(S,v)=>{const T=r.k%4;return T===0?[S,v]:T===1?[v,t.height-1-S]:T===2?[t.width-1-S,t.height-1-v]:[t.width-1-v,S]},x=[s,u].map(S=>{const[v,T]=b(S.cx,S.cy);return[it(v),it(T)]});return{position:y,confidence:Math.round(w*1e4)/1e4,ends:x,k:r.k,found:!a}}async function cg(e,t,n){let r=null,i=null;for(const a of n){const o=Rw(t.width,t.height,a);if(o===null)continue;const s=un(t,o.x,o.y,o.width,o.height);if(s.width===0||s.height===0)continue;He.bandes+=1;const u=await ts(e,s,i===null?void 0:[i]);u!==null&&i===null&&(i=u.k),u!==null&&(He.premiereGagne===null?He.premiereGagne=!0:r!==null&&u.confidence>r.confidence&&(He.premiereGagne=!1),ug()),u!==null&&(r===null||u.confidence>r.confidence)&&(r={...u,ends:u.ends.map(([l,d])=>[l+o.x,d+o.y])})}return r}function dg(){const e=[No,Bo,Do,Fo,Go,qo,Ho,Ko,ni,Qo,Jo,ai];for(const t of e)try{Promise.resolve(t()).catch(()=>{})}catch{}}async function yx(e,t){dg();const n=[{code:"LOW_CONFIDENCE",message:"On-device mode: everything is recognised locally — card counts, coin denominations, laurel values, wonders, guilds and token identities, with the same models as the server. What still deserves a look is COMPLETENESS: an object the detector never saw cannot be corrected by any of them, so check the totals against the table."}],r={left:null,right:null},i=e.left.length+e.right.length+(e.both!==void 0?2:0);let a=0;const o=(m,g=0)=>{t(m,i>0?Math.min(.99,(a+g)/i):void 0)},s=()=>{a+=1};for(const m of["left","right"]){const g=e[m];g.length>0&&(r[m]=await px(g,m,n,o,s))}let u=null,l=null;if(e.both!==void 0){const m={},g=await ri(e.both),y=await rg(g,n,"both",o,"both photo 1/1",m,[],[]),w=async(S,v)=>{const T=ag();return T.unidentifiedTokens+=y.unidentifiedTokens,og(T,await ig(y,S,!0,v,1,g,n,o,`${v} photo 1/1`,T.guilds)),s(),sg(T,v,n)},b={player:await w("player","left"),opponent:await w("opponent","right")};if(o("military pawn…",.95),m.image!==void 0)try{const S=await ai();S!==null&&(m.bandBoxes!==void 0&&m.bandBoxes.length>0&&(u=await cg(S,m.image,m.bandBoxes)),u===null&&(u=await ts(S,m.image)))}catch(S){console.warn("[#125] both-photo pawn read failed:",S)}u!==null&&(l=Pw(u.ends,m.hulls??[],u.position));const x=l!==null&&!l.ambiguous?Dw(l):null;x!==null?(r.left=b[x.left],r.right=b[x.right],n.push({code:"AMBIGUOUS_OWNER",message:`Both-players photo: LEFT and RIGHT were derived from the MILITARY BOARD geometry (each track end paired with the city it is the capital of), which overrides the cluster-dominance guess — favored ${l.favoredOwner}, pawn at ${u.position}. Swap them in the review only if this is wrong.`})):(r.left=b.player,r.right=b.opponent,n.push({code:"AMBIGUOUS_OWNER",message:"Both-players photo: the DOMINANT city was assigned to the left player and the opposing city to the right — swap them in the review if the seating is the other way around."}))}{const m={},g={};for(const y of["left","right"]){const w=r[y];w!=null&&(m[y]=w.wonders.map(b=>b.id),g[y]=w.progressTokens.map(b=>b.id))}for(const y of[...n$(m),...r$(g)])n.push({code:"INCONSISTENT_STATE",message:y.message})}let d={conflictPawnPosition:0,found:!1,confidence:0};if(e.board!==void 0)try{const m=await ri(e.board),g=await ai();if(g!==null){let y=await ts(g,m);if(y===null){const w=await ni();if(w!==null){const b=await Dt("banner",m),x=qr(b.rows,b.params,at.banner.conf),S=await Qm(w,m,x);y=await cg(g,m,S)}}y!==null&&(d={conflictPawnPosition:y.position,found:!0,confidence:y.confidence},n.push({code:"AMBIGUOUS_OWNER",message:`Conflict pawn read at position ${y.position} — confirm which player it favours (the sign is a convention, not read from the photo).`}))}}catch(m){console.warn("[pawn] on-device read failed:",m)}else u!==null&&l!==null&&(d={conflictPawnPosition:u.position,found:u.found,confidence:u.confidence});if(!d.found){const m=b=>{var x,S;return Number(((S=(x=b==null?void 0:b.cardCounts)==null?void 0:x.byFamily)==null?void 0:S.military)??0)},g=m(r.left),y=m(r.right),w=Math.abs(g-y);n.push({code:"MILITARY_PAWN_NOT_FOUND",message:w>=3?`The conflict pawn was NOT read, so the military score is 0 — but one city has ${g} military cards and the other ${y}. A gap that wide almost never leaves the pawn in the middle: set its position below, it is very likely worth points.`:"The conflict pawn was not read — the military score is 0 by default, not by measurement. Set its position below if the pawn is off-centre."})}const p=d.conflictPawnPosition,h=Math.abs(p)>=ii?{type:"military",winner:p>0?"left":"right"}:{type:"civilian"};return{imageId:e.imageId,players:r,militaryTrack:d,outcome:h,confidence:.5,warnings:n}}self.onmessage=e=>{const{id:t,kind:n}=e.data;let r=null;const i=(a,o)=>{I$(a);const s=k$()?"Initialisation des modèles de vision…":Sw(a);self.postMessage({id:t,progress:s,...o!==void 0?{fraction:o}:{},...a!==r?{perfPartiel:{providers:Wm(),etapes:Gm(),etapeCourante:s}}:{}}),r=a};(async()=>{try{if(n==="ping"){self.postMessage({id:t,ok:!0,result:{pong:!0}});return}if(n==="prechauffer"){dg(),await Promise.allSettled([No(),Bo(),Do(),Fo(),Go(),qo(),Ho(),Ko(),ni(),Qo(),Jo(),ai()]),self.postMessage({id:t,ok:!0,result:{prechauffe:!0}});return}n==="recognize"&&i("starting the on-device engine…",0),E$(),O$();const a=performance.now(),o=n==="classify"?await cx(e.data.file):await yx(e.data.payload,i);self.postMessage({id:t,ok:!0,result:o,perf:{etapes:Gm(),providers:Wm(),runtime:M$(),inference:R$(),famillesJs:_w(),inferenceParEtape:A$(),totalMs:Math.round(performance.now()-a)}})}catch(a){self.postMessage({id:t,ok:!1,error:String(a)})}})()}})();
