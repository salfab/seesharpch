...
`)},type:p,offsetToIndices:v,indicesToOffset:k,broadcastedIndicesToOffset:G,indices:S,indicesGet:R,indicesSet:B,set:(...C)=>{if(C.length!==o+1)throw new Error(`indices length must be ${o}`);let z=C[o];if(typeof z!="string")throw new Error("value must be string");let U=C.slice(0,o).map(f).join(",");return o===0?q("0u",z):o===1?q(U[0],z):(m.set=!0,m.setByIndices=!0,m.indicesToOffset=!0,`set_${e}(${U}, ${z})`)},setByOffset:q,setByIndices:(C,z)=>o<2?q(C,z):(m.setByIndices=!0,m.indicesToOffset=!0,`set_${e}ByIndices(${C}, ${z});`),get:Z,getByOffset:N,getByIndices:le,usage:r,name:e,strides:b,shape:w,rank:o}},K=(e,t,n,r=1)=>er(e,t,n,"input",r),de=(e,t,n,r=1)=>er(e,t,n,"output",r),ju=(e,t,n)=>er(e,t,n,"atomicOutput",1),oo=(e,t,n,r=1)=>er(e,t,n,"internal",r),Ku=class{constructor(e,t){this.normalizedDispatchGroup=e,this.limits=t,this.internalVariables=[],this.variables=[],this.uniforms=[],this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(e){return`if (global_idx >= ${typeof e=="number"?`${e}u`:e}) { return; }`}mainStart(e=Pn){let t=typeof e=="number"?e:e[0],n=typeof e=="number"?1:e[1],r=typeof e=="number"?1:e[2];if(t>this.limits.maxComputeWorkgroupSizeX||n>this.limits.maxComputeWorkgroupSizeY||r>this.limits.maxComputeWorkgroupSizeZ)throw new Error(`workgroup size [${t}, ${n}, ${r}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(t*n*r>this.limits.maxComputeInvocationsPerWorkgroup)throw new Error(`workgroup size [${t}, ${n}, ${r}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let i=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,a=i?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Yu=(e,t)=>new Ku(e,t)}),Xu,ao,Qu,Zu,Ju,el,pt,tl,nl,on=re(()=>{be(),$e(),Ve(),ve(),Xu=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},ao=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Qu=(e,t)=>V.sortBasedOnPerm(e,ao(e.length,t)),Zu=(e,t,n,r)=>{let i=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let a=0;a<t;++a)i+=`a[${e[a]}]=i[${a}];`;return i+="return a;}"},Ju=(e,t)=>{let n=[],r=[];for(let i=0;i<e.length;++i)e[i]!==1&&n.push(e[i]),e[t[i]]!==1&&r.push(t[i]);return{newShape:n,newPerm:r}},el=(e,t)=>{let n=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<n)return!1;n=e[r]}return!0},pt=(e,t)=>{let n=e.dataType,r=e.dims.length,i=ao(r,t),a=Qu(e.dims,i),o=e.dims,s=a,u=r<2||el(i,e.dims),l;if(u)return l=m=>{let y=K("input",n,o,4),w=de("output",n,s,4);return`
  ${m.registerUniform("output_size","u32").declareVariables(y,w)}
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let m=V.size(a);return{outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(m/4)}]}},getShaderSource:l};let{newShape:c,newPerm:d}=Ju(e.dims,i),p=V.areEqual(d,[2,3,1]),f=V.areEqual(d,[3,1,2]);if(c.length===2||p||f){o=p?[c[0],c[1]*c[2]]:f?[c[0]*c[1],c[2]]:c,s=[o[1],o[0]];let m=16;return l=y=>{let w=K("a",n,o.length),b=de("output",n,s.length);return`
  ...
  ${m.mainStart()}
    ...
    ${w.setByOffset("global_idx",y.getByIndices("aIndices"))}
       ...
       `,m=y=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Mt=(e,t,n,r)=>{let i=e.inputs.length===1?n:so(e.inputs,n),a=i.axes;a.length===0&&!i.noopWithEmptyAxes&&(a=e.inputs[0].dims.map((f,m)=>m));let o=V.normalizeAxes(a,e.inputs[0].dims.length),s=o,u=e.inputs[0],l=dl(s,e.inputs[0].dims.length);l.length>0&&(u=e.compute(pt(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],s=sl(s.length,u.dims.length));let[c,d]=ul(u.dims,s),p=c;i.keepDims&&(p=ll(c,o)),e.compute(hl(t,i.cacheKey,[u],r,e.inputs[0].dataType,p,d),{inputs:[u]})},pl=(e,t)=>{Mt(e,"ReduceMeanShared",t,"mean")},fl=(e,t)=>{Mt(e,"ReduceL1Shared",t,"l1")},ml=(e,t)=>{Mt(e,"ReduceL2Shared",t,"l2")},gl=(e,t)=>{Mt(e,"ReduceLogSumExpShared",t,"logSumExp")},yl=(e,t)=>{Mt(e,"ReduceMaxShared",t,"max")},wl=(e,t)=>{Mt(e,"ReduceMinShared",t,"min")},bl=(e,t)=>{Mt(e,"ReduceProdShared",t,"prod")},_l=(e,t)=>{Mt(e,"ReduceSumShared",t,"sum")},xl=(e,t)=>{Mt(e,"ReduceSumSquareShared",t,"sumSquare")},$l=(e,t)=>{Mt(e,"ReduceLogSumShared",t,"logSum")}}),St,vl,Or,so,It,Ml,Sl,Il,Tl,El,kl,Cl,Al,Rl,Ol,Tt,Nl,zl,Bl,Pl,Dl,Ul,Ll,Fl,Gl,Wl,uo=re(()=>{be(),$e(),Ve(),ve(),Yy(),St=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},vl=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Or=(e,t,n,r,i,a,o=!1,s=!1)=>{let u=[],l=n[0].dims,c=l.length,d=V.normalizeAxes(i,c),p=!s&&d.length===0;l.forEach((y,w)=>{p||d.indexOf(w)>=0?o&&u.push(1):u.push(y)});let f=u.length,m=V.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let w=[],b=K("_A",n[0].dataType,c),x=de("output",a,f),M=r(b,x,d),v=M[2];for(let I=0,E=0;I<c;I++)p||d.indexOf(I)>=0?(o&&E++,v=`for(var j${I}: u32 = 0; j${I} < ${l[I]}; j${I}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${o}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:x,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...fe(a)]:[{type:12,data:u}]})}},ec=e=>Oe(e),tc=(e,t)=>{let{inputs:n,outputCount:r}=e,i=ec({...t,outputCount:r});if(ze.webgpu.validateInputContent&&Zl(n,i),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Jl(n,i))}}),nc,rc,ic,Zy=re(()=>{$e(),ve(),nc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},rc=e=>{let t=e[0].dims,n=e[0].dims[2],r=V.size(t)/4,i=e[0].dataType,a=K("input",i,t,4),o=K("bias",i,[n],4),s=K("residual",i,t,4),u=de("output",i,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
  ...
  }`}},ic=e=>{nc(e.inputs),e.compute(rc(e.inputs))}}),oc,Re,ac,sc,uc,lc,cc,dc,hc,pc,fc,mc,gc,yc,wc,bc,nr,_c,zr,xc,$c,vc,Mc,Sc,Ic,Tc,Ec,kc,Cc,Ac,Rc,Oc,Nc,zc,Bc,po,Pc,fo,mo,Dc,Uc,Lc,Fc,Gc,Wc,go=re(()=>{be(),$e(),Ve(),ve(),oc=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),u="";typeof i=="string"?u=`${i}(a)`:u=i("a");let l=K("inputData",n,[s],4),c=de("outputData",r,[s],4),d=[{name:"vec_size",type:"u32"}];return o&&d.push(...o),`
  ...
  }`},Re=(e,t,n,r,i,a=e.dataType,o,s)=>{let u=[{type:12,data:Math.ceil(V.size(e.dims)/4)}];return o&&u.push(...o),{name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:l=>oc(l,V.size(e.dims),e.dataType,a,n,r,s),getRunData:l=>({outputs:[{dims:e.dims,dataType:a}],dispatchGroup:{x:Math.ceil(V.size(l[0].dims)/64/4)},programUniforms:u})}},ac=e=>{e.compute(Re(e.inputs[0],"Abs","abs"))},sc=e=>{e.compute(Re(e.inputs[0],"Acos","acos"))},uc=e=>{e.compute(Re(e.inputs[0],"Acosh","acosh"))},lc=e=>{e.compute(Re(e.inputs[0],"Asin","asin"))},cc=e=>{e.compute(Re(e.inputs[0],"Asinh","asinh"))},dc=e=>{e.compute(Re(e.inputs[0],"Atan","atan"))},hc=e=>{e.compute(Re(e.inputs[0],"Atanh","atanh"))},pc=e=>Oe(e),fc=(e,t)=>{let n;switch(t.to){case 10:n="vec4<f16>";break;case 1:n="vec4<f32>";break;case 12:n="vec4<u32>";break;case 6:n="vec4<i32>";break;case 9:n="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Re(e.inputs[0],"Cast",n,void 0,t.cacheKey,t.to))},mc=e=>{let t,n,r=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=i?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Oe({min:t,max:n})},gc=(e,t)=>{let n=t||mc(e.inputs),r=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Clip",i=>`clamp(${i}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},yc=e=>{e.compute(Re(e.inputs[0],"Ceil","ceil"))},wc=e=>{e.compute(Re(e.inputs[0],"Cos","cos"))},bc=e=>{e.compute(Re(e.inputs[0],"Cosh","cosh"))},nr=e=>Oe(e),_c=(e,t)=>{let n=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,xc=e=>{let t=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,zr(t)))},$c=e=>{e.compute(Re(e.inputs[0],"Exp","exp"))},vc=e=>{e.compute(Re(e.inputs[0],"Floor","floor"))},Mc=e=>{let t=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,zr(t)))},Sc=(e,t)=>{let n=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},Ic=e=>{e.compute(Re(e.inputs[0],"Not",t=>`!${t}`))},Tc=e=>{e.compute(Re(e.inputs[0],"Neg",t=>`-${t}`))},Ec=e=>{e.compute(Re(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},kc=e=>{let t=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},Cc=e=>{e.compute(Re(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Ac=e=>Oe(e),Rc=(e,t)=>{let n=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},Oc=e=>{e.compute(Re(e.inputs[0],"Sin","sin"))},Nc=e=>{e.compute(Re(e.inputs[0],"Sinh","sinh"))},zc=e=>{e.compute(Re(e.inputs[0],"Sqrt","sqrt"))},Bc=e=>{e.compute(Re(e.inputs[0],"Tan","tan"))},po=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Pc=e=>{e.compute(Re(e.inputs[0],"Tanh",po))},fo=(e="f32")=>`
...
`,mo=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Dc=e=>{let t=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"FastGelu",mo,fo(t),void 0,e.inputs[0].dataType))},Uc=(e,t)=>{let n=rt(e.inputs[0].dataType);return e.compute(Re(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Lc=e=>{e.compute(Re(e.inputs[0],"Log","log"))},Fc=(e,t)=>`
...
`,Gc=e=>`quick_gelu_impl(${e})`,Wc=(e,t)=>{let n=rt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"QuickGelu",Gc,Fc(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),qc,Vc,Hc,Jy=re(()=>{$e(),ve(),go(),qc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Vc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=K("input",e[0].dataType,e[0].dims,4),r=K("bias",e[0].dataType,[e[0].dims[2]],4),i=de("output",e[0].dataType,t,4),a=V.size(t)/4,o=Qe(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:s=>`
  ...
  ${s.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ed=e=>{Et(e,"Sub",(t,n)=>`${t}-${n}`)},td=e=>{Et(e,"Greater",{scalar:(t,n)=>`u32(${t}>${n})`,vector:(t,n)=>`vec4<u32>(${t}>${n})`},void 0,void 0,9)},nd=e=>{Et(e,"Less",{scalar:(t,n)=>`u32(${t}<${n})`,vector:(t,n)=>`vec4<u32>(${t}<${n})`},void 0,void 0,9)},rd=e=>{Et(e,"GreaterOrEqual",{scalar:(t,n)=>`u32(${t}>=${n})`,vector:(t,n)=>`vec4<u32>(${t}>=${n})`},void 0,void 0,9)},id=e=>{Et(e,"LessOrEqual",{scalar:(t,n)=>`u32(${t}<=${n})`,vector:(t,n)=>`vec4<u32>(${t}<=${n})`},void 0,void 0,9)}}),od,ad,sd,ud,ld,cd,tw=re(()=>{be(),$e(),Ve(),ve(),od=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let n=0,r=e[n],i=r.dataType,a=r.dims.length;e.forEach((o,s)=>{if(s!==n){if(o.dataType!==i)throw new Error("input tensors should be one type");if(o.dims.length!==a)throw new Error("input tensors should have the same shape");o.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},ad=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,sd=(e,t)=>{let n=e.length,r=[];for(let i=0;i<n;++i){let a=t.setByOffset("global_idx",e[i].getByIndices("indices"));n===1?r.push(a):i===0?r.push(`if (inputIndex == ${i}u) { ${a} }`):i===n-1?r.push(`else { ${a} }`):r.push(`else if (inputIndex == ${i}) { ${a} }`)}return r.join(`
`)},ud=(e,t,n,r)=>{let i=V.size(n),a=new Array(e.length),o=new Array(e.length),s=0,u=[],l=[],c=[{type:12,data:i}];for(let y=0;y<e.length;++y)s+=e[y].dims[t],a[y]=s,l.push(e[y].dims.length),o[y]=K(`input${y}`,r,l[y]),u.push("rank"),c.push({type:12,data:a[y]});for(let y=0;y<e.length;++y)c.push(...fe(e[y].dims));c.push(...fe(n));let d=de("output",r,n.length),p=d.indicesGet("indices",t),f=Array.from(Array(a.length).keys()).map(y=>`uniforms.sizeInConcatAxis${y}`).join(","),m=y=>`
  ...
  ${y.mainStart()}
    ...
    ${sd(o,d)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}),getShaderSource:m}},ld=(e,t)=>{let n=e.inputs,r=n[0].dims,i=V.normalizeAxis(t.axis,r.length);od(n,i);let a=r.slice();a[i]=n.reduce((s,u)=>s+(u.dims.length>i?u.dims[i]:0),0);let o=n.filter(s=>V.size(s.dims)>0);e.compute(ud(o,i,a,n[0].dataType),{inputs:o})},cd=e=>Oe({axis:e.axis})}),xn,$n,vn,yo,Mn=re(()=>{be(),$e(),xn=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},$n=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},vn=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},yo=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[n,r]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=(e==null?void 0:e.activation_params)||[Ou,Nu];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:n}}return{activation:t}}}),Je,dd,wo=re(()=>{Je=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},dd=e=>`
...
`}),rr,bo,_o=re(()=>{be(),$e(),ve(),Mn(),rr=(e,t,n,r,i)=>{let a=r-n;return`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${d};${p};${f};${i}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:x}),getShaderSource:M}}}),pd,fd,xo,$o,md,vo,gd,Br,Mo=re(()=>{be(),$e(),ve(),Mn(),_o(),wo(),pd=(e,t)=>e?`
        ...
        }`,xo=(e,t,n="f32",r,i=!1,a=32,o=!1,s=32)=>{let u=t[1]*e[1],l=t[0]*e[0],c=i?u:a,d=i?a:u,p=c/t[0],f=a/t[1];if(!((i&&p===4&&e[1]===4||!i&&(p===3||p===4))&&c%t[0]===0&&a%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
`},gd=(e,t,n,r,i=!1)=>{let[a,o,s,u]=r,l=Qe(r[0].type.tensor);return`
  ...
  ${y?xo(w,b,X,F):vo(w,b,X,F)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${L}>`:L}) {
        ...
        ${O}
        ${yd(l,R,B,Y,o,t,G[0],G[1],G[2],L)}
        ${y?xo(M,x,L,void 0,!l,S):vo(M,x,L,void 0,!l,S,!1,void 0,s)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${y};${R};${B};${Y};${E};${k};${S}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(n):n,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:q}),getShaderSource:F}}}),bd,So,ir,_d,Io,xd,$d,vd,iw=re(()=>{be(),jt(),$e(),ve(),Mn(),wo(),bd=e=>{let t=1;for(let n=0;n<e.length;n++)t*=e[n];return t},So=e=>typeof e=="number"?[e,e,e]:e,ir=(e,t)=>t<=1?e:e+(e-1)*(t-1),_d=(e,t,n,r=1)=>{let i=ir(t,r);return Math.floor((e[0]*(n-1)-n+i)/2)},Io=(e,t,n,r,i)=>{i==null&&(i=_d(e,t[0],r[0]));let a=[0,0,0,n];for(let o=0;o<3;o++)e[o]+2*i>=t[o]&&(a[o]=Math.trunc((e[o]-t[o]+2*i)/r[o]+1));return a},xd=(e,t,n,r,i,a,o,s,u,l)=>{let c,d,p,f;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=Io([t,n,r,1],[s,u,l],1,[i,a,o],e);d=m[0],p=m[1],f=m[2]}else if(Array.isArray(e)){if(!e.every((y,w,b)=>y===b[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=Io([t,n,r,1],[s,u,l],1,[i,a,o],e[0]);d=m[0],p=m[1],f=m[2]}else if(e==="SAME_UPPER"){d=Math.ceil(t/i),p=Math.ceil(n/a),f=Math.ceil(r/o);let m=(d-1)*i+s-t,y=(p-1)*a+u-n,w=(f-1)*o+l-r,b=Math.floor(m/2),x=m-b,M=Math.floor(y/2),v=y-M,I=Math.floor(w/2),E=w-I;c={top:M,bottom:v,left:I,right:E,front:b,back:x}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:d,outHeight:p,outWidth:f}},$d=(e,t,n,r,i,a=!1,o="channelsLast")=>{let s,u,l,c,d;if(o==="channelsLast")[s,u,l,c,d]=e;else if(o==="channelsFirst")[s,d,u,l,c]=e;else throw new Error(`Unknown dataFormat ${o}`);let[p,,f,m,y]=t,[w,b,x]=So(n),[M,v,I]=So(r),E=ir(f,M),k=ir(m,v),S=ir(y,I),{padInfo:R,outDepth:B,outHeight:Y,outWidth:G}=xd(i,u,l,c,w,b,x,E,k,S),q=a?p*d:p,N=[0,0,0,0,0];return o==="channelsFirst"?N=[s,q,B,Y,G]:o==="channelsLast"&&(N=[s,B,Y,G,q]),{batchSize:s,dataFormat:o,inDepth:u,inHeight:l,inWidth:c,inChannels:d,outDepth:B,outHeight:Y,outWidth:G,outChannels:q,padInfo:R,strideDepth:w,strideHeight:b,strideWidth:x,filterDepth:f,filterHeight:m,filterWidth:y,effectiveFilterDepth:E,effectiveFilterHeight:k,effectiveFilterWidth:S,dilationDepth:M,dilationHeight:v,dilationWidth:I,inShape:e,outShape:N,filterShape:t}},vd=(e,t,n,r,i,a)=>{let o=a==="channelsLast";o?e[0].dims[3]:e[0].dims[1];let s=[64,1,1],u={x:n.map((w,b)=>b)},l=[Math.ceil(bd(u.x.map(w=>n[w]))/s[0]),1,1];Ce("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let c=1,d=V.size(n),p=[{type:12,data:d},{type:12,data:r},{type:12,data:i},{type:12,data:t.strides},{type:12,data:t.dilations}];$n(t,p),p.push(...fe(e[0].dims,e[1].dims));let f=["rank","rank"],m=e.length===3;m&&(p.push(...fe(e[2].dims)),f.push("rank")),p.push(...fe(n));let y=w=>{let b=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:i.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];vn(t,b);let x=1,M=Qe(e[0].dataType),v=K("x",e[0].dataType,e[0].dims.length,c),I=K("W",e[1].dataType,e[1].dims.length,x),E=[v,I],k=de("result",e[0].dataType,n.length,x),S="";if(m){let Y=K("bias",e[2].dataType,e[2].dims.length,x);E.push(Y),S+=`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${a};${o};${p};${l[0]};${l[1]}`,inputDependencies:i?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:f}}}),Id,Pr,Td,Dr,To,Eo,Ed,kd,ko,aw=re(()=>{$e(),rw(),iw(),Mo(),ow(),Mn(),_o(),on(),Id=(e,t,n,r,i,a)=>{let o=e[0],s=e.slice(a?1:2,a?3:4),u=s.length,l=t[0],c=t.slice(2).map((p,f)=>p+(p-1)*(n[f]-1)),d=s.map((p,f)=>p+r[f]+r[f+u]).map((p,f)=>Math.floor((p-c[f]+i[f])/i[f]));return d.splice(0,0,o),d.splice(a?3:1,0,l),d},Pr=[2,3,1,0],Td=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Dr=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let a=2;a<t[1].dims.length;++a)n[a-2]===0&&(n[a-2]=t[1].dims[a]);let r=e.pads.slice();kr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:n,pads:r}),i},To=e=>{let t=yo(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,a=e.group,o=e.kernel_shape,s=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,pads:s,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Eo=(e,t,n,r)=>{let i=n.format==="NHWC",a=Id(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,i);if(n.group!==1){let E=[t[0]];if(i){let k=e.kernelCustomData.wT??e.compute(pt(t[1],Pr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=k),E.push(k)}else E.push(t[1]);t.length===3&&E.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&i&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(Sd(E,n,a,r),{inputs:E}):e.compute(Md(E,n,a,r),{inputs:E});return}let o=t.length===3,s=t[0].dims[i?1:2],u=t[0].dims[i?2:3],l=t[0].dims[i?3:1],c=t[1].dims[2],d=t[1].dims[3],p=a[i?1:2],f=a[i?2:3],m=a[i?3:1],y=i&&c===s&&d===u&&n.pads[0]===0&&n.pads[1]===0;if(y||c===1&&d===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let E=a[0],k,S,R,B=[];if(i){let q=e.kernelCustomData.wT??e.compute(pt(t[1],Pr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=q),y){let N=s*u*l;k=t[0].reshape([1,E,N]),S=q.reshape([1,N,m]),R=[1,E,m]}else k=t[0].reshape([E,s*u,l]),S=q.reshape([1,l,m]),R=[E,p*f,m];B.push(k),B.push(S)}else k=t[0].reshape([E,l,s*u]),S=t[1].reshape([1,m,l]),R=[E,m,p*f],B.push(S),B.push(k);o&&B.push(t[2]);let Y=R[2],G=B[0].dims[B[0].dims.length-1];Y<8&&G<8?e.compute(bo(B,n,a,R,i,r),{inputs:B}):e.compute(Br(B,n,a,R,i,r),{inputs:B});return}let w=!0,b=e.kernelCustomData.wT??e.compute(pt(t[1],Pr),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let x=[t[0],b];o&&x.push(t[2]);let M=i?p*f:m,v=i?m:p*f,I=c*d*l;e.compute(wd(x,n,a,M,v,I,o,w,r),{inputs:x})},Ed=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),o=[1].concat(t.dilations),s=[1].concat(t.kernelShape),u=Dr({...t,pads:i,strides:a,dilations:o,kernelShape:s},r);Eo(e,r,u,l=>n?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},kd=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",i=Dr(n,t),a=n.autoPad==="NOTSET"?n.pads:n.autoPad,o=$d(t[0].dims,t[1].dims,n.strides,n.dilations,a,!1,r);e.compute(vd(t,i,o.outShape,[o.filterDepth,o.filterHeight,o.filterWidth],[o.padInfo.front,o.padInfo.top,o.padInfo.left],r))},ko=(e,t)=>{if(Td(e.inputs,t),e.inputs[0].dims.length===3)Ed(e,t);else if(e.inputs[0].dims.length===5)kd(e,e.inputs,t);else{let n=Dr(t,e.inputs);Eo(e,e.inputs,n)}}}),Cd,sw=re(()=>{be(),jt(),$e(),ve(),Cd=(e,t,n)=>{let r=e.length>2,i=t.outputShape,a=t.format==="NHWC",o=t.group,s=e[1].dims,u=s[2]/o,l=s[3],c=a?We(u):1,d=a&&l===1&&u>=4,p=d?Math.floor(u/4)*4:Math.floor(u/c)*c,f=u-p,m=a?We(l):1,y=a?l===1?c:m:1,w=V.size(i)/m,b=[Math.ceil(w/64),1,1];Ce("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${b}`);let x=["rank","rank"],M=[t.strides[0],t.strides[1]],v=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],I=[t.dilations[0],t.dilations[1]],E=[v[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),v[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],k=[E[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),E[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],S=[{type:12,data:w},{type:12,data:M},{type:12,data:v},{type:12,data:I},{type:12,data:E},{type:6,data:k},{type:12,data:p},{type:12,data:u},{type:12,data:l},...fe(e[0].dims,e[1].dims)];r&&(S.push(...fe(e[2].dims)),x.push("rank")),S.push(...fe(i));let R=B=>{let Y=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:M.length},{name:"filter_dims",type:"u32",length:v.length},{name:"dilations",type:"u32",length:v.length},{name:"effective_filter_dims",type:"u32",length:E.length},{name:"pads",type:"i32",length:k.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],G=Qe(e[0].dataType),q=a?1:2,N=a?2:3,F=a?3:1,X=K("W",e[1].dataType,e[1].dims.length,y),Z=K("Dy",e[0].dataType,e[0].dims.length,c),le=[Z,X];r&&le.push(K("bias",e[2].dataType,[i[F]].length,m));let L=de("result",e[0].dataType,i.length,m),O=()=>{let U="";if(d)c===4?U+=`
...
`)};
    ...
    ${m}`},c=[{type:12,data:u},...fe(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},nh=e=>{Jd(e.inputs),e.compute(th(e.inputs),{inputs:[0]})}}),rh,ih,pw=re(()=>{be(),$e(),ve(),go(),rh=e=>{let t=e[0].dataType,n=V.size(e[0].dims),r=V.size(e[1].dims),i=r%4===0,a=o=>{let s=K("x",t,[1],4),u=K("bias",t,[1],4),l=de("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=f=>`
  ...
  ${p.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((f,m)=>m!==1).map(f=>f.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(f,m)=>"rank")},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:p}},fh=(e,t)=>{let n=e.inputs;hh(n,t),e.compute(ph(e.inputs,t))},mh=e=>Oe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),gh,yh,wh,bh,yw=re(()=>{be(),$e(),Ve(),ve(),gh=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},yh=(e,t)=>{let n=e[0].dims,r=e[0].dataType,i=n.length,a=e[1].dims,o=e[1].dataType,s=V.normalizeAxis(t.axis,i),u=n[s],l=a.slice(0),c=V.size(l),d=K("input",r,i),p=K("indicesInput",o,a.length),f=de("output",r,l.length),m=[{type:12,data:c},{type:6,data:u},{type:12,data:s}];return m.push(...fe(n,a,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:m}),getShaderSource:y=>`
...
`,Ch=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:c},{inputs:[t,n],outputs:[-1]})[0]},ar=(e,t,n,r,i,a,o,s)=>{let u=a;if(o&&V.size(o.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Bh(e,a,o,t,r,n*i,s),u=u.reshape([t,r,n,i]),n===1||r===1?u:e.compute(pt(u,zo.perm),{inputs:[u],outputs:[-1]})[0]}else return a.dims.length===3&&(u=a.reshape([t,r,n,i])),n===1||r===1?u:e.compute(pt(u,zo.perm),{inputs:[u],outputs:[-1]})[0]},Ph=(e,t)=>{let n=Nh(e.inputs,t),r=e.inputs[0],i=ot(e.inputs,1),a=ot(e.inputs,2),o=ot(e.inputs,3),s=ot(e.inputs,4),u=ot(e.inputs,5),l=ot(e.inputs,6),c=ot(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if((i==null?void 0:i.dims.length)===5)throw new Error("Packed KV is not implemented");let d=i&&a&&i.dims.length===4&&a.dims.length===4,p=ar(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,o,0);if(d)return tr(e,p,i,a,s,void 0,l,c,u,n);if(!i||!a)throw new Error("key and value must be provided");let f=ar(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,i,o,n.hiddenSize),m=ar(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,o,2*n.hiddenSize);tr(e,p,f,m,s,void 0,l,c,u,n)}}),Uh,Lh,Fh,Gh,Bo,Wh,qh,Vh=re(()=>{be(),$e(),Ve(),ve(),Uh=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Lh=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>n.push(Number(i))),r=n.length),Oe({numOutputs:r,axis:t.axis,splitSizes:n})},Fh=e=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:a},getRunData:()=>({outputs:[{dims:o,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},Zh=(e,t)=>{var v;let n=Yh(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((v=e.inputs[1])==null?void 0:v.dims.length)===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=Oe({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,c*n.headSize,c*n.headSize]}),[p,f,m]=!i&&!a?e.compute(Bo([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],y,w;if(t.doRotary){let I=e.compute(Qh(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],E=e.inputs[7],k=e.inputs[8],S=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),R=[p,I,E,k],B=[-1];y=e.compute(Lr(R,S),{inputs:R,outputs:B})[0],R.splice(0,1,f);let Y=Oe({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});w=e.compute(Lr(R,Y),{inputs:R,outputs:B})[0]}let b=ar(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?y:p,void 0,0),x=Po(e,t.doRotary?w:f,n),M=Po(e,m,n);tr(e,b,x,M,void 0,void 0,o,s,void 0,n,u,l)}}),Do,Jh,ep,tp,xw=re(()=>{be(),$e(),on(),ve(),Do=(e,t,n,r,i,a,o,s)=>{let u=We(a),l=u===1?"f32":`vec${u}f`,c=u===1?"vec2f":`mat2x${u}f`,d=i*o,p=64;d===1&&(p=256);let f=[i,o,a/u],m=[i,o,2],y=["rank","type","type"],w=[];w.push(...fe(f,m));let b=x=>{let M=K("x",t.dataType,3,u),v=K("scale",n.dataType,n.dims),I=K("bias",r.dataType,r.dims),E=de("output",1,3,2),k=[M,v,I,E];return`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${s};${p}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:w}),getShaderSource:b},{inputs:[t,n,r],outputs:[-1]})[0]},Jh=(e,t,n)=>{let r=t[0].dims,i=r,a=2,o=r[0],s=r[1],u=V.sizeFromDimension(r,a),l=We(u),c=V.size(i)/l,d=Do(e,t[0],t[1],t[2],o,u,s,n.epsilon),p=[o,s,u/l],f=[o,s],m=["type","none"],y=w=>{let b=K("x",t[0].dataType,p.length,l),x=K("scale_shift",1,f.length,2),M=de("output",t[0].dataType,p.length,l),v=[b,x,M];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:w},{inputs:[t[0],y]})},tp=(e,t)=>{t.format==="NHWC"?ep(e,e.inputs,t):Jh(e,e.inputs,t)}}),np,rp,ip,$w=re(()=>{be(),$e(),ve(),np=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},rp=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,u=V.normalizeAxis(t.axis,i.length),l=V.sizeToDimension(i,u),c=V.sizeFromDimension(i,u),d=V.size(a.dims),p=o?V.size(o.dims):0;if(d!==c||o&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${I.mainStart()}
    ...
    ${x?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},v=[{dims:s,dataType:e[0].dataType}];return b&&v.push({dims:f,dataType:1}),x&&v.push({dims:f,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${n};${r}`,inputDependencies:y},getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:w}),getShaderSource:M}},ip=(e,t)=>{np(e.inputs),e.compute(rp(e.inputs,t,e.outputCount))}}),op,ap,vw=re(()=>{$e(),_o(),Mo(),op=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},ap=e=>{op(e.inputs);let t=Bn.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(bo(e.inputs,{activation:""},t));else{let i=t[t.length-2],a=V.size(e.inputs[0].dims.slice(0,-2)),o=V.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let s=e.inputs[0].reshape([1,a,r]),u=e.inputs[1].reshape([1,r,n]),l=[1,a,n],c=[s,u];e.compute(Br(c,{activation:""},t,l),{inputs:c})}else e.compute(Br(e.inputs,{activation:""},t))}}}),sp,up,lp,cp,dp,Mw=re(()=>{be(),$e(),Ve(),ve(),sp=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!V.areEqual(o.dims,[t.n,i,a]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let s=e[2].dims;if(V.size(s)!==t.n*i)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(V.size(u)!==l)throw new Error("zeroPoints input size error.")}},up=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),u=V.size(s),l=e[1].dims[2]/4,c=e[0].dataType,d=We(t.k),p=We(l),f=We(o),m=s.concat([i,o]),y=i>1&&o/f%2===0?2:1,w=V.size(m)/f/y,b=64,x=[],M=[u,i,a/d],v=V.convertShape(e[1].dims).slice();v.splice(-1,1,l/p),x.push(...fe(M)),x.push(...fe(v)),x.push(...fe(e[2].dims)),e.length===4&&x.push(...fe(V.convertShape(e[3].dims)));let I=[u,i,o/f];x.push(...fe(I));let E=k=>{let S=M.length,R=K("a",e[0].dataType,S,d),B=K("b",12,v.length,p),Y=K("scales",e[2].dataType,e[2].dims.length),G=[R,B,Y],q=e.length===4?K("zero_points",12,e[3].dims.length):void 0;q&&G.push(q);let N=I.length,F=de("output",e[0].dataType,N,f),X=Qe(e[0].dataType),Z=(()=>{switch(d){case 1:return`array<${X}, 8>`;case 2:return`mat4x2<${X}>`;case 4:return`mat2x4<${X}>`;default:throw new Error(`${d}-component is not supported.`)}})(),le=Math.floor(32/t.bits),L=Math.floor(le/8),O=()=>{let U="";for(let P=0;P<L;P++){let j=P*t.bits*4,ie=j+t.bits;U+=`
          // reuse a data (pass ${P})
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${d};${p};${w};${y}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:c}],dispatchGroup:{x:I},programUniforms:E}),getShaderSource:B}},cp=(e,t)=>{sp(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(lp(e.inputs,t)):e.compute(up(e.inputs,t))},dp=e=>Oe(e)}),hp,pp,fp,mp,gp,yp,wp,bp,_p,Sw=re(()=>{be(),$e(),ve(),hp=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},pp=(e,t,n)=>{let r="";for(let i=t-1;i>=0;--i)r+=`
      ...
      `},fp=(e,t,n)=>{let r="";for(let i=t-1;i>=0;--i)r+=`
          ...
          `},yp=(e,t,n)=>{switch(n.mode){case 0:return pp(e,t,n.pads.length);case 1:return fp(e,t,n.pads.length);case 2:return mp(e,t,n.pads.length);case 3:return gp(e,t,n.pads.length);default:throw new Error("Invalid mode")}},wp=(e,t)=>{let n=V.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,i=V.size(n),a=[{type:12,data:i},{type:6,data:t.pads}],o=e.length>=3&&e[2].data;t.mode===0&&a.push({type:o?e[2].dataType:1,data:t.value}),a.push(...fe(e[0].dims,n));let s=["rank"],u=l=>{let c=de("output",e[0].dataType,n.length),d=K("x",e[0].dataType,r.length),p=d.type.value,f=yp(c,r.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:o?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Go=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,xp=e=>`${Go(e)};${e.countIncludePad}`,$p=e=>`${Go(e)};${e.storageOrder};${e.dilations}`,Wo=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),qo=(e,t,n,r)=>{let[i,a]=Uo(t,r,n),o=K("x",t.dataType,t.dims.length),s=o.type.value,u="value += x_val;",l="";i.countIncludePad?l+=`value /= ${s}(uniforms.kernelSize);`:l+=`value /= ${s}(i32(uniforms.kernelSize) - pad);`;let[c,d,p,f,m]=Lo(a,i);c.push(...fe(t.dims,a));let y=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(a)/64)},programUniforms:c}),getShaderSource:w=>Fo(w,o,t.dims.length,a.length,i,u,l,0,d,p,f,m)}},vp=e=>{let t=e.count_include_pad!==0,n=Wo(e);if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...n,cacheKey:""};return{...r,cacheKey:xp(r)}},Mp=(e,t)=>{sr(e.inputs),e.compute(qo("AveragePool",e.inputs[0],!1,t))},Vo={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Sp=e=>{let t=e.format;return{format:t,...Vo,cacheKey:t}},Ip=(e,t)=>{sr(e.inputs),e.compute(qo("GlobalAveragePool",e.inputs[0],!0,t))},Ho=(e,t,n,r)=>{let[i,a]=Uo(t,r,n),o=`
      value = max(x_val, value);
    `,s="",u=K("x",t.dataType,t.dims.length),l=["rank"],[c,d,p,f,m]=Lo(a,i);return c.push(...fe(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(a)/64)},programUniforms:c}),getShaderSource:y=>Fo(y,u,t.dims.length,a.length,i,o,s,t.dataType===10?-65504:-1e5,d,p,f,m)}},Tp=(e,t)=>{sr(e.inputs),e.compute(Ho("MaxPool",e.inputs[0],!1,t))},Ep=e=>{let t=e.storage_order,n=e.dilations,r=Wo(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:n,...r,cacheKey:""};return{...i,cacheKey:$p(i)}},kp=e=>{let t=e.format;return{format:t,...Vo,cacheKey:t}},Cp=(e,t)=>{sr(e.inputs),e.compute(Ho("GlobalMaxPool",e.inputs[0],!0,t))}}),Ap,Rp,Op,Np,Tw=re(()=>{be(),$e(),Ve(),ve(),Ap=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===t.axis||i===e[0].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Rp=(e,t)=>{let n=V.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=V.size(a),u=r===3||r===2,l=u?[Math.ceil(V.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,d=e.length>2?e[2]:void 0,p=d?u?[Math.ceil(V.size(d.dims)/4)]:d.dims:void 0,f=c.length===0||c.length===1&&c[0]===1,m=f===!1&&c.length===1,y=We(s),w=f&&(!u||y===4),b=w?y:1,x=w&&!u?y:1,M=K("input",u?12:r,l.length,x),v=K("scale",o,c.length),I=d?K("zero_point",u?12:r,p.length):void 0,E=de("output",o,a.length,b),k=[M,v];I&&k.push(I);let S=[l,c];d&&S.push(p);let R=[{type:12,data:s/b},{type:12,data:n},{type:12,data:t.blockSize},...fe(...S,a)],B=Y=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/b/64),y:1,z:1},programUniforms:R})}},Op=(e,t)=>{Ap(e.inputs,t),e.compute(Rp(e.inputs,t))},Np=e=>Oe({axis:e.axis,blockSize:e.blockSize})}),zp,Bp,Pp,Ew=re(()=>{mt(),be(),ve(),zp=(e,t,n)=>{let r=e===t,i=e<t&&n<0,a=e>t&&n>0;if(r||i||a)throw new Error("Range these inputs' contents are invalid.")},Bp=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...fe(a)],u=l=>{let c=de("output",r,a.length),d=c.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:d},{name:"delta",type:d}];return`
        ${l.registerUniforms(p).declareVariables(c)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${d}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},Pp=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),ze.webgpu.validateInputContent&&zp(t,n,r),e.compute(Bp(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),Dp,Up,Lp,Fp,kw=re(()=>{be(),$e(),Ve(),ve(),Dp=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
              ...
              ${i}bitcast<${r}>(oldValue) + (${n})${a}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${n}));`:`
                ${i}max(bitcast<f32>(oldValue), (${n}))${a}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${n}));`:`${i}min(bitcast<${r}>(oldValue), (${n}))${a}`;case"mul":return`${i}(bitcast<${r}>(oldValue) * (${n}))${a}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Up=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n,a=1,o=Math.ceil(V.sizeToDimension(r,r.length-1)/a),s=r[r.length-1],u=V.sizeFromDimension(n,s),l=[{type:12,data:o},{type:12,data:s},{type:12,data:u},...fe(e[1].dims,e[2].dims,i)],c=d=>{let p=K("indices",e[1].dataType,e[1].dims.length),f=K("updates",e[2].dataType,e[2].dims.length,a),m=t.reduction!=="none"&&t.reduction!==""?ju("output",e[0].dataType,i.length):de("output",e[0].dataType,i.length,a);return`
...
`,Vp=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Hp=(e,t,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",jp=(e,t,n)=>{let r=new Array(n).fill(0).concat(new Array(n).fill(1)),i=e.length===0?r:e.slice();return t.length>0?(t.forEach((a,o)=>{r[a]=i[o],r[o+n]=i[t.length+o]}),r):i},Kp=(e,t,n,r)=>{let i=[];if(n.length>0)if(r.length>0){if(e.forEach(a=>i.push(a)),Math.max(...r)>e.length)throw new Error("axes is out of bound");r.forEach((a,o)=>i[a]=n[o])}else n.forEach(a=>i.push(a));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");i=e.map((a,o)=>Math.round(a*t[o]))}return i},Yp=(e,t,n)=>{let r=(()=>{switch(n.keepAspectRatioPolicy){case"not_larger":return n.axes.length>0?Math.min(...n.axes.map(a=>t[a]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return n.axes.length>0?Math.max(...n.axes.map(a=>t[a]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return n.axes.length>0?(n.axes.forEach(a=>t[a]=r),n.axes.forEach(a=>i[a]=Math.round(e[a]*t[a]))):(t.fill(r,0,t.length),i.forEach((a,o)=>i[o]=Math.round(a*t[o]))),i},Xp=(e,t,n,r,i)=>`
...
`:"",Jp=(e,t,n,r,i)=>{let[a,o,s,u]=n.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},ef=(e,t,n,r,i,a,o,s,u,l)=>{let c=n.length===2,[d,p]=c?[0,1]:[2,3],f=e.type.value,m=y=>{let w=y===d?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    `},tf=(e,t,n,r,i)=>{let[a,o,s,u,l]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],c=e.type.value;return`
    ...
    }`},nf=(e,t,n,r,i,a)=>{let o=e.dims,s=jp(a,t.axes,o.length),u=Kp(o,r,i,t.axes),l=r.slice();r.length===0&&(l=o.map((x,M)=>x===0?1:u[M]/x),t.keepAspectRatioPolicy!=="stretch"&&(u=Yp(o,l,t)));let c=de("output",e.dataType,u.length),d=K("input",e.dataType,o.length),p=V.size(u),f=o.length===u.length&&o.every((x,M)=>x===u[M]),m=t.coordinateTransformMode==="tf_crop_and_resize",y=t.extrapolationValue,w=d.type.value,b=x=>`
      ${f?"":`
      ${Vp(t.coordinateTransformMode,w)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Zp(d,o)};
              ${Hp(t.nearestMode,n,w)};
              ${Qp(d,c,o,u,l.length,s.length,m)};
              `;case"linear":return`
              ${Xp(c,o,u,l.length,s.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${Jp(d,c,o,m,y)}`;if(o.length===3||o.length===5)return`${tf(d,c,o,m,y)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(o.length===2||o.length===4)return`${ef(d,c,o,u,l,s,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${n}|${l.length>0?t.mode==="cubic"?l:l.length:""}|${i.length>0?i:""}|${s.length>0?s:""}|${f}|${t.mode==="nearest"?o.length:o}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},{type:1,data:l},{type:1,data:s},...fe(o,u)]})}},rf=e=>{let t=e.customDataBuffer;return new Uint32Array(t.buffer,t.byteOffset,1)[0]},of=(e,t)=>{let n=[],r=[],i=[],a=rf(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");qp(e.inputs,t,a,n,r,i),e.compute(nf(e.inputs[0],t,a,n,r,i),{inputs:[0]})},af=e=>{let t=e.antialias,n=e.axes,r=e.coordinateTransformMode,i=e.cubicCoeffA,a=e.excludeOutside!==0,o=e.extrapolationValue,s=e.keepAspectRatioPolicy,u=e.mode,l=e.nearestMode===""?"simple":e.nearestMode;return Oe({antialias:t,axes:n,coordinateTransformMode:r,cubicCoeffA:i,excludeOutside:a,extrapolationValue:o,keepAspectRatioPolicy:s,mode:u,nearestMode:l})}}),sf,uf,lf,Aw=re(()=>{be(),$e(),ve(),sf=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],n=e[1],r=e[2];if(t.dataType!==n.dataType||t.dataType!==r.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(n.dims.length!==3&&n.dims.length!==2)throw new Error("Skip must be 2D or 3D");let i=t.dims[t.dims.length-1],a=t.dims[t.dims.length-2];if(n.dims[n.dims.length-1]!==i)throw new Error("Skip must have the same hidden size as input");if(n.dims[n.dims.length-2]!==a)throw new Error("Skip must have the same sequence length as input");if(r.dims.length!==1)throw new Error("Gamma must be 1D");if(r.dims[r.dims.length-1]!==i)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let o=e[3];if(o.dims.length!==1)throw new Error("Beta must be 1D");if(o.dims[o.dims.length-1]!==i)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let o=e[4];if(o.dims.length!==1)throw new Error("Bias must be 1D");if(o.dims[o.dims.length-1]!==i)throw new Error("Bias must have the same hidden size as input")}},uf=(e,t,n,r)=>{let i=t.simplified,a=e[0].dims,o=V.size(a),s=a,u=o,l=a.slice(-1)[0],c=r?a.slice(0,-1).concat(1):[],d=!i&&e.length>3,p=e.length>4,f=r&&n>1,m=r&&n>2,y=n>3,w=64,b=We(l),x=[{type:12,data:u},{type:12,data:b},{type:12,data:l},{type:1,data:t.epsilon}],M=I=>{let E=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],k=[K("x",e[0].dataType,e[0].dims,b),K("skip",e[1].dataType,e[1].dims,b),K("gamma",e[2].dataType,e[2].dims,b)];d&&k.push(K("beta",e[3].dataType,e[3].dims,b)),p&&k.push(K("bias",e[4].dataType,e[4].dims,b)),k.push(de("output",e[0].dataType,s,b)),f&&k.push(de("mean_output",1,c)),m&&k.push(de("inv_std_output",1,c)),y&&k.push(de("input_skip_bias_sum",e[0].dataType,s,b));let S=Qe(e[0].dataType),R=Qe(1,b);return`
      ...
      }`},v=[{dims:s,dataType:e[0].dataType}];return n>1&&v.push({dims:c,dataType:1}),n>2&&v.push({dims:c,dataType:1}),n>3&&v.push({dims:a,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${b};${f};${m};${y}`,inputDependencies:e.map((I,E)=>"type")},getShaderSource:M,getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:x})}},lf=(e,t)=>{sf(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(uf(e.inputs,t,e.outputCount,!1),{outputs:n})}}),cf,ur,df,Yo,hf,pf,ff,mf,Rw=re(()=>{be(),$e(),Ve(),ve(),cf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},ur=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},df=(e,t)=>{if(e.length>1){let n=ur(e,1),r=ur(e,2),i=ur(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),Oe({starts:n,ends:r,axes:i})}else return t},Yo=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},hf=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...fe(e[0].dims,i)]}),getShaderSource:l}},vf=e=>{_f(e.inputs),e.compute($f(e.inputs),{inputs:[0]})}}),Mf,Sf,If,zw=re(()=>{be(),$e(),ve(),Mf=(e,t,n,r,i)=>{let a=de("output_data",i,n.length,4),o=K("a_data",t[1].dataType,t[1].dims.length,4),s=K("b_data",t[2].dataType,t[2].dims.length,4),u=K("c_data",t[0].dataType,t[0].dims.length,4),l,c=(d,p,f)=>`select(${p}, ${d}, ${f})`;if(!r)l=a.setByOffset("global_idx",c(o.getByOffset("global_idx"),s.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let d=(p,f,m="")=>{let y=`a_data[index_a${f}][component_a${f}]`,w=`b_data[index_b${f}][component_b${f}]`,b=`bool(c_data[index_c${f}] & (0xffu << (component_c${f} * 8)))`;return`
 ...
 * limitations under the License.
 * =============================================================================
 */const Vr=new Map;function Jf(e,t){const n=Vr.get(e)??{ms:0,appels:0};n.ms+=t,n.appels+=1,Vr.set(e,n)}function at(e,t){const n=performance.now();try{return t()}finally{Jf(e,performance.now()-n)}}async function et(e,t){const n=performance.now();try{return await t()}finally{Jf(e,performance.now()-n)}}function Ww(){return[...Vr.entries()].map(([e,t])=>({nom:e,ms:Math.round(t.ms),appels:t.appels})).sort((e,t)=>t.ms-e.ms)}function qw(){Vr.clear()}function Vw(e,t,n,r){const i=t*n,a=new Uint8ClampedArray(new ArrayBuffer(i*4));if(r===4)return a.set(e),a;for(let o=0;o<i;o+=1)a[o*4]=e[o*r],a[o*4+1]=e[o*r+1],a[o*4+2]=e[o*r+2],a[o*4+3]=255;return a}function st(e){const t=Math.floor(e);return e-t===.5?t%2===0?t:t+1:Math.round(e)}function Ln(e){if(e.length===0)return Number.NaN;const t=[...e].sort((r,i)=>r-i),n=Math.floor(t.length/2);return t.length%2===1?t[n]:(t[n-1]+t[n])/2}function em(e,t){if(e.length===0)return Number.NaN;const n=[...e].sort((o,s)=>o-s),r=t/100*(n.length-1),i=Math.floor(r),a=Math.ceil(r);return i===a?n[i]:n[i]*(a-r)+n[a]*(r-i)}const Hw=114;function jw(e,t,n,r=1){const i=Math.min(n*r/e,n*r/t),a=Math.round(e*i),o=Math.round(t*i);return{scale:i,padX:Math.floor((n-a)/2),padY:Math.floor((n-o)/2),resizedWidth:a,resizedHeight:o}}function ca(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let c=0;c<n;c++){const d=(c+.5)*l-.5,p=Math.max(0,Math.min(i-1,Math.floor(d))),f=Math.min(i-1,p+1),m=Math.max(0,Math.min(1,d-p));for(let y=0;y<t;y++){const w=(y+.5)*u-.5,b=Math.max(0,Math.min(r-1,Math.floor(w))),x=Math.min(r-1,b+1),M=Math.max(0,Math.min(1,w-b)),v=(p*r+b)*a,I=(p*r+x)*a,E=(f*r+b)*a,k=(f*r+x)*a,S=(c*t+y)*3;for(let R=0;R<3;R++){const B=o[v+R]*(1-M)+o[I+R]*M,Y=o[E+R]*(1-M)+o[k+R]*M;s[S+R]=Math.min(255,Math.max(0,Math.round(B*(1-m)+Y*m)))}}}return s}function Fn(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n;for(let c=0;c<n;c++){const d=c*l,p=Math.min((c+1)*l,i);for(let f=0;f<t;f++){const m=f*u,y=Math.min((f+1)*u,r);let w=0,b=0,x=0,M=0;for(let I=Math.floor(d);I<p;I++){const E=Math.min(I+1,p)-Math.max(I,d);if(!(E<=0))for(let k=Math.floor(m);k<y;k++){const S=Math.min(k+1,y)-Math.max(k,m);if(S<=0)continue;const R=S*E,B=(I*r+k)*a;w+=o[B]*R,b+=o[B+1]*R,x+=o[B+2]*R,M+=R}}const v=(c*t+f)*3;s[v]=Math.min(255,Math.max(0,st(w/M))),s[v+1]=Math.min(255,Math.max(0,st(b/M))),s[v+2]=Math.min(255,Math.max(0,st(x/M)))}}return s}function tm(e){const n=((-.75*(e+1)- -3.75)*(e+1)+-6)*(e+1)- -3,r=((-.75+2)*e-(-.75+3))*e*e+1,i=((-.75+2)*(1-e)-(-.75+3))*(1-e)*(1-e)+1;return[n,r,i,1-n-r-i]}function dr(e,t,n){const{width:r,height:i,channels:a,data:o}=e,s=new Uint8Array(t*n*3),u=r/t,l=i/n,c=p=>Math.max(0,Math.min(r-1,p)),d=p=>Math.max(0,Math.min(i-1,p));for(let p=0;p<n;p++){const f=(p+.5)*l-.5,m=Math.floor(f),y=tm(f-m);for(let w=0;w<t;w++){const b=(w+.5)*u-.5,x=Math.floor(b),M=tm(b-x),v=(p*t+w)*3;for(let I=0;I<3;I++){let E=0;for(let k=0;k<4;k++){const S=d(m-1+k)*r;let R=0;for(let B=0;B<4;B++)R+=M[B]*o[(S+c(x-1+B))*a+I];E+=y[k]*R}s[v+I]=Math.min(255,Math.max(0,Math.round(E)))}}}return s}function Hr(e,t,n=1){const r=jw(e.width,e.height,t,n),i=ca(e,r.resizedWidth,r.resizedHeight),a=t*t,o=new Float32Array(3*a).fill(Hw/255);for(let s=0;s<r.resizedHeight;s++){const u=(s+r.padY)*t+r.padX,l=s*r.resizedWidth;for(let c=0;c<r.resizedWidth;c++){const d=(l+c)*3,p=u+c;o[p]=i[d]/255,o[a+p]=i[d+1]/255,o[2*a+p]=i[d+2]/255}}return{tensor:o,params:r}}function da(e,t,n,r){const i=[],a=Math.floor(e.length/6);for(let o=0;o<a;o++){const s=e[o*6],u=e[o*6+1],l=e[o*6+2],c=e[o*6+3],d=e[o*6+4],p=e[o*6+5];if(d<n)continue;const f=Math.round(p);if(f<0||f>=r)continue;const m=(s-t.padX)/t.scale,y=(u-t.padY)/t.scale,w=(l-t.padX)/t.scale,b=(c-t.padY)/t.scale;i.push({classIndex:f,confidence:d,box:[Math.trunc(m),Math.trunc(y),Math.trunc(w-m),Math.trunc(b-y)],boxFloat:[m,y,w-m,b-y]})}return i}const hr=.8,nm=.65,Kw=110,Yw=1280;function Xw(e,t,n){if(n==null)return hr;if(n.length===0)return nm;const r=Math.max(e,t);if(!(r>0))return hr;const i=Yw/r,a=n.filter(u=>Array.isArray(u.box)||u.box!==void 0).map(u=>Math.sqrt(Number(u.box[2])**2+Number(u.box[3])**2)*i).filter(u=>Number.isFinite(u)).sort((u,l)=>u-l);if(a.length===0)return hr;const o=a.length;return(o%2===1?a[(o-1)/2]:(a[o/2-1]+a[o/2])/2)>=Kw?nm:hr}const rm=.25,im=.6;function Qw(e,t,n){const r=Math.trunc(Number(n[0])),i=Math.trunc(Number(n[1])),a=Math.trunc(Number(n[2])),o=Math.trunc(Number(n[3]));if(![r,i,a,o].every(b=>Number.isFinite(b)))return null;const s=a-r,u=o-i;if(s<=0||u<=0)return null;const l=Math.trunc(s*(s>=u?rm:im)),c=Math.trunc(u*(s>=u?im:rm)),d=Math.max(0,r-l),p=Math.max(0,i-c),f=Math.min(Math.trunc(e),a+l),m=Math.min(Math.trunc(t),o+c),y=f-d,w=m-p;return y<=0||w<=0?null:{x:d,y:p,width:y,height:w}}const Zw=3,Jw=.15,eb=.6;function ha(e,t){return Math.hypot(Number(e[0])-Number(t[0]),Number(e[1])-Number(t[1]))}function tb(e){const t=e.filter(i=>i&&Number.isFinite(Number(i[0]))&&Number.isFinite(Number(i[1])));if(t.length===0)return null;let n=0,r=0;for(const i of t)n+=Number(i[0]),r+=Number(i[1]);return[n/t.length,r/t.length]}function nb(e,t,n){try{if(n==null)return null;const r=Math.trunc(Number(n));if(!Number.isFinite(r)||r===0||!e||e.length<2)return null;const i=[Number(e[0][0]),Number(e[0][1])],a=[Number(e[1][0]),Number(e[1][1])];if(![...i,...a].every(v=>Number.isFinite(v)))return null;const o=ha(i,a);if(!(o>0))return null;const s=[];for(const v of t??[]){const I=Math.trunc(Number(v.n));if(!Number.isFinite(I)||I<Zw)continue;const E=tb(v.poly);E!==null&&s.push({owner:v.owner,c:E,n:I,d0:0,d1:0,ecart:0})}if(s.length<2)return null;s.sort((v,I)=>I.n-v.n);const u=s.slice(0,2);let l=!1;s.length>2&&u[1].n>0&&(l=s[2].n/u[1].n>eb);for(const v of u)v.d0=ha(v.c,i),v.d1=ha(v.c,a),v.ecart=Math.abs(v.d0-v.d1);const c=[...u].sort((v,I)=>I.ecart-v.ecart),d=c[0],p=c[1],f=d.d0<d.d1?0:1,m=r>0?1:0,y=f===m?d:p,w=f===m?p:d,b=f===1?d.owner:p.owner,x=f===1?p.owner:d.owner,M=d.ecart/o<Jw;return{favoredOwner:w.owner,threatenedOwner:y.owner,ownerAtEnd0:x,ownerAtEnd1:b,distance:Math.abs(r),ambiguous:!!(M||l)}}catch{return null}}function rb(e){if(!e)return null;const t=e.ownerAtEnd1,n=e.ownerAtEnd0;return!t||!n||t===n?null:{left:n,right:t}}const ib=.6;function om(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++){if(e[a*6+4]<n)continue;const s=(e[a*6]-t.padX)/t.scale,u=(e[a*6+1]-t.padY)/t.scale,l=(e[a*6+2]-t.padX)/t.scale,c=(e[a*6+3]-t.padY)/t.scale,d=st((s+l)/2),p=st((u+c)/2),f=st((l-s+(c-u))/4);f>=1&&r.push({cx:d,cy:p,r:f})}return r}function ob(e){const t=[];for(const n of[...e].sort((r,i)=>r.r-i.r)){const r=(ib*n.r)**2;t.every(i=>(n.cx-i.cx)**2+(n.cy-i.cy)**2>r)&&t.push(n)}return t}function ab(e){if(e.length===0)return[];const t=Math.max(1,Math.trunc(Ln(e.map(n=>n.r))*1.5));return[...e].sort((n,r)=>{const i=Math.floor(n.cy/t),a=Math.floor(r.cy/t);return i!==a?i-a:n.cx-r.cx})}function am(e,t,n){const r=om(e,t,n);return r.length===0?[]:ab(ob(r))}function sb(e,t,n){return om(e,t,n)}function pa(e,t,n){const r=[],i=Math.floor(e.length/6);for(let a=0;a<i;a++)e[a*6+4]<n||r.push([(e[a*6]-t.padX)/t.scale,(e[a*6+1]-t.padY)/t.scale,(e[a*6+2]-t.padX)/t.scale,(e[a*6+3]-t.padY)/t.scale]);return r}const ub=.5,lb=.7,cb=.55;function fa(e){const t=e.map(([n,r,i,a])=>Math.min(i-n,a-r)).sort((n,r)=>n-r);return t[Math.floor(t.length/2)]||1}function sm(e){if(e.length===0)return[];const t=(ub*fa(e))**2,n=[];for(const i of e){const a=(i[0]+i[2])/2,o=(i[1]+i[3])/2,s=n.find(u=>(u.cx-a)**2+(u.cy-o)**2<=t);if(s===void 0)n.push({cx:a,cy:o,boxes:[i]});else{s.boxes.push(i);const u=s.boxes.length;s.cx=(s.cx*(u-1)+a)/u,s.cy=(s.cy*(u-1)+o)/u}}let r=n.map(({boxes:i})=>[Math.trunc(Ln(i.map(a=>a[0]))),Math.trunc(Ln(i.map(a=>a[1]))),Math.trunc(Ln(i.map(a=>a[2]))),Math.trunc(Ln(i.map(a=>a[3])))]);if(r.length>=2){const i=fa(r),a=r.map(()=>!0);for(let o=0;o<r.length;o++)if(a[o])for(let s=o+1;s<r.length;s++){if(!a[s])continue;const u=r[o],l=r[s],c=Math.max(0,Math.min(u[2],l[2])-Math.max(u[0],l[0])),d=Math.max(0,Math.min(u[3],l[3])-Math.max(u[1],l[1])),p=c*d,f=(u[2]-u[0])*(u[3]-u[1]),m=(l[2]-l[0])*(l[3]-l[1]);if(p>=lb*Math.min(f,m)){const y=Math.abs(Math.min(u[2]-u[0],u[3]-u[1])-i),w=Math.abs(Math.min(l[2]-l[0],l[3]-l[1])-i);if(a[y<=w?s:o]=!1,!a[o])break}}r=r.filter((o,s)=>a[s])}if(r.length>=3){const i=fa(r);r=r.filter(([a,o,s,u])=>Math.min(s-a,u-o)>=cb*i)}return r}const db=.7;function hb(e,t){const n=Math.max(e[0],t[0]),r=Math.max(e[1],t[1]),i=Math.min(e[2],t[2]),a=Math.min(e[3],t[3]);if(i<=n||a<=r)return 0;const o=(i-n)*(a-r),s=(e[2]-e[0])*(e[3]-e[1]),u=(t[2]-t[0])*(t[3]-t[1]),l=s+u-o;return l>0?o/l:0}function um(e,t,n,r,i,a=db){const o=t-4;if(o<=0||n<=0)return[];const s=[];for(let l=0;l<n;l+=1){let c=0,d=0;for(let p=0;p<o;p+=1){const f=e[(4+p)*n+l];f>c&&(c=f,d=p)}c<i||s.push({box:[(e[l]-r.padX)/r.scale,(e[n+l]-r.padY)/r.scale,(e[2*n+l]-r.padX)/r.scale,(e[3*n+l]-r.padY)/r.scale],score:c,cls:d})}s.sort((l,c)=>c.score-l.score);const u=[];for(const l of s){let c=!1;for(const d of u)if(d.cls===l.cls&&hb(d.box,l.box)>a){c=!0;break}c||u.push(l)}return u.map(l=>l.box)}const lm=["brown","grey","blue","green","yellow","red","purple"],pb={brown:"raw",grey:"manufactured",blue:"civilian",green:"scientific",yellow:"commercial",red:"military",purple:"guild"},fb=.7;function cm(e){const t=e.map((i,a)=>a).sort((i,a)=>e[a].confidence-e[i].confidence),n=new Set,r=[];for(const i of t){const a=e[i],[o,s,u,l]=a.box;let c=!1;for(const d of r){const p=e[d];if(p.family!==a.family)continue;const[f,m,y,w]=p.box,b=Math.max(0,Math.min(o+u,f+y)-Math.max(o,f)),x=Math.max(0,Math.min(s+l,m+w)-Math.max(s,m)),M=Math.max(1,Math.min(u*l,y*w));if(b*x>=fb*M){c=!0;break}}c?n.add(i):r.push(i)}return e.filter((i,a)=>!n.has(a))}function jr(e,t,n){const r=da(e,t,n,lm.length).map(i=>{const a=lm[i.classIndex];return{color:a,family:pb[a],box:i.box,confidence:i.confidence}});return cm(r)}const mb=8,gb=.8,dm=1.25;function yb(e){if(e.length<mb)return[];const t=[],n=[];for(const o of e){const[,,s,u]=o.box;s>u*dm?t.push(o):u>s*dm&&n.push(o)}const[r,i,a]=t.length>=n.length?[t,n,"vertical"]:[n,t,"horizontal"];return r.length<gb*e.length||i.length===0?[]:i.map(o=>({family:o.family,color:o.color,box:[...o.box],reason:`${o.color} banner sits ${a} while ${r.length}/${e.length} of the tableau faces the other way — probably a stray card poking into the frame`}))}const wb=2.25,hm=8;function bb(e){if(e.length<hm)return[];const t=e.map(d=>[d.box[0]+d.box[2]/2,d.box[1]+d.box[3]/2]),n=e.map(d=>Math.hypot(d.box[2],d.box[3])).sort((d,p)=>d-p),r=wb*n[Math.floor(n.length/2)],i=r*r,a=e.map((d,p)=>p),o=d=>{for(;a[d]!==d;)a[d]=a[a[d]],d=a[d];return d};for(let d=0;d<e.length;d++)for(let p=d+1;p<e.length;p++){const f=t[d][0]-t[p][0],m=t[d][1]-t[p][1];f*f+m*m<=i&&(a[o(d)]=o(p))}const s=new Map;for(let d=0;d<e.length;d++){const p=o(d);s.set(p,[...s.get(p)??[],d])}let u=[];for(const d of s.values())d.length>u.length&&(u=d);if(u.length<hm||u.length===e.length)return[];const l=new Set(u),c=e.map((d,p)=>p).filter(d=>!l.has(d));return c.map(d=>({family:e[d].family,color:e[d].color,box:[...e[d].box],reason:`${e[d].color} banner sits in a detached group of ${c.length}, away from the ${u.length}-card tableau — probably the draw/discard pile, not this player's city`}))}const nt={banner:{onnx:"banner_yolo.onnx",input:1280,conf:.5},coin:{onnx:"coin_yolo.onnx",input:1280,conf:.25},laurel:{onnx:"laurel_yolo.onnx",input:1280,conf:.25},token:{onnx:"token_yolo.onnx",input:1280,conf:.4},wonder:{onnx:"wonder_yolo.onnx",input:1280,conf:.3}};function kt(e,t,n){const r=Math.max(e,t,n),i=Math.min(e,t,n),a=r-i,o=r===0?0:Math.round(255*a/r);if(a===0)return{h:0,s:o,v:r};let s;return r===e?s=60*(t-n)/a:r===t?s=120+60*(n-e)/a:s=240+60*(e-t)/a,s<0&&(s+=360),{h:Math.round(s/2),s:o,v:r}}const _b=.42,xb=22,$b=43,vb=120,Mb=1.5,Sb=.72,Ib=110,pm=3;function pr(e,t,n){const{width:r,height:i,channels:a,data:o}=e;if(r<4||i<4)return 0;const s=Math.floor(r/2),u=Math.floor(i/2),l=Math.trunc(Math.min(r,i)*_b);if(l<1)return 0;let c=0;for(let d=0;d<i;d++)for(let p=0;p<r;p++){if((p-s)**2+(d-u)**2>l*l)continue;const f=(d*r+p)*a,m=o[f],y=o[f+1],w=o[f+2];!t&&m>=250&&y>=250&&w>=250||(n(m,y,w),c+=1)}return c}function Tb(e){let t=0,n=0,r=0,i=pr(e,!1,(a,o,s)=>{const u=kt(a,o,s);t+=u.h,n+=u.s,r+=u.v});return i===0&&(i=pr(e,!0,(a,o,s)=>{const u=kt(a,o,s);t+=u.h,n+=u.s,r+=u.v})),i===0?null:{h:t/i,s:n/i,v:r/i}}function Eb(e){let t=0,n=0,r=pr(e,!1,(a,o)=>{t+=a,n+=o});if(r===0&&(r=pr(e,!0,(a,o)=>{t+=a,n+=o})),r===0)return null;const i=n/r;return i<=1e-6?null:t/r/i}function kb(e){let t=0;const n=pr(e,!0,(r,i,a)=>{t+=kt(r,i,a).s});return n===0?null:t/n}function Cb(e){const t=Tb(e);if(t===null||t.s<=xb)return 1;if(t.s>=vb){const n=Eb(e);return n!==null&&n>=Mb?6:3}return t.s>=$b?3:6}function Ab(e,t){const n=[...t];if(e.length!==3||t.length!==3||new Set(t).size===3&&t.every(o=>[1,3,6].includes(o)))return n;const r=e.map(o=>o.r).sort((o,s)=>o-s);if(r[0]<=0||!(r[1]>=r[0]*1.12&&r[2]>=r[1]*1.12))return n;const i=[0,1,2].sort((o,s)=>e[o].r-e[s].r),a=new Map([[i[0],1],[i[1],3],[i[2],6]]);return[0,1,2].map(o=>a.get(o))}function Rb(e,t){const n=[...t];if(e.length<pm||t.length!==e.length)return n;const r=e.map(o=>kb(o)),i=r.filter(o=>o!==null);if(i.length<pm)return n;const a=Ln(i);return a<=0||r.forEach((o,s)=>{o!==null&&n[s]!==1&&o<Sb*a&&o<Ib&&(n[s]=1)}),n}function fm(e,t){const{cx:n,cy:r,r:i}=t,a=Math.max(0,n-i),o=Math.max(0,r-i),s=Math.min(e.width,n+i),u=Math.min(e.height,r+i),l=Math.max(0,s-a),c=Math.max(0,u-o),d=new Uint8Array(l*c*3);for(let p=0;p<c;p++)for(let f=0;f<l;f++){const m=(p*l+f)*3;if((f+a-n)**2+(p+o-r)**2<=i*i){const w=((p+o)*e.width+(f+a))*e.channels;d[m]=e.data[w],d[m+1]=e.data[w+1],d[m+2]=e.data[w+2]}else d[m]=255,d[m+1]=255,d[m+2]=255}return{width:l,height:c,channels:3,data:d}}function Ob(e,t){const n=t.map(a=>fm(e,a)),r=n.map(a=>Cb(a)),i=Ab(t,r);return Rb(n,i)}function Nb(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n);for(let o=0,s=0;o<a.length;o++,s+=r)a[o]=i[s]*4899+i[s+1]*9617+i[s+2]*1868+8192>>14;return{width:t,height:n,data:a}}function mm(e,t,n){const r=new Uint8Array(t*n),i=e.width/t,a=e.height/n;for(let o=0;o<n;o++){const s=o*a,u=Math.min((o+1)*a,e.height);for(let l=0;l<t;l++){const c=l*i,d=Math.min((l+1)*i,e.width);let p=0,f=0;for(let m=Math.floor(s);m<u;m++){const y=Math.min(m+1,u)-Math.max(m,s);if(!(y<=0))for(let w=Math.floor(c);w<d;w++){const b=Math.min(w+1,d)-Math.max(w,c);b<=0||(p+=e.data[m*e.width+w]*b*y,f+=b*y)}}r[o*t+l]=Math.min(255,Math.max(0,st(p/f)))}}return{width:t,height:n,data:r}}function zb(e){const t=new Array(256).fill(0);for(const u of e.data)t[u]+=1;const n=e.data.length;let r=0;for(;r<256&&t[r]===0;)r+=1;const i=new Uint8Array(n);if(r>=255||t[r]===n)return i.fill(r<256?r:0),{width:e.width,height:e.height,data:i};const a=255/(n-t[r]),o=new Uint8Array(256);let s=0;for(let u=r+1;u<256;u++)s+=t[u],o[u]=Math.min(255,Math.max(0,st(s*a)));for(let u=0;u<n;u++)i[u]=o[e.data[u]];return{width:e.width,height:e.height,data:i}}function Bb(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!0;for(let u=-1;u<=1&&s;u++)for(let l=-1;l<=1;l++){const c=o+l,d=a+u;if(!(c<0||c>=t||d<0||d>=n)&&r[d*t+c]===0){s=!1;break}}i[a*t+o]=s&&r[a*t+o]>0?255:0}return{width:t,height:n,data:i}}function Pb(e){const{width:t,height:n,data:r}=e,i=new Uint8Array(t*n);for(let a=0;a<n;a++)for(let o=0;o<t;o++){let s=!1;for(let u=-1;u<=1&&!s;u++)for(let l=-1;l<=1;l++){const c=o+l,d=a+u;if(c>=0&&c<t&&d>=0&&d<n&&r[d*t+c]>0){s=!0;break}}i[a*t+o]=s?255:0}return{width:t,height:n,data:i}}function ma(e){const{width:t,height:n,data:r}=e,i=new Int32Array(t*n),a=[],o=new Int32Array(t*n);let s=1;for(let u=0;u<r.length;u++){if(r[u]===0||i[u]!==0)continue;let l=0,c=0;o[c++]=u,i[u]=s;let d=0,p=0,f=0;for(;l<c;){const m=o[l++],y=m%t,w=m/t|0;d+=1,p+=y,f+=w;for(let b=-1;b<=1;b++)for(let x=-1;x<=1;x++){if(x===0&&b===0)continue;const M=y+x,v=w+b;if(M<0||M>=t||v<0||v>=n)continue;const I=v*t+M;r[I]>0&&i[I]===0&&(i[I]=s,o[c++]=I)}}a[s]={area:d,centroidX:p/d,centroidY:f/d},s+=1}return{labels:i,stats:a}}function Db(e,t,n){return gm(Float32Array.from(e.data),e.width,t,n)}function gm(e,t,n,r){const i=new Float32Array(t*t),a=t/2,o=-n*Math.PI/180,s=Math.cos(o),u=Math.sin(o);for(let l=0;l<t;l++)for(let c=0;c<t;c++){const d=c-a,p=l-a,f=s*d-u*p+a,m=u*d+s*p+a,y=Math.floor(f),w=Math.floor(m),b=f-y,x=m-w,M=(E,k)=>E>=0&&E<t&&k>=0&&k<t?e[k*t+E]:r,v=M(y,w)*(1-b)+M(y+1,w)*b,I=M(y,w+1)*(1-b)+M(y+1,w+1)*b;i[l*t+c]=v*(1-x)+I*x}return i}const Ub=.9,Lb=.34,Fb=[.55,.6,.66,.72],Gb=22,Wb=88,qb=35,Gn=28,ga=4,Vb=Array.from({length:15},(e,t)=>-21+t*3),ym=[-2,0,2],Hb=3,jb=.3;function Kb(e){return e.templates.flatMap(({label:t,bits:n})=>{const r=Uint8Array.from(atob(n),i=>i.charCodeAt(0));return r.length!==e.size*e.size?[]:[{label:t,bits:Float32Array.from(r)}]})}function Yb(e){let t=e.width,n=-1,r=e.height,i=-1,a=0;for(let y=0;y<e.height;y++)for(let w=0;w<e.width;w++)e.data[y*e.width+w]>0&&(a+=1,t=Math.min(t,w),n=Math.max(n,w),r=Math.min(r,y),i=Math.max(i,y));if(a<8)return null;const o=n-t+1,s=i-r+1,u=Math.max(s,o),l=new Uint8Array(u*u),c=Math.floor((u-o)/2),d=Math.floor((u-s)/2);for(let y=0;y<s;y++)for(let w=0;w<o;w++)l[(y+d)*u+(w+c)]=e.data[(y+r)*e.width+(w+t)];const p=Gn-2*ga,f=mm({width:u,height:u,data:l},p,p),m=new Float32Array(Gn*Gn);for(let y=0;y<p;y++)for(let w=0;w<p;w++)m[(y+ga)*Gn+(w+ga)]=f.data[y*p+w]>110?1:0;return m}function Xb(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(r/2),s=Math.floor(n/2),u=Math.trunc(Math.min(n,r)*Lb);if(u<4)return null;const l=o-u,c=s-u,d=2*u,p=2*u;if(d<6||p<6)return null;const f=new Int16Array(d*p),m=new Int16Array(d*p),y=new Int16Array(d*p),w=new Uint8Array(d*p),b=[],x=Math.min(d,p)/2;for(let L=0;L<d;L++)for(let O=0;O<p;O++){const C=((L+l)*n+(O+c))*i,{h:z,s:U,v:P}=kt(a[C],a[C+1],a[C+2]),j=L*p+O;f[j]=z,m[j]=U,y[j]=P,Math.sqrt((O-p/2)**2+(L-d/2)**2)/x<=t&&(w[j]=1,b.push(P))}if(b.length<16)return null;const M=em(b,55);let v=0,I=0,E=0;const k=L=>f[L]>=Gb&&f[L]<=Wb&&m[L]>=qb,S=L=>y[L]>=M&&m[L]<=95&&!k(L)&&w[L]===1;for(let L=0;L<d*p;L++)w[L]===1&&(E+=1,y[L]>=130&&!k(L)&&(v+=1),S(L)&&(I+=1));const R=v>.5*E&&I<.15*E,B=new Uint8Array(d*p);if(R){const L=em(b,45);for(let O=0;O<d*p;O++)B[O]=w[O]===1&&y[O]<=L?255:0}else for(let L=0;L<d*p;L++)B[L]=S(L)?255:0;const Y={width:p,height:d,data:B},G=Bb(Y);let q=ma(G),N=q;if(q.stats.length<=1&&(q=ma(Y),N=q,q.stats.length<=1))return null;const F=Math.min(d,p)/2;let X=0,Z=-1;for(let L=1;L<N.stats.length;L++){const O=N.stats[L];if(O===void 0)continue;const C=Math.hypot(O.centroidX-p/2,O.centroidY-d/2)/F,z=O.area*(1-.6*Math.min(C,1));z>Z&&(Z=z,X=L)}if(X===0)return null;const le=new Uint8Array(d*p);for(let L=0;L<d*p;L++)le[L]=N.labels[L]===X?255:0;return Yb(Pb({width:p,height:d,data:le}))}function Qb(e,t,n,r,i,a){const o=Gn;let s=0,u=0;for(let l=0;l<o;l++){const c=l-a;if(!(c<0||c>=o))for(let d=0;d<o;d++){const p=d-i;if(p<0||p>=o)continue;const f=e[c*o+p];f!==0&&(u+=f,s+=f*n[l*o+d])}}return s/(u+r-s+1e-6)}function Zb(e,t){const n=t.reduce((i,a)=>i+a,0);let r=-1;for(const i of Vb){const a=i===0?e:gm(e,Gn,i,0),o=a.reduce((s,u)=>s+u,0);for(const s of ym)for(const u of ym){const l=Qb(a,o,t,n,s,u);l>r&&(r=l)}}return r}function Jb(e,t){if(t.length===0||Math.min(e.width,e.height)<8)return[null,0];const n=[];for(const o of Fb){const s=Xb(e,o);if(s!==null)for(const{label:u,bits:l}of t)n.push([Zb(s,l),u])}if(n.length===0)return[null,0];if(n.sort((o,s)=>s[0]-o[0]),n[0][0]<jb)return[null,0];const r=new Map;for(const[o,s]of n.slice(0,Hb))r.set(s,(r.get(s)??0)+o);let i=0,a=-1;for(const[o,s]of r)s>a&&(a=s,i=o);return[i,n[0][0]]}const e_=2560,t_=.3,n_=.5,r_=1.6,i_=3,o_=5;function a_(e){const t=Math.min(1,e_/Math.max(e.width,e.height)),n=Math.max(32,Math.round(e.width*t/32)*32),r=Math.max(32,Math.round(e.height*t/32)*32),i=n*r,a=new Float32Array(3*i),o=e.width/n,s=e.height/r;for(let u=0;u<r;u++){const l=(u+.5)*s-.5,c=Math.max(0,Math.min(e.height-1,Math.floor(l))),d=Math.min(e.height-1,c+1),p=Math.max(0,Math.min(1,l-c));for(let f=0;f<n;f++){const m=(f+.5)*o-.5,y=Math.max(0,Math.min(e.width-1,Math.floor(m))),w=Math.min(e.width-1,y+1),b=Math.max(0,Math.min(1,m-y));for(let x=0;x<3;x++){const M=2-x,v=(c*e.width+y)*e.channels+M,I=(c*e.width+w)*e.channels+M,E=(d*e.width+y)*e.channels+M,k=(d*e.width+w)*e.channels+M,S=e.data[v]*(1-b)+e.data[I]*b,R=e.data[E]*(1-b)+e.data[k]*b,B=S*(1-p)+R*p;a[x*i+u*n+f]=(B/255-.5)/.5}}}return{tensor:a,width:n,height:r}}function s_(e,t,n){const r=new Uint8Array(e.length);for(let i=0;i<n;i++){const a=i===n-1;for(let o=0;o<t;o++){const s=i*t+o;let u=e[s];if(o+1<t&&e[s+1]>u&&(u=e[s+1]),!a){const l=s+t;e[l]>u&&(u=e[l]),o+1<t&&e[l+1]>u&&(u=e[l+1])}r[s]=u}}return r}function u_(e){if(e.length<3)return e;const t=[...e].sort((a,o)=>a[0]-o[0]||a[1]-o[1]),n=(a,o,s)=>(o[0]-a[0])*(s[1]-a[1])-(o[1]-a[1])*(s[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(let a=t.length-1;a>=0;a--){const o=t[a];for(;i.length>=2&&n(i[i.length-2],i[i.length-1],o)<=0;)i.pop();i.push(o)}return r.pop(),i.pop(),r.concat(i)}function l_(e){if(e.length===1)return{cx:e[0][0],cy:e[0][1],w:0,h:0,angle:0};let t=null,n=1/0;for(let r=0;r<e.length;r++){const[i,a]=e[r],[o,s]=e[(r+1)%e.length],u=o-i,l=s-a,c=Math.hypot(u,l);if(c===0)continue;const d=u/c,p=l/c;let f=1/0,m=-1/0,y=1/0,w=-1/0;for(const[v,I]of e){const E=v*d+I*p,k=-v*p+I*d;E<f&&(f=E),E>m&&(m=E),k<y&&(y=k),k>w&&(w=k)}const b=m-f,x=w-y,M=b*x;if(M<n){n=M;const v=(f+m)/2,I=(y+w)/2;t={cx:v*d-I*p,cy:v*p+I*d,w:b,h:x,angle:Math.atan2(p,d)}}}return t}function c_(e,t,n,r){const i=Math.cos(r.angle),a=Math.sin(r.angle),o=r.w/2,s=r.h/2,u=Math.abs(o*i)+Math.abs(s*a),l=Math.abs(o*a)+Math.abs(s*i),c=Math.max(0,Math.floor(r.cx-u)),d=Math.min(t-1,Math.ceil(r.cx+u)),p=Math.max(0,Math.floor(r.cy-l)),f=Math.min(n-1,Math.ceil(r.cy+l));let m=0,y=0;for(let w=p;w<=f;w++)for(let b=c;b<=d;b++){const x=b-r.cx,M=w-r.cy,v=x*i+M*a,I=-x*a+M*i;Math.abs(v)<=o&&Math.abs(I)<=s&&(m+=e[w*t+b],y+=1)}return y===0?0:m/y}function d_(e){const t=Math.cos(e.angle),n=Math.sin(e.angle),r=e.w/2,i=e.h/2,o=[...[[e.cx+-r*t- -i*n,e.cy+-r*n+-i*t],[e.cx+r*t- -i*n,e.cy+r*n+-i*t],[e.cx+r*t-i*n,e.cy+r*n+i*t],[e.cx+-r*t-i*n,e.cy+-r*n+i*t]]].sort((y,w)=>y[0]-w[0]),[s,u,l,c]=o,[d,p]=s[1]<=u[1]?[s,u]:[u,s],[f,m]=l[1]<=c[1]?[l,c]:[c,l];return[[d[0],d[1]],[f[0],f[1]],[m[0],m[1]],[p[0],p[1]]]}function h_(e,t,n,r){const{width:i,height:a}=t;let o=new Uint8Array(i*a);for(let f=0;f<o.length;f++)o[f]=e[f]>t_?255:0;o=s_(o,i,a);const s={width:i,height:a,data:o},{labels:u}=ma(s),l=new Map;for(let f=0;f<a;f++)for(let m=0;m<i;m++){const y=u[f*i+m];if(y===0)continue;let w=l.get(y);w===void 0&&(w=new Map,l.set(y,w));const b=w.get(f);b===void 0?w.set(f,[m,m]):(m<b[0]&&(b[0]=m),m>b[1]&&(b[1]=m))}const c=n/i,d=r/a,p=[];for(const[f,m]of l){const y=[];for(const[B,[Y,G]]of m)y.push([Y-.5,B-.5],[Y-.5,B+.5],[G+.5,B-.5],[G+.5,B+.5]);const w=l_(u_(y));if(Math.min(w.w,w.h)<i_)continue;const b=c_(e,i,a,w);if(b<n_)continue;const x=w.w*w.h*r_/(2*(w.w+w.h)),M={...w,w:w.w+2*x,h:w.h+2*x};if(Math.min(M.w,M.h)<o_+2)continue;const I=d_(M).map(([B,Y])=>[Math.min(n,Math.max(0,Math.round(B*c))),Math.min(r,Math.max(0,Math.round(Y*d)))]),E=I.map(B=>B[0]),k=I.map(B=>B[1]),S=Math.min(...E),R=Math.min(...k);p.push({quad:I,x:S,y:R,width:Math.max(...E)-S,height:Math.max(...k)-R,score:b})}return p.sort((f,m)=>m.score-f.score)}function p_(e,t){const[n,r,i,a]=t,o=Math.max(1,Math.round(Math.max(Math.hypot(r[0]-n[0],r[1]-n[1]),Math.hypot(i[0]-a[0],i[1]-a[1])))),s=Math.max(1,Math.round(Math.max(Math.hypot(a[0]-n[0],a[1]-n[1]),Math.hypot(i[0]-r[0],i[1]-r[1])))),u=f_([[0,0],[o,0],[o,s],[0,s]],[n,r,i,a]),l=new Uint8Array(o*s*e.channels);for(let d=0;d<s;d++)for(let p=0;p<o;p++){const f=u[6]*p+u[7]*d+u[8],m=(u[0]*p+u[1]*d+u[2])/f,y=(u[3]*p+u[4]*d+u[5])/f,w=Math.floor(m),b=Math.floor(y),x=m-w,M=y-b,v=Math.max(0,Math.min(e.width-1,w)),I=Math.max(0,Math.min(e.width-1,w+1)),E=Math.max(0,Math.min(e.height-1,b)),k=Math.max(0,Math.min(e.height-1,b+1));for(let S=0;S<e.channels;S++){const R=e.data[(E*e.width+v)*e.channels+S],B=e.data[(E*e.width+I)*e.channels+S],Y=e.data[(k*e.width+v)*e.channels+S],G=e.data[(k*e.width+I)*e.channels+S],q=R*(1-x)+B*x,N=Y*(1-x)+G*x;l[(d*o+p)*e.channels+S]=Math.round(q*(1-M)+N*M)}}const c={width:o,height:s,channels:e.channels,data:l};return s/o>=1.5?Yt(c,3):c}function f_(e,t){const n=[],r=[];for(let i=0;i<4;i++){const[a,o]=e[i],[s,u]=t[i];n.push([a,o,1,0,0,0,-s*a,-s*o]),r.push(s),n.push([0,0,0,a,o,1,-u*a,-u*o]),r.push(u)}for(let i=0;i<8;i++){let a=i;for(let s=i+1;s<8;s++)Math.abs(n[s][i])>Math.abs(n[a][i])&&(a=s);[n[i],n[a]]=[n[a],n[i]],[r[i],r[a]]=[r[a],r[i]];const o=n[i][i];for(let s=i;s<8;s++)n[i][s]/=o;r[i]/=o;for(let s=0;s<8;s++){if(s===i)continue;const u=n[s][i];if(u!==0){for(let l=i;l<8;l++)n[s][l]-=u*n[i][l];r[s]-=u*r[i]}}}return[r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],1]}function Yt(e,t){const n=(t%4+4)%4;if(n===0)return e;const{width:r,height:i,channels:a,data:o}=e,s=n%2===0?r:i,u=n%2===0?i:r,l=new Uint8Array(s*u*a);for(let c=0;c<i;c++)for(let d=0;d<r;d++){let p,f;n===1?(p=i-1-c,f=d):n===2?(p=r-1-d,f=i-1-c):(p=c,f=r-1-d);const m=(c*r+d)*a,y=(f*s+p)*a;for(let w=0;w<a;w++)l[y+w]=o[m+w]}return{width:s,height:u,channels:a,data:l}}const m_=.6;(()=>{const e=new Uint8Array(256);for(let t=0;t<256;t++)e[t]=Math.min(255,Math.round(Math.pow(t/255,m_)*255));return e})();const Xt=48,g_=320;function y_(e){return["blank",...e.characters," "]}function w_(e,t,n){let r="";const i=[];for(let o=0;o<e.length;o++){const s=e[o];s!==0&&(o>0&&e[o-1]===s||(r+=n[s]??"",i.push(t[o])))}if(i.length===0)return["",0];const a=i.reduce((o,s)=>o+s,0)/i.length;return[r,a]}function b_(e,t){const n=Math.trunc(Xt*t),r=e.width/e.height,i=Math.ceil(Xt*r)>n?n:Math.ceil(Xt*r),a=new Float32Array(3*Xt*n),o=Xt*n,s=e.width/i,u=e.height/Xt;for(let l=0;l<Xt;l++){const c=(l+.5)*u-.5,d=Math.max(0,Math.min(e.height-1,Math.floor(c))),p=Math.min(e.height-1,d+1),f=Math.max(0,Math.min(1,c-d));for(let m=0;m<i;m++){const y=(m+.5)*s-.5,w=Math.max(0,Math.min(e.width-1,Math.floor(y))),b=Math.min(e.width-1,w+1),x=Math.max(0,Math.min(1,y-w));for(let M=0;M<3;M++){const v=2-M,I=(d*e.width+w)*e.channels+v,E=(d*e.width+b)*e.channels+v,k=(p*e.width+w)*e.channels+v,S=(p*e.width+b)*e.channels+v,R=e.data[I]*(1-x)+e.data[E]*x,B=e.data[k]*(1-x)+e.data[S]*x,Y=R*(1-f)+B*f;a[M*o+l*n+m]=(Y/255-.5)/.5}}}return{tensor:a,width:n}}const __=62,x_=8,$_=5;function ya(e){return e?e.normalize("NFKD").replace(new RegExp("\\p{M}","gu"),"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim():""}function v_(e,t){const n=e.length,r=t.length;if(n===0||r===0)return 0;let i=new Int32Array(r+1),a=new Int32Array(r+1);for(let o=1;o<=n;o++){for(let s=1;s<=r;s++)a[s]=e[o-1]===t[s-1]?i[s-1]+1:Math.max(i[s],a[s-1]);[i,a]=[a,i]}return i[r]}function Kr(e,t){return e.length===0&&t.length===0?100:200*v_(e,t)/(e.length+t.length)}function wm(e,t){const n=r=>r.split(/\s+/).filter(Boolean).sort().join(" ");return Kr(n(e),n(t))}function M_(e,t){const n=new Set(e.split(/\s+/).filter(Boolean)),r=new Set(t.split(/\s+/).filter(Boolean)),i=[...n].filter(c=>r.has(c)).sort(),a=[...n].filter(c=>!r.has(c)).sort(),o=[...r].filter(c=>!n.has(c)).sort(),s=i.join(" "),u=[s,a.join(" ")].filter(Boolean).join(" "),l=[s,o.join(" ")].filter(Boolean).join(" ");return s.length>0&&(a.length===0||o.length===0)?100:Math.max(Kr(s,u),Kr(s,l),Kr(u,l))}function S_(e){const t=new Set,n=[];for(const r of e){const i=r.nameFr??r.name;for(const a of[ya(i),ya(r.name)])if(a)for(const o of[a,a.replace(/ /g,"")])o&&!t.has(o)&&(t.add(o),n.push({key:o,id:r.id,display:i,...r.kind!==void 0?{kind:r.kind}:{}}))}return n}function I_(e,t){const n=ya(e);if(!n||t.length===0)return null;const i=S_(t).map(c=>({...c,score:M_(n,c.key)})).sort((c,d)=>d.score-c.score).slice(0,x_).filter(c=>c.score>=__);if(i.length===0)return null;const a=i[0].score,o=i.filter(c=>a-c.score<=$_),s=[...new Set(n.split(/\s+/).filter(Boolean))].join(" ");let u=o[0],l=[wm(s,u.key),u.score];for(const c of o.slice(1)){const d=[wm(s,c.key),c.score];(d[0]>l[0]||d[0]===l[0]&&d[1]>l[1])&&(u=c,l=d)}return{id:u.id,name:u.display,...u.kind!==void 0?{kind:u.kind}:{},confidence:Math.round(u.score/100*1e4)/1e4}}const bm=5e3,wa=.75,_m=15,T_=1.25,E_=2.4,k_=.003,C_=.85,A_=4,ba=2600,_a=2,xa=.3,xm=.1,$m=.012,R_=22,vm=.5,Yr=.12;function tt(e,t){const n=new e.Mat(t.height,t.width,e.CV_8UC3),r=n.data,i=t.channels;for(let a=0,o=t.width*t.height;a<o;a++)r[a*3]=t.data[a*i],r[a*3+1]=t.data[a*i+1],r[a*3+2]=t.data[a*i+2];return n}function O_(e,t,n,r){const i=r.map(J=>J[0]),a=r.map(J=>J[1]),o=i.reduce((J,me)=>J+me,0)/i.length,s=a.reduce((J,me)=>J+me,0)/a.length,u=Math.max(Math.max(...i)-Math.min(...i),Math.max(...a)-Math.min(...a));if(u<4)return null;const l=u*A_,c=Math.max(0,Math.trunc(o-l)),d=Math.min(n.width,Math.trunc(o+l)),p=Math.max(0,Math.trunc(s-l)),f=Math.min(n.height,Math.trunc(s+l));if(d-c<8||f-p<8)return null;const m=Math.max(n.width,n.height)<ba?_a:1,y=tt(e,n),w=tt(e,t),b=new e.Rect(c,p,d-c,f-p),x=y.roi(b),M=new e.Mat;m!==1?e.resize(x,M,new e.Size(0,0),m,m,e.INTER_CUBIC):x.copyTo(M);const v=new e.Mat,I=new e.Mat;e.cvtColor(w,v,e.COLOR_RGB2GRAY),e.cvtColor(M,I,e.COLOR_RGB2GRAY);const E=new e.ORB(bm),k=new e.KeyPointVector,S=new e.KeyPointVector,R=new e.Mat,B=new e.Mat,Y=new e.Mat,G=[y,w,x,M,v,I,k,S,R,B,Y],q=J=>{for(const me of G)try{me.delete()}catch{}try{E.delete()}catch{}return J};if(E.detectAndCompute(v,Y,k,R),E.detectAndCompute(I,Y,S,B),R.rows<8||B.rows<8)return q(null);const N=new e.BFMatcher(e.NORM_HAMMING),F=new e.DMatchVectorVector;N.knnMatch(R,B,F,2);const X=[],Z=[];for(let J=0;J<F.size();J++){const me=F.get(J);if(me.size()===2){const Te=me.get(0),W=me.get(1);if(Te.distance<wa*W.distance){const ee=k.get(Te.queryIdx).pt,ne=S.get(Te.trainIdx).pt;X.push(ee.x,ee.y),Z.push(ne.x,ne.y)}}}if(F.delete(),N.delete(),X.length/2<8)return q(null);const le=e.matFromArray(X.length/2,1,e.CV_32FC2,X),L=e.matFromArray(Z.length/2,1,e.CV_32FC2,Z),O=new e.Mat,C=e.findHomography(le,L,e.RANSAC,5,O);let z=0;for(let J=0;J<O.rows;J++)z+=O.data[J];const U=C.rows===3?[...C.data64F]:null;if(le.delete(),L.delete(),O.delete(),C.delete(),U===null||z<_m)return q(null);const P=1/m,j=[[P,0,c],[0,P,p],[0,0,1]],ie=[0,1,2].map(J=>[0,1,2].map(me=>j[J][0]*U[me]+j[J][1]*U[3+me]+j[J][2]*U[6+me]));return q({H:ie,inliers:z})}function $a(e,t,n){if(e.length!==4||e.some(u=>!Number.isFinite(u[0])||!Number.isFinite(u[1])))return!1;let r=0;for(let u=0;u<4;u++){const[l,c]=e[u],[d,p]=e[(u+1)%4];r+=l*p-d*c}const i=Math.abs(r/2)/(t*n);if(i<k_||i>C_)return!1;const a=e.map((u,l)=>{const c=e[(l+1)%4];return Math.hypot(c[0]-u[0],c[1]-u[1])}),o=Math.min(...a);if(o<1)return!1;const s=Math.max(...a)/o;return s>=T_&&s<=E_}function va(e,t,n){const r=e[2][0]*t+e[2][1]*n+e[2][2];return[(e[0][0]*t+e[0][1]*n+e[0][2])/r,(e[1][0]*t+e[1][1]*n+e[1][2])/r]}function Ma(e,t,n,r){const i=n.width,a=n.height,o=Math.max(8,Math.trunc(xa*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=r.map(G=>[G[0],G[1],G[2]-o*(G[0]+G[1])+0]);for(let G=0;G<3;G++)l[G][2]=r[G][2]-o*r[G][0]-o*r[G][1];const c=tt(e,t),d=new e.Mat,p=e.matFromArray(3,3,e.CV_64F,l.flat());e.warpPerspective(c,d,p,new e.Size(s,u),e.WARP_INVERSE_MAP);const f=new e.Mat;e.cvtColor(d,f,e.COLOR_RGB2Lab),c.delete(),p.delete();const m=f.data,y=Math.max(4,Math.trunc(o/3)),w=[[],[],[]],b=(G,q)=>{const N=(q*s+G)*3;w[0].push(m[N]),w[1].push(m[N+1]),w[2].push(m[N+2])};for(let G=0;G<u;G++)for(let q=0;q<s;q++)(G<y||G>=u-y||q<y||q>=s-y)&&b(q,G);const x=G=>{G.sort((N,F)=>N-F);const q=G.length>>1;return G.length%2?G[q]:(G[q-1]+G[q])/2},M=[x(w[0]),x(w[1]),x(w[2])],v=(G,q)=>{const N=(q*s+G)*3,F=m[N]-M[0],X=m[N+1]-M[1],Z=m[N+2]-M[2];return Math.sqrt(F*F+X*X+Z*Z)>R_},I=Math.max(6,Math.trunc(xm*i)),E=Math.max(6,Math.trunc(xm*a)),k=Math.max(2,Math.trunc($m*i)),S=Math.max(2,Math.trunc($m*a)),R=G=>{let q=0,N=0;for(const F of G)N=F?N+1:0,N>q&&(q=N);return q/Math.max(1,G.length)},B=G=>{let q,N,F,X,Z;if(G==="L"?(q=o,N=o+a,F=Math.max(0,o-k-I),X=Math.max(0,o-k),Z=!1):G==="R"?(q=o,N=o+a,F=o+i+k,X=Math.min(s,o+i+k+I),Z=!1):(q=Math.max(0,o-S-E),N=Math.max(0,o-S),F=o,X=o+i,Z=!0),N<=q||X<=F)return 0;const le=[];if(Z)for(let L=F;L<X;L++){let O=0;for(let C=q;C<N;C++)v(L,C)&&O++;le.push(O/(N-q)>vm)}else for(let L=q;L<N;L++){let O=0;for(let C=F;C<X;C++)v(C,L)&&O++;le.push(O/(X-F)>vm)}return R(le)},Y={L:B("L"),R:B("R"),T:B("T")};return d.delete(),f.delete(),Y}const N_=6e3,z_=8,Mm=.5,B_=.6;function P_(e,t,n,r){if(n.size===0)return[];const i=Math.max(t.width,t.height)<ba?_a:1,a=tt(e,t),o=new e.Mat;i!==1?e.resize(a,o,new e.Size(0,0),i,i,e.INTER_CUBIC):a.copyTo(o);const s=new e.Mat;e.cvtColor(o,s,e.COLOR_RGB2GRAY),a.delete(),o.delete();const u=new e.ORB(N_),l=new e.Mat,c=new e.KeyPointVector,d=new e.Mat;u.detectAndCompute(s,l,c,d);const p=[],f=new e.BFMatcher(e.NORM_HAMMING);try{if(d.rows<8)return p;for(const[m,y]of n){if(r!==void 0&&Date.now()>r)break;const w=tt(e,y),b=new e.Mat;e.cvtColor(w,b,e.COLOR_RGB2GRAY);const x=new e.KeyPointVector,M=new e.Mat;u.detectAndCompute(b,l,x,M);const v=[w,x,M],I=()=>{for(const ie of v)ie.delete();b.delete()};if(M.rows<8){I();continue}const E=new e.DMatchVectorVector;f.knnMatch(M,d,E,2);const k=[],S=[];for(let ie=0;ie<E.size();ie++){const J=E.get(ie);if(J.size()===2){const me=J.get(0);if(me.distance<wa*J.get(1).distance){const Te=x.get(me.queryIdx).pt,W=c.get(me.trainIdx).pt;k.push(Te.x,Te.y),S.push(W.x,W.y)}}}if(E.delete(),k.length/2<8){I();continue}const R=e.matFromArray(k.length/2,1,e.CV_32FC2,k),B=e.matFromArray(S.length/2,1,e.CV_32FC2,S),Y=new e.Mat,G=e.findHomography(R,B,e.RANSAC,5,Y);let q=0;for(let ie=0;ie<Y.rows;ie++)q+=Y.data[ie];const N=G.rows===3?[...G.data64F]:null;if(R.delete(),B.delete(),Y.delete(),G.delete(),N===null||q<z_){I();continue}const F=1/i,X=[[F*N[0],F*N[1],F*N[2]],[F*N[3],F*N[4],F*N[5]],[N[6],N[7],N[8]]],Z=[[0,0],[y.width,0],[y.width,y.height],[0,y.height]].map(([ie,J])=>va(X,ie,J));if(!$a(Z,t.width,t.height)){I();continue}const le=tt(e,t),L=e.matFromArray(3,3,e.CV_64F,X.flat()),O=new e.Mat;e.warpPerspective(le,O,L,new e.Size(y.width,y.height),e.WARP_INVERSE_MAP);const C=new e.Mat;e.cvtColor(O,C,e.COLOR_RGB2GRAY);const z=new e.Mat;e.matchTemplate(C,b,z,e.TM_CCOEFF_NORMED);const U=z.data32F[0];if(le.delete(),L.delete(),O.delete(),C.delete(),z.delete(),U<Mm){I();continue}const P=Ma(e,t,y,X),j=Sa(P);p.push({id:m,confidence:Math.max(0,U),footprint:Z,built:P!==null&&Math.max(P.L,P.R,P.T)>=Yr,tuckRegion:Xr(Z,j)}),I()}}finally{s.delete(),l.delete(),c.delete(),d.delete();try{u.delete(),f.delete()}catch{}}return p}function Sa(e){return e!==null&&e.R>=Yr?["R"]:[]}function Xr(e,t){if(e.length<4||t.length===0)return null;const n=e.map(y=>[y[0],y[1]]),r=Math.hypot(n[1][0]-n[0][0],n[1][1]-n[0][1]),i=Math.hypot(n[2][0]-n[3][0],n[2][1]-n[3][1]),a=.5*(r+i),o=xa*a;if(!(o>0))return null;const s=n.reduce((y,w)=>y+w[0],0)/n.length,u=n.reduce((y,w)=>y+w[1],0)/n.length,l={T:[0,1],R:[1,2],L:[0,3]},c=[...n];for(const y of["L","R","T"]){if(!t.includes(y))continue;const[w,b]=l[y],x=n[w],M=n[b];let v=-(M[1]-x[1]),I=M[0]-x[0];const E=(x[0]+M[0])/2,k=(x[1]+M[1])/2;v*(E-s)+I*(k-u)<0&&(v=-v,I=-I);const S=Math.hypot(v,I);S<=1e-6||(v=v/S*o,I=I/S*o,c.push([x[0]+v,x[1]+I],[M[0]+v,M[1]+I]))}const d=c.map(y=>y[0]),p=c.map(y=>y[1]),f=Math.round(Math.min(...d)),m=Math.round(Math.min(...p));return{x:f,y:m,width:Math.round(Math.max(...d))-f,height:Math.round(Math.max(...p))-m}}function D_(e,t,n,r){const i=O_(e,n,t,r);if(i===null)return null;const o=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([l,c])=>va(i.H,l,c));if(!$a(o,t.width,t.height))return null;const s=Ma(e,t,n,i.H);if(s===null)return null;const u=Sa(s);return{built:Math.max(s.L,s.R,s.T)>=Yr,footprint:o,overflow:u,edgeScores:s,inliers:i.inliers}}const U_=.88;function Ia(e,t,n,r){if(r.length!==4)return null;const i=n.width,a=n.height,o=Math.max(8,Math.trunc(xa*i)),s=i+2*o,u=a+2*o;if(s*u>4e7)return null;const l=o+Math.trunc(i*U_),c=s-l;if(c<1)return null;const d=tt(e,t),p=e.matFromArray(4,1,e.CV_32FC2,[0,0,i,0,i,a,0,a]),f=e.matFromArray(4,1,e.CV_32FC2,[r[0][0],r[0][1],r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]),m=e.getPerspectiveTransform(p,f),y=[...m.data64F],w=[0,1,2].flatMap(k=>[y[k*3],y[k*3+1],y[k*3+2]-o*y[k*3]-o*y[k*3+1]]),b=e.matFromArray(3,3,e.CV_64F,w),x=new e.Mat;e.warpPerspective(d,x,b,new e.Size(s,u),e.WARP_INVERSE_MAP);const M=x.roi(new e.Rect(l,0,c,u)),v=new e.Mat;M.copyTo(v);const I=v.data,E=new Uint8ClampedArray(c*u*3);E.set(I.subarray(0,E.length));for(const k of[d,p,f,m,b,x,M,v])try{k.delete()}catch{}return{width:c,height:u,channels:3,data:E}}function L_(e,t,n,r){const[i,a,o,s]=r;if(o<8||s<8)return null;const u=Math.trunc(.06*o),l=Math.trunc(.06*s),c=Math.max(0,Math.trunc(i-u)),d=Math.min(n.width,Math.trunc(i+o+u)),p=Math.max(0,Math.trunc(a-l)),f=Math.min(n.height,Math.trunc(a+s+l));if(d-c<8||f-p<8)return null;const m=Math.max(n.width,n.height)<ba?_a:1,y=tt(e,n),w=tt(e,t),b=y.roi(new e.Rect(c,p,d-c,f-p)),x=new e.Mat;m!==1?e.resize(b,x,new e.Size(0,0),m,m,e.INTER_CUBIC):b.copyTo(x);const M=new e.Mat,v=new e.Mat;e.cvtColor(w,M,e.COLOR_RGB2GRAY),e.cvtColor(x,v,e.COLOR_RGB2GRAY);const I=new e.ORB(bm),E=new e.KeyPointVector,k=new e.KeyPointVector,S=new e.Mat,R=new e.Mat,B=new e.Mat,Y=[y,w,b,x,M,v,E,k,S,R,B],G=ie=>{for(const J of Y)try{J.delete()}catch{}try{I.delete()}catch{}return ie};if(I.detectAndCompute(M,B,E,S),I.detectAndCompute(v,B,k,R),S.rows<8||R.rows<8)return G(null);const q=new e.BFMatcher(e.NORM_HAMMING),N=new e.DMatchVectorVector;q.knnMatch(S,R,N,2);const F=[],X=[];for(let ie=0;ie<N.size();ie++){const J=N.get(ie);if(J.size()===2){const me=J.get(0),Te=J.get(1);if(me.distance<wa*Te.distance){const W=E.get(me.queryIdx).pt,ee=k.get(me.trainIdx).pt;F.push(W.x,W.y),X.push(ee.x,ee.y)}}}if(N.delete(),q.delete(),F.length/2<8)return G(null);const Z=e.matFromArray(F.length/2,1,e.CV_32FC2,F),le=e.matFromArray(X.length/2,1,e.CV_32FC2,X),L=new e.Mat,O=e.findHomography(Z,le,e.RANSAC,5,L);let C=0;for(let ie=0;ie<L.rows;ie++)C+=L.data[ie];const z=O.rows===3?[...O.data64F]:null;if(Z.delete(),le.delete(),L.delete(),O.delete(),z===null||C<_m)return G(null);const U=1/m,P=[[U,0,c],[0,U,p],[0,0,1]],j=[0,1,2].map(ie=>[0,1,2].map(J=>P[ie][0]*z[J]+P[ie][1]*z[3+J]+P[ie][2]*z[6+J]));return G({H:j,inliers:C})}const F_=620;function G_(e,t){return{width:t.cols,height:t.rows,channels:3,data:new Uint8Array(t.data.slice(0,t.rows*t.cols*3))}}function Sm(e,t,n,r){const i=Im(e,t,n,r);if(i!==null)return i;try{const[a,o,s,u]=r.map(I=>Math.trunc(I));if(Math.min(s,u)>=F_||s<=0||u<=0)return null;const l=Math.trunc(s*.25),c=Math.trunc(u*.25),d=Math.max(0,a-l),p=Math.max(0,o-c),f=Math.min(t.width,a+s+l),m=Math.min(t.height,o+u+c);if(f<=d||m<=p)return null;const y=tt(e,t),w=y.roi(new e.Rect(d,p,f-d,m-p)),b=new e.Mat;e.resize(w,b,new e.Size((f-d)*2,(m-p)*2),0,0,e.INTER_CUBIC);const x=G_(e,b);for(const I of[y,w,b])try{I.delete()}catch{}const M=[(a-d)*2,(o-p)*2,s*2,u*2],v=Im(e,x,n,M);return v===null?null:{...v,footprint:v.footprint.map(([I,E])=>[I*.5+d,E*.5+p])}}catch{return null}}function Im(e,t,n,r){const i=L_(e,n,t,r);if(i===null)return null;const o=[[0,0],[n.width,0],[n.width,n.height],[0,n.height]].map(([b,x])=>va(i.H,b,x));if(!$a(o,t.width,t.height))return null;const s=tt(e,t),u=e.matFromArray(3,3,e.CV_64F,i.H.flat()),l=new e.Mat;e.warpPerspective(s,l,u,new e.Size(n.width,n.height),e.WARP_INVERSE_MAP);const c=tt(e,n),d=new e.Mat,p=new e.Mat;e.cvtColor(l,d,e.COLOR_RGB2GRAY),e.cvtColor(c,p,e.COLOR_RGB2GRAY);const f=new e.Mat;e.matchTemplate(d,p,f,e.TM_CCOEFF_NORMED);const m=f.data32F[0];for(const b of[s,u,l,c,d,p,f])try{b.delete()}catch{}if(m<Mm)return null;const y=Ma(e,t,n,i.H);if(y===null)return null;const w=Sa(y);return{built:Math.max(y.L,y.R,y.T)>=Yr,footprint:o,overflow:w,edgeScores:y,inliers:i.inliers}}function W_(e,t,n,r=.03){let i=null,a=1/0;for(const o of e){const[s,u,l,c]=o;if(l<=0||c<=0)continue;const d=r*l,p=r*c;if(t>=s-d&&t<=s+l+d&&n>=u-p&&n<=u+c+p){const f=l*c;f<a&&(a=f,i=[s,u,l,c])}}return i}const q_=.3,V_=.3;function H_(e,t){const n=e.filter(a=>a.edgeScores!==null);if(n.length===0)return[];const r=n.length>=2&&n.every(a=>{const{L:o,R:s,T:u}=a.edgeScores;return Math.min(o,s,u)>=q_}),i=[];return e.forEach((a,o)=>{if(!a.built||a.edgeScores===null)return;const{L:s,R:u,T:l}=a.edgeScores,c=Math.max(s,u,l)<V_;if(!r&&!c)return;t.some(([p,f])=>p>=a.zone.x0&&p<=a.zone.x1&&f>=a.zone.y0&&f<=a.zone.y1)||i.push(o)}),i}const gt=128,Wn=.5;function Qr(e){const t=Fn(e,gt,gt),n=gt*gt,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function Ta(e){const t=e[1]??0;return{built:t>=Wn,prob:t}}const fr=120,mr=179,j_=1.3,K_=3.6,Y_=.45,X_=6e-4,Q_=.02,Z_=6e3,J_=.78,e1=1.25,t1=2.4,n1=.05,r1=1.5,i1=.5,o1=.9,a1=150,s1=18,u1=34,l1=90,c1=130,d1=.13,h1=.15,Zr="magistrates-guild",Ea="merchants-guild";function p1(e,t){const n=tt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2HSV),n.delete();const i=new e.Mat(r.rows,r.cols,r.type(),[fr,30,40,0]),a=new e.Mat(r.rows,r.cols,r.type(),[mr,255,205,255]),o=new e.Mat;e.inRange(r,i,a,o),r.delete(),i.delete(),a.delete();const s=new Uint8Array(o.data),u=e.getStructuringElement(e.MORPH_RECT,new e.Size(31,31)),l=new e.Mat;e.morphologyEx(o,l,e.MORPH_CLOSE,u),o.delete(),u.delete();const c=new e.Mat,d=new e.Mat,p=new e.Mat,f=e.connectedComponentsWithStats(l,c,d,p,8);l.delete(),c.delete(),p.delete();const m=t.width*t.height,y=[];for(let w=1;w<f;w++){const b=d.intAt(w,0),x=d.intAt(w,1),M=d.intAt(w,2),v=d.intAt(w,3),I=d.intAt(w,4),E=I/m;E<X_||E>Q_||I/Math.max(M*v,1)<Y_||y.push({x:b,y:x,w:M,h:v})}return d.delete(),{blobs:y,mask:s,maskWidth:t.width}}function f1(e,t,n,r,i,a,o){const s=e,u=a,l=o,c=i;if(!c.gray){const U=tt(e,r);c.gray=new s.Mat,s.cvtColor(U,c.gray,s.COLOR_RGB2GRAY),U.delete(),c.k=new s.KeyPointVector,c.d=new s.Mat;const P=new s.Mat;u.detectAndCompute(c.gray,P,c.k,c.d),P.delete()}const d=n,p=new s.Mat,f=new s.KeyPointVector,m=new s.Mat;u.detectAndCompute(d,p,f,m),p.delete();const y=U=>(f.delete(),m.delete(),U);if(c.d.rows<8||m.rows<8)return y(null);const w=new s.DMatchVectorVector;l.knnMatch(c.d,m,w,2);const b=[],x=[];for(let U=0;U<w.size();U++){const P=w.get(U);if(P.size()===2){const j=P.get(0);if(j.distance<J_*P.get(1).distance){const ie=c.k.get(j.queryIdx).pt,J=f.get(j.trainIdx).pt;b.push(ie.x,ie.y),x.push(J.x,J.y)}}}if(w.delete(),b.length/2<8)return y(null);const M=s.matFromArray(b.length/2,1,s.CV_32FC2,b),v=s.matFromArray(x.length/2,1,s.CV_32FC2,x),I=new s.Mat,E=s.findHomography(M,v,s.RANSAC,5,I);if(M.delete(),v.delete(),I.delete(),E.rows!==3)return E.delete(),y(null);const k=[...E.data64F],S=(U,P)=>{const j=k[6]*U+k[7]*P+k[8];return[(k[0]*U+k[1]*P+k[2])/j,(k[3]*U+k[4]*P+k[5])/j]},R=[[0,0],[r.width,0],[r.width,r.height],[0,r.height]].map(([U,P])=>S(U,P));if(R.some(U=>!Number.isFinite(U[0])||!Number.isFinite(U[1])))return E.delete(),y(null);const B=R.map((U,P)=>{const j=R[(P+1)%4];return Math.hypot(j[0]-U[0],j[1]-U[1])}),Y=Math.min(...B);if(Y<1)return E.delete(),y(null);const G=Math.max(...B)/Y;let q=0;for(let U=0;U<4;U++){const[P,j]=R[U],[ie,J]=R[(U+1)%4];q+=P*J-ie*j}const N=t,F=Math.abs(q/2)/(N.rows*N.cols);if(G<e1||G>t1||F<n1||F>r1)return E.delete(),y(null);const X=new s.Mat;s.warpPerspective(N,X,E,new s.Size(r.width,r.height),s.WARP_INVERSE_MAP),E.delete();const Z=new s.Mat;s.cvtColor(X,Z,s.COLOR_RGB2GRAY),X.delete();const le=Math.trunc(r.height/2),L=Z.roi(new s.Rect(0,0,r.width,le)),O=c.gray.roi(new s.Rect(0,0,r.width,le)),C=new s.Mat;s.matchTemplate(L,O,C,s.TM_CCOEFF_NORMED);const z=C.data32F[0];return L.delete(),O.delete(),C.delete(),Z.delete(),y(z)}function m1(e,t,n){let r,i;if(n===Zr)r=Ea,i=d1;else if(n===Ea)r=Zr,i=h1;else return null;const{x:a,y:o,w:s,h:u}=t;if(s<8||u<8)return null;const l=Math.trunc(s/2);let c=0,d=null;for(const[p,f]of[[0,l],[l,s]]){let m=0,y=0;for(let b=o;b<o+u;b++)for(let x=a+p;x<a+f;x++){const M=(b*e.width+x)*e.channels,{h:v,s:I,v:E}=kt(e.data[M],e.data[M+1],e.data[M+2]);if(v>=fr&&v<=mr&&I>=30&&I<=170&&E<=170)continue;m++,(r===Ea?v>=s1&&v<=u1&&I>=l1&&E>=c1:v>=95&&v<=130&&I>=80)&&y++}if(m<20)continue;const w=y/m;w>c&&(c=w,d={x:a+p,y:o,w:f-p,h:u})}return c>=i&&d!==null?{id:r,box:d}:null}const g1=1.7,y1=140,w1=170,b1=.2,_1=.1,Tm=240,Em=80,km=60,x1=50,Cm="scientists-guild",Am="tacticians-guild",Jr=["shipowners-guild","merchants-guild","builders-guild","moneylenders-guild"];function $1(e,t,n){const{x:r,y:i,w:a,h:o}=n,s=new Float32Array(o);for(let v=0;v<o;v++){let I=0;for(let E=0;E<a;E++)e[(i+v)*t+r+E]>0&&I++;s[v]=I/a}const u=[];for(let v=0;v<o;v++)s[v]>.3&&u.push(v);if(u.length<5)return[];const l=u[0],c=u[u.length-1],d=c-l;if(d<5)return[];const p=a/d;if(p<j_||p>K_)return[];if(p>=g1)return[{x:r,y:i+l,w:a,h:d}];const f=new Float32Array(o),m=.3*(8*.5-1)+.8,y=[];let w=0;for(let v=-4;v<=4;v++){const I=Math.exp(-(v*v)/(2*m*m));y.push(I),w+=I}for(let v=0;v<o;v++){let I=0;for(let E=-4;E<=4;E++){const k=Math.min(o-1,Math.max(0,v+E));I+=s[k]*y[E+4]}f[v]=I/w}const b=l+Math.trunc(d*.3),x=l+Math.trunc(d*.78);let M=l+Math.trunc(d/2);if(x>b){let v=1/0;for(let I=b;I<x;I++)f[I]<v&&(v=f[I],M=I)}return[{x:r,y:i+l,w:a,h:M-l},{x:r,y:i+M,w:a,h:c-M}]}function v1(e,t){const n=Math.max(0,t.x),r=Math.max(0,t.y),i=Math.min(e.width,t.x+t.w),a=Math.min(e.height,t.y+t.h),o=Math.max(0,i-n),s=Math.max(0,a-r),u=new Uint8Array(o*s*3);for(let l=0;l<s;l++)for(let c=0;c<o;c++){const d=((r+l)*e.width+n+c)*e.channels,p=(l*o+c)*3;u[p]=e.data[d],u[p+1]=e.data[d+1],u[p+2]=e.data[d+2]}return{width:o,height:s,channels:3,data:u}}function M1(e){let t=0,n=0;for(let r=0,i=e.width*e.height;r<i;r++){const a=r*e.channels,{h:o,s,v:u}=kt(e.data[a],e.data[a+1],e.data[a+2]);s>=40&&u>=40&&u<=205&&(t++,o>=y1&&o<=w1&&n++)}return t===0?0:n/t}function S1(e){let t=0;const n=e.width*e.height;for(let r=0;r<n;r++){const i=r*e.channels,{h:a,s:o,v:s}=kt(e.data[i],e.data[i+1],e.data[i+2]);!(a>=fr&&a<=mr)&&o>=70&&s>=50&&t++}return n===0?0:t/n}function Rm(e,t){const n=tt(e,t),r=new e.Mat;e.resize(n,r,new e.Size(Tm,Em),0,0,e.INTER_AREA),n.delete();const i=new Uint8Array(r.data);return r.delete(),{width:Tm,height:Em,channels:3,data:i}}function I1(e){const t=e.width*e.height,n=[0,0,0];for(let a=0;a<t;a++){const o=a*e.channels;n[0]+=e.data[o],n[1]+=e.data[o+1],n[2]+=e.data[o+2]}n[0]/=t,n[1]/=t,n[2]/=t;const r=(n[0]+n[1]+n[2])/3,i=new Uint8Array(t*3);for(let a=0;a<t;a++){const o=a*e.channels;for(let s=0;s<3;s++){const u=n[s]>1e-6?r/n[s]:1;i[a*3+s]=Math.max(0,Math.min(255,Math.round(e.data[o+s]*u)))}}return{width:e.width,height:e.height,channels:3,data:i}}function Om(e,t){const n=I1(t),r=n.width*n.height,i=new Uint8Array(r);let a=0;for(let m=0;m<r;m++){const y=m*3,{h:w,s:b,v:x}=kt(n.data[y],n.data[y+1],n.data[y+2]);!(w>=fr&&w<=mr&&b>=30&&b<=170&&x<=170)&&x>=40&&(i[m]=1,a++)}const o=a<20,s=tt(e,n),u=new e.Mat;e.cvtColor(s,u,e.COLOR_RGB2Lab),s.delete();const l=u.data;let c=0,d=0,p=0,f=0;for(let m=0;m<r;m++)!o&&i[m]===0||(c+=l[m*3]*100/255,d+=l[m*3+1]-128,p+=l[m*3+2]-128,f++);return u.delete(),f===0?[0,0,0]:[c/f,d/f,p/f]}function T1(e){let t=0,n=0,r=0,i=0,a=0;const o=e.width*e.height;for(let u=0;u<o;u++){const l=u*e.channels,{h:c,s:d,v:p}=kt(e.data[l],e.data[l+1],e.data[l+2]);c>=fr&&c<=mr&&d>=30&&d<=170&&p<=170||(t++,d>=70&&p>=50&&(c>=95&&c<=130?n++:c>=35&&c<=92?r++:c<=10?i++:c>=15&&c<=34&&p>=80&&a++))}const s=Math.max(t,1);return{blue:n/s,green:r/s,red:i/s,gold:a/s}}function E1(e){const t=e.width*e.height,n={blue:0,green:0,red:0,gold:0,brown:0,grey:0};for(let r=0;r<t;r++){const i=r*e.channels,{h:a,s:o,v:s}=kt(e.data[i],e.data[i+1],e.data[i+2]);o>=km&&s>=x1?(a>=95&&a<=128&&n.blue++,a>=35&&a<=85&&n.green++,(a<=8||a>=170)&&n.red++,a>=18&&a<=34&&n.gold++,a>=4&&a<=17&&s<150&&n.brown++):o<km&&s>=70&&s<=235&&n.grey++}for(const r of Object.keys(n))n[r]/=t;return n}function k1(e,t){let n=0,r=0;for(let s=0;s<e.length;s++)n+=e[s],r+=t[s];n/=e.length,r/=t.length;let i=0,a=0,o=0;for(let s=0;s<e.length;s++){const u=e[s]-n,l=t[s]-r;i+=u*l,a+=u*u,o+=l*l}return i/(Math.sqrt(a*o)+1e-6)}function Nm(e,t){const n=tt(e,t),r=new e.Mat;e.cvtColor(n,r,e.COLOR_RGB2GRAY),n.delete();const i=Float32Array.from(r.data);return r.delete(),i}function C1(e,t){const n=new Map,r=new Map;for(const[i,a]of t){const o=Rm(e,a);n.set(i,Nm(e,o)),Jr.includes(i)&&r.set(i,Om(e,o))}return{gray:n,warmLab:r}}function A1(e,t,n){const r=Rm(e,t),i=T1(r);if(i.blue>=.15&&i.blue>i.red&&i.blue>2*i.gold)return Zr;if(i.green>=.08&&i.green>i.blue&&i.green>i.gold)return Cm;if(i.red>=.15&&i.red>i.blue&&i.red>1.5*i.gold)return Am;const a=E1(r),o={blue:a.blue,green:a.green,red:a.red,gold:a.gold,browngrey:a.brown+a.grey};let s="blue";for(const l of Object.keys(o))o[l]>o[s]&&(s=l);if(o[s]<=0)return"";let u;if(s==="blue")u=Zr;else if(s==="green")u=Cm;else if(s==="red")u=Am;else{const l=Nm(e,r);let c="",d=-2;for(const p of Jr){const f=n.gray.get(p);if(f===void 0)continue;const m=k1(l,f);m>d&&(d=m,c=p)}u=c||Jr[0]}if(Jr.includes(u)&&n.warmLab.size>0){const l=Om(e,r);let c=u,d=1/0;for(const[p,f]of n.warmLab){const m=Math.hypot(l[0]-f[0],l[1]-f[1],l[2]-f[2]);m<d&&(d=m,c=p)}return c}return u}function R1(e,t,n,r,i){var y;const a=[],{blobs:o,mask:s,maskWidth:u}=p1(e,t);if(o.length===0||n.size===0)return a;const l=e,c=new l.ORB(Z_),d=new l.BFMatcher(l.NORM_HAMMING),p=new Map;for(const w of n.keys())p.set(w,{});const f=tt(e,t);let m=null;try{for(const w of o){if(r!==void 0&&Date.now()>r)break;const b=w.x+Math.trunc(w.w/2),x=w.y+Math.trunc(w.h/2),M=Math.max(a1,Math.trunc(o1*Math.max(w.w,w.h))),v=Math.max(0,b-M),I=Math.max(0,x-M),E=Math.min(t.width,b+M),k=Math.min(t.height,x+M);if(E-v<16||k-I<16)continue;const S=f.roi(new l.Rect(v,I,E-v,k-I)),R=new l.Mat;l.cvtColor(S,R,l.COLOR_RGB2GRAY);let B=null,Y=-2;for(const[F,X]of n){if(r!==void 0&&Date.now()>r)break;const Z=f1(e,S,R,X,p.get(F),c,d);Z!==null&&Z>Y&&(Y=Z,B=F)}S.delete(),R.delete();const G=new Set;if(B!==null&&Y>=i1){a.push({id:B,boundingBox:{x:w.x,y:w.y,width:w.w,height:w.h},confidence:1}),G.add(B);const F=m1(t,w,B);F&&(a.push({id:F.id,boundingBox:{x:F.box.x,y:F.box.y,width:F.box.w,height:F.box.h},confidence:.9}),G.add(F.id))}if(i===void 0||i.size===0)continue;const q=$1(s,u,w);if(q.length!==2)continue;const N=q.map(F=>v1(t,F));if(!N.some(F=>F.width*F.height===0||S1(F)<_1))for(let F=0;F<q.length;F++){const X=N[F];if(M1(X)<b1)continue;m===null&&(m=C1(e,i));const Z=A1(e,X,m);if(Z&&!G.has(Z)){G.add(Z);const le=q[F];a.push({id:Z,boundingBox:{x:le.x,y:le.y,width:le.w,height:le.h},confidence:1})}}}}finally{f.delete();for(const w of p.values()){const b=w;for(const x of["gray","k","d"])try{(y=b[x])==null||y.delete()}catch{}}try{c.delete(),d.delete()}catch{}}return a}const zm=128,O1=.56,N1=15,z1=.58,B1=70,P1=50,D1=.12,U1=.2,L1=.1,F1=.17,Bm=.15;function G1(e){const t=new Map;for(const[n,r]of Object.entries(e.templates)){const i=Uint8Array.from(atob(r),a=>a.charCodeAt(0));i.length===e.size*e.size&&t.set(n,i)}return t}function Pm(e,t){const{width:n,height:r,channels:i,data:a}=e,o=Math.floor(n/2),s=Math.floor(r/2),u=Math.trunc(Math.min(n,r)*.5*t);if(u<1)return e;const l=Math.max(0,o-u),c=Math.max(0,s-u),d=Math.min(n,o+u),p=Math.min(r,s+u),f=d-l,m=p-c,y=new Uint8Array(f*m*i);for(let w=0;w<m;w++){const b=((w+c)*n+l)*i;y.set(a.subarray(b,b+f*i),w*f*i)}return{width:f,height:m,channels:i,data:y}}function W1(e){const t=Pm(e,O1),n=Nb(t),r=mm(n,zm,zm);return zb(r)}function q1(e,t){const n=e.length;let r=0,i=0;for(let u=0;u<n;u++)r+=e[u],i+=t[u];r/=n,i/=n;let a=0,o=0,s=0;for(let u=0;u<n;u++){const l=e[u]-r,c=t[u]-i;a+=l*c,o+=l*l,s+=c*c}return a/(Math.sqrt(o*s)+1e-6)}function V1(e){const t=new Map([["masonry",0],["strategy",0]]),n=Pm(e,z1),{width:r,height:i,channels:a,data:o}=n,s=r*i||1;let u=0,l=0;for(let p=0;p<r*i;p++){const f=p*a,{h:m,s:y,v:w}=kt(o[f],o[f+1],o[f+2]);y>=B1&&w>=P1&&(m>=95&&m<=130&&(u+=1),(m<=8||m>=170)&&(l+=1))}const c=u/s,d=l/s;return c>=D1&&t.set("masonry",Bm*Math.min(1,c/U1)),d>=L1&&t.set("strategy",Bm*Math.min(1,d/F1)),t}function H1(e,t){if(t.size===0||e.width===0||e.height===0)return["",0];const n=W1(e);let r=0;for(const l of n.data)r+=l;const i=r/n.data.length,a=[];for(let l=0;l<360;l+=N1)a.push(Db(n,l,i));const o=new Map;for(const[l,c]of t){let d=-1/0;for(const p of a){const f=q1(p,c);f>d&&(d=f)}o.set(l,d)}for(const[l,c]of V1(e))c>0&&o.has(l)&&o.set(l,o.get(l)+c);let s="",u=-1/0;for(const[l,c]of o)c>u&&(s=l,u=c);return[s,u]}const un=224,j1=512,K1=[.485,.456,.406],Y1=[.229,.224,.225];function X1(e){const t=atob(e.x),n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);const r=new Float32Array(n.buffer);if(r.length!==e.ids.length*e.dim)throw new Error(`token_embed_index: ${r.length} floats != ${e.ids.length}x${e.dim}`);return{dim:e.dim,ids:e.ids,x:r}}function Q1(e){const t=ca(e,un,un),n=un*un,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=(t[i*3+a]/255-K1[a])/Y1[a];return r}function Z1(e){const t=3*un*un,n=new Float32Array(4*t);for(let r=0;r<4;r++)n.set(Q1(Yt(e,r)),r*t);return n}function J1(e,t=j1){const n=e.length/t,r=new Float32Array(t);for(let a=0;a<n;a++)for(let o=0;o<t;o++)r[o]+=e[a*t+o];let i=0;for(let a=0;a<t;a++)r[a]/=n,i+=r[a]*r[a];i=Math.max(Math.sqrt(i),1e-9);for(let a=0;a<t;a++)r[a]/=i;return r}function e2(e,t){let n=0,r=-2;for(let i=0;i<e.ids.length;i++){let a=0;const o=i*e.dim;for(let s=0;s<e.dim;s++)a+=e.x[o+s]*t[s];a>r&&(r=a,n=i)}return{id:e.ids[n],cosine:r}}const qn=96,t2=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"],n2=.45;function r2(e){const t=ca(e,qn,qn),n=qn*qn,r=new Float32Array(3*n);for(let i=0;i<n;i++)for(let a=0;a<3;a++)r[a*n+i]=t[i*3+a]/255;return r}function i2(e){let t=0;for(let r=1;r<e.length;r++)e[r]>e[t]&&(t=r);const n=e[t];return{id:n>=n2?t2[t]??"":"",prob:n}}const Qt=128,o2=["circus-maximus","piraeus","the-appian-way","the-colossus","the-great-library","the-great-lighthouse","the-hanging-gardens","the-mausoleum","the-pyramids","the-sphinx","the-statue-of-zeus","the-temple-of-artemis","other"],a2=.5;let Dm=null;function s2(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError(`seuil merveilles hors bornes : ${e}`);Dm=e}function Um(){return Dm??a2}let Lm=null;function u2(e){if(!Array.isArray(e)||e.length===0||!e.includes("other"))throw new RangeError("classes merveilles invalides (liste vide ou sans `other`)");Lm=[...e]}function l2(){return Lm??o2}const Fm="__inverse";function c2(e){return e.endsWith(Fm)?[e.slice(0,-Fm.length),!0]:[e,!1]}function d2(e){const{width:t,height:n,channels:r,data:i}=e,a=new Uint8Array(t*n*3);for(let o=0;o<t*n;o++)for(let s=0;s<3;s++)a[o*3+s]=i[o*r+s];return a}function h2(e){const t=Math.min(Qt/e.width,Qt/e.height),n=Math.max(1,Math.round(e.width*t)),r=Math.max(1,Math.round(e.height*t)),i=n===e.width&&r===e.height?d2(e):t<1?Fn(e,n,r):dr(e,n,r),a=Qt*Qt,o=new Float32Array(3*a);o.fill(114/255);const s=Math.floor((Qt-r)/2),u=Math.floor((Qt-n)/2);for(let l=0;l<r;l++)for(let c=0;c<n;c++){const d=(l*n+c)*3,p=(l+s)*Qt+(c+u);for(let f=0;f<3;f++)o[f*a+p]=i[d+f]/255}return o}async function p2(e,t){const{index:n,prob:r}=f2(await t(h2(e))),[i,a]=c2(l2()[n]??"");return r<Um()||i==="other"||i===""?{id:"",prob:r,inverse:!1}:{id:i,prob:r,inverse:a}}function f2(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{index:t,prob:e[t]}}const Pt=96,m2=[1,2,3,4,5,6,7],g2=.8,y2=.99;function w2(e){const t=dr(e,e.width*2,e.height*2),n=e.width*2<Pt&&e.height*2<Pt,r={width:e.width*2,height:e.height*2,channels:3,data:t},i=n?dr(r,Pt,Pt):Fn(r,Pt,Pt),a=Pt*Pt,o=new Float32Array(3*a);for(let s=0;s<a;s++)for(let u=0;u<3;u++)o[u*a+s]=i[s*3+u]/255;return o}function b2(e){let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{value:m2[t],prob:e[t]}}const ln=128,Gm=.35,_2=["fp","laurel"],x2=.85,Vn=40;function $2(e){const r=(e.width<ln&&e.height<ln?dr:Fn)(e,ln,ln),i=ln*ln,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function v2(e){return e[_2.indexOf("fp")]}const cn=128,M2=.15,Wm=["blue","brown","green","grey","purple","red","yellow","tuile_militaire","dos_de_carte","livret_de_regles","objet_hors_jeu"],S2=7,I2=.9;function T2(e,t,n){const[r,i,a,o]=e.map(Number);if(!(a>1)||!(o>1))return null;const s=r+a/2,u=i+o/2,l=Math.max(a,o)*(1+2*M2),c=Math.max(0,st(s-l/2)),d=Math.max(0,st(u-l/2)),p=Math.min(t,st(s+l/2)),f=Math.min(n,st(u+l/2));return p-c<8||f-d<8?null:{x:c,y:d,w:p-c,h:f-d}}function E2(e){const r=(e.width<cn&&e.height<cn?dr:Fn)(e,cn,cn),i=cn*cn,a=new Float32Array(3*i);for(let o=0;o<i;o++)for(let s=0;s<3;s++)a[s*i+o]=r[o*3+s]/255;return a}function k2(e){let t=0;for(let i=1;i<Wm.length;i++)e[i]>e[t]&&(t=i);const n=e[t],r=t>=S2;return{className:Wm[t],probability:n,rejected:r&&n>=I2}}const ei=3,C2=2.2,A2=.3,R2=.65,O2=3,N2=1.3,z2=.77;function qm(e,t,n){const[r,i,a,o]=e,s=[];return r<=ei&&s.push("gauche"),i<=ei&&s.push("haut"),r+a>=t-ei&&s.push("droit"),i+o>=n-ei&&s.push("bas"),s}function Vm(e){const t=e[3]/Math.max(e[2],1);return t>=N2?"portrait":t<=z2?"paysage":null}function ka(e){const t=[...e].sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function B2(e,t,n){for(const[r,i,a,o]of e??[])if(Math.max(Math.abs(a-r)/Math.max(t,1),Math.abs(o-i)/Math.max(n,1))>R2)return!0;return!1}function P2(e,t,n,r,i){try{const a=[...e],o=a.filter(w=>qm(w.box,r,i).length>0);if(o.length===0)return{kept:a,dropped:[],suspects:[]};const s=a.filter(w=>!o.includes(w)),u=w=>({kept:s,dropped:o.map(b=>({banner:b,edgeReason:w})),suspects:[]});if(B2(n,r,i))return u("photo-piste");if(s.length<O2)return t>0?u("photo-merveilles"):{kept:a,dropped:[],suspects:o.map(w=>({family:w.family,color:w.color,box:w.box,reason:"bord-sans-scene"}))};if(o.length>(s.length+o.length)/3)return u("debordement-structurel");const l=ka(s.map(w=>w.box[2]*w.box[3])),c=ka(s.map(w=>w.box[2])),d=ka(s.map(w=>w.box[3])),p=new Set(s.map(w=>Vm(w.box)).filter(w=>w!==null)),f=[...s],m=[],y=[];for(const w of o){const b=qm(w.box,r,i),[,,x,M]=w.box,v=l>0?x*M/l:0,I=[];(b.includes("gauche")||b.includes("droit"))&&I.push(c>0?x/c:1),(b.includes("haut")||b.includes("bas"))&&I.push(d>0?M/d:1);const E=I.length>0?Math.min(...I):1,k=Vm(w.box);v>C2?m.push({banner:w,edgeReason:"bord-grosse"}):E<A2?m.push({banner:w,edgeReason:"bord-tronquee"}):k!==null&&p.size>0&&!p.has(k)?m.push({banner:w,edgeReason:"bord-orientation-adverse"}):(f.push(w),y.push({family:w.family,color:w.color,box:w.box,reason:"tronquee-par-le-bord"}))}return{kept:f,dropped:m,suspects:y}}catch{return{kept:[...e],dropped:[],suspects:[]}}}const D2=1,U2=1.5;function L2(e){return e.length<4?[]:[[e[0],e[1]],[e[1],e[2]],[e[2],e[3]],[e[3],e[0]]]}function F2(e,t,n,r){const i=r[0]-n[0],a=r[1]-n[1],o=Math.hypot(i,a);if(o<=0)return null;const s=((e-n[0])*i+(t-n[1])*a)/(o*o);return[Math.abs((e-n[0])*a-(t-n[1])*i)/o,Math.abs(s-.5)*o]}function G2(e){if(e.length===0)return null;const t=e.map(r=>r[0]),n=e.map(r=>r[1]);return Math.max(...t)-Math.min(...t)>Math.max(...n)-Math.min(...n)}function W2(e,t,n){try{const r=Number(n);if(!(r>0)||e.length<4||t.length<4)return null;const[i,a,o,s]=t,u=i+o/2,l=a+s/2;let c=null;for(const[p,f]of L2(e)){const m=F2(u,l,p,f);m!==null&&(c===null||m[0]<c[0])&&(c=m)}if(c===null)return null;const d=G2(e);return d===null?null:{distBord:c[0]/r,decalLat:c[1]/r,perpendiculaire:d!==o>s}}catch{return null}}function q2(e,t,n,r=D2,i=U2){const a=[];for(const[o,s]of t??[]){const u=W2(e,s,n);u!==null&&u.perpendiculaire&&(u.decalLat>r||u.distBord>i||a.push([u.decalLat,o]))}return a.length===0?null:(a.sort((o,s)=>o[0]-s[0]||o[1]-s[1]),a[0][1])}const yt=64,Hm=.5,V2=[.67,1.24];function jm(e,t,n,r){const i=Math.max(0,t-r),a=Math.max(0,n-r),o=Math.min(e.width,t+r),s=Math.min(e.height,n+r),u=o-i,l=s-a;if(u<=0||l<=0)return null;const c=e.channels,d=new Uint8ClampedArray(u*l*3),p=r*r;for(let w=0;w<l;w++){const b=a+w,x=b-n;for(let M=0;M<u;M++){const v=i+M,I=v-t,E=(w*u+M)*3;if(I*I+x*x<=p){const k=(b*e.width+v)*c;d[E]=e.data[k],d[E+1]=e.data[k+1],d[E+2]=e.data[k+2]}else d[E]=255,d[E+1]=255,d[E+2]=255}}const f=Fn({width:u,height:l,channels:3,data:d},yt,yt),m=yt*yt,y=new Float32Array(3*m);for(let w=0;w<m;w++)for(let b=0;b<3;b++)y[b*m+w]=f[w*3+b]/255;return y}function H2(e){return e[1]}const ti=[1,3,6],j2=.5;function K2(e){if(e.length!==ti.length)return null;let t=0;for(let n=1;n<e.length;n++)e[n]>e[t]&&(t=n);return{denomination:ti[t],prob:e[t]}}function Y2(e,t){return e.map((n,r)=>{const i=t[r]??null;return i!==null&&ti.includes(i.denomination)&&i.prob>=j2?{value:i.denomination,source:"cnn",conf:i.prob}:{value:n,source:null,conf:null}})}const X2=2.25,ni=3,Q2=1.15,Z2=.5,J2=2.5,ex=.75,tx=2.25,nx=1.3,rx=.77;function ri(e,t){const n=Math.max(0,Math.max(e[0],t[0])-Math.min(e[0]+e[2],t[0]+t[2])),r=Math.max(0,Math.max(e[1],t[1])-Math.min(e[1]+e[3],t[1]+t[3]));return Math.hypot(n,r)}function ix(e){const t=Array.from(new Map(e.map(a=>[`${a[0]},${a[1]}`,a])).values());if(t.sort((a,o)=>a[0]-o[0]||a[1]-o[1]),t.length<=2)return t;const n=(a,o,s)=>(o[0]-a[0])*(s[1]-a[1])-(o[1]-a[1])*(s[0]-a[0]),r=[];for(const a of t){for(;r.length>=2&&n(r[r.length-2],r[r.length-1],a)<=0;)r.pop();r.push(a)}const i=[];for(const a of[...t].reverse()){for(;i.length>=2&&n(i[i.length-2],i[i.length-1],a)<=0;)i.pop();i.push(a)}return[...r.slice(0,-1),...i.slice(0,-1)]}function Km(e,t,n){let r=!1;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[(a+1)%i];if(s>t!=l>t){const c=(u-o)*(t-s)/(l-s)+o;e<c&&(r=!r)}}return r}function ox(e,t,n){if(n.length>=3&&Km(e,t,n))return 0;let r=Number.POSITIVE_INFINITY;const i=n.length;for(let a=0;a<i;a+=1){const[o,s]=n[a],[u,l]=n[i>1?(a+1)%i:a],c=u-o,d=l-s,p=c*c+d*d,f=p===0?0:Math.max(0,Math.min(1,((e-o)*c+(t-s)*d)/p));r=Math.min(r,Math.hypot(e-(o+f*c),t-(s+f*d)))}return r}function ax(e,t,n){const r=Math.max(Math.abs(e-(n[0]+n[2]/2))-n[2]/2,0),i=Math.max(Math.abs(t-(n[1]+n[3]/2))-n[3]/2,0);return Math.hypot(r,i)}function sx(e,t,n){const[r,i]=e,a=t[0]-r,o=t[1]-i;if(a===0&&o===0)return!1;const[s,u,l,c]=n;let d=0,p=1;const f=[[-a,r-s],[a,l-r],[-o,i-u],[o,c-i]];for(const[m,y]of f){if(m===0){if(y<0)return!1;continue}const w=y/m;if(m<0?d=Math.max(d,w):p=Math.min(p,w),d>p)return!1}return d>=p?!1:d>=.1&&p<=.95||p-d>=.15}const Ca=e=>e.box[3]/Math.max(1,e.box[2]),Zt=e=>Ca(e)>Q2,Hn=e=>Ca(e)>=nx||Ca(e)<=rx;function Aa(e){const[t,n,r,i]=e.box;if(r>=i){const o=7*i;return[t,n-o,r,i+2*o]}const a=7*r;return[t-a,n,r+2*a,i]}function Ra(e,t,n,r,i){const a=new Set(t),o=[...e.map((O,C)=>({box:[O[0],O[1],O[2],O[3]],kind:a.has(C)?"card":"tucked",src:["banner",C]})),...n.map((O,C)=>({box:[O[0],O[1],O[2],O[3]],kind:"wonder",src:["wonder",C]}))],s=e.map(()=>"player"),u=n.map(()=>"player");if(o.length===0)return{bannerOwner:s,wonderOwner:u,opponentFound:!1,hulls:[],hullBoxCounts:[],pointOwner:()=>"player",pointInside:()=>"none"};const l=o.map(O=>[O.box[0]+O.box[2]/2,O.box[1]+O.box[3]/2]);let c=o.filter(O=>O.kind!=="wonder").map(O=>Math.hypot(O.box[2],O.box[3])).sort((O,C)=>O-C);c.length===0&&(c=o.map(O=>Math.hypot(O.box[2],O.box[3])).sort((O,C)=>O-C));const d=c[Math.floor(c.length/2)],p=(X2*d)**2,f=o.map((O,C)=>C),m=O=>{let C=O;for(;f[C]!==C;)f[C]=f[f[C]],C=f[C];return C},y=o.map((O,C)=>O.kind==="card"?C:-1).filter(O=>O>=0),w=o.map((O,C)=>O.kind!=="card"?C:-1).filter(O=>O>=0);for(let O=0;O<y.length;O+=1)for(let C=O+1;C<y.length;C+=1){const z=y[O],U=y[C],P=o[z],j=o[U];if(Hn(P)&&Hn(j)&&Zt(P)!==Zt(j))continue;const ie=l[z][0]-l[U][0],J=l[z][1]-l[U][1],me=ie*ie+J*J;let Te=me<=p;!Te&&Hn(P)&&Hn(j)&&Zt(P)===Zt(j)&&me<=(4*d)**2&&(Te=ri(Aa(P),Aa(j))<=.5*d),Te&&(f[m(z)]=m(U))}for(let O=0;O<w.length;O+=1)for(let C=O+1;C<w.length;C+=1){const z=w[O],U=w[C];ri(o[z].box,o[U].box)<=ex*d&&(f[m(z)]=m(U))}const b=new Map;for(const O of w){const C=m(O);b.set(C,[...b.get(C)??[],O])}const x=new Map;for(const O of y){const C=m(O);x.set(C,[...x.get(C)??[],O])}for(const O of b.values()){const C=O.filter(j=>o[j].kind==="wonder"&&Hn(o[j])).map(j=>Zt(o[j])),z=C.length>0?C.filter(Boolean).length*2>C.length:null,U=[];for(const[j,ie]of x){let J=Number.POSITIVE_INFINITY;for(const W of O)for(const ee of ie)J=Math.min(J,ri(o[W].box,o[ee].box));if(J>tx*d)continue;const Te=ie.filter(W=>Zt(o[W])).length/ie.length>=.5;z!==null&&Te!==z||U.push([j,J,Te])}if(U.length===0)continue;const P=new Set(U.map(j=>j[2]));if(U.length>=2&&P.size===1&&z!==null){const j=U[0][0];for(const[ie]of U.slice(1))f[m(ie)]=m(j);f[m(O[0])]=m(j)}else{const j=U.reduce((ie,J)=>J[1]<ie[1]?J:ie);f[m(O[0])]=m(j[0])}}let M=new Map;for(let O=0;O<o.length;O+=1){const C=m(O);M.set(C,[...M.get(C)??[],O])}const v=o.map((O,C)=>O.kind==="wonder"?C:-1).filter(O=>O>=0);if(v.length>0){const O=(z,U)=>{const[P,j,ie,J]=Aa(o[z]),[me,Te,W,ee]=o[U].box,ne=Math.max(0,Math.min(P+ie,me+W)-Math.max(P,me)),oe=Math.max(0,Math.min(j+J,Te+ee)-Math.max(j,Te));return ne*oe>=.9*o[z].box[2]*o[z].box[3]},C=new Map;for(let z=0;z<o.length;z+=1)if(!(o[z].kind!=="card"||!Hn(o[z])))for(const U of v){const P=ri(o[z].box,o[U].box);if(P<=.8*d&&Zt(o[z])!==Zt(o[U])&&O(z,U)){const j=C.get(U);(!j||P<j[1])&&C.set(U,[z,P])}}for(const[z,[U]]of C){const P=m(z);for(const[j,ie]of M){const J=ie.indexOf(U);if(J>=0&&j!==P){ie.splice(J,1),M.set(P,[...M.get(P)??[],U]),o[U].kind="tucked";break}}}M=new Map([...M].filter(([,z])=>z.length>0))}const I=O=>O.filter(C=>o[C].kind==="card").length,E=O=>{const C=O.filter(z=>o[z].kind==="card"||o[z].kind==="wonder");return C.length===0?null:C.filter(z=>Zt(o[z])).length/C.length},k=O=>[O.reduce((C,z)=>C+l[z][0],0)/O.length,O.reduce((C,z)=>C+l[z][1],0)/O.length],S=[i[0]/2,i[1]/2],R=[...M.values()].sort((O,C)=>{const z=I(O),U=I(C);if(z!==U)return U-z;const P=Math.hypot(k(O)[0]-S[0],k(O)[1]-S[1]),j=Math.hypot(k(C)[0]-S[0],k(C)[1]-S[1]);return P-j}),B=k(R[0]),Y=E(R[0]),G=R.map((O,C)=>{if(C===0||I(O)<ni)return"player";const z=E(O),U=z!==null&&Y!==null&&Math.abs(z-Y)>=Z2,P=k(O),j=r.some(ie=>sx(B,P,ie));return U||j?"opponent":"player"});if(!G.includes("opponent")){const O=z=>z.reduce((U,P)=>U+(o[P].kind==="wonder"?1:0),0);let C=G.map((z,U)=>U).filter(z=>z>0&&(I(R[z])>=ni||O(R[z])>=2));if(C.reduce((z,U)=>z+O(R[U]),0)<1&&(C=[]),C.length>0&&(I(R[0])<2*ni||C.reduce((z,U)=>z+I(R[U]),0)<2*ni)&&(C=[]),C.length>0){const z=new Map(C.map(j=>[j,k(R[j])])),U=(j,ie)=>(j[0]-ie[0])**2+(j[1]-ie[1])**2;if(C.every((j,ie)=>C.slice(ie+1).every(J=>U(z.get(j),z.get(J))<Math.min(U(z.get(j),B),U(z.get(J),B)))))for(const j of C)G[j]="opponent"}}const q=[],N=[];let F=!1;R.forEach((O,C)=>{const z=G[C];z==="opponent"&&(F=!0);const U=[],P=[];for(const j of O){const[ie,J,me,Te]=o[j].box;U.push([ie,J],[ie+me,J],[ie,J+Te],[ie+me,J+Te]),P.push(o[j].box);const[W,ee]=o[j].src;W==="banner"?s[ee]=z:u[ee]=z}q.push([z,ix(U)]),N.push([z,P])});const X=(O,C,z)=>Math.min(...N[z][1].map(U=>ax(O,C,U))),Z=(O,C)=>q.map(([,z],U)=>z.length>=3&&Km(O,C,z)?U:-1).filter(z=>z>=0),le=(O,C)=>{if(q.length===0)return"player";const z=d>0?J2*d:Number.POSITIVE_INFINITY,U=Z(O,C);if(U.length>0){const ie=U.reduce((J,me)=>X(O,C,me)<X(O,C,J)?me:J);return q[ie][0]}let P=-1,j=Number.POSITIVE_INFINITY;return q.forEach(([,ie],J)=>{const me=ox(O,C,ie);me<j&&(P=J,j=me)}),P>=0&&j<=z?q[P][0]:"none"},L=(O,C)=>{if(q.length===0)return"none";const z=Z(O,C);if(z.length===0)return"none";const U=z.reduce((P,j)=>X(O,C,j)<X(O,C,P)?j:P);return q[U][0]};return{bannerOwner:s,wonderOwner:u,opponentFound:F,hulls:q,hullBoxCounts:N.map(([,O])=>O.length),pointOwner:le,pointInside:L}}const ux=3;function lx(e,t=ux){const n=e.length,r=Array.from({length:n},(o,s)=>s),i=o=>{for(;r[o]!==o;)r[o]=r[r[o]],o=r[o];return o};for(let o=0;o<n;o+=1)for(let s=o+1;s<n;s+=1){const u=e[o],l=e[s],c=Number(u.center[0]),d=Number(u.center[1]),p=Number(l.center[0]),f=Number(l.center[1]),m=Number(u.radius??0),y=Number(l.radius??0);![c,d,p,f,m,y].every(Number.isFinite)||m<=0||y<=0||Math.hypot(c-p,d-f)<=t*(m+y)&&(r[i(o)]=i(s))}const a=new Map;for(let o=0;o<n;o+=1){const s=i(o);a.has(s)||a.set(s,[]),a.get(s).push(o)}return[...a.values()]}function cx(e,t,n){const r=Number(n[0]),i=Number(n[1]),a=Number(n[2]),o=Number(n[3]),s=Math.max(Math.min(r,a)-e,0,e-Math.max(r,a)),u=Math.max(Math.min(i,o)-t,0,t-Math.max(i,o));return Math.hypot(s,u)}function Oa(e,t,n,r){const i=new Set(e.filter(o=>t.pointOwner(Number(o.center[0]),Number(o.center[1]))===n));if(i.size===0)return[];const a=[];for(const o of lx(e)){const s=o.map(y=>e[y]),u=s.filter(y=>i.has(y));if(u.length===0)continue;let l=0,c=0,d=0;for(const y of s){const w=Number(y.center[0]),b=Number(y.center[1]);c+=w,d+=b,t.pointInside(w,b)===n&&(l+=1)}const p=c/s.length,f=d/s.length,m=r&&r.length>0?Math.min(...r.map(y=>cx(p,f,y))):0;a.push({cle:[...o].sort((y,w)=>y-w).join(","),membres:s,miens:u,inside:l,dPiste:m,centre:[p,f],valeur:u.reduce((y,w)=>y+(Number(w.denomination??0)||0),0)})}return a}function dx(e){return e.reduce((t,n)=>{const r=[t.inside>0?1:0,t.inside,t.dPiste,t.valeur],i=[n.inside>0?1:0,n.inside,n.dPiste,n.valeur];for(let a=0;a<4;a+=1){if(i[a]>r[a])return n;if(i[a]<r[a])return t}return t})}function hx(e,t,n,r){const[i,a]=e.centre,o={};for(const c of["player","opponent"]){const d=Oa(t,n,c,r).filter(p=>p.cle!==e.cle);o[c]=d.length===0?1/0:Math.min(...d.map(p=>Math.hypot(i-p.centre[0],a-p.centre[1])))}if(o.player!==o.opponent)return o.player>o.opponent?"player":"opponent";const s=c=>{const d=Oa(t,n,c,r).find(p=>p.cle===e.cle);return d?[d.inside,d.dPiste,d.valeur]:[-1,-1,-1]},u=s("player"),l=s("opponent");for(let c=0;c<3;c+=1){if(u[c]>l[c])return"player";if(u[c]<l[c])return"opponent"}return"player"}function px(e,t,n){const r={player:[],opponent:[]},i={};for(const o of["player","opponent"]){const s=Oa(e,t,o,n);s.length>0&&(i[o]=dx(s))}const a=Object.keys(i);if(a.length===0)return r;if(a.length===2&&i.player.cle===i.opponent.cle){const o=hx(i.player,e,t,n);return r[o]=i[o].membres,r}for(const o of a)r[o]=i[o].membres;return r}function fx(e,t,n,r){const i=()=>e.filter(a=>t.pointOwner(Number(a.center[0]),Number(a.center[1]))===n);try{return px(e,t,r)[n]??[]}catch{try{return i()}catch{return[...e]}}}const mx=1280,gx=80,yx=3,wx=3,bx=.3,_x=2.4,xx=1,$x=5.2,vx=5;function Na(e){const t=e.filter(r=>r&&r.length>=4).map(r=>Math.min(r[2],r[3])).sort((r,i)=>r-i),n=t.length;return n===0?0:n%2?t[(n-1)/2]:.5*(t[n/2-1]+t[n/2])}function Mx(e,t,n){const r=Math.min(e,t),i=Math.max(e,t);return!(n>0)||!(r>0)?!1:r/n>=bx&&r/n<=_x&&i/n>=xx&&i/n<=$x&&i/r<=vx}function Sx(e,t,n){const r=Math.max(e,t);return!(r>0)||!(n>0)?!1:n*mx/r<gx}function Ix(e,t){if(t.length===0)return e.slice();const n=e.map(r=>{const i=r.poly.map(s=>s[0]),a=r.poly.map(s=>s[1]),o=Math.max(1,i.length);return{hull:r,cx:i.reduce((s,u)=>s+u,0)/o,cy:a.reduce((s,u)=>s+u,0)/o,extra:[]}});if(n.length===0)return e.slice();for(const r of t){const i=Number(r[0]),a=Number(r[1]),o=Number(r[2]),s=Number(r[3]);if(![i,a,o,s].every(Number.isFinite))continue;const u=i+o/2,l=a+s/2;let c=n[0],d=1/0;for(const p of n){const f=(u-p.cx)**2+(l-p.cy)**2;f<d&&(d=f,c=p)}c.extra.push([i,a],[i+o,a+s])}return n.map(r=>r.extra.length===0?r.hull:{...r.hull,poly:[...r.hull.poly.map(i=>[i[0],i[1]]),...r.extra]})}function Ym(e,t,n,r,i=[]){const a=Na(n);if(!Sx(e,t,a))return[];const o=r.filter(l=>l.n>=wx&&l.poly.length>0).slice().sort((l,c)=>c.n-l.n).slice(0,2),s=Math.round(a*yx),u=[];for(const l of Ix(o,i)){const c=l.poly.map(w=>w[0]),d=l.poly.map(w=>w[1]);if(c.length===0)continue;const p=Math.max(0,Math.trunc(Math.min(...c))-s),f=Math.max(0,Math.trunc(Math.min(...d))-s),m=Math.min(e,Math.trunc(Math.max(...c))+s),y=Math.min(t,Math.trunc(Math.max(...d))+s);m>p&&y>f&&u.push([p,f,m,y])}return u}function Tx(e,t,n){if(!e||e.length<4)return null;const[r,i,a,o]=[e[0],e[1],e[2],e[3]];return Mx(a,o,n)?[Math.round(r+t[0]),Math.round(i+t[1]),Math.round(a),Math.round(o)]:null}function Ex(e,t,n,r,i){return Ym(e,t,n,r,i)}function kx(e,t){var s,u,l,c;const[n,r,i,a]=t,o=[];for(const d of e){const p=Number((s=d.box)==null?void 0:s[0]),f=Number((u=d.box)==null?void 0:u[1]),m=Number((l=d.box)==null?void 0:l[2]),y=Number((c=d.box)==null?void 0:c[3]);[p,f,m,y].every(Number.isFinite)&&(p+m<n||p>i||f+y<r||f>a||o.push({...d,box:[Math.round(p-n),Math.round(f-r),Math.round(m),Math.round(y)]}))}return o}function Cx(e){const t=[];for(const n of e){const r=n==null?void 0:n.boundingBox;if(!r||!Number.isFinite(r.width)||!Number.isFinite(r.height))continue;const i=r.x+r.width/2,a=r.y+r.height/2;let o=!1;for(const s of t){if(n.id&&s.id===n.id){o=!0;break}const u=s.boundingBox,l=u.x+u.width/2,c=u.y+u.height/2,d=.5*Math.min(u.width,u.height);if((i-l)**2+(a-c)**2<d*d){o=!0;break}}o||t.push(n)}return t}function Xm(e,t){return{x:Math.round(e.x+t[0]),y:Math.round(e.y+t[1]),width:Math.round(e.width),height:Math.round(e.height)}}const Ax=1.1,Rx=3.2,Ox=20,Nx=.5,zx=1280,Bx=.18,Px=28,Dx=.3;function Ux(e){const t=Math.min(...e),n=Math.max(...e);let r=(t+n)/2;for(let o=0;o<30;o++){const s=e.filter(c=>c<=r),u=e.filter(c=>c>r);if(s.length===0||u.length===0)return[e.map((c,d)=>d)];const l=(s.reduce((c,d)=>c+d,0)/s.length+u.reduce((c,d)=>c+d,0)/u.length)/2;if(Math.abs(l-r)<1)break;r=l}const i=[],a=[];return e.forEach((o,s)=>(o<=r?i:a).push(s)),[i,a]}function Lx(e,t,n=Ax){const[r,i]=t;if(e.length<3||r<=0||i<=0)return[];const a=e.map(l=>l[0]+l[2]/2),o=e.map(l=>l[1]+l[3]/2),s=Math.max(...a)-Math.min(...a)>Math.max(...o)-Math.min(...o)?a:o,u=[];for(const l of Ux(s)){if(l.length===0)continue;const c=l.map(R=>e[R]),d=c.map(R=>Math.min(R[2],R[3])).sort((R,B)=>R-B),p=d[Math.trunc(d.length/2)],f=Rx*p,m=Math.max(0,Math.min(...c.map(R=>R[0]))-f),y=Math.max(0,Math.min(...c.map(R=>R[1]))-f),w=Math.min(r,Math.max(...c.map(R=>R[0]+R[2]))+f),b=Math.min(i,Math.max(...c.map(R=>R[1]+R[3]))+f),x=Math.max(w-m,b-y);if(x<=0)continue;const M=Nx*p*zx/x,v=M>0?Math.max(1,Math.ceil(Ox/M)):1;if(v===1){u.push([Math.trunc(m),Math.trunc(y),Math.trunc(w),Math.trunc(b)]);continue}const I=w-m>=b-y,k=(I?w-m:b-y)/v,S=k*(1+Bx);for(let R=0;R<v;R++){let B=(I?m:y)+R*k-(S-k)/2;B=Math.max(I?m:y,B);const Y=Math.min(I?w:b,B+S);u.push(I?[Math.trunc(B),Math.trunc(y),Math.trunc(Y),Math.trunc(b)]:[Math.trunc(m),Math.trunc(B),Math.trunc(w),Math.trunc(Y)])}}return u.filter(([l,c,d,p])=>Math.max(r,i)/Math.max(1,Math.max(d-l,p-c))>=n)}function Fx(e,t,n,r=Px){const[i,a]=n,o=e;for(const[s,u,l,c]of t){const d=(s+l)/2+i,p=(u+c)/2+a;o.some(([m,y,w,b])=>{const x=d-(m+w)/2,M=p-(y+b)/2;return Math.hypot(x,M)<=r})||o.push([s+i,u+a,l+i,c+a])}return o}function Gx(e,t,n,r=Dx){for(const i of n){const a=r*Math.min(i[2],i[3]);if(i[0]-a<=e&&e<=i[0]+i[2]+a&&i[1]-a<=t&&t<=i[1]+i[3]+a)return!0}return!1}function Wx(e,t,n){return n.some(([r,i,a,o])=>r<=e&&e<=a&&i<=t&&t<=o)}function qx(e,t,n,r){return n.length===0?!1:Wx(e,t,n)&&!Gx(e,t,r)}const Qm=4,Zm=8,ii=5,kn="base-game rule";function Dt(e,t){return{code:e,message:t,severity:"warning"}}function za(e){const t=new Set,n=new Set;for(const r of e)t.has(r)&&n.add(r),t.add(r);return[...n].sort()}function Vx(e,t=""){const n=e.filter(o=>!!o),r=t||"a player",i=[];n.length>Qm&&i.push(Dt("TOO_MANY_WONDERS",`${r}: ${n.length} wonders recognised, but a player builds at most ${Qm} (${kn}) — at least one reading is wrong. Check the wonder list in the review; a card seen at an angle can be named as a wonder.`));const a=za(n);return a.length>0&&i.push(Dt("DUPLICATE_WONDER",`${r}: wonder(s) counted twice — ${a.join(", ")}. Only one copy of each wonder exists (${kn}), so one of the two readings is wrong.`)),i}function Hx(e){const t=[],n=Object.entries(e).map(([i,a])=>[i,new Set(a.filter(o=>!!o))]),r=Object.values(e).reduce((i,a)=>i+a.filter(Boolean).length,0);r>Zm&&t.push(Dt("TOO_MANY_WONDERS_IN_PLAY",`${r} wonders recognised across both cities, but only ${Zm} are in play (${kn}) — at least one reading is wrong.`));for(let i=0;i<n.length;i++){const[a,o]=n[i];for(let s=i+1;s<n.length;s++){const[u,l]=n[s],c=[...o].filter(d=>l.has(d)).sort();c.length>0&&t.push(Dt("WONDER_IN_BOTH_CITIES",`wonder(s) assigned to both cities at once (${a} and ${u}): ${c.join(", ")} — the city split misread one of them.`))}}return t}function jx(e,t=null){const n=[],r=Object.values(e).flatMap(a=>a.filter(o=>!!o));r.length>ii&&n.push(Dt("TOO_MANY_TOKENS",`${r.length} Progress tokens claimed by the cities, but only ${ii} are in play (${kn}) — reserve tokens sitting on the board were probably counted as owned.`));const i=za(r);if(i.length>0&&n.push(Dt("DUPLICATE_TOKEN",`Progress token(s) counted twice: ${i.join(", ")} — only one copy of each token exists (${kn}).`)),t!==null){const a=t.filter(Boolean),o=r.length+a.length;o!==ii&&n.push(Dt("TOKEN_COUNT_MISMATCH",`${r.length} token(s) in the cities + ${t.length} in the reserve = ${o}, but exactly ${ii} are in play (${kn}) — one is missing or one was counted twice.`));const s=new Set(a),u=[...new Set(r.filter(l=>s.has(l)))].sort();u.length>0&&n.push(Dt("TOKEN_IN_CITY_AND_RESERVE",`token(s) seen both in a city and in the reserve: ${u.join(", ")} — the board-token exclusion did not fire.`))}return n}function Kx(e,t=""){const n=t||"a player",r=[],i=e.filter(o=>!o).length;i>0&&r.push(Dt("UNNAMED_GUILD",`${n}: ${i} guild(s) detected but not identified — their points cannot be computed. Name them in the review.`));const a=za(e.filter(o=>!!o));return a.length>0&&r.push(Dt("DUPLICATE_GUILD",`${n}: guild(s) counted twice — ${a.join(", ")}. Only one copy of each guild exists (${kn}).`)),r}const Yx=.25,Xx=.45;function Qx(e,t,n,r,i){const a=Math.cos(i),o=Math.sin(i),s=[n/2*a,n/2*o],u=[-r/2*o,r/2*a],c=[...[[e+s[0]+u[0],t+s[1]+u[1]],[e+s[0]-u[0],t+s[1]-u[1]],[e-s[0]-u[0],t-s[1]-u[1]],[e-s[0]+u[0],t-s[1]+u[1]]]].reverse();return[c[1],c[2],c[3],c[0]]}function Ba(e,t){return e.matFromArray(t.length,1,e.CV_32FC2,t.flatMap(n=>[n[0],n[1]]))}function Jm(e,t){const n=Ba(e,t);try{return Math.abs(e.contourArea(n))}finally{n.delete()}}function Zx(e,t,n){const r=Ba(e,t),i=Ba(e,n),a=new e.Mat;try{return Math.abs(e.intersectConvexConvex(r,i,a,!0))}finally{r.delete(),i.delete(),a.delete()}}function Jx(e,t,n=Xx){const r=[...t].sort((a,o)=>o.confidence-a.confidence),i=[];for(const a of r){let o=!1;for(const s of i){const u=Zx(e,a.quad,s.quad);if(u<=0)continue;const l=Jm(e,a.quad)+Jm(e,s.quad)-u;if(u/Math.max(1e-6,l)>=n){o=!0;break}}o||i.push(a)}return i}function e$(e,t,n,r,i=Yx){const a=[];for(let o=0;o<n;o++){const s=t[4*n+o];if(s<i)continue;const l=Qx(t[o],t[n+o],t[2*n+o],t[3*n+o],t[5*n+o]).map(c=>[(c[0]-r.padX)/r.scale,(c[1]-r.padY)/r.scale]);a.push({quad:l,confidence:s})}return Jx(e,a)}const t$=128,n$=88;function r$(e,t,n,r=t$,i=n$){const a=new e.Mat(t.height,t.width,e.CV_8UC3),o=a.data,s=t.channels;for(let p=0,f=t.width*t.height;p<f;p++)o[p*3]=t.data[p*s],o[p*3+1]=t.data[p*s+1],o[p*3+2]=t.data[p*s+2];const u=e.matFromArray(4,1,e.CV_32FC2,n.flatMap(p=>[p[0],p[1]])),l=e.matFromArray(4,1,e.CV_32FC2,[0,0,r,0,r,i,0,i]),c=e.getPerspectiveTransform(u,l),d=new e.Mat;try{return e.warpPerspective(a,d,c,new e.Size(r,i)),{data:new Uint8Array(d.data),width:r,height:i,channels:3}}finally{a.delete(),u.delete(),l.delete(),c.delete(),d.delete()}}function i$(e){return[e[2],e[3],e[0],e[1]]}const o$=[{id:"merchants-guild",name:"Merchants Guild",nameFr:"Guilde des commerçants",color:"guild",age:3,victoryPoints:0,variableScoring:"merchantsGuild",cost:{clay:1,wood:1,glass:1,papyrus:1}},{id:"shipowners-guild",name:"Shipowners Guild",nameFr:"Guilde des armateurs",color:"guild",age:3,victoryPoints:0,variableScoring:"shipownersGuild",cost:{clay:2,glass:1,papyrus:1}},{id:"builders-guild",name:"Builders Guild",nameFr:"Guilde des bâtisseurs",color:"guild",age:3,victoryPoints:0,variableScoring:"buildersGuild",cost:{stone:2,clay:1,wood:1,glass:1}},{id:"magistrates-guild",name:"Magistrates Guild",nameFr:"Guilde des magistrats",color:"guild",age:3,victoryPoints:0,variableScoring:"magistratesGuild",cost:{wood:2,clay:1,papyrus:1}},{id:"scientists-guild",name:"Scientists Guild",nameFr:"Guilde des scientifiques",color:"guild",age:3,victoryPoints:0,variableScoring:"scientistsGuild",cost:{wood:2,clay:2}},{id:"tacticians-guild",name:"Tacticians Guild",nameFr:"Guilde des tacticiens",color:"guild",age:3,victoryPoints:0,variableScoring:"tacticiansGuild",cost:{stone:2,clay:1,papyrus:1}},{id:"moneylenders-guild",name:"Moneylenders Guild",nameFr:"Guilde des usuriers",color:"guild",age:3,victoryPoints:0,variableScoring:"moneylendersGuild",cost:{stone:2,wood:2}}],a$=[{id:"lumber-yard",name:"Lumber Yard",nameFr:"Chantier",color:"raw",age:1,victoryPoints:0},{id:"logging-camp",name:"Logging Camp",nameFr:"Exploitation",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"clay-pool",name:"Clay Pool",nameFr:"Bassin argileux",color:"raw",age:1,victoryPoints:0},{id:"clay-pit",name:"Clay Pit",nameFr:"Cavité",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"quarry",name:"Quarry",nameFr:"Gisement",color:"raw",age:1,victoryPoints:0},{id:"stone-pit",name:"Stone Pit",nameFr:"Mine",color:"raw",age:1,victoryPoints:0,coinCost:1},{id:"glassworks",name:"Glassworks",nameFr:"Verrerie",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"press",name:"Press",nameFr:"Presse",color:"manufactured",age:1,victoryPoints:0,coinCost:1},{id:"theater",name:"Theater",nameFr:"Théâtre",color:"civilian",age:1,victoryPoints:3},{id:"altar",name:"Altar",nameFr:"Autel",color:"civilian",age:1,victoryPoints:3,providesChain:"moon"},{id:"baths",name:"Baths",nameFr:"Bains",color:"civilian",age:1,victoryPoints:3,providesChain:"drop",cost:{stone:1}},{id:"pharmacist",name:"Pharmacist",nameFr:"Officine",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"mortar",providesChain:"mortar-chain",cost:{glass:2}},{id:"apothecary",name:"Apothecary",nameFr:"Apothicaire",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain",cost:{glass:1}},{id:"workshop",name:"Workshop",nameFr:"Atelier",color:"scientific",age:1,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain",cost:{papyrus:1}},{id:"scriptorium",name:"Scriptorium",nameFr:"Scriptorium",color:"scientific",age:1,victoryPoints:0,scienceSymbol:"inkwell",providesChain:"inkwell-chain",coinCost:2},{id:"stone-reserve",name:"Stone Reserve",nameFr:"Dépôt de pierre",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"clay-reserve",name:"Clay Reserve",nameFr:"Dépôt d'argile",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"wood-reserve",name:"Wood Reserve",nameFr:"Dépôt de bois",color:"commercial",age:1,victoryPoints:0,coinCost:3},{id:"tavern",name:"Tavern",nameFr:"Taverne",color:"commercial",age:1,victoryPoints:0,providesChain:"jug"},{id:"guard-tower",name:"Guard Tower",nameFr:"Tour de garde",color:"military",age:1,victoryPoints:0,shields:1},{id:"stable",name:"Stable",nameFr:"Écuries",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"horseshoe",cost:{wood:1}},{id:"garrison",name:"Garrison",nameFr:"Caserne",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"sword",cost:{clay:1}},{id:"palisade",name:"Palisade",nameFr:"Palissade",color:"military",age:1,victoryPoints:0,shields:1,providesChain:"tower",coinCost:2}],s$=[{id:"sawmill",name:"Sawmill",nameFr:"Scierie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"brickyard",name:"Brickyard",nameFr:"Briqueterie",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"shelf-quarry",name:"Shelf Quarry",nameFr:"Carrière",color:"raw",age:2,victoryPoints:0,coinCost:2},{id:"glass-blower",name:"Glass-Blower",nameFr:"Soufflerie",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"drying-room",name:"Drying Room",nameFr:"Séchoir",color:"manufactured",age:2,victoryPoints:0,coinCost:2},{id:"courthouse",name:"Courthouse",nameFr:"Tribunal",color:"civilian",age:2,victoryPoints:5,cost:{wood:2,glass:1}},{id:"statue",name:"Statue",nameFr:"Statue",color:"civilian",age:2,victoryPoints:4,providesChain:"column",chainFrom:"moon",cost:{clay:2}},{id:"temple",name:"Temple",nameFr:"Temple",color:"civilian",age:2,victoryPoints:4,providesChain:"sun",chainFrom:"drop",cost:{wood:1,papyrus:1}},{id:"aqueduct",name:"Aqueduct",nameFr:"Aqueduc",color:"civilian",age:2,victoryPoints:5,cost:{stone:3}},{id:"rostrum",name:"Rostrum",nameFr:"Rostres",color:"civilian",age:2,victoryPoints:4,providesChain:"horseshoe",cost:{stone:1,wood:1}},{id:"school",name:"School",nameFr:"École",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"wheel",providesChain:"wheel-chain-2",cost:{wood:1,papyrus:2}},{id:"laboratory",name:"Laboratory",nameFr:"Laboratoire",color:"scientific",age:2,victoryPoints:1,scienceSymbol:"pendulum",providesChain:"pendulum-chain-2",cost:{wood:1,glass:2}},{id:"library",name:"Library",nameFr:"Bibliothèque",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"inkwell",chainFrom:"inkwell-chain",cost:{stone:1,wood:1,glass:1}},{id:"dispensary",name:"Dispensary",nameFr:"Dispensaire",color:"scientific",age:2,victoryPoints:2,scienceSymbol:"mortar",chainFrom:"mortar-chain",cost:{clay:2,stone:1}},{id:"forum",name:"Forum",nameFr:"Forum",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel",coinCost:3,cost:{clay:1}},{id:"caravansery",name:"Caravansery",nameFr:"Caravansérail",color:"commercial",age:2,victoryPoints:0,coinCost:2,cost:{glass:1,papyrus:1}},{id:"customs-house",name:"Customs House",nameFr:"Douanes",color:"commercial",age:2,victoryPoints:0,coinCost:4},{id:"brewery",name:"Brewery",nameFr:"Brasserie",color:"commercial",age:2,victoryPoints:0,providesChain:"barrel-2"},{id:"horse-breeders",name:"Horse Breeders",nameFr:"Haras",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"horseshoe",cost:{clay:1,wood:1}},{id:"barracks",name:"Barracks",nameFr:"Baraquements",color:"military",age:2,victoryPoints:0,shields:1,chainFrom:"sword",coinCost:3},{id:"archery-range",name:"Archery Range",nameFr:"Champ de tir",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"target",cost:{stone:1,wood:1,papyrus:1}},{id:"parade-ground",name:"Parade Ground",nameFr:"Place d'armes",color:"military",age:2,victoryPoints:0,shields:2,providesChain:"mask",cost:{clay:2,glass:1}},{id:"walls",name:"Walls",nameFr:"Muraille",color:"military",age:2,victoryPoints:0,shields:2,cost:{stone:2}}],u$=[{id:"pantheon",name:"Pantheon",nameFr:"Panthéon",color:"civilian",age:3,victoryPoints:6,chainFrom:"sun",cost:{clay:1,wood:1,papyrus:2}},{id:"gardens",name:"Gardens",nameFr:"Jardins",color:"civilian",age:3,victoryPoints:6,chainFrom:"column",cost:{clay:2,wood:2}},{id:"town-hall",name:"Town Hall",nameFr:"Hôtel de ville",color:"civilian",age:3,victoryPoints:7,cost:{stone:3,wood:2}},{id:"palace",name:"Palace",nameFr:"Palace",color:"civilian",age:3,victoryPoints:7,cost:{clay:1,stone:1,wood:1,glass:2}},{id:"senate",name:"Senate",nameFr:"Sénat",color:"civilian",age:3,victoryPoints:5,chainFrom:"horseshoe",cost:{clay:2,stone:1,papyrus:1}},{id:"obelisk",name:"Obelisk",nameFr:"Obélisque",color:"civilian",age:3,victoryPoints:5,cost:{stone:2,glass:1}},{id:"academy",name:"Academy",nameFr:"Académie",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{stone:1,wood:1,glass:2}},{id:"study",name:"Study",nameFr:"Étude",color:"scientific",age:3,victoryPoints:3,scienceSymbol:"sundial",cost:{wood:2,glass:1,papyrus:1}},{id:"university",name:"University",nameFr:"Université",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"wheel-chain-2",cost:{clay:1,glass:1,papyrus:1}},{id:"observatory",name:"Observatory",nameFr:"Observatoire",color:"scientific",age:3,victoryPoints:2,scienceSymbol:"globe",chainFrom:"pendulum-chain-2",cost:{stone:1,papyrus:2}},{id:"chamber-of-commerce",name:"Chamber of Commerce",nameFr:"Chambre de commerce",color:"commercial",age:3,victoryPoints:3,variableScoring:"chamberOfCommerce",cost:{papyrus:2}},{id:"port",name:"Port",nameFr:"Port",color:"commercial",age:3,victoryPoints:3,variableScoring:"port",cost:{wood:1,glass:1,papyrus:1}},{id:"armory",name:"Armory",nameFr:"Armurerie",color:"commercial",age:3,victoryPoints:3,variableScoring:"armory",cost:{stone:2,glass:1}},{id:"lighthouse",name:"Lighthouse",nameFr:"Phare",color:"commercial",age:3,victoryPoints:3,variableScoring:"lighthouse",chainFrom:"jug",cost:{clay:2,glass:1}},{id:"arena",name:"Arena",nameFr:"Arène",color:"commercial",age:3,victoryPoints:3,variableScoring:"arena",chainFrom:"barrel-2",cost:{clay:1,stone:1,wood:1}},{id:"pretorium",name:"Pretorium",nameFr:"Prétoire",color:"military",age:3,victoryPoints:0,shields:3,coinCost:8},{id:"arsenal",name:"Arsenal",nameFr:"Arsenal",color:"military",age:3,victoryPoints:0,shields:3,cost:{clay:3,wood:2}},{id:"fortifications",name:"Fortifications",nameFr:"Fortifications",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"tower",cost:{stone:2,clay:1,papyrus:1}},{id:"siege-workshop",name:"Siege Workshop",nameFr:"Atelier de siège",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"target",cost:{wood:3,glass:1}},{id:"circus",name:"Circus",nameFr:"Cirque",color:"military",age:3,victoryPoints:0,shields:2,chainFrom:"mask",cost:{clay:2,stone:2}}],l$=[...a$,...s$,...u$,...o$];Object.fromEntries(l$.map(e=>[e.id,e]));const c$=Object.fromEntries([{id:"the-appian-way",name:"The Appian Way",nameFr:"La Via Appia",victoryPoints:3,description:"The opponent loses 3 coins. Take another turn. Once built, repeated discards are not affected. Worth 3 victory points."},{id:"circus-maximus",name:"Circus Maximus",nameFr:"Le Circus Maximus",victoryPoints:3,shields:1,description:"Destroy one grey (manufactured) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-colossus",name:"The Colossus",nameFr:"Le Colosse",victoryPoints:3,shields:2,description:"Provides 2 shields. Worth 3 victory points."},{id:"the-great-library",name:"The Great Library",nameFr:"La Grande Bibliothèque",victoryPoints:4,description:"Randomly draw 3 of the Progress tokens discarded at game setup and keep one. Worth 4 victory points."},{id:"the-great-lighthouse",name:"The Great Lighthouse",nameFr:"Le Grand Phare",victoryPoints:4,description:"Once built, the owner may take any raw or manufactured good of choice each turn (production effect). Worth 4 victory points."},{id:"the-hanging-gardens",name:"The Hanging Gardens",nameFr:"Les Jardins Suspendus",victoryPoints:3,description:"Gain 6 coins. Take another turn. Worth 3 victory points."},{id:"the-mausoleum",name:"The Mausoleum",nameFr:"Le Mausolée",victoryPoints:2,description:"Build, for free, any one card from the discard pile. Worth 2 victory points."},{id:"piraeus",name:"Piraeus",nameFr:"Le Pirée",victoryPoints:2,description:"Once built, the owner may take any one manufactured good (glass or papyrus) of choice each turn. Take another turn. Worth 2 victory points."},{id:"the-pyramids",name:"The Pyramids",nameFr:"Les Pyramides",victoryPoints:9,description:"Worth 9 victory points."},{id:"the-sphinx",name:"The Sphinx",nameFr:"Le Sphinx",victoryPoints:6,description:"Take another turn. Worth 6 victory points."},{id:"the-statue-of-zeus",name:"The Statue of Zeus",nameFr:"La Statue de Zeus",victoryPoints:3,shields:1,description:"Destroy one brown (raw) card the opponent has built. Provides 1 shield. Worth 3 victory points."},{id:"the-temple-of-artemis",name:"The Temple of Artemis",nameFr:"Le Temple d'Artémis",victoryPoints:0,description:"Gain 12 coins. Take another turn. Worth 0 victory points."}].map(e=>[e.id,e]));Object.fromEntries([{id:"agriculture",name:"Agriculture",nameFr:"Agriculture",victoryPoints:4,description:"Gain 6 coins immediately. Worth 4 victory points at game end."},{id:"architecture",name:"Architecture",nameFr:"Architecture",description:"Any future Wonder constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"economy",name:"Economy",nameFr:"Économie",description:"When the opponent uses the trading-cost coins (pays the bank to buy goods), the owner receives those coins instead."},{id:"law",name:"Law",nameFr:"Loi",variableScoring:"law",description:"Grants one science symbol, counting toward the six-symbol scientific victory and toward pairs of identical symbols."},{id:"masonry",name:"Masonry",nameFr:"Maçonnerie",description:"Any future blue (civilian) building constructed by the owner costs 2 fewer resources of the owner's choice."},{id:"mathematics",name:"Mathematics",nameFr:"Mathématiques",variableScoring:"mathematics",description:"Worth 3 victory points at game end for EACH Progress token the owner possesses (including this one)."},{id:"philosophy",name:"Philosophy",nameFr:"Philosophie",victoryPoints:7,description:"Worth 7 victory points at game end."},{id:"strategy",name:"Strategy",nameFr:"Stratégie",description:"Whenever the owner builds a red (military) building, it provides 1 additional shield."},{id:"theology",name:"Theology",nameFr:"Théologie",description:"Every future Wonder built by the owner grants an extra turn."},{id:"urbanism",name:"Urbanism",nameFr:"Urbanisme",description:"Gain 6 coins immediately. When the owner builds a card for free via a chain link, they also gain 4 coins."}].map(e=>[e.id,e]));const eg=.2,d$=.3,tg=.25,Pa={total:0,idDiff:0,verdictDiff:0},wt={pass1Calls:0,pass1Boxes:0,pass1Kept:0,pass2Calls:0,pass2Boxes:0,pass2Promoted:0},Ut={total:0,divergent:0,positifs4:0,positifs2:0,detail:[]},oi={total:0,memeK:0,memeKInverse:0,detail:[]};function h$(e,t,n){for(const r of e){let i=!1;for(let a=0,o=r.length-1;a<r.length;o=a++){const s=r[a],u=r[o];s[1]>n!=u[1]>n&&t<(u[0]-s[0])*(n-s[1])/(u[1]-s[1])+s[0]&&(i=!i)}if(i)return r.map(a=>[a[0],a[1]])}return null}function p$(e,t,n){if(t.height<=0)return!1;const r=t.width/t.height;if(Math.abs(Math.log(r))<=tg)return!1;const i=e.x+e.width,a=e.y+e.height;for(const o of n){const s=o.box;if(!s||s.length<4||s[3]<=0)continue;const u=s[0]+s[2]/2,l=s[1]+s[3]/2;if(!(u>=e.x&&u<=i&&l>=e.y&&l<=a))continue;const c=s[2]/s[3];if(!(Math.abs(Math.log(c))<=tg)&&r>1==c>1)return!0}return!1}async function f$(e,t,n,r,i=[0,1,2,3]){const[a,o,s,u]=t;if(s<=0||u<=0)return null;const l=Math.round(s*eg),c=Math.round(u*eg),d=Math.max(0,Math.round(a-l)),p=Math.max(0,Math.round(o-c)),f=Math.min(e.width,Math.round(a+s+l)),m=Math.min(e.height,Math.round(o+u+c)),y=f-d,w=m-p;if(y<=0||w<=0)return null;const b=e.channels,x=new Uint8ClampedArray(y*w*b);for(let I=0;I<w;I++){const E=((p+I)*e.width+d)*b;x.set(e.data.subarray(E,E+y*b),I*y*b)}const M={width:y,height:w,channels:b,data:x};let v=null;for(const I of i){const E=I===0?M:Yt(M,I),k=E.width,S=k-Math.floor(d$*k),R=k-S;if(R<=0)continue;const B=new Uint8ClampedArray(R*E.height*E.channels);for(let F=0;F<E.height;F++){const X=(F*k+S)*E.channels;B.set(E.data.subarray(X,X+R*E.channels),F*R*E.channels)}const Y={width:R,height:E.height,channels:E.channels,data:B},G=Qr(Y),N=(await n.run({[n.inputNames[0]]:new Be("float32",G,[1,3,gt,gt])}))[n.outputNames[0]].data[1]??0;r&&(r[I]=N),v=v===null?N:Math.max(v,N)}return v}async function ng(e,t,n,r,i,a,o){var f;const s=async m=>(await i.run({[i.inputNames[0]]:new Be("float32",m,[1,3,Qt,Qt])}))[i.outputNames[0]].data,u=e.obbQuads===void 0?null:await et("OBB merveilles (détection orientée)",async()=>{try{return await e.obbQuads(n)}catch(m){return console.warn("[wonders-obb] détection échouée, repli ORB :",m),null}}),l=new Map;for(const m of r){const[y,w,b,x]=m;if(b<=0||x<=0)continue;const M=u===null?null:h$(u,y+b/2,w+x/2);if(M===null||e.redresserQuad===void 0)continue;let v=M;const I=at("identify: redressement du quad",()=>e.redresserQuad(n,v)),E=Um(),{id:k,prob:S,inverse:R}=await et("classifieur merveille (1 lecture)",()=>p2(I,s));if(k===""||S<E)continue;R&&(v=i$(v).map(Y=>[Y[0],Y[1]]));const B=l.get(k);(B===void 0||S>B.prob)&&l.set(k,{prob:S,box:m,quad:v})}const c=[],d=await e.tuckClassifier(),p=await e.tuckBoxClassifier();for(const[m,{prob:y,box:w,quad:b}]of l){const[x,M,v,I]=w;let E={x:Math.round(x),y:Math.round(M),width:Math.round(v),height:Math.round(I)},k=null,S=[],R=null;if(b!==null){k=b;const L=k.map(U=>U[0]),O=k.map(U=>U[1]),C=Math.max(0,Math.round(Math.min(...L))),z=Math.max(0,Math.round(Math.min(...O)));if(E={x:C,y:z,width:Math.min(n.width,Math.round(Math.max(...L)))-C,height:Math.min(n.height,Math.round(Math.max(...O)))-z},d!==null)try{const U=await e.wonderRef(m),P=k,j=U===null||P===null?null:at("identify: bande droite #63",()=>Ia(t,n,U,P));if(j!==null){const ie=at("identify: preprocess tuck",()=>Qr(j)),J=await d.run({[d.inputNames[0]]:new Be("float32",ie,[1,3,gt,gt])});R=Ta(J[d.outputNames[0]].data).prob,S=R>=Wn?["R"]:[]}}catch{}}else if(Date.now()<a)try{const L=await et("chargement refs merveilles",()=>e.wonderRef(m));if(L!==null){const O=at("ORB registration (merveille)",()=>Sm(t,n,L,w));if(O!==null){k=O.footprint,S=O.overflow;const C=k.map(j=>j[0]),z=k.map(j=>j[1]),U=Math.max(0,Math.round(Math.min(...C))),P=Math.max(0,Math.round(Math.min(...z)));if(E={x:U,y:P,width:Math.min(n.width,Math.round(Math.max(...C)))-U,height:Math.min(n.height,Math.round(Math.max(...z)))-P},d!==null)try{const j=k,ie=j===null?null:at("identify: bande droite #63",()=>Ia(t,n,L,j));if(ie!==null){const J=at("identify: preprocess tuck",()=>Qr(ie)),me=await d.run({[d.inputNames[0]]:new Be("float32",J,[1,3,gt,gt])});R=Ta(me[d.outputNames[0]].data).prob}}catch{}}}}catch(L){console.warn(`[wonders-cls] ${m} registration failed:`,L)}const B=k!==null?Xr(k,S):null,Y=b!==null&&k!==null?Xr(k,["R"]):null,G=[];if(R!==null&&G.push(R>=Wn?1:0),p!==null)try{let L=[0,1,2,3];if(b!==null){const z=b[1][1]-b[0][1],U=b[1][0]-b[0][0],P=(Math.round(Math.atan2(z,U)*180/Math.PI/90)%4+4)%4;L=[(0+P)%4,(2+P)%4]}const O=[0,0,0,0],C=await et("identify: sonde marges (#68)",()=>f$(n,w,p,O,L));if(C!==null&&(G.push(C>=Wn?1:0),b!==null)){const z=b[1][1]-b[0][1],U=b[1][0]-b[0][0],P=(Math.round(Math.atan2(z,U)*180/Math.PI/90)%4+4)%4,j=Math.max(O[(0+P)%4],O[(2+P)%4]);Ut.total+=1;const ie=C>=Wn?1:0,J=j>=Wn?1:0;ie===1&&(Ut.positifs4+=1),J===1&&(Ut.positifs2+=1),ie!==J&&(Ut.divergent+=1,Ut.detail.push(`${m.slice(0,12)}:v4=${ie}/v2=${J} p=[${O.map(me=>me.toFixed(2)).join(",")}]kQ${P}`))}}catch{}const q=Y??B??E,N=o.some(L=>{const O=L.box[0]+L.box[2]/2,C=L.box[1]+L.box[3]/2;return O>=q.x&&O<=q.x+q.width&&C>=q.y&&C<=q.y+q.height});G.push(N?1:0);let F=G.length>0&&G.reduce((L,O)=>L+O,0)*2>G.length;F&&p$(q,E,o)&&(F=!1);const X=B??(F&&Y!==null?Y:null),Z={id:m,name:((f=c$[m])==null?void 0:f.name)??m,builtWithCardUnderneath:F,boundingBox:E,confidence:Math.round(y*1e4)/1e4,...X?{tuckRegion:X}:{}},le=X??E;c.push({obj:Z,edgeScores:null,zone:{x0:le.x,y0:le.y,x1:le.x+le.width,y1:le.y+le.height},quad:k,region:X})}return c}async function rg(e,t,n,r,i,a,o=[]){let s=await e.localiseWonders(n);return s.length===0?[]:o.length>0&&(s=s.filter(([u,l,c,d])=>{const p=u+c/2,f=l+d/2;return!o.some(m=>{const y=m.x+m.width/2,w=m.y+m.height/2,b=.5*Math.min(m.width,m.height);return(p-y)**2+(f-w)**2<b*b})}),s.length===0)?[]:ng(e,t,n,s,r,i,a)}function m$(e,t){const n=Xm(e.obj.boundingBox,t),r=e.region===null?null:Xm(e.region,t),i=r??n;return{obj:{...e.obj,boundingBox:n,...e.region===null?{}:{tuckRegion:r}},edgeScores:e.edgeScores,zone:{x0:i.x,y0:i.y,x1:i.x+i.width,y1:i.y+i.height},quad:e.quad===null?null:e.quad.map(([a,o])=>[a+t[0],o+t[1]]),region:r}}async function ig(e){try{const t=Ex(e.image.width,e.image.height,e.banners.map(o=>o.box),e.hulls,e.wonderBoxes);if(t.length===0)return[];const n=[];for(const o of t){const s=e.cropFrame(o);if(s.width<=0||s.height<=0)continue;const u=e.skipKnownNear?e.known.map(l=>({x:l.boundingBox.x-o[0],y:l.boundingBox.y-o[1],width:l.boundingBox.width,height:l.boundingBox.height})):void 0;for(const l of await e.detect(s,kx(e.banners,o),u))n.push(m$(l,o))}if(e.builtSeenOut)for(const o of n)o.obj.id&&o.obj.builtWithCardUnderneath===!0&&e.builtSeenOut.add(o.obj.id);if(n.length===0)return[];const r=[...e.known.map(o=>({boundingBox:o.boundingBox,id:o.id,neuf:-1})),...n.map((o,s)=>({boundingBox:o.obj.boundingBox,id:o.obj.id,neuf:s}))],i=Cx(r),a=[];for(const o of i){const s=o.neuf;s>=0&&a.push(n[s])}return a}catch(t){return console.warn("[#149 wonder-rescan] skipped:",t),[]}}const je="/7wd-scorer/models/",Da=[];let Ct=null;function g$(){Da.length=0,Ct=null}function y$(e){const t=performance.now();Ct!==null&&Da.push({nom:Ct.nom,ms:Math.round(t-Ct.debut)}),Ct={nom:e,debut:t}}function og(){const e=[...Da];Ct!==null&&e.push({nom:`${Ct.nom} (en cours)`,ms:Math.round(performance.now()-Ct.debut)});const t=new Map;for(const n of e){const r=t.get(n.nom)??{appels:0,ms:0};r.appels+=1,r.ms+=n.ms,t.set(n.nom,r)}return[...t.entries()].map(([n,r])=>({nom:n,appels:r.appels,ms:r.ms})).sort((n,r)=>r.ms-n.ms)}function ag(){const e={};for(const t of Object.keys(nt))e[nt[t].onnx]=ui.has(t)?"wasm (repli apres echec webgpu)":"webgpu>wasm";for(const[t,n]of ut)e[t]=n;return e}function w$(){var e,t;return si(),{crossOriginIsolated:globalThis.crossOriginIsolated??null,numThreads:ze.wasm.numThreads??null,sharedArrayBuffer:typeof SharedArrayBuffer<"u",coeurs:((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??null,webgpuPresent:typeof((t=globalThis.navigator)==null?void 0:t.gpu)<"u"}}let sg=!1;const ai=new Map;function si(){var e;sg||(ze.wasm.wasmPaths="/7wd-scorer/ort/",ze.wasm.numThreads=globalThis.crossOriginIsolated?Math.max(1,(((e=globalThis.navigator)==null?void 0:e.hardwareConcurrency)??4)-2):1,sg=!0)}const ui=new Set;let Ua=0;function ug(e){return Ua+=1,e.finally(()=>{Ua-=1})}function b$(){return Ua>0}function _$(e){si();let t=ai.get(e);return t===void 0&&(t=ug(et(`session: 1er chargement ${nt[e].onnx}`,()=>zn.create(`${je}${nt[e].onnx}`,{executionProviders:ui.has(e)?["wasm"]:["webgpu","wasm"]}))),ai.set(e,t),t.catch(()=>ai.delete(e))),t}const ut=new Map;let gr=0,yr=0;const li=new Map;function La(e){const t=(Ct==null?void 0:Ct.nom)??"(hors etage)";li.set(t,(li.get(t)??0)+e)}function x$(){return[...li.entries()].map(([e,t])=>({nom:e,ms:Math.round(t)})).sort((e,t)=>t.ms-e.ms)}let Fa=0;function $$(){return{ms:Math.round(gr),appels:yr,preparationMs:Math.round(Fa)}}function v$(){gr=0,yr=0,Fa=0,qw(),li.clear(),cv()}const lg=new Set(["coin_yolo.onnx","token_yolo.onnx","wonder_yolo.onnx"]),Ga=new Set;let Wa=null;async function qa(e){if(Wa)return await Wa.catch(()=>{}),e();const t=e();return Wa=t.catch(()=>{}),t}async function Va(e,t){return qa(()=>zn.create(`${je}${e}`,{executionProviders:t?["webgpu"]:["wasm"]}))}async function ft(e){return ug(et(`session: 1er chargement ${e}`,()=>M$(e)))}async function M$(e){si();const t=!lg.has(e)&&!Ga.has(e);let n=null;if(t)try{n=await Va(e,!0),ut.set(e,"webgpu")}catch(o){Ga.add(e),ut.set(e,`wasm (webgpu refuse a la creation: ${String(o).slice(0,60)})`)}else ut.set(e,lg.has(e)?"wasm (webgpu incompatible, mesure)":"wasm");if(n===null)try{n=await Va(e,!1)}catch(o){return ut.set(e,`ECHEC wasm: ${String(o).slice(0,160)}`),null}let r=n,i=ut.get(e)==="webgpu";const a=async(o,...s)=>{const u=performance.now();try{const l=await r.run(o,...s),c=performance.now()-u;return gr+=c,La(c),yr+=1,l}catch(l){if(!i)throw l;Ga.add(e),ut.set(e,`wasm (repli au run: ${String(l).slice(0,60)})`),i=!1,r=await Va(e,!1);const c=await r.run(o,...s),d=performance.now()-u;return gr+=d,La(d),yr+=1,c}};return new Proxy(r,{get(o,s,u){if(s==="run")return a;const l=Reflect.get(r,s,u);return typeof l=="function"?l.bind(r):l}})}let Ha=null,ja=null;const S$=.75,I$=4,T$=.65,E$=3e4;let Ka=null;function jn(){return Ka===null&&(Ka=(async()=>{try{let e;return self.importScripts("/7wd-scorer/opencv/opencv.js"),e=self.cv,typeof(e==null?void 0:e.then)=="function"&&(e=await e),typeof(e==null?void 0:e.getBuildInformation)!="function"&&(e=await new Promise(t=>{e.onRuntimeInitialized=()=>t(e)})),e}catch(e){return console.warn("[wonders-reg] opencv.js load failed:",e),null}})()),Ka}const cg=new Map;function Ya(e){let t=cg.get(e);return t===void 0&&(t=(async()=>{try{const n=await fetch(`${je}${e}`);if(!n.ok)return null;const r=await createImageBitmap(await n.blob()),a=new OffscreenCanvas(r.width,r.height).getContext("2d");a.drawImage(r,0,0);const o=a.getImageData(0,0,r.width,r.height);return{width:r.width,height:r.height,channels:4,data:new Uint8Array(o.data.buffer)}}catch{return null}})(),cg.set(e,t)),t}function Xa(e){return Ya(`wonder-refs/${e}.jpg`)}const dg=["builders-guild","magistrates-guild","merchants-guild","moneylenders-guild","scientists-guild","shipowners-guild","tacticians-guild"];async function k$(){const e=new Map;for(const t of dg){const n=await Ya(`guild-refs/${t}.jpg`);n!==null&&e.set(t,n)}return e}async function C$(){const e=new Map;for(const t of dg){const n=await Ya(`guild-band-refs/${t}.png`);n!==null&&e.set(t,n)}return e}const A$=.6,R$=12,O$=45e3;let Qa=null;function hg(){return Qa===null&&(si(),Qa=(async()=>{try{const[e,t,n,r]=await Promise.all([qa(()=>zn.create(`${je}ocr/ch_PP-OCRv4_det_infer.onnx`,{executionProviders:["webgpu","wasm"]})),qa(()=>zn.create(`${je}ocr/ch_PP-OCRv4_rec_infer.onnx`,{executionProviders:["webgpu","wasm"]})),fetch(`${je}ocr_charset.json`).then(i=>i.ok?i.json():null),fetch(`${je}wonder_names.json`).then(i=>i.ok?i.json():null)]);return n===null||r===null?(console.warn("[wonders-ocr] charset/names asset missing"),null):{det:e,rec:t,charset:y_(n),catalog:r.entries}}catch(e){return console.warn("[wonders-ocr] bundle load failed:",e),null}})()),Qa}async function N$(e,t){const n=Math.max(g_/Xt,t.width/t.height),{tensor:r,width:i}=b_(t,n),a={[e.rec.inputNames[0]]:new Be("float32",r,[1,3,Xt,i])},o=(await e.rec.run(a))[e.rec.outputNames[0]],[s,u,l]=o.dims,c=o.data,d=new Array(u),p=new Array(u);for(let f=0;f<u;f++){let m=0,y=-1/0;const w=f*l;for(let b=0;b<l;b++){const x=c[w+b];x>y&&(y=x,m=b)}d[f]=m,p[f]=y}return w_(d,p,e.charset)}function z$(...e){return et("merveilles (OCR+ORB+opencv)",()=>B$(...e))}async function B$(e,t){const n=await hg();if(n===null)return{wonders:[],aborted:!1};const r=new Map,i=Date.now()+O$;let a=!1;e:for(const o of[0,1,2,3]){if(Date.now()>i){a=!0;break}t(`wonder names: rotation ${o*90}°…`,o/4);const s=Yt(e,o),u=a_(s),l={[n.det.inputNames[0]]:new Be("float32",u.tensor,[1,3,u.height,u.width])},c=(await n.det.run(l))[n.det.outputNames[0]],d=h_(c.data,u,s.width,s.height).slice(0,R$);console.debug(`[wonders-ocr] rot ${o*90}: ${d.length} det boxes`,d.slice(0,5).map(p=>`${p.width}x${p.height}@${p.score.toFixed(2)}`));for(const p of d){if(Date.now()>i){a=!0;break e}const f=p_(s,p.quad);if(f.width<f.height*1.5)continue;const[m,y]=await N$(n,f);if(console.debug(`[wonders-ocr] rec "${m}" @${y.toFixed(2)}`),y<A$||m.trim().length<I$)continue;const w=I_(m,n.catalog);if(console.debug("[wonders-ocr] fuzzy",w),w===null||w.confidence<S$||w.kind!=="wonder")continue;const b=r.get(w.id);(b===void 0||w.confidence>b.confidence)&&r.set(w.id,{id:w.id,name:w.name,confidence:w.confidence,nameBox:Za(p,o,e.width,e.height)})}}return{wonders:[...r.values()],aborted:a}}function Za(e,t,n,r){const i=(t%4+4)%4;if(i===0)return{x:e.x,y:e.y,width:e.width,height:e.height};const a=(d,p)=>i===1?[p,r-1-d]:i===2?[n-1-d,r-1-p]:[n-1-p,d],o=[a(e.x,e.y),a(e.x+e.width,e.y+e.height)],s=o.map(d=>d[0]),u=o.map(d=>d[1]),l=Math.min(...s),c=Math.min(...u);return{x:l,y:c,width:Math.max(...s)-l,height:Math.max(...u)-c}}function P$(){return ja===null&&(ja=fetch(`${je}laurel_gallery.json`).then(async e=>e.ok?Kb(await e.json()):[]).catch(()=>[])),ja}function D$(e,t,n,r){return at("crop",()=>U$(e,t,n,r))}function U$(e,t,n,r){return Lt(e,t-r,n-r,2*r,2*r)}function Lt(e,t,n,r,i){return at("crop",()=>L$(e,t,n,r,i))}function L$(e,t,n,r,i){const a=Math.max(0,Math.round(t)),o=Math.max(0,Math.round(n)),s=Math.min(e.width,Math.round(t+r)),u=Math.min(e.height,Math.round(n+i)),l=Math.max(0,s-a),c=Math.max(0,u-o),d=new Uint8Array(l*c*3);for(let p=0;p<c;p++)for(let f=0;f<l;f++){const m=((p+o)*e.width+(f+a))*e.channels,y=(p*l+f)*3;d[y]=e.data[m],d[y+1]=e.data[m+1],d[y+2]=e.data[m+2]}return{width:l,height:c,channels:3,data:d}}function F$(){return Ha===null&&(Ha=fetch(`${je}token_templates.json`).then(async e=>e.ok?G1(await e.json()):new Map).catch(()=>new Map)),Ha}let Ja=null;function pg(){return Ja===null&&(Ja=(async()=>{try{const e=await fetch(`${je}token_embed_index.json`);if(!e.ok)return null;const t=X1(await e.json()),n=await ft("token_embed.onnx");return n===null?null:{session:n,index:t}}catch{return null}})()),Ja}const G$=.92;let es=null;function fg(){return es===null&&(es=(async()=>{try{return(await fetch(`${je}guild_classifier.onnx`,{method:"HEAD"})).ok?await ft("guild_classifier.onnx"):null}catch{return null}})()),es}let ts=null;function mg(){return ts===null&&(ts=(async()=>{try{return(await fetch(`${je}laurel_digit.onnx`,{method:"HEAD"})).ok?await ft("laurel_digit.onnx"):null}catch{return null}})()),ts}let ns=null,rs=null;function gg(){return rs===null&&(rs=(async()=>{try{return(await fetch(`${je}banner_class.onnx`,{method:"HEAD"})).ok?await ft("banner_class.onnx"):null}catch{return null}})()),rs}async function W$(e,t){if(t.length===0)return t;const n=await gg();if(n===null)return t;const r=[];for(const i of t)try{const a=T2(i.box,e.width,e.height);if(a===null){r.push(i);continue}const o=Lt(e,a.x,a.y,a.w,a.h),s=E2(o),u=await n.run({[n.inputNames[0]]:new Be("float32",s,[1,3,cn,cn])});k2(u[n.outputNames[0]].data).rejected||r.push(i)}catch{r.push(i)}return r}function yg(){return ns===null&&(ns=(async()=>{try{return(await fetch(`${je}laurel_filter.onnx`,{method:"HEAD"})).ok?await ft("laurel_filter.onnx"):null}catch{return null}})()),ns}async function q$(e,t,n){let[r,i,a,o]=t,s=a-r,u=o-i;if(s<=0||u<=0)return null;if(s<Vn){const w=Math.floor((r+a)/2);r=w-Math.floor(Vn/2),a=w+Math.floor(Vn/2),s=a-r}if(u<Vn){const w=Math.floor((i+o)/2);i=w-Math.floor(Vn/2),o=w+Math.floor(Vn/2),u=o-i}const l=Math.trunc(Gm*s),c=Math.trunc(Gm*u),d=Math.max(0,r-l),p=Math.max(0,i-c),f=Math.min(e.width,a+l),m=Math.min(e.height,o+c),y=Lt(e,d,p,f-d,m-p);if(y.width<=0||y.height<=0)return null;try{const w=$2(y),b=await n.run({[n.inputNames[0]]:new Be("float32",w,[1,3,ln,ln])});return v2(b[n.outputNames[0]].data)}catch{return null}}let is=null;function wg(){return is===null&&(is=(async()=>{try{return(await fetch(`${je}coin_filter_cnn.onnx`,{method:"HEAD"})).ok?await ft("coin_filter_cnn.onnx"):null}catch{return null}})()),is}let os=null;function bg(){return os===null&&(os=(async()=>{try{return(await fetch(`${je}coin_denom.onnx`,{method:"HEAD"})).ok?await ft("coin_denom.onnx"):null}catch{return null}})()),os}async function V$(e,t,n){if(t.length===0)return[];try{const r=[];for(const u of t){const l=jm(e,Math.round(u.cx),Math.round(u.cy),Math.round(u.r));if(l===null)return null;r.push(l)}const i=new Float32Array(t.length*3*yt*yt);r.forEach((u,l)=>i.set(u,l*u.length));const o=(await n.run({[n.inputNames[0]]:new Be("float32",i,[t.length,3,yt,yt])}))[n.outputNames[0]].data,s=ti.length;return t.map((u,l)=>K2(o.subarray(l*s,l*s+s)))}catch{return null}}async function H$(e,t,n){if(t.length===0)return[];try{const r=async u=>{const l=[];for(let f=0;f<t.length;f++){const m=jm(e,Math.round(t[f].cx),Math.round(t[f].cy),Math.round(u[f]));if(m===null)return null;l.push(m)}const c=new Float32Array(t.length*3*yt*yt);l.forEach((f,m)=>c.set(f,m*f.length));const p=(await n.run({[n.inputNames[0]]:new Be("float32",c,[t.length,3,yt,yt])}))[n.outputNames[0]].data;return t.map((f,m)=>H2(p.subarray(m*2,m*2+2)))},i=await r(t.map(u=>u.r));if(i===null)return null;const a=t.map(u=>u.r).sort((u,l)=>u-l),o=a.length%2===1?a[(a.length-1)/2]:(a[a.length/2-1]+a[a.length/2])/2,s=Math.trunc(o);if(s>=8){const u=await r(t.map(()=>s));if(u!==null)return i.map((l,c)=>Math.max(l,u[c]))}return i}catch{return null}}let as=null;function ss(){return as===null&&(as=(async()=>{try{return(await fetch(`${je}tuck_classifier.onnx`,{method:"HEAD"})).ok?await ft("tuck_classifier.onnx"):null}catch{return null}})()),as}const _g=.1;let us=null;function ls(){return us===null&&(us=(async()=>{try{return(await fetch(`${je}track_band_brut.onnx`,{method:"HEAD"})).ok?await ft("track_band_brut.onnx"):null}catch{return null}})()),us}async function xg(e,t,n){try{const r=Hr(t,1280,Xw(t.width,t.height,n)),a=(await e.run({[e.inputNames[0]]:new Be("float32",r.tensor,[1,3,1280,1280])}))[e.outputNames[0]];return um(a.data,a.dims[1]??0,a.dims[2]??0,r.params,_g)}catch{return[]}}let cs=null;const j$=.4;function K$(e,t){const n=Math.min(e.x+e.width,t.x+t.width)-Math.max(e.x,t.x),r=Math.min(e.y+e.height,t.y+t.height)-Math.max(e.y,t.y);if(n<=0||r<=0)return 0;const i=e.width*e.height;return i>0?n*r/i:0}function Y$(e,t){const n=[],r=[];for(const i of t){if(!i.builtWithCardUnderneath)continue;i.boundingBox&&n.push(i.boundingBox);const a=i.tuckRegion;a&&r.push(a)}return n.length===0&&r.length===0?e:e.filter(i=>{const a=i.boundingBox;if(!a)return!0;const o=a.x+a.width/2,s=a.y+a.height/2;for(const u of n)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height||K$(a,u)>=j$)return!1;for(const u of r)if(o>=u.x&&o<=u.x+u.width&&s>=u.y&&s<=u.y+u.height)return!1;return!0})}function $g(){return cs===null&&(cs=(async()=>{try{return(await fetch(`${je}tuck_box.onnx`,{method:"HEAD"})).ok?await ft("tuck_box.onnx"):null}catch{return null}})()),cs}let ds=null;function vg(){return ds===null&&(ds=(async()=>{try{return(await fetch(`${je}wonder_classifier.onnx`,{method:"HEAD"})).ok?(await X$(),await ft("wonder_classifier.onnx")):null}catch{return null}})()),ds}let Mg=!1;async function X$(){if(Mg)return;const e=await(await fetch(`${je}wonder_classifier_seuil.json`)).json();s2(Number(e.seuil)),u2(e.classes),Mg=!0}let Sg=null,Ig=null;async function Q$(e){var d;Sg??(Sg=ft("wonder_obb.onnx"));const t=await Sg;if(t===null)return null;const n=await jn();if(n===null)return null;Ig=n;const{tensor:r,params:i}=Hr(e,1024),o=(await t.run({[t.inputNames[0]]:new Be("float32",r,[1,3,1024,1024])}))[t.outputNames[0]],s=o.dims[o.dims.length-1],u=o.data;let l=0;for(let p=0;p<s;p++){const f=u[4*s+p];f>l&&(l=f)}const c=e$(n,u,s,i);return ut.set("wonder_obb.onnx",`${ut.get("wonder_obb.onnx")??"?"} | dims=${o.dims} scoreMax=${l.toFixed(4)} dets=${c.length} q0=${(d=c[0])!=null&&d.quad[0]?JSON.stringify(c[0].quad[0].map(Math.round)):"-"} img=${e.width}x${e.height} scale=${i.scale.toFixed(4)} pad=${i.padX},${i.padY}`),c.map(p=>p.quad.map(f=>[f[0],f[1]]))}const hs={wonderRef:Xa,tuckClassifier:ss,tuckBoxClassifier:$g,obbQuads:Q$,redresserQuad:(e,t)=>r$(Ig,e,t),localiseWonders:async e=>{try{const{rows:t,params:n}=await bt("wonder",e);return da(t,n,nt.wonder.conf,Number.POSITIVE_INFINITY).map(r=>r.box)}catch{return[]}}};async function Z$(e,t){const n=await pg();if(n!==null)try{const r=Z1(e),i=new Be("float32",r,[4,3,un,un]),o=(await n.session.run({image:i}))[n.session.outputNames[0]].data,{id:s,cosine:u}=e2(n.index,J1(o));return u<G$?["",-1]:[s,u]}catch{}return H1(e,t)}const Tg=new WeakMap;async function ci(e){const t=Tg.get(e);if(t!==void 0)return await t;const n=et("decodage image",()=>J$(e));return Tg.set(e,n),await n}async function J$(e){let t;try{t=await createImageBitmap(e)}catch(n){const r=e.name||"(sans nom)",i=e.type||"(type inconnu)",a=e.size===0?"le fichier est VIDE (0 octet) — la capture a probablement été interrompue":/heic|heif/i.test(i)||/\.hei[cf]$/i.test(r)?"format HEIC/HEIF : ce navigateur ne sait pas le décoder — régler l'appareil photo sur JPEG (« Plus compatible » sur iPhone), ou repasser par la galerie qui convertit":"le fichier n'est plus lisible : s'il vient de l'appareil photo, l'OS a pu l'invalider pendant que l'app était en arrière-plan — reprendre la photo devrait suffire";throw new Error(`Image illisible (${r}, ${i}, ${e.size} octets) : ${a}. [${n instanceof Error?n.name:String(n)}]`)}try{const r=new OffscreenCanvas(t.width,t.height).getContext("2d",{willReadFrequently:!0});if(r===null)throw new Error("OffscreenCanvas 2D context unavailable.");r.drawImage(t,0,0);const{data:i}=r.getImageData(0,0,t.width,t.height);return{width:t.width,height:t.height,channels:4,data:i}}finally{t.close()}}const Eg=new WeakMap;async function bt(e,t){let n=Eg.get(t);n===void 0&&(n=new Map,Eg.set(t,n));const r=n.get(e);if(r!==void 0)return await r;const i=ev(e,t);return n.set(e,i),await i}async function ev(e,t){const n=nt[e],r=performance.now(),{tensor:i,params:a}=Hr(t,n.input);Fa+=performance.now()-r;const o=async()=>{const s=await _$(e),u={[s.inputNames[0]]:new Be("float32",i,[1,3,n.input,n.input])},l=performance.now(),c=await s.run(u),d=performance.now()-l;gr+=d,La(d),yr+=1;const p=c[s.outputNames[0]];return{rows:new Float32Array(p.data),params:a}};try{return await o()}catch(s){if(ui.has(e))throw s;return ui.add(e),ai.delete(e),await o()}}const tv=6,nv=4,rv=5,iv=2;async function ov(e){const t={kind:"unknown",confidence:0,banners:null,laurels:null,coins:null,pawnFound:!1},n=await ci(e),r=await bt("banner",n),i=jr(r.rows,r.params,nt.banner.conf);if(t.banners=i.length,i.length>=tv)return{...t,kind:"player",confidence:Math.min(1,i.length/12)};const a=await bt("laurel",n),o=pa(a.rows,a.params,nt.laurel.conf);if(t.laurels=o.length,o.length>=nv)return{...t,kind:"player",confidence:Math.min(1,o.length/8)};const s=await bt("coin",n),u=am(s.rows,s.params,nt.coin.conf);return t.coins=u.length,u.length>=rv?{...t,kind:"player",confidence:.5}:t.banners!==null&&t.banners<=iv?{...t,kind:"board",confidence:.4}:t}function av(){return{wonders:[],guilds:[],progressTokens:[],laurels:[],cardVictoryPoints:{value:0,laurelsKept:0,laurelsUnread:0,complete:!0},cardCounts:{byFamily:{},source:"none",tuckedExcluded:0},coins:{total:0,confidence:0,source:"none",coins:[]}}}async function kg(e,t,n,r,i,a,o,s){let u=0;r(`${i}: card banners…`,.04);const l=await bt("banner",e);let c=jr(l.rows,l.params,nt.banner.conf);c=await W$(e,c),r(`${i}: progress tokens…`,.08);let d=[];const p=await ls();p!==null&&(d=await xg(p,e,c)),d.length>0&&c.length>0&&(c=c.filter(W=>{const ee=W.box[0]+W.box[2]/2,ne=W.box[1]+W.box[3]/2;return!d.some(([oe,ae,xe,_e])=>Math.min(oe,xe)<=ee&&ee<=Math.max(oe,xe)&&Math.min(ae,_e)<=ne&&ne<=Math.max(ae,_e))}));const f=await bt("token",e),m=await F$(),y=[],w=[];for(const W of sb(f.rows,f.params,nt.token.conf)){if(w.push({cx:W.cx,cy:W.cy,r:W.r}),d.some(([oe,ae,xe,_e])=>W.cx>=oe&&W.cx<=xe&&W.cy>=ae&&W.cy<=_e))continue;const[ee,ne]=await Z$(fm(e,W),m);ee===""&&ne<0?w.pop():ee===""?u+=1:!y.some(oe=>oe.id===ee)&&!s.some(oe=>oe.id===ee)&&y.push({id:ee,center:[W.cx,W.cy],radius:W.r,confidence:Math.round(ne*1e4)/1e4})}r(`${i}: coins…`,.14);const b=await bt("coin",e),x=am(b.rows,b.params,nt.coin.conf).filter(W=>!w.some(ee=>(W.cx-ee.cx)**2+(W.cy-ee.cy)**2<=W.r*W.r)),M=await wg(),v=M!==null?await H$(e,x,M):null,I=(v!==null?x.filter((W,ee)=>v[ee]>=Hm).map(W=>W.r):[]).sort((W,ee)=>W-ee),E=I.length>0?I.length%2===1?I[(I.length-1)/2]:(I[I.length/2-1]+I[I.length/2])/2:null,[k,S]=V2,R=x.map((W,ee)=>{const ne=v!==null?v[ee]:null;return ne===null||ne>=Hm?"keep":E!==null&&E>0&&W.r/E>=k&&W.r/E<=S?"suspect":"drop"}),B=x.filter((W,ee)=>R[ee]==="keep"),Y=Ob(e,B),G=await bg(),q=G!==null?await V$(e,B,G):null,N=Y2(Y,q??Y.map(()=>null));N.map(W=>W.value);const F=[];let X=0;if(x.forEach((W,ee)=>{if(R[ee]==="drop")return;if(R[ee]==="suspect"){const oe=v[ee];F.push({denomination:null,center:[W.cx,W.cy],radius:W.r,suspect:!0,suspectReason:`content rejected as non-coin (P=${oe.toFixed(2)}) but the size matches this photo's confirmed coins — glare-blinded real coin OR a look-alike object; confirm or remove (a busy table warrants a cleaner photo)`});return}const ne=N[X++];F.push({denomination:ne.value,center:[W.cx,W.cy],radius:W.r,denomSource:ne.source??"colour"})}),x.length>0&&F.length===0&&t.push({code:"LOW_CONFIDENCE",message:`${n}: ${x.length} disque(s) rond(s) détecté(s) mais tous rejetés comme non-pièces (0 pièce comptée) — vérifie, ou reprends une photo plus nette.`}),F.length>=2){const W=F.map(ne=>ne.radius).sort((ne,oe)=>ne-oe),ee=W.length%2===1?W[(W.length-1)/2]:(W[W.length/2-1]+W[W.length/2])/2;if(ee>0)for(const ne of F)ne.radius/ee>2&&(ne.suspect=!0,ne.suspectReason=`radius ${ne.radius}px is ${(ne.radius/ee).toFixed(1)}x the photo's median coin radius — probably not a coin`)}if(F.length>=2)for(let W=0;W<F.length;W+=1)for(let ee=W+1;ee<F.length;ee+=1){const ne=F[W],oe=F[ee],ae=Math.hypot(ne.center[0]-oe.center[0],ne.center[1]-oe.center[1]);if(ae<1.1*Math.min(ne.radius,oe.radius))for(const xe of[ne,oe])xe.suspect||(xe.suspect=!0,xe.suspectReason=`almost concentric with another coin (${ae.toFixed(0)}px apart) — either a pile of two coins or a duplicate read of one; confirm which`)}const Z=[],le=[],L=[],O=Date.now()+E$;let C=null,z=null;const U=()=>(z===null&&(z=(async()=>{try{const{rows:W,params:ee}=await bt("wonder",e);return da(W,ee,nt.wonder.conf,Number.POSITIVE_INFINITY).map(ne=>ne.box)}catch{return[]}})()),z),P=[];let j=!1;const ie=await vg();if(ie!==null){const W=await U();if(W.length>0&&(C=await et("opencv.js (chargement)",()=>jn()),C!==null)){r(`${i}: identifying wonders…`,.35);const ee=await et("identifyWondersByClassifier",()=>ng(hs,C,e,W,ie,O,c));for(const ne of ee)Z.some(oe=>oe.id===ne.obj.id)||o.some(oe=>oe.id===ne.obj.id)||(Z.push(ne.obj),P.push({obj:ne.obj,edgeScores:ne.edgeScores,zone:ne.zone}),le.push(ne.zone),L.push({quad:ne.quad,region:ne.region}));j=ee.length>0}}j||r(`${i}: wonder names…`,.2);const J=j?{wonders:[],aborted:!1}:await z$(e,(W,ee)=>r(`${i}: ${W}`,.2+.35*(ee??0)));C===null&&(C=J.wonders.length>0?await jn():null);for(const W of J.wonders){let ee=null;if(C!==null&&Date.now()<O){r(`${i}: registering ${W.name}…`,.6);try{const ne=await Xa(W.id);if(ne!==null){let oe=D_(C,e,ne,[[W.nameBox.x,W.nameBox.y],[W.nameBox.x+W.nameBox.width,W.nameBox.y],[W.nameBox.x+W.nameBox.width,W.nameBox.y+W.nameBox.height],[W.nameBox.x,W.nameBox.y+W.nameBox.height]]);if(oe===null){const ae=await U(),xe=W_(ae,W.nameBox.x+W.nameBox.width/2,W.nameBox.y+W.nameBox.height/2);xe!==null&&(oe=Sm(C,e,ne,xe))}if(oe!==null){let ae=oe.built,xe=!1;const _e=await ss();if(_e!==null)try{const ge=Ia(C,e,ne,oe.footprint);if(ge!==null){const we=Qr(ge),Se=await _e.run({[_e.inputNames[0]]:new Be("float32",we,[1,3,gt,gt])});ae=Ta(Se[_e.outputNames[0]].data).built,xe=!0}}catch{}const Q=oe.footprint.map(ge=>ge[0]),te=oe.footprint.map(ge=>ge[1]),se=Math.max(0,Math.round(Math.min(...Q))),pe=Math.max(0,Math.round(Math.min(...te)));ee={built:ae,boundingBox:{x:se,y:pe,width:Math.min(e.width,Math.round(Math.max(...Q)))-se,height:Math.min(e.height,Math.round(Math.max(...te)))-pe},tuckRegion:Xr(oe.footprint,oe.overflow),footprint:oe.footprint,edgeScores:oe.edgeScores,builtByTuck:xe}}}}catch(ne){console.warn(`[wonders-reg] ${W.id} failed:`,ne)}}if(ee!==null){const ne=ee.tuckRegion??ee.boundingBox;le.push({x0:ne.x,y0:ne.y,x1:ne.x+ne.width,y1:ne.y+ne.height}),L.push({quad:ee.footprint,region:ee.tuckRegion})}else{const ne=Math.max(8,W.nameBox.height),oe=Math.round(W.nameBox.width*.15);le.push({x0:W.nameBox.x-oe,y0:W.nameBox.y-ne*2.5,x1:W.nameBox.x+W.nameBox.width+oe,y1:W.nameBox.y+W.nameBox.height+ne*2.5}),L.push({quad:null,region:null})}if(!Z.some(ne=>ne.id===W.id)&&!o.some(ne=>ne.id===W.id)){const ne=(ee==null?void 0:ee.builtByTuck)===!0,oe=ne?ee.built:!1,ae=!ne&&(ee==null?void 0:ee.built)===!0,xe={id:W.id,name:W.name,builtWithCardUnderneath:oe,boundingBox:(ee==null?void 0:ee.boundingBox)??{x:0,y:0,width:0,height:0},...ee!=null&&ee.tuckRegion?{tuckRegion:ee.tuckRegion}:{},confidence:W.confidence,...ae?{suspect:!0,suspectReason:"built-unconfirmed"}:{}};Z.push(xe),P.push({obj:xe,edgeScores:ee&&!ee.builtByTuck?ee.edgeScores:null,zone:le[le.length-1]})}}if(!j){const W=H_(P.map(ee=>({built:ee.obj.builtWithCardUnderneath,edgeScores:ee.edgeScores,zone:ee.zone})),c.map(ee=>[ee.box[0]+ee.box[2]/2,ee.box[1]+ee.box[3]/2]));for(const ee of W){const ne=P[ee];ne.obj.builtWithCardUnderneath=!1,t.push({code:"INCONSISTENT_STATE",message:`${n}: wonder '${ne.obj.id}' was NOT marked built — the card-under-wonder signal saturated on this surface and no tucked card banner supports it. Tick it in the review if it really was built.`})}if(c.length>0){const ee=new Set(W);for(let ne=0;ne<P.length;ne++){const oe=P[ne];if(ee.has(ne)||!oe.obj.builtWithCardUnderneath)continue;const ae=oe.obj.tuckRegion;if(ae===void 0)continue;if(!c.some(_e=>{const Q=_e.box[0]+_e.box[2]/2,te=_e.box[1]+_e.box[3]/2;return Q>=ae.x&&Q<=ae.x+ae.width&&te>=ae.y&&te<=ae.y+ae.height})){const _e=oe.obj;_e.builtWithCardUnderneath=!1,_e.suspect=!0,_e.suspectReason="built-unconfirmed"}}}}if(J.aborted&&t.push({code:"LOW_CONFIDENCE",message:`${i}: the wonder-name read ran out of its time budget on this device — ${J.wonders.length} wonder(s) read before the cutoff; check the built-wonders list.`}),C!==null&&J.wonders.length>0&&Date.now()<O)try{const W=await hg(),ee=(W==null?void 0:W.catalog.filter(oe=>oe.kind==="wonder").map(oe=>oe.id))??[],ne=new Map;for(const oe of ee)if(!Z.some(ae=>ae.id===oe)&&!o.some(ae=>ae.id===oe)){const ae=await Xa(oe);ae!==null&&ne.set(oe,ae)}if(ne.size>0){r(`${i}: searching occluded wonders…`,.7);const oe=P_(C,e,ne,O);for(const ae of oe){const xe=ae.footprint.map(ye=>ye[0]),_e=ae.footprint.map(ye=>ye[1]),Q=Math.max(0,Math.round(Math.min(...xe))),te=Math.max(0,Math.round(Math.min(..._e))),se={x:Q,y:te,width:Math.min(e.width,Math.round(Math.max(...xe)))-Q,height:Math.min(e.height,Math.round(Math.max(..._e)))-te},pe=ye=>{const Ue=ye.boundingBox,qe=Math.max(0,Math.min(Ue.x+Ue.width,se.x+se.width)-Math.max(Ue.x,se.x)),Fe=Math.max(0,Math.min(Ue.y+Ue.height,se.y+se.height)-Math.max(Ue.y,se.y)),Ge=qe*Fe,it=Ue.width*Ue.height+se.width*se.height-Ge;return it>0&&Ge/it>B_};if(Z.some(pe)||o.some(pe))continue;const we=W==null?void 0:W.catalog.find(ye=>ye.id===ae.id);Z.push({id:ae.id,name:(we==null?void 0:we.nameFr)??(we==null?void 0:we.name)??ae.id,builtWithCardUnderneath:ae.built,boundingBox:se,...ae.tuckRegion?{tuckRegion:ae.tuckRegion}:{},confidence:Math.round(ae.confidence*1e4)/1e4});const Se=ae.tuckRegion??se;le.push({x0:Se.x,y0:Se.y,x1:Se.x+Se.width,y1:Se.y+Se.height}),L.push({quad:ae.footprint.map(([ye,Ue])=>[ye,Ue]),region:ae.tuckRegion??null})}}}catch(W){console.warn("[wonders-reg] discovery failed:",W)}const me=async()=>{let W=Z.slice();const ee=[];c.forEach((_e,Q)=>{const te=_e.box[0]+_e.box[2]/2,se=_e.box[1]+_e.box[3]/2;le.some(pe=>te>=pe.x0&&te<=pe.x1&&se>=pe.y0&&se<=pe.y1)||ee.push(Q)});const ne=[],oe=[];W.forEach((_e,Q)=>{const te=_e.boundingBox;te&&te.width>0&&(ne.push(Q),oe.push([te.x,te.y,te.width,te.height]))});const ae=_e=>{const Q=[];return _e.forEach((te,se)=>{const pe=te.box[0]+te.box[2]/2,ge=te.box[1]+te.box[3]/2;le.some(we=>pe>=we.x0&&pe<=we.x1&&ge>=we.y0&&ge<=we.y1)||Q.push(se)}),Q};let xe=Ra(c.map(_e=>_e.box),ee,oe,d,[e.width,e.height]);if(ie!==null){r(`${i}: seconde passe merveilles (crop de cité)…`,.42),wt.pass1Calls+=1;const Q=(await ig({skipKnownNear:!0,image:e,banners:c,hulls:xe.hulls.map(([te,se],pe)=>({owner:te,poly:se,n:xe.hullBoxCounts[pe]??0})),wonderBoxes:oe,known:W,cropFrame:([te,se,pe,ge])=>Lt(e,te,se,pe-te,ge-se),detect:async(te,se,pe)=>{if(C===null&&(C=await jn()),C===null)return[];const ge=await rg(hs,C,te,ie,O,se,pe);return wt.pass1Boxes+=ge.length,ge}})).filter(te=>!Z.some(se=>se.id===te.obj.id)&&!o.some(se=>se.id===te.obj.id));if(wt.pass1Kept+=Q.length,Q.length>0){for(const te of Q)Z.push(te.obj),le.push(te.zone),L.push({quad:te.quad,region:te.region});W=Z.slice(),ne.length=0,oe.length=0,W.forEach((te,se)=>{const pe=te.boundingBox;pe&&pe.width>0&&(ne.push(se),oe.push([pe.x,pe.y,pe.width,pe.height]))}),xe=Ra(c.map(te=>te.box),ae(c),oe,d,[e.width,e.height])}}try{const _e=Ym(e.width,e.height,c.map(Q=>Q.box),xe.hulls.map(([Q,te],se)=>({owner:Q,poly:te,n:xe.hullBoxCounts[se]??0})),oe);if(_e.length>0){const Q=Na(c.map(se=>se.box)),te=[];for(const se of _e){const[pe,ge,we,Se]=se,ye=Lt(e,pe,ge,we-pe,Se-ge);if(ye.width<=0||ye.height<=0)continue;const Ue=await bt("banner",ye);for(const qe of jr(Ue.rows,Ue.params,nt.banner.conf)){const Fe=Tx(qe.box,se,Q);Fe&&te.push({...qe,box:Fe})}}if(te.length>0){const se=cm([...c,...te]);se.length>c.length&&(c=se,xe=Ra(c.map(pe=>pe.box),ae(c),oe,d,[e.width,e.height]))}}}catch(_e){console.warn("[#129 city-rescan] skipped:",_e)}if(ie!==null&&W.some(_e=>_e.builtWithCardUnderneath!==!0)){r(`${i}: revote built (crop de cité)…`,.47);const _e=new Set;wt.pass2Calls+=1,await ig({builtSeenOut:_e,image:e,banners:c,hulls:xe.hulls.map(([Q,te],se)=>({owner:Q,poly:te,n:xe.hullBoxCounts[se]??0})),wonderBoxes:oe,known:W,cropFrame:([Q,te,se,pe])=>Lt(e,Q,te,se-Q,pe-te),detect:async(Q,te)=>{if(C===null&&(C=await jn()),C===null)return[];const se=await rg(hs,C,Q,ie,O,te);return wt.pass2Boxes+=se.length,se}}),wt.pass2Promoted+=[..._e].filter(Q=>W.some(te=>te.id===Q&&te.builtWithCardUnderneath!==!0)).length;for(const Q of W)Q.id&&_e.has(Q.id)&&Q.builtWithCardUnderneath!==!0&&(Q.builtWithCardUnderneath=!0,Q.builtByCityCrop=!0)}return a!==void 0&&(a.hulls=xe.hulls.map(([_e,Q],te)=>({owner:_e,poly:Q,n:xe.hullBoxCounts[te]??0})),a.bandBoxes=d,a.image=e),{split:xe,photoWonders:W,splitWonderIdx:ne}};let Te=null;try{Te=await me()}catch(W){console.warn("[city-split] failed (side unfiltered):",W)}return{bannerDetections:c,photoCoins:F,photoTokenDiscs:w,discs:x,bandBoxes:d,bandSession:p,wonderFootprints:le,wonderTuckGates:L,photoTokensList:y,geo:Te,cv:C,regDeadline:O,unidentifiedTokens:u}}async function Cg(e,t,n,r,i,a,o,s,u,l){let c=e.bannerDetections,d=e.cv;const{photoCoins:p,photoTokenDiscs:f,discs:m,bandBoxes:y,bandSession:w,wonderFootprints:b,wonderTuckGates:x,photoTokensList:M,geo:v,regDeadline:I}=e,E={},k=[],S=[];let R=0;const B=[];let Y=0,G=0;const q=[],N=[],F=[],X=t==="opponent";let Z=(Q,te)=>!X,le=(Q,te)=>!X,L=null;if(v!==null)try{const{split:Q,photoWonders:te,splitWonderIdx:se}=v;Z=(Se,ye)=>Q.pointOwner(Se,ye)==="opponent"===X;const pe=X?"opponent":"player";if(le=(Se,ye)=>Q.pointOwner(Se,ye)===pe,n){const Se=Q;L=ye=>new Set(fx(ye,Se,pe,y))}c=c.filter((Se,ye)=>Q.bannerOwner[ye]==="opponent"===X);const ge=te.map(()=>"player");se.forEach((Se,ye)=>{ge[Se]=Q.wonderOwner[ye]});const we=[];te.forEach((Se,ye)=>{ge[ye]==="opponent"===X&&we.push(Se)});for(const Se of we)N.push(Se);b.length=0;for(const Se of we){const ye=Se.tuckRegion??Se.boundingBox;ye&&b.push({x0:ye.x,y0:ye.y,x1:ye.x+ye.width,y1:ye.y+ye.height})}for(const Se of M)Z(Se.center[0],Se.center[1])&&F.push(Se)}catch(Q){console.warn("[city-split] failed (side unfiltered):",Q)}const O=L!==null?L(p):null;for(const Q of p)(O!==null?!O.has(Q):!le(Q.center[0],Q.center[1]))||(R+=Q.denomination??0,S.push(Q));const C=new Set,z=[],U=Na(c.map(Q=>Q.box));x.forEach((Q,te)=>{if(Q.quad===null||Q.region===null){const we=b[te];we&&z.push(we);return}const se=Q.region,pe=[];c.forEach((we,Se)=>{const ye=we.box[0]+we.box[2]/2,Ue=we.box[1]+we.box[3]/2;ye>=se.x&&ye<=se.x+se.width&&Ue>=se.y&&Ue<=se.y+se.height&&pe.push([Se,we.box])});const ge=q2(Q.quad,pe,U);ge!==null&&C.add(ge)});let P=[],j=0;c.forEach((Q,te)=>{if(C.has(te)){G+=1,j+=1;return}const se=Q.box[0]+Q.box[2]/2,pe=Q.box[1]+Q.box[3]/2;if(z.some(ge=>se>=ge.x0&&se<=ge.x1&&pe>=ge.y0&&pe<=ge.y1)){G+=1,j+=1;return}P.push(Q)});const ie=P2(P,j,y,a.width,a.height);P=ie.kept;for(const Q of P)E[Q.family]=(E[Q.family]??0)+1,Y+=1;const J=yb(P),me=new Set(J.map(Q=>Q.box.join(",")));for(const Q of bb(P))me.has(Q.box.join(","))||(J.push(Q),me.add(Q.box.join(",")));for(const Q of ie.suspects)me.has(Q.box.join(","))||(J.push(Q),me.add(Q.box.join(",")));for(const Q of J)q.push(Q);if(P.some(Q=>Q.family==="guild")){const Q=await fg();if(Q!==null){s(`${u}: identifying guilds…`,.75);for(const te of P)if(te.family==="guild")try{const[se,pe,ge,we]=te.box,Se=Lt(a,se,pe,ge,we),ye=r2(Se),Ue={[Q.inputNames[0]]:new Be("float32",ye,[1,3,qn,qn])},Fe=(await Q.run(Ue))[Q.outputNames[0]].data,{id:Ge,prob:it}=i2(Fe);Ge!==""&&!B.some(Rt=>Rt.id===Ge)&&!l.some(Rt=>Rt.id===Ge)&&B.push({id:Ge,boundingBox:{x:se,y:pe,width:ge,height:we},confidence:Math.round(it*1e4)/1e4})}catch(se){console.warn("[guild-cls] failed:",se)}}else if(Date.now()<I)try{const te=d??await jn();if(te!==null){const se=await k$();if(se.size>0){s(`${u}: identifying guilds…`,.75);const pe=await C$();for(const ge of R1(te,a,se,I,pe))!B.some(we=>we.id===ge.id)&&!l.some(we=>we.id===ge.id)&&B.push(ge)}}}catch(te){console.warn("[guilds-reg] failed:",te)}}s(`${u}: laurels…`,.8);const W=await et("laurier: chargement galerie gabarits",()=>P$()),ee=[];for(const Q of[0]){const te=Q===0?a:Yt(a,Q),se=await et("laurier: passe PLEINE photo",()=>bt("laurel",te));for(const[pe,ge,we,Se]of at("laurier: decodage YOLO (JS)",()=>pa(se.rows,se.params,nt.laurel.conf))){const ye=Za({x:pe,y:ge,width:we-pe,height:Se-ge},Q,a.width,a.height);ee.push([ye.x,ye.y,ye.x+ye.width,ye.y+ye.height])}}let ne=at("laurier: dedup",()=>sm(ee));const oe=[];try{const Q=Lx(c.map(te=>te.box),[a.width,a.height]);ut.set("_tta.onnx",`total=${Pa.total} idDiff=${Pa.idDiff} verdictDiff=${Pa.verdictDiff}`),ut.set("_rescan.onnx",`p1: ${wt.pass1Calls} appels, ${wt.pass1Boxes} boites, ${wt.pass1Kept} neuves | p2: ${wt.pass2Calls} appels, ${wt.pass2Boxes} boites, ${wt.pass2Promoted} promues`),ut.set("_marge2.onnx",`total=${Ut.total} pos4=${Ut.positifs4} pos2=${Ut.positifs2} divergent=${Ut.divergent} `+Ut.detail.slice(0,10).join(" | ")),ut.set("_ttaObb.onnx",`total=${oi.total} memeK=${oi.memeK} inv=${oi.memeKInverse} `+oi.detail.slice(0,12).join(" ")),ut.set("_tuilage.onnx",`groupes=? tuiles=${Q.length} bannieres=${c.length} image=${a.width}x${a.height}`);for(const[te,se,pe,ge]of Q){const we=Lt(a,te,se,pe-te,ge-se);if(we.width<=0||we.height<=0)continue;const Se=[];for(const ye of[0]){const Ue=ye===0?we:Yt(we,ye),qe=await et("laurier: passe par TUILE (#113)",()=>bt("laurel",Ue));for(const[Fe,Ge,it,Rt]of at("laurier: decodage YOLO (JS)",()=>pa(qe.rows,qe.params,nt.laurel.conf))){const lt=Za({x:Fe,y:Ge,width:it-Fe,height:Rt-Ge},ye,we.width,we.height);Se.push([lt.x,lt.y,lt.x+lt.width,lt.y+lt.height])}}if(ne=Fx(ne,sm(Se),[te,se]),w!==null)try{const ye=await et("laurier: bande de piste sur tuile (#114)",async()=>{const Fe=Hr(we,1280,hr);return{sortie:await w.run({[w.inputNames[0]]:new Be("float32",Fe.tensor,[1,3,1280,1280])}),params:Fe.params}}),Ue={params:ye.params},qe=ye.sortie[w.outputNames[0]];for(const[Fe,Ge,it,Rt]of um(qe.data,qe.dims[1]??0,qe.dims[2]??0,Ue.params,_g))oe.push([Fe+te,Ge+se,it+te,Rt+se])}catch{}}}catch(Q){console.warn("[laurel-containers] failed:",Q)}const ae=[...y,...oe];ne=ne.filter(([Q,te,se,pe])=>!qx((Q+se)/2,(te+pe)/2,ae,c.map(ge=>ge.box)));const[xe,_e]=await et("laurier: 1er contact des 2 ResNet (89,6 Mo)",()=>Promise.all([mg(),yg()]));for(const[Q,te,se,pe]of ne){const ge=Math.trunc((Q+se)/2),we=Math.trunc((te+pe)/2);if([...f,...m].some(He=>(ge-He.cx)**2+(we-He.cy)**2<=He.r*He.r)||!Z(ge,we))continue;if(_e!==null){const He=await et("laurier: filtre FP (#49)",()=>q$(a,[Math.trunc(Q),Math.trunc(te),Math.trunc(se),Math.trunc(pe)],_e));if(He!==null&&He>=x2)continue}const ye=Math.min(Math.trunc(se-Q),Math.trunc(pe-te)),Ue=Math.max(6,Math.trunc(Math.max(se-Q,pe-te)*Ub)),qe=D$(a,ge,we,Ue);let Fe=null,Ge=0,it=!1;if(xe!==null&&ye>=6){const He=Lt(a,Math.trunc(Q),Math.trunc(te),Math.trunc(se-Q),Math.trunc(pe-te));let Xe=null,_t=0;for(const Ot of[0,1,2,3]){const Jt=Ot===0?He:Yt(He,Ot),gs=w2(Jt),ys=await et("laurier: lecture chiffre (CNN)",()=>xe.run({[xe.inputNames[0]]:new Be("float32",gs,[1,3,Pt,Pt])})),{value:ws,prob:hi}=b2(ys[xe.outputNames[0]].data);if(hi>_t&&(Xe=ws,_t=hi),Xe!==null&&_t>=y2)break}Xe!==null&&_t>=g2&&(Fe=Xe,Ge=_t)}if(Fe===null&&ye>=6){const He=new Map;for(const Xe of[0,1,2,3]){const _t=Xe===0?qe:Yt(qe,Xe),[Ot,Jt]=at("laurier: lecteur GABARITS (repli, JS pur)",()=>Jb(_t,W));Ot!==null&&(He.set(Ot,Math.max(He.get(Ot)??0,Jt)),Jt>Ge&&(Fe=Ot,Ge=Jt))}Fe!==null&&Ge<T$&&(Fe=null),it=Fe!==null&&[...He.entries()].some(([Xe,_t])=>Xe!==Fe&&_t>=Ge-.1)}const Rt=b.some(He=>ge>=He.x0&&ge<=He.x1&&we>=He.y0&&we<=He.y1),lt=[...B,...l].some(He=>{const Xe=He.boundingBox;return Xe!==void 0&&ge>=Xe.x&&ge<=Xe.x+Xe.width&&we>=Xe.y&&we<=Xe.y+Xe.height});k.push({value:Fe,valueRead:Fe!==null,center:[Math.round((Q+se)/2),Math.round((te+pe)/2)],boundingBox:{x:Math.trunc(Q),y:Math.trunc(te),width:Math.trunc(se-Q),height:Math.trunc(pe-te)},confidence:Math.round(Ge*1e4)/1e4,excluded:Rt||lt,photoIndex:i-1,...it?{suspect:!0,suspectReason:"orientation-ambiguous"}:{}})}return{byFamily:E,laurels:k,coins:S,coinTotal:R,guilds:B,bannerCount:Y,tuckedExcluded:G,bannerSuspects:q,cityWondersKept:N,cityTokensKept:F}}function Ag(){return{byFamily:{},laurels:[],coins:[],progressTokens:[],wonders:[],guilds:[],bannerSuspects:[],coinTotal:0,unidentifiedTokens:0,bannerCount:0,tuckedExcluded:0}}function Rg(e,t){for(const n of t.cityWondersKept)e.wonders.push(n);for(const n of t.cityTokensKept)e.progressTokens.push(n);for(const n of t.coins)e.coins.push(n);e.coinTotal+=t.coinTotal;for(const n of t.laurels)e.laurels.push(n);for(const n of t.guilds)e.guilds.push(n);for(const n of t.bannerSuspects)e.bannerSuspects.push(n);e.bannerCount+=t.bannerCount,e.tuckedExcluded+=t.tuckedExcluded;for(const[n,r]of Object.entries(t.byFamily))e.byFamily[n]=(e.byFamily[n]??0)+r}function Og(e,t,n){const{byFamily:r,laurels:i,coins:a,progressTokens:o,wonders:s,guilds:u,bannerSuspects:l,coinTotal:c,unidentifiedTokens:d,bannerCount:p,tuckedExcluded:f}=e;f>0?n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: ${f} banner(s) near a wonder were excluded as tucked/consumed (estimated footprint — the server uses the real card box); verify the per-colour counts.`}):p>0&&s.length===0&&n.push({code:"OVERLAPPING_OBJECTS",message:`${t}: no wonder was located on this photo, so a card tucked under a wonder may still be counted — verify the per-colour counts.`});const m=r.guild??0;m!==u.length?n.push({code:"INCONSISTENT_STATE",message:`${t}: ${m} purple banner(s) counted but ${u.length} guild(s) identified — reconcile in the review (stacked guilds or a missed identification).`}):u.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: guild(s) identified by their card art: `+u.map(M=>M.id).join(", ")+" — confirm in the review."});const y=s.filter(M=>M.boundingBox.width===0);if(y.length>0?n.push({code:"LOW_CONFIDENCE",message:`${t}: wonder(s) identified by name but NOT registered against their reference (${y.map(M=>M.name).join(", ")}) — their BUILT flag is a suggestion: unselect any that was not built.`}):s.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: ${s.length} wonder(s) registered — the BUILT flags were measured (card protruding underneath); confirm in the review.`}),d>0&&n.push({code:"UNRECOGNIZED_OBJECT",message:`${t}: ${d} token disc(s) found but not identified — pick them in the review below.`}),o.length>0&&n.push({code:"LOW_CONFIDENCE",message:`${t}: progress token(s) identified on-device: `+o.map(M=>M.id).join(", ")+" — confirm in the review."}),a.length>0){const M=a.filter(I=>I.denomSource==="cnn").length,v=a.length-M;n.push({code:"LOW_CONFIDENCE",message:v===0?`${t}: coins read as ${c} from ${a.length} tile(s) by the learned denomination model — confirm the total.`:`${t}: coins read as ${c} from ${a.length} tile(s) — ${M} by the learned model, ${v} by metal COLOUR alone (the model abstained); confirm the total.`})}const w=Y$(u,s);for(const M of[...Vx(s.map(v=>v.id),t),...Kx(w.map(v=>v.id),t)])n.push({code:"INCONSISTENT_STATE",message:M.message});const b=i.filter(M=>!M.excluded),x=b.filter(M=>M.valueRead);return{...av(),wonders:s,guilds:w,progressTokens:o,laurels:i,cardVictoryPoints:{value:x.reduce((M,v)=>M+(v.value??0),0),laurelsKept:b.length,laurelsUnread:b.length-x.length,complete:b.length===x.length},cardCounts:{byFamily:r,source:p>0?"yolo":"none",tuckedExcluded:f,...l.length>0?{suspects:l}:{}},coins:{total:c,confidence:a.length>0?.5:0,source:a.length===0?"none":a.some(M=>M.denomSource==="cnn")?"local-cnn":"local-colour",coins:a}}}async function sv(e,t,n,r,i=()=>{},a="player",o,s=!1){const u=Ag();let l=0;for(const c of e){l+=1;const d=`${t} photo ${l}/${e.length}`;r(`${d}: reading pixels…`,.01);const p=await ci(c),f=await kg(p,n,t,r,d,o,u.wonders,u.progressTokens);u.unidentifiedTokens+=f.unidentifiedTokens;const m=await Cg(f,a,s,t,l,p,n,r,d,u.guilds);Rg(u,m),i()}return Og(u,t,n)}const At=1280,uv=.3,di=9;let ps=null;function fs(){return ps===null&&(ps=(async()=>{try{return(await fetch(`${je}pawn_ends_brut.onnx`,{method:"HEAD"})).ok?await ft("pawn_ends_brut.onnx"):null}catch{return null}})()),ps}function lv(e){const t=At/Math.max(e.width,e.height),n=Math.round(e.width*t),r=Math.round(e.height*t),i=new OffscreenCanvas(e.width,e.height),a=i.getContext("2d",{willReadFrequently:!0}),o=Vw(e.data,e.width,e.height,e.channels);a.putImageData(new ImageData(o,e.width,e.height),0,0);const u=new OffscreenCanvas(At,At).getContext("2d",{willReadFrequently:!0});u.fillStyle="rgb(114,114,114)",u.fillRect(0,0,At,At),u.drawImage(i,0,0,e.width,e.height,0,0,n,r);const{data:l}=u.getImageData(0,0,At,At),c=At*At,d=new Float32Array(3*c);for(let p=0;p<c;p+=1)d[p]=l[p*4]/255,d[c+p]=l[p*4+1]/255,d[2*c+p]=l[p*4+2]/255;return{tensor:d,r:t}}const Ye={appels:0,inferences:0,bandes:0,detail:[],premiereGagne:null};function cv(){Ye.appels=0,Ye.inferences=0,Ye.bandes=0,Ye.detail=[],Ye.premiereGagne=null}function Ng(){ut.set("_pion.onnx",`appels=${Ye.appels} inferences=${Ye.inferences} bandes=${Ye.bandes} premiereGagne=${Ye.premiereGagne??"n/a"} | ${Ye.detail.join(" ")}`)}async function dv(e,t){Ye.inferences+=1;const{tensor:n,r}=at("pion: mise en tenseur 1280x1280",()=>lv(t)),a=(await e.run({[e.inputNames[0]]:new Be("float32",n,[1,3,At,At])}))[e.outputNames[0]],o=a.data,s=a.dims[2]??0,u=(a.dims[1]??4)-4;return at("pion: depouillement des ancres brutes",()=>{const c=new Map;for(let d=0;d<u;d+=1){const p=(4+d)*s;let f=-1,m=uv;for(let y=0;y<s;y+=1){const w=o[p+y];w>=m&&(m=w,f=y)}if(f>=0){const y=(o[f]+o[2*s+f])/2/r,w=(o[s+f]+o[3*s+f])/2/r;c.set(d,{conf:m,cx:y,cy:w})}}return c})}async function ms(e,t,n){const r=Ye.inferences,i=`a${Ye.appels}`;Ye.appels+=1;const a=await et("pion: UNE passe (les 4 rotations)",()=>hv(e,t,n));return Ye.detail.push(`${i}:${Ye.inferences-r}inf conf=${a===null?"rien":a.confidence.toFixed(2)}`),Ng(),a}async function hv(e,t,n){let r=null;const i=1.8;for(const x of n??[0,1,2,3]){const M=x===0?t:at("pion: rotation de l'image",()=>Yt(t,x)),v=await dv(e,M);if(v.has(0)&&v.has(1)&&v.has(2)){const I=v.get(0).conf+v.get(1).conf+v.get(2).conf;if((r===null||I>r.score)&&(r={score:I,det:v,k:x}),I>=i)break}}if(r===null)return null;const a=r.det.get(0),o=r.det.get(1),s=r.det.get(2),u=s.cx-o.cx,l=s.cy-o.cy,c=(o.cx+s.cx)/2,d=(o.cy+s.cy)/2,p=u*u+l*l;if(p<=0)return null;const f=((a.cx-c)*u+(a.cy-d)*l)/p*(2*di),m=Math.min(di,Math.max(-di,st(f))),y=Math.min(a.conf,o.conf,s.conf),w=(x,M)=>{const v=r.k%4;return v===0?[x,M]:v===1?[M,t.height-1-x]:v===2?[t.width-1-x,t.height-1-M]:[t.width-1-M,x]},b=[o,s].map(x=>{const[M,v]=w(x.cx,x.cy);return[st(M),st(v)]});return{position:m,confidence:Math.round(y*1e4)/1e4,ends:b,k:r.k}}async function zg(e,t,n){let r=null,i=null;for(const a of n){const o=Qw(t.width,t.height,a);if(o===null)continue;const s=Lt(t,o.x,o.y,o.width,o.height);if(s.width===0||s.height===0)continue;Ye.bandes+=1;const u=await ms(e,s,i===null?void 0:[i]);u!==null&&i===null&&(i=u.k),u!==null&&(Ye.premiereGagne===null?Ye.premiereGagne=!0:r!==null&&u.confidence>r.confidence&&(Ye.premiereGagne=!1),Ng()),u!==null&&(r===null||u.confidence>r.confidence)&&(r={...u,ends:u.ends.map(([l,c])=>[l+o.x,c+o.y])})}return r}function pv(){const e=[pg,fg,mg,gg,yg,wg,bg,ss,ls,$g,vg,fs];for(const t of e)try{Promise.resolve(t()).catch(()=>{})}catch{}}async function fv(e,t){pv();const n=[{code:"LOW_CONFIDENCE",message:"On-device mode: everything is recognised locally — card counts, coin denominations, laurel values, wonders, guilds and token identities, with the same models as the server. What still deserves a look is COMPLETENESS: an object the detector never saw cannot be corrected by any of them, so check the totals against the table."}],r={left:null,right:null},i=e.left.length+e.right.length+(e.both!==void 0?2:0);let a=0;const o=(f,m=0)=>{t(f,i>0?Math.min(.99,(a+m)/i):void 0)},s=()=>{a+=1};for(const f of["left","right"]){const m=e[f];m.length>0&&(r[f]=await sv(m,f,n,o,s))}let u=null,l=null;if(e.both!==void 0){const f={},m=await ci(e.both),y=await kg(m,n,"both",o,"both photo 1/1",f,[],[]),w=async(M,v)=>{const I=Ag();return I.unidentifiedTokens+=y.unidentifiedTokens,Rg(I,await Cg(y,M,!0,v,1,m,n,o,`${v} photo 1/1`,I.guilds)),s(),Og(I,v,n)},b={player:await w("player","left"),opponent:await w("opponent","right")};if(o("military pawn…",.95),f.image!==void 0)try{const M=await fs();M!==null&&(f.bandBoxes!==void 0&&f.bandBoxes.length>0&&(u=await zg(M,f.image,f.bandBoxes)),u===null&&(u=await ms(M,f.image)))}catch(M){console.warn("[#125] both-photo pawn read failed:",M)}u!==null&&(l=nb(u.ends,f.hulls??[],u.position));const x=l!==null&&!l.ambiguous?rb(l):null;x!==null?(r.left=b[x.left],r.right=b[x.right],n.push({code:"AMBIGUOUS_OWNER",message:`Both-players photo: LEFT and RIGHT were derived from the MILITARY BOARD geometry (each track end paired with the city it is the capital of), which overrides the cluster-dominance guess — favored ${l.favoredOwner}, pawn at ${u.position}. Swap them in the review only if this is wrong.`})):(r.left=b.player,r.right=b.opponent,n.push({code:"AMBIGUOUS_OWNER",message:"Both-players photo: the DOMINANT city was assigned to the left player and the opposing city to the right — swap them in the review if the seating is the other way around."}))}{const f={},m={};for(const y of["left","right"]){const w=r[y];w!=null&&(f[y]=w.wonders.map(b=>b.id),m[y]=w.progressTokens.map(b=>b.id))}for(const y of[...Hx(f),...jx(m)])n.push({code:"INCONSISTENT_STATE",message:y.message})}let c={conflictPawnPosition:0,found:!1,confidence:0};if(e.board!==void 0)try{const f=await ci(e.board),m=await fs();if(m!==null){let y=await ms(m,f);if(y===null){const w=await ls();if(w!==null){const b=await bt("banner",f),x=jr(b.rows,b.params,nt.banner.conf),M=await xg(w,f,x);y=await zg(m,f,M)}}y!==null&&(c={conflictPawnPosition:y.position,found:!0,confidence:y.confidence},n.push({code:"AMBIGUOUS_OWNER",message:`Conflict pawn read at position ${y.position} — confirm which player it favours (the sign is a convention, not read from the photo).`}))}}catch(f){console.warn("[pawn] on-device read failed:",f)}else u!==null&&l!==null&&(c={conflictPawnPosition:u.position,found:!0,confidence:u.confidence});if(!c.found){const f=b=>{var x,M;return Number(((M=(x=b==null?void 0:b.cardCounts)==null?void 0:x.byFamily)==null?void 0:M.military)??0)},m=f(r.left),y=f(r.right),w=Math.abs(m-y);n.push({code:"MILITARY_PAWN_NOT_FOUND",message:w>=3?`The conflict pawn was NOT read, so the military score is 0 — but one city has ${m} military cards and the other ${y}. A gap that wide almost never leaves the pawn in the middle: set its position below, it is very likely worth points.`:"The conflict pawn was not read — the military score is 0 by default, not by measurement. Set its position below if the pawn is off-centre."})}const d=c.conflictPawnPosition,p=Math.abs(d)>=di?{type:"military",winner:d>0?"left":"right"}:{type:"civilian"};return{imageId:e.imageId,players:r,militaryTrack:c,outcome:p,confidence:.5,warnings:n}}self.onmessage=e=>{const{id:t,kind:n}=e.data;let r=null;const i=(a,o)=>{y$(a);const s=b$()?"Initialisation des modèles de vision…":a;self.postMessage({id:t,progress:s,...o!==void 0?{fraction:o}:{},...a!==r?{perfPartiel:{providers:ag(),etapes:og(),etapeCourante:s}}:{}}),r=a};(async()=>{try{n==="recognize"&&i("starting the on-device engine…",0),g$(),v$();const a=performance.now(),o=n==="classify"?await ov(e.data.file):await fv(e.data.payload,i);self.postMessage({id:t,ok:!0,result:o,perf:{etapes:og(),providers:ag(),runtime:w$(),inference:$$(),famillesJs:Ww(),inferenceParEtape:x$(),totalMs:Math.round(performance.now()-a)}})}catch(a){self.postMessage({id:t,ok:!1,error:String(a)})}})()}})();
